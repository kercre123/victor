...
void ProceduralFaceParams::GetEyeBoundingBox(Value& xmin, Value& xmax, Value& ymin, Value& ymax)
{
  ...
  const Value leftHalfWidth = GetParameter(WhichEye::Left, Parameter::EyeScaleX) * ProceduralFace::NominalEyeWidth/2;
  const Value rightHalfWidth = GetParameter(WhichEye::Right, Parameter::EyeScaleX) * ProceduralFace::NominalEyeWidth/2;
  ...
  ymin = (ProceduralFace::NominalEyeY + _faceScale.y() * (
  ...
  ymax = (ProceduralFace::NominalEyeY + _faceScale.y() * (
