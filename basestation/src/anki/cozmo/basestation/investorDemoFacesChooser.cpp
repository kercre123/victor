/**
 * File: investorDemoFacesBehaviorChooser.cpp
 *
 * Author: Brad Neuman
 * Created: 2015-11-25
 *
...
InvestorDemoFacesBehaviorChooser::InvestorDemoFacesBehaviorChooser(Robot& robot, const Json::Value& config)
  : super()
{
...
void InvestorDemoFacesBehaviorChooser::AddNonFactoryBehavior(BehaviorFactory& behaviorFactory, IBehavior* newBehavior)
{
...
void InvestorDemoFacesBehaviorChooser::SetupBehaviors(Robot& robot, const Json::Value& config)
{
...
Result InvestorDemoFacesBehaviorChooser::Update(double currentTime_sec)
{
