...
namespace Cozmo {
  ...
  BehaviorInteractWithFaces::~BehaviorInteractWithFaces()
  {
    ...
    {
      _robot.GetMoveComponent().DisableTrackToFace();
  ...
  IBehavior::Status BehaviorInteractWithFaces::Update(double currentTime_sec)
  {
    switch(_currentState)
    {
      ...
      {
        auto faceID = _robot.GetMoveComponent().GetTrackToFace();
...
#pragma mark Signal Handlers
  ...
  {
    _robot.GetMoveComponent().EnableTrackToFace(face->GetID(), false);
