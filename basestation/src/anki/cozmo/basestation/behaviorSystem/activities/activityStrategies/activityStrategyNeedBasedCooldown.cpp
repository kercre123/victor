...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
ActivityStrategyNeedBasedCooldown::ActivityStrategyNeedBasedCooldown(Robot& robot, const Json::Value& config)
: IActivityStrategy(robot, config)
{
  if(robot.HasExternalInterface())
  {
    auto helper = MakeAnkiEventUtil(*robot.GetContext()->GetExternalInterface(), *this, _eventHandles);
