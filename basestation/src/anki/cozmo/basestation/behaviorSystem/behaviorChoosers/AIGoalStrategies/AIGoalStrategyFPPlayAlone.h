/**
 * File: AIGoalStrategyFPPlayAlone
 *
 * Author: Raul
 * Created: 08/10/2016
 *
 * Description: Specific strategy for FreePlay PlayAlone goal.
 *
 * Copyright: Anki, Inc. 2016
 *
 **/
#ifndef __Cozmo_Basestation_BehaviorSystem_AIGoalStrategyFPPlayAlone_H__
#define __Cozmo_Basestation_BehaviorSystem_AIGoalStrategyFPPlayAlone_H__
...
class AIGoalStrategyFPPlayAlone : public IAIGoalStrategy
{
public:

  // constructor
  AIGoalStrategyFPPlayAlone(Robot& robot, const Json::Value& config);
