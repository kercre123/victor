...
//      msgHandler_(MessageHandler::getInstance())
    {
      ...
      // Webots mat:
      {
        ...
        mat->AddMarker(Vision::MARKER_ANKILOGO, //{24, 24, 24, 16, 25, 49, 56, 9, 56, 48, 32},
                       Pose3d(2.094395, {-0.577350,0.577350,-0.577350}, {-250.000000,250.000000,0.000000}),
                       75);
        mat->AddMarker(Vision::MARKER_ANKILOGO, //{35, 64, 70, 196, 140, 137, 8, 1, 48, 32, 34},
                       Pose3d(-3.141593, {-0.000000,-0.707107,0.707107}, {0.000000,250.000000,0.000000}),
                       75);
        mat->AddMarker(Vision::MARKER_ANKILOGO, //{35, 64, 70, 196, 141, 137, 8, 1, 48, 32, 34},
                       Pose3d(-3.141593, {-0.000000,-0.707107,0.707107}, {250.000000,250.000000,0.000000}),
                       75);
        mat->AddMarker(Vision::MARKER_ANKILOGO, //{24, 24, 24, 16, 24, 49, 56, 9, 56, 48, 32},
                       Pose3d(2.094395, {-0.577350,0.577350,-0.577350}, {-250.000000,0.000000,0.000000}),
                       75);
        mat->AddMarker(Vision::MARKER_ANKILOGO, //{35, 98, 2, 196, 136, 9, 24, 0, 32, 34, 98},
                       Pose3d(1.570796, {-1.000000,0.000000,0.000000}, {0.000000,0.000000,0.000000}),
                       75);
        mat->AddMarker(Vision::MARKER_ANKILOGO, //{8, 24, 24, 24, 8, 25, 56, 33, 56, 24, 48},
                       Pose3d(2.094395, {-0.577350,-0.577350,0.577350}, {250.000000,0.000000,0.000000}),
                       75);
        mat->AddMarker(Vision::MARKER_ANKILOGO, //{35, 98, 2, 196, 137, 9, 24, 1, 32, 34, 98},
                       Pose3d(1.570796, {-1.000000,0.000000,0.000000}, {-250.000000,-250.000000,0.000000}),
                       75);
        mat->AddMarker(Vision::MARKER_ANKILOGO, //{35, 98, 2, 196, 136, 9, 24, 1, 32, 34, 98},
                       Pose3d(1.570796, {-1.000000,0.000000,0.000000}, {0.000000,-250.000000,0.000000}),
                       75);
        mat->AddMarker(Vision::MARKER_ANKILOGO, //{8, 24, 24, 24, 9, 25, 56, 33, 56, 24, 48},
                       Pose3d(2.094395, {-0.577350,-0.577350,0.577350}, {250.000000,-250.000000,0.000000}),
                       75);
