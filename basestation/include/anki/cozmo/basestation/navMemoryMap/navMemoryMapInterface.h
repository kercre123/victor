...
public:
  ...
  virtual bool HasBorders(EContentType innerType, std::set<EContentType> outerTypes) const = 0;
  ...
  virtual void CalculateBorders(EContentType innerType, std::set<EContentType> outerTypes, BorderVector& outBorders) = 0;
