...
public:
  ...
  virtual Result InitInternal(Robot& robot, double currentTime_sec, bool isResuming) final override;
...
protected:
  ...
  virtual Result RequestGame_InitInternal(Robot& robot, double currentTime_sec, bool isResuming) = 0;
