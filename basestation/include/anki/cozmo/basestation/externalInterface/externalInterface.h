...
public:
  ...
  virtual void BroadcastThreadSafe(const ExternalInterface::MessageGameToEngine& message) = 0;
  virtual void BroadcastThreadSafe(ExternalInterface::MessageGameToEngine&& message) = 0;
