...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
StrategyPlacedOnCharger::StrategyPlacedOnCharger(Robot& robot, const Json::Value& config)
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool StrategyPlacedOnCharger::WantsToRunInternal(const Robot& robot) const
{
