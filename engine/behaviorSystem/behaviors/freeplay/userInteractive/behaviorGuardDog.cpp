...
CONSOLE_VAR_RANGED(float, kMovementScoreDetectionThreshold, "Behavior.GuardDog",  28.f,  5.f,  50.f);
CONSOLE_VAR_RANGED(float, kMovementScoreMax, "Behavior.GuardDog", 70.f, 30.f, 200.f);
