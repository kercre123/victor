...
static const char* kBehaviorTestName = "Factory centroid extractor";
  ...
  static const BackpackLEDArray fail_onColorRed{{NamedColors::BLACK,NamedColors::RED,NamedColors::RED,NamedColors::RED}};
  static const BackpackLEDArray fail_onColorOrange{{NamedColors::BLACK,NamedColors::ORANGE,NamedColors::ORANGE,NamedColors::ORANGE}};
  static const BackpackLEDArray fail_onColorMagenta{{NamedColors::BLACK,NamedColors::MAGENTA,NamedColors::MAGENTA,NamedColors::MAGENTA}};
  static const BackpackLEDArray fail_onColorBlue{{NamedColors::BLACK,NamedColors::BLUE,NamedColors::BLUE,NamedColors::BLUE}};
  static const BackpackLEDArray fail_offColor{{NamedColors::BLACK,NamedColors::BLACK,NamedColors::BLACK,NamedColors::BLACK}};
