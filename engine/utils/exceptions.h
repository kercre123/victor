...
__attribute__((used)) static const char* GetExceptionDefinition(
    ExceptionType exception) {
  return ExceptionDefinitions[exception];
}

__attribute__((used)) static const char* GetExceptionDefinition(int exception) {
  if (exception < ET_GENERIC_ERROR || exception > ET_LAST_VALUE)
