...
DataAccessorComponent::DataAccessorComponent()
    : IDependencyManagedComponent<RobotComponentID>(
          this, RobotComponentID::DataAccessor) {}
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void DataAccessorComponent::InitDependent(Vector::Robot* robot,
  ...
  _userDefinedConditionToBehaviorsMap =
      dataLoader.GetUserDefinedConditionToBehaviorsMap();
