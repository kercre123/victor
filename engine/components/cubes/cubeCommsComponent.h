...
public:
  ...
  void SetConnectionChangedCallback(std::function<void(bool)>& callback) { _connectionChangedCallback = callback; }
...
private:
  ...
  std::function<void(bool connected)> _connectionChangedCallback = nullptr;
