...
{
  _appToEngineTags = {{
    AppToEngineTag::kRequestCubeConnection,
    AppToEngineTag::kDoneWithCubeConnection,
    AppToEngineTag::kFlashCubeLights,
    AppToEngineTag::kForgetPreferredCube
  }};
}
...
void AppCubeConnectionSubscriber::ConnectedInteractableCallback()
{
  ...
  auto* connectResultMsg = new external_interface::CubeConnectionAttemptResult;
...
void AppCubeConnectionSubscriber::HandleAppRequest(const AppToEngineEvent& event)
{
  ...
  switch(event.GetData().GetTag()) {
    case GatewayWrapperTag::kRequestCubeConnection:
    {
      PRINT_NAMED_INFO("AppCubeConnectionSubscriber.HandleAppRequest.RequestConnection",
    ...
    case GatewayWrapperTag::kDoneWithCubeConnection:
    {
      PRINT_NAMED_INFO("AppCubeConnectionSubscriber.HandleAppRequest.DoneWithConnection",
    ...
    case GatewayWrapperTag::kFlashCubeLights:
    {
      PRINT_NAMED_INFO("AppCubeConnectionSubscriber.HandleAppRequest.FlashCubeLights",
      ...
      if (ccc.IsConnectedToCube()) {
        ...
        PRINT_NAMED_WARNING("AppCubeConnectionSubscriber.HandleAppRequest.FlashCubeLights.NotConnected",
                            "Cannot flash cube lights - not connected to any cube!");
      }
      break;
    }
    case GatewayWrapperTag::kForgetPreferredCube:
    {
      PRINT_NAMED_INFO("AppCubeConnectionSubscriber.HandleAppRequest.ForgetPreferredCube",
