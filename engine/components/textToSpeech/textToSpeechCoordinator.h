 ...
 * Created: 5/22/18
 *
 * Description: Component for requesting and tracking TTS utterance generation
 *and playing
 *
...
class TextToSpeechCoordinator
 ...
 public:
  ...
  //  + if cancelling when tts is generating, thread will hang until generation
  //  is complete
  //  + cancelling will clear the wav data in AnkiPluginInterface, regardless of
  //  which utteranceID was last delivered
