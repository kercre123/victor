 ...
 * Implementations are split across the coordinator behavior and the timer
 *utility component within the AI system. Functions declared here so they're
 *exposed to each other and provide a centeral reference point for Devs working
 *with this system
 *
