/**
* File: StrategyObjectPositionUpdated.h
*
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void StrategyObjectPositionUpdated::HandleObjectObserved(BehaviorExternalInterface& behaviorExternalInterface,
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void StrategyObjectPositionUpdated::AddReactionData(s32 idToAdd, ReactionData &&data)
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool StrategyObjectPositionUpdated::RemoveReactionData(s32 idToRemove)
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void StrategyObjectPositionUpdated::ReactionData::FakeReaction()
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void StrategyObjectPositionUpdated::HandleNewObservation(s32 id,
                                                         const Pose3d& pose,
                                                         u32 timestamp,
                                                         bool reactionEnabled)
{
  ...
  if( reactionIt == _reactionData.end() ) {
    ...
    if( kDebugAcknowledgements ) {
      PRINT_CH_INFO("ReactionTriggers", ("StrategyObjectPositionUpdated.AddNewID"),
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool StrategyObjectPositionUpdated::ShouldReactToTarget(BehaviorExternalInterface& behaviorExternalInterface,
                                                            ...
                                                            bool matchAnyPose) const
{
  ...
  if( matchAnyPose ) {
    ...
    if( kDebugAcknowledgements ) {
      reactionPair.second.lastPose.Print("Behaviors", ("StrategyObjectPositionUpdated.lastPose"));
    }
    ...
    for( const auto& otherPair : _reactionData ) {
      ...
      if( otherPair.second.lastReactionTime_ms == 0 ) {
        ...
        if( kDebugAcknowledgements ) {
          PRINT_CH_INFO("ReactionTriggers", ("StrategyObjectPositionUpdated.CheckAnyPose.Skip"),
      ...
      if( kDebugAcknowledgements ) {
        PRINT_CH_INFO("ReactionTriggers", ("StrategyObjectPositionUpdated.CheckAnyPose"),
                      "%3d vs %3d: shouldReactToOther?%d ",
                      reactionPair.first,
                      otherPair.first,
                      shouldReactToOther ? 1 : 0);
        
        otherPair.second.lastReactionPose.Print("Behaviors", ("StrategyObjectPositionUpdated.other.lastReaction"));
      }
    ...
    if( hasEverReactedToThisId ) {
      ...
      if( kDebugAcknowledgements ) {
        PRINT_CH_INFO("ReactionTriggers", ("StrategyObjectPositionUpdated.SingleReaction"),
        ...
        reactionPair.second.lastPose.Print("Behaviors", ("StrategyObjectPositionUpdated.lastPose"));
        reactionPair.second.lastReactionPose.Print("Behaviors", ("StrategyObjectPositionUpdated.lastReactionPose"));
      }
      ...
      if( kDebugAcknowledgements ) {
        PRINT_CH_INFO("ReactionTriggers", ("StrategyObjectPositionUpdated.DoInitialReaction"),
                      "Doing first reaction to new id %d at ts=%dms",
                      reactionPair.first,
                      reactionPair.second.lastSeenTime_ms);
        reactionPair.second.lastPose.Print("Behaviors", ("StrategyObjectPositionUpdated.NewPose"));
      }
    }
  }
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool StrategyObjectPositionUpdated::HasDesiredReactionTargets(BehaviorExternalInterface& behaviorExternalInterface, bool matchAnyPose) const
{
