...
#ifndef __Cozmo_Basestation_BehaviorSystem_WantsToRunStrategies_StrategyObjectPositionUpdated_H__
...
{
public:
  StrategyObjectPositionUpdated(const Json::Value& config);
...
#endif // __Cozmo_Basestation_BehaviorSystem_WantsToRunStrategies_StrategyObjectPositionUpdated_H__
