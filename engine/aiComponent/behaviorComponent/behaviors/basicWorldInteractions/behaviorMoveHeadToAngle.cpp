...
BehaviorMoveHeadToAngle::BehaviorMoveHeadToAngle(const Json::Value& config)
  ...
  _iConfig.headAngle_deg =
      JsonTools::ParseFloat(config, kHeadAngleKey, GetDebugLabel());
}
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorMoveHeadToAngle::GetBehaviorOperationModifiers(
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorMoveHeadToAngle::GetBehaviorJsonKeys(
...
void BehaviorMoveHeadToAngle::OnBehaviorActivated() {
  ...
  DelegateIfInControl(
      new MoveHeadToAngleAction(Radians{DEG_TO_RAD(_iConfig.headAngle_deg)}));
}
