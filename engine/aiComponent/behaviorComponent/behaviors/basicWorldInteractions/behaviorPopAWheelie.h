 ...
 * Created: 2016-06-15
 *
 * Description: A behavior which allows cozmo to use a block to pop himself onto
 *his back
 *
...
class BehaviorPopAWheelie : public ICozmoBehavior {
 public:
  ...
  // True starting at the end of predock and ending when the wheelie animation
  // complete
 ...
 private:
  enum class DebugState { ReactingToBlock, PerformingAction };
  ...
  struct DynamicVariables {
    DynamicVariables();
    // TODO:(bn) a few behaviors have used this pattern now, maybe we should
    // re-think having some kind of UpdateWhileNotRunning
