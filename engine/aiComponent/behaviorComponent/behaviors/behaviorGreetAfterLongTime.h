...
class BehaviorGreetAfterLongTime : public ICozmoBehavior {
 public:
  ...
  using LastSeenMapPtr =
      std::shared_ptr<std::unordered_map<std::string, time_t>>;
 ...
 private:
  ...
  // runs checks to decide whether the behavior update should run during this
  // tick
  ...
  struct DynamicVariables {
    ...
    // should play reaction flag as long as we can play it before the given
    // (basestation) time
