...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
BehaviorAnimSequenceWithObject::BehaviorAnimSequenceWithObject(
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorAnimSequenceWithObject::GetBehaviorJsonKeys(
...
void BehaviorAnimSequenceWithObject::OnBehaviorActivated() {
  ...
  if (obj != nullptr) {
    // Attempt to turn toward the specified object, and even if fails, move on
    // to the animations
    DelegateIfInControl(new TurnTowardsObjectAction(obj->GetID()),
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
const ObservableObject* BehaviorAnimSequenceWithObject::GetLocatedObject()
    const {
  ...
  const auto* object =
      GetBEI().GetBlockWorld().FindLocatedObjectClosestTo(robotPose, filter);
