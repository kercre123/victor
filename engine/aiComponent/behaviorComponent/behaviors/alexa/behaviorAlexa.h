...
class BehaviorAlexa : public ICozmoBehavior {
 ...
 private:
  ...
  AnimationTrigger GetTransitionAnimation(AlexaUXState fromState,
                                          AlexaUXState toState) const;
  ...
  void TransitionTo_Transition(
      AlexaUXState oldState,
      AlexaUXState newState);  // i heard you like transitions
  ...
  using AnimTransitionList =
      std::vector<std::pair<AlexaUXState, AnimationTrigger> >;
