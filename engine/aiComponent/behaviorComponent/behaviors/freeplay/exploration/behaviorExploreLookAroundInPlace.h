...
protected:
  ...
  struct Configuration
  {
    ...
    AnimationTrigger s2_WaitAnimTrigger; // animation that will play instead of the wait
    ...
    AnimationTrigger s4_WaitAnimTrigger; // animation that will play instead of the wait
