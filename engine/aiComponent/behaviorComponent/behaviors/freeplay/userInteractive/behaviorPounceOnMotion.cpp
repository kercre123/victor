...
void BehaviorPounceOnMotion::PounceOnMotionWithCallback(BehaviorExternalInterface& behaviorExternalInterface, void(T::*callback)(BehaviorExternalInterface&),  IActionRunner* intermittentAction)
{
  ...
  StartActing(compAction, [this, callback](BehaviorExternalInterface& behaviorExternalInterface){
    // DEPRECATED - Grabbing robot to support current cozmo code, but this should
    // be removed
    Robot& robot = behaviorExternalInterface.GetRobot();
    ...
    StartActing(new WaitAction(robot, relaxTime), [this, callback](BehaviorExternalInterface& behaviorExternalInterface){
      // DEPRECATED - Grabbing robot to support current cozmo code, but this should
      // be removed
      Robot& robot = behaviorExternalInterface.GetRobot();
