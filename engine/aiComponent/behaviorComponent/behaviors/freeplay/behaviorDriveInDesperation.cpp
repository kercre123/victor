...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void BehaviorDriveInDesperation::InitBehavior() {
...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void BehaviorDriveInDesperation::OnBehaviorActivated()
{
...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void BehaviorDriveInDesperation::OnBehaviorDeactivated()
{
}

//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void BehaviorDriveInDesperation::BehaviorUpdate()
{
  if(!IsActivated()){
    return;
  }
...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool BehaviorDriveInDesperation::WantsToBeActivatedBehavior() const
{
  return true;
}

//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void BehaviorDriveInDesperation::TransitionToIdle()
{
  SET_STATE(Idle);
...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void BehaviorDriveInDesperation::TransitionToDriveRandom()
{
...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void BehaviorDriveInDesperation::TransitionToRequest()
{
  SET_STATE(Request);
  ...
  DelegateIfInControl(faceAction, [this]() {
...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void BehaviorDriveInDesperation::TransitionToSearchForCube()
{
  ...
  SmartDelegateToHelper(searchHelper,
                        &BehaviorDriveInDesperation::TransitionToDriveToCube);
}

//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void BehaviorDriveInDesperation::TransitionToDriveToCube()
{
  ...
  if( !_targetCube.IsSet() ) {
    const ObservableObject* recentObj =
      GetBEI().GetBlockWorld().FindMostRecentlyObservedObject( *_validCubesFilter );
  ...
  const ActionableObject* obj = dynamic_cast<const ActionableObject*>(
            GetBEI().GetBlockWorld().GetLocatedObjectByID(_targetCube) );
  ...
  if( hasPoseToDriveTo ) {
    ...
    TransitionToLookAtCube();
  }

}

//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void BehaviorDriveInDesperation::TransitionToLookAtCube()
{
  ...
  TurnTowardsObjectAction* turnAction = new TurnTowardsObjectAction(
                                                                    ...
                                                                    verifyWhenDone,
                                                                    headTrackWhenDone);
  DelegateIfInControl(turnAction, [this](ActionResult res) {
...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void BehaviorDriveInDesperation::TransitionFromIdle()
{
  if( _params->_useCubes ) {
    TransitionFromIdle_WithCubes();
  }
  else {
    TransitionFromIdle_NoCubes();
  }
}
    

//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void BehaviorDriveInDesperation::TransitionFromIdle_NoCubes()
{
...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void BehaviorDriveInDesperation::TransitionFromIdle_WithCubes()
{
  ...
  if( _nextTimeToRevisitCube < 0.0f || currTime_s >= _nextTimeToRevisitCube ) {
    ...
    GetBEI().GetBlockWorld().FindLocatedMatchingObjects(*_validCubesFilter, cubes);
...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void BehaviorDriveInDesperation::GetRandomDrivingPose(Pose3d& outPose)
{
