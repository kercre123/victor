...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
BehaviorReactToUnclaimedIntent::BehaviorReactToUnclaimedIntent(
    const Json::Value& config)
    : ICozmoBehavior(config) {}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorReactToUnclaimedIntent::GetBehaviorOperationModifiers(
...
void BehaviorReactToUnclaimedIntent::OnBehaviorActivated() {
  ...
  IAction* playAnim = new TriggerLiftSafeAnimationAction(
      animTrigger, numLoops, interruptRunning, tracksToLock);
