 ...
 * Created: 2018-12-10
 *
 * Description: Reimplementing 1p0 onboarding in the new framework: sit still
 *and await a VC, exit onboarding if one is recieved.
 *
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
BehaviorOnboardingEmulate1p0WaitForVC::
    ~BehaviorOnboardingEmulate1p0WaitForVC() {}
...
void BehaviorOnboardingEmulate1p0WaitForVC::InitBehavior() {
  ...
  _iConfig.lookAtUserBehavior =
      BC.FindBehaviorByID(BEHAVIOR_ID(OnboardingLookAtUser));
  _iConfig.reactToTriggerWordBehavior =
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorOnboardingEmulate1p0WaitForVC::GetBehaviorOperationModifiers(
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorOnboardingEmulate1p0WaitForVC::GetAllDelegates(
