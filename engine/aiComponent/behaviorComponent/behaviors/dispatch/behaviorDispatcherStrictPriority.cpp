...
BehaviorDispatcherStrictPriority::InstanceConfig::InstanceConfig()
    : linkScope(false), actAsSelector(false) {}
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
BehaviorDispatcherStrictPriority::BehaviorDispatcherStrictPriority(
    const Json::Value& config)
    : IBehaviorDispatcher(config) {
  static_assert(std::is_base_of<BehaviorDispatcherStrictPriority::BaseClass,
                                BehaviorDispatcherStrictPriority>::value,
                "BaseClass is wrong");
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorDispatcherStrictPriority::GetBehaviorJsonKeys(
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorDispatcherStrictPriority::GetLinkedActivatableScopeBehaviors(
...
ICozmoBehaviorPtr BehaviorDispatcherStrictPriority::GetDesiredBehavior() {
  ...
  // Iterate through available behaviors, and use the first one that is
  // activated or wants to be activated since this is the highest priority
  // behavior
  for (const auto& entry : GetAllPossibleDispatches()) {
