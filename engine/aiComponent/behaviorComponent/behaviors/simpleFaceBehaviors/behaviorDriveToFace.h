...
class BehaviorDriveToFace : public ICozmoBehavior {
 ...
 private:
  ...
  struct InstanceConfig {
    ...
    bool trackFaceOnceKnown;  // if true, this behavior spends time tracking the
                              // face after driving up to it
  ...
  // Returns true if the robot is close enough to the face that he won't
  // actually drive forward when this behavior runs
