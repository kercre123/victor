 ...
 * Created: 01/25/17
 *
 * Description: Behavior for responding to robot being placed down on a slope or
 *at a pitch angle away from horizontal.
 *
...
class BehaviorReactToPlacedOnSlope : public ICozmoBehavior {
 ...
 private:
  ...
  // Checks whether the cliffs detected are valid in order to activate or
  // continue running the behavior.
