...
class BehaviorReactToMicDirection : public ICozmoBehavior {
 ...
 private:
  ...
  // For each of these possible states, we need to be able to (possibly) react
  // differently eg. lock treads if being held
  ...
  // Helpers ...
  EClockDirection ConvertMicDirectionToClockDirection(
