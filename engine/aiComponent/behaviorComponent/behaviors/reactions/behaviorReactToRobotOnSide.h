...
class BehaviorReactToRobotOnSide : public ICozmoBehavior {
 ...
 private:
  struct InstanceConfig {
    ...
    // After having been activated for this long, then transition to the "ask
    // for help" behavior. If this is less than zero, then just infinitely loop
    // in this behavior until we're no longer on our side.
