...
// BN: just adding this as a placeholder in case anyone goes looking for this, but I don't think it's used
CONSOLE_VAR(bool, kLightDesignVariablesDisabled, "CubeLightDesign.Variables(these were disabled, check behaviorDevDesignCubeLights.cpp to re-enable)", false);

// LED 1
CONSOLE_CONST_RANGED(u8, kLED1_s1_red, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED1_s1_green, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED1_s1_blue, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED1_s1_alpha, CONSOLE_GROUP, 255, 0, 255);

CONSOLE_CONST_RANGED(u8, kLED1_s2_red, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED1_s2_green, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED1_s2_blue, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED1_s2_alpha, CONSOLE_GROUP, 255, 0, 255);

CONSOLE_CONST_RANGED(u32, kLED1_s1_hold_ms, CONSOLE_GROUP, 0, 0, MAX_SEG_LEN);
CONSOLE_CONST_RANGED(u32, kLED1_s2_hold_ms, CONSOLE_GROUP, 0, 0, MAX_SEG_LEN);
CONSOLE_CONST_RANGED(u32, kLED1_s1_transition_s2_ms, CONSOLE_GROUP, 0, 0, MAX_SEG_LEN);
CONSOLE_CONST_RANGED(u32, kLED1_s2_transition_s1_ms, CONSOLE_GROUP, 0, 0, MAX_SEG_LEN);
CONSOLE_CONST_RANGED(u32, kLED1_s1_hold_offset_ms, CONSOLE_GROUP, 0, 0, MAX_SEG_LEN*4);


// LED 2
CONSOLE_CONST_RANGED(u8, kLED2_s1_red, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED2_s1_green, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED2_s1_blue, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED2_s1_alpha, CONSOLE_GROUP, 255, 0, 255);

CONSOLE_CONST_RANGED(u8, kLED2_s2_red, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED2_s2_green, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED2_s2_blue, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED2_s2_alpha, CONSOLE_GROUP, 255, 0, 255);

CONSOLE_CONST_RANGED(u32, kLED2_s1_hold_ms, CONSOLE_GROUP, 0, 0, MAX_SEG_LEN);
CONSOLE_CONST_RANGED(u32, kLED2_s2_hold_ms, CONSOLE_GROUP, 0, 0, MAX_SEG_LEN);
CONSOLE_CONST_RANGED(u32, kLED2_s1_transition_s2_ms, CONSOLE_GROUP, 0, 0, MAX_SEG_LEN);
CONSOLE_CONST_RANGED(u32, kLED2_s2_transition_s1_ms, CONSOLE_GROUP, 0, 0, MAX_SEG_LEN);
CONSOLE_CONST_RANGED(u32, kLED2_s1_hold_offset_ms, CONSOLE_GROUP, 0, 0, MAX_SEG_LEN * 4);


// LED 3
CONSOLE_CONST_RANGED(u8, kLED3_s1_red, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED3_s1_green, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED3_s1_blue, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED3_s1_alpha, CONSOLE_GROUP, 255, 0, 255);

CONSOLE_CONST_RANGED(u8, kLED3_s2_red, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED3_s2_green, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED3_s2_blue, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED3_s2_alpha, CONSOLE_GROUP, 255, 0, 255);

CONSOLE_CONST_RANGED(u32, kLED3_s1_hold_ms, CONSOLE_GROUP, 0, 0, MAX_SEG_LEN);
CONSOLE_CONST_RANGED(u32, kLED3_s2_hold_ms, CONSOLE_GROUP, 0, 0,  MAX_SEG_LEN);
CONSOLE_CONST_RANGED(u32, kLED3_s1_transition_s2_ms, CONSOLE_GROUP, 0, 0, MAX_SEG_LEN);
CONSOLE_CONST_RANGED(u32, kLED3_s2_transition_s1_ms, CONSOLE_GROUP, 0, 0,  MAX_SEG_LEN);
CONSOLE_CONST_RANGED(u32, kLED3_s1_hold_offset_ms, CONSOLE_GROUP, 0, 0, MAX_SEG_LEN*4);


// LED 4
CONSOLE_CONST_RANGED(u8, kLED4_s1_red, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED4_s1_green, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED4_s1_blue, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED4_s1_alpha, CONSOLE_GROUP, 255, 0, 255);

CONSOLE_CONST_RANGED(u8, kLED4_s2_red, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED4_s2_green, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED4_s2_blue, CONSOLE_GROUP, 0, 0, 255);
CONSOLE_CONST_RANGED(u8, kLED4_s2_alpha, CONSOLE_GROUP,  255, 0, 255);

CONSOLE_CONST_RANGED(u32, kLED4_s1_hold_ms, CONSOLE_GROUP, 0, 0, MAX_SEG_LEN);
CONSOLE_CONST_RANGED(u32, kLED4_s2_hold_ms, CONSOLE_GROUP, 0, 0, MAX_SEG_LEN);
CONSOLE_CONST_RANGED(u32, kLED4_s1_transition_s2_ms, CONSOLE_GROUP, 0, 0,  MAX_SEG_LEN);
CONSOLE_CONST_RANGED(u32, kLED4_s2_transition_s1_ms, CONSOLE_GROUP, 0, 0, MAX_SEG_LEN);
CONSOLE_CONST_RANGED(u32, kLED4_s1_hold_offset_ms, CONSOLE_GROUP, 0, 0, MAX_SEG_LEN*4);


CONSOLE_CONST(bool, kRotate, CONSOLE_GROUP, false);
