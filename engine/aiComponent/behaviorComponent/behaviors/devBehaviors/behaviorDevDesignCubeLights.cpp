...
// LED 1
CONSOLE_VAR_RANGED(u8, kLED1_s1_red, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED1_s1_green, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED1_s1_blue, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED1_s1_alpha, CONSOLE_GROUP, 0, 255, 0);

CONSOLE_VAR_RANGED(u8, kLED1_s2_red, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED1_s2_green, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED1_s2_blue, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED1_s2_alpha, CONSOLE_GROUP, 0, 255, 0);

CONSOLE_VAR_RANGED(u32, kLED1_s1_hold_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN, 0);
CONSOLE_VAR_RANGED(u32, kLED1_s2_hold_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN, 0);
CONSOLE_VAR_RANGED(u32, kLED1_s1_transition_s2_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN, 0);
CONSOLE_VAR_RANGED(u32, kLED1_s2_transition_s1_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN, 0);
CONSOLE_VAR_RANGED(u32, kLED1_s1_hold_offset_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN*4, 0);


// LED 2
CONSOLE_VAR_RANGED(u8, kLED2_s1_red, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED2_s1_green, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED2_s1_blue, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED2_s1_alpha, CONSOLE_GROUP, 0, 255, 0);

CONSOLE_VAR_RANGED(u8, kLED2_s2_red, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED2_s2_green, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED2_s2_blue, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED2_s2_alpha, CONSOLE_GROUP, 0, 255, 0);

CONSOLE_VAR_RANGED(u32, kLED2_s1_hold_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN, 0);
CONSOLE_VAR_RANGED(u32, kLED2_s2_hold_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN, 0);
CONSOLE_VAR_RANGED(u32, kLED2_s1_transition_s2_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN, 0);
CONSOLE_VAR_RANGED(u32, kLED2_s2_transition_s1_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN, 0);
CONSOLE_VAR_RANGED(u32, kLED2_s1_hold_offset_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN * 4, 0);


// LED 3
CONSOLE_VAR_RANGED(u8, kLED3_s1_red, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED3_s1_green, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED3_s1_blue, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED3_s1_alpha, CONSOLE_GROUP, 0, 255, 0);

CONSOLE_VAR_RANGED(u8, kLED3_s2_red, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED3_s2_green, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED3_s2_blue, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED3_s2_alpha, CONSOLE_GROUP, 0, 255, 0);

CONSOLE_VAR_RANGED(u32, kLED3_s1_hold_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN, 0);
CONSOLE_VAR_RANGED(u32, kLED3_s2_hold_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN, 0);
CONSOLE_VAR_RANGED(u32, kLED3_s1_transition_s2_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN, 0);
CONSOLE_VAR_RANGED(u32, kLED3_s2_transition_s1_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN, 0);
CONSOLE_VAR_RANGED(u32, kLED3_s1_hold_offset_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN*4, 0);


// LED 4
CONSOLE_VAR_RANGED(u8, kLED4_s1_red, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED4_s1_green, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED4_s1_blue, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED4_s1_alpha, CONSOLE_GROUP, 0, 255, 0);

CONSOLE_VAR_RANGED(u8, kLED4_s2_red, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED4_s2_green, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED4_s2_blue, CONSOLE_GROUP, 0, 255, 0);
CONSOLE_VAR_RANGED(u8, kLED4_s2_alpha, CONSOLE_GROUP, 0, 255, 0);

CONSOLE_VAR_RANGED(u32, kLED4_s1_hold_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN, 0);
CONSOLE_VAR_RANGED(u32, kLED4_s2_hold_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN, 0);
CONSOLE_VAR_RANGED(u32, kLED4_s1_transition_s2_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN, 0);
CONSOLE_VAR_RANGED(u32, kLED4_s2_transition_s1_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN, 0);
CONSOLE_VAR_RANGED(u32, kLED4_s1_hold_offset_ms, CONSOLE_GROUP, 0, MAX_SEG_LEN*4, 0);
...
void BehaviorDevDesignCubeLights::BehaviorUpdate() 
{
  ...
  if(ANKI_DEV_CHEATS && s_shouldSaveNextTick){
    struct tm time;
  ...
  if((newLights != _dVars.currentLights) &&
     (obj != nullptr)){
    GetBEI().GetCubeLightComponent().StopLightAnimAndResumePrevious(_dVars.handle);
    

    
    GetBEI().GetCubeLightComponent().PlayLightAnim(obj->GetID(), anim, {}, "DevDesignCubeLights", _dVars.handle);
