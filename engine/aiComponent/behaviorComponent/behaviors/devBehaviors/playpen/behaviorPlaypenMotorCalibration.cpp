...
BehaviorPlaypenMotorCalibration::BehaviorPlaypenMotorCalibration(
...
Result BehaviorPlaypenMotorCalibration::OnBehaviorActivatedInternal() {
  ...
  robot.SendMessage(
      RobotInterface::EngineToRobot(RobotInterface::StartMotorCalibration(
          true, true, MotorCalibrationReason::Playpen)));
  AddTimer(PlaypenConfig::kMotorCalibrationTimeout_ms, [this]() {
    PLAYPEN_SET_RESULT(FactoryTestResultCode::MOTORS_UNCALIBRATED)
  });
...
BehaviorPlaypenMotorCalibration::PlaypenUpdateInternal() {
...
void BehaviorPlaypenMotorCalibration::HandleWhileActivatedInternal(
