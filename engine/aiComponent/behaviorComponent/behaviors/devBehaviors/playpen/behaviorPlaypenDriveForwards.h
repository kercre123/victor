 ...
 * Created: 07/28/17
 *
 * Description: Drives Cozmo fowards over a narrow cliff checking that all 4
 *cliff sensors are working
 *
...
class BehaviorPlaypenDriveForwards : public IBehaviorPlaypen {
 ...
 private:
  ...
  // First the front cliffs should be detected and then undetected, then the
  // back cliffs should be detected and finally undetected
  enum State {
    NONE,
