 ...
 * Created: 09/22/17
 *
 * Description: Turns towards a target marker and records a number of distance
 *sensor readings
 *
...
class BehaviorPlaypenDistanceSensor : public IBehaviorPlaypen {
 ...
 private:
  ...
  // Gets the most recently observed marker pose (wrt robot) of the expected
  // object Returns true if markerPoseWrtRobot is valid
