...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorDevCubeSpinnerConsole::GetBehaviorOperationModifiers(
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorDevCubeSpinnerConsole::GetAllDelegates(
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorDevCubeSpinnerConsole::GetBehaviorJsonKeys(
  ...
  if (_dVars.lastLockResult != CubeSpinnerGame::LockResult::Count) {
    switch (_dVars.lastLockResult) {
      case CubeSpinnerGame::LockResult::Locked: {
        DelegateNow(
            new TriggerAnimationAction(AnimationTrigger::PounceSuccess));
        break;
      }
      case CubeSpinnerGame::LockResult::Error: {
        DelegateNow(new TriggerAnimationAction(AnimationTrigger::PounceFail),
                    [this]() { ResetGame(); });
        break;
      }
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorDevCubeSpinnerConsole::HandleWhileActivated(
