...
// The self test behaviors should be written in such a way so that they can
...
// Cliff sensors must be reporting less than this value when the robot is upside
// down
static u16 kUpsideDownCliffValThresh = 50;

// Once the robot has been turned upside down, if more than this amount of time
// passes the test will fail
static u16 kUpsideDownTimeout_ms = 5000;

// ----------InitChecks----------
// Minimum battery voltage the robot should have at the start and end of self
// test
static f32 kMinBatteryVoltage = 3.6;

// Minimum charger voltage the robot should see when on the charger at the
...
// Distance to drive backwards at the beginning of the self test to align
...
// The charger marker's last observed time is allowed to be this old compared to
