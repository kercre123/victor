...
BehaviorDevTestBlackjackViz::BehaviorDevTestBlackjackViz(
    ...
    : ICozmoBehavior(config), _game(), _visualizer(&_game) {
  sThis = this;
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
BehaviorDevTestBlackjackViz::~BehaviorDevTestBlackjackViz() { sThis = nullptr; }
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorDevTestBlackjackViz::GetBehaviorOperationModifiers(
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorDevTestBlackjackViz::GetAllDelegates(
    std::set<IBehavior*>& delegates) const {}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorDevTestBlackjackViz::GetBehaviorJsonKeys(
