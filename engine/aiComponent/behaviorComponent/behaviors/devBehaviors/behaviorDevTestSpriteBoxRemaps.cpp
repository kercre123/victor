...
const std::vector<Vision::SpriteBoxName> kPlayerDealingSpriteBoxes = {
    Vision::SpriteBoxName::SpriteBox_1, Vision::SpriteBoxName::SpriteBox_4,
    Vision::SpriteBoxName::SpriteBox_7, Vision::SpriteBoxName::SpriteBox_10,
    Vision::SpriteBoxName::SpriteBox_13};
const std::vector<Vision::SpriteBoxName> kPlayerShowCardSpriteBoxes = {
    Vision::SpriteBoxName::SpriteBox_2, Vision::SpriteBoxName::SpriteBox_5,
    Vision::SpriteBoxName::SpriteBox_8, Vision::SpriteBoxName::SpriteBox_11,
    Vision::SpriteBoxName::SpriteBox_14};
const std::vector<Vision::SpriteBoxName> kPlayerCardSpriteBoxes = {
    Vision::SpriteBoxName::SpriteBox_3, Vision::SpriteBoxName::SpriteBox_6,
    Vision::SpriteBoxName::SpriteBox_9, Vision::SpriteBoxName::SpriteBox_12,
    Vision::SpriteBoxName::SpriteBox_15};
const std::vector<Vision::SpriteBoxName> kDealerDealingSpriteBoxes = {
    Vision::SpriteBoxName::SpriteBox_16, Vision::SpriteBoxName::SpriteBox_19,
    Vision::SpriteBoxName::SpriteBox_22, Vision::SpriteBoxName::SpriteBox_25,
    Vision::SpriteBoxName::SpriteBox_28};
const std::vector<Vision::SpriteBoxName> kDealerShowCardSpriteBoxes = {
    Vision::SpriteBoxName::SpriteBox_17, Vision::SpriteBoxName::SpriteBox_20,
    Vision::SpriteBoxName::SpriteBox_23, Vision::SpriteBoxName::SpriteBox_26,
    Vision::SpriteBoxName::SpriteBox_29};
const std::vector<Vision::SpriteBoxName> kDealerCardSpriteBoxes = {
    Vision::SpriteBoxName::SpriteBox_18, Vision::SpriteBoxName::SpriteBox_21,
    Vision::SpriteBoxName::SpriteBox_24, Vision::SpriteBoxName::SpriteBox_27,
...
const Vision::SpriteBoxName kCharlieFrameSpriteBox =
    Vision::SpriteBoxName::SpriteBox_31;
const Vision::SpritePathMap::AssetID kCharlieFrameAssetID =
    Vision::SpritePathMap::GetAssetID("charlieframe");
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorDevTestSpriteBoxRemaps::GetBehaviorOperationModifiers(
...
void BehaviorDevTestSpriteBoxRemaps::ClearAllPositions() {
  ...
  for (const auto& spriteBox : kPlayerDealingSpriteBoxes) {
    _dVars.remapMap.insert(
        {spriteBox, Vision::SpritePathMap::kEmptySpriteBoxID});
  }
  ...
  _dVars.remapMap.insert(
      {kCharlieFrameSpriteBox, Vision::SpritePathMap::kEmptySpriteBoxID});
}
...
void BehaviorDevTestSpriteBoxRemaps::DealNextPlayerCard() {
  if (_dVars.playerCardIndex >= kPlayerCards.size()) {
    ...
    GetBEI().GetAnimationComponent().PlayAnimWithSpriteBoxRemaps(
        kDealAnimationName, _dVars.remapMap, interruptRunning,
        animationCallback);
  } else {
    // Show the animated card dealing
    _dVars.remapMap[kPlayerShowCardSpriteBoxes[_dVars.playerCardIndex]] =
        kPlayerCards[_dVars.playerCardIndex];
    _dVars.remapMap[kPlayerDealingSpriteBoxes[_dVars.playerCardIndex]] =
        kDealPlayerSpriteSeqID;
    ...
    _dVars.remapMap[kPlayerShowCardSpriteBoxes[_dVars.playerCardIndex]] =
        Vision::SpritePathMap::kEmptySpriteBoxID;
    _dVars.remapMap[kPlayerDealingSpriteBoxes[_dVars.playerCardIndex]] =
        Vision::SpritePathMap::kEmptySpriteBoxID;
    // ...and store the dealt card
    _dVars.remapMap[kPlayerCardSpriteBoxes[_dVars.playerCardIndex]] =
        kPlayerCards[_dVars.playerCardIndex];
...
void BehaviorDevTestSpriteBoxRemaps::DealNextDealerCard() {
  // Show the animated card dealing
  _dVars.remapMap[kDealerShowCardSpriteBoxes[_dVars.dealerCardIndex]] =
      kDealerCards[_dVars.dealerCardIndex];
  _dVars.remapMap[kDealerDealingSpriteBoxes[_dVars.dealerCardIndex]] =
      kDealPlayerSpriteSeqID;
  ...
  const bool interruptRunning = true;
  GetBEI().GetAnimationComponent().PlayAnimWithSpriteBoxRemaps(
      kDealAnimationName, _dVars.remapMap, interruptRunning, animationCallback);
  ...
  _dVars.remapMap[kDealerDealingSpriteBoxes[_dVars.dealerCardIndex]] =
      Vision::SpritePathMap::kEmptySpriteBoxID;
  // ...and store the dealt card
  _dVars.remapMap[kDealerCardSpriteBoxes[_dVars.dealerCardIndex]] =
      kDealerCards[_dVars.dealerCardIndex];
