...
class BehaviorComponent : public IBehaviorMessageSubscriber,
 ...
 public:
  ...
  // Pass in any components that have already been initialized as part of the
  // entity all other required components will be automatically generated
  static void GenerateManagedComponents(Robot& robot, ComponentPtr& entity);
