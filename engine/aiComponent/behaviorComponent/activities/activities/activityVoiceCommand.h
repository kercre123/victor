...
private:
  ...
  bool HasEnoughSparksForCommand(BehaviorExternalInterface& behaviorExternalInterface, VoiceCommand::VoiceCommandType command) const;
  
  // Returns whether or not the unlockID a behavior requires for a voice command is unlocked
  bool HasAppropriateUnlocksForCommand(BehaviorExternalInterface& behaviorExternalInterface, VoiceCommand::VoiceCommandType command) const;
  
  void RemoveSparksForCommand(BehaviorExternalInterface& behaviorExternalInterface, VoiceCommand::VoiceCommandType command);
  ...
  bool CheckRefusalDueToNeeds(BehaviorExternalInterface& behaviorExternalInterface, ChooseNextBehaviorQueue& responseQueue) const;
  ...
  bool CheckAndSetupRefuseBehavior(BehaviorExternalInterface& behaviorExternalInterface,
                                   BehaviorID whichRefuse, ChooseNextBehaviorQueue& responseQueue) const;
  
  // Handles what response to do for the "How are you doing" command based on Cozmo's current needs
  void HandleHowAreYouDoingCommand(BehaviorExternalInterface& behaviorExternalInterface, ChooseNextBehaviorQueue& responseQueue);
