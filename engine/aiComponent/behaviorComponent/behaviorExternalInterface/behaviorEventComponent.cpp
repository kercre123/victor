...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorEventComponent::InitDependent(Robot* robot,
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorEventComponent::Init(
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BehaviorEventComponent::SubscribeToTags(
...
// - - - - - - - - - - - - - - - - - - - -
void BehaviorEventComponent::SubscribeToTags(
    IBehavior* subscriber, std::set<AppToEngineTag>&& tags) const {
  if (ANKI_VERIFY(_messageSubscriber != nullptr,
                  "BehaviorEventComponent.SubscribeToTags.NoMessageSubscriber",
                  "")) {
    _messageSubscriber->_ref.SubscribeToTags(subscriber, std::move(tags));
