...
// This class controlls behavior music state which is not realevent when playing
// audio on the robot
...
class BehaviorAudioComponent
 ...
 protected:
  void HandleRobotPublicStateChange(
 ...
 private:
  ...
  // Keep track of the last AI goal name sent from the PublicStateBroadcaster so
  // we
