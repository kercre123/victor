...
protected:
  ...
  void HandleNewObservation(BehaviorExternalInterface& behaviorExternalInterface, s32 id, const Pose3d& pose, u32 timestamp);
  ...
  void GetDesiredReactionTargets(BehaviorExternalInterface& behaviorExternalInterface, std::set<s32>& targets, bool matchAnyPose = false) const;
  ...
  bool GetBestTarget(BehaviorExternalInterface& behaviorExternalInterface, s32& bestTarget, bool matchAnyPose = false) const;
  ...
  void RobotReactedToId(BehaviorExternalInterface& behaviorExternalInterface, s32 id);
  
  // handle delocalized message
  virtual void AlwaysHandleInternal(const EngineToGameEvent& event, BehaviorExternalInterface& behaviorExternalInterface) override final;
  virtual void AlwaysHandlePoseBasedInternal(const EngineToGameEvent& event, BehaviorExternalInterface& behaviorExternalInterface) {};
