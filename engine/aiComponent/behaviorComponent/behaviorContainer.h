...
private:
  ...
  // This is the generated function that will get auto-generated by the build
  ICozmoBehaviorPtr CreateBehavior_generated(BehaviorClass behaviorType, const Json::Value& config) const;
