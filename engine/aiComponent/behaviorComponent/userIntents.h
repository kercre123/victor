 ...
 * Created: 2018 feb 12
 *
 * Description: This file provides a set of wrappers around the CLAD types and
 *methods in userIntent.h. In almost all cases, these wrappers should be used
 *instead of clad-generated code to avoid very slow incremental builds. If you
 *directly use the CLAD enums, even in a .cpp file, that file will need to be
 *re-built every time a UserIntent type is added
 *
