...
ICozmoBehaviorPtr BehaviorFactory::CreateBehavior(const Json::Value& config)
{
  ...
  switch (behaviorType)
  {
    ...
    case BehaviorClass::BoxDemoDescribeScene:
    {
      newBehavior = ICozmoBehaviorPtr(new BehaviorBoxDemoDescribeScene(config));
      break;
    }
    ...
    case BehaviorClass::BoxDemoOpenStream:
    {
      newBehavior = ICozmoBehaviorPtr(new BehaviorBoxDemoOpenStream(config));
      break;
    }
    ...
    case BehaviorClass::ShowText:
    {
      newBehavior = ICozmoBehaviorPtr(new BehaviorShowText(config));
      break;
    }
