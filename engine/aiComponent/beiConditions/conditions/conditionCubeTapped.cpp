...
ConditionCubeTapped::ConditionCubeTapped(const Json::Value& config)
    : IBEICondition(config), _tapInfo({ObjectID(), 0.0f}) {
  _params.maxTapResponseTime =
      config.get(kKeyMaxResponseTime, kCubeTapDefaultResponseTime).asFloat();
}
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void ConditionCubeTapped::InitInternal(
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
bool ConditionCubeTapped::AreConditionsMetInternal(
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void ConditionCubeTapped::HandleEvent(
