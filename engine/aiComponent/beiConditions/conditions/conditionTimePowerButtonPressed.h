...
class ConditionTimePowerButtonPressed : public IBEICondition {
 public:
  ...
  ConditionTimePowerButtonPressed(const TimeStamp_t minTimePressed_ms,
...
#endif  // endif
        // __Cozmo_Basestation_BehaviorSystem_WantsToRunStrategies_ConditionTimePowerButtonPressed_H__
