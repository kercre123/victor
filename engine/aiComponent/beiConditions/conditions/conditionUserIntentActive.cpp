 ...
 * Created: 2018 May 16
 *
 * Description: Condition to check if there is an active intent that matches one
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
Json::Value ConditionUserIntentActive::GenerateConfig(
    const Json::Value& config) {
  Json::Value ret;

  ret[kList] = config;
  ret[kConditionTypeKey] =
      BEIConditionTypeToString(BEIConditionType::UserIntentActive);
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
ConditionUserIntentActive::ConditionUserIntentActive(
