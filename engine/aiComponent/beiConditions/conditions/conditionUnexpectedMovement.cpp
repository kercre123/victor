...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
ConditionUnexpectedMovement::ConditionUnexpectedMovement(
    const Json::Value& config)
    : IBEICondition(config) {}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
bool ConditionUnexpectedMovement::AreConditionsMetInternal(
    BehaviorExternalInterface& behaviorExternalInterface) const {
  return behaviorExternalInterface.GetMovementComponent()
      .IsUnexpectedMovementDetected();
}
