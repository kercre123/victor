...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
ConditionRobotTouchGesture::ConditionRobotTouchGesture(const Json::Value& config)
: IBEICondition(config)
{
  {
    const auto& touchGestureStr = JsonTools::ParseString(config,
                                                        kTouchGestureKey,
                                                        "ConditionRobotTouchGesture.ConfigError.NeedLevel");
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool ConditionRobotTouchGesture::AreConditionsMetInternal(BehaviorExternalInterface& behaviorExternalInterface) const
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool ConditionRobotTouchGesture::IsReceivingTouchGesture(BehaviorExternalInterface& behaviorExternalInterface) const
{
