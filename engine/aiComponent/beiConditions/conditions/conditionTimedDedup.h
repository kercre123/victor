 ...
 * This makes it easy to toggle states based on conditions without worrying
 *about throttling back and forth on a per-tick basis
 *
...
class ConditionTimedDedup : public IBEICondition {
 ...
 private:
  ...
  mutable struct { EngineTimeStamp_t nextTimeValid_ms = 0; } _lifetimeParams;
};
