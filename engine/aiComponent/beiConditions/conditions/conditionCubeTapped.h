 ...
 *
 *  Description
 *  + BEI Condition that listens for cube tap events within a specified response
 *time
 *
 **********************************************************************************************************************/
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - -
class ConditionCubeTapped : public IBEICondition,
 ...
 private:
  ...
  void HandleObjectTapped(BehaviorExternalInterface& bei,
  ...
  struct ConfigParams {
    float maxTapResponseTime;  // if a cube has been tapped within the last
                               // maxTapResponseTime seconds
  };
