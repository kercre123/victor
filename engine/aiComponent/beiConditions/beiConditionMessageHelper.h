...
class BEIConditionMessageHelper {
 public:
  // create this component which will call the callbacks on the given handler.
  // In most cases, users will pass in `this` as the handler
  BEIConditionMessageHelper(IBEIConditionEventHandler* handler,
