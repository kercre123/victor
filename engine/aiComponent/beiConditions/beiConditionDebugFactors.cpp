 ...
 * Created: May 18 2018
 *
 * Description: Helps with aggregating factors that influence the
 *AreConditionsMet() method of IBEIConditions
 *
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
BEIConditionDebugFactors::Data::Data(int val) : type(intType), asInt(val) {}
BEIConditionDebugFactors::Data::Data(bool val) : type(boolType), asBool(val) {}
BEIConditionDebugFactors::Data::Data(float val)
    : type(floatType), asFloat(val) {}
...
// - - - - - - - - - - - - - - - - - - - -
BEIConditionDebugFactors::Data::Data(
    const BEIConditionDebugFactors::Data& other) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
BEIConditionDebugFactors::Data& BEIConditionDebugFactors::Data::operator=(
    const BEIConditionDebugFactors::Data& other) {
  if (other.type == stringType) {
    new (&asString) std::string(other.asString);
  } else if (other.type == intType) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void BEIConditionDebugFactors::AddChild(const std::string& name,
                                        IBEIConditionPtr child) {
