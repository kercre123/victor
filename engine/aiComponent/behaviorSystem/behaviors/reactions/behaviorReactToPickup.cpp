...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool BehaviorReactToPickup::IsRunnableInternal(BehaviorExternalInterface& behaviorExternalInterface) const
{
  return true;
}
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
IBehavior::Status BehaviorReactToPickup::UpdateInternal(BehaviorExternalInterface& behaviorExternalInterface)
{
