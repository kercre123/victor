...
static const char* kBehaviorTestName = "Behavior factory test";
  ...
  void BehaviorFactoryTest::InitBehavior(BehaviorExternalInterface& behaviorExternalInterface)
  {
    ...
    if(ENABLE_FACTORY_TEST && RUNNING_FROM_WEBOTS)
    {
      ...
      _robot->GetExternalInterface()->BroadcastToEngine<ExternalInterface::BlockPoolEnabledMessage>(0, false);
    }
...
//                      }
  ...
  void BehaviorFactoryTest::OnBehaviorDeactivated(BehaviorExternalInterface& behaviorExternalInterface)
  {
