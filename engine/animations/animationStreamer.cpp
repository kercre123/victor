...
#include "engine/animations/trackLayerManagers/faceLayerManager.h"
...
#include "engine/utils/hasSettableParameters_impl.h"
  ...
  Result AnimationStreamer::InitStream(Animation* anim, Tag withTag)
  {
    ...
    if(lastResult == RESULT_OK)
    {
      ...
      if(!_sendBuffer.empty()) {
        PRINT_NAMED_INFO("Animation.Init.SendBufferNotEmpty",
...
#   endif
  ...
  Result AnimationStreamer::StreamLayers(Robot& robot)
  {
    Result lastResult = RESULT_OK;
