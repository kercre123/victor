...
class StaticMoodData {
 public:
  ...
  void SetDefaultRepetitionPenalty(const Util::GraphEvaluator2d& newGraph) {
    _defaultRepetitionPenalty = newGraph;
  }
  const Util::GraphEvaluator2d& GetDefaultRepetitionPenalty() const {
    return _defaultRepetitionPenalty;
  }

  const EmotionEventMapper& GetEmotionEventMapper() const {
    return _emotionEventMapper;
  }
  ...
  const EmotionValueRangeMap& GetEmotionValueRangeMap() const {
    return _emotionValueRangeMap;
  }
