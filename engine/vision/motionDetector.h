...
private:
  ...
  // that specific area.
  Result DetectPeripheralMotion(Vision::Image &ratioImage, DebugImageList <Anki::Vision::ImageRGB> &debugImageRGBs,
                                ExternalInterface::RobotObservedMotion &msg, f32 scaleMultiplier, bool &motionDetected);
