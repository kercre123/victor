...
//#define START_BLOCK_DEFINITION(__NAME__, __SIZE__, __COLOR__)
//__NAME__##_BLOCK_TYPE,
#define START_BLOCK_DEFINITION(__NAME__, __SIZE__, __COLOR__) \
  static const Type __NAME__;
#define ADD_FACE_CODE(__WHICHFACE__, __SIZE__, __CODE__, __DOCK_ORIENTATIONS__)
#define END_BLOCK_DEFINITION
...
//__NAME__##_BLOCK_TYPE,
#define START_BLOCK_DEFINITION(__NAME__, __SIZE__, __COLOR__) \
  const Block::Type Block::Type::__NAME__(QUOTE(__NAME__));
#define ADD_FACE_CODE(__WHICHFACE__, __SIZE__, __CODE__, __DOCK_ORIENTATIONS__)
#define END_BLOCK_DEFINITION
...
#define START_BLOCK_DEFINITION(__NAME__, __SIZE__, __COLOR__)           \
  {                                                                     \
    Block::Type::Block_##__NAME__, {                                    \
      .name = QUOTE(__NAME__), .color = ::Anki::NamedColors::__COLOR__, \
      .size = {UNWRAP __SIZE__}, .faces = {
#define ADD_FACE_CODE(__WHICHFACE__, __SIZE__, __CODE__, \
                      __DOCK_ORIENTATIONS__)             \
...
#define START_BLOCK_DEFINITION(__NAME__, __SIZE__, __COLOR__) \
  {QUOTE(__NAME__), Block::Type::__NAME__},
#define ADD_FACE_CODE(__WHICHFACE__, __SIZE__, __CODE__, __DOCK_ORIENTATIONS__)
#define END_BLOCK_DEFINITION
