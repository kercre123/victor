 ...
 * Created: 4/4/2016
 *
 * Description: Utility wrapper around needed archive file creation
 * functionality.
 *
...
class ArchiveUtil {
 public:
  // Static methods for creating and expanding archive files. Only tar.gz files
  // supported
  ...
  // Removes an initial part of a filename (does nothing if the filename has no
  // path separators)
  static std::string RemoveFilenameBase(const std::string& filenameBase,
