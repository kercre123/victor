...
class DevLoggingSystem : Util::noncopyable {
 public:
  ...
  // These methods provide a minimal interface for configuration and use of the
  // engine's internal log system.
  ANKI_VISIBLE static void CreateInstance(
      const std::string& loggingBaseDirectory, const std::string& appRunId);
  ...
  static const DevLoggingClock::time_point& GetAppRunStartTime() {
    return kAppRunStartTime;
  }
  ...
  const std::string& GetDevLoggingBaseDirectory() const {
    return _devLoggingBaseDirectory;
  }
 ...
 private:
  ...
  void DeleteFiles(const std::string& baseDirectory,
                   const std::string& extension) const;
  static void CopyFile(const std::string& sourceFile,
                       const std::string& destination);
  void ArchiveDirectories(
  ...
  void CreateAppRunFile(const std::string& appRunTimeString,
                        const std::string& appRunId);
};
