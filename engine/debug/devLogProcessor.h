...
class DevLogProcessor : Util::noncopyable {
 public:
  ...
  // return the best estimate of the last time in this log. Note that this is
  // just an estimate, the log may be longer than this
  uint32_t GetFinalTime_ms() const;

  // return the number of milliseconds that the caller should advance to get
  // another print message. Note that this is a rough, it may undercount and
  // print nothing, or there may be multiple prints within the same timestamp
