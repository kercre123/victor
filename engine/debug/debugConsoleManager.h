 ...
 * Created: 11/17/15
 *
 * Description: A singleton wrapper around the console so that it can use CLAD
 *at the game level instead of util. If you need to specify robotID for a
 *console command it needs to be a function.
 *
