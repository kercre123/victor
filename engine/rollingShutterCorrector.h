...
class RollingShutterCorrector {
 ...
 private:
  ...
  // Returns false if unable to calculate shifts due to not having relevant gyro
  // data
  bool ComputePixelShiftsWithImageIMU(RobotTimeStamp_t t, Vec2f& shift,
                                      const VisionPoseData& poseData,
                                      const VisionPoseData& prevPoseData,
                                      const f32 frac);

  // Vector of vectors of varying pixel shift amounts based on gyro rates and
