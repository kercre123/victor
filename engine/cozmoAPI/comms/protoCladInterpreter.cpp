...
void ProtoCladInterpreter::ProtoDriveWheelsRequestToClad(
  ...
  drive_wheels.lwheel_speed_mmps =
      proto_message.drive_wheels_request().left_wheel_mmps();
  drive_wheels.rwheel_speed_mmps =
      proto_message.drive_wheels_request().right_wheel_mmps();
  drive_wheels.lwheel_accel_mmps2 =
      proto_message.drive_wheels_request().right_wheel_mmps2();
  drive_wheels.rwheel_accel_mmps2 =
      proto_message.drive_wheels_request().left_wheel_mmps2();
...
void ProtoCladInterpreter::ProtoPlayAnimationRequestToClad(
  ...
  play_animation.animationName =
      proto_message.play_animation_request().animation().name();
  play_animation.ignoreBodyTrack =
      proto_message.play_animation_request().ignore_body_track();
  play_animation.ignoreHeadTrack =
      proto_message.play_animation_request().ignore_head_track();
  play_animation.ignoreLiftTrack =
      proto_message.play_animation_request().ignore_lift_track();
...
void ProtoCladInterpreter::ProtoCancelActionByIdTagRequestToClad(
  ...
  cancel_action_by_id_tag.idTag =
      proto_message.cancel_action_by_id_tag_request().id_tag();
...
void ProtoCladInterpreter::ProtoListAnimationsRequestToClad(
    const external_interface::GatewayWrapper& proto_message,
    ExternalInterface::MessageGameToEngine& clad_message) {
  Anki::Vector::ExternalInterface::RequestAvailableAnimations
      request_available_animations;
...
void ProtoCladInterpreter::ProtoPlayAnimationTriggerRequestToClad(
  ...
  play_animation_trigger.trigger =
      AnimationTriggerFromString(proto_message.play_animation_trigger_request()
                                     .animation_trigger()
                                     .name());
  play_animation_trigger.useLiftSafe =
      proto_message.play_animation_trigger_request().use_lift_safe();
  play_animation_trigger.ignoreBodyTrack =
      proto_message.play_animation_trigger_request().ignore_body_track();
  play_animation_trigger.ignoreHeadTrack =
      proto_message.play_animation_trigger_request().ignore_head_track();
  play_animation_trigger.ignoreLiftTrack =
      proto_message.play_animation_trigger_request().ignore_lift_track();
  play_animation_trigger.numLoops =
      proto_message.play_animation_trigger_request().loops();
...
void ProtoCladInterpreter::ProtoSetFaceToEnrollRequestToClad(
  ...
  set_face_to_enroll.observedID =
      proto_message.set_face_to_enroll_request().observed_id();
  set_face_to_enroll.saveID =
      proto_message.set_face_to_enroll_request().save_id();
  set_face_to_enroll.saveToRobot =
      proto_message.set_face_to_enroll_request().save_to_robot();
  set_face_to_enroll.sayName =
      proto_message.set_face_to_enroll_request().say_name();
  set_face_to_enroll.useMusic =
      proto_message.set_face_to_enroll_request().use_music();
...
void ProtoCladInterpreter::CladDriveWheelsToProto(
  ...
  external_interface::DriveWheelsResponse* drive_wheels_response =
      new external_interface::DriveWheelsResponse;
...
void ProtoCladInterpreter::CladPlayAnimationToProto(
  ...
  external_interface::PlayAnimationResponse* play_animation_response =
      new external_interface::PlayAnimationResponse;
...
void ProtoCladInterpreter::CladCancelActionByIdTagToProto(
    const ExternalInterface::MessageGameToEngine& clad_message,
    external_interface::GatewayWrapper& proto_message) {
  external_interface::CancelActionByIdTagResponse*
      cancel_action_by_id_tag_response =
          new external_interface::CancelActionByIdTagResponse;
  proto_message =
      ExternalMessageRouter::WrapResponse(cancel_action_by_id_tag_response);
}
...
void ProtoCladInterpreter::CladStopAllMotorsToProto(
    const ExternalInterface::MessageGameToEngine& clad_message,
    external_interface::GatewayWrapper& proto_message) {
  external_interface::StopAllMotorsResponse* stop_all_motors_response =
      new external_interface::StopAllMotorsResponse;
...
void ProtoCladInterpreter::CladEndOfMessageToProto(
  ...
  end_of_list_animations_response->add_animation_names()->set_name(
      "EndOfListAnimationsResponses");
  proto_message =
      ExternalMessageRouter::WrapResponse(end_of_list_animations_response);
}

void ProtoCladInterpreter::CladPerRobotSettingsToProto(
    const ExternalInterface::MessageEngineToGame& clad_message,
    external_interface::GatewayWrapper& proto_message) {
  external_interface::CameraConfigResponse* camera_config_response =
      new external_interface::CameraConfigResponse;
  camera_config_response->set_focal_length_x(
      clad_message.Get_PerRobotSettings().cameraConfig.focalLengthX);
  camera_config_response->set_focal_length_y(
      clad_message.Get_PerRobotSettings().cameraConfig.focalLengthY);
  camera_config_response->set_center_x(
      clad_message.Get_PerRobotSettings().cameraConfig.centerX);
  camera_config_response->set_center_y(
      clad_message.Get_PerRobotSettings().cameraConfig.centerY);
  camera_config_response->set_fov_x(
      clad_message.Get_PerRobotSettings()
          .cameraConfig.fovX);  // Full FOV in degrees
  camera_config_response->set_fov_y(
      clad_message.Get_PerRobotSettings()
          .cameraConfig.fovY);  // Full FOV in degrees
  camera_config_response->set_min_camera_exposure_time_ms(
      clad_message.Get_PerRobotSettings()
          .cameraConfig.minCameraExposureTime_ms);
  camera_config_response->set_max_camera_exposure_time_ms(
      clad_message.Get_PerRobotSettings()
          .cameraConfig.maxCameraExposureTime_ms);
  camera_config_response->set_min_camera_gain(
      clad_message.Get_PerRobotSettings().cameraConfig.minCameraGain);
  camera_config_response->set_max_camera_gain(
      clad_message.Get_PerRobotSettings().cameraConfig.maxCameraGain);
...
void ProtoCladInterpreter::CladCurrentCameraParamsToProto(
    const ExternalInterface::MessageEngineToGame& clad_message,
    external_interface::GatewayWrapper& proto_message) {
  external_interface::CameraSettingsUpdate* current_camera_settings =
      new external_interface::CameraSettingsUpdate;
  current_camera_settings->set_gain(
      clad_message.Get_CurrentCameraParams().cameraGain);
  current_camera_settings->set_exposure_ms(
      clad_message.Get_CurrentCameraParams().exposure_ms);
  current_camera_settings->set_auto_exposure_enabled(
      clad_message.Get_CurrentCameraParams().autoExposureEnabled);
