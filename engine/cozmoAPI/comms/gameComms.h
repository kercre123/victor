...
class GameComms : public Comms::IComms {
 public:
  // Default constructor
  GameComms(int deviceID, int serverListenPort, const char* advertisementRegIP_,
 ...
 private:
  ...
  // 'Queue' of received messages from all connected user devices with their
  // received times.
  ...
  static const size_t MAX_RECV_BUF_SIZE =
      1920000;  // [TODO] 1.9MB seems excessive?
