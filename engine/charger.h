...
class Charger : public ActionableObject {
 public:
  ...
  constexpr static const f32 kLength =
      kSlopeLength + kPlatformLength + kWallWidth;
  constexpr static const f32 kMarkerHeight = 46.f;
  constexpr static const f32 kMarkerWidth = 46.f;
  constexpr static const f32 kMarkerZPosition =
      48.5f;  // Middle of marker above ground
  constexpr static const f32 kPreAscentDistance =
      100.f;  // for ascending from bottom
  constexpr static const f32 kRobotToChargerDistWhenDocked =
      30.f;  // Distance from front of charger to robot origin when docked
  constexpr static const f32 kRobotToChargerDistPostRollOff =
      80.f;  // Distance from front of charger to robot origin after just having
             // rolled off the charger
