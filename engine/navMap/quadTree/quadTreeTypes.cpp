...
{
  switch (dir) {
    case QuadTreeTypes::EDirection::North:   { return Vec2f{ 1.0f,  0.0f}; };
    case QuadTreeTypes::EDirection::East:    { return Vec2f{ 0.0f, -1.0f}; };
    case QuadTreeTypes::EDirection::South:   { return Vec2f{-1.0f,  0.0f}; };
    case QuadTreeTypes::EDirection::West:    { return Vec2f{ 0.0f,  1.0f}; };
  }
