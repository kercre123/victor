...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
MemoryMapData_ObservableObject::MemoryMapData_ObservableObject(
    const ObservableObject& o, const Poly2f& p, RobotTimeStamp_t t)
...
bool MemoryMapData_ObservableObject::Equals(const MemoryMapData* other) const {
  ...
  const MemoryMapData_ObservableObject* castPtr =
      static_cast<const MemoryMapData_ObservableObject*>(other);
...
MemoryMapData_ObservableObject::GetExternalContentType() const {
