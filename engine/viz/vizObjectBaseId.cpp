...
constexpr const uint32_t
    VizObjectBaseID[(int)VizObjectType::NUM_VIZ_OBJECT_TYPES + 1] = {
        0,                  // VIZ_OBJECT_ROBOT
...
// If this static_assert is hit, and additions have been made to VizObjectType
// enum then there are missing entries in the initializer list written above
// here
static_assert(VizObjectBaseID[(int)VizObjectType::NUM_VIZ_OBJECT_TYPES] ==
                  kLastValidObjectID,
              "The last valid object ID does not match expected");
