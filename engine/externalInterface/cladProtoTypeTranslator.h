 ...
 * Created: jun 18 2018
 *
 * Description: Guards and helpers make sure translation between clad and proto
 * enum types is safe, in case the underlying values or field numbers change.
 *
...
constexpr external_interface::OnboardingPhase ToProtoEnum(
    OnboardingPhase value) {
  return static_cast<external_interface::OnboardingPhase>(
      static_cast<std::underlying_type_t<OnboardingPhase>>(value));
}

constexpr OnboardingPhase ToCladEnum(
    external_interface::OnboardingPhase value) {
  return static_cast<OnboardingPhase>(
      static_cast<std::underlying_type_t<external_interface::OnboardingPhase>>(
          value));
}

constexpr external_interface::OnboardingPhaseState ToProtoEnum(
    OnboardingPhaseState value) {
  return static_cast<external_interface::OnboardingPhaseState>(
      static_cast<std::underlying_type_t<OnboardingPhaseState>>(value));
}

constexpr OnboardingPhaseState ToCladEnum(
    external_interface::OnboardingPhaseState value) {
  return static_cast<OnboardingPhaseState>(
      static_cast<
          std::underlying_type_t<external_interface::OnboardingPhaseState>>(
          value));
}

constexpr external_interface::OnboardingStages ToProtoEnum(
    OnboardingStages value) {
  return static_cast<external_interface::OnboardingStages>(
      static_cast<std::underlying_type_t<OnboardingStages>>(value));
}

constexpr external_interface::AttentionTransferReason ToProtoEnum(
    AttentionTransferReason value) {
  return static_cast<external_interface::AttentionTransferReason>(
      static_cast<std::underlying_type_t<AttentionTransferReason>>(value));
}

constexpr external_interface::FaceEnrollmentResult ToProtoEnum(
    FaceEnrollmentResult value) {
  return static_cast<external_interface::FaceEnrollmentResult>(
      static_cast<std::underlying_type_t<FaceEnrollmentResult>>(value));
}

constexpr external_interface::AlexaAuthState ToProtoEnum(AlexaAuthState value) {
  return static_cast<external_interface::AlexaAuthState>(
      static_cast<std::underlying_type_t<AlexaAuthState>>(value));
}

constexpr external_interface::UnexpectedMovementSide ToProtoEnum(
    UnexpectedMovementSide value) {
  return static_cast<external_interface::UnexpectedMovementSide>(
      static_cast<std::underlying_type_t<UnexpectedMovementSide>>(value));
}

constexpr external_interface::UnexpectedMovementType ToProtoEnum(
    UnexpectedMovementType value) {
  return static_cast<external_interface::UnexpectedMovementType>(
      static_cast<std::underlying_type_t<UnexpectedMovementType>>(value));
}

#define CLAD_PROTO_COMPARE_ASSERT(T, V)                        \
  static_assert(ToProtoEnum(T::V) == external_interface::T::V, \
                "Invalid cast " #T "::" #V)
#define CLAD_PROTO_COMPARE_ASSERT2(T, V, U)                    \
  static_assert(ToProtoEnum(T::V) == external_interface::T::U, \
                "Invalid cast " #T "::" #V " to " #T "::" #U)
...
CLAD_PROTO_COMPARE_ASSERT2(FaceEnrollmentResult, SawMultipleFaces,
                           SAW_MULTIPLE_FACES);
...
CLAD_PROTO_COMPARE_ASSERT2(FaceEnrollmentResult, NamedStorageFull,
                           NAMED_STORAGE_FULL);
CLAD_PROTO_COMPARE_ASSERT2(FaceEnrollmentResult, UnknownFailure,
                           UNKNOWN_FAILURE);

CLAD_PROTO_COMPARE_ASSERT2(AlexaAuthState, Invalid, ALEXA_AUTH_INVALID);
CLAD_PROTO_COMPARE_ASSERT2(AlexaAuthState, Uninitialized,
                           ALEXA_AUTH_UNINITIALIZED);
CLAD_PROTO_COMPARE_ASSERT2(AlexaAuthState, RequestingAuth,
                           ALEXA_AUTH_REQUESTING_AUTH);
CLAD_PROTO_COMPARE_ASSERT2(AlexaAuthState, WaitingForCode,
                           ALEXA_AUTH_WAITING_FOR_CODE);
