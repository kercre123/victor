...
LINK_COMPONENT_TYPE_TO_ENUM(AppCubeConnectionSubscriber, RobotComponentID,
                            AppCubeConnectionSubscriber)
LINK_COMPONENT_TYPE_TO_ENUM(ContextWrapper, RobotComponentID,
                            CozmoContextWrapper)
...
LINK_COMPONENT_TYPE_TO_ENUM(PublicStateBroadcaster, RobotComponentID,
                            PublicStateBroadcaster)
LINK_COMPONENT_TYPE_TO_ENUM(Audio::EngineRobotAudioClient, RobotComponentID,
                            EngineAudioClient)
LINK_COMPONENT_TYPE_TO_ENUM(PathComponent, RobotComponentID, PathPlanning)
LINK_COMPONENT_TYPE_TO_ENUM(DrivingAnimationHandler, RobotComponentID,
...
LINK_COMPONENT_TYPE_TO_ENUM(VisionScheduleMediator, RobotComponentID,
...
LINK_COMPONENT_TYPE_TO_ENUM(BackpackLightComponent, RobotComponentID,
                            BackpackLights)
...
LINK_COMPONENT_TYPE_TO_ENUM(CubeConnectionCoordinator, RobotComponentID,
                            CubeConnectionCoordinator)
LINK_COMPONENT_TYPE_TO_ENUM(CubeInteractionTracker, RobotComponentID,
                            CubeInteractionTracker)
LINK_COMPONENT_TYPE_TO_ENUM(RobotGyroDriftDetector, RobotComponentID,
                            GyroDriftDetector)
LINK_COMPONENT_TYPE_TO_ENUM(HabitatDetectorComponent, RobotComponentID,
                            HabitatDetector)
...
LINK_COMPONENT_TYPE_TO_ENUM(StimulationFaceDisplay, RobotComponentID,
                            StimulationFaceDisplay)
LINK_COMPONENT_TYPE_TO_ENUM(BlockTapFilterComponent, RobotComponentID,
                            BlockTapFilter)
LINK_COMPONENT_TYPE_TO_ENUM(RobotToEngineImplMessaging, RobotComponentID,
...
LINK_COMPONENT_TYPE_TO_ENUM(DataAccessorComponent, RobotComponentID,
                            DataAccessor)
LINK_COMPONENT_TYPE_TO_ENUM(BeatDetectorComponent, RobotComponentID,
                            BeatDetector)
LINK_COMPONENT_TYPE_TO_ENUM(TextToSpeechCoordinator, RobotComponentID,
                            TextToSpeechCoordinator)
LINK_COMPONENT_TYPE_TO_ENUM(SDKComponent, RobotComponentID, SDK)
LINK_COMPONENT_TYPE_TO_ENUM(PhotographyManager, RobotComponentID,
                            PhotographyManager)
LINK_COMPONENT_TYPE_TO_ENUM(SettingsCommManager, RobotComponentID,
                            SettingsCommManager)
LINK_COMPONENT_TYPE_TO_ENUM(SettingsManager, RobotComponentID, SettingsManager)
LINK_COMPONENT_TYPE_TO_ENUM(RobotHealthReporter, RobotComponentID,
                            RobotHealthReporter)
LINK_COMPONENT_TYPE_TO_ENUM(RobotStatsTracker, RobotComponentID,
                            RobotStatsTracker)
LINK_COMPONENT_TYPE_TO_ENUM(VariableSnapshotComponent, RobotComponentID,
                            VariableSnapshotComponent)
LINK_COMPONENT_TYPE_TO_ENUM(PowerStateManager, RobotComponentID,
                            PowerStateManager)
...
LINK_COMPONENT_TYPE_TO_ENUM(RobotExternalRequestComponent, RobotComponentID,
                            RobotExternalRequestComponent)
LINK_COMPONENT_TYPE_TO_ENUM(AccountSettingsManager, RobotComponentID,
                            AccountSettingsManager)
LINK_COMPONENT_TYPE_TO_ENUM(UserEntitlementsManager, RobotComponentID,
...
template <>
std::string GetEntityNameForEnumType<Vector::RobotComponentID>() {
  return "RobotComponents";
}

template <>
std::string GetComponentStringForID<Vector::RobotComponentID>(
    Vector::RobotComponentID enumID) {
// Handy macro tricks: Use #param to stringify macro parameters
#define CASE(id)                       \
  case Vector::RobotComponentID::id: { \
    return #id;                        \
  }
