...
public:
  ...
  void HandleFallingStarted(const AnkiEvent<RobotInterface::RobotToEngine>& message, Robot* const robot);
  void HandleFallingStopped(const AnkiEvent<RobotInterface::RobotToEngine>& message, Robot* const robot);
