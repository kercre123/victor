...
FullRobotPose::FullRobotPose()
    : IDependencyManagedComponent<RobotComponentID>(
          this, RobotComponentID::FullRobotPose),
      _neckPose(0.f, Y_AXIS_3D(),
                {NECK_JOINT_POSITION[0], NECK_JOINT_POSITION[1],
                 NECK_JOINT_POSITION[2]},
                _pose, "RobotNeck"),
      _headCamPose(
          kDefaultHeadCamRotation,
          {HEAD_CAM_POSITION[0], HEAD_CAM_POSITION[1], HEAD_CAM_POSITION[2]},
          _neckPose, "RobotHeadCam"),
      _liftBasePose(
          0.f, Y_AXIS_3D(),
          {LIFT_BASE_POSITION[0], LIFT_BASE_POSITION[1], LIFT_BASE_POSITION[2]},
          _pose, "RobotLiftBase"),
