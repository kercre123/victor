...
class CozmoContext : private Util::noncopyable {
 public:
  CozmoContext(Util::Data::DataPlatform* dataPlatform,
  ...
  // Returns true if the current thread is the "main thread" used for engine
  // updates. Requires SetEngineThread (above) to have been called.
