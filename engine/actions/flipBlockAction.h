...
class DriveAndFlipBlockAction : public IDriveToInteractWithObject {
 public:
  ...
  static ActionResult GetPossiblePoses(
...
class FlipBlockAction : public IAction {
 ...
 private:
  ...
  // Note: any custom motion profile from the path component will be ignored for
  // this speed, since it is hand-tuned to work with this action
