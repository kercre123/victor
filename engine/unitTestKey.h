 ...
 * Created: feb 23 2018
 *
 * Description: A class constructable only by specific unit tests. A shipping
 *class can expose a member function with UnitTestKey as a parameter, and since
 *only unit tests can construct it, only unit tests can call it
 *
