...
class RobotConnectionData : Util::noncopyable,
                            public Anki::Util::INetTransportDataReceiver {
 public:
  enum class State { Disconnected, Waiting, Connected };
  ...
  void PushArrivedMessage(const uint8_t* buffer, uint32_t numBytes,
  ...
  virtual void ReceiveData(
      ...
      const Util::TransportAddress& sourceAddress) override;
