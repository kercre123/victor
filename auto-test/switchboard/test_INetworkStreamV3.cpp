...
Test_INetworkStreamV3::Test_INetworkStreamV3()
  ...
  _cladHandler->OnReceiveRtsMessage().SubscribeForever(std::bind(
      &Test_INetworkStreamV3::ReceiveMessage, this, std::placeholders::_1));
}
...
void Test_INetworkStreamV3::ReceiveMessage(
    ...
    switch (msg.GetTag()) {
      ...
      case Anki::Vector::ExternalComms::RtsConnection_3Tag::RtsNonceMessage: {
        ...
        SendRtsMessage<Vector::ExternalComms::RtsAck>(
            (uint8_t)Anki::Vector::ExternalComms::RtsConnection_3Tag::
                RtsNonceMessage);
...
//
//
int Test_INetworkStreamV3::ClientEncrypt(uint8_t* buffer, int length,
                                         uint8_t* output,
...
int Test_INetworkStreamV3::ClientDecrypt(uint8_t* buffer, int length,
                                         uint8_t* output,
                                         uint64_t* outputLength) {
  // decrypt message
