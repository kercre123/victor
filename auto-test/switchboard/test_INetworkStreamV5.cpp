...
Test_INetworkStreamV5::Test_INetworkStreamV5()
  ...
  _cladHandler->OnReceiveRtsMessage().SubscribeForever(std::bind(
      &Test_INetworkStreamV5::ReceiveMessage, this, std::placeholders::_1));
}
...
void Test_INetworkStreamV5::ReceiveMessage(
    ...
    switch (msg.GetTag()) {
      ...
      case Anki::Vector::ExternalComms::RtsConnection_5Tag::RtsNonceMessage: {
        ...
        SendRtsMessage<Vector::ExternalComms::RtsAck>(
            (uint8_t)Anki::Vector::ExternalComms::RtsConnection_5Tag::
                RtsNonceMessage);
...
//
//
int Test_INetworkStreamV5::ClientEncrypt(uint8_t* buffer, int length,
                                         uint8_t* output,
...
int Test_INetworkStreamV5::ClientDecrypt(uint8_t* buffer, int length,
                                         uint8_t* output,
                                         uint64_t* outputLength) {
  // decrypt message
