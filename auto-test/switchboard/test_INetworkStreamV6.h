...
class Test_INetworkStreamV6 : public INetworkStream {
public:
  explicit Test_INetworkStreamV6();
  virtual ~Test_INetworkStreamV6();
...
private:
  MessageState _state;
  CladHandlerV6* _cladHandler;
  bool _handShake;
  bool _connected;
  std::queue<Anki::Vector::ExternalComms::RtsConnection_6> _queue;
  ...
  void ReceiveMessage(const Anki::Vector::ExternalComms::RtsConnection_6& msg);
};
