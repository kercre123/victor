 ...
 *
 * The GAP Manager module is responsible for providing an API to the application
 *in order to manage all non connected stuff such as configuring device to go in
 *desired mode (discoverable, connectable, etc.) and perform required actions
 *(scanning, connection, etc.). GAP Manager is also responsible of managing GAP
 *Controller state according to corresponding BLE connection states.
 *
 * @{
 ****************************************************************************************
 */
 ...
 ****************************************************************************************
 */
void gapm_send_error_evt(uint8_t operation, const ke_task_id_t requester,
                         uint8_t status);

#if (BLE_CENTRAL || BLE_PERIPHERAL)
/**
 ****************************************************************************************
 * @brief A connection has been created, initialize host stack to be ready for
 *connection.
 *
