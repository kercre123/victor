...
/// Maximum number of Cycling Speed and Cadence Profile Sensor role task
/// instances
...
struct cscps_create_db_req {
  /**
   * CSC Feature Value - Not supposed to be modified during the lifetime of the
   * device This value is used to decide if the SC Control Point Characteristic
   * is part of the Cycling Speed and Cadence service.
   */
   ...
   * csc_feature parameter, the characteristic will be added (mandatory).
   */
