...
/// Message structure used to inform APP that a profile client role has been
/// disabled
...
/// Message structure used to inform APP that an error has occured in the
/// profile server role task
