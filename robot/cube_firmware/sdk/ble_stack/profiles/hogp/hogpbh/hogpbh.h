...
/// HOGPBH HID Over GATT Profile Client Role
...
#define HOGPBH_FOUND_CHAR(p_hogpbh_env, char_code) \
  (hogpbh_env->hids[hogpbh_env->last_svc_inst_req] \
       .chars[char_code]                           \
...
enum {
  ...
  HOGPBH_RD_WR_HIDS_BOOT_KB_IN_REPORT_CFG =
      (HOGPBH_DESC_MASK | HOGPBH_DESC_BOOT_KB_IN_REPORT_CFG),
  /// Read/Write HIDS Boot Mouse Input Report Client Cfg. Desc
  HOGPBH_RD_WR_HIDS_BOOT_MOUSE_IN_REPORT_CFG =
      (HOGPBH_DESC_MASK | HOGPBH_DESC_BOOT_MOUSE_IN_REPORT_CFG),
};
 ...
 ****************************************************************************************
 */
void hogpbh_enable_cfm_send(struct hogpbh_env_tag *hogpbh_env,
 ...
 ****************************************************************************************
 */
void hogpbh_char_req_rsp_send(struct hogpbh_env_tag *hogpbh_env,
                              ke_msg_id_t msg_id, uint8_t status);
