 ...
 *
 * The HOGPRHTASK is responsible for handling the messages coming in and out of
 *the
...
/// Parameters of the @ref HOGPRH_WR_CHAR_RSP and @ref HOGPRH_RD_CHAR_ERR_RSP
/// message
...
struct hogprh_cfg_ntf_req {
  ...
  uint16_t ntf_cfg;
  /// Report instance (The Report Char. is the only one for which we can receive
  /// notifications)
  uint8_t report_nb;
  /// HIDS instance
  uint8_t hids_nb;
...
/// Parameters of the @ref HOGPRH_REPORT_WR_REQ message - Need to dynamically
/// allocated
