 ...
 *
 * The HOGP module is the responsible block for implementing the HID Over GATT
 *Profile functionalities in the BLE Host.
 *
 * The HID Over GATT Profile defines the functionality required to allow HID
 *reports and HID data to be exchanged between a HID Device and a HID Host
 *****************************************************************************************
 */
