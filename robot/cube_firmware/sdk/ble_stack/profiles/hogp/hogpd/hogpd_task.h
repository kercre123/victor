 ...
 *
 * The HOGPD_TASK is responsible for handling the messages coming in and out of
 *the
...
enum {
  ...
  /// Inform Device APP that a Client Characteristic Configuration has been
  /// modified
  HOGPD_NTF_CFG_IND,
  /// Inform Device APP that Protocol Mode Characteristic Value has been written
  /// on Device
  ...
  /// Inform APP that HID Control Point Characteristic Value has been written on
  /// Device
  HOGPD_CTNL_PT_IND,
...
/// Parameters of the @ref HOGPD_SET_REPORT_MAP_REQ - Need to be dynamically
/// allocated
...
/// Parameters of the @ref HOGPD_REPORT_UPD_REQ and @ref HOGPD_REPORT_IND - Need
...
/// Parameters of the @ref HOGPD_BOOT_REPORT_UPD_REQ and @ref
/// HOGPD_BOOT_KB_IN_IND - Need to be dynamically allocated
