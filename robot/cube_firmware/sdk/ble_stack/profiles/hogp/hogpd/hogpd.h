...
enum {
  ...
  HOGPD_BOOT_MOUSE_IN_REPORT_CFG =
      HOGPD_BOOT_MOUSE_IN_REPORT_CHAR | HOGPD_DESC_MASK,
...
/**
 ****************************************************************************************
 * @brief Initialize a Client Characteristic Configuration Descriptor value in
 *the database
 ****************************************************************************************
 */
 ...
 ****************************************************************************************
 */
void hogpd_ntf_cfm_send(uint8_t status, uint8_t char_code, uint8_t hids_nb,
                        uint8_t report_nb);
 ...
 ****************************************************************************************
 */
uint8_t hogpd_ntf_cfg_ind_send(uint16_t ntf_cfg, uint16_t handle,
                               uint8_t cfg_code, uint8_t hids_nb,
                               uint8_t report_nb);

/**
 ****************************************************************************************
 * @brief Retrieve all the attribute information using the handle of this
 *attribute
 *
 ...
 ****************************************************************************************
 */
uint8_t hogpd_get_att(uint16_t handle, uint8_t *char_code, uint8_t *hids_nb,
                      uint8_t *report_nb);
