 ...
 *
 * The FINDLTASK is responsible for handling the API messages coming from the
 *application or internal tasks.
 *
 * @{
 ****************************************************************************************
 */
...
enum {
  ...
  /// Enable confirm message, containing IAS attribute details if discovery
  /// conneciton type
  FINDL_ENABLE_CFM,
