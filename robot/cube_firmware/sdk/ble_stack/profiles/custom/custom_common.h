 ...
 * @param[in] bool  indicates whether the CFG is Notification (true) or
 *Indication (false)
...
int check_client_char_cfg(bool is_notification,
                          struct gattc_write_cmd_ind const *param);

/**
 ****************************************************************************************
 * @brief  Find the handle of the Characteristic Value having as input the
 *Client Characteristic CFG handle
...
/**
 ****************************************************************************************
 * @brief  Find the handle of Client Characteristic CFG handle having as input
