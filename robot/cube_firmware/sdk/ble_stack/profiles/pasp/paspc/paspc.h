...
/// PASPC Phone Alert Status Profile Client role
...
/// Internal codes for reading/writing a PAS characteristic with one single
/// request
enum {
 ...
 * descriptors for the Phone Alert Status Service
 */
