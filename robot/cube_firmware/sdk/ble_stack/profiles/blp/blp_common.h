 ...
 *
 * The BLP module is the responsible block for implementing the Blood Pressure
 *Profile functionalities in the BLE Host.
 *
 * The Blood Pressure Profile defines the functionality required in a device
 *that allows the user (Collector device) to configure and recover blood
 *pressure measurements from a blood pressure device.
 *****************************************************************************************
 */
...
/// BLPC codes for the 2 possible client configuration characteristic
/// descriptors determination in BPS
enum {
