 ...
 *
 * The BLPC is responsible for providing Blood Pressure Profile Collector
 *functionalities to upper layer module or application. The device using this
 *profile takes the role of Blood Pressure Profile Collector.
 *
 ...
 *blood pressure measurement in a way suitable to the user application.
 *
 * @{
 ****************************************************************************************
 */
...
/// Internal codes for reading a BPS or DIS characteristic with one single
/// request
enum {
 ...
 ****************************************************************************************
 */
void blpc_enable_cfm_send(struct blpc_env_tag *blpc_env,
 ...
 *
 * @param[out] pmeas_val  Pointer to Blood pressure measurement structure
 *destination
 * @param[in] packed_bp   Pointer of the packed data of Blood Pressure
