 ...
 ****************************************************************************************
 */
void bcsc_enable_cfm_send(struct bcsc_env_tag *bcsc_env,
                          struct prf_con_info *con_info, uint8_t status);

/**
 ****************************************************************************************
 * @brief Unpack Body Composition measurement data into a comprehensive
 *structure.
 ...
 * @param[in] packed_bp     Pointer of the packed data of Body Composition
 *Measurement information.
 ****************************************************************************************
 */
void bcsc_unpack_meas_value(bcs_meas_t *pmeas_val, uint16_t *pmeas_flags,
                            uint8_t *packed_bp);
