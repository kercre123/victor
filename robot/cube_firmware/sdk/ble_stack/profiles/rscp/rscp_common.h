 ...
 *
 * The Running Speed and Cadence profile enables a Collector device to connect
 *and interact with a Running Speed and Cadence Sensor for use in sports and
 *fitness applications.
 *
 * This file contains all definitions that are common for the server and the
 *client parts of the profile.
 *****************************************************************************************
 */
