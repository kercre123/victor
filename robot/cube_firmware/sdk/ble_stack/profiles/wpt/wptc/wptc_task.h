...
enum {
  ...
  /// OFFLINE (Without dynamic discovering characteristic) profile enabling.
  /// This should be used during registration phase This request uses a
  /// wptc_offline_enable_req structure
