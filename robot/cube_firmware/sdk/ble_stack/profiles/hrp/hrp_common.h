 ...
 *
 * The HRP module is the responsible block for implementing the Heart Rate
 *Profile functionalities in the BLE Host.
 *
 * The Heart Rate Profile defines the functionality required in a device that
 *allows the user (Collector device) to configure and recover Heart Rate
 *measurements from a Heart Rate device.
 *****************************************************************************************
 */
...
/// HRS codes for the 2 possible client configuration characteristic descriptors
/// determination
enum {
