 ...
 *
 * The HRPSTASK is responsible for handling the messages coming in and out of
 *the
...
enum {
  ...
  HRPS_MEAS_SEND_REQ,
  /// Send Heart Rate measurement value confirm to APP so stable values can be
  /// erased if correctly sent.
  HRPS_MEAS_SEND_CFM,
