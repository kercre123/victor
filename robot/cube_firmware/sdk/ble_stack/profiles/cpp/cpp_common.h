 ...
 *
 * The Cycling Power Profile is used to enable a collector device in order to
 *obtain data from a Cycling Power Sensor (CP Sensor) that exposes the Cycling
 *Power Service in sports and fitness applications.
 *
