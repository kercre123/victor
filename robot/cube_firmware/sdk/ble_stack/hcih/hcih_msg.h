...
/**
****************************************************************************************
* @brief HCI function for packing basic command packets, for commands with no
*parameters.
*
...
*
* @param ke_msg Pointer to the kernel message containing the parameters to send.
*The parameters will be packed into this space, in order ot avoid allocating
*               more space. The message will be queued fot transport, sent if
*possible then freed.
*****************************************************************************************
*/
// legacy
