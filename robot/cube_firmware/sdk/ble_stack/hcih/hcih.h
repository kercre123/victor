...
/// HCI Event header components structure - contains all details possible in an
/// event
struct hcih_evt_hdr {
  /// Event code
  uint8_t code;
...
/**
 ****************************************************************************************
 * @brief Function called in HCIH EIF reception routine to allocate and dispatch
 *a KE message for a command status event.
 *
 *****************************************************************************************
 */
 ...
 ****************************************************************************************
 * @brief Function called in HCIH EIF reception routine to dispatch a KE message
 *for all events except the command status event, once payload reception has
 *been completed.
 *
 * @param[in]  payl Pointer to receiver buffer payload
 *
