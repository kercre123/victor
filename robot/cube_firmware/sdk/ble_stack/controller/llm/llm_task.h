 ...
 * specific connection with a peer (e.g. scanning, advertising, etc.). It
...
struct llm_le_add_dev_to_wlst_cmd {
  /// Type of address of the device to be added to the White List -
  /// 0=public/1=random
...
struct llm_le_rmv_dev_from_wlst_cmd {
  /// Type of address of the device to be removed from the White List -
  /// 0=public/1=random
  uint8_t dev_addr_type;
...
/// LLM command complete event structure for the Read Advertising Channel Tx
/// Power Command
