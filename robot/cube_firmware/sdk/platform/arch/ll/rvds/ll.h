 ...
 * This macro must be used when the initialization phase is over and the
 * interrupts can start being handled by the system.
 */
 ...
 *
 * @warning It is suggested that this macro is called while the interrupts are
 * disabled to have performed the checks necessary to decide to move to sleep
 * mode.
 *
 */
