...
/// Kernel message header length for transport through interface between App and
/// SW stack.
#define KE_MSG_HDR_LEN 8

#if BLE_APP_NEB
/// Nebulizer message header length for transport through interface between App
/// and SW stack.
