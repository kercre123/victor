...
__INLINE void rpl_btrfip_ver_unpack(uint8_t* typ, uint8_t* rel, uint8_t* upg,
                                    uint8_t* build) {
...
__INLINE void rpl_rfdyncntl_pack(uint8_t txedrgain, uint8_t txgfskgain,
                                 uint8_t channel, uint8_t btleen, uint8_t rxen,
                                 uint8_t txedr, uint8_t txen) {
  ...
  REG_RPL_WR(RPL_RFDYNCNTL_ADDR,
             ((uint32_t)txedrgain << 20) | ((uint32_t)txgfskgain << 16) |
                 ((uint32_t)channel << 8) | ((uint32_t)btleen << 7) |
                 ((uint32_t)rxen << 4) | ((uint32_t)txedr << 1) |
                 ((uint32_t)txen << 0));
}

__INLINE void rpl_rfdyncntl_unpack(uint8_t* txedrgain, uint8_t* txgfskgain,
                                   uint8_t* channel, uint8_t* btleen,
                                   uint8_t* rxen, uint8_t* txedr,
                                   uint8_t* txen) {
...
__INLINE void rpl_tx_edr_gain_setf(uint8_t txedrgain) {
  ASSERT_ERR((((uint32_t)txedrgain << 20) & ~((uint32_t)0x00F00000)) == 0);
  REG_RPL_WR(RPL_RFDYNCNTL_ADDR,
             (REG_RPL_RD(RPL_RFDYNCNTL_ADDR) & ~((uint32_t)0x00F00000)) |
                 ((uint32_t)txedrgain << 20));
}
...
__INLINE void rpl_tx_gfsk_gain_setf(uint8_t txgfskgain) {
  ASSERT_ERR((((uint32_t)txgfskgain << 16) & ~((uint32_t)0x000F0000)) == 0);
  REG_RPL_WR(RPL_RFDYNCNTL_ADDR,
             (REG_RPL_RD(RPL_RFDYNCNTL_ADDR) & ~((uint32_t)0x000F0000)) |
                 ((uint32_t)txgfskgain << 16));
}
...
__INLINE void rpl_channel_setf(uint8_t channel) {
  ASSERT_ERR((((uint32_t)channel << 8) & ~((uint32_t)0x00007F00)) == 0);
  REG_RPL_WR(RPL_RFDYNCNTL_ADDR,
             (REG_RPL_RD(RPL_RFDYNCNTL_ADDR) & ~((uint32_t)0x00007F00)) |
                 ((uint32_t)channel << 8));
}
...
__INLINE void rpl_btle_en_setf(uint8_t btleen) {
  ASSERT_ERR((((uint32_t)btleen << 7) & ~((uint32_t)0x00000080)) == 0);
  REG_RPL_WR(RPL_RFDYNCNTL_ADDR,
             (REG_RPL_RD(RPL_RFDYNCNTL_ADDR) & ~((uint32_t)0x00000080)) |
                 ((uint32_t)btleen << 7));
}
...
__INLINE void rpl_rx_en_setf(uint8_t rxen) {
  ASSERT_ERR((((uint32_t)rxen << 4) & ~((uint32_t)0x00000010)) == 0);
  REG_RPL_WR(RPL_RFDYNCNTL_ADDR,
             (REG_RPL_RD(RPL_RFDYNCNTL_ADDR) & ~((uint32_t)0x00000010)) |
                 ((uint32_t)rxen << 4));
}
...
__INLINE void rpl_tx_edr_setf(uint8_t txedr) {
  ASSERT_ERR((((uint32_t)txedr << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_RPL_WR(RPL_RFDYNCNTL_ADDR,
             (REG_RPL_RD(RPL_RFDYNCNTL_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)txedr << 1));
}
...
__INLINE void rpl_tx_en_setf(uint8_t txen) {
  ASSERT_ERR((((uint32_t)txen << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(RPL_RFDYNCNTL_ADDR,
             (REG_RPL_RD(RPL_RFDYNCNTL_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)txen << 0));
}
...
__INLINE uint32_t rpl_seqcntl_get(void) { return REG_RPL_RD(RPL_SEQCNTL_ADDR); }
...
__INLINE void rpl_seqcntl_pack(uint8_t rxflagcheck, uint8_t rxdivfactor,
                               uint8_t txflagcheck, uint8_t txdivfactor) {
  ...
  REG_RPL_WR(RPL_SEQCNTL_ADDR,
             ((uint32_t)rxflagcheck << 24) | ((uint32_t)rxdivfactor << 16) |
                 ((uint32_t)txflagcheck << 8) | ((uint32_t)txdivfactor << 0));
}

__INLINE void rpl_seqcntl_unpack(uint8_t* rxflagcheck, uint8_t* rxdivfactor,
                                 uint8_t* txflagcheck, uint8_t* txdivfactor) {
...
__INLINE void rpl_rx_flag_check_setf(uint8_t rxflagcheck) {
  ASSERT_ERR((((uint32_t)rxflagcheck << 24) & ~((uint32_t)0x0F000000)) == 0);
  REG_RPL_WR(RPL_SEQCNTL_ADDR,
             (REG_RPL_RD(RPL_SEQCNTL_ADDR) & ~((uint32_t)0x0F000000)) |
                 ((uint32_t)rxflagcheck << 24));
}
...
__INLINE void rpl_rx_div_factor_setf(uint8_t rxdivfactor) {
  ASSERT_ERR((((uint32_t)rxdivfactor << 16) & ~((uint32_t)0x001F0000)) == 0);
  REG_RPL_WR(RPL_SEQCNTL_ADDR,
             (REG_RPL_RD(RPL_SEQCNTL_ADDR) & ~((uint32_t)0x001F0000)) |
                 ((uint32_t)rxdivfactor << 16));
}
...
__INLINE void rpl_tx_flag_check_setf(uint8_t txflagcheck) {
  ASSERT_ERR((((uint32_t)txflagcheck << 8) & ~((uint32_t)0x00000F00)) == 0);
  REG_RPL_WR(RPL_SEQCNTL_ADDR,
             (REG_RPL_RD(RPL_SEQCNTL_ADDR) & ~((uint32_t)0x00000F00)) |
                 ((uint32_t)txflagcheck << 8));
}
...
__INLINE void rpl_tx_div_factor_setf(uint8_t txdivfactor) {
  ASSERT_ERR((((uint32_t)txdivfactor << 0) & ~((uint32_t)0x0000001F)) == 0);
  REG_RPL_WR(RPL_SEQCNTL_ADDR,
             (REG_RPL_RD(RPL_SEQCNTL_ADDR) & ~((uint32_t)0x0000001F)) |
                 ((uint32_t)txdivfactor << 0));
}
...
__INLINE void rpl_rftxup_dly0_pack(uint16_t txupdly2, uint16_t txupdly1,
                                   uint16_t txupdly0) {
  ...
  REG_RPL_WR(RPL_RFTXUP_DLY0_ADDR, ((uint32_t)txupdly2 << 22) |
                                       ((uint32_t)txupdly1 << 11) |
                                       ((uint32_t)txupdly0 << 0));
}

__INLINE void rpl_rftxup_dly0_unpack(uint16_t* txupdly2, uint16_t* txupdly1,
                                     uint16_t* txupdly0) {
...
__INLINE void rpl_tx_up_dly2_setf(uint16_t txupdly2) {
  ASSERT_ERR((((uint32_t)txupdly2 << 22) & ~((uint32_t)0xFFC00000)) == 0);
  REG_RPL_WR(RPL_RFTXUP_DLY0_ADDR,
             (REG_RPL_RD(RPL_RFTXUP_DLY0_ADDR) & ~((uint32_t)0xFFC00000)) |
                 ((uint32_t)txupdly2 << 22));
}
...
__INLINE void rpl_tx_up_dly1_setf(uint16_t txupdly1) {
  ASSERT_ERR((((uint32_t)txupdly1 << 11) & ~((uint32_t)0x001FF800)) == 0);
  REG_RPL_WR(RPL_RFTXUP_DLY0_ADDR,
             (REG_RPL_RD(RPL_RFTXUP_DLY0_ADDR) & ~((uint32_t)0x001FF800)) |
                 ((uint32_t)txupdly1 << 11));
}
...
__INLINE void rpl_tx_up_dly0_setf(uint16_t txupdly0) {
  ASSERT_ERR((((uint32_t)txupdly0 << 0) & ~((uint32_t)0x000003FF)) == 0);
  REG_RPL_WR(RPL_RFTXUP_DLY0_ADDR,
             (REG_RPL_RD(RPL_RFTXUP_DLY0_ADDR) & ~((uint32_t)0x000003FF)) |
                 ((uint32_t)txupdly0 << 0));
}
...
__INLINE void rpl_rftxup_dly1_pack(uint16_t txupdly5, uint16_t txupdly4,
                                   uint16_t txupdly3) {
  ...
  REG_RPL_WR(RPL_RFTXUP_DLY1_ADDR, ((uint32_t)txupdly5 << 22) |
                                       ((uint32_t)txupdly4 << 11) |
                                       ((uint32_t)txupdly3 << 0));
}

__INLINE void rpl_rftxup_dly1_unpack(uint16_t* txupdly5, uint16_t* txupdly4,
                                     uint16_t* txupdly3) {
...
__INLINE void rpl_tx_up_dly5_setf(uint16_t txupdly5) {
  ASSERT_ERR((((uint32_t)txupdly5 << 22) & ~((uint32_t)0xFFC00000)) == 0);
  REG_RPL_WR(RPL_RFTXUP_DLY1_ADDR,
             (REG_RPL_RD(RPL_RFTXUP_DLY1_ADDR) & ~((uint32_t)0xFFC00000)) |
                 ((uint32_t)txupdly5 << 22));
}
...
__INLINE void rpl_tx_up_dly4_setf(uint16_t txupdly4) {
  ASSERT_ERR((((uint32_t)txupdly4 << 11) & ~((uint32_t)0x001FF800)) == 0);
  REG_RPL_WR(RPL_RFTXUP_DLY1_ADDR,
             (REG_RPL_RD(RPL_RFTXUP_DLY1_ADDR) & ~((uint32_t)0x001FF800)) |
                 ((uint32_t)txupdly4 << 11));
}
...
__INLINE void rpl_tx_up_dly3_setf(uint16_t txupdly3) {
  ASSERT_ERR((((uint32_t)txupdly3 << 0) & ~((uint32_t)0x000003FF)) == 0);
  REG_RPL_WR(RPL_RFTXUP_DLY1_ADDR,
             (REG_RPL_RD(RPL_RFTXUP_DLY1_ADDR) & ~((uint32_t)0x000003FF)) |
                 ((uint32_t)txupdly3 << 0));
}
...
__INLINE void rpl_rftxup_dly2_pack(uint16_t txupdly8, uint16_t txupdly7,
                                   uint16_t txupdly6) {
  ...
  REG_RPL_WR(RPL_RFTXUP_DLY2_ADDR, ((uint32_t)txupdly8 << 22) |
                                       ((uint32_t)txupdly7 << 11) |
                                       ((uint32_t)txupdly6 << 0));
}

__INLINE void rpl_rftxup_dly2_unpack(uint16_t* txupdly8, uint16_t* txupdly7,
                                     uint16_t* txupdly6) {
...
__INLINE void rpl_tx_up_dly8_setf(uint16_t txupdly8) {
  ASSERT_ERR((((uint32_t)txupdly8 << 22) & ~((uint32_t)0xFFC00000)) == 0);
  REG_RPL_WR(RPL_RFTXUP_DLY2_ADDR,
             (REG_RPL_RD(RPL_RFTXUP_DLY2_ADDR) & ~((uint32_t)0xFFC00000)) |
                 ((uint32_t)txupdly8 << 22));
}
...
__INLINE void rpl_tx_up_dly7_setf(uint16_t txupdly7) {
  ASSERT_ERR((((uint32_t)txupdly7 << 11) & ~((uint32_t)0x001FF800)) == 0);
  REG_RPL_WR(RPL_RFTXUP_DLY2_ADDR,
             (REG_RPL_RD(RPL_RFTXUP_DLY2_ADDR) & ~((uint32_t)0x001FF800)) |
                 ((uint32_t)txupdly7 << 11));
}
...
__INLINE void rpl_tx_up_dly6_setf(uint16_t txupdly6) {
  ASSERT_ERR((((uint32_t)txupdly6 << 0) & ~((uint32_t)0x000003FF)) == 0);
  REG_RPL_WR(RPL_RFTXUP_DLY2_ADDR,
             (REG_RPL_RD(RPL_RFTXUP_DLY2_ADDR) & ~((uint32_t)0x000003FF)) |
                 ((uint32_t)txupdly6 << 0));
}
...
__INLINE void rpl_rftxdn_dly0_pack(uint16_t txdndly2, uint16_t txdndly1,
                                   uint16_t txdndly0) {
  ...
  REG_RPL_WR(RPL_RFTXDN_DLY0_ADDR, ((uint32_t)txdndly2 << 22) |
                                       ((uint32_t)txdndly1 << 11) |
                                       ((uint32_t)txdndly0 << 0));
}

__INLINE void rpl_rftxdn_dly0_unpack(uint16_t* txdndly2, uint16_t* txdndly1,
                                     uint16_t* txdndly0) {
...
__INLINE void rpl_tx_dn_dly2_setf(uint16_t txdndly2) {
  ASSERT_ERR((((uint32_t)txdndly2 << 22) & ~((uint32_t)0xFFC00000)) == 0);
  REG_RPL_WR(RPL_RFTXDN_DLY0_ADDR,
             (REG_RPL_RD(RPL_RFTXDN_DLY0_ADDR) & ~((uint32_t)0xFFC00000)) |
                 ((uint32_t)txdndly2 << 22));
}
...
__INLINE void rpl_tx_dn_dly1_setf(uint16_t txdndly1) {
  ASSERT_ERR((((uint32_t)txdndly1 << 11) & ~((uint32_t)0x001FF800)) == 0);
  REG_RPL_WR(RPL_RFTXDN_DLY0_ADDR,
             (REG_RPL_RD(RPL_RFTXDN_DLY0_ADDR) & ~((uint32_t)0x001FF800)) |
                 ((uint32_t)txdndly1 << 11));
}
...
__INLINE void rpl_tx_dn_dly0_setf(uint16_t txdndly0) {
  ASSERT_ERR((((uint32_t)txdndly0 << 0) & ~((uint32_t)0x000003FF)) == 0);
  REG_RPL_WR(RPL_RFTXDN_DLY0_ADDR,
             (REG_RPL_RD(RPL_RFTXDN_DLY0_ADDR) & ~((uint32_t)0x000003FF)) |
                 ((uint32_t)txdndly0 << 0));
}
...
__INLINE void rpl_rftxdn_dly1_pack(uint16_t txdndly5, uint16_t txdndly4,
                                   uint16_t txdndly3) {
  ...
  REG_RPL_WR(RPL_RFTXDN_DLY1_ADDR, ((uint32_t)txdndly5 << 22) |
                                       ((uint32_t)txdndly4 << 11) |
                                       ((uint32_t)txdndly3 << 0));
}

__INLINE void rpl_rftxdn_dly1_unpack(uint16_t* txdndly5, uint16_t* txdndly4,
                                     uint16_t* txdndly3) {
...
__INLINE void rpl_tx_dn_dly5_setf(uint16_t txdndly5) {
  ASSERT_ERR((((uint32_t)txdndly5 << 22) & ~((uint32_t)0xFFC00000)) == 0);
  REG_RPL_WR(RPL_RFTXDN_DLY1_ADDR,
             (REG_RPL_RD(RPL_RFTXDN_DLY1_ADDR) & ~((uint32_t)0xFFC00000)) |
                 ((uint32_t)txdndly5 << 22));
}
...
__INLINE void rpl_tx_dn_dly4_setf(uint16_t txdndly4) {
  ASSERT_ERR((((uint32_t)txdndly4 << 11) & ~((uint32_t)0x001FF800)) == 0);
  REG_RPL_WR(RPL_RFTXDN_DLY1_ADDR,
             (REG_RPL_RD(RPL_RFTXDN_DLY1_ADDR) & ~((uint32_t)0x001FF800)) |
                 ((uint32_t)txdndly4 << 11));
}
...
__INLINE void rpl_tx_dn_dly3_setf(uint16_t txdndly3) {
  ASSERT_ERR((((uint32_t)txdndly3 << 0) & ~((uint32_t)0x000003FF)) == 0);
  REG_RPL_WR(RPL_RFTXDN_DLY1_ADDR,
             (REG_RPL_RD(RPL_RFTXDN_DLY1_ADDR) & ~((uint32_t)0x000003FF)) |
                 ((uint32_t)txdndly3 << 0));
}
...
__INLINE void rpl_rftxdn_dly2_pack(uint16_t txdndly8, uint16_t txdndly7,
                                   uint16_t txdndly6) {
  ...
  REG_RPL_WR(RPL_RFTXDN_DLY2_ADDR, ((uint32_t)txdndly8 << 22) |
                                       ((uint32_t)txdndly7 << 11) |
                                       ((uint32_t)txdndly6 << 0));
}

__INLINE void rpl_rftxdn_dly2_unpack(uint16_t* txdndly8, uint16_t* txdndly7,
                                     uint16_t* txdndly6) {
...
__INLINE void rpl_tx_dn_dly8_setf(uint16_t txdndly8) {
  ASSERT_ERR((((uint32_t)txdndly8 << 22) & ~((uint32_t)0xFFC00000)) == 0);
  REG_RPL_WR(RPL_RFTXDN_DLY2_ADDR,
             (REG_RPL_RD(RPL_RFTXDN_DLY2_ADDR) & ~((uint32_t)0xFFC00000)) |
                 ((uint32_t)txdndly8 << 22));
}
...
__INLINE void rpl_tx_dn_dly7_setf(uint16_t txdndly7) {
  ASSERT_ERR((((uint32_t)txdndly7 << 11) & ~((uint32_t)0x001FF800)) == 0);
  REG_RPL_WR(RPL_RFTXDN_DLY2_ADDR,
             (REG_RPL_RD(RPL_RFTXDN_DLY2_ADDR) & ~((uint32_t)0x001FF800)) |
                 ((uint32_t)txdndly7 << 11));
}
...
__INLINE void rpl_tx_dn_dly6_setf(uint16_t txdndly6) {
  ASSERT_ERR((((uint32_t)txdndly6 << 0) & ~((uint32_t)0x000003FF)) == 0);
  REG_RPL_WR(RPL_RFTXDN_DLY2_ADDR,
             (REG_RPL_RD(RPL_RFTXDN_DLY2_ADDR) & ~((uint32_t)0x000003FF)) |
                 ((uint32_t)txdndly6 << 0));
}
...
__INLINE void rpl_rfrxup_dly0_pack(uint16_t rxupdly2, uint16_t rxupdly1,
                                   uint16_t rxupdly0) {
  ...
  REG_RPL_WR(RPL_RFRXUP_DLY0_ADDR, ((uint32_t)rxupdly2 << 22) |
                                       ((uint32_t)rxupdly1 << 11) |
                                       ((uint32_t)rxupdly0 << 0));
}

__INLINE void rpl_rfrxup_dly0_unpack(uint16_t* rxupdly2, uint16_t* rxupdly1,
                                     uint16_t* rxupdly0) {
...
__INLINE void rpl_rx_up_dly2_setf(uint16_t rxupdly2) {
  ASSERT_ERR((((uint32_t)rxupdly2 << 22) & ~((uint32_t)0xFFC00000)) == 0);
  REG_RPL_WR(RPL_RFRXUP_DLY0_ADDR,
             (REG_RPL_RD(RPL_RFRXUP_DLY0_ADDR) & ~((uint32_t)0xFFC00000)) |
                 ((uint32_t)rxupdly2 << 22));
}
...
__INLINE void rpl_rx_up_dly1_setf(uint16_t rxupdly1) {
  ASSERT_ERR((((uint32_t)rxupdly1 << 11) & ~((uint32_t)0x001FF800)) == 0);
  REG_RPL_WR(RPL_RFRXUP_DLY0_ADDR,
             (REG_RPL_RD(RPL_RFRXUP_DLY0_ADDR) & ~((uint32_t)0x001FF800)) |
                 ((uint32_t)rxupdly1 << 11));
}
...
__INLINE void rpl_rx_up_dly0_setf(uint16_t rxupdly0) {
  ASSERT_ERR((((uint32_t)rxupdly0 << 0) & ~((uint32_t)0x000003FF)) == 0);
  REG_RPL_WR(RPL_RFRXUP_DLY0_ADDR,
             (REG_RPL_RD(RPL_RFRXUP_DLY0_ADDR) & ~((uint32_t)0x000003FF)) |
                 ((uint32_t)rxupdly0 << 0));
}
...
__INLINE void rpl_rfrxup_dly1_pack(uint16_t rxupdly5, uint16_t rxupdly4,
                                   uint16_t rxupdly3) {
  ...
  REG_RPL_WR(RPL_RFRXUP_DLY1_ADDR, ((uint32_t)rxupdly5 << 22) |
                                       ((uint32_t)rxupdly4 << 11) |
                                       ((uint32_t)rxupdly3 << 0));
}

__INLINE void rpl_rfrxup_dly1_unpack(uint16_t* rxupdly5, uint16_t* rxupdly4,
                                     uint16_t* rxupdly3) {
...
__INLINE void rpl_rx_up_dly5_setf(uint16_t rxupdly5) {
  ASSERT_ERR((((uint32_t)rxupdly5 << 22) & ~((uint32_t)0xFFC00000)) == 0);
  REG_RPL_WR(RPL_RFRXUP_DLY1_ADDR,
             (REG_RPL_RD(RPL_RFRXUP_DLY1_ADDR) & ~((uint32_t)0xFFC00000)) |
                 ((uint32_t)rxupdly5 << 22));
}
...
__INLINE void rpl_rx_up_dly4_setf(uint16_t rxupdly4) {
  ASSERT_ERR((((uint32_t)rxupdly4 << 11) & ~((uint32_t)0x001FF800)) == 0);
  REG_RPL_WR(RPL_RFRXUP_DLY1_ADDR,
             (REG_RPL_RD(RPL_RFRXUP_DLY1_ADDR) & ~((uint32_t)0x001FF800)) |
                 ((uint32_t)rxupdly4 << 11));
}
...
__INLINE void rpl_rx_up_dly3_setf(uint16_t rxupdly3) {
  ASSERT_ERR((((uint32_t)rxupdly3 << 0) & ~((uint32_t)0x000003FF)) == 0);
  REG_RPL_WR(RPL_RFRXUP_DLY1_ADDR,
             (REG_RPL_RD(RPL_RFRXUP_DLY1_ADDR) & ~((uint32_t)0x000003FF)) |
                 ((uint32_t)rxupdly3 << 0));
}
...
__INLINE void rpl_rfrxup_dly2_pack(uint16_t rxupdly8, uint16_t rxupdly7,
                                   uint16_t rxupdly6) {
  ...
  REG_RPL_WR(RPL_RFRXUP_DLY2_ADDR, ((uint32_t)rxupdly8 << 22) |
                                       ((uint32_t)rxupdly7 << 11) |
                                       ((uint32_t)rxupdly6 << 0));
}

__INLINE void rpl_rfrxup_dly2_unpack(uint16_t* rxupdly8, uint16_t* rxupdly7,
                                     uint16_t* rxupdly6) {
...
__INLINE void rpl_rx_up_dly8_setf(uint16_t rxupdly8) {
  ASSERT_ERR((((uint32_t)rxupdly8 << 22) & ~((uint32_t)0xFFC00000)) == 0);
  REG_RPL_WR(RPL_RFRXUP_DLY2_ADDR,
             (REG_RPL_RD(RPL_RFRXUP_DLY2_ADDR) & ~((uint32_t)0xFFC00000)) |
                 ((uint32_t)rxupdly8 << 22));
}
...
__INLINE void rpl_rx_up_dly7_setf(uint16_t rxupdly7) {
  ASSERT_ERR((((uint32_t)rxupdly7 << 11) & ~((uint32_t)0x001FF800)) == 0);
  REG_RPL_WR(RPL_RFRXUP_DLY2_ADDR,
             (REG_RPL_RD(RPL_RFRXUP_DLY2_ADDR) & ~((uint32_t)0x001FF800)) |
                 ((uint32_t)rxupdly7 << 11));
}
...
__INLINE void rpl_rx_up_dly6_setf(uint16_t rxupdly6) {
  ASSERT_ERR((((uint32_t)rxupdly6 << 0) & ~((uint32_t)0x000003FF)) == 0);
  REG_RPL_WR(RPL_RFRXUP_DLY2_ADDR,
             (REG_RPL_RD(RPL_RFRXUP_DLY2_ADDR) & ~((uint32_t)0x000003FF)) |
                 ((uint32_t)rxupdly6 << 0));
}
...
__INLINE void rpl_rfrxdn_dly0_pack(uint16_t rxdndly2, uint16_t rxdndly1,
                                   uint16_t rxdndly0) {
  ...
  REG_RPL_WR(RPL_RFRXDN_DLY0_ADDR, ((uint32_t)rxdndly2 << 22) |
                                       ((uint32_t)rxdndly1 << 11) |
                                       ((uint32_t)rxdndly0 << 0));
}

__INLINE void rpl_rfrxdn_dly0_unpack(uint16_t* rxdndly2, uint16_t* rxdndly1,
                                     uint16_t* rxdndly0) {
...
__INLINE void rpl_rx_dn_dly2_setf(uint16_t rxdndly2) {
  ASSERT_ERR((((uint32_t)rxdndly2 << 22) & ~((uint32_t)0xFFC00000)) == 0);
  REG_RPL_WR(RPL_RFRXDN_DLY0_ADDR,
             (REG_RPL_RD(RPL_RFRXDN_DLY0_ADDR) & ~((uint32_t)0xFFC00000)) |
                 ((uint32_t)rxdndly2 << 22));
}
...
__INLINE void rpl_rx_dn_dly1_setf(uint16_t rxdndly1) {
  ASSERT_ERR((((uint32_t)rxdndly1 << 11) & ~((uint32_t)0x001FF800)) == 0);
  REG_RPL_WR(RPL_RFRXDN_DLY0_ADDR,
             (REG_RPL_RD(RPL_RFRXDN_DLY0_ADDR) & ~((uint32_t)0x001FF800)) |
                 ((uint32_t)rxdndly1 << 11));
}
...
__INLINE void rpl_rx_dn_dly0_setf(uint16_t rxdndly0) {
  ASSERT_ERR((((uint32_t)rxdndly0 << 0) & ~((uint32_t)0x000003FF)) == 0);
  REG_RPL_WR(RPL_RFRXDN_DLY0_ADDR,
             (REG_RPL_RD(RPL_RFRXDN_DLY0_ADDR) & ~((uint32_t)0x000003FF)) |
                 ((uint32_t)rxdndly0 << 0));
}
...
__INLINE void rpl_rfrxdn_dly1_pack(uint16_t rxdndly5, uint16_t rxdndly4,
                                   uint16_t rxdndly3) {
  ...
  REG_RPL_WR(RPL_RFRXDN_DLY1_ADDR, ((uint32_t)rxdndly5 << 22) |
                                       ((uint32_t)rxdndly4 << 11) |
                                       ((uint32_t)rxdndly3 << 0));
}

__INLINE void rpl_rfrxdn_dly1_unpack(uint16_t* rxdndly5, uint16_t* rxdndly4,
                                     uint16_t* rxdndly3) {
...
__INLINE void rpl_rx_dn_dly5_setf(uint16_t rxdndly5) {
  ASSERT_ERR((((uint32_t)rxdndly5 << 22) & ~((uint32_t)0xFFC00000)) == 0);
  REG_RPL_WR(RPL_RFRXDN_DLY1_ADDR,
             (REG_RPL_RD(RPL_RFRXDN_DLY1_ADDR) & ~((uint32_t)0xFFC00000)) |
                 ((uint32_t)rxdndly5 << 22));
}
...
__INLINE void rpl_rx_dn_dly4_setf(uint16_t rxdndly4) {
  ASSERT_ERR((((uint32_t)rxdndly4 << 11) & ~((uint32_t)0x001FF800)) == 0);
  REG_RPL_WR(RPL_RFRXDN_DLY1_ADDR,
             (REG_RPL_RD(RPL_RFRXDN_DLY1_ADDR) & ~((uint32_t)0x001FF800)) |
                 ((uint32_t)rxdndly4 << 11));
}
...
__INLINE void rpl_rx_dn_dly3_setf(uint16_t rxdndly3) {
  ASSERT_ERR((((uint32_t)rxdndly3 << 0) & ~((uint32_t)0x000003FF)) == 0);
  REG_RPL_WR(RPL_RFRXDN_DLY1_ADDR,
             (REG_RPL_RD(RPL_RFRXDN_DLY1_ADDR) & ~((uint32_t)0x000003FF)) |
                 ((uint32_t)rxdndly3 << 0));
}
...
__INLINE void rpl_rfrxdn_dly2_pack(uint16_t rxdndly8, uint16_t rxdndly7,
                                   uint16_t rxdndly6) {
  ...
  REG_RPL_WR(RPL_RFRXDN_DLY2_ADDR, ((uint32_t)rxdndly8 << 22) |
                                       ((uint32_t)rxdndly7 << 11) |
                                       ((uint32_t)rxdndly6 << 0));
}

__INLINE void rpl_rfrxdn_dly2_unpack(uint16_t* rxdndly8, uint16_t* rxdndly7,
                                     uint16_t* rxdndly6) {
...
__INLINE void rpl_rx_dn_dly8_setf(uint16_t rxdndly8) {
  ASSERT_ERR((((uint32_t)rxdndly8 << 22) & ~((uint32_t)0xFFC00000)) == 0);
  REG_RPL_WR(RPL_RFRXDN_DLY2_ADDR,
             (REG_RPL_RD(RPL_RFRXDN_DLY2_ADDR) & ~((uint32_t)0xFFC00000)) |
                 ((uint32_t)rxdndly8 << 22));
}
...
__INLINE void rpl_rx_dn_dly7_setf(uint16_t rxdndly7) {
  ASSERT_ERR((((uint32_t)rxdndly7 << 11) & ~((uint32_t)0x001FF800)) == 0);
  REG_RPL_WR(RPL_RFRXDN_DLY2_ADDR,
             (REG_RPL_RD(RPL_RFRXDN_DLY2_ADDR) & ~((uint32_t)0x001FF800)) |
                 ((uint32_t)rxdndly7 << 11));
}
...
__INLINE void rpl_rx_dn_dly6_setf(uint16_t rxdndly6) {
  ASSERT_ERR((((uint32_t)rxdndly6 << 0) & ~((uint32_t)0x000003FF)) == 0);
  REG_RPL_WR(RPL_RFRXDN_DLY2_ADDR,
             (REG_RPL_RD(RPL_RFRXDN_DLY2_ADDR) & ~((uint32_t)0x000003FF)) |
                 ((uint32_t)rxdndly6 << 0));
}
...
__INLINE void rpl_seqtxup_out0_pack(uint16_t txupout2, uint16_t txupout1,
                                    uint16_t txupout0) {
  ...
  REG_RPL_WR(RPL_SEQTXUP_OUT0_ADDR, ((uint32_t)txupout2 << 22) |
                                        ((uint32_t)txupout1 << 11) |
                                        ((uint32_t)txupout0 << 0));
}

__INLINE void rpl_seqtxup_out0_unpack(uint16_t* txupout2, uint16_t* txupout1,
                                      uint16_t* txupout0) {
...
__INLINE void rpl_tx_up_out2_setf(uint16_t txupout2) {
  ASSERT_ERR((((uint32_t)txupout2 << 22) & ~((uint32_t)0x7FC00000)) == 0);
  REG_RPL_WR(RPL_SEQTXUP_OUT0_ADDR,
             (REG_RPL_RD(RPL_SEQTXUP_OUT0_ADDR) & ~((uint32_t)0x7FC00000)) |
                 ((uint32_t)txupout2 << 22));
}
...
__INLINE void rpl_tx_up_out1_setf(uint16_t txupout1) {
  ASSERT_ERR((((uint32_t)txupout1 << 11) & ~((uint32_t)0x000FF800)) == 0);
  REG_RPL_WR(RPL_SEQTXUP_OUT0_ADDR,
             (REG_RPL_RD(RPL_SEQTXUP_OUT0_ADDR) & ~((uint32_t)0x000FF800)) |
                 ((uint32_t)txupout1 << 11));
}
...
__INLINE void rpl_tx_up_out0_setf(uint16_t txupout0) {
  ASSERT_ERR((((uint32_t)txupout0 << 0) & ~((uint32_t)0x000001FF)) == 0);
  REG_RPL_WR(RPL_SEQTXUP_OUT0_ADDR,
             (REG_RPL_RD(RPL_SEQTXUP_OUT0_ADDR) & ~((uint32_t)0x000001FF)) |
                 ((uint32_t)txupout0 << 0));
}
...
__INLINE void rpl_seqtxup_out1_pack(uint16_t txupout5, uint16_t txupout4,
                                    uint16_t txupout3) {
  ...
  REG_RPL_WR(RPL_SEQTXUP_OUT1_ADDR, ((uint32_t)txupout5 << 22) |
                                        ((uint32_t)txupout4 << 11) |
                                        ((uint32_t)txupout3 << 0));
}

__INLINE void rpl_seqtxup_out1_unpack(uint16_t* txupout5, uint16_t* txupout4,
                                      uint16_t* txupout3) {
...
__INLINE void rpl_tx_up_out5_setf(uint16_t txupout5) {
  ASSERT_ERR((((uint32_t)txupout5 << 22) & ~((uint32_t)0x7FC00000)) == 0);
  REG_RPL_WR(RPL_SEQTXUP_OUT1_ADDR,
             (REG_RPL_RD(RPL_SEQTXUP_OUT1_ADDR) & ~((uint32_t)0x7FC00000)) |
                 ((uint32_t)txupout5 << 22));
}
...
__INLINE void rpl_tx_up_out4_setf(uint16_t txupout4) {
  ASSERT_ERR((((uint32_t)txupout4 << 11) & ~((uint32_t)0x000FF800)) == 0);
  REG_RPL_WR(RPL_SEQTXUP_OUT1_ADDR,
             (REG_RPL_RD(RPL_SEQTXUP_OUT1_ADDR) & ~((uint32_t)0x000FF800)) |
                 ((uint32_t)txupout4 << 11));
}
...
__INLINE void rpl_tx_up_out3_setf(uint16_t txupout3) {
  ASSERT_ERR((((uint32_t)txupout3 << 0) & ~((uint32_t)0x000001FF)) == 0);
  REG_RPL_WR(RPL_SEQTXUP_OUT1_ADDR,
             (REG_RPL_RD(RPL_SEQTXUP_OUT1_ADDR) & ~((uint32_t)0x000001FF)) |
                 ((uint32_t)txupout3 << 0));
}
...
__INLINE void rpl_seqtxup_out2_pack(uint16_t txupout8, uint16_t txupout7,
                                    uint16_t txupout6) {
  ...
  REG_RPL_WR(RPL_SEQTXUP_OUT2_ADDR, ((uint32_t)txupout8 << 22) |
                                        ((uint32_t)txupout7 << 11) |
                                        ((uint32_t)txupout6 << 0));
}

__INLINE void rpl_seqtxup_out2_unpack(uint16_t* txupout8, uint16_t* txupout7,
                                      uint16_t* txupout6) {
...
__INLINE void rpl_tx_up_out8_setf(uint16_t txupout8) {
  ASSERT_ERR((((uint32_t)txupout8 << 22) & ~((uint32_t)0x7FC00000)) == 0);
  REG_RPL_WR(RPL_SEQTXUP_OUT2_ADDR,
             (REG_RPL_RD(RPL_SEQTXUP_OUT2_ADDR) & ~((uint32_t)0x7FC00000)) |
                 ((uint32_t)txupout8 << 22));
}
...
__INLINE void rpl_tx_up_out7_setf(uint16_t txupout7) {
  ASSERT_ERR((((uint32_t)txupout7 << 11) & ~((uint32_t)0x000FF800)) == 0);
  REG_RPL_WR(RPL_SEQTXUP_OUT2_ADDR,
             (REG_RPL_RD(RPL_SEQTXUP_OUT2_ADDR) & ~((uint32_t)0x000FF800)) |
                 ((uint32_t)txupout7 << 11));
}
...
__INLINE void rpl_tx_up_out6_setf(uint16_t txupout6) {
  ASSERT_ERR((((uint32_t)txupout6 << 0) & ~((uint32_t)0x000001FF)) == 0);
  REG_RPL_WR(RPL_SEQTXUP_OUT2_ADDR,
             (REG_RPL_RD(RPL_SEQTXUP_OUT2_ADDR) & ~((uint32_t)0x000001FF)) |
                 ((uint32_t)txupout6 << 0));
}
...
__INLINE void rpl_seqtxdn_out0_pack(uint16_t txdnout2, uint16_t txdnout1,
                                    uint16_t txdnout0) {
  ...
  REG_RPL_WR(RPL_SEQTXDN_OUT0_ADDR, ((uint32_t)txdnout2 << 22) |
                                        ((uint32_t)txdnout1 << 11) |
                                        ((uint32_t)txdnout0 << 0));
}

__INLINE void rpl_seqtxdn_out0_unpack(uint16_t* txdnout2, uint16_t* txdnout1,
                                      uint16_t* txdnout0) {
...
__INLINE void rpl_tx_dn_out2_setf(uint16_t txdnout2) {
  ASSERT_ERR((((uint32_t)txdnout2 << 22) & ~((uint32_t)0x7FC00000)) == 0);
  REG_RPL_WR(RPL_SEQTXDN_OUT0_ADDR,
             (REG_RPL_RD(RPL_SEQTXDN_OUT0_ADDR) & ~((uint32_t)0x7FC00000)) |
                 ((uint32_t)txdnout2 << 22));
}
...
__INLINE void rpl_tx_dn_out1_setf(uint16_t txdnout1) {
  ASSERT_ERR((((uint32_t)txdnout1 << 11) & ~((uint32_t)0x000FF800)) == 0);
  REG_RPL_WR(RPL_SEQTXDN_OUT0_ADDR,
             (REG_RPL_RD(RPL_SEQTXDN_OUT0_ADDR) & ~((uint32_t)0x000FF800)) |
                 ((uint32_t)txdnout1 << 11));
}
...
__INLINE void rpl_tx_dn_out0_setf(uint16_t txdnout0) {
  ASSERT_ERR((((uint32_t)txdnout0 << 0) & ~((uint32_t)0x000001FF)) == 0);
  REG_RPL_WR(RPL_SEQTXDN_OUT0_ADDR,
             (REG_RPL_RD(RPL_SEQTXDN_OUT0_ADDR) & ~((uint32_t)0x000001FF)) |
                 ((uint32_t)txdnout0 << 0));
}
...
__INLINE void rpl_seqtxdn_out1_pack(uint16_t txdnout5, uint16_t txdnout4,
                                    uint16_t txdnout3) {
  ...
  REG_RPL_WR(RPL_SEQTXDN_OUT1_ADDR, ((uint32_t)txdnout5 << 22) |
                                        ((uint32_t)txdnout4 << 11) |
                                        ((uint32_t)txdnout3 << 0));
}

__INLINE void rpl_seqtxdn_out1_unpack(uint16_t* txdnout5, uint16_t* txdnout4,
                                      uint16_t* txdnout3) {
...
__INLINE void rpl_tx_dn_out5_setf(uint16_t txdnout5) {
  ASSERT_ERR((((uint32_t)txdnout5 << 22) & ~((uint32_t)0x7FC00000)) == 0);
  REG_RPL_WR(RPL_SEQTXDN_OUT1_ADDR,
             (REG_RPL_RD(RPL_SEQTXDN_OUT1_ADDR) & ~((uint32_t)0x7FC00000)) |
                 ((uint32_t)txdnout5 << 22));
}
...
__INLINE void rpl_tx_dn_out4_setf(uint16_t txdnout4) {
  ASSERT_ERR((((uint32_t)txdnout4 << 11) & ~((uint32_t)0x000FF800)) == 0);
  REG_RPL_WR(RPL_SEQTXDN_OUT1_ADDR,
             (REG_RPL_RD(RPL_SEQTXDN_OUT1_ADDR) & ~((uint32_t)0x000FF800)) |
                 ((uint32_t)txdnout4 << 11));
}
...
__INLINE void rpl_tx_dn_out3_setf(uint16_t txdnout3) {
  ASSERT_ERR((((uint32_t)txdnout3 << 0) & ~((uint32_t)0x000001FF)) == 0);
  REG_RPL_WR(RPL_SEQTXDN_OUT1_ADDR,
             (REG_RPL_RD(RPL_SEQTXDN_OUT1_ADDR) & ~((uint32_t)0x000001FF)) |
                 ((uint32_t)txdnout3 << 0));
}
...
__INLINE void rpl_seqtxdn_out2_pack(uint16_t txdnout8, uint16_t txdnout7,
                                    uint16_t txdnout6) {
  ...
  REG_RPL_WR(RPL_SEQTXDN_OUT2_ADDR, ((uint32_t)txdnout8 << 22) |
                                        ((uint32_t)txdnout7 << 11) |
                                        ((uint32_t)txdnout6 << 0));
}

__INLINE void rpl_seqtxdn_out2_unpack(uint16_t* txdnout8, uint16_t* txdnout7,
                                      uint16_t* txdnout6) {
...
__INLINE void rpl_tx_dn_out8_setf(uint16_t txdnout8) {
  ASSERT_ERR((((uint32_t)txdnout8 << 22) & ~((uint32_t)0x7FC00000)) == 0);
  REG_RPL_WR(RPL_SEQTXDN_OUT2_ADDR,
             (REG_RPL_RD(RPL_SEQTXDN_OUT2_ADDR) & ~((uint32_t)0x7FC00000)) |
                 ((uint32_t)txdnout8 << 22));
}
...
__INLINE void rpl_tx_dn_out7_setf(uint16_t txdnout7) {
  ASSERT_ERR((((uint32_t)txdnout7 << 11) & ~((uint32_t)0x000FF800)) == 0);
  REG_RPL_WR(RPL_SEQTXDN_OUT2_ADDR,
             (REG_RPL_RD(RPL_SEQTXDN_OUT2_ADDR) & ~((uint32_t)0x000FF800)) |
                 ((uint32_t)txdnout7 << 11));
}
...
__INLINE void rpl_tx_dn_out6_setf(uint16_t txdnout6) {
  ASSERT_ERR((((uint32_t)txdnout6 << 0) & ~((uint32_t)0x000001FF)) == 0);
  REG_RPL_WR(RPL_SEQTXDN_OUT2_ADDR,
             (REG_RPL_RD(RPL_SEQTXDN_OUT2_ADDR) & ~((uint32_t)0x000001FF)) |
                 ((uint32_t)txdnout6 << 0));
}
...
__INLINE void rpl_seqrxup_out0_pack(uint16_t rxupout2, uint16_t rxupout1,
                                    uint16_t rxupout0) {
  ...
  REG_RPL_WR(RPL_SEQRXUP_OUT0_ADDR, ((uint32_t)rxupout2 << 22) |
                                        ((uint32_t)rxupout1 << 11) |
                                        ((uint32_t)rxupout0 << 0));
}

__INLINE void rpl_seqrxup_out0_unpack(uint16_t* rxupout2, uint16_t* rxupout1,
                                      uint16_t* rxupout0) {
...
__INLINE void rpl_rx_up_out2_setf(uint16_t rxupout2) {
  ASSERT_ERR((((uint32_t)rxupout2 << 22) & ~((uint32_t)0x7FC00000)) == 0);
  REG_RPL_WR(RPL_SEQRXUP_OUT0_ADDR,
             (REG_RPL_RD(RPL_SEQRXUP_OUT0_ADDR) & ~((uint32_t)0x7FC00000)) |
                 ((uint32_t)rxupout2 << 22));
}
...
__INLINE void rpl_rx_up_out1_setf(uint16_t rxupout1) {
  ASSERT_ERR((((uint32_t)rxupout1 << 11) & ~((uint32_t)0x000FF800)) == 0);
  REG_RPL_WR(RPL_SEQRXUP_OUT0_ADDR,
             (REG_RPL_RD(RPL_SEQRXUP_OUT0_ADDR) & ~((uint32_t)0x000FF800)) |
                 ((uint32_t)rxupout1 << 11));
}
...
__INLINE void rpl_rx_up_out0_setf(uint16_t rxupout0) {
  ASSERT_ERR((((uint32_t)rxupout0 << 0) & ~((uint32_t)0x000001FF)) == 0);
  REG_RPL_WR(RPL_SEQRXUP_OUT0_ADDR,
             (REG_RPL_RD(RPL_SEQRXUP_OUT0_ADDR) & ~((uint32_t)0x000001FF)) |
                 ((uint32_t)rxupout0 << 0));
}
...
__INLINE void rpl_seqrxup_out1_pack(uint16_t rxupout5, uint16_t rxupout4,
                                    uint16_t rxupout3) {
  ...
  REG_RPL_WR(RPL_SEQRXUP_OUT1_ADDR, ((uint32_t)rxupout5 << 22) |
                                        ((uint32_t)rxupout4 << 11) |
                                        ((uint32_t)rxupout3 << 0));
}

__INLINE void rpl_seqrxup_out1_unpack(uint16_t* rxupout5, uint16_t* rxupout4,
                                      uint16_t* rxupout3) {
...
__INLINE void rpl_rx_up_out5_setf(uint16_t rxupout5) {
  ASSERT_ERR((((uint32_t)rxupout5 << 22) & ~((uint32_t)0x7FC00000)) == 0);
  REG_RPL_WR(RPL_SEQRXUP_OUT1_ADDR,
             (REG_RPL_RD(RPL_SEQRXUP_OUT1_ADDR) & ~((uint32_t)0x7FC00000)) |
                 ((uint32_t)rxupout5 << 22));
}
...
__INLINE void rpl_rx_up_out4_setf(uint16_t rxupout4) {
  ASSERT_ERR((((uint32_t)rxupout4 << 11) & ~((uint32_t)0x000FF800)) == 0);
  REG_RPL_WR(RPL_SEQRXUP_OUT1_ADDR,
             (REG_RPL_RD(RPL_SEQRXUP_OUT1_ADDR) & ~((uint32_t)0x000FF800)) |
                 ((uint32_t)rxupout4 << 11));
}
...
__INLINE void rpl_rx_up_out3_setf(uint16_t rxupout3) {
  ASSERT_ERR((((uint32_t)rxupout3 << 0) & ~((uint32_t)0x000001FF)) == 0);
  REG_RPL_WR(RPL_SEQRXUP_OUT1_ADDR,
             (REG_RPL_RD(RPL_SEQRXUP_OUT1_ADDR) & ~((uint32_t)0x000001FF)) |
                 ((uint32_t)rxupout3 << 0));
}
...
__INLINE void rpl_seqrxup_out2_pack(uint16_t rxupout8, uint16_t rxupout7,
                                    uint16_t rxupout6) {
  ...
  REG_RPL_WR(RPL_SEQRXUP_OUT2_ADDR, ((uint32_t)rxupout8 << 22) |
                                        ((uint32_t)rxupout7 << 11) |
                                        ((uint32_t)rxupout6 << 0));
}

__INLINE void rpl_seqrxup_out2_unpack(uint16_t* rxupout8, uint16_t* rxupout7,
                                      uint16_t* rxupout6) {
...
__INLINE void rpl_rx_up_out8_setf(uint16_t rxupout8) {
  ASSERT_ERR((((uint32_t)rxupout8 << 22) & ~((uint32_t)0x7FC00000)) == 0);
  REG_RPL_WR(RPL_SEQRXUP_OUT2_ADDR,
             (REG_RPL_RD(RPL_SEQRXUP_OUT2_ADDR) & ~((uint32_t)0x7FC00000)) |
                 ((uint32_t)rxupout8 << 22));
}
...
__INLINE void rpl_rx_up_out7_setf(uint16_t rxupout7) {
  ASSERT_ERR((((uint32_t)rxupout7 << 11) & ~((uint32_t)0x000FF800)) == 0);
  REG_RPL_WR(RPL_SEQRXUP_OUT2_ADDR,
             (REG_RPL_RD(RPL_SEQRXUP_OUT2_ADDR) & ~((uint32_t)0x000FF800)) |
                 ((uint32_t)rxupout7 << 11));
}
...
__INLINE void rpl_rx_up_out6_setf(uint16_t rxupout6) {
  ASSERT_ERR((((uint32_t)rxupout6 << 0) & ~((uint32_t)0x000001FF)) == 0);
  REG_RPL_WR(RPL_SEQRXUP_OUT2_ADDR,
             (REG_RPL_RD(RPL_SEQRXUP_OUT2_ADDR) & ~((uint32_t)0x000001FF)) |
                 ((uint32_t)rxupout6 << 0));
}
...
__INLINE void rpl_seqrxdn_out0_pack(uint16_t rxdnout2, uint16_t rxdnout1,
                                    uint16_t rxdnout0) {
  ...
  REG_RPL_WR(RPL_SEQRXDN_OUT0_ADDR, ((uint32_t)rxdnout2 << 22) |
                                        ((uint32_t)rxdnout1 << 11) |
                                        ((uint32_t)rxdnout0 << 0));
}

__INLINE void rpl_seqrxdn_out0_unpack(uint16_t* rxdnout2, uint16_t* rxdnout1,
                                      uint16_t* rxdnout0) {
...
__INLINE void rpl_rx_dn_out2_setf(uint16_t rxdnout2) {
  ASSERT_ERR((((uint32_t)rxdnout2 << 22) & ~((uint32_t)0x7FC00000)) == 0);
  REG_RPL_WR(RPL_SEQRXDN_OUT0_ADDR,
             (REG_RPL_RD(RPL_SEQRXDN_OUT0_ADDR) & ~((uint32_t)0x7FC00000)) |
                 ((uint32_t)rxdnout2 << 22));
}
...
__INLINE void rpl_rx_dn_out1_setf(uint16_t rxdnout1) {
  ASSERT_ERR((((uint32_t)rxdnout1 << 11) & ~((uint32_t)0x000FF800)) == 0);
  REG_RPL_WR(RPL_SEQRXDN_OUT0_ADDR,
             (REG_RPL_RD(RPL_SEQRXDN_OUT0_ADDR) & ~((uint32_t)0x000FF800)) |
                 ((uint32_t)rxdnout1 << 11));
}
...
__INLINE void rpl_rx_dn_out0_setf(uint16_t rxdnout0) {
  ASSERT_ERR((((uint32_t)rxdnout0 << 0) & ~((uint32_t)0x000001FF)) == 0);
  REG_RPL_WR(RPL_SEQRXDN_OUT0_ADDR,
             (REG_RPL_RD(RPL_SEQRXDN_OUT0_ADDR) & ~((uint32_t)0x000001FF)) |
                 ((uint32_t)rxdnout0 << 0));
}
...
__INLINE void rpl_seqrxdn_out1_pack(uint16_t rxdnout5, uint16_t rxdnout4,
                                    uint16_t rxdnout3) {
  ...
  REG_RPL_WR(RPL_SEQRXDN_OUT1_ADDR, ((uint32_t)rxdnout5 << 22) |
                                        ((uint32_t)rxdnout4 << 11) |
                                        ((uint32_t)rxdnout3 << 0));
}

__INLINE void rpl_seqrxdn_out1_unpack(uint16_t* rxdnout5, uint16_t* rxdnout4,
                                      uint16_t* rxdnout3) {
...
__INLINE void rpl_rx_dn_out5_setf(uint16_t rxdnout5) {
  ASSERT_ERR((((uint32_t)rxdnout5 << 22) & ~((uint32_t)0x7FC00000)) == 0);
  REG_RPL_WR(RPL_SEQRXDN_OUT1_ADDR,
             (REG_RPL_RD(RPL_SEQRXDN_OUT1_ADDR) & ~((uint32_t)0x7FC00000)) |
                 ((uint32_t)rxdnout5 << 22));
}
...
__INLINE void rpl_rx_dn_out4_setf(uint16_t rxdnout4) {
  ASSERT_ERR((((uint32_t)rxdnout4 << 11) & ~((uint32_t)0x000FF800)) == 0);
  REG_RPL_WR(RPL_SEQRXDN_OUT1_ADDR,
             (REG_RPL_RD(RPL_SEQRXDN_OUT1_ADDR) & ~((uint32_t)0x000FF800)) |
                 ((uint32_t)rxdnout4 << 11));
}
...
__INLINE void rpl_rx_dn_out3_setf(uint16_t rxdnout3) {
  ASSERT_ERR((((uint32_t)rxdnout3 << 0) & ~((uint32_t)0x000001FF)) == 0);
  REG_RPL_WR(RPL_SEQRXDN_OUT1_ADDR,
             (REG_RPL_RD(RPL_SEQRXDN_OUT1_ADDR) & ~((uint32_t)0x000001FF)) |
                 ((uint32_t)rxdnout3 << 0));
}
...
__INLINE void rpl_seqrxdn_out2_pack(uint16_t rxdnout8, uint16_t rxdnout7,
                                    uint16_t rxdnout6) {
  ...
  REG_RPL_WR(RPL_SEQRXDN_OUT2_ADDR, ((uint32_t)rxdnout8 << 22) |
                                        ((uint32_t)rxdnout7 << 11) |
                                        ((uint32_t)rxdnout6 << 0));
}

__INLINE void rpl_seqrxdn_out2_unpack(uint16_t* rxdnout8, uint16_t* rxdnout7,
                                      uint16_t* rxdnout6) {
...
__INLINE void rpl_rx_dn_out8_setf(uint16_t rxdnout8) {
  ASSERT_ERR((((uint32_t)rxdnout8 << 22) & ~((uint32_t)0x7FC00000)) == 0);
  REG_RPL_WR(RPL_SEQRXDN_OUT2_ADDR,
             (REG_RPL_RD(RPL_SEQRXDN_OUT2_ADDR) & ~((uint32_t)0x7FC00000)) |
                 ((uint32_t)rxdnout8 << 22));
}
...
__INLINE void rpl_rx_dn_out7_setf(uint16_t rxdnout7) {
  ASSERT_ERR((((uint32_t)rxdnout7 << 11) & ~((uint32_t)0x000FF800)) == 0);
  REG_RPL_WR(RPL_SEQRXDN_OUT2_ADDR,
             (REG_RPL_RD(RPL_SEQRXDN_OUT2_ADDR) & ~((uint32_t)0x000FF800)) |
                 ((uint32_t)rxdnout7 << 11));
}
...
__INLINE void rpl_rx_dn_out6_setf(uint16_t rxdnout6) {
  ASSERT_ERR((((uint32_t)rxdnout6 << 0) & ~((uint32_t)0x000001FF)) == 0);
  REG_RPL_WR(RPL_SEQRXDN_OUT2_ADDR,
             (REG_RPL_RD(RPL_SEQRXDN_OUT2_ADDR) & ~((uint32_t)0x000001FF)) |
                 ((uint32_t)rxdnout6 << 0));
}
...
__INLINE void rpl_rfswcntl_pack(uint8_t testmuxen, uint8_t selinputbuf,
                                uint8_t selrfsw32, uint8_t selrfsw10) {
  ...
  REG_RPL_WR(RPL_RFSWCNTL_ADDR,
             ((uint32_t)testmuxen << 12) | ((uint32_t)selinputbuf << 8) |
                 ((uint32_t)selrfsw32 << 4) | ((uint32_t)selrfsw10 << 0));
}

__INLINE void rpl_rfswcntl_unpack(uint8_t* testmuxen, uint8_t* selinputbuf,
                                  uint8_t* selrfsw32, uint8_t* selrfsw10) {
...
__INLINE void rpl_testmux_en_setf(uint8_t testmuxen) {
  ASSERT_ERR((((uint32_t)testmuxen << 12) & ~((uint32_t)0x00001000)) == 0);
  REG_RPL_WR(RPL_RFSWCNTL_ADDR,
             (REG_RPL_RD(RPL_RFSWCNTL_ADDR) & ~((uint32_t)0x00001000)) |
                 ((uint32_t)testmuxen << 12));
}
...
__INLINE void rpl_sel_inputbuf_setf(uint8_t selinputbuf) {
  ASSERT_ERR((((uint32_t)selinputbuf << 8) & ~((uint32_t)0x00000300)) == 0);
  REG_RPL_WR(RPL_RFSWCNTL_ADDR,
             (REG_RPL_RD(RPL_RFSWCNTL_ADDR) & ~((uint32_t)0x00000300)) |
                 ((uint32_t)selinputbuf << 8));
}
...
__INLINE void rpl_sel_rfsw32_setf(uint8_t selrfsw32) {
  ASSERT_ERR((((uint32_t)selrfsw32 << 4) & ~((uint32_t)0x00000070)) == 0);
  REG_RPL_WR(RPL_RFSWCNTL_ADDR,
             (REG_RPL_RD(RPL_RFSWCNTL_ADDR) & ~((uint32_t)0x00000070)) |
                 ((uint32_t)selrfsw32 << 4));
}
...
__INLINE void rpl_sel_rfsw10_setf(uint8_t selrfsw10) {
  ASSERT_ERR((((uint32_t)selrfsw10 << 0) & ~((uint32_t)0x00000007)) == 0);
  REG_RPL_WR(RPL_RFSWCNTL_ADDR,
             (REG_RPL_RD(RPL_RFSWCNTL_ADDR) & ~((uint32_t)0x00000007)) |
                 ((uint32_t)selrfsw10 << 0));
}
...
__INLINE void rpl_rpllcntl0_pack(uint8_t forcerpllctrl, uint8_t rplldelta,
                                 uint8_t xo32on, uint8_t xobiastrim,
                                 uint8_t xotesten, uint8_t xoopendrainen,
                                 uint8_t xorefclken, uint8_t xoon,
                                 uint8_t rpllvcorefon, uint8_t rplllocnton,
                                 uint8_t rpllldon, uint8_t rpllvcoon,
                                 uint8_t rpllcpon, uint8_t rplldivon) {
  ...
  REG_RPL_WR(RPL_RPLLCNTL0_ADDR,
             ((uint32_t)forcerpllctrl << 31) | ((uint32_t)rplldelta << 18) |
                 ((uint32_t)xo32on << 14) | ((uint32_t)xobiastrim << 12) |
                 ((uint32_t)xotesten << 11) | ((uint32_t)xoopendrainen << 10) |
                 ((uint32_t)xorefclken << 9) | ((uint32_t)xoon << 8) |
                 ((uint32_t)rpllvcorefon << 5) | ((uint32_t)rplllocnton << 4) |
                 ((uint32_t)rpllldon << 3) | ((uint32_t)rpllvcoon << 2) |
                 ((uint32_t)rpllcpon << 1) | ((uint32_t)rplldivon << 0));
}

__INLINE void rpl_rpllcntl0_unpack(uint8_t* forcerpllctrl, uint8_t* rplldelta,
                                   uint8_t* xo32on, uint8_t* xobiastrim,
                                   uint8_t* xotesten, uint8_t* xoopendrainen,
                                   uint8_t* xorefclken, uint8_t* xoon,
                                   uint8_t* rpllvcorefon, uint8_t* rplllocnton,
...
__INLINE void rpl_force_rpll_ctrl_setf(uint8_t forcerpllctrl) {
  ASSERT_ERR((((uint32_t)forcerpllctrl << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL0_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)forcerpllctrl << 31));
}
...
__INLINE void rpl_rpll_delta_setf(uint8_t rplldelta) {
  ASSERT_ERR((((uint32_t)rplldelta << 18) & ~((uint32_t)0x000C0000)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL0_ADDR) & ~((uint32_t)0x000C0000)) |
                 ((uint32_t)rplldelta << 18));
}
...
__INLINE void rpl_xo32_on_setf(uint8_t xo32on) {
  ASSERT_ERR((((uint32_t)xo32on << 14) & ~((uint32_t)0x00004000)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL0_ADDR) & ~((uint32_t)0x00004000)) |
                 ((uint32_t)xo32on << 14));
}
...
__INLINE void rpl_xo_bias_trim_setf(uint8_t xobiastrim) {
  ASSERT_ERR((((uint32_t)xobiastrim << 12) & ~((uint32_t)0x00003000)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL0_ADDR) & ~((uint32_t)0x00003000)) |
                 ((uint32_t)xobiastrim << 12));
}
...
__INLINE void rpl_xo_test_en_setf(uint8_t xotesten) {
  ASSERT_ERR((((uint32_t)xotesten << 11) & ~((uint32_t)0x00000800)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL0_ADDR) & ~((uint32_t)0x00000800)) |
                 ((uint32_t)xotesten << 11));
}
...
__INLINE void rpl_xo_opendrain_en_setf(uint8_t xoopendrainen) {
  ASSERT_ERR((((uint32_t)xoopendrainen << 10) & ~((uint32_t)0x00000400)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL0_ADDR) & ~((uint32_t)0x00000400)) |
                 ((uint32_t)xoopendrainen << 10));
}
...
__INLINE void rpl_xo_refclk_en_setf(uint8_t xorefclken) {
  ASSERT_ERR((((uint32_t)xorefclken << 9) & ~((uint32_t)0x00000200)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL0_ADDR) & ~((uint32_t)0x00000200)) |
                 ((uint32_t)xorefclken << 9));
}
...
__INLINE void rpl_xo_on_setf(uint8_t xoon) {
  ASSERT_ERR((((uint32_t)xoon << 8) & ~((uint32_t)0x00000100)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL0_ADDR) & ~((uint32_t)0x00000100)) |
                 ((uint32_t)xoon << 8));
}
...
__INLINE void rpl_rpll_vcoref_on_setf(uint8_t rpllvcorefon) {
  ASSERT_ERR((((uint32_t)rpllvcorefon << 5) & ~((uint32_t)0x00000020)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL0_ADDR) & ~((uint32_t)0x00000020)) |
                 ((uint32_t)rpllvcorefon << 5));
}
...
__INLINE void rpl_rpll_locnt_on_setf(uint8_t rplllocnton) {
  ASSERT_ERR((((uint32_t)rplllocnton << 4) & ~((uint32_t)0x00000010)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL0_ADDR) & ~((uint32_t)0x00000010)) |
                 ((uint32_t)rplllocnton << 4));
}
...
__INLINE void rpl_rpll_ld_on_setf(uint8_t rpllldon) {
  ASSERT_ERR((((uint32_t)rpllldon << 3) & ~((uint32_t)0x00000008)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL0_ADDR) & ~((uint32_t)0x00000008)) |
                 ((uint32_t)rpllldon << 3));
}
...
__INLINE void rpl_rpll_vco_on_setf(uint8_t rpllvcoon) {
  ASSERT_ERR((((uint32_t)rpllvcoon << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL0_ADDR) & ~((uint32_t)0x00000004)) |
                 ((uint32_t)rpllvcoon << 2));
}
...
__INLINE void rpl_rpll_cp_on_setf(uint8_t rpllcpon) {
  ASSERT_ERR((((uint32_t)rpllcpon << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL0_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)rpllcpon << 1));
}
...
__INLINE void rpl_rpll_div_on_setf(uint8_t rplldivon) {
  ASSERT_ERR((((uint32_t)rplldivon << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL0_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)rplldivon << 0));
}
...
__INLINE void rpl_rpllcntl1_pack(uint8_t rpllivcobuftrim,
                                 uint8_t rpllvcorefbackupen, uint8_t rpllnref,
                                 uint8_t rpllcptest, uint8_t rpllicpoffset,
                                 uint8_t rpllicp, uint8_t rpllvcofc,
                                 uint8_t rpllivco, uint8_t rpllvcomode) {
  ASSERT_ERR((((uint32_t)rpllivcobuftrim << 24) & ~((uint32_t)0x03000000)) ==
             0);
  ASSERT_ERR((((uint32_t)rpllvcorefbackupen << 22) & ~((uint32_t)0x00400000)) ==
             0);
  ...
  REG_RPL_WR(RPL_RPLLCNTL1_ADDR,
             ((uint32_t)rpllivcobuftrim << 24) |
                 ((uint32_t)rpllvcorefbackupen << 22) |
                 ((uint32_t)rpllnref << 20) | ((uint32_t)rpllcptest << 16) |
                 ((uint32_t)rpllicpoffset << 12) | ((uint32_t)rpllicp << 8) |
                 ((uint32_t)rpllvcofc << 4) | ((uint32_t)rpllivco << 2) |
                 ((uint32_t)rpllvcomode << 0));
}

__INLINE void rpl_rpllcntl1_unpack(uint8_t* rpllivcobuftrim,
                                   uint8_t* rpllvcorefbackupen,
                                   uint8_t* rpllnref, uint8_t* rpllcptest,
                                   uint8_t* rpllicpoffset, uint8_t* rpllicp,
                                   uint8_t* rpllvcofc, uint8_t* rpllivco,
                                   uint8_t* rpllvcomode) {
...
__INLINE void rpl_rpll_ivco_buf_trim_setf(uint8_t rpllivcobuftrim) {
  ASSERT_ERR((((uint32_t)rpllivcobuftrim << 24) & ~((uint32_t)0x03000000)) ==
             0);
  REG_RPL_WR(RPL_RPLLCNTL1_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL1_ADDR) & ~((uint32_t)0x03000000)) |
                 ((uint32_t)rpllivcobuftrim << 24));
}
...
__INLINE void rpl_rpll_vcorefbackup_en_setf(uint8_t rpllvcorefbackupen) {
  ASSERT_ERR((((uint32_t)rpllvcorefbackupen << 22) & ~((uint32_t)0x00400000)) ==
             0);
  REG_RPL_WR(RPL_RPLLCNTL1_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL1_ADDR) & ~((uint32_t)0x00400000)) |
                 ((uint32_t)rpllvcorefbackupen << 22));
}
...
__INLINE void rpl_rpll_nref_setf(uint8_t rpllnref) {
  ASSERT_ERR((((uint32_t)rpllnref << 20) & ~((uint32_t)0x00100000)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL1_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL1_ADDR) & ~((uint32_t)0x00100000)) |
                 ((uint32_t)rpllnref << 20));
}
...
__INLINE void rpl_rpll_cp_test_setf(uint8_t rpllcptest) {
  ASSERT_ERR((((uint32_t)rpllcptest << 16) & ~((uint32_t)0x00070000)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL1_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL1_ADDR) & ~((uint32_t)0x00070000)) |
                 ((uint32_t)rpllcptest << 16));
}
...
__INLINE void rpl_rpll_icp_offset_setf(uint8_t rpllicpoffset) {
  ASSERT_ERR((((uint32_t)rpllicpoffset << 12) & ~((uint32_t)0x00007000)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL1_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL1_ADDR) & ~((uint32_t)0x00007000)) |
                 ((uint32_t)rpllicpoffset << 12));
}
...
__INLINE void rpl_rpll_icp_setf(uint8_t rpllicp) {
  ASSERT_ERR((((uint32_t)rpllicp << 8) & ~((uint32_t)0x00000F00)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL1_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL1_ADDR) & ~((uint32_t)0x00000F00)) |
                 ((uint32_t)rpllicp << 8));
}
...
__INLINE void rpl_rpll_vcofc_setf(uint8_t rpllvcofc) {
  ASSERT_ERR((((uint32_t)rpllvcofc << 4) & ~((uint32_t)0x000000F0)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL1_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL1_ADDR) & ~((uint32_t)0x000000F0)) |
                 ((uint32_t)rpllvcofc << 4));
}
...
__INLINE void rpl_rpll_ivco_setf(uint8_t rpllivco) {
  ASSERT_ERR((((uint32_t)rpllivco << 2) & ~((uint32_t)0x0000000C)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL1_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL1_ADDR) & ~((uint32_t)0x0000000C)) |
                 ((uint32_t)rpllivco << 2));
}
...
__INLINE void rpl_rpll_vco_mode_setf(uint8_t rpllvcomode) {
  ASSERT_ERR((((uint32_t)rpllvcomode << 0) & ~((uint32_t)0x00000003)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL1_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL1_ADDR) & ~((uint32_t)0x00000003)) |
                 ((uint32_t)rpllvcomode << 0));
}
...
__INLINE void rpl_rpllcntl2_pack(uint8_t rpllldfrefinven,
                                 uint8_t rpllldfdivinven, uint8_t rplledgescomp,
                                 uint8_t rpllfedetectval,
                                 uint8_t rpllredetectval, uint8_t rpllunlockcnt,
                                 uint8_t rplllockcnt) {
  ASSERT_ERR((((uint32_t)rpllldfrefinven << 21) & ~((uint32_t)0x00200000)) ==
             0);
  ASSERT_ERR((((uint32_t)rpllldfdivinven << 20) & ~((uint32_t)0x00100000)) ==
             0);
  ASSERT_ERR((((uint32_t)rplledgescomp << 18) & ~((uint32_t)0x000C0000)) == 0);
  ASSERT_ERR((((uint32_t)rpllfedetectval << 17) & ~((uint32_t)0x00020000)) ==
             0);
  ASSERT_ERR((((uint32_t)rpllredetectval << 16) & ~((uint32_t)0x00010000)) ==
             0);
  ASSERT_ERR((((uint32_t)rpllunlockcnt << 8) & ~((uint32_t)0x00000F00)) == 0);
  ASSERT_ERR((((uint32_t)rplllockcnt << 0) & ~((uint32_t)0x000000FF)) == 0);
  REG_RPL_WR(
      RPL_RPLLCNTL2_ADDR,
      ((uint32_t)rpllldfrefinven << 21) | ((uint32_t)rpllldfdivinven << 20) |
          ((uint32_t)rplledgescomp << 18) | ((uint32_t)rpllfedetectval << 17) |
          ((uint32_t)rpllredetectval << 16) | ((uint32_t)rpllunlockcnt << 8) |
          ((uint32_t)rplllockcnt << 0));
}

__INLINE void rpl_rpllcntl2_unpack(
    uint8_t* rpllldfrefinven, uint8_t* rpllldfdivinven, uint8_t* rplledgescomp,
    uint8_t* rpllfedetectval, uint8_t* rpllredetectval, uint8_t* rpllunlockcnt,
    uint8_t* rplllockcnt) {
...
__INLINE void rpl_rpll_ld_fref_inv_en_setf(uint8_t rpllldfrefinven) {
  ASSERT_ERR((((uint32_t)rpllldfrefinven << 21) & ~((uint32_t)0x00200000)) ==
             0);
  REG_RPL_WR(RPL_RPLLCNTL2_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL2_ADDR) & ~((uint32_t)0x00200000)) |
                 ((uint32_t)rpllldfrefinven << 21));
}
...
__INLINE void rpl_rpll_ld_fdiv_inv_en_setf(uint8_t rpllldfdivinven) {
  ASSERT_ERR((((uint32_t)rpllldfdivinven << 20) & ~((uint32_t)0x00100000)) ==
             0);
  REG_RPL_WR(RPL_RPLLCNTL2_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL2_ADDR) & ~((uint32_t)0x00100000)) |
                 ((uint32_t)rpllldfdivinven << 20));
}
...
__INLINE void rpl_rpll_edges_comp_setf(uint8_t rplledgescomp) {
  ASSERT_ERR((((uint32_t)rplledgescomp << 18) & ~((uint32_t)0x000C0000)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL2_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL2_ADDR) & ~((uint32_t)0x000C0000)) |
                 ((uint32_t)rplledgescomp << 18));
}
...
__INLINE void rpl_rpll_fe_detect_val_setf(uint8_t rpllfedetectval) {
  ASSERT_ERR((((uint32_t)rpllfedetectval << 17) & ~((uint32_t)0x00020000)) ==
             0);
  REG_RPL_WR(RPL_RPLLCNTL2_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL2_ADDR) & ~((uint32_t)0x00020000)) |
                 ((uint32_t)rpllfedetectval << 17));
}
...
__INLINE void rpl_rpll_re_detect_val_setf(uint8_t rpllredetectval) {
  ASSERT_ERR((((uint32_t)rpllredetectval << 16) & ~((uint32_t)0x00010000)) ==
             0);
  REG_RPL_WR(RPL_RPLLCNTL2_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL2_ADDR) & ~((uint32_t)0x00010000)) |
                 ((uint32_t)rpllredetectval << 16));
}
...
__INLINE void rpl_rpll_unlock_cnt_setf(uint8_t rpllunlockcnt) {
  ASSERT_ERR((((uint32_t)rpllunlockcnt << 8) & ~((uint32_t)0x00000F00)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL2_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL2_ADDR) & ~((uint32_t)0x00000F00)) |
                 ((uint32_t)rpllunlockcnt << 8));
}
...
__INLINE void rpl_rpll_lock_cnt_setf(uint8_t rplllockcnt) {
  ASSERT_ERR((((uint32_t)rplllockcnt << 0) & ~((uint32_t)0x000000FF)) == 0);
  REG_RPL_WR(RPL_RPLLCNTL2_ADDR,
             (REG_RPL_RD(RPL_RPLLCNTL2_ADDR) & ~((uint32_t)0x000000FF)) |
                 ((uint32_t)rplllockcnt << 0));
}
...
__INLINE void rpl_rfpllstat_unpack(uint16_t* rplllocntval,
                                   uint8_t* rplllocntdone,
                                   uint8_t* fifooverflow, uint8_t* rplllocked) {
...
__INLINE void rpl_rpllsdcntl0_pack(uint32_t rplln0fract, uint8_t rplln0int) {
  ...
  REG_RPL_WR(RPL_RPLLSDCNTL0_ADDR,
             ((uint32_t)rplln0fract << 8) | ((uint32_t)rplln0int << 0));
}

__INLINE void rpl_rpllsdcntl0_unpack(uint32_t* rplln0fract,
                                     uint8_t* rplln0int) {
...
__INLINE void rpl_rpll_n0fract_setf(uint32_t rplln0fract) {
  ASSERT_ERR((((uint32_t)rplln0fract << 8) & ~((uint32_t)0xFFFFFF00)) == 0);
  REG_RPL_WR(RPL_RPLLSDCNTL0_ADDR,
             (REG_RPL_RD(RPL_RPLLSDCNTL0_ADDR) & ~((uint32_t)0xFFFFFF00)) |
                 ((uint32_t)rplln0fract << 8));
}
...
__INLINE void rpl_rpll_n0int_setf(uint8_t rplln0int) {
  ASSERT_ERR((((uint32_t)rplln0int << 0) & ~((uint32_t)0x000000FF)) == 0);
  REG_RPL_WR(RPL_RPLLSDCNTL0_ADDR,
             (REG_RPL_RD(RPL_RPLLSDCNTL0_ADDR) & ~((uint32_t)0x000000FF)) |
                 ((uint32_t)rplln0int << 0));
}
...
__INLINE void rpl_rpllsdcntl2_pack(uint8_t btledumoen,
                                   uint8_t btlefilterscaling,
                                   uint8_t filterscaling, uint8_t fmtx2pen,
                                   uint8_t fmtxen, uint8_t sdditheren,
                                   uint8_t rpllsdorder, uint8_t rpllfracen) {
  ASSERT_ERR((((uint32_t)btledumoen << 31) & ~((uint32_t)0x80000000)) == 0);
  ASSERT_ERR((((uint32_t)btlefilterscaling << 16) & ~((uint32_t)0x00FF0000)) ==
             0);
  ...
  REG_RPL_WR(RPL_RPLLSDCNTL2_ADDR,
             ((uint32_t)btledumoen << 31) |
                 ((uint32_t)btlefilterscaling << 16) |
                 ((uint32_t)filterscaling << 8) | ((uint32_t)fmtx2pen << 5) |
                 ((uint32_t)fmtxen << 4) | ((uint32_t)sdditheren << 3) |
                 ((uint32_t)rpllsdorder << 1) | ((uint32_t)rpllfracen << 0));
}

__INLINE void rpl_rpllsdcntl2_unpack(uint8_t* btledumoen,
                                     uint8_t* btlefilterscaling,
                                     uint8_t* filterscaling, uint8_t* fmtx2pen,
                                     uint8_t* fmtxen, uint8_t* sdditheren,
                                     uint8_t* rpllsdorder,
...
__INLINE void rpl_btle_dumo_en_setf(uint8_t btledumoen) {
  ASSERT_ERR((((uint32_t)btledumoen << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_RPL_WR(RPL_RPLLSDCNTL2_ADDR,
             (REG_RPL_RD(RPL_RPLLSDCNTL2_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)btledumoen << 31));
}
...
__INLINE void rpl_btle_filter_scaling_setf(uint8_t btlefilterscaling) {
  ASSERT_ERR((((uint32_t)btlefilterscaling << 16) & ~((uint32_t)0x00FF0000)) ==
             0);
  REG_RPL_WR(RPL_RPLLSDCNTL2_ADDR,
             (REG_RPL_RD(RPL_RPLLSDCNTL2_ADDR) & ~((uint32_t)0x00FF0000)) |
                 ((uint32_t)btlefilterscaling << 16));
}
...
__INLINE void rpl_filter_scaling_setf(uint8_t filterscaling) {
  ASSERT_ERR((((uint32_t)filterscaling << 8) & ~((uint32_t)0x0000FF00)) == 0);
  REG_RPL_WR(RPL_RPLLSDCNTL2_ADDR,
             (REG_RPL_RD(RPL_RPLLSDCNTL2_ADDR) & ~((uint32_t)0x0000FF00)) |
                 ((uint32_t)filterscaling << 8));
}
...
__INLINE void rpl_fmtx2p_en_setf(uint8_t fmtx2pen) {
  ASSERT_ERR((((uint32_t)fmtx2pen << 5) & ~((uint32_t)0x00000020)) == 0);
  REG_RPL_WR(RPL_RPLLSDCNTL2_ADDR,
             (REG_RPL_RD(RPL_RPLLSDCNTL2_ADDR) & ~((uint32_t)0x00000020)) |
                 ((uint32_t)fmtx2pen << 5));
}
...
__INLINE void rpl_fmtx_en_setf(uint8_t fmtxen) {
  ASSERT_ERR((((uint32_t)fmtxen << 4) & ~((uint32_t)0x00000010)) == 0);
  REG_RPL_WR(RPL_RPLLSDCNTL2_ADDR,
             (REG_RPL_RD(RPL_RPLLSDCNTL2_ADDR) & ~((uint32_t)0x00000010)) |
                 ((uint32_t)fmtxen << 4));
}
...
__INLINE void rpl_sddither_en_setf(uint8_t sdditheren) {
  ASSERT_ERR((((uint32_t)sdditheren << 3) & ~((uint32_t)0x00000008)) == 0);
  REG_RPL_WR(RPL_RPLLSDCNTL2_ADDR,
             (REG_RPL_RD(RPL_RPLLSDCNTL2_ADDR) & ~((uint32_t)0x00000008)) |
                 ((uint32_t)sdditheren << 3));
}
...
__INLINE void rpl_rpll_sdorder_setf(uint8_t rpllsdorder) {
  ASSERT_ERR((((uint32_t)rpllsdorder << 1) & ~((uint32_t)0x00000006)) == 0);
  REG_RPL_WR(RPL_RPLLSDCNTL2_ADDR,
             (REG_RPL_RD(RPL_RPLLSDCNTL2_ADDR) & ~((uint32_t)0x00000006)) |
                 ((uint32_t)rpllsdorder << 1));
}
...
__INLINE void rpl_rpll_frac_en_setf(uint8_t rpllfracen) {
  ASSERT_ERR((((uint32_t)rpllfracen << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(RPL_RPLLSDCNTL2_ADDR,
             (REG_RPL_RD(RPL_RPLLSDCNTL2_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)rpllfracen << 0));
}
...
__INLINE void rpl_rpllmash_init_pack(uint8_t mashsdi4, uint8_t mashsdi3,
                                     uint8_t mashsdi2, uint8_t mashsdi1) {
  ...
  REG_RPL_WR(RPL_RPLLMASH_INIT_ADDR,
             ((uint32_t)mashsdi4 << 24) | ((uint32_t)mashsdi3 << 16) |
                 ((uint32_t)mashsdi2 << 8) | ((uint32_t)mashsdi1 << 0));
}

__INLINE void rpl_rpllmash_init_unpack(uint8_t* mashsdi4, uint8_t* mashsdi3,
                                       uint8_t* mashsdi2, uint8_t* mashsdi1) {
...
__INLINE void rpl_mash_sdi4_setf(uint8_t mashsdi4) {
  ASSERT_ERR((((uint32_t)mashsdi4 << 24) & ~((uint32_t)0xFF000000)) == 0);
  REG_RPL_WR(RPL_RPLLMASH_INIT_ADDR,
             (REG_RPL_RD(RPL_RPLLMASH_INIT_ADDR) & ~((uint32_t)0xFF000000)) |
                 ((uint32_t)mashsdi4 << 24));
}
...
__INLINE void rpl_mash_sdi3_setf(uint8_t mashsdi3) {
  ASSERT_ERR((((uint32_t)mashsdi3 << 16) & ~((uint32_t)0x00FF0000)) == 0);
  REG_RPL_WR(RPL_RPLLMASH_INIT_ADDR,
             (REG_RPL_RD(RPL_RPLLMASH_INIT_ADDR) & ~((uint32_t)0x00FF0000)) |
                 ((uint32_t)mashsdi3 << 16));
}
...
__INLINE void rpl_mash_sdi2_setf(uint8_t mashsdi2) {
  ASSERT_ERR((((uint32_t)mashsdi2 << 8) & ~((uint32_t)0x0000FF00)) == 0);
  REG_RPL_WR(RPL_RPLLMASH_INIT_ADDR,
             (REG_RPL_RD(RPL_RPLLMASH_INIT_ADDR) & ~((uint32_t)0x0000FF00)) |
                 ((uint32_t)mashsdi2 << 8));
}
...
__INLINE void rpl_mash_sdi1_setf(uint8_t mashsdi1) {
  ASSERT_ERR((((uint32_t)mashsdi1 << 0) & ~((uint32_t)0x000000FF)) == 0);
  REG_RPL_WR(RPL_RPLLMASH_INIT_ADDR,
             (REG_RPL_RD(RPL_RPLLMASH_INIT_ADDR) & ~((uint32_t)0x000000FF)) |
                 ((uint32_t)mashsdi1 << 0));
}
...
__INLINE void rpl_dpllcntl0_pack(uint8_t forcedpllctrl, uint8_t dpllldon,
                                 uint8_t dpllvcoon, uint8_t dpllcpon) {
  ...
  REG_RPL_WR(RPL_DPLLCNTL0_ADDR,
             ((uint32_t)forcedpllctrl << 31) | ((uint32_t)dpllldon << 3) |
                 ((uint32_t)dpllvcoon << 2) | ((uint32_t)dpllcpon << 1));
}

__INLINE void rpl_dpllcntl0_unpack(uint8_t* forcedpllctrl, uint8_t* dpllldon,
                                   uint8_t* dpllvcoon, uint8_t* dpllcpon) {
...
__INLINE void rpl_force_dpll_ctrl_setf(uint8_t forcedpllctrl) {
  ASSERT_ERR((((uint32_t)forcedpllctrl << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL0_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)forcedpllctrl << 31));
}
...
__INLINE void rpl_dpll_ld_on_setf(uint8_t dpllldon) {
  ASSERT_ERR((((uint32_t)dpllldon << 3) & ~((uint32_t)0x00000008)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL0_ADDR) & ~((uint32_t)0x00000008)) |
                 ((uint32_t)dpllldon << 3));
}
...
__INLINE void rpl_dpll_vco_on_setf(uint8_t dpllvcoon) {
  ASSERT_ERR((((uint32_t)dpllvcoon << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL0_ADDR) & ~((uint32_t)0x00000004)) |
                 ((uint32_t)dpllvcoon << 2));
}
...
__INLINE void rpl_dpll_cp_on_setf(uint8_t dpllcpon) {
  ASSERT_ERR((((uint32_t)dpllcpon << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL0_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL0_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)dpllcpon << 1));
}
...
__INLINE void rpl_dpllcntl1_pack(uint8_t dplldivr, uint8_t dplldivp,
                                 uint16_t dpllnfract, uint8_t dpllnint) {
  ...
  REG_RPL_WR(RPL_DPLLCNTL1_ADDR,
             ((uint32_t)dplldivr << 28) | ((uint32_t)dplldivp << 24) |
                 ((uint32_t)dpllnfract << 8) | ((uint32_t)dpllnint << 0));
}

__INLINE void rpl_dpllcntl1_unpack(uint8_t* dplldivr, uint8_t* dplldivp,
                                   uint16_t* dpllnfract, uint8_t* dpllnint) {
...
__INLINE void rpl_dpll_divr_setf(uint8_t dplldivr) {
  ASSERT_ERR((((uint32_t)dplldivr << 28) & ~((uint32_t)0x30000000)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL1_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL1_ADDR) & ~((uint32_t)0x30000000)) |
                 ((uint32_t)dplldivr << 28));
}
...
__INLINE void rpl_dpll_divp_setf(uint8_t dplldivp) {
  ASSERT_ERR((((uint32_t)dplldivp << 24) & ~((uint32_t)0x07000000)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL1_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL1_ADDR) & ~((uint32_t)0x07000000)) |
                 ((uint32_t)dplldivp << 24));
}
...
__INLINE void rpl_dpll_nfract_setf(uint16_t dpllnfract) {
  ASSERT_ERR((((uint32_t)dpllnfract << 8) & ~((uint32_t)0x00FFFF00)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL1_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL1_ADDR) & ~((uint32_t)0x00FFFF00)) |
                 ((uint32_t)dpllnfract << 8));
}
...
__INLINE void rpl_dpll_nint_setf(uint8_t dpllnint) {
  ASSERT_ERR((((uint32_t)dpllnint << 0) & ~((uint32_t)0x0000001F)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL1_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL1_ADDR) & ~((uint32_t)0x0000001F)) |
                 ((uint32_t)dpllnint << 0));
}
...
__INLINE void rpl_dpllcntl2_pack(uint8_t dpllsdorder, uint8_t dpllicpoffset,
                                 uint8_t dpllvcocfg, uint8_t dpllpfdcfg,
                                 uint8_t dpllicp, uint8_t dplltesten,
                                 uint8_t dpllvcospeedupen, uint8_t dpllfracten,
                                 uint8_t dplldtpen) {
  ...
  ASSERT_ERR((((uint32_t)dpllvcospeedupen << 2) & ~((uint32_t)0x00000004)) ==
             0);
  ASSERT_ERR((((uint32_t)dpllfracten << 1) & ~((uint32_t)0x00000002)) == 0);
  ASSERT_ERR((((uint32_t)dplldtpen << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL2_ADDR,
             ((uint32_t)dpllsdorder << 16) | ((uint32_t)dpllicpoffset << 12) |
                 ((uint32_t)dpllvcocfg << 11) | ((uint32_t)dpllpfdcfg << 8) |
                 ((uint32_t)dpllicp << 4) | ((uint32_t)dplltesten << 3) |
                 ((uint32_t)dpllvcospeedupen << 2) |
                 ((uint32_t)dpllfracten << 1) | ((uint32_t)dplldtpen << 0));
}

__INLINE void rpl_dpllcntl2_unpack(uint8_t* dpllsdorder, uint8_t* dpllicpoffset,
                                   uint8_t* dpllvcocfg, uint8_t* dpllpfdcfg,
                                   uint8_t* dpllicp, uint8_t* dplltesten,
                                   uint8_t* dpllvcospeedupen,
                                   uint8_t* dpllfracten, uint8_t* dplldtpen) {
...
__INLINE void rpl_dpll_sdorder_setf(uint8_t dpllsdorder) {
  ASSERT_ERR((((uint32_t)dpllsdorder << 16) & ~((uint32_t)0x00030000)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL2_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL2_ADDR) & ~((uint32_t)0x00030000)) |
                 ((uint32_t)dpllsdorder << 16));
}
...
__INLINE void rpl_dpll_icp_offset_setf(uint8_t dpllicpoffset) {
  ASSERT_ERR((((uint32_t)dpllicpoffset << 12) & ~((uint32_t)0x00007000)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL2_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL2_ADDR) & ~((uint32_t)0x00007000)) |
                 ((uint32_t)dpllicpoffset << 12));
}
...
__INLINE void rpl_dpll_vco_cfg_setf(uint8_t dpllvcocfg) {
  ASSERT_ERR((((uint32_t)dpllvcocfg << 11) & ~((uint32_t)0x00000800)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL2_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL2_ADDR) & ~((uint32_t)0x00000800)) |
                 ((uint32_t)dpllvcocfg << 11));
}
...
__INLINE void rpl_dpll_pfd_cfg_setf(uint8_t dpllpfdcfg) {
  ASSERT_ERR((((uint32_t)dpllpfdcfg << 8) & ~((uint32_t)0x00000700)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL2_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL2_ADDR) & ~((uint32_t)0x00000700)) |
                 ((uint32_t)dpllpfdcfg << 8));
}
...
__INLINE void rpl_dpll_icp_setf(uint8_t dpllicp) {
  ASSERT_ERR((((uint32_t)dpllicp << 4) & ~((uint32_t)0x000000F0)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL2_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL2_ADDR) & ~((uint32_t)0x000000F0)) |
                 ((uint32_t)dpllicp << 4));
}
...
__INLINE void rpl_dpll_test_en_setf(uint8_t dplltesten) {
  ASSERT_ERR((((uint32_t)dplltesten << 3) & ~((uint32_t)0x00000008)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL2_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL2_ADDR) & ~((uint32_t)0x00000008)) |
                 ((uint32_t)dplltesten << 3));
}
...
__INLINE void rpl_dpll_vco_speedup_en_setf(uint8_t dpllvcospeedupen) {
  ASSERT_ERR((((uint32_t)dpllvcospeedupen << 2) & ~((uint32_t)0x00000004)) ==
             0);
  REG_RPL_WR(RPL_DPLLCNTL2_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL2_ADDR) & ~((uint32_t)0x00000004)) |
                 ((uint32_t)dpllvcospeedupen << 2));
}
...
__INLINE void rpl_dpll_fract_en_setf(uint8_t dpllfracten) {
  ASSERT_ERR((((uint32_t)dpllfracten << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL2_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL2_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)dpllfracten << 1));
}
...
__INLINE void rpl_dpll_dtp_en_setf(uint8_t dplldtpen) {
  ASSERT_ERR((((uint32_t)dplldtpen << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL2_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL2_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)dplldtpen << 0));
}
...
__INLINE void rpl_dpllcntl3_pack(uint8_t dpllldfrefclkinven,
                                 uint8_t dpllldfdivclkinven,
                                 uint8_t dpllldedgescomb, uint8_t dpllldfe,
                                 uint8_t dpllldre, uint8_t dpllldunlockcnt,
                                 uint8_t dpllldlockcnt) {
  ASSERT_ERR((((uint32_t)dpllldfrefclkinven << 21) & ~((uint32_t)0x00200000)) ==
             0);
  ASSERT_ERR((((uint32_t)dpllldfdivclkinven << 20) & ~((uint32_t)0x00100000)) ==
             0);
  ASSERT_ERR((((uint32_t)dpllldedgescomb << 18) & ~((uint32_t)0x000C0000)) ==
             0);
  ...
  REG_RPL_WR(RPL_DPLLCNTL3_ADDR, ((uint32_t)dpllldfrefclkinven << 21) |
                                     ((uint32_t)dpllldfdivclkinven << 20) |
                                     ((uint32_t)dpllldedgescomb << 18) |
                                     ((uint32_t)dpllldfe << 17) |
                                     ((uint32_t)dpllldre << 16) |
                                     ((uint32_t)dpllldunlockcnt << 8) |
                                     ((uint32_t)dpllldlockcnt << 0));
}

__INLINE void rpl_dpllcntl3_unpack(uint8_t* dpllldfrefclkinven,
                                   uint8_t* dpllldfdivclkinven,
                                   uint8_t* dpllldedgescomb, uint8_t* dpllldfe,
                                   uint8_t* dpllldre, uint8_t* dpllldunlockcnt,
                                   uint8_t* dpllldlockcnt) {
...
__INLINE void rpl_dpll_ld_fref_clk_inv_en_setf(uint8_t dpllldfrefclkinven) {
  ASSERT_ERR((((uint32_t)dpllldfrefclkinven << 21) & ~((uint32_t)0x00200000)) ==
             0);
  REG_RPL_WR(RPL_DPLLCNTL3_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL3_ADDR) & ~((uint32_t)0x00200000)) |
                 ((uint32_t)dpllldfrefclkinven << 21));
}
...
__INLINE void rpl_dpll_ld_fdiv_clk_inv_en_setf(uint8_t dpllldfdivclkinven) {
  ASSERT_ERR((((uint32_t)dpllldfdivclkinven << 20) & ~((uint32_t)0x00100000)) ==
             0);
  REG_RPL_WR(RPL_DPLLCNTL3_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL3_ADDR) & ~((uint32_t)0x00100000)) |
                 ((uint32_t)dpllldfdivclkinven << 20));
}
...
__INLINE void rpl_dpll_ld_edges_comb_setf(uint8_t dpllldedgescomb) {
  ASSERT_ERR((((uint32_t)dpllldedgescomb << 18) & ~((uint32_t)0x000C0000)) ==
             0);
  REG_RPL_WR(RPL_DPLLCNTL3_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL3_ADDR) & ~((uint32_t)0x000C0000)) |
                 ((uint32_t)dpllldedgescomb << 18));
}
...
__INLINE void rpl_dpll_ld_fe_setf(uint8_t dpllldfe) {
  ASSERT_ERR((((uint32_t)dpllldfe << 17) & ~((uint32_t)0x00020000)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL3_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL3_ADDR) & ~((uint32_t)0x00020000)) |
                 ((uint32_t)dpllldfe << 17));
}
...
__INLINE void rpl_dpll_ld_re_setf(uint8_t dpllldre) {
  ASSERT_ERR((((uint32_t)dpllldre << 16) & ~((uint32_t)0x00010000)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL3_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL3_ADDR) & ~((uint32_t)0x00010000)) |
                 ((uint32_t)dpllldre << 16));
}
...
__INLINE void rpl_dpll_ld_unlock_cnt_setf(uint8_t dpllldunlockcnt) {
  ASSERT_ERR((((uint32_t)dpllldunlockcnt << 8) & ~((uint32_t)0x0000FF00)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL3_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL3_ADDR) & ~((uint32_t)0x0000FF00)) |
                 ((uint32_t)dpllldunlockcnt << 8));
}
...
__INLINE void rpl_dpll_ld_lock_cnt_setf(uint8_t dpllldlockcnt) {
  ASSERT_ERR((((uint32_t)dpllldlockcnt << 0) & ~((uint32_t)0x000000FF)) == 0);
  REG_RPL_WR(RPL_DPLLCNTL3_ADDR,
             (REG_RPL_RD(RPL_DPLLCNTL3_ADDR) & ~((uint32_t)0x000000FF)) |
                 ((uint32_t)dpllldlockcnt << 0));
}
...
__INLINE void rpl_dpllstat_unpack(uint8_t* dpllvcoclkok,
                                  uint8_t* dplllockdetect) {
...
__INLINE void rpl_rc_calib_cntl_pack(
    uint8_t filtrcval, uint8_t rpllrcval, uint8_t dpllrcval,
    uint8_t filtrccalclken, uint8_t rpllrccalclken, uint8_t dpllrccalclken,
    uint8_t filtrccalnosc, uint8_t rpllrccalnosc, uint8_t dpllrccalnosc,
    uint8_t filtrccalon, uint8_t rpllrccalon, uint8_t dpllrccalon) {
  ...
  REG_RPL_WR(
      RPL_RC_CALIB_CNTL_ADDR,
      ((uint32_t)filtrcval << 28) | ((uint32_t)rpllrcval << 24) |
          ((uint32_t)dpllrcval << 16) | ((uint32_t)filtrccalclken << 11) |
          ((uint32_t)rpllrccalclken << 10) | ((uint32_t)dpllrccalclken << 9) |
          ((uint32_t)filtrccalnosc << 8) | ((uint32_t)rpllrccalnosc << 7) |
          ((uint32_t)dpllrccalnosc << 6) | ((uint32_t)filtrccalon << 2) |
          ((uint32_t)rpllrccalon << 1) | ((uint32_t)dpllrccalon << 0));
}

__INLINE void rpl_rc_calib_cntl_unpack(
    uint8_t* filtrcval, uint8_t* rpllrcval, uint8_t* dpllrcval,
    uint8_t* filtrccalclken, uint8_t* rpllrccalclken, uint8_t* dpllrccalclken,
    uint8_t* filtrccalnosc, uint8_t* rpllrccalnosc, uint8_t* dpllrccalnosc,
    uint8_t* filtrccalon, uint8_t* rpllrccalon, uint8_t* dpllrccalon) {
...
__INLINE void rpl_filt_rc_val_setf(uint8_t filtrcval) {
  ASSERT_ERR((((uint32_t)filtrcval << 28) & ~((uint32_t)0xF0000000)) == 0);
  REG_RPL_WR(RPL_RC_CALIB_CNTL_ADDR,
             (REG_RPL_RD(RPL_RC_CALIB_CNTL_ADDR) & ~((uint32_t)0xF0000000)) |
                 ((uint32_t)filtrcval << 28));
}
...
__INLINE void rpl_rpll_rc_val_setf(uint8_t rpllrcval) {
  ASSERT_ERR((((uint32_t)rpllrcval << 24) & ~((uint32_t)0x0F000000)) == 0);
  REG_RPL_WR(RPL_RC_CALIB_CNTL_ADDR,
             (REG_RPL_RD(RPL_RC_CALIB_CNTL_ADDR) & ~((uint32_t)0x0F000000)) |
                 ((uint32_t)rpllrcval << 24));
}
...
__INLINE void rpl_dpll_rc_val_setf(uint8_t dpllrcval) {
  ASSERT_ERR((((uint32_t)dpllrcval << 16) & ~((uint32_t)0x003F0000)) == 0);
  REG_RPL_WR(RPL_RC_CALIB_CNTL_ADDR,
             (REG_RPL_RD(RPL_RC_CALIB_CNTL_ADDR) & ~((uint32_t)0x003F0000)) |
                 ((uint32_t)dpllrcval << 16));
}
...
__INLINE void rpl_filt_rccal_clk_en_setf(uint8_t filtrccalclken) {
  ASSERT_ERR((((uint32_t)filtrccalclken << 11) & ~((uint32_t)0x00000800)) == 0);
  REG_RPL_WR(RPL_RC_CALIB_CNTL_ADDR,
             (REG_RPL_RD(RPL_RC_CALIB_CNTL_ADDR) & ~((uint32_t)0x00000800)) |
                 ((uint32_t)filtrccalclken << 11));
}
...
__INLINE void rpl_rpll_rccal_clk_en_setf(uint8_t rpllrccalclken) {
  ASSERT_ERR((((uint32_t)rpllrccalclken << 10) & ~((uint32_t)0x00000400)) == 0);
  REG_RPL_WR(RPL_RC_CALIB_CNTL_ADDR,
             (REG_RPL_RD(RPL_RC_CALIB_CNTL_ADDR) & ~((uint32_t)0x00000400)) |
                 ((uint32_t)rpllrccalclken << 10));
}
...
__INLINE void rpl_dpll_rccal_clk_en_setf(uint8_t dpllrccalclken) {
  ASSERT_ERR((((uint32_t)dpllrccalclken << 9) & ~((uint32_t)0x00000200)) == 0);
  REG_RPL_WR(RPL_RC_CALIB_CNTL_ADDR,
             (REG_RPL_RD(RPL_RC_CALIB_CNTL_ADDR) & ~((uint32_t)0x00000200)) |
                 ((uint32_t)dpllrccalclken << 9));
}
...
__INLINE void rpl_filt_rccal_nosc_setf(uint8_t filtrccalnosc) {
  ASSERT_ERR((((uint32_t)filtrccalnosc << 8) & ~((uint32_t)0x00000100)) == 0);
  REG_RPL_WR(RPL_RC_CALIB_CNTL_ADDR,
             (REG_RPL_RD(RPL_RC_CALIB_CNTL_ADDR) & ~((uint32_t)0x00000100)) |
                 ((uint32_t)filtrccalnosc << 8));
}
...
__INLINE void rpl_rpll_rccal_nosc_setf(uint8_t rpllrccalnosc) {
  ASSERT_ERR((((uint32_t)rpllrccalnosc << 7) & ~((uint32_t)0x00000080)) == 0);
  REG_RPL_WR(RPL_RC_CALIB_CNTL_ADDR,
             (REG_RPL_RD(RPL_RC_CALIB_CNTL_ADDR) & ~((uint32_t)0x00000080)) |
                 ((uint32_t)rpllrccalnosc << 7));
}
...
__INLINE void rpl_dpll_rccal_nosc_setf(uint8_t dpllrccalnosc) {
  ASSERT_ERR((((uint32_t)dpllrccalnosc << 6) & ~((uint32_t)0x00000040)) == 0);
  REG_RPL_WR(RPL_RC_CALIB_CNTL_ADDR,
             (REG_RPL_RD(RPL_RC_CALIB_CNTL_ADDR) & ~((uint32_t)0x00000040)) |
                 ((uint32_t)dpllrccalnosc << 6));
}
...
__INLINE void rpl_filt_rccal_on_setf(uint8_t filtrccalon) {
  ASSERT_ERR((((uint32_t)filtrccalon << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_RPL_WR(RPL_RC_CALIB_CNTL_ADDR,
             (REG_RPL_RD(RPL_RC_CALIB_CNTL_ADDR) & ~((uint32_t)0x00000004)) |
                 ((uint32_t)filtrccalon << 2));
}
...
__INLINE void rpl_rpll_rccal_on_setf(uint8_t rpllrccalon) {
  ASSERT_ERR((((uint32_t)rpllrccalon << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_RPL_WR(RPL_RC_CALIB_CNTL_ADDR,
             (REG_RPL_RD(RPL_RC_CALIB_CNTL_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)rpllrccalon << 1));
}
...
__INLINE void rpl_dpll_rccal_on_setf(uint8_t dpllrccalon) {
  ASSERT_ERR((((uint32_t)dpllrccalon << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(RPL_RC_CALIB_CNTL_ADDR,
             (REG_RPL_RD(RPL_RC_CALIB_CNTL_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)dpllrccalon << 0));
}
...
__INLINE void rpl_pll_rc_calib_stat_unpack(uint16_t* rpllrccalbtunestat,
                                           uint8_t* rpllrccaldone,
                                           uint16_t* dpllrccalbtunestat,
                                           uint8_t* dpllrccaldone) {
...
__INLINE void rpl_filter_rc_calib_stat_unpack(uint16_t* filtrccalbtunestat,
                                              uint8_t* filtrccaldone) {
...
__INLINE void rpl_vcofc_icp_calibcntl_pack(uint8_t lutldin, uint8_t luticpin,
                                           uint8_t lutvcofcin,
                                           uint8_t lutvcofcicpwen,
                                           uint8_t lutvcofcicpadd) {
  ...
  REG_RPL_WR(RPL_VCOFC_ICP_CALIBCNTL_ADDR,
             ((uint32_t)lutldin << 16) | ((uint32_t)luticpin << 12) |
                 ((uint32_t)lutvcofcin << 8) | ((uint32_t)lutvcofcicpwen << 7) |
                 ((uint32_t)lutvcofcicpadd << 0));
}

__INLINE void rpl_vcofc_icp_calibcntl_unpack(uint8_t* lutldin,
                                             uint8_t* luticpin,
                                             uint8_t* lutvcofcin,
                                             uint8_t* lutvcofcicpwen,
                                             uint8_t* lutvcofcicpadd) {
...
__INLINE void rpl_lut_ld_in_setf(uint8_t lutldin) {
  ASSERT_ERR((((uint32_t)lutldin << 16) & ~((uint32_t)0x00010000)) == 0);
  REG_RPL_WR(
      RPL_VCOFC_ICP_CALIBCNTL_ADDR,
      (REG_RPL_RD(RPL_VCOFC_ICP_CALIBCNTL_ADDR) & ~((uint32_t)0x00010000)) |
          ((uint32_t)lutldin << 16));
}
...
__INLINE void rpl_lut_icp_in_setf(uint8_t luticpin) {
  ...
  REG_RPL_WR(
      RPL_VCOFC_ICP_CALIBCNTL_ADDR,
      (REG_RPL_RD(RPL_VCOFC_ICP_CALIBCNTL_ADDR) & ~((uint32_t)0x0000F000)) |
          ((uint32_t)luticpin << 12));
}
...
__INLINE void rpl_lut_vcofc_in_setf(uint8_t lutvcofcin) {
  ...
  REG_RPL_WR(
      RPL_VCOFC_ICP_CALIBCNTL_ADDR,
      (REG_RPL_RD(RPL_VCOFC_ICP_CALIBCNTL_ADDR) & ~((uint32_t)0x00000F00)) |
          ((uint32_t)lutvcofcin << 8));
}
...
__INLINE void rpl_lut_vcofc_icp_wen_setf(uint8_t lutvcofcicpwen) {
  ...
  REG_RPL_WR(
      RPL_VCOFC_ICP_CALIBCNTL_ADDR,
      (REG_RPL_RD(RPL_VCOFC_ICP_CALIBCNTL_ADDR) & ~((uint32_t)0x00000080)) |
          ((uint32_t)lutvcofcicpwen << 7));
}
...
__INLINE void rpl_lut_vcofc_icp_add_setf(uint8_t lutvcofcicpadd) {
  ...
  REG_RPL_WR(
      RPL_VCOFC_ICP_CALIBCNTL_ADDR,
      (REG_RPL_RD(RPL_VCOFC_ICP_CALIBCNTL_ADDR) & ~((uint32_t)0x0000007F)) |
          ((uint32_t)lutvcofcicpadd << 0));
}
...
__INLINE void rpl_vcofc_icp_calibconfig_pack(uint8_t kvcostepden,
                                             uint8_t kvcostepnum,
                                             uint8_t icpcalsign,
                                             uint16_t kvcoref) {
  ...
  REG_RPL_WR(RPL_VCOFC_ICP_CALIBCONFIG_ADDR,
             ((uint32_t)kvcostepden << 24) | ((uint32_t)kvcostepnum << 16) |
                 ((uint32_t)icpcalsign << 12) | ((uint32_t)kvcoref << 0));
}

__INLINE void rpl_vcofc_icp_calibconfig_unpack(uint8_t* kvcostepden,
                                               uint8_t* kvcostepnum,
                                               uint8_t* icpcalsign,
                                               uint16_t* kvcoref) {
...
__INLINE void rpl_kvcostep_den_setf(uint8_t kvcostepden) {
  ASSERT_ERR((((uint32_t)kvcostepden << 24) & ~((uint32_t)0x07000000)) == 0);
  REG_RPL_WR(
      RPL_VCOFC_ICP_CALIBCONFIG_ADDR,
      (REG_RPL_RD(RPL_VCOFC_ICP_CALIBCONFIG_ADDR) & ~((uint32_t)0x07000000)) |
          ((uint32_t)kvcostepden << 24));
}
...
__INLINE void rpl_kvcostep_num_setf(uint8_t kvcostepnum) {
  ...
  REG_RPL_WR(
      RPL_VCOFC_ICP_CALIBCONFIG_ADDR,
      (REG_RPL_RD(RPL_VCOFC_ICP_CALIBCONFIG_ADDR) & ~((uint32_t)0x00FF0000)) |
          ((uint32_t)kvcostepnum << 16));
}
...
__INLINE void rpl_icpcalsign_setf(uint8_t icpcalsign) {
  ...
  REG_RPL_WR(
      RPL_VCOFC_ICP_CALIBCONFIG_ADDR,
      (REG_RPL_RD(RPL_VCOFC_ICP_CALIBCONFIG_ADDR) & ~((uint32_t)0x00001000)) |
          ((uint32_t)icpcalsign << 12));
}
...
__INLINE void rpl_kvco_ref_setf(uint16_t kvcoref) {
  ...
  REG_RPL_WR(
      RPL_VCOFC_ICP_CALIBCONFIG_ADDR,
      (REG_RPL_RD(RPL_VCOFC_ICP_CALIBCONFIG_ADDR) & ~((uint32_t)0x000003FF)) |
          ((uint32_t)kvcoref << 0));
}
...
__INLINE void rpl_vcofc_icp_calibstat_unpack(uint8_t* lutldval,
                                             uint8_t* luticpval,
                                             uint8_t* lutvcofcval) {
...
__INLINE void rpl_txdc_calibcntl_pack(uint8_t luttxdcsel, uint8_t luttxdcqin,
                                      uint8_t luttxdciin, uint8_t luttxdcwen,
                                      uint8_t luttxdcadd) {
  ...
  REG_RPL_WR(RPL_TXDC_CALIBCNTL_ADDR,
             ((uint32_t)luttxdcsel << 28) | ((uint32_t)luttxdcqin << 16) |
                 ((uint32_t)luttxdciin << 8) | ((uint32_t)luttxdcwen << 4) |
                 ((uint32_t)luttxdcadd << 0));
}

__INLINE void rpl_txdc_calibcntl_unpack(uint8_t* luttxdcsel,
                                        uint8_t* luttxdcqin,
                                        uint8_t* luttxdciin,
                                        uint8_t* luttxdcwen,
                                        uint8_t* luttxdcadd) {
...
__INLINE void rpl_lut_txdc_sel_setf(uint8_t luttxdcsel) {
  ASSERT_ERR((((uint32_t)luttxdcsel << 28) & ~((uint32_t)0x70000000)) == 0);
  REG_RPL_WR(RPL_TXDC_CALIBCNTL_ADDR,
             (REG_RPL_RD(RPL_TXDC_CALIBCNTL_ADDR) & ~((uint32_t)0x70000000)) |
                 ((uint32_t)luttxdcsel << 28));
}
...
__INLINE void rpl_lut_txdcq_in_setf(uint8_t luttxdcqin) {
  ASSERT_ERR((((uint32_t)luttxdcqin << 16) & ~((uint32_t)0x001F0000)) == 0);
  REG_RPL_WR(RPL_TXDC_CALIBCNTL_ADDR,
             (REG_RPL_RD(RPL_TXDC_CALIBCNTL_ADDR) & ~((uint32_t)0x001F0000)) |
                 ((uint32_t)luttxdcqin << 16));
}
...
__INLINE void rpl_lut_txdci_in_setf(uint8_t luttxdciin) {
  ASSERT_ERR((((uint32_t)luttxdciin << 8) & ~((uint32_t)0x00001F00)) == 0);
  REG_RPL_WR(RPL_TXDC_CALIBCNTL_ADDR,
             (REG_RPL_RD(RPL_TXDC_CALIBCNTL_ADDR) & ~((uint32_t)0x00001F00)) |
                 ((uint32_t)luttxdciin << 8));
}
...
__INLINE void rpl_lut_txdc_wen_setf(uint8_t luttxdcwen) {
  ASSERT_ERR((((uint32_t)luttxdcwen << 4) & ~((uint32_t)0x00000010)) == 0);
  REG_RPL_WR(RPL_TXDC_CALIBCNTL_ADDR,
             (REG_RPL_RD(RPL_TXDC_CALIBCNTL_ADDR) & ~((uint32_t)0x00000010)) |
                 ((uint32_t)luttxdcwen << 4));
}
...
__INLINE void rpl_lut_txdc_add_setf(uint8_t luttxdcadd) {
  ASSERT_ERR((((uint32_t)luttxdcadd << 0) & ~((uint32_t)0x0000000F)) == 0);
  REG_RPL_WR(RPL_TXDC_CALIBCNTL_ADDR,
             (REG_RPL_RD(RPL_TXDC_CALIBCNTL_ADDR) & ~((uint32_t)0x0000000F)) |
                 ((uint32_t)luttxdcadd << 0));
}
...
__INLINE void rpl_txdc_calibstat_unpack(uint8_t* luttxdcq8dpskval,
                                        uint8_t* luttxdci8dpskval,
                                        uint8_t* luttxdcqdqpskval,
                                        uint8_t* luttxdcidqpskval,
                                        uint8_t* luttxdcqgfskval,
                                        uint8_t* luttxdcigfskval) {
...
__INLINE void rpl_agc_rssi_config_pack(uint8_t rxagcsatdetmode,
                                       uint8_t rssipreloadcnt,
                                       uint8_t rssiondlydcnt,
                                       uint8_t agcsettletime) {
  ASSERT_ERR((((uint32_t)rxagcsatdetmode << 31) & ~((uint32_t)0x80000000)) ==
             0);
  ...
  REG_RPL_WR(RPL_AGC_RSSI_CONFIG_ADDR, ((uint32_t)rxagcsatdetmode << 31) |
                                           ((uint32_t)rssipreloadcnt << 12) |
                                           ((uint32_t)rssiondlydcnt << 8) |
                                           ((uint32_t)agcsettletime << 0));
}

__INLINE void rpl_agc_rssi_config_unpack(uint8_t* rxagcsatdetmode,
                                         uint8_t* rssipreloadcnt,
                                         uint8_t* rssiondlydcnt,
                                         uint8_t* agcsettletime) {
...
__INLINE void rpl_rxagc_satdet_mode_setf(uint8_t rxagcsatdetmode) {
  ASSERT_ERR((((uint32_t)rxagcsatdetmode << 31) & ~((uint32_t)0x80000000)) ==
             0);
  REG_RPL_WR(RPL_AGC_RSSI_CONFIG_ADDR,
             (REG_RPL_RD(RPL_AGC_RSSI_CONFIG_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)rxagcsatdetmode << 31));
}
...
__INLINE void rpl_rssi_preload_cnt_setf(uint8_t rssipreloadcnt) {
  ASSERT_ERR((((uint32_t)rssipreloadcnt << 12) & ~((uint32_t)0x0001F000)) == 0);
  REG_RPL_WR(RPL_AGC_RSSI_CONFIG_ADDR,
             (REG_RPL_RD(RPL_AGC_RSSI_CONFIG_ADDR) & ~((uint32_t)0x0001F000)) |
                 ((uint32_t)rssipreloadcnt << 12));
}
...
__INLINE void rpl_rssi_on_dlyd_cnt_setf(uint8_t rssiondlydcnt) {
  ASSERT_ERR((((uint32_t)rssiondlydcnt << 8) & ~((uint32_t)0x00000F00)) == 0);
  REG_RPL_WR(RPL_AGC_RSSI_CONFIG_ADDR,
             (REG_RPL_RD(RPL_AGC_RSSI_CONFIG_ADDR) & ~((uint32_t)0x00000F00)) |
                 ((uint32_t)rssiondlydcnt << 8));
}
...
__INLINE void rpl_agc_settle_time_setf(uint8_t agcsettletime) {
  ASSERT_ERR((((uint32_t)agcsettletime << 0) & ~((uint32_t)0x000000FF)) == 0);
  REG_RPL_WR(RPL_AGC_RSSI_CONFIG_ADDR,
             (REG_RPL_RD(RPL_AGC_RSSI_CONFIG_ADDR) & ~((uint32_t)0x000000FF)) |
                 ((uint32_t)agcsettletime << 0));
}
...
__INLINE void rpl_rfrxgaintable_pack(int reg_idx, uint8_t rxlnagain,
                                     uint8_t rxmixgain, uint8_t rxfiltergain) {
  ASSERT_ERR(reg_idx <= 6);
  ...
  REG_RPL_WR(RPL_RFRXGAINTABLE_ADDR + reg_idx * 1,
             ((uint32_t)rxlnagain << 8) | ((uint32_t)rxmixgain << 4) |
                 ((uint32_t)rxfiltergain << 0));
}

__INLINE void rpl_rfrxgaintable_unpack(int reg_idx, uint8_t* rxlnagain,
                                       uint8_t* rxmixgain,
                                       uint8_t* rxfiltergain) {
  ASSERT_ERR(reg_idx <= 6);
...
__INLINE void rpl_rxlna_gain_setf(int reg_idx, uint8_t rxlnagain) {
  ...
  ASSERT_ERR((((uint32_t)rxlnagain << 8) & ~((uint32_t)0x00000300)) == 0);
  REG_RPL_WR(RPL_RFRXGAINTABLE_ADDR + reg_idx * 1,
             (REG_RPL_RD(RPL_RFRXGAINTABLE_ADDR + reg_idx * 1) &
              ~((uint32_t)0x00000300)) |
                 ((uint32_t)rxlnagain << 8));
}
...
__INLINE void rpl_rfpower_cntl_pack(uint8_t ldorxtxtrim, uint8_t ldovdigtrim,
                                    uint8_t ldoaddatrim, uint8_t ldovcotrim,
                                    uint8_t ldoxotrim, uint8_t ldoplltrim,
                                    uint8_t ldobgaptrim, uint8_t ldorxtxlpmode,
                                    uint8_t ldaaddalpmode, uint8_t ldovcolpmode,
                                    uint8_t ldoplllpmode, uint8_t ldoxolpmode,
                                    uint8_t ldorxtxon, uint8_t ldoaddaon,
                                    uint8_t ldovcoon, uint8_t ldopllon,
                                    uint8_t ldoxoon) {
  ...
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             ((uint32_t)ldorxtxtrim << 28) | ((uint32_t)ldovdigtrim << 25) |
                 ((uint32_t)ldoaddatrim << 22) | ((uint32_t)ldovcotrim << 19) |
                 ((uint32_t)ldoxotrim << 16) | ((uint32_t)ldoplltrim << 13) |
                 ((uint32_t)ldobgaptrim << 10) |
                 ((uint32_t)ldorxtxlpmode << 9) |
                 ((uint32_t)ldaaddalpmode << 8) |
                 ((uint32_t)ldovcolpmode << 7) | ((uint32_t)ldoplllpmode << 6) |
                 ((uint32_t)ldoxolpmode << 5) | ((uint32_t)ldorxtxon << 4) |
                 ((uint32_t)ldoaddaon << 3) | ((uint32_t)ldovcoon << 2) |
                 ((uint32_t)ldopllon << 1) | ((uint32_t)ldoxoon << 0));
}

__INLINE void rpl_rfpower_cntl_unpack(
    uint8_t* ldorxtxtrim, uint8_t* ldovdigtrim, uint8_t* ldoaddatrim,
    uint8_t* ldovcotrim, uint8_t* ldoxotrim, uint8_t* ldoplltrim,
    uint8_t* ldobgaptrim, uint8_t* ldorxtxlpmode, uint8_t* ldaaddalpmode,
    uint8_t* ldovcolpmode, uint8_t* ldoplllpmode, uint8_t* ldoxolpmode,
    uint8_t* ldorxtxon, uint8_t* ldoaddaon, uint8_t* ldovcoon,
    uint8_t* ldopllon, uint8_t* ldoxoon) {
...
__INLINE void rpl_ldo_rxtx_trim_setf(uint8_t ldorxtxtrim) {
  ASSERT_ERR((((uint32_t)ldorxtxtrim << 28) & ~((uint32_t)0x70000000)) == 0);
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             (REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR) & ~((uint32_t)0x70000000)) |
                 ((uint32_t)ldorxtxtrim << 28));
}
...
__INLINE void rpl_ldo_vdig_trim_setf(uint8_t ldovdigtrim) {
  ASSERT_ERR((((uint32_t)ldovdigtrim << 25) & ~((uint32_t)0x0E000000)) == 0);
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             (REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR) & ~((uint32_t)0x0E000000)) |
                 ((uint32_t)ldovdigtrim << 25));
}
...
__INLINE void rpl_ldo_adda_trim_setf(uint8_t ldoaddatrim) {
  ASSERT_ERR((((uint32_t)ldoaddatrim << 22) & ~((uint32_t)0x01C00000)) == 0);
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             (REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR) & ~((uint32_t)0x01C00000)) |
                 ((uint32_t)ldoaddatrim << 22));
}
...
__INLINE void rpl_ldo_vco_trim_setf(uint8_t ldovcotrim) {
  ASSERT_ERR((((uint32_t)ldovcotrim << 19) & ~((uint32_t)0x00380000)) == 0);
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             (REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR) & ~((uint32_t)0x00380000)) |
                 ((uint32_t)ldovcotrim << 19));
}
...
__INLINE void rpl_ldo_xo_trim_setf(uint8_t ldoxotrim) {
  ASSERT_ERR((((uint32_t)ldoxotrim << 16) & ~((uint32_t)0x00070000)) == 0);
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             (REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR) & ~((uint32_t)0x00070000)) |
                 ((uint32_t)ldoxotrim << 16));
}
...
__INLINE void rpl_ldo_pll_trim_setf(uint8_t ldoplltrim) {
  ASSERT_ERR((((uint32_t)ldoplltrim << 13) & ~((uint32_t)0x0000E000)) == 0);
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             (REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR) & ~((uint32_t)0x0000E000)) |
                 ((uint32_t)ldoplltrim << 13));
}
...
__INLINE void rpl_ldo_bgap_trim_setf(uint8_t ldobgaptrim) {
  ASSERT_ERR((((uint32_t)ldobgaptrim << 10) & ~((uint32_t)0x00001C00)) == 0);
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             (REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR) & ~((uint32_t)0x00001C00)) |
                 ((uint32_t)ldobgaptrim << 10));
}
...
__INLINE void rpl_ldo_rxtx_lp_mode_setf(uint8_t ldorxtxlpmode) {
  ASSERT_ERR((((uint32_t)ldorxtxlpmode << 9) & ~((uint32_t)0x00000200)) == 0);
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             (REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR) & ~((uint32_t)0x00000200)) |
                 ((uint32_t)ldorxtxlpmode << 9));
}
...
__INLINE void rpl_lda_adda_lp_mode_setf(uint8_t ldaaddalpmode) {
  ASSERT_ERR((((uint32_t)ldaaddalpmode << 8) & ~((uint32_t)0x00000100)) == 0);
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             (REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR) & ~((uint32_t)0x00000100)) |
                 ((uint32_t)ldaaddalpmode << 8));
}
...
__INLINE void rpl_ldo_vco_lp_mode_setf(uint8_t ldovcolpmode) {
  ASSERT_ERR((((uint32_t)ldovcolpmode << 7) & ~((uint32_t)0x00000080)) == 0);
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             (REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR) & ~((uint32_t)0x00000080)) |
                 ((uint32_t)ldovcolpmode << 7));
}
...
__INLINE void rpl_ldo_pll_lp_mode_setf(uint8_t ldoplllpmode) {
  ASSERT_ERR((((uint32_t)ldoplllpmode << 6) & ~((uint32_t)0x00000040)) == 0);
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             (REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR) & ~((uint32_t)0x00000040)) |
                 ((uint32_t)ldoplllpmode << 6));
}
...
__INLINE void rpl_ldo_xo_lp_mode_setf(uint8_t ldoxolpmode) {
  ASSERT_ERR((((uint32_t)ldoxolpmode << 5) & ~((uint32_t)0x00000020)) == 0);
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             (REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR) & ~((uint32_t)0x00000020)) |
                 ((uint32_t)ldoxolpmode << 5));
}
...
__INLINE void rpl_ldo_rxtx_on_setf(uint8_t ldorxtxon) {
  ASSERT_ERR((((uint32_t)ldorxtxon << 4) & ~((uint32_t)0x00000010)) == 0);
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             (REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR) & ~((uint32_t)0x00000010)) |
                 ((uint32_t)ldorxtxon << 4));
}
...
__INLINE void rpl_ldo_adda_on_setf(uint8_t ldoaddaon) {
  ASSERT_ERR((((uint32_t)ldoaddaon << 3) & ~((uint32_t)0x00000008)) == 0);
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             (REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR) & ~((uint32_t)0x00000008)) |
                 ((uint32_t)ldoaddaon << 3));
}
...
__INLINE void rpl_ldo_vco_on_setf(uint8_t ldovcoon) {
  ASSERT_ERR((((uint32_t)ldovcoon << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             (REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR) & ~((uint32_t)0x00000004)) |
                 ((uint32_t)ldovcoon << 2));
}
...
__INLINE void rpl_ldo_pll_on_setf(uint8_t ldopllon) {
  ASSERT_ERR((((uint32_t)ldopllon << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             (REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)ldopllon << 1));
}
...
__INLINE void rpl_ldo_xo_on_setf(uint8_t ldoxoon) {
  ASSERT_ERR((((uint32_t)ldoxoon << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(RPL_RFPOWER_CNTL_ADDR,
             (REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)ldoxoon << 0));
}
...
__INLINE void rpl_rampgencntl_pack(uint8_t epcmode, uint16_t edrswitchcnt,
                                   uint8_t gaindec, uint8_t gainincr) {
  ...
  REG_RPL_WR(RPL_RAMPGENCNTL_ADDR,
             ((uint32_t)epcmode << 30) | ((uint32_t)edrswitchcnt << 20) |
                 ((uint32_t)gaindec << 8) | ((uint32_t)gainincr << 0));
}

__INLINE void rpl_rampgencntl_unpack(uint8_t* epcmode, uint16_t* edrswitchcnt,
                                     uint8_t* gaindec, uint8_t* gainincr) {
...
__INLINE void rpl_epc_mode_setf(uint8_t epcmode) {
  ASSERT_ERR((((uint32_t)epcmode << 30) & ~((uint32_t)0xC0000000)) == 0);
  REG_RPL_WR(RPL_RAMPGENCNTL_ADDR,
             (REG_RPL_RD(RPL_RAMPGENCNTL_ADDR) & ~((uint32_t)0xC0000000)) |
                 ((uint32_t)epcmode << 30));
}
...
__INLINE void rpl_edr_switch_cnt_setf(uint16_t edrswitchcnt) {
  ASSERT_ERR((((uint32_t)edrswitchcnt << 20) & ~((uint32_t)0x1FF00000)) == 0);
  REG_RPL_WR(RPL_RAMPGENCNTL_ADDR,
             (REG_RPL_RD(RPL_RAMPGENCNTL_ADDR) & ~((uint32_t)0x1FF00000)) |
                 ((uint32_t)edrswitchcnt << 20));
}
...
__INLINE void rpl_gain_dec_setf(uint8_t gaindec) {
  ASSERT_ERR((((uint32_t)gaindec << 8) & ~((uint32_t)0x0000FF00)) == 0);
  REG_RPL_WR(RPL_RAMPGENCNTL_ADDR,
             (REG_RPL_RD(RPL_RAMPGENCNTL_ADDR) & ~((uint32_t)0x0000FF00)) |
                 ((uint32_t)gaindec << 8));
}
...
__INLINE void rpl_gain_incr_setf(uint8_t gainincr) {
  ASSERT_ERR((((uint32_t)gainincr << 0) & ~((uint32_t)0x000000FF)) == 0);
  REG_RPL_WR(RPL_RAMPGENCNTL_ADDR,
             (REG_RPL_RD(RPL_RAMPGENCNTL_ADDR) & ~((uint32_t)0x000000FF)) |
                 ((uint32_t)gainincr << 0));
}
...
__INLINE void rpl_rftx_gfsk_gain_table_pack(int reg_idx,
                                            uint8_t txgfskpaintgain,
                                            uint8_t txgfskdrvgain,
                                            uint8_t txgfskfiltergain) {
  ASSERT_ERR(reg_idx <= 15);
  ASSERT_ERR((((uint32_t)txgfskpaintgain << 8) & ~((uint32_t)0x00000700)) == 0);
  ASSERT_ERR((((uint32_t)txgfskdrvgain << 4) & ~((uint32_t)0x00000070)) == 0);
  ASSERT_ERR((((uint32_t)txgfskfiltergain << 0) & ~((uint32_t)0x00000007)) ==
             0);
  REG_RPL_WR(RPL_RFTX_GFSK_GAIN_TABLE_ADDR + reg_idx * 1,
             ((uint32_t)txgfskpaintgain << 8) | ((uint32_t)txgfskdrvgain << 4) |
                 ((uint32_t)txgfskfiltergain << 0));
}

__INLINE void rpl_rftx_gfsk_gain_table_unpack(int reg_idx,
                                              uint8_t* txgfskpaintgain,
                                              uint8_t* txgfskdrvgain,
                                              uint8_t* txgfskfiltergain) {
  ASSERT_ERR(reg_idx <= 15);
...
__INLINE void rpl_tx_gfsk_paint_gain_setf(int reg_idx,
                                          uint8_t txgfskpaintgain) {
  ASSERT_ERR(reg_idx <= 15);
  ASSERT_ERR((((uint32_t)txgfskpaintgain << 8) & ~((uint32_t)0x00000700)) == 0);
  REG_RPL_WR(RPL_RFTX_GFSK_GAIN_TABLE_ADDR + reg_idx * 1,
             (REG_RPL_RD(RPL_RFTX_GFSK_GAIN_TABLE_ADDR + reg_idx * 1) &
              ~((uint32_t)0x00000700)) |
                 ((uint32_t)txgfskpaintgain << 8));
}
...
__INLINE void rpl_tx_gfsk_filter_gain_setf(int reg_idx,
                                           uint8_t txgfskfiltergain) {
  ASSERT_ERR(reg_idx <= 15);
  ASSERT_ERR((((uint32_t)txgfskfiltergain << 0) & ~((uint32_t)0x00000007)) ==
             0);
...
__INLINE void rpl_rftx_edr_gain_table_pack(
    int reg_idx, uint8_t txdqpskpaintgain, uint8_t txdqpskdrvgain,
    uint8_t txdqpskfiltergain, uint8_t tx8dpskpaintgain, uint8_t tx8dpskdrvgain,
    uint8_t tx8dpskfiltergain) {
  ASSERT_ERR(reg_idx <= 15);
  ASSERT_ERR((((uint32_t)txdqpskpaintgain << 20) & ~((uint32_t)0x00700000)) ==
             0);
  ASSERT_ERR((((uint32_t)txdqpskdrvgain << 16) & ~((uint32_t)0x00070000)) == 0);
  ASSERT_ERR((((uint32_t)txdqpskfiltergain << 12) & ~((uint32_t)0x00007000)) ==
             0);
  ASSERT_ERR((((uint32_t)tx8dpskpaintgain << 8) & ~((uint32_t)0x00000700)) ==
             0);
  ASSERT_ERR((((uint32_t)tx8dpskdrvgain << 4) & ~((uint32_t)0x00000070)) == 0);
  ASSERT_ERR((((uint32_t)tx8dpskfiltergain << 0) & ~((uint32_t)0x00000007)) ==
             0);
  REG_RPL_WR(
      RPL_RFTX_EDR_GAIN_TABLE_ADDR + reg_idx * 1,
      ((uint32_t)txdqpskpaintgain << 20) | ((uint32_t)txdqpskdrvgain << 16) |
          ((uint32_t)txdqpskfiltergain << 12) |
          ((uint32_t)tx8dpskpaintgain << 8) | ((uint32_t)tx8dpskdrvgain << 4) |
          ((uint32_t)tx8dpskfiltergain << 0));
}

__INLINE void rpl_rftx_edr_gain_table_unpack(
    int reg_idx, uint8_t* txdqpskpaintgain, uint8_t* txdqpskdrvgain,
    uint8_t* txdqpskfiltergain, uint8_t* tx8dpskpaintgain,
    uint8_t* tx8dpskdrvgain, uint8_t* tx8dpskfiltergain) {
  ASSERT_ERR(reg_idx <= 15);
...
__INLINE void rpl_tx_dqpsk_paint_gain_setf(int reg_idx,
                                           uint8_t txdqpskpaintgain) {
  ASSERT_ERR(reg_idx <= 15);
  ASSERT_ERR((((uint32_t)txdqpskpaintgain << 20) & ~((uint32_t)0x00700000)) ==
             0);
  REG_RPL_WR(RPL_RFTX_EDR_GAIN_TABLE_ADDR + reg_idx * 1,
             (REG_RPL_RD(RPL_RFTX_EDR_GAIN_TABLE_ADDR + reg_idx * 1) &
              ~((uint32_t)0x00700000)) |
                 ((uint32_t)txdqpskpaintgain << 20));
}
...
__INLINE void rpl_tx_dqpsk_filter_gain_setf(int reg_idx,
                                            uint8_t txdqpskfiltergain) {
  ASSERT_ERR(reg_idx <= 15);
  ASSERT_ERR((((uint32_t)txdqpskfiltergain << 12) & ~((uint32_t)0x00007000)) ==
             0);
  REG_RPL_WR(RPL_RFTX_EDR_GAIN_TABLE_ADDR + reg_idx * 1,
...
__INLINE void rpl_tx_8dpsk_paint_gain_setf(int reg_idx,
                                           uint8_t tx8dpskpaintgain) {
  ASSERT_ERR(reg_idx <= 15);
  ASSERT_ERR((((uint32_t)tx8dpskpaintgain << 8) & ~((uint32_t)0x00000700)) ==
             0);
  REG_RPL_WR(RPL_RFTX_EDR_GAIN_TABLE_ADDR + reg_idx * 1,
...
__INLINE void rpl_tx_8dpsk_filter_gain_setf(int reg_idx,
                                            uint8_t tx8dpskfiltergain) {
  ASSERT_ERR(reg_idx <= 15);
  ASSERT_ERR((((uint32_t)tx8dpskfiltergain << 0) & ~((uint32_t)0x00000007)) ==
             0);
...
__INLINE void rpl_rftx_daciq_gain_pack(
    uint8_t txdacq8dpskgain, uint8_t txdaci8dpskgain, uint8_t txdacqdqpskgain,
    uint8_t txdacidqpskgain, uint8_t txdacqgfskgain, uint8_t txdacigfskgain) {
  ASSERT_ERR((((uint32_t)txdacq8dpskgain << 20) & ~((uint32_t)0x00700000)) ==
             0);
  ASSERT_ERR((((uint32_t)txdaci8dpskgain << 16) & ~((uint32_t)0x00070000)) ==
             0);
  ASSERT_ERR((((uint32_t)txdacqdqpskgain << 12) & ~((uint32_t)0x00007000)) ==
             0);
  ...
  REG_RPL_WR(
      RPL_RFTX_DACIQ_GAIN_ADDR,
      ((uint32_t)txdacq8dpskgain << 20) | ((uint32_t)txdaci8dpskgain << 16) |
          ((uint32_t)txdacqdqpskgain << 12) | ((uint32_t)txdacidqpskgain << 8) |
          ((uint32_t)txdacqgfskgain << 4) | ((uint32_t)txdacigfskgain << 0));
}

__INLINE void rpl_rftx_daciq_gain_unpack(uint8_t* txdacq8dpskgain,
                                         uint8_t* txdaci8dpskgain,
                                         uint8_t* txdacqdqpskgain,
                                         uint8_t* txdacidqpskgain,
                                         uint8_t* txdacqgfskgain,
                                         uint8_t* txdacigfskgain) {
...
__INLINE void rpl_txdacq_8dpsk_gain_setf(uint8_t txdacq8dpskgain) {
  ASSERT_ERR((((uint32_t)txdacq8dpskgain << 20) & ~((uint32_t)0x00700000)) ==
             0);
  REG_RPL_WR(RPL_RFTX_DACIQ_GAIN_ADDR,
             (REG_RPL_RD(RPL_RFTX_DACIQ_GAIN_ADDR) & ~((uint32_t)0x00700000)) |
                 ((uint32_t)txdacq8dpskgain << 20));
}
...
__INLINE void rpl_txdaci_8dpsk_gain_setf(uint8_t txdaci8dpskgain) {
  ASSERT_ERR((((uint32_t)txdaci8dpskgain << 16) & ~((uint32_t)0x00070000)) ==
             0);
  REG_RPL_WR(RPL_RFTX_DACIQ_GAIN_ADDR,
             (REG_RPL_RD(RPL_RFTX_DACIQ_GAIN_ADDR) & ~((uint32_t)0x00070000)) |
                 ((uint32_t)txdaci8dpskgain << 16));
}
...
__INLINE void rpl_txdacq_dqpsk_gain_setf(uint8_t txdacqdqpskgain) {
  ASSERT_ERR((((uint32_t)txdacqdqpskgain << 12) & ~((uint32_t)0x00007000)) ==
             0);
  REG_RPL_WR(RPL_RFTX_DACIQ_GAIN_ADDR,
             (REG_RPL_RD(RPL_RFTX_DACIQ_GAIN_ADDR) & ~((uint32_t)0x00007000)) |
                 ((uint32_t)txdacqdqpskgain << 12));
}
...
__INLINE void rpl_txdaci_dqpsk_gain_setf(uint8_t txdacidqpskgain) {
  ASSERT_ERR((((uint32_t)txdacidqpskgain << 8) & ~((uint32_t)0x00000700)) == 0);
  REG_RPL_WR(RPL_RFTX_DACIQ_GAIN_ADDR,
             (REG_RPL_RD(RPL_RFTX_DACIQ_GAIN_ADDR) & ~((uint32_t)0x00000700)) |
                 ((uint32_t)txdacidqpskgain << 8));
}
...
__INLINE void rpl_txdacq_gfsk_gain_setf(uint8_t txdacqgfskgain) {
  ASSERT_ERR((((uint32_t)txdacqgfskgain << 4) & ~((uint32_t)0x00000070)) == 0);
  REG_RPL_WR(RPL_RFTX_DACIQ_GAIN_ADDR,
             (REG_RPL_RD(RPL_RFTX_DACIQ_GAIN_ADDR) & ~((uint32_t)0x00000070)) |
                 ((uint32_t)txdacqgfskgain << 4));
}
...
__INLINE void rpl_txdaci_gfsk_gain_setf(uint8_t txdacigfskgain) {
  ASSERT_ERR((((uint32_t)txdacigfskgain << 0) & ~((uint32_t)0x00000007)) == 0);
  REG_RPL_WR(RPL_RFTX_DACIQ_GAIN_ADDR,
             (REG_RPL_RD(RPL_RFTX_DACIQ_GAIN_ADDR) & ~((uint32_t)0x00000007)) |
                 ((uint32_t)txdacigfskgain << 0));
}
...
__INLINE void rpl_crm_cntl0_pack(
    uint8_t forceresets, uint8_t forceclockgates, uint8_t daptxdcrsten,
    uint8_t rpllfdivrsten, uint8_t mdmrsten, uint8_t dbrsten, uint8_t agcrsten,
    uint8_t sdrsten, uint8_t gfskprefiltrsten, uint8_t dapcalibrsten,
    uint8_t daprsten, uint8_t daptxdcclkgateen, uint8_t rpllfdivclkgateen,
    uint8_t saradcclkgateen, uint8_t mdmtxdpsk13clkgateen,
    uint8_t mdmtxgfsk13clkgateen, uint8_t mdmtx13clkgateen,
    uint8_t mdmrxdpsk13clkgateen, uint8_t mdmrxdpsk52clkgateen,
    uint8_t mdmrxdl13clkgateen, uint8_t mdmrxgfsk13clkgateen,
    uint8_t mdmrxgfsk52clkgateen, uint8_t mdmrx52clkgateen,
    uint8_t mdmcore13clkgateen, uint8_t dbclkgateen, uint8_t agcclkgateen,
    uint8_t sdclkgateen, uint8_t gfskprefiltclkgateen,
    uint8_t dapcalibclkgateen, uint8_t dapclkgateen) {
  ASSERT_ERR((((uint32_t)forceresets << 31) & ~((uint32_t)0x80000000)) == 0);
  ASSERT_ERR((((uint32_t)forceclockgates << 30) & ~((uint32_t)0x40000000)) ==
             0);
  ...
  ASSERT_ERR((((uint32_t)gfskprefiltrsten << 22) & ~((uint32_t)0x00400000)) ==
             0);
  ASSERT_ERR((((uint32_t)dapcalibrsten << 21) & ~((uint32_t)0x00200000)) == 0);
  ASSERT_ERR((((uint32_t)daprsten << 20) & ~((uint32_t)0x00100000)) == 0);
  ASSERT_ERR((((uint32_t)daptxdcclkgateen << 18) & ~((uint32_t)0x00040000)) ==
             0);
  ASSERT_ERR((((uint32_t)rpllfdivclkgateen << 17) & ~((uint32_t)0x00020000)) ==
             0);
  ASSERT_ERR((((uint32_t)saradcclkgateen << 16) & ~((uint32_t)0x00010000)) ==
             0);
  ASSERT_ERR(
      (((uint32_t)mdmtxdpsk13clkgateen << 15) & ~((uint32_t)0x00008000)) == 0);
  ASSERT_ERR(
      (((uint32_t)mdmtxgfsk13clkgateen << 14) & ~((uint32_t)0x00004000)) == 0);
  ASSERT_ERR((((uint32_t)mdmtx13clkgateen << 13) & ~((uint32_t)0x00002000)) ==
             0);
  ASSERT_ERR(
      (((uint32_t)mdmrxdpsk13clkgateen << 12) & ~((uint32_t)0x00001000)) == 0);
  ASSERT_ERR(
      (((uint32_t)mdmrxdpsk52clkgateen << 11) & ~((uint32_t)0x00000800)) == 0);
  ASSERT_ERR((((uint32_t)mdmrxdl13clkgateen << 10) & ~((uint32_t)0x00000400)) ==
             0);
  ASSERT_ERR(
      (((uint32_t)mdmrxgfsk13clkgateen << 9) & ~((uint32_t)0x00000200)) == 0);
  ASSERT_ERR(
      (((uint32_t)mdmrxgfsk52clkgateen << 8) & ~((uint32_t)0x00000100)) == 0);
  ASSERT_ERR((((uint32_t)mdmrx52clkgateen << 7) & ~((uint32_t)0x00000080)) ==
             0);
  ASSERT_ERR((((uint32_t)mdmcore13clkgateen << 6) & ~((uint32_t)0x00000040)) ==
             0);
  ...
  ASSERT_ERR(
      (((uint32_t)gfskprefiltclkgateen << 2) & ~((uint32_t)0x00000004)) == 0);
  ASSERT_ERR((((uint32_t)dapcalibclkgateen << 1) & ~((uint32_t)0x00000002)) ==
             0);
  ASSERT_ERR((((uint32_t)dapclkgateen << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(
      RPL_CRM_CNTL0_ADDR,
      ((uint32_t)forceresets << 31) | ((uint32_t)forceclockgates << 30) |
          ((uint32_t)daptxdcrsten << 28) | ((uint32_t)rpllfdivrsten << 27) |
          ((uint32_t)mdmrsten << 26) | ((uint32_t)dbrsten << 25) |
          ((uint32_t)agcrsten << 24) | ((uint32_t)sdrsten << 23) |
          ((uint32_t)gfskprefiltrsten << 22) | ((uint32_t)dapcalibrsten << 21) |
          ((uint32_t)daprsten << 20) | ((uint32_t)daptxdcclkgateen << 18) |
          ((uint32_t)rpllfdivclkgateen << 17) |
          ((uint32_t)saradcclkgateen << 16) |
          ((uint32_t)mdmtxdpsk13clkgateen << 15) |
          ((uint32_t)mdmtxgfsk13clkgateen << 14) |
          ((uint32_t)mdmtx13clkgateen << 13) |
          ((uint32_t)mdmrxdpsk13clkgateen << 12) |
          ((uint32_t)mdmrxdpsk52clkgateen << 11) |
          ((uint32_t)mdmrxdl13clkgateen << 10) |
          ((uint32_t)mdmrxgfsk13clkgateen << 9) |
          ((uint32_t)mdmrxgfsk52clkgateen << 8) |
          ((uint32_t)mdmrx52clkgateen << 7) |
          ((uint32_t)mdmcore13clkgateen << 6) | ((uint32_t)dbclkgateen << 5) |
          ((uint32_t)agcclkgateen << 4) | ((uint32_t)sdclkgateen << 3) |
          ((uint32_t)gfskprefiltclkgateen << 2) |
          ((uint32_t)dapcalibclkgateen << 1) | ((uint32_t)dapclkgateen << 0));
}

__INLINE void rpl_crm_cntl0_unpack(
    uint8_t* forceresets, uint8_t* forceclockgates, uint8_t* daptxdcrsten,
    uint8_t* rpllfdivrsten, uint8_t* mdmrsten, uint8_t* dbrsten,
    uint8_t* agcrsten, uint8_t* sdrsten, uint8_t* gfskprefiltrsten,
    uint8_t* dapcalibrsten, uint8_t* daprsten, uint8_t* daptxdcclkgateen,
    uint8_t* rpllfdivclkgateen, uint8_t* saradcclkgateen,
    uint8_t* mdmtxdpsk13clkgateen, uint8_t* mdmtxgfsk13clkgateen,
    uint8_t* mdmtx13clkgateen, uint8_t* mdmrxdpsk13clkgateen,
    uint8_t* mdmrxdpsk52clkgateen, uint8_t* mdmrxdl13clkgateen,
    uint8_t* mdmrxgfsk13clkgateen, uint8_t* mdmrxgfsk52clkgateen,
    uint8_t* mdmrx52clkgateen, uint8_t* mdmcore13clkgateen,
    uint8_t* dbclkgateen, uint8_t* agcclkgateen, uint8_t* sdclkgateen,
    uint8_t* gfskprefiltclkgateen, uint8_t* dapcalibclkgateen,
    uint8_t* dapclkgateen) {
...
__INLINE void rpl_force_resets_setf(uint8_t forceresets) {
  ...
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x80000000)) |
...
__INLINE void rpl_force_clock_gates_setf(uint8_t forceclockgates) {
  ASSERT_ERR((((uint32_t)forceclockgates << 30) & ~((uint32_t)0x40000000)) ==
             0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x40000000)) |
                 ((uint32_t)forceclockgates << 30));
}
...
__INLINE void rpl_dap_txdc_rst_en_setf(uint8_t daptxdcrsten) {
  ASSERT_ERR((((uint32_t)daptxdcrsten << 28) & ~((uint32_t)0x10000000)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x10000000)) |
                 ((uint32_t)daptxdcrsten << 28));
}
...
__INLINE void rpl_rpll_fdiv_rst_en_setf(uint8_t rpllfdivrsten) {
  ASSERT_ERR((((uint32_t)rpllfdivrsten << 27) & ~((uint32_t)0x08000000)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x08000000)) |
                 ((uint32_t)rpllfdivrsten << 27));
}
...
__INLINE void rpl_mdm_rst_en_setf(uint8_t mdmrsten) {
  ASSERT_ERR((((uint32_t)mdmrsten << 26) & ~((uint32_t)0x04000000)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x04000000)) |
                 ((uint32_t)mdmrsten << 26));
}
...
__INLINE void rpl_db_rst_en_setf(uint8_t dbrsten) {
  ASSERT_ERR((((uint32_t)dbrsten << 25) & ~((uint32_t)0x02000000)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x02000000)) |
                 ((uint32_t)dbrsten << 25));
}
...
__INLINE void rpl_agc_rst_en_setf(uint8_t agcrsten) {
  ASSERT_ERR((((uint32_t)agcrsten << 24) & ~((uint32_t)0x01000000)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x01000000)) |
                 ((uint32_t)agcrsten << 24));
}
...
__INLINE void rpl_sd_rst_en_setf(uint8_t sdrsten) {
  ASSERT_ERR((((uint32_t)sdrsten << 23) & ~((uint32_t)0x00800000)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00800000)) |
                 ((uint32_t)sdrsten << 23));
}
...
__INLINE void rpl_gfsk_prefilt_rst_en_setf(uint8_t gfskprefiltrsten) {
  ASSERT_ERR((((uint32_t)gfskprefiltrsten << 22) & ~((uint32_t)0x00400000)) ==
             0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00400000)) |
                 ((uint32_t)gfskprefiltrsten << 22));
}
...
__INLINE void rpl_dap_calib_rst_en_setf(uint8_t dapcalibrsten) {
  ASSERT_ERR((((uint32_t)dapcalibrsten << 21) & ~((uint32_t)0x00200000)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00200000)) |
                 ((uint32_t)dapcalibrsten << 21));
}
...
__INLINE void rpl_dap_rst_en_setf(uint8_t daprsten) {
  ASSERT_ERR((((uint32_t)daprsten << 20) & ~((uint32_t)0x00100000)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00100000)) |
                 ((uint32_t)daprsten << 20));
}
...
__INLINE void rpl_dap_txdc_clk_gate_en_setf(uint8_t daptxdcclkgateen) {
  ASSERT_ERR((((uint32_t)daptxdcclkgateen << 18) & ~((uint32_t)0x00040000)) ==
             0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00040000)) |
                 ((uint32_t)daptxdcclkgateen << 18));
}
...
__INLINE void rpl_rpll_fdiv_clk_gate_en_setf(uint8_t rpllfdivclkgateen) {
  ASSERT_ERR((((uint32_t)rpllfdivclkgateen << 17) & ~((uint32_t)0x00020000)) ==
             0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00020000)) |
                 ((uint32_t)rpllfdivclkgateen << 17));
}
...
__INLINE void rpl_sar_adc_clk_gate_en_setf(uint8_t saradcclkgateen) {
  ASSERT_ERR((((uint32_t)saradcclkgateen << 16) & ~((uint32_t)0x00010000)) ==
             0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00010000)) |
                 ((uint32_t)saradcclkgateen << 16));
}
...
__INLINE void rpl_mdm_txdpsk13_clk_gate_en_setf(uint8_t mdmtxdpsk13clkgateen) {
  ASSERT_ERR(
      (((uint32_t)mdmtxdpsk13clkgateen << 15) & ~((uint32_t)0x00008000)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00008000)) |
                 ((uint32_t)mdmtxdpsk13clkgateen << 15));
}
...
__INLINE void rpl_mdm_txgfsk13_clk_gate_en_setf(uint8_t mdmtxgfsk13clkgateen) {
  ASSERT_ERR(
      (((uint32_t)mdmtxgfsk13clkgateen << 14) & ~((uint32_t)0x00004000)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00004000)) |
                 ((uint32_t)mdmtxgfsk13clkgateen << 14));
}
...
__INLINE void rpl_mdm_tx13_clk_gate_en_setf(uint8_t mdmtx13clkgateen) {
  ASSERT_ERR((((uint32_t)mdmtx13clkgateen << 13) & ~((uint32_t)0x00002000)) ==
             0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00002000)) |
                 ((uint32_t)mdmtx13clkgateen << 13));
}
...
__INLINE void rpl_mdm_rxdpsk13_clk_gate_en_setf(uint8_t mdmrxdpsk13clkgateen) {
  ASSERT_ERR(
      (((uint32_t)mdmrxdpsk13clkgateen << 12) & ~((uint32_t)0x00001000)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00001000)) |
                 ((uint32_t)mdmrxdpsk13clkgateen << 12));
}
...
__INLINE void rpl_mdm_rxdpsk52_clk_gate_en_setf(uint8_t mdmrxdpsk52clkgateen) {
  ASSERT_ERR(
      (((uint32_t)mdmrxdpsk52clkgateen << 11) & ~((uint32_t)0x00000800)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00000800)) |
                 ((uint32_t)mdmrxdpsk52clkgateen << 11));
}
...
__INLINE void rpl_mdm_rxdl13_clk_gate_en_setf(uint8_t mdmrxdl13clkgateen) {
  ASSERT_ERR((((uint32_t)mdmrxdl13clkgateen << 10) & ~((uint32_t)0x00000400)) ==
             0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00000400)) |
                 ((uint32_t)mdmrxdl13clkgateen << 10));
}
...
__INLINE void rpl_mdm_rxgfsk13_clk_gate_en_setf(uint8_t mdmrxgfsk13clkgateen) {
  ASSERT_ERR(
      (((uint32_t)mdmrxgfsk13clkgateen << 9) & ~((uint32_t)0x00000200)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00000200)) |
                 ((uint32_t)mdmrxgfsk13clkgateen << 9));
}
...
__INLINE void rpl_mdm_rxgfsk52_clk_gate_en_setf(uint8_t mdmrxgfsk52clkgateen) {
  ASSERT_ERR(
      (((uint32_t)mdmrxgfsk52clkgateen << 8) & ~((uint32_t)0x00000100)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00000100)) |
                 ((uint32_t)mdmrxgfsk52clkgateen << 8));
}
...
__INLINE void rpl_mdm_rx52_clk_gate_en_setf(uint8_t mdmrx52clkgateen) {
  ASSERT_ERR((((uint32_t)mdmrx52clkgateen << 7) & ~((uint32_t)0x00000080)) ==
             0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00000080)) |
                 ((uint32_t)mdmrx52clkgateen << 7));
}
...
__INLINE void rpl_mdm_core13_clk_gate_en_setf(uint8_t mdmcore13clkgateen) {
  ASSERT_ERR((((uint32_t)mdmcore13clkgateen << 6) & ~((uint32_t)0x00000040)) ==
             0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00000040)) |
                 ((uint32_t)mdmcore13clkgateen << 6));
}
...
__INLINE void rpl_db_clk_gate_en_setf(uint8_t dbclkgateen) {
  ASSERT_ERR((((uint32_t)dbclkgateen << 5) & ~((uint32_t)0x00000020)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00000020)) |
                 ((uint32_t)dbclkgateen << 5));
}
...
__INLINE void rpl_agc_clk_gate_en_setf(uint8_t agcclkgateen) {
  ASSERT_ERR((((uint32_t)agcclkgateen << 4) & ~((uint32_t)0x00000010)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00000010)) |
                 ((uint32_t)agcclkgateen << 4));
}
...
__INLINE void rpl_sd_clk_gate_en_setf(uint8_t sdclkgateen) {
  ASSERT_ERR((((uint32_t)sdclkgateen << 3) & ~((uint32_t)0x00000008)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00000008)) |
                 ((uint32_t)sdclkgateen << 3));
}
...
__INLINE void rpl_gfsk_prefilt_clk_gate_en_setf(uint8_t gfskprefiltclkgateen) {
  ASSERT_ERR(
      (((uint32_t)gfskprefiltclkgateen << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00000004)) |
                 ((uint32_t)gfskprefiltclkgateen << 2));
}
...
__INLINE void rpl_dap_calib_clk_gate_en_setf(uint8_t dapcalibclkgateen) {
  ASSERT_ERR((((uint32_t)dapcalibclkgateen << 1) & ~((uint32_t)0x00000002)) ==
             0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)dapcalibclkgateen << 1));
}
...
__INLINE void rpl_dap_clk_gate_en_setf(uint8_t dapclkgateen) {
  ASSERT_ERR((((uint32_t)dapclkgateen << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL0_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL0_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)dapclkgateen << 0));
}
...
__INLINE void rpl_crm_cntl1_pack(uint8_t forcecrmctrl, uint8_t clkswitchctrl,
                                 uint8_t dpllen, uint8_t saradcclksel,
                                 uint8_t bbclkdiv, uint8_t lpmode) {
  ...
  REG_RPL_WR(RPL_CRM_CNTL1_ADDR,
             ((uint32_t)forcecrmctrl << 31) | ((uint32_t)clkswitchctrl << 24) |
                 ((uint32_t)dpllen << 23) | ((uint32_t)saradcclksel << 12) |
                 ((uint32_t)bbclkdiv << 8) | ((uint32_t)lpmode << 0));
}

__INLINE void rpl_crm_cntl1_unpack(uint8_t* forcecrmctrl,
                                   uint8_t* clkswitchctrl, uint8_t* dpllen,
                                   uint8_t* saradcclksel, uint8_t* bbclkdiv,
                                   uint8_t* lpmode) {
...
__INLINE void rpl_force_crm_ctrl_setf(uint8_t forcecrmctrl) {
  ASSERT_ERR((((uint32_t)forcecrmctrl << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL1_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL1_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)forcecrmctrl << 31));
}
...
__INLINE void rpl_clk_switch_ctrl_setf(uint8_t clkswitchctrl) {
  ASSERT_ERR((((uint32_t)clkswitchctrl << 24) & ~((uint32_t)0x03000000)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL1_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL1_ADDR) & ~((uint32_t)0x03000000)) |
                 ((uint32_t)clkswitchctrl << 24));
}
...
__INLINE void rpl_dpll_en_setf(uint8_t dpllen) {
  ASSERT_ERR((((uint32_t)dpllen << 23) & ~((uint32_t)0x00800000)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL1_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL1_ADDR) & ~((uint32_t)0x00800000)) |
                 ((uint32_t)dpllen << 23));
}
...
__INLINE void rpl_sar_adc_clk_sel_setf(uint8_t saradcclksel) {
  ASSERT_ERR((((uint32_t)saradcclksel << 12) & ~((uint32_t)0x00001000)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL1_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL1_ADDR) & ~((uint32_t)0x00001000)) |
                 ((uint32_t)saradcclksel << 12));
}
...
__INLINE void rpl_bb_clk_div_setf(uint8_t bbclkdiv) {
  ASSERT_ERR((((uint32_t)bbclkdiv << 8) & ~((uint32_t)0x00000300)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL1_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL1_ADDR) & ~((uint32_t)0x00000300)) |
                 ((uint32_t)bbclkdiv << 8));
}
...
__INLINE void rpl_lp_mode_setf(uint8_t lpmode) {
  ASSERT_ERR((((uint32_t)lpmode << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(RPL_CRM_CNTL1_ADDR,
             (REG_RPL_RD(RPL_CRM_CNTL1_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)lpmode << 0));
}
...
__INLINE void rpl_rfrxcntl_pack(
    uint8_t rxctrlforce, uint8_t rxgainforce, uint8_t forceaddarst,
    uint8_t rssiclkinven, uint8_t rxadcclkinven, uint8_t nldoaddarst,
    uint8_t rxadcsatdeten, uint8_t modemrxen, uint8_t rxadcen, uint8_t rxadcon,
    uint8_t agcen, uint8_t rssion, uint8_t rxfilton, uint8_t rxlobufon,
    uint8_t rxmixon, uint8_t rxlnaon, uint8_t rxrfbiason, uint8_t rxgainsel) {
  ...
  REG_RPL_WR(
      RPL_RFRXCNTL_ADDR,
      ((uint32_t)rxctrlforce << 31) | ((uint32_t)rxgainforce << 30) |
          ((uint32_t)forceaddarst << 29) | ((uint32_t)rssiclkinven << 25) |
          ((uint32_t)rxadcclkinven << 24) | ((uint32_t)nldoaddarst << 18) |
          ((uint32_t)rxadcsatdeten << 13) | ((uint32_t)modemrxen << 12) |
          ((uint32_t)rxadcen << 11) | ((uint32_t)rxadcon << 10) |
          ((uint32_t)agcen << 9) | ((uint32_t)rssion << 8) |
          ((uint32_t)rxfilton << 7) | ((uint32_t)rxlobufon << 6) |
          ((uint32_t)rxmixon << 5) | ((uint32_t)rxlnaon << 4) |
          ((uint32_t)rxrfbiason << 3) | ((uint32_t)rxgainsel << 0));
}

__INLINE void rpl_rfrxcntl_unpack(uint8_t* rxctrlforce, uint8_t* rxgainforce,
                                  uint8_t* forceaddarst, uint8_t* rssiclkinven,
                                  uint8_t* rxadcclkinven, uint8_t* nldoaddarst,
                                  uint8_t* rxadcsatdeten, uint8_t* modemrxen,
                                  uint8_t* rxadcen, uint8_t* rxadcon,
                                  uint8_t* agcen, uint8_t* rssion,
                                  uint8_t* rxfilton, uint8_t* rxlobufon,
                                  uint8_t* rxmixon, uint8_t* rxlnaon,
                                  uint8_t* rxrfbiason, uint8_t* rxgainsel) {
...
__INLINE void rpl_rxctrl_force_setf(uint8_t rxctrlforce) {
  ASSERT_ERR((((uint32_t)rxctrlforce << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)rxctrlforce << 31));
}
...
__INLINE void rpl_rxgain_force_setf(uint8_t rxgainforce) {
  ASSERT_ERR((((uint32_t)rxgainforce << 30) & ~((uint32_t)0x40000000)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x40000000)) |
                 ((uint32_t)rxgainforce << 30));
}
...
__INLINE void rpl_force_adda_rst_setf(uint8_t forceaddarst) {
  ASSERT_ERR((((uint32_t)forceaddarst << 29) & ~((uint32_t)0x20000000)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x20000000)) |
                 ((uint32_t)forceaddarst << 29));
}
...
__INLINE void rpl_rssi_clk_inv_en_setf(uint8_t rssiclkinven) {
  ASSERT_ERR((((uint32_t)rssiclkinven << 25) & ~((uint32_t)0x02000000)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x02000000)) |
                 ((uint32_t)rssiclkinven << 25));
}
...
__INLINE void rpl_rxadc_clk_inv_en_setf(uint8_t rxadcclkinven) {
  ASSERT_ERR((((uint32_t)rxadcclkinven << 24) & ~((uint32_t)0x01000000)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x01000000)) |
                 ((uint32_t)rxadcclkinven << 24));
}
...
__INLINE void rpl_n_ldo_adda_rst_setf(uint8_t nldoaddarst) {
  ASSERT_ERR((((uint32_t)nldoaddarst << 18) & ~((uint32_t)0x00040000)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x00040000)) |
                 ((uint32_t)nldoaddarst << 18));
}
...
__INLINE void rpl_rxadc_satdet_en_setf(uint8_t rxadcsatdeten) {
  ASSERT_ERR((((uint32_t)rxadcsatdeten << 13) & ~((uint32_t)0x00002000)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x00002000)) |
                 ((uint32_t)rxadcsatdeten << 13));
}
...
__INLINE void rpl_modem_rx_en_setf(uint8_t modemrxen) {
  ASSERT_ERR((((uint32_t)modemrxen << 12) & ~((uint32_t)0x00001000)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x00001000)) |
                 ((uint32_t)modemrxen << 12));
}
...
__INLINE void rpl_rxadc_en_setf(uint8_t rxadcen) {
  ASSERT_ERR((((uint32_t)rxadcen << 11) & ~((uint32_t)0x00000800)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x00000800)) |
                 ((uint32_t)rxadcen << 11));
}
...
__INLINE void rpl_rxadc_on_setf(uint8_t rxadcon) {
  ASSERT_ERR((((uint32_t)rxadcon << 10) & ~((uint32_t)0x00000400)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x00000400)) |
                 ((uint32_t)rxadcon << 10));
}
...
__INLINE void rpl_agc_en_setf(uint8_t agcen) {
  ASSERT_ERR((((uint32_t)agcen << 9) & ~((uint32_t)0x00000200)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x00000200)) |
                 ((uint32_t)agcen << 9));
}
...
__INLINE void rpl_rssi_on_setf(uint8_t rssion) {
  ASSERT_ERR((((uint32_t)rssion << 8) & ~((uint32_t)0x00000100)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x00000100)) |
                 ((uint32_t)rssion << 8));
}
...
__INLINE void rpl_rxfilt_on_setf(uint8_t rxfilton) {
  ASSERT_ERR((((uint32_t)rxfilton << 7) & ~((uint32_t)0x00000080)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x00000080)) |
                 ((uint32_t)rxfilton << 7));
}
...
__INLINE void rpl_rxlobuf_on_setf(uint8_t rxlobufon) {
  ASSERT_ERR((((uint32_t)rxlobufon << 6) & ~((uint32_t)0x00000040)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x00000040)) |
                 ((uint32_t)rxlobufon << 6));
}
...
__INLINE void rpl_rxmix_on_setf(uint8_t rxmixon) {
  ASSERT_ERR((((uint32_t)rxmixon << 5) & ~((uint32_t)0x00000020)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x00000020)) |
                 ((uint32_t)rxmixon << 5));
}
...
__INLINE void rpl_rxlna_on_setf(uint8_t rxlnaon) {
  ASSERT_ERR((((uint32_t)rxlnaon << 4) & ~((uint32_t)0x00000010)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x00000010)) |
                 ((uint32_t)rxlnaon << 4));
}
...
__INLINE void rpl_rxrf_bias_on_setf(uint8_t rxrfbiason) {
  ASSERT_ERR((((uint32_t)rxrfbiason << 3) & ~((uint32_t)0x00000008)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x00000008)) |
                 ((uint32_t)rxrfbiason << 3));
}
...
__INLINE void rpl_rxgain_sel_setf(uint8_t rxgainsel) {
  ASSERT_ERR((((uint32_t)rxgainsel << 0) & ~((uint32_t)0x00000007)) == 0);
  REG_RPL_WR(RPL_RFRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x00000007)) |
                 ((uint32_t)rxgainsel << 0));
}
...
__INLINE void rpl_rfrxconfig_pack(uint8_t rxfiltifen, uint8_t rxmixtrim,
                                  uint8_t rxlnatrim, uint8_t rxlnacfg,
                                  uint8_t rxfiltcfg, uint8_t rxadccfg,
                                  uint8_t rssicfg) {
  ...
  REG_RPL_WR(RPL_RFRXCONFIG_ADDR,
             ((uint32_t)rxfiltifen << 31) | ((uint32_t)rxmixtrim << 24) |
                 ((uint32_t)rxlnatrim << 22) | ((uint32_t)rxlnacfg << 20) |
                 ((uint32_t)rxfiltcfg << 16) | ((uint32_t)rxadccfg << 8) |
                 ((uint32_t)rssicfg << 0));
}

__INLINE void rpl_rfrxconfig_unpack(uint8_t* rxfiltifen, uint8_t* rxmixtrim,
                                    uint8_t* rxlnatrim, uint8_t* rxlnacfg,
                                    uint8_t* rxfiltcfg, uint8_t* rxadccfg,
                                    uint8_t* rssicfg) {
...
__INLINE void rpl_rxfilt_if_en_setf(uint8_t rxfiltifen) {
  ASSERT_ERR((((uint32_t)rxfiltifen << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_RPL_WR(RPL_RFRXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFRXCONFIG_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)rxfiltifen << 31));
}
...
__INLINE void rpl_rxmix_trim_setf(uint8_t rxmixtrim) {
  ASSERT_ERR((((uint32_t)rxmixtrim << 24) & ~((uint32_t)0x03000000)) == 0);
  REG_RPL_WR(RPL_RFRXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFRXCONFIG_ADDR) & ~((uint32_t)0x03000000)) |
                 ((uint32_t)rxmixtrim << 24));
}
...
__INLINE void rpl_rxlna_trim_setf(uint8_t rxlnatrim) {
  ASSERT_ERR((((uint32_t)rxlnatrim << 22) & ~((uint32_t)0x00C00000)) == 0);
  REG_RPL_WR(RPL_RFRXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFRXCONFIG_ADDR) & ~((uint32_t)0x00C00000)) |
                 ((uint32_t)rxlnatrim << 22));
}
...
__INLINE void rpl_rxlna_cfg_setf(uint8_t rxlnacfg) {
  ASSERT_ERR((((uint32_t)rxlnacfg << 20) & ~((uint32_t)0x00300000)) == 0);
  REG_RPL_WR(RPL_RFRXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFRXCONFIG_ADDR) & ~((uint32_t)0x00300000)) |
                 ((uint32_t)rxlnacfg << 20));
}
...
__INLINE void rpl_rxfilt_cfg_setf(uint8_t rxfiltcfg) {
  ASSERT_ERR((((uint32_t)rxfiltcfg << 16) & ~((uint32_t)0x000F0000)) == 0);
  REG_RPL_WR(RPL_RFRXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFRXCONFIG_ADDR) & ~((uint32_t)0x000F0000)) |
                 ((uint32_t)rxfiltcfg << 16));
}
...
__INLINE void rpl_rxadc_cfg_setf(uint8_t rxadccfg) {
  ASSERT_ERR((((uint32_t)rxadccfg << 8) & ~((uint32_t)0x0000FF00)) == 0);
  REG_RPL_WR(RPL_RFRXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFRXCONFIG_ADDR) & ~((uint32_t)0x0000FF00)) |
                 ((uint32_t)rxadccfg << 8));
}
...
__INLINE void rpl_rssi_cfg_setf(uint8_t rssicfg) {
  ASSERT_ERR((((uint32_t)rssicfg << 0) & ~((uint32_t)0x000000FF)) == 0);
  REG_RPL_WR(RPL_RFRXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFRXCONFIG_ADDR) & ~((uint32_t)0x000000FF)) |
                 ((uint32_t)rssicfg << 0));
}
...
__INLINE void rpl_rftxcntl0_pack(
    uint8_t txctrlforce, uint8_t txgaingfskforce, uint8_t txgainedrforce,
    uint8_t txdacclkinven, uint8_t txdccaltimeoutdsb, uint8_t txdccalen,
    uint8_t txdccalstart, uint8_t sdfifoen, uint8_t rampgenen,
    uint8_t modemtxen, uint8_t fmtx2pon, uint8_t txfiltqon, uint8_t txfiltion,
    uint8_t txdacqon, uint8_t txdacion, uint8_t fmtxon, uint8_t txpaon,
    uint8_t txpasel, uint8_t txrfdetecton, uint8_t txmixon, uint8_t txlobufon,
    uint8_t txgainedrsel, uint8_t txgaingfsksel) {
  ASSERT_ERR((((uint32_t)txctrlforce << 31) & ~((uint32_t)0x80000000)) == 0);
  ASSERT_ERR((((uint32_t)txgaingfskforce << 30) & ~((uint32_t)0x40000000)) ==
             0);
  ASSERT_ERR((((uint32_t)txgainedrforce << 29) & ~((uint32_t)0x20000000)) == 0);
  ASSERT_ERR((((uint32_t)txdacclkinven << 27) & ~((uint32_t)0x08000000)) == 0);
  ASSERT_ERR((((uint32_t)txdccaltimeoutdsb << 26) & ~((uint32_t)0x04000000)) ==
             0);
  ...
  REG_RPL_WR(
      RPL_RFTXCNTL0_ADDR,
      ((uint32_t)txctrlforce << 31) | ((uint32_t)txgaingfskforce << 30) |
          ((uint32_t)txgainedrforce << 29) | ((uint32_t)txdacclkinven << 27) |
          ((uint32_t)txdccaltimeoutdsb << 26) | ((uint32_t)txdccalen << 25) |
          ((uint32_t)txdccalstart << 24) | ((uint32_t)sdfifoen << 21) |
          ((uint32_t)rampgenen << 20) | ((uint32_t)modemtxen << 19) |
          ((uint32_t)fmtx2pon << 18) | ((uint32_t)txfiltqon << 17) |
          ((uint32_t)txfiltion << 16) | ((uint32_t)txdacqon << 15) |
          ((uint32_t)txdacion << 14) | ((uint32_t)fmtxon << 13) |
          ((uint32_t)txpaon << 12) | ((uint32_t)txpasel << 11) |
          ((uint32_t)txrfdetecton << 10) | ((uint32_t)txmixon << 9) |
          ((uint32_t)txlobufon << 8) | ((uint32_t)txgainedrsel << 4) |
          ((uint32_t)txgaingfsksel << 0));
}

__INLINE void rpl_rftxcntl0_unpack(
    uint8_t* txctrlforce, uint8_t* txgaingfskforce, uint8_t* txgainedrforce,
    uint8_t* txdacclkinven, uint8_t* txdccaltimeoutdsb, uint8_t* txdccalen,
    uint8_t* txdccalstart, uint8_t* sdfifoen, uint8_t* rampgenen,
    uint8_t* modemtxen, uint8_t* fmtx2pon, uint8_t* txfiltqon,
    uint8_t* txfiltion, uint8_t* txdacqon, uint8_t* txdacion, uint8_t* fmtxon,
    uint8_t* txpaon, uint8_t* txpasel, uint8_t* txrfdetecton, uint8_t* txmixon,
    uint8_t* txlobufon, uint8_t* txgainedrsel, uint8_t* txgaingfsksel) {
...
__INLINE void rpl_txctrl_force_setf(uint8_t txctrlforce) {
  ASSERT_ERR((((uint32_t)txctrlforce << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)txctrlforce << 31));
}
...
__INLINE void rpl_txgain_gfsk_force_setf(uint8_t txgaingfskforce) {
  ASSERT_ERR((((uint32_t)txgaingfskforce << 30) & ~((uint32_t)0x40000000)) ==
             0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x40000000)) |
                 ((uint32_t)txgaingfskforce << 30));
}
...
__INLINE void rpl_txgain_edr_force_setf(uint8_t txgainedrforce) {
  ASSERT_ERR((((uint32_t)txgainedrforce << 29) & ~((uint32_t)0x20000000)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x20000000)) |
                 ((uint32_t)txgainedrforce << 29));
}
...
__INLINE void rpl_txdac_clk_inv_en_setf(uint8_t txdacclkinven) {
  ASSERT_ERR((((uint32_t)txdacclkinven << 27) & ~((uint32_t)0x08000000)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x08000000)) |
                 ((uint32_t)txdacclkinven << 27));
}
...
__INLINE void rpl_txdc_cal_timeout_dsb_setf(uint8_t txdccaltimeoutdsb) {
  ASSERT_ERR((((uint32_t)txdccaltimeoutdsb << 26) & ~((uint32_t)0x04000000)) ==
             0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x04000000)) |
                 ((uint32_t)txdccaltimeoutdsb << 26));
}
...
__INLINE void rpl_txdc_cal_en_setf(uint8_t txdccalen) {
  ASSERT_ERR((((uint32_t)txdccalen << 25) & ~((uint32_t)0x02000000)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x02000000)) |
                 ((uint32_t)txdccalen << 25));
}
...
__INLINE void rpl_txdc_cal_start_setf(uint8_t txdccalstart) {
  ASSERT_ERR((((uint32_t)txdccalstart << 24) & ~((uint32_t)0x01000000)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x01000000)) |
                 ((uint32_t)txdccalstart << 24));
}
...
__INLINE void rpl_sd_fifo_en_setf(uint8_t sdfifoen) {
  ASSERT_ERR((((uint32_t)sdfifoen << 21) & ~((uint32_t)0x00200000)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x00200000)) |
                 ((uint32_t)sdfifoen << 21));
}
...
__INLINE void rpl_ramp_gen_en_setf(uint8_t rampgenen) {
  ASSERT_ERR((((uint32_t)rampgenen << 20) & ~((uint32_t)0x00100000)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x00100000)) |
                 ((uint32_t)rampgenen << 20));
}
...
__INLINE void rpl_modem_tx_en_setf(uint8_t modemtxen) {
  ASSERT_ERR((((uint32_t)modemtxen << 19) & ~((uint32_t)0x00080000)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x00080000)) |
                 ((uint32_t)modemtxen << 19));
}
...
__INLINE void rpl_fmtx2p_on_setf(uint8_t fmtx2pon) {
  ASSERT_ERR((((uint32_t)fmtx2pon << 18) & ~((uint32_t)0x00040000)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x00040000)) |
                 ((uint32_t)fmtx2pon << 18));
}
...
__INLINE void rpl_txfiltq_on_setf(uint8_t txfiltqon) {
  ASSERT_ERR((((uint32_t)txfiltqon << 17) & ~((uint32_t)0x00020000)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x00020000)) |
                 ((uint32_t)txfiltqon << 17));
}
...
__INLINE void rpl_txfilti_on_setf(uint8_t txfiltion) {
  ASSERT_ERR((((uint32_t)txfiltion << 16) & ~((uint32_t)0x00010000)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x00010000)) |
                 ((uint32_t)txfiltion << 16));
}
...
__INLINE void rpl_txdacq_on_setf(uint8_t txdacqon) {
  ASSERT_ERR((((uint32_t)txdacqon << 15) & ~((uint32_t)0x00008000)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x00008000)) |
                 ((uint32_t)txdacqon << 15));
}
...
__INLINE void rpl_txdaci_on_setf(uint8_t txdacion) {
  ASSERT_ERR((((uint32_t)txdacion << 14) & ~((uint32_t)0x00004000)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x00004000)) |
                 ((uint32_t)txdacion << 14));
}
...
__INLINE void rpl_fmtx_on_setf(uint8_t fmtxon) {
  ASSERT_ERR((((uint32_t)fmtxon << 13) & ~((uint32_t)0x00002000)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x00002000)) |
                 ((uint32_t)fmtxon << 13));
}
...
__INLINE void rpl_txpa_on_setf(uint8_t txpaon) {
  ASSERT_ERR((((uint32_t)txpaon << 12) & ~((uint32_t)0x00001000)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x00001000)) |
                 ((uint32_t)txpaon << 12));
}
...
__INLINE void rpl_txpa_sel_setf(uint8_t txpasel) {
  ASSERT_ERR((((uint32_t)txpasel << 11) & ~((uint32_t)0x00000800)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x00000800)) |
                 ((uint32_t)txpasel << 11));
}
...
__INLINE void rpl_txrf_detect_on_setf(uint8_t txrfdetecton) {
  ASSERT_ERR((((uint32_t)txrfdetecton << 10) & ~((uint32_t)0x00000400)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x00000400)) |
                 ((uint32_t)txrfdetecton << 10));
}
...
__INLINE void rpl_txmix_on_setf(uint8_t txmixon) {
  ASSERT_ERR((((uint32_t)txmixon << 9) & ~((uint32_t)0x00000200)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x00000200)) |
                 ((uint32_t)txmixon << 9));
}
...
__INLINE void rpl_txlobuf_on_setf(uint8_t txlobufon) {
  ASSERT_ERR((((uint32_t)txlobufon << 8) & ~((uint32_t)0x00000100)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x00000100)) |
                 ((uint32_t)txlobufon << 8));
}
...
__INLINE void rpl_txgain_edr_sel_setf(uint8_t txgainedrsel) {
  ASSERT_ERR((((uint32_t)txgainedrsel << 4) & ~((uint32_t)0x000000F0)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x000000F0)) |
                 ((uint32_t)txgainedrsel << 4));
}
...
__INLINE void rpl_txgain_gfsk_sel_setf(uint8_t txgaingfsksel) {
  ASSERT_ERR((((uint32_t)txgaingfsksel << 0) & ~((uint32_t)0x0000000F)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL0_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL0_ADDR) & ~((uint32_t)0x0000000F)) |
                 ((uint32_t)txgaingfsksel << 0));
}
...
__INLINE void rpl_rftxcntl1_pack(uint8_t txdcforce, uint8_t txdcq,
                                 uint8_t txdci) {
  ...
  REG_RPL_WR(RPL_RFTXCNTL1_ADDR, ((uint32_t)txdcforce << 31) |
                                     ((uint32_t)txdcq << 8) |
                                     ((uint32_t)txdci << 0));
}

__INLINE void rpl_rftxcntl1_unpack(uint8_t* txdcforce, uint8_t* txdcq,
                                   uint8_t* txdci) {
...
__INLINE void rpl_txdc_force_setf(uint8_t txdcforce) {
  ASSERT_ERR((((uint32_t)txdcforce << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL1_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL1_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)txdcforce << 31));
}
...
__INLINE void rpl_txdc_q_setf(uint8_t txdcq) {
  ASSERT_ERR((((uint32_t)txdcq << 8) & ~((uint32_t)0x00001F00)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL1_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL1_ADDR) & ~((uint32_t)0x00001F00)) |
                 ((uint32_t)txdcq << 8));
}
...
__INLINE void rpl_txdc_i_setf(uint8_t txdci) {
  ASSERT_ERR((((uint32_t)txdci << 0) & ~((uint32_t)0x0000001F)) == 0);
  REG_RPL_WR(RPL_RFTXCNTL1_ADDR,
             (REG_RPL_RD(RPL_RFTXCNTL1_ADDR) & ~((uint32_t)0x0000001F)) |
                 ((uint32_t)txdci << 0));
}
...
__INLINE void rpl_rftxconfig_pack(uint8_t txfiltifen,
                                  uint8_t txdccaltimeoutdelay,
                                  uint8_t fmtx2pondlydcnt, uint8_t fmtxtrim,
                                  uint8_t txmixtrim, uint8_t txtanksel,
                                  uint8_t txfiltcfg, uint8_t txpacfg) {
  ASSERT_ERR((((uint32_t)txfiltifen << 31) & ~((uint32_t)0x80000000)) == 0);
  ASSERT_ERR(
      (((uint32_t)txdccaltimeoutdelay << 20) & ~((uint32_t)0x0FF00000)) == 0);
  ASSERT_ERR((((uint32_t)fmtx2pondlydcnt << 16) & ~((uint32_t)0x000F0000)) ==
             0);
  ...
  REG_RPL_WR(
      RPL_RFTXCONFIG_ADDR,
      ((uint32_t)txfiltifen << 31) | ((uint32_t)txdccaltimeoutdelay << 20) |
          ((uint32_t)fmtx2pondlydcnt << 16) | ((uint32_t)fmtxtrim << 14) |
          ((uint32_t)txmixtrim << 12) | ((uint32_t)txtanksel << 8) |
          ((uint32_t)txfiltcfg << 4) | ((uint32_t)txpacfg << 0));
}

__INLINE void rpl_rftxconfig_unpack(uint8_t* txfiltifen,
                                    uint8_t* txdccaltimeoutdelay,
                                    uint8_t* fmtx2pondlydcnt, uint8_t* fmtxtrim,
                                    uint8_t* txmixtrim, uint8_t* txtanksel,
                                    uint8_t* txfiltcfg, uint8_t* txpacfg) {
...
__INLINE void rpl_txfilt_if_en_setf(uint8_t txfiltifen) {
  ASSERT_ERR((((uint32_t)txfiltifen << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_RPL_WR(RPL_RFTXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXCONFIG_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)txfiltifen << 31));
}
...
__INLINE void rpl_txdc_cal_timeout_delay_setf(uint8_t txdccaltimeoutdelay) {
  ASSERT_ERR(
      (((uint32_t)txdccaltimeoutdelay << 20) & ~((uint32_t)0x0FF00000)) == 0);
  REG_RPL_WR(RPL_RFTXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXCONFIG_ADDR) & ~((uint32_t)0x0FF00000)) |
                 ((uint32_t)txdccaltimeoutdelay << 20));
}
...
__INLINE void rpl_fmtx2p_on_dlyd_cnt_setf(uint8_t fmtx2pondlydcnt) {
  ASSERT_ERR((((uint32_t)fmtx2pondlydcnt << 16) & ~((uint32_t)0x000F0000)) ==
             0);
  REG_RPL_WR(RPL_RFTXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXCONFIG_ADDR) & ~((uint32_t)0x000F0000)) |
                 ((uint32_t)fmtx2pondlydcnt << 16));
}
...
__INLINE void rpl_fmtx_trim_setf(uint8_t fmtxtrim) {
  ASSERT_ERR((((uint32_t)fmtxtrim << 14) & ~((uint32_t)0x0000C000)) == 0);
  REG_RPL_WR(RPL_RFTXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXCONFIG_ADDR) & ~((uint32_t)0x0000C000)) |
                 ((uint32_t)fmtxtrim << 14));
}
...
__INLINE void rpl_txmix_trim_setf(uint8_t txmixtrim) {
  ASSERT_ERR((((uint32_t)txmixtrim << 12) & ~((uint32_t)0x00003000)) == 0);
  REG_RPL_WR(RPL_RFTXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXCONFIG_ADDR) & ~((uint32_t)0x00003000)) |
                 ((uint32_t)txmixtrim << 12));
}
...
__INLINE void rpl_txtank_sel_setf(uint8_t txtanksel) {
  ASSERT_ERR((((uint32_t)txtanksel << 8) & ~((uint32_t)0x00000700)) == 0);
  REG_RPL_WR(RPL_RFTXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXCONFIG_ADDR) & ~((uint32_t)0x00000700)) |
                 ((uint32_t)txtanksel << 8));
}
...
__INLINE void rpl_txfilt_cfg_setf(uint8_t txfiltcfg) {
  ASSERT_ERR((((uint32_t)txfiltcfg << 4) & ~((uint32_t)0x000000F0)) == 0);
  REG_RPL_WR(RPL_RFTXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXCONFIG_ADDR) & ~((uint32_t)0x000000F0)) |
                 ((uint32_t)txfiltcfg << 4));
}
...
__INLINE void rpl_txpa_cfg_setf(uint8_t txpacfg) {
  ASSERT_ERR((((uint32_t)txpacfg << 0) & ~((uint32_t)0x00000007)) == 0);
  REG_RPL_WR(RPL_RFTXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXCONFIG_ADDR) & ~((uint32_t)0x00000007)) |
                 ((uint32_t)txpacfg << 0));
}
...
__INLINE void rpl_rftxstat_unpack(uint8_t* txdcqval, uint8_t* txdcival,
                                  uint8_t* txdccaldead, uint8_t* txdccaldone) {
...
__INLINE void rpl_rftxrxcntl_pack(
    uint8_t txrxctrlforce, uint8_t vcofcicpcalforce, uint8_t vcofccalicpmode,
    uint8_t rxmdmbypassen, uint8_t txmdmbypassen, uint8_t rfpllcaltimeoutdsb,
    uint8_t icpcalstart, uint8_t vcofccalstart, uint8_t pdon, uint8_t bbbiason,
    uint8_t lodiv2on) {
  ASSERT_ERR((((uint32_t)txrxctrlforce << 31) & ~((uint32_t)0x80000000)) == 0);
  ASSERT_ERR((((uint32_t)vcofcicpcalforce << 30) & ~((uint32_t)0x40000000)) ==
             0);
  ASSERT_ERR((((uint32_t)vcofccalicpmode << 12) & ~((uint32_t)0x00001000)) ==
             0);
  ASSERT_ERR((((uint32_t)rxmdmbypassen << 9) & ~((uint32_t)0x00000200)) == 0);
  ASSERT_ERR((((uint32_t)txmdmbypassen << 8) & ~((uint32_t)0x00000100)) == 0);
  ASSERT_ERR((((uint32_t)rfpllcaltimeoutdsb << 6) & ~((uint32_t)0x00000040)) ==
             0);
  ...
  REG_RPL_WR(
      RPL_RFTXRXCNTL_ADDR,
      ((uint32_t)txrxctrlforce << 31) | ((uint32_t)vcofcicpcalforce << 30) |
          ((uint32_t)vcofccalicpmode << 12) | ((uint32_t)rxmdmbypassen << 9) |
          ((uint32_t)txmdmbypassen << 8) | ((uint32_t)rfpllcaltimeoutdsb << 6) |
          ((uint32_t)icpcalstart << 5) | ((uint32_t)vcofccalstart << 4) |
          ((uint32_t)pdon << 2) | ((uint32_t)bbbiason << 1) |
          ((uint32_t)lodiv2on << 0));
}

__INLINE void rpl_rftxrxcntl_unpack(
    uint8_t* txrxctrlforce, uint8_t* vcofcicpcalforce, uint8_t* vcofccalicpmode,
    uint8_t* rxmdmbypassen, uint8_t* txmdmbypassen, uint8_t* rfpllcaltimeoutdsb,
    uint8_t* icpcalstart, uint8_t* vcofccalstart, uint8_t* pdon,
    uint8_t* bbbiason, uint8_t* lodiv2on) {
...
__INLINE void rpl_txrxctrl_force_setf(uint8_t txrxctrlforce) {
  ASSERT_ERR((((uint32_t)txrxctrlforce << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_RPL_WR(RPL_RFTXRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCNTL_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)txrxctrlforce << 31));
}
...
__INLINE void rpl_vcofc_icp_cal_force_setf(uint8_t vcofcicpcalforce) {
  ASSERT_ERR((((uint32_t)vcofcicpcalforce << 30) & ~((uint32_t)0x40000000)) ==
             0);
  REG_RPL_WR(RPL_RFTXRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCNTL_ADDR) & ~((uint32_t)0x40000000)) |
                 ((uint32_t)vcofcicpcalforce << 30));
}
...
__INLINE void rpl_vcofc_cal_icp_mode_setf(uint8_t vcofccalicpmode) {
  ASSERT_ERR((((uint32_t)vcofccalicpmode << 12) & ~((uint32_t)0x00001000)) ==
             0);
  REG_RPL_WR(RPL_RFTXRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCNTL_ADDR) & ~((uint32_t)0x00001000)) |
                 ((uint32_t)vcofccalicpmode << 12));
}
...
__INLINE void rpl_rxmdm_bypass_en_setf(uint8_t rxmdmbypassen) {
  ASSERT_ERR((((uint32_t)rxmdmbypassen << 9) & ~((uint32_t)0x00000200)) == 0);
  REG_RPL_WR(RPL_RFTXRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCNTL_ADDR) & ~((uint32_t)0x00000200)) |
                 ((uint32_t)rxmdmbypassen << 9));
}
...
__INLINE void rpl_txmdm_bypass_en_setf(uint8_t txmdmbypassen) {
  ASSERT_ERR((((uint32_t)txmdmbypassen << 8) & ~((uint32_t)0x00000100)) == 0);
  REG_RPL_WR(RPL_RFTXRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCNTL_ADDR) & ~((uint32_t)0x00000100)) |
                 ((uint32_t)txmdmbypassen << 8));
}
...
__INLINE void rpl_rfpll_cal_timeout_dsb_setf(uint8_t rfpllcaltimeoutdsb) {
  ASSERT_ERR((((uint32_t)rfpllcaltimeoutdsb << 6) & ~((uint32_t)0x00000040)) ==
             0);
  REG_RPL_WR(RPL_RFTXRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCNTL_ADDR) & ~((uint32_t)0x00000040)) |
                 ((uint32_t)rfpllcaltimeoutdsb << 6));
}
...
__INLINE void rpl_icp_cal_start_setf(uint8_t icpcalstart) {
  ASSERT_ERR((((uint32_t)icpcalstart << 5) & ~((uint32_t)0x00000020)) == 0);
  REG_RPL_WR(RPL_RFTXRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCNTL_ADDR) & ~((uint32_t)0x00000020)) |
                 ((uint32_t)icpcalstart << 5));
}
...
__INLINE void rpl_vcofc_cal_start_setf(uint8_t vcofccalstart) {
  ASSERT_ERR((((uint32_t)vcofccalstart << 4) & ~((uint32_t)0x00000010)) == 0);
  REG_RPL_WR(RPL_RFTXRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCNTL_ADDR) & ~((uint32_t)0x00000010)) |
                 ((uint32_t)vcofccalstart << 4));
}
...
__INLINE void rpl_pd_on_setf(uint8_t pdon) {
  ASSERT_ERR((((uint32_t)pdon << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_RPL_WR(RPL_RFTXRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCNTL_ADDR) & ~((uint32_t)0x00000004)) |
                 ((uint32_t)pdon << 2));
}
...
__INLINE void rpl_bb_bias_on_setf(uint8_t bbbiason) {
  ASSERT_ERR((((uint32_t)bbbiason << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_RPL_WR(RPL_RFTXRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCNTL_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)bbbiason << 1));
}
...
__INLINE void rpl_lodiv2_on_setf(uint8_t lodiv2on) {
  ASSERT_ERR((((uint32_t)lodiv2on << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(RPL_RFTXRXCNTL_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCNTL_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)lodiv2on << 0));
}
...
__INLINE void rpl_rftxrxconfig_pack(uint8_t databuspol, uint8_t icpcaldsb,
                                    uint8_t calibmode,
                                    uint8_t calibtimeoutdelay,
                                    uint8_t icpcalsettletime,
                                    uint8_t vcofccalsettletime,
                                    uint8_t bbbiascfg, uint8_t dapclkmode,
                                    uint8_t lodiv2trim, uint8_t lobuftrim) {
  ...
  ASSERT_ERR((((uint32_t)calibtimeoutdelay << 20) & ~((uint32_t)0x0FF00000)) ==
             0);
  ASSERT_ERR((((uint32_t)icpcalsettletime << 14) & ~((uint32_t)0x000FC000)) ==
             0);
  ASSERT_ERR((((uint32_t)vcofccalsettletime << 8) & ~((uint32_t)0x00003F00)) ==
             0);
  ...
  REG_RPL_WR(RPL_RFTXRXCONFIG_ADDR,
             ((uint32_t)databuspol << 31) | ((uint32_t)icpcaldsb << 30) |
                 ((uint32_t)calibmode << 28) |
                 ((uint32_t)calibtimeoutdelay << 20) |
                 ((uint32_t)icpcalsettletime << 14) |
                 ((uint32_t)vcofccalsettletime << 8) |
                 ((uint32_t)bbbiascfg << 6) | ((uint32_t)dapclkmode << 4) |
                 ((uint32_t)lodiv2trim << 2) | ((uint32_t)lobuftrim << 0));
}

__INLINE void rpl_rftxrxconfig_unpack(uint8_t* databuspol, uint8_t* icpcaldsb,
                                      uint8_t* calibmode,
                                      uint8_t* calibtimeoutdelay,
                                      uint8_t* icpcalsettletime,
                                      uint8_t* vcofccalsettletime,
...
__INLINE void rpl_data_bus_pol_setf(uint8_t databuspol) {
  ASSERT_ERR((((uint32_t)databuspol << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_RPL_WR(RPL_RFTXRXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCONFIG_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)databuspol << 31));
}
...
__INLINE void rpl_icp_cal_dsb_setf(uint8_t icpcaldsb) {
  ASSERT_ERR((((uint32_t)icpcaldsb << 30) & ~((uint32_t)0x40000000)) == 0);
  REG_RPL_WR(RPL_RFTXRXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCONFIG_ADDR) & ~((uint32_t)0x40000000)) |
                 ((uint32_t)icpcaldsb << 30));
}
...
__INLINE void rpl_calib_mode_setf(uint8_t calibmode) {
  ASSERT_ERR((((uint32_t)calibmode << 28) & ~((uint32_t)0x30000000)) == 0);
  REG_RPL_WR(RPL_RFTXRXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCONFIG_ADDR) & ~((uint32_t)0x30000000)) |
                 ((uint32_t)calibmode << 28));
}
...
__INLINE void rpl_calib_timeout_delay_setf(uint8_t calibtimeoutdelay) {
  ASSERT_ERR((((uint32_t)calibtimeoutdelay << 20) & ~((uint32_t)0x0FF00000)) ==
             0);
  REG_RPL_WR(RPL_RFTXRXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCONFIG_ADDR) & ~((uint32_t)0x0FF00000)) |
                 ((uint32_t)calibtimeoutdelay << 20));
}
...
__INLINE void rpl_icp_cal_settle_time_setf(uint8_t icpcalsettletime) {
  ASSERT_ERR((((uint32_t)icpcalsettletime << 14) & ~((uint32_t)0x000FC000)) ==
             0);
  REG_RPL_WR(RPL_RFTXRXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCONFIG_ADDR) & ~((uint32_t)0x000FC000)) |
                 ((uint32_t)icpcalsettletime << 14));
}
...
__INLINE void rpl_vcofc_cal_settle_time_setf(uint8_t vcofccalsettletime) {
  ASSERT_ERR((((uint32_t)vcofccalsettletime << 8) & ~((uint32_t)0x00003F00)) ==
             0);
  REG_RPL_WR(RPL_RFTXRXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCONFIG_ADDR) & ~((uint32_t)0x00003F00)) |
                 ((uint32_t)vcofccalsettletime << 8));
}
...
__INLINE void rpl_bb_bias_cfg_setf(uint8_t bbbiascfg) {
  ASSERT_ERR((((uint32_t)bbbiascfg << 6) & ~((uint32_t)0x000000C0)) == 0);
  REG_RPL_WR(RPL_RFTXRXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCONFIG_ADDR) & ~((uint32_t)0x000000C0)) |
                 ((uint32_t)bbbiascfg << 6));
}
...
__INLINE void rpl_dap_clk_mode_setf(uint8_t dapclkmode) {
  ASSERT_ERR((((uint32_t)dapclkmode << 4) & ~((uint32_t)0x00000010)) == 0);
  REG_RPL_WR(RPL_RFTXRXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCONFIG_ADDR) & ~((uint32_t)0x00000010)) |
                 ((uint32_t)dapclkmode << 4));
}
...
__INLINE void rpl_lodiv2_trim_setf(uint8_t lodiv2trim) {
  ASSERT_ERR((((uint32_t)lodiv2trim << 2) & ~((uint32_t)0x0000000C)) == 0);
  REG_RPL_WR(RPL_RFTXRXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCONFIG_ADDR) & ~((uint32_t)0x0000000C)) |
                 ((uint32_t)lodiv2trim << 2));
}
...
__INLINE void rpl_lobuf_trim_setf(uint8_t lobuftrim) {
  ASSERT_ERR((((uint32_t)lobuftrim << 0) & ~((uint32_t)0x00000003)) == 0);
  REG_RPL_WR(RPL_RFTXRXCONFIG_ADDR,
             (REG_RPL_RD(RPL_RFTXRXCONFIG_ADDR) & ~((uint32_t)0x00000003)) |
                 ((uint32_t)lobuftrim << 0));
}
...
__INLINE void rpl_rftxrxstat_unpack(uint8_t* caltimeout, uint8_t* icpcaldone,
                                    uint8_t* vcofccaldone) {
...
__INLINE void rpl_sar_adc_cntl_pack(uint8_t saradcforce, uint8_t saradcsel,
                                    uint8_t saradcmode, uint8_t saradcstart,
                                    uint8_t saradcon) {
  ...
  REG_RPL_WR(RPL_SAR_ADC_CNTL_ADDR,
             ((uint32_t)saradcforce << 31) | ((uint32_t)saradcsel << 4) |
                 ((uint32_t)saradcmode << 2) | ((uint32_t)saradcstart << 1) |
                 ((uint32_t)saradcon << 0));
}

__INLINE void rpl_sar_adc_cntl_unpack(uint8_t* saradcforce, uint8_t* saradcsel,
                                      uint8_t* saradcmode, uint8_t* saradcstart,
                                      uint8_t* saradcon) {
...
__INLINE void rpl_sar_adc_force_setf(uint8_t saradcforce) {
  ASSERT_ERR((((uint32_t)saradcforce << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_RPL_WR(RPL_SAR_ADC_CNTL_ADDR,
             (REG_RPL_RD(RPL_SAR_ADC_CNTL_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)saradcforce << 31));
}
...
__INLINE void rpl_sar_adc_sel_setf(uint8_t saradcsel) {
  ASSERT_ERR((((uint32_t)saradcsel << 4) & ~((uint32_t)0x000000F0)) == 0);
  REG_RPL_WR(RPL_SAR_ADC_CNTL_ADDR,
             (REG_RPL_RD(RPL_SAR_ADC_CNTL_ADDR) & ~((uint32_t)0x000000F0)) |
                 ((uint32_t)saradcsel << 4));
}
...
__INLINE void rpl_sar_adc_mode_setf(uint8_t saradcmode) {
  ASSERT_ERR((((uint32_t)saradcmode << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_RPL_WR(RPL_SAR_ADC_CNTL_ADDR,
             (REG_RPL_RD(RPL_SAR_ADC_CNTL_ADDR) & ~((uint32_t)0x00000004)) |
                 ((uint32_t)saradcmode << 2));
}
...
__INLINE void rpl_sar_adc_start_setf(uint8_t saradcstart) {
  ASSERT_ERR((((uint32_t)saradcstart << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_RPL_WR(RPL_SAR_ADC_CNTL_ADDR,
             (REG_RPL_RD(RPL_SAR_ADC_CNTL_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)saradcstart << 1));
}
...
__INLINE void rpl_sar_adc_on_setf(uint8_t saradcon) {
  ASSERT_ERR((((uint32_t)saradcon << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(RPL_SAR_ADC_CNTL_ADDR,
             (REG_RPL_RD(RPL_SAR_ADC_CNTL_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)saradcon << 0));
}
...
__INLINE void rpl_sar_adc_stat_unpack(uint8_t* saradcdone,
                                      uint16_t* saradcval) {
...
__INLINE void rpl_rxadc_satdet_config_pack(uint8_t rxadcsatdetmode,
                                           uint8_t rxadcsatdetthr,
                                           uint8_t rxadcsatdetwindow) {
  ASSERT_ERR((((uint32_t)rxadcsatdetmode << 30) & ~((uint32_t)0xC0000000)) ==
             0);
  ASSERT_ERR((((uint32_t)rxadcsatdetthr << 8) & ~((uint32_t)0x00007F00)) == 0);
  ASSERT_ERR((((uint32_t)rxadcsatdetwindow << 0) & ~((uint32_t)0x0000007F)) ==
             0);
  REG_RPL_WR(RPL_RXADC_SATDET_CONFIG_ADDR,
             ((uint32_t)rxadcsatdetmode << 30) |
                 ((uint32_t)rxadcsatdetthr << 8) |
                 ((uint32_t)rxadcsatdetwindow << 0));
}

__INLINE void rpl_rxadc_satdet_config_unpack(uint8_t* rxadcsatdetmode,
                                             uint8_t* rxadcsatdetthr,
                                             uint8_t* rxadcsatdetwindow) {
...
__INLINE void rpl_rxadc_satdet_mode_setf(uint8_t rxadcsatdetmode) {
  ASSERT_ERR((((uint32_t)rxadcsatdetmode << 30) & ~((uint32_t)0xC0000000)) ==
             0);
  REG_RPL_WR(
      RPL_RXADC_SATDET_CONFIG_ADDR,
      (REG_RPL_RD(RPL_RXADC_SATDET_CONFIG_ADDR) & ~((uint32_t)0xC0000000)) |
          ((uint32_t)rxadcsatdetmode << 30));
}
...
__INLINE void rpl_rxadc_satdet_thr_setf(uint8_t rxadcsatdetthr) {
  ...
  REG_RPL_WR(
      RPL_RXADC_SATDET_CONFIG_ADDR,
      (REG_RPL_RD(RPL_RXADC_SATDET_CONFIG_ADDR) & ~((uint32_t)0x00007F00)) |
          ((uint32_t)rxadcsatdetthr << 8));
}
...
__INLINE void rpl_rxadc_satdet_window_setf(uint8_t rxadcsatdetwindow) {
  ...
  REG_RPL_WR(
      RPL_RXADC_SATDET_CONFIG_ADDR,
      (REG_RPL_RD(RPL_RXADC_SATDET_CONFIG_ADDR) & ~((uint32_t)0x0000007F)) |
          ((uint32_t)rxadcsatdetwindow << 0));
}
...
__INLINE void rpl_txdc_detect_config_pack(uint8_t txdcmode,
                                          uint16_t txdcrefvalue,
                                          uint8_t txdcsettletime) {
  ...
  REG_RPL_WR(RPL_TXDC_DETECT_CONFIG_ADDR, ((uint32_t)txdcmode << 31) |
                                              ((uint32_t)txdcrefvalue << 16) |
                                              ((uint32_t)txdcsettletime << 0));
}

__INLINE void rpl_txdc_detect_config_unpack(uint8_t* txdcmode,
                                            uint16_t* txdcrefvalue,
                                            uint8_t* txdcsettletime) {
...
__INLINE void rpl_txdc_mode_setf(uint8_t txdcmode) {
  ASSERT_ERR((((uint32_t)txdcmode << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_RPL_WR(
      RPL_TXDC_DETECT_CONFIG_ADDR,
      (REG_RPL_RD(RPL_TXDC_DETECT_CONFIG_ADDR) & ~((uint32_t)0x80000000)) |
          ((uint32_t)txdcmode << 31));
}
...
__INLINE void rpl_txdc_ref_value_setf(uint16_t txdcrefvalue) {
  ...
  REG_RPL_WR(
      RPL_TXDC_DETECT_CONFIG_ADDR,
      (REG_RPL_RD(RPL_TXDC_DETECT_CONFIG_ADDR) & ~((uint32_t)0x03FF0000)) |
          ((uint32_t)txdcrefvalue << 16));
}
...
__INLINE void rpl_txdc_settle_time_setf(uint8_t txdcsettletime) {
  ...
  REG_RPL_WR(
      RPL_TXDC_DETECT_CONFIG_ADDR,
      (REG_RPL_RD(RPL_TXDC_DETECT_CONFIG_ADDR) & ~((uint32_t)0x000000FF)) |
          ((uint32_t)txdcsettletime << 0));
}
...
__INLINE void rpl_testmuxcntl_pack(uint8_t mux1ctrl, uint8_t mux0ctrl) {
  ...
  REG_RPL_WR(RPL_TESTMUXCNTL_ADDR,
             ((uint32_t)mux1ctrl << 8) | ((uint32_t)mux0ctrl << 0));
}
...
__INLINE void rpl_mux1_ctrl_setf(uint8_t mux1ctrl) {
  ASSERT_ERR((((uint32_t)mux1ctrl << 8) & ~((uint32_t)0x0000FF00)) == 0);
  REG_RPL_WR(RPL_TESTMUXCNTL_ADDR,
             (REG_RPL_RD(RPL_TESTMUXCNTL_ADDR) & ~((uint32_t)0x0000FF00)) |
                 ((uint32_t)mux1ctrl << 8));
}
...
__INLINE void rpl_mux0_ctrl_setf(uint8_t mux0ctrl) {
  ASSERT_ERR((((uint32_t)mux0ctrl << 0) & ~((uint32_t)0x000000FF)) == 0);
  REG_RPL_WR(RPL_TESTMUXCNTL_ADDR,
             (REG_RPL_RD(RPL_TESTMUXCNTL_ADDR) & ~((uint32_t)0x000000FF)) |
                 ((uint32_t)mux0ctrl << 0));
}
...
__INLINE void rpl_pad_cntl_pack(uint8_t drvstrcntl, uint8_t pulldncntl,
                                uint8_t pullupcntl) {
  ...
  REG_RPL_WR(RPL_PAD_CNTL_ADDR, ((uint32_t)drvstrcntl << 16) |
                                    ((uint32_t)pulldncntl << 8) |
                                    ((uint32_t)pullupcntl << 0));
}

__INLINE void rpl_pad_cntl_unpack(uint8_t* drvstrcntl, uint8_t* pulldncntl,
                                  uint8_t* pullupcntl) {
...
__INLINE void rpl_drvstr_cntl_setf(uint8_t drvstrcntl) {
  ASSERT_ERR((((uint32_t)drvstrcntl << 16) & ~((uint32_t)0x00FF0000)) == 0);
  REG_RPL_WR(RPL_PAD_CNTL_ADDR,
             (REG_RPL_RD(RPL_PAD_CNTL_ADDR) & ~((uint32_t)0x00FF0000)) |
                 ((uint32_t)drvstrcntl << 16));
}
...
__INLINE void rpl_pulldn_cntl_setf(uint8_t pulldncntl) {
  ASSERT_ERR((((uint32_t)pulldncntl << 8) & ~((uint32_t)0x0000FF00)) == 0);
  REG_RPL_WR(RPL_PAD_CNTL_ADDR,
             (REG_RPL_RD(RPL_PAD_CNTL_ADDR) & ~((uint32_t)0x0000FF00)) |
                 ((uint32_t)pulldncntl << 8));
}
...
__INLINE void rpl_pullup_cntl_setf(uint8_t pullupcntl) {
  ASSERT_ERR((((uint32_t)pullupcntl << 0) & ~((uint32_t)0x000000FF)) == 0);
  REG_RPL_WR(RPL_PAD_CNTL_ADDR,
             (REG_RPL_RD(RPL_PAD_CNTL_ADDR) & ~((uint32_t)0x000000FF)) |
                 ((uint32_t)pullupcntl << 0));
}
