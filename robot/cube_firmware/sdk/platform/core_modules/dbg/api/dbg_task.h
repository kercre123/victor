 ...
 * @brief Debug task
 *
 * The DBG task is responsible for receiving and sending debug informations
 *between the HCI and the embedded.
 *
 * @{
 ****************************************************************************************
 */
...
#if (RW_WLAN_COEX_TEST)
/// HCI Debug wlan coexistence test scenario command parameters - vendor
/// specific
...
struct dbg_le_llcp_discard_req {
  /// Handle pointing to the connection for which LLCP commands have to be
  /// discarded
  uint16_t conhdl;
