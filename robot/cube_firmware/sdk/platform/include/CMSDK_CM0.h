...
#define CMSDK_UART_BAUDDIV_Msk                                                \
  (0xFFFFFul << CMSDK_UART_BAUDDIV_Pos) /*!< CMSDK_UART BAUDDIV: BAUDDIV Mask \
                                         */
...
#define CMSDK_DUALTIMER1_CTRL_EN_Msk                                          \
  (0x1ul << CMSDK_DUALTIMER1_CTRL_EN_Pos) /*!< CMSDK_DUALTIMER1 CTRL_EN: CTRL \
                                             Enable Mask */
...
#define CMSDK_DUALTIMER1_CTRL_INTEN_Msk                                        \
  (0x1ul << CMSDK_DUALTIMER1_CTRL_INTEN_Pos) /*!< CMSDK_DUALTIMER1 CTRL_INTEN: \
...
#define CMSDK_DUALTIMER1_CTRL_PRESCALE_Msk                                     \
  (0x3ul                                                                       \
   << CMSDK_DUALTIMER1_CTRL_PRESCALE_Pos) /*!< CMSDK_DUALTIMER1 CTRL_PRESCALE: \
                                             CTRL PRESCALE Mask */
...
#define CMSDK_DUALTIMER1_CTRL_ONESHOOT_Msk                                     \
  (0x1ul                                                                       \
   << CMSDK_DUALTIMER1_CTRL_ONESHOOT_Pos) /*!< CMSDK_DUALTIMER1 CTRL_ONESHOOT: \
                                             CTRL ONESHOOT Mask */
...
#define CMSDK_DUALTIMER1_RAWINTSTAT_Msk                                        \
  (0x1ul << CMSDK_DUALTIMER1_RAWINTSTAT_Pos) /*!< CMSDK_DUALTIMER1 RAWINTSTAT: \
                                                Raw Int Status Mask */
...
#define CMSDK_DUALTIMER1_MASKINTSTAT_Msk                                   \
  (0x1ul                                                                   \
   << CMSDK_DUALTIMER1_MASKINTSTAT_Pos) /*!< CMSDK_DUALTIMER1 MASKINTSTAT: \
...
#define CMSDK_DUALTIMER1_BGLOAD_Msk                                           \
  (0xFFFFFFFFul << CMSDK_DUALTIMER1_BGLOAD_Pos) /*!< CMSDK_DUALTIMER1 BGLOAD: \
...
#define CMSDK_DUALTIMER2_CTRL_EN_Msk                                          \
  (0x1ul << CMSDK_DUALTIMER2_CTRL_EN_Pos) /*!< CMSDK_DUALTIMER2 CTRL_EN: CTRL \
                                             Enable Mask */
...
#define CMSDK_DUALTIMER2_CTRL_INTEN_Msk                                        \
  (0x1ul << CMSDK_DUALTIMER2_CTRL_INTEN_Pos) /*!< CMSDK_DUALTIMER2 CTRL_INTEN: \
                                                CTRL Int Enable Mask */
...
#define CMSDK_DUALTIMER2_CTRL_PRESCALE_Msk                                     \
  (0x3ul                                                                       \
   << CMSDK_DUALTIMER2_CTRL_PRESCALE_Pos) /*!< CMSDK_DUALTIMER2 CTRL_PRESCALE: \
                                             CTRL PRESCALE Mask */
...
#define CMSDK_DUALTIMER2_CTRL_ONESHOOT_Msk                                     \
  (0x1ul                                                                       \
   << CMSDK_DUALTIMER2_CTRL_ONESHOOT_Pos) /*!< CMSDK_DUALTIMER2 CTRL_ONESHOOT: \
                                             CTRL ONESHOOT Mask */
...
#define CMSDK_DUALTIMER2_RAWINTSTAT_Msk                                        \
  (0x1ul << CMSDK_DUALTIMER2_RAWINTSTAT_Pos) /*!< CMSDK_DUALTIMER2 RAWINTSTAT: \
                                                Raw Int Status Mask */
...
#define CMSDK_DUALTIMER2_MASKINTSTAT_Msk                                   \
  (0x1ul                                                                   \
   << CMSDK_DUALTIMER2_MASKINTSTAT_Pos) /*!< CMSDK_DUALTIMER2 MASKINTSTAT: \
                                           Mask Int Status Mask */

#define CMSDK_DUALTIMER2_BGLOAD_Pos \
  0 /*!< CMSDK_DUALTIMER2 BGLOAD: Background Load Position */
#define CMSDK_DUALTIMER2_BGLOAD_Msk                                           \
  (0xFFFFFFFFul << CMSDK_DUALTIMER2_BGLOAD_Pos) /*!< CMSDK_DUALTIMER2 BGLOAD: \
                                                   Background Load Mask */
...
#define CMSDK_DUALTIMER_CTRL_PRESCALE_Msk                                    \
  (0x3ul                                                                     \
   << CMSDK_DUALTIMER_CTRL_PRESCALE_Pos) /*!< CMSDK_DUALTIMER CTRL_PRESCALE: \
                                            CTRL PRESCALE Mask */
...
#define CMSDK_DUALTIMER_CTRL_ONESHOOT_Msk                                    \
  (0x1ul                                                                     \
   << CMSDK_DUALTIMER_CTRL_ONESHOOT_Pos) /*!< CMSDK_DUALTIMER CTRL_ONESHOOT: \
                                            CTRL ONESHOOT Mask */

#define CMSDK_DUALTIMER_INTCLR_Pos \
  0 /*!< CMSDK_DUALTIMER INTCLR: INT Clear Position */
#define CMSDK_DUALTIMER_INTCLR_Msk                                             \
  (0x1ul << CMSDK_DUALTIMER_INTCLR_Pos) /*!< CMSDK_DUALTIMER INTCLR: INT Clear \
                                           Mask */
...
#define CMSDK_DUALTIMER_MASKINTSTAT_Msk                                        \
  (0x1ul << CMSDK_DUALTIMER_MASKINTSTAT_Pos) /*!< CMSDK_DUALTIMER MASKINTSTAT: \
                                                Mask Int Status Mask */
...
typedef struct {
  ...
  __IO uint32_t
      OUTENABLESET; /*!< Offset: 0x010 Output Enable Set Register  (R/W) */
  __IO uint32_t
      OUTENABLECLR; /*!< Offset: 0x014 Output Enable Clear Register  (R/W) */
  __IO uint32_t
      ALTFUNCSET; /*!< Offset: 0x018 Alternate Function Set Register  (R/W) */
  __IO uint32_t
      ALTFUNCCLR; /*!< Offset: 0x01C Alternate Function Clear Register  (R/W) */
  __IO uint32_t
      INTENSET; /*!< Offset: 0x020 Interrupt Enable Set Register  (R/W) */
  __IO uint32_t
      INTENCLR; /*!< Offset: 0x024 Interrupt Enable Clear Register  (R/W) */
  __IO uint32_t
      INTTYPESET; /*!< Offset: 0x028 Interrupt Type Set Register  (R/W) */
  __IO uint32_t
      INTTYPECLR; /*!< Offset: 0x02C Interrupt Type Clear Register  (R/W) */
  __IO uint32_t
      INTPOLSET; /*!< Offset: 0x030 Interrupt Polarity Set Register  (R/W) */
  __IO uint32_t
      INTPOLCLR; /*!< Offset: 0x034 Interrupt Polarity Clear Register  (R/W) */
  union {
    __I uint32_t
        INTSTATUS;         /*!< Offset: 0x038 Interrupt Status Register (R/ ) */
...
#define CMSDK_GPIO_INTCLEAR_Msk                                               \
  (0xFFul << CMSDK_GPIO_INTCLEAR_Pos) /*!< CMSDK_GPIO INTCLEAR: INTCLEAR Mask \
                                       */
...
#define CMSDK_SYSCON_LOCKUPRST_RESETOP_Msk                                   \
  (0x01ul                                                                    \
   << CMSDK_SYSCON_LOCKUPRST_RESETOP_Pos) /*!< CMSDK_SYSCON SYS_CTRL: LOCKUP \
                                             RESET ENABLE Mask */
...
typedef struct {
  ...
  __IO uint32_t CTRL_BASE_PTR;    /*!< Offset: 0x008 Channel Control Data Base
                                     Pointer Register  (R/W) */
  __I uint32_t ALT_CTRL_BASE_PTR; /*!< Offset: 0x00C Channel Alternate Control
                                     Data Base Pointer Register  (R/ ) */
  __I uint32_t DMA_WAITONREQ_STATUS; /*!< Offset: 0x010 Channel Wait On Request
                                        Status Register  (R/ ) */
  __O uint32_t CHNL_SW_REQUEST;      /*!< Offset: 0x014 Channel Software Request
                                        Register  ( /W) */
  __IO uint32_t CHNL_USEBURST_SET;   /*!< Offset: 0x018 Channel UseBurst Set
                                        Register  (R/W) */
  __O uint32_t CHNL_USEBURST_CLR;    /*!< Offset: 0x01C Channel UseBurst Clear
                                        Register  ( /W) */
  __IO uint32_t CHNL_REQ_MASK_SET;   /*!< Offset: 0x020 Channel Request Mask Set
                                        Register  (R/W) */
  __O uint32_t CHNL_REQ_MASK_CLR; /*!< Offset: 0x024 Channel Request Mask Clear
                                     Register  ( /W) */
  __IO uint32_t
      CHNL_ENABLE_SET; /*!< Offset: 0x028 Channel Enable Set Register  (R/W) */
  __O uint32_t CHNL_ENABLE_CLR; /*!< Offset: 0x02C Channel Enable Clear Register
                                   ( /W) */
  __IO uint32_t CHNL_PRI_ALT_SET;  /*!< Offset: 0x030 Channel Primary-Alterante
                                      Set Register  (R/W) */
  __O uint32_t CHNL_PRI_ALT_CLR;   /*!< Offset: 0x034 Channel Primary-Alterante
                                      Clear Register  ( /W) */
  __IO uint32_t CHNL_PRIORITY_SET; /*!< Offset: 0x038 Channel Priority Set
                                      Register  (R/W) */
  __O uint32_t CHNL_PRIORITY_CLR;  /*!< Offset: 0x03C Channel Priority Clear
                                      Register  ( /W) */
...
#define CMSDK_PL230_DMA_STATUS_MSTREN_Msk                                    \
  (0x00000001ul                                                              \
   << CMSDK_PL230_DMA_STATUS_MSTREN_Pos) /*!< CMSDK_PL230 DMA STATUS: MSTREN \
                                            Mask */
...
#define CMSDK_PL230_DMA_STATUS_CHNLS_MINUS1_Msk                             \
  (0x0000001Ful                                                             \
   << CMSDK_PL230_DMA_STATUS_CHNLS_MINUS1_Pos) /*!< CMSDK_PL230 DMA STATUS: \
                                                  CHNLS_MINUS1 Mask */
...
#define CMSDK_PL230_DMA_STATUS_TEST_STATUS_Msk                             \
  (0x00000001ul                                                            \
   << CMSDK_PL230_DMA_STATUS_TEST_STATUS_Pos) /*!< CMSDK_PL230 DMA STATUS: \
                                                 TEST_STATUS Mask */
...
#define CMSDK_PL230_DMA_CFG_CPCCACHE_Msk                                       \
  (0x00000001ul << CMSDK_PL230_DMA_CFG_CPCCACHE_Pos) /*!< CMSDK_PL230 DMA CFG: \
                                                        CPCCACHE Mask */
...
#define CMSDK_PL230_DMA_CFG_CPCPRIV_Msk                                       \
  (0x00000001ul << CMSDK_PL230_DMA_CFG_CPCPRIV_Pos) /*!< CMSDK_PL230 DMA CFG: \
                                                       CPCPRIV Mask */
...
#define CMSDK_PL230_ALT_CTRL_BASE_PTR_Msk                                      \
  (0xFFFFFFFFul << CMSDK_PL230_ALT_CTRL_BASE_PTR_Pos) /*!< CMSDK_PL230 STATUS: \
                                                         MSTREN Mask */
...
#define CMSDK_PL230_CHNL_SW_REQUEST_Msk                                  \
  (0xFFFFFFFFul                                                          \
   << CMSDK_PL230_CHNL_SW_REQUEST_Pos) /*!< CMSDK_PL230 CHNL_SW_REQUEST: \
                                          CHNL_SW_REQUEST Mask */

#define CMSDK_PL230_CHNL_USEBURST_SET_Pos \
  0 /*!< CMSDK_PL230 CHNL_USEBURST: SET Position */
#define CMSDK_PL230_CHNL_USEBURST_SET_Msk                                    \
  (0xFFFFFFFFul                                                              \
   << CMSDK_PL230_CHNL_USEBURST_SET_Pos) /*!< CMSDK_PL230 CHNL_USEBURST: SET \
                                            Mask */
...
#define CMSDK_PL230_CHNL_USEBURST_CLR_Msk                                    \
  (0xFFFFFFFFul                                                              \
   << CMSDK_PL230_CHNL_USEBURST_CLR_Pos) /*!< CMSDK_PL230 CHNL_USEBURST: CLR \
                                            Mask */
...
#define CMSDK_PL230_CHNL_REQ_MASK_SET_Msk                                    \
  (0xFFFFFFFFul                                                              \
   << CMSDK_PL230_CHNL_REQ_MASK_SET_Pos) /*!< CMSDK_PL230 CHNL_REQ_MASK: SET \
                                            Mask */
...
#define CMSDK_PL230_CHNL_REQ_MASK_CLR_Msk                                    \
  (0xFFFFFFFFul                                                              \
   << CMSDK_PL230_CHNL_REQ_MASK_CLR_Pos) /*!< CMSDK_PL230 CHNL_REQ_MASK: CLR \
                                            Mask */
...
#define CMSDK_PL230_CHNL_PRI_ALT_SET_Msk                                   \
  (0xFFFFFFFFul                                                            \
   << CMSDK_PL230_CHNL_PRI_ALT_SET_Pos) /*!< CMSDK_PL230 CHNL_PRI_ALT: SET \
                                           Mask */
...
#define CMSDK_PL230_CHNL_PRI_ALT_CLR_Msk                                   \
  (0xFFFFFFFFul                                                            \
   << CMSDK_PL230_CHNL_PRI_ALT_CLR_Pos) /*!< CMSDK_PL230 CHNL_PRI_ALT: CLR \
                                           Mask */
...
#define CMSDK_PL230_CHNL_PRIORITY_SET_Msk                                    \
  (0xFFFFFFFFul                                                              \
   << CMSDK_PL230_CHNL_PRIORITY_SET_Pos) /*!< CMSDK_PL230 CHNL_PRIORITY: SET \
                                            Mask */
...
#define CMSDK_PL230_CHNL_PRIORITY_CLR_Msk                                    \
  (0xFFFFFFFFul                                                              \
   << CMSDK_PL230_CHNL_PRIORITY_CLR_Pos) /*!< CMSDK_PL230 CHNL_PRIORITY: CLR \
                                            Mask */
...
typedef struct {
  ...
  __IO uint32_t
      UARTCR;  // <h> Control
               ...
               // </h>
  __IO uint32_t
      UARTIFLS;  // <h> Interrupt FIFO Level Select
  ...
  __IO uint32_t UARTIMSC;  // <h> Interrupt Mask Set / Clear
                           ...
                           // </h>
  __IO uint32_t
      UARTRIS;  // <h> Raw Interrupt Status <r>
                ...
                // </h>
  __IO uint32_t
      UARTMIS;  // <h> Masked Interrupt Status <r>
                ...
                //   <o.3>    DSRMMIS: nUARTDSR modem masked interrupt status
                //   <r> <o.2>    DCDMMIS: nUARTDCD modem masked interrupt
                //   status <r> <o.1>    CTSMMIS: nUARTCTS modem masked
                //   interrupt status <r> <o.0>    RIMMIS: nUARTRI modem masked
                //   interrupt status <r>
                // </h>
  __O uint32_t
      UARTICR;  // <h> Interrupt Clear <w>
...
#define CMSDK_PL110_DATAOVRRUN_Msk                                        \
  (0x1ul << CMSDK_PL110_DATAOVRRUN_Pos) /*!< CMSDK_PL110 DATAOVRRUN: Data \
                                           Overrun Mask */
...
#define CMSDK_PL110_DATABREAKERR_Msk                                          \
  (0x1ul << CMSDK_PL110_DATABREAKERR_Pos) /*!< CMSDK_PL110 DATABREAKERR: Data \
                                             Break Error Mask */
...
#define CMSDK_PL110_DATAPARITYERR_Msk                                      \
  (0x1ul << CMSDK_PL110_DATAPARITYERR_Pos) /*!< CMSDK_PL110 DATAPARITYERR: \
                                              Data Parity Error Mask */
...
#define CMSDK_PL110_DATAFRAMEERR_Msk                                          \
  (0x1ul << CMSDK_PL110_DATAFRAMEERR_Pos) /*!< CMSDK_PL110 DATAFRAMEERR: Data \
                                             Frame Error Mask */

#define CMSDK_PL110_RECOVRRUN_Pos \
  3 /*!< CMSDK_PL110 RECOVRRUN: Receive Overrun Position */
#define CMSDK_PL110_RECOVRRUN_Msk                                          \
  (0x1ul << CMSDK_PL110_RECOVRRUN_Pos) /*!< CMSDK_PL110 RECOVRRUN: Receive \
                                          Overrun Mask */
...
#define CMSDK_PL110_RECBREAKERR_Msk                                            \
  (0x1ul << CMSDK_PL110_RECBREAKERR_Pos) /*!< CMSDK_PL110 RECBREAKERR: Receive \
                                            Break Error Mask */
...
#define CMSDK_PL110_RECPARITYERR_Msk                                     \
  (0x1ul << CMSDK_PL110_RECPARITYERR_Pos) /*!< CMSDK_PL110 RECPARITYERR: \
                                             Receive Parity Error Mask */
...
#define CMSDK_PL110_RECFRAMEERR_Msk                                            \
  (0x1ul << CMSDK_PL110_RECFRAMEERR_Pos) /*!< CMSDK_PL110 RECFRAMEERR: Receive \
                                            Frame Error Mask */

#define CMSDK_PL110_ERRCLROVRRUN_Pos \
  3 /*!< CMSDK_PL110 ERRCLROVRRUN: Clear Overrun Position */
#define CMSDK_PL110_ERRCLROVRRUN_Msk                                           \
  (0x1ul << CMSDK_PL110_ERRCLROVRRUN_Pos) /*!< CMSDK_PL110 ERRCLROVRRUN: Clear \
                                             Overrun Mask */
...
#define CMSDK_PL110_ERRCLRBREAKERR_Msk                                       \
  (0x1ul << CMSDK_PL110_ERRCLRBREAKERR_Pos) /*!< CMSDK_PL110 ERRCLRBREAKERR: \
                                               Clear Break Error Mask */
...
#define CMSDK_PL110_ERRCLRPARITYERR_Msk                                        \
  (0x1ul << CMSDK_PL110_ERRCLRPARITYERR_Pos) /*!< CMSDK_PL110 ERRCLRPARITYERR: \
                                                Clear Parity Error Mask */
...
#define CMSDK_PL110_ERRCLRFRAMEERR_Msk                                       \
  (0x1ul << CMSDK_PL110_ERRCLRFRAMEERR_Pos) /*!< CMSDK_PL110 ERRCLRFRAMEERR: \
                                               Clear Frame Error Mask */

#define CMSDK_PL110_FLAG_RINGIND_Pos \
  8 /*!< CMSDK_PL110 FLAG_RINGIND: Ring Indicator Position */
#define CMSDK_PL110_FLAG_RINGIND_Msk                                          \
  (0x1ul << CMSDK_PL110_FLAG_RINGIND_Pos) /*!< CMSDK_PL110 FLAG_RINGIND: Ring \
                                             Indicator Mask */
...
#define CMSDK_PL110_FLAG_TXFEMPTY_Msk                                      \
  (0x1ul << CMSDK_PL110_FLAG_TXFEMPTY_Pos) /*!< CMSDK_PL110 FLAG_TXFEMPTY: \
...
#define CMSDK_PL110_FLAG_RXFFULL_Msk                                     \
  (0x1ul << CMSDK_PL110_FLAG_RXFFULL_Pos) /*!< CMSDK_PL110 FLAG_RXFFULL: \
...
#define CMSDK_PL110_FLAG_TXFFULL_Msk                                     \
  (0x1ul << CMSDK_PL110_FLAG_TXFFULL_Pos) /*!< CMSDK_PL110 FLAG_TXFFULL: \
...
#define CMSDK_PL110_FLAG_RXFEMPTY_Msk                                      \
  (0x1ul << CMSDK_PL110_FLAG_RXFEMPTY_Pos) /*!< CMSDK_PL110 FLAG_RXFEMPTY: \
                                              Receive FIFO Empty Mask */

#define CMSDK_PL110_FLAG_UARTBUSY_Pos \
  3 /*!< CMSDK_PL110 FLAG_UARTBUSY: UART Busy Position */
#define CMSDK_PL110_FLAG_UARTBUSY_Msk                                      \
  (0x1ul << CMSDK_PL110_FLAG_UARTBUSY_Pos) /*!< CMSDK_PL110 FLAG_UARTBUSY: \
                                              UART Busy Mask */
...
#define CMSDK_PL110_FLAG_CARRIERDETECT_Msk                                     \
  (0x1ul                                                                       \
   << CMSDK_PL110_FLAG_CARRIERDETECT_Pos) /*!< CMSDK_PL110 FLAG_CARRIERDETECT: \
                                             Carrier Detect Mask */
...
#define CMSDK_PL110_FLAG_DATASETREADY_Msk                                    \
  (0x1ul                                                                     \
   << CMSDK_PL110_FLAG_DATASETREADY_Pos) /*!< CMSDK_PL110 FLAG_DATASETREADY: \
                                            Data Set Ready Mask */
...
#define CMSDK_PL110_FLAG_CLR2SEND_Msk                                      \
  (0x1ul << CMSDK_PL110_FLAG_CLR2SEND_Pos) /*!< CMSDK_PL110 FLAG_CLR2SEND: \
                                              Clear To Send Mask */

#define CMSDK_PL110_IRDALOWPOWERCOUNT_Pos                                  \
  0 /*!< CMSDK_PL110 IRDALOWPOWERCOUNT: IrDA 8-bit low-power divisor value \
       Position */
#define CMSDK_PL110_IRDALOWPOWERCOUNT_Msk                                      \
  (0xFFul                                                                      \
   << CMSDK_PL110_IRDALOWPOWERCOUNT_Pos) /*!< CMSDK_PL110 IRDALOWPOWERCOUNT:   \
                                            IrDA 8-bit low-power divisor value \
                                            Mask */

#define CMSDK_PL110_INTDIVIDER_Pos \
  0 /*!< CMSDK_PL110 INTDIVIDER: Integer Divider Position */
#define CMSDK_PL110_INTDIVIDER_Msk                                      \
  (0xFFFFul << CMSDK_PL110_INTDIVIDER_Pos) /*!< CMSDK_PL110 INTDIVIDER: \
                                              Integer Divider Mask */
...
#define CMSDK_PL110_FRACTDIVIDER_Msk                                      \
  (0x3Ful << CMSDK_PL110_FRACTDIVIDER_Pos) /*!< CMSDK_PL110 FRACTDIVIDER: \
                                              Fractional Divider Mask */
...
#define CMSDK_PL110_STICKPARITYSEL_Msk                                       \
  (0x1ul << CMSDK_PL110_STICKPARITYSEL_Pos) /*!< CMSDK_PL110 STICKPARITYSEL: \
                                               Stick parity select Mask */

#define CMSDK_PL110_WORDLEN_Pos \
  5 /*!< CMSDK_PL110 WORDLEN: Word Length Select Position */
#define CMSDK_PL110_WORDLEN_Msk                                            \
  (0x3ul << CMSDK_PL110_WORDLEN_Pos) /*!< CMSDK_PL110 WORDLEN: Word Length \
                                        Select Mask */
...
#define CMSDK_PL110_CTS_FLOWCTRL_Msk                                     \
  (0x1ul << CMSDK_PL110_CTS_FLOWCTRL_Pos) /*!< CMSDK_PL110 CTS_FLOWCTRL: \
                                             Enable CTS Flow Control Mask */
...
#define CMSDK_PL110_RTS_FLOWCTRL_Msk                                     \
  (0x1ul << CMSDK_PL110_RTS_FLOWCTRL_Pos) /*!< CMSDK_PL110 RTS_FLOWCTRL: \
                                             Enable RTS Flow Control Mask */
...
#define CMSDK_PL110_OUT2_Msk                                                \
  (0x1ul << CMSDK_PL110_OUT2_Pos) /*!< CMSDK_PL110 OUT2: Complement of Out2 \
                                     modem status output Mask */
...
#define CMSDK_PL110_OUT1_Msk                                                \
  (0x1ul << CMSDK_PL110_OUT1_Pos) /*!< CMSDK_PL110 OUT1: Complement of Out1 \
                                     modem status output Mask */

#define CMSDK_PL110_REQ2SEND_Pos \
  11 /*!< CMSDK_PL110 REQ2SEND: Request To Send Position */
#define CMSDK_PL110_REQ2SEND_Msk                                            \
  (0x1ul << CMSDK_PL110_REQ2SEND_Pos) /*!< CMSDK_PL110 REQ2SEND: Request To \
                                         Send Mask */
...
#define CMSDK_PL110_UARTEN_Msk                                                \
  (0x1ul << CMSDK_PL110_UARTEN_Pos) /*!< CMSDK_PL110 UARTEN: UART Enable Mask \
                                     */
...
#define CMSDK_PL110_RECINTFIFOLEVEL_Msk                                      \
  (0x7ul                                                                     \
   << CMSDK_PL110_RECINTFIFOLEVEL_Pos) /*!< CMSDK_PL110 RECINTFIFOLEVEL: Set \
                                          Receive Int FIFO Level Mask */
...
#define CMSDK_PL110_TRANSINTFIFOLEVEL_Msk                                    \
  (0x7ul                                                                     \
   << CMSDK_PL110_TRANSINTFIFOLEVEL_Pos) /*!< CMSDK_PL110 TRANSINTFIFOLEVEL: \
                                            Set Transmit Int FIFO Level Mask \
                                          */

#define CMSDK_PL110_SETMASK_OVRRUNERRINT_Pos                           \
  10 /*!< CMSDK_PL110 SETMASK_OVRRUNERRINT: Set Overrun Error Int Mask \
        Position */
#define CMSDK_PL110_SETMASK_OVRRUNERRINT_Msk                             \
  (0x1ul                                                                 \
   << CMSDK_PL110_SETMASK_OVRRUNERRINT_Pos) /*!< CMSDK_PL110             \
                                               SETMASK_OVRRUNERRINT: Set \
                                               Overrun Error Int Mask Mask */
...
#define CMSDK_PL110_SETMASK_BREAKERRINT_Msk                                  \
  (0x1ul                                                                     \
   << CMSDK_PL110_SETMASK_BREAKERRINT_Pos) /*!< CMSDK_PL110                  \
                                              SETMASK_BREAKERRINT: Set Break \
                                              Error Int Mask Mask */
...
#define CMSDK_PL110_SETMASK_PARITYERRINT_Msk                             \
  (0x1ul                                                                 \
   << CMSDK_PL110_SETMASK_PARITYERRINT_Pos) /*!< CMSDK_PL110             \
                                               SETMASK_PARITYERRINT: Set \
                                               Parity Error Int Mask Mask */
...
#define CMSDK_PL110_SETMASK_FRAMEERRINT_Msk                                  \
  (0x1ul                                                                     \
   << CMSDK_PL110_SETMASK_FRAMEERRINT_Pos) /*!< CMSDK_PL110                  \
                                              SETMASK_FRAMEERRINT: Set Frame \
                                              Error Int Mask Mask */

#define CMSDK_PL110_SETMASK_RECTRANSINT_Pos                                  \
  6 /*!< CMSDK_PL110 SETMASK_RECTRANSINT: Set Transmit Receive Comb Int Mask \
       Position */
#define CMSDK_PL110_SETMASK_RECTRANSINT_Msk                                   \
  (0x1ul << CMSDK_PL110_SETMASK_RECTRANSINT_Pos) /*!< CMSDK_PL110             \
                                                    SETMASK_RECTRANSINT: Set  \
                                                    Transmit Receive Comb Int \
                                                    Mask Mask */
...
#define CMSDK_PL110_SETMASK_TRANSINT_Msk                                       \
  (0x1ul                                                                       \
   << CMSDK_PL110_SETMASK_TRANSINT_Pos) /*!< CMSDK_PL110 SETMASK_TRANSINT: Set \
                                           Transmit Int Mask Mask */
...
#define CMSDK_PL110_SETMASK_RECINT_Msk                                       \
  (0x1ul << CMSDK_PL110_SETMASK_RECINT_Pos) /*!< CMSDK_PL110 SETMASK_RECINT: \
                                               Set Receive Int Mask Mask */

#define CMSDK_PL110_SETMASK_UART_DSRMODINT_Pos                                 \
  3 /*!< CMSDK_PL110 SETMASK_UART_DSRMODINT: Set Data Set Ready Modem Int Mask \
       Position */
#define CMSDK_PL110_SETMASK_UART_DSRMODINT_Msk                                 \
  (0x1ul << CMSDK_PL110_SETMASK_UARTD_SRMODINT_Pos) /*!< CMSDK_PL110           \
                                                       SETMASK_UART_DSRMODINT: \
                                                       Set Data Set Ready      \
                                                       Modem Int Mask Mask */

#define CMSDK_PL110_SETMASK_UART_DCDMODINT_Pos                                 \
  2 /*!< CMSDK_PL110 SETMASK_UART_DCDMODINT: Set Data Carrier Detect Modem Int \
       Mask Position */
#define CMSDK_PL110_SETMASK_UART_DCDMODINT_Msk                                 \
  (0x1ul << CMSDK_PL110_SETMASK_UART_DCDMODINT_Pos) /*!< CMSDK_PL110           \
                                                       SETMASK_UART_DCDMODINT: \
                                                       Set Data Carrier Detect \
                                                       Modem Int Mask Mask */

#define CMSDK_PL110_SETMASK_UART_CTSMODINT_Pos                                \
  1 /*!< CMSDK_PL110 SETMASK_UART_CTSMODINT: Set Clear To Send Modem Int Mask \
       Position */
#define CMSDK_PL110_SETMASK_UART_CTSMODINT_Msk                                 \
  (0x1ul << CMSDK_PL110_SETMASK_UART_CTSMODINT_Pos) /*!< CMSDK_PL110           \
                                                       SETMASK_UART_CTSMODINT: \
                                                       Set Clear To Send Modem \
                                                       Int Mask Mask */

#define CMSDK_PL110_SETMASK_UART_RIMODINT_Pos                          \
  0 /*!< CMSDK_PL110 SETMASK_UART_RIMODINT: Set nUARTRI Modem Int Mask \
       Position */
#define CMSDK_PL110_SETMASK_UART_RIMODINT_Msk                              \
  (0x1ul                                                                   \
   << CMSDK_PL110_SETMASK_UART_RIMODINT_Pos) /*!< CMSDK_PL110              \
                                                SETMASK_UART_RIMODINT: Set \
                                                nUARTRI Modem Int Mask Mask */

#define CMSDK_PL110_RAWINTSTAT_OVRRUNERRINT_Pos                             \
  10 /*!< CMSDK_PL110 RAWINTSTAT_OVRRUNERRINT: Raw Overrun Error Int Status \
        Mask Position */
#define CMSDK_PL110_RAWINTSTAT_OVRRUNERRINT_Msk                                  \
  (0x1ul << CMSDK_PL110_RAWINTSTAT_OVRRUNERRINT_Pos) /*!< CMSDK_PL110            \
                                                        RAWINTSTAT_OVRRUNERRINT: \
                                                        Raw Overrun Error Int    \
                                                        Status  Mask */

#define CMSDK_PL110_RAWINTSTAT_BREAKERRINT_Pos                               \
  9 /*!< CMSDK_PL110 RAWINTSTAT_BREAKERRINT: Raw Break Error Int Status Mask \
       Position */
#define CMSDK_PL110_RAWINTSTAT_BREAKERRINT_Msk                                 \
  (0x1ul << CMSDK_PL110_RAWINTSTAT_BREAKERRINT_Pos) /*!< CMSDK_PL110           \
                                                       RAWINTSTAT_BREAKERRINT: \
                                                       Raw Break Error Int     \
                                                       Status  Mask */

#define CMSDK_PL110_RAWINTSTAT_PARITYERRINT_Pos                                \
  8 /*!< CMSDK_PL110 RAWINTSTAT_PARITYERRINT: Raw Parity Error Int Status Mask \
       Position */
#define CMSDK_PL110_RAWINTSTAT_PARITYERRINT_Msk                                  \
  (0x1ul << CMSDK_PL110_RAWINTSTAT_PARITYERRINT_Pos) /*!< CMSDK_PL110            \
                                                        RAWINTSTAT_PARITYERRINT: \
                                                        Raw Parity Error Int     \
                                                        Status  Mask */

#define CMSDK_PL110_RAWINTSTAT_FRAMEERRINT_Pos                               \
  7 /*!< CMSDK_PL110 RAWINTSTAT_FRAMEERRINT: Raw Frame Error Int Status Mask \
       Position */
#define CMSDK_PL110_RAWINTSTAT_FRAMEERRINT_Msk                                 \
  (0x1ul << CMSDK_PL110_RAWINTSTAT_FRAMEERRINT_Pos) /*!< CMSDK_PL110           \
                                                       RAWINTSTAT_FRAMEERRINT: \
                                                       Raw Frame Error Int     \
                                                       Status Mask */

#define CMSDK_PL110_RAWINTSTAT_RECTRANSINT_Pos                             \
  6 /*!< CMSDK_PL110 RAWINTSTAT_RECTRANSINT: Raw Transmit Receive Comb Int \
       Status Position */
#define CMSDK_PL110_RAWINTSTAT_RECTRANSINT_Msk                                 \
  (0x1ul << CMSDK_PL110_RAWINTSTAT_RECTRANSINT_Pos) /*!< CMSDK_PL110           \
                                                       RAWINTSTAT_RECTRANSINT: \
                                                       Raw Transmit Receive    \
                                                       Comb Int Status Mask */
...
#define CMSDK_PL110_RAWINTSTAT_TRANSINT_Msk                            \
  (0x1ul                                                               \
   << CMSDK_PL110_RAWINTSTAT_TRANSINT_Pos) /*!< CMSDK_PL110            \
                                              RAWINTSTAT_TRANSINT: Raw \
                                              Transmit Int Status Mask */
...
#define CMSDK_PL110_RAWINTSTAT_RECINT_Msk                                    \
  (0x1ul                                                                     \
   << CMSDK_PL110_RAWINTSTAT_RECINT_Pos) /*!< CMSDK_PL110 RAWINTSTAT_RECINT: \
                                            Raw Receive Int Status Mask */

#define CMSDK_PL110_RAWINTSTAT_UART_DSRMODINT_Pos                             \
  3 /*!< CMSDK_PL110 RAWINTSTAT_UART_DSRMODINT: Raw Data Set Ready Int Status \
       Position */
#define CMSDK_PL110_RAWINTSTAT_UART_DSRMODINT_Msk                                    \
  (0x1ul << CMSDK_PL110_RAWINTSTAT_UARTD_SRMODINT_Pos) /*!< CMSDK_PL110              \
                                                          RAWINTSTAT_UARTD_SRMODINT: \
                                                          Raw Data Set Ready         \
                                                          Int Status Mask */

#define CMSDK_PL110_RAWINTSTAT_UART_DCDMODINT_Pos                           \
  2 /*!< CMSDK_PL110 RAWINTSTAT_UART_DCDMODINT: Raw Data Carrier Detect Int \
       Status Position */
#define CMSDK_PL110_RAWINTSTAT_UART_DCDMODINT_Msk                              \
  (0x1ul                                                                       \
   << CMSDK_PL110_RAWINTSTAT_UART_DCDMODINT_Pos) /*!< CMSDK_PL110              \
                                                    RAWINTSTAT_UART_DCDMODINT: \
                                                    Raw Data Carrier Detect    \
                                                    Int Status Mask */

#define CMSDK_PL110_RAWINTSTAT_UART_CTSMODINT_Pos                            \
  1 /*!< CMSDK_PL110 RAWINTSTAT_UART_CTSMODINT: Raw Clear To Send Int Status \
       Position */
#define CMSDK_PL110_RAWINTSTAT_UART_CTSMODINT_Msk                                    \
  (0x1ul << CMSDK_PL110_RAWINTSTAT_UART_CTSMODINT_Pos) /*!< CMSDK_PL110              \
                                                          RAWINTSTAT_UART_CTSMODINT: \
                                                          Raw Clear To Send          \
                                                          Int Status Mask */

#define CMSDK_PL110_RAWINTSTAT_UART_RIMODINT_Pos                            \
  0 /*!< CMSDK_PL110 RAWINTSTAT_UART_RIMODINT: Raw nUARTRI Modem Int Status \
       Position */
#define CMSDK_PL110_RAWINTSTAT_UART_RIMODINT_Msk                                   \
  (0x1ul << CMSDK_PL110_RAWINTSTAT_UART_RIMODINT_Pos) /*!< CMSDK_PL110             \
                                                         RAWINTSTAT_UART_RIMODINT: \
                                                         Raw nUARTRI Modem Int     \
                                                         Status Mask */

#define CMSDK_PL110_MSKINTSTAT_OVRRUNERRINT_Pos                                \
  10 /*!< CMSDK_PL110 MSKINTSTAT_OVRRUNERRINT: Masked Overrun Error Int Status \
        Position */
#define CMSDK_PL110_MSKINTSTAT_OVRRUNERRINT_Msk                                  \
  (0x1ul << CMSDK_PL110_MSKINTSTAT_OVRRUNERRINT_Pos) /*!< CMSDK_PL110            \
                                                        MSKINTSTAT_OVRRUNERRINT: \
                                                        Masked Overrun Error     \
                                                        Int Status Mask */

#define CMSDK_PL110_MSKINTSTAT_BREAKERRINT_Pos                             \
  9 /*!< CMSDK_PL110 MSKINTSTAT_BREAKERRINT: Masked Break Error Int Status \
       Position */
#define CMSDK_PL110_MSKINTSTAT_BREAKERRINT_Msk                                 \
  (0x1ul << CMSDK_PL110_MSKINTSTAT_BREAKERRINT_Pos) /*!< CMSDK_PL110           \
                                                       MSKINTSTAT_BREAKERRINT: \
                                                       Masked Break Error Int  \
                                                       Status Mask */

#define CMSDK_PL110_MSKINTSTAT_PARITYERRINT_Pos                              \
  8 /*!< CMSDK_PL110 MSKINTSTAT_PARITYERRINT: Masked Parity Error Int Status \
       Position */
#define CMSDK_PL110_MSKINTSTAT_PARITYERRINT_Msk                                  \
  (0x1ul << CMSDK_PL110_MSKINTSTAT_PARITYERRINT_Pos) /*!< CMSDK_PL110            \
                                                        MSKINTSTAT_PARITYERRINT: \
                                                        Masked Parity Error      \
                                                        Int Status Mask */

#define CMSDK_PL110_MSKINTSTAT_FRAMEERRINT_Pos                             \
  7 /*!< CMSDK_PL110 MSKINTSTAT_FRAMEERRINT: Masked Frame Error Int Status \
       Position */
#define CMSDK_PL110_MSKINTSTAT_FRAMEERRINT_Msk                                 \
  (0x1ul << CMSDK_PL110_MSKINTSTAT_FRAMEERRINT_Pos) /*!< CMSDK_PL110           \
                                                       MSKINTSTAT_FRAMEERRINT: \
                                                       Masked Frame Error Int  \
                                                       Status Mask */

#define CMSDK_PL110_MSKINTSTAT_RECTRANSINT_Pos                                \
  6 /*!< CMSDK_PL110 MSKINTSTAT_RECTRANSINT: Masked Transmit Receive Comb Int \
       Status Position */
#define CMSDK_PL110_MSKINTSTAT_RECTRANSINT_Msk                                 \
  (0x1ul << CMSDK_PL110_MSKINTSTAT_RECTRANSINT_Pos) /*!< CMSDK_PL110           \
                                                       MSKINTSTAT_RECTRANSINT: \
                                                       Masked Transmit Receive \
                                                       Comb Int Status Mask */
...
#define CMSDK_PL110_MSKINTSTAT_TRANSINT_Msk                               \
  (0x1ul                                                                  \
   << CMSDK_PL110_MSKINTSTAT_TRANSINT_Pos) /*!< CMSDK_PL110               \
                                              MSKINTSTAT_TRANSINT: Masked \
                                              Transmit Int Status Mask */
...
#define CMSDK_PL110_MSKINTSTAT_RECINT_Msk                                    \
  (0x1ul                                                                     \
   << CMSDK_PL110_MSKINTSTAT_RECINT_Pos) /*!< CMSDK_PL110 MSKINTSTAT_RECINT: \
                                            Masked Receive Int Status Mask */

#define CMSDK_PL110_MSKINTSTAT_UART_DSRMODINT_Pos                         \
  3 /*!< CMSDK_PL110 MSKINTSTAT_UART_DSRMODINT: Masked Data Set Ready Int \
       Status Position */
#define CMSDK_PL110_MSKINTSTAT_UART_DSRMODINT_Msk                              \
  (0x1ul                                                                       \
   << CMSDK_PL110_MSKINTSTAT_UARTD_SRMODINT_Pos) /*!< CMSDK_PL110              \
                                                    MSKINTSTAT_UART_DSRMODINT: \
                                                    Masked Data Set Ready Int  \
                                                    Status Mask */

#define CMSDK_PL110_MSKINTSTAT_UART_DCDMODINT_Pos                              \
  2 /*!< CMSDK_PL110 MSKINTSTAT_UART_DCDMODINT: Masked Data Carrier Detect Int \
       Status Position */
#define CMSDK_PL110_MSKINTSTAT_UART_DCDMODINT_Msk                              \
  (0x1ul                                                                       \
   << CMSDK_PL110_MSKINTSTAT_UART_DCDMODINT_Pos) /*!< CMSDK_PL110              \
                                                    MSKINTSTAT_UART_DCDMODINT: \
                                                    Masked Data Carrier Detect \
                                                    Int Status Mask */

#define CMSDK_PL110_MSKINTSTAT_UART_CTSMODINT_Pos                        \
  1 /*!< CMSDK_PL110 MSKINTSTAT_UART_CTSMODINT: Masked Clear To Send Int \
       Status Position */
#define CMSDK_PL110_MSKINTSTAT_UART_CTSMODINT_Msk                                    \
  (0x1ul << CMSDK_PL110_MSKINTSTAT_UART_CTSMODINT_Pos) /*!< CMSDK_PL110              \
                                                          MSKINTSTAT_UART_CTSMODINT: \
                                                          Masked Clear To Send       \
                                                          Int Status Mask */

#define CMSDK_PL110_MSKINTSTAT_UART_RIMODINT_Pos                               \
  0 /*!< CMSDK_PL110 MSKINTSTAT_UART_RIMODINT: Masked nUARTRI Modem Int Status \
       Position */
#define CMSDK_PL110_MSKINTSTAT_UART_RIMODINT_Msk                                   \
  (0x1ul << CMSDK_PL110_MSKINTSTAT_UART_RIMODINT_Pos) /*!< CMSDK_PL110             \
                                                         MSKINTSTAT_UART_RIMODINT: \
                                                         Masked nUARTRI Modem      \
                                                         Int Status Mask */
...
#define CMSDK_PL110_INTCLR_OVRRUNERRINT_Msk                                    \
  (0x1ul << CMSDK_PL110_INTCLR_OVRRUNERRINT_Pos) /*!< CMSDK_PL110              \
                                                    INTCLR_OVRRUNERRINT: Clear \
                                                    Overrun Error Int Mask */
...
#define CMSDK_PL110_INTCLR_BREAKERRINT_Msk                                     \
  (0x1ul                                                                       \
   << CMSDK_PL110_INTCLR_BREAKERRINT_Pos) /*!< CMSDK_PL110 INTCLR_BREAKERRINT: \
                                             Clear Break Error Int Mask */
...
#define CMSDK_PL110_INTCLR_PARITYERRINT_Msk                                    \
  (0x1ul << CMSDK_PL110_INTCLR_PARITYERRINT_Pos) /*!< CMSDK_PL110              \
                                                    INTCLR_PARITYERRINT: Clear \
                                                    Parity Error Int Mask */
...
#define CMSDK_PL110_INTCLR_FRAMEERRINT_Msk                                     \
  (0x1ul                                                                       \
   << CMSDK_PL110_INTCLR_FRAMEERRINT_Pos) /*!< CMSDK_PL110 INTCLR_FRAMEERRINT: \
                                             Clear Frame Error Int Mask */

#define CMSDK_PL110_INTCLR_RECTRANSINT_Pos                               \
  6 /*!< CMSDK_PL110 INTCLR_RECTRANSINT: Clear Receive Transmit Comb Int \
       Position */
#define CMSDK_PL110_INTCLR_RECTRANSINT_Msk                                     \
  (0x1ul                                                                       \
   << CMSDK_PL110_INTCLR_RECTRANSINT_Pos) /*!< CMSDK_PL110 INTCLR_RECTRANSINT: \
                                             Clear Receive Transmit Comb Int   \
                                             Mask */
...
#define CMSDK_PL110_INTCLR_TRANSINT_Msk                                        \
  (0x1ul << CMSDK_PL110_INTCLR_TRANSINT_Pos) /*!< CMSDK_PL110 INTCLR_TRANSINT: \
                                                Clear Transmit Int Mask */
...
#define CMSDK_PL110_INTCLR_RECINT_Msk                                      \
  (0x1ul << CMSDK_PL110_INTCLR_RECINT_Pos) /*!< CMSDK_PL110 INTCLR_RECINT: \
                                              Clear Receive Int Mask */

#define CMSDK_PL110_INTCLR_UART_DSRMODINT_Pos                             \
  3 /*!< CMSDK_PL110 INTCLR_UART_DSRMODINT: Clear Data Carrier Detect Int \
       Position */
#define CMSDK_PL110_INTCLR_UART_DSRMODINT_Msk                                \
  (0x1ul << CMSDK_PL110_INTCLR_UARTD_SRMODINT_Pos) /*!< CMSDK_PL110          \
                                                      INTCLR_UARTD_SRMODINT: \
                                                      Clear Data Carrier     \
                                                      Detect Int Mask */
...
#define CMSDK_PL110_INTCLR_UART_DCDMODINT_Msk                                \
  (0x1ul                                                                     \
   << CMSDK_PL110_INTCLR_UART_DCDMODINT_Pos) /*!< CMSDK_PL110                \
                                                INTCLR_UART_DCDMODINT: Clear \
                                                Data Set Ready Int Mask */
...
#define CMSDK_PL110_INTCLR_UART_CTSMODINT_Msk                                \
  (0x1ul                                                                     \
   << CMSDK_PL110_INTCLR_UART_CTSMODINT_Pos) /*!< CMSDK_PL110                \
                                                INTCLR_UART_CTSMODINT: Clear \
                                                Clear To Sent Int Mask */
...
#define CMSDK_PL110_INTCLR_UART_RIMODINT_Msk                               \
  (0x1ul                                                                   \
   << CMSDK_PL110_INTCLR_UART_RIMODINT_Pos) /*!< CMSDK_PL110               \
                                               INTCLR_UART_RIMODINT: Clear \
                                               nUARTRI Modem Int Mask */

#define CMSDK_PL110_DMA_ERR_Pos \
  2 /*!< CMSDK_PL110 DMA_ERR: DMA Error Position */
#define CMSDK_PL110_DMA_ERR_Msk                                               \
  (0x1ul << CMSDK_PL110_DMA_ERR_Pos) /*!< CMSDK_PL110 DMA_ERR: DMA Error Mask \
                                      */
...
#define CMSDK_PL110_DMA_TRANS_EN_Msk                                         \
  (0x1ul << CMSDK_PL110_DMA_TRANS_EN_Pos) /*!< CMSDK_PL110 DMA_TRANS_EN: DMA \
                                             Transmit Error Mask */

#define CMSDK_PL110_DMA_REC_EN_Pos \
  0 /*!< CMSDK_PL110 DMA_REC_EN: DMA Receive Error Position */
#define CMSDK_PL110_DMA_REC_EN_Msk                                       \
  (0x1ul << CMSDK_PL110_DMA_REC_EN_Pos) /*!< CMSDK_PL110 DMA_REC_EN: DMA \
                                           Receive Error Mask */
...
#define CMSDK_Watchdog_CTRL_INTEN_Msk                                          \
  (0x1ul << CMSDK_Watchdog_CTRL_INTEN_Pos) /*!< CMSDK_Watchdog CTRL_INTEN: Int \
                                              Enable Mask */
...
#define CMSDK_Watchdog_RAWINTSTAT_Msk                                          \
  (0x1ul << CMSDK_Watchdog_RAWINTSTAT_Pos) /*!< CMSDK_Watchdog RAWINTSTAT: Raw \
                                              Int Status Mask */
...
#define CMSDK_Watchdog_INTEGTESTOUTSET_Msk                                     \
  (0x1ul                                                                       \
   << CMSDK_Watchdog_INTEGTESTOUTSET_Pos) /*!< CMSDK_Watchdog INTEGTESTOUTSET: \
                                             Integration Test Output Set Mask  \
                                           */
...
#define CMSDK_PL061_INTBOTHEDGE_Msk                                        \
  (0x1ul << CMSDK_PL061_INTBOTHEDGE_Pos) /*!< CMSDK_PL061 INTBOTHEDGE: INT \
                                            BOTH EDGE Mask */
...
#define CMSDK_PL061_MODECTRL_HWEN_Msk                                     \
  (0x1ul                                                                  \
   << CMSDK_PL061_MODECTRL_HWEN_Pos) /*!< CMSDK_PL061 MODECTRL_HWEN: Mode \
                                        Control Hardware Enable Mask */
