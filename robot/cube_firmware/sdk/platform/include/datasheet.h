...
/*
 * --------------------------------------------------------------------------------------------
 * The Cortex-M0 Processor Exceptions Numbers and the SC14580 Specific Interrupt
 * Numbers.     -
 * --------------------------------------------------------------------------------------------
 */
typedef enum IRQn {
  ...
  BLE_FINETGTIM_IRQn =
      1, /* Fine Target Timer interrupt generated when Fine Target timer
            expired. Timer resolution is 625us base time reference. */
  BLE_GROSSTGTIM_IRQn =
      2, /* Gross Target Timer interrupt generated when Gross Target timer
            expired. Timer resolution is 16 times 625us base time reference. */
  BLE_CSCNT_IRQn =
      3, /* 625us base time reference interrupt, available in active modes. */
  BLE_SLP_IRQn = 4,   /* End of Sleep mode interrupt.   */
  BLE_ERROR_IRQn = 5, /* Error interrupt, generated when undesired behavior or
                         bad programming occurs in the RW-BLE Core. */
  BLE_RX_IRQn =
      6, /* Receipt interrupt at the end of each received packets. */
  BLE_EVENT_IRQn =
      7, /* End of Advertising / Scanning / Connection events interrupt. */
  SWTIM_IRQn = 8,        /* Software Timer (Timer0) interrupt.        */
  WKUP_QUADEC_IRQn = 9,  /* Combines the Wake up Capture Timer interrupt, the
                            GPIO interrupt and the QuadDecoder interrupt  */
  BLE_RF_DIAG_IRQn = 10, /* Baseband or Radio Diagnostics Interrupt. Signals
                            Radio or Baseband internal events */
  BLE_CRYPT_IRQn = 11,   /* Encryption / Decryption interrupt, generated either
                            when AES and/or CCM processing is finished.   */
...
/*--------------------------------------------------------------------------------------------*/
/* Configuration of the Cortex-M0 Processor and Core Peripherals (see also
 * CMSDK_CM0.h).      */
/*--------------------------------------------------------------------------------------------*/
/* Note: The next 2 defines are used in "core_cm0.h" for the CMSIS Core SysTick
 * function.     */
#ifndef ARMCM0_H
...
#define CLK_REF_SEL_REG \
  (0x50001600) /* Select clock for oscillator calibration */
#define CLK_REF_CNT_REG \
  (0x50001602) /* Count value for oscillator calibration */
#define CLK_REF_VAL_L_REG \
  (0x50001604) /* XTAL16M reference cycles, lower 16 bits */
#define CLK_REF_VAL_H_REG \
  (0x50001606)                   /* XTAL16M reference cycles, upper 16 bits */
...
#define RF_PA_CTRL_REG \
  (0x50002A00) /* Removed obsolete values of bits 10:7, pa_pw back to 4 */
...
#define BLE_CURRENTRXDESCPTR_REG \
  (0x4000002C) /* Rx Descriptor Pointer for the Receive Buffer Chained List */
#define BLE_DEEPSLCNTL_REG (0x40000030) /* Deep-Sleep control register */
#define BLE_DEEPSLWKUP_REG                                                     \
  (0x40000034) /* Time (measured in Low Power clock cycles) in Deep Sleep Mode \
                  before waking-up the device */
#define BLE_DEEPSLSTAT_REG \
  (0x40000038) /* Duration of the last deep sleep phase register */
#define BLE_ENBPRESET_REG \
  (0x4000003C) /* Time in low power oscillator cycles register */
...
#define BLE_RADIOPWRUPDN_REG \
  (0x40000080)                        /* RX/TX power up/down phase register */
...
#define BLE_WLPUBADDPTR_REG \
  (0x400000B0) /* Start address of public devices list */
#define BLE_WLPRIVADDPTR_REG \
  (0x400000B4)                       /* Start address of private devices list */
...
#define BLE_AESPTR_REG \
  (0x400000D4) /* Pointer to the block to encrypt/decrypt */
...
#define BLE_RF_DIAGIRQ_REG \
  (0x40000204) /* BLE/RF Diagnostic IRQ Control Register */
...
#define ANA_STATUS_REG \
  (0x5000002A) /* status bit of analog (power management) circuits */
...
#define GP_ADC_CTRL2_REG \
  (0x50001502) /* General Purpose ADC Second Control Register */
#define GP_ADC_OFFP_REG \
  (0x50001504) /* General Purpose ADC Positive Offset Register */
#define GP_ADC_OFFN_REG \
  (0x50001506) /* General Purpose ADC Negative Offset Register */
#define GP_ADC_CLEAR_INT_REG \
  (0x50001508) /* General Purpose ADC Clear Interrupt Register */
...
#define GP_ADC_DELAY2_REG \
  (0x5000150E) /* General Purpose ADC Second Delay Register */
...
#define P01_PADPWR_CTRL_REG \
  (0x50003070) /* Ports 0 and 1 Output Power Control Register */
#define P2_PADPWR_CTRL_REG \
  (0x50003072) /* Port 2 Output Power Control Register */
#define P3_PADPWR_CTRL_REG \
  (0x50003074)                       /* Port 3 Output Power Control Register */
...
/* memory map GPREG */
/*===========================================================================*/
#define SET_FREEZE_REG \
  (0x50003300) /* Controls freezing of various timers/counters. */
#define RESET_FREEZE_REG \
  (0x50003302) /* Controls unfreezing of various timers/counters. */
...
#define GP_STATUS_REG (0x50003306) /* General purpose system status register. \
                                    */
#define GP_CONTROL_REG \
  (0x50003308) /* General purpose system control register. */
...
#define I2C_DATA_CMD_REG \
  (0x50001310) /* I2C Rx/Tx Data Buffer and Command Register */
#define I2C_SS_SCL_HCNT_REG \
  (0x50001314) /* Standard Speed I2C Clock SCL High Count Register */
#define I2C_SS_SCL_LCNT_REG \
  (0x50001318) /* Standard Speed I2C Clock SCL Low Count Register */
#define I2C_FS_SCL_HCNT_REG \
  (0x5000131C) /* Fast Speed I2C Clock SCL High Count Register */
#define I2C_FS_SCL_LCNT_REG \
  (0x50001320) /* Fast Speed I2C Clock SCL Low Count Register */
...
#define I2C_RAW_INTR_STAT_REG \
  (0x50001334)                     /* I2C Raw Interrupt Status Register */
...
#define I2C_CLR_INTR_REG \
  (0x50001340) /* Clear Combined and Individual Interrupt Register */
#define I2C_CLR_RX_UNDER_REG \
  (0x50001344)                           /* Clear RX_UNDER Interrupt Register */
...
#define I2C_CLR_RX_DONE_REG (0x50001358) /* Clear RX_DONE Interrupt Register \
                                          */
#define I2C_CLR_ACTIVITY_REG \
  (0x5000135C) /* Clear ACTIVITY Interrupt Register */
#define I2C_CLR_STOP_DET_REG \
  (0x50001360) /* Clear STOP_DET Interrupt Register */
#define I2C_CLR_START_DET_REG \
  (0x50001364) /* Clear START_DET Interrupt Register */
#define I2C_CLR_GEN_CALL_REG \
  (0x50001368)                        /* Clear GEN_CALL Interrupt Register */
...
#define I2C_TX_ABRT_SOURCE_REG \
  (0x50001380)                         /* I2C Transmit Abort Source Register */
#define I2C_SDA_SETUP_REG (0x50001394) /* I2C SDA Setup Register */
#define I2C_ACK_GENERAL_CALL_REG \
  (0x50001398)                             /* I2C ACK General Call Register */
#define I2C_ENABLE_STATUS_REG (0x5000139C) /* I2C Enable Status Register */
#define I2C_IC_FS_SPKLEN_REG \
  (0x500013A0) /* I2C SS and FS spike suppression limit Size */
...
#define GPIO_IRQ0_IN_SEL_REG \
  (0x50001400) /* GPIO interrupt selection for GPIO_IRQ0 */
#define GPIO_IRQ1_IN_SEL_REG \
  (0x50001402) /* GPIO interrupt selection for GPIO_IRQ1 */
#define GPIO_IRQ2_IN_SEL_REG \
  (0x50001404) /* GPIO interrupt selection for GPIO_IRQ2 */
#define GPIO_IRQ3_IN_SEL_REG \
  (0x50001406) /* GPIO interrupt selection for GPIO_IRQ3 */
#define GPIO_IRQ4_IN_SEL_REG \
  (0x50001408) /* GPIO interrupt selection for GPIO_IRQ4 */
#define GPIO_DEBOUNCE_REG \
  (0x5000140C) /* debounce counter value for GPIO inputs */
#define GPIO_RESET_IRQ_REG (0x5000140E) /* GPIO interrupt reset register */
#define GPIO_INT_LEVEL_CTRL_REG \
  (0x50001410) /* high or low level select for GPIO interrupts */
#define KBRD_IRQ_IN_SEL0_REG \
  (0x50001412) /* GPIO interrupt selection for KBRD_IRQ for P0 */
#define KBRD_IRQ_IN_SEL1_REG \
  (0x50001414) /* GPIO interrupt selection for KBRD_IRQ for P1 and P2 */
...
#define OTPC_FFRD_REG                                                     \
  (0x4000801C) /* The data which have taken with the latest read from the \
                  OTPC_FFPRT_REG */
...
#define UART_IIR_FCR_REG \
  (0x50001008) /* Interrupt Identification Register/FIFO Control Register */
...
#define UART_SRBR_STHR0_REG \
  (0x50001030) /* Shadow Receive/Transmit Buffer Register */
#define UART_SRBR_STHR1_REG \
  (0x50001034) /* Shadow Receive/Transmit Buffer Register */
#define UART_SRBR_STHR2_REG \
  (0x50001038) /* Shadow Receive/Transmit Buffer Register */
#define UART_SRBR_STHR3_REG \
  (0x5000103C) /* Shadow Receive/Transmit Buffer Register */
#define UART_SRBR_STHR4_REG \
  (0x50001040) /* Shadow Receive/Transmit Buffer Register */
#define UART_SRBR_STHR5_REG \
  (0x50001044) /* Shadow Receive/Transmit Buffer Register */
#define UART_SRBR_STHR6_REG \
  (0x50001048) /* Shadow Receive/Transmit Buffer Register */
#define UART_SRBR_STHR7_REG \
  (0x5000104C) /* Shadow Receive/Transmit Buffer Register */
#define UART_SRBR_STHR8_REG \
  (0x50001050) /* Shadow Receive/Transmit Buffer Register */
#define UART_SRBR_STHR9_REG \
  (0x50001054) /* Shadow Receive/Transmit Buffer Register */
#define UART_SRBR_STHR10_REG \
  (0x50001058) /* Shadow Receive/Transmit Buffer Register */
#define UART_SRBR_STHR11_REG \
  (0x5000105C) /* Shadow Receive/Transmit Buffer Register */
#define UART_SRBR_STHR12_REG \
  (0x50001060) /* Shadow Receive/Transmit Buffer Register */
#define UART_SRBR_STHR13_REG \
  (0x50001064) /* Shadow Receive/Transmit Buffer Register */
#define UART_SRBR_STHR14_REG \
  (0x50001068) /* Shadow Receive/Transmit Buffer Register */
#define UART_SRBR_STHR15_REG \
  (0x5000106C)                     /* Shadow Receive/Transmit Buffer Register */
...
#define UART2_IIR_FCR_REG \
  (0x50001108) /* Interrupt Identification Register/FIFO Control Register */
...
#define UART2_SRBR_STHR0_REG \
  (0x50001130) /* Shadow Receive/Transmit Buffer Register */
#define UART2_SRBR_STHR1_REG \
  (0x50001134) /* Shadow Receive/Transmit Buffer Register */
#define UART2_SRBR_STHR2_REG \
  (0x50001138) /* Shadow Receive/Transmit Buffer Register */
#define UART2_SRBR_STHR3_REG \
  (0x5000113C) /* Shadow Receive/Transmit Buffer Register */
#define UART2_SRBR_STHR4_REG \
  (0x50001140) /* Shadow Receive/Transmit Buffer Register */
#define UART2_SRBR_STHR5_REG \
  (0x50001144) /* Shadow Receive/Transmit Buffer Register */
#define UART2_SRBR_STHR6_REG \
  (0x50001148) /* Shadow Receive/Transmit Buffer Register */
#define UART2_SRBR_STHR7_REG \
  (0x5000114C) /* Shadow Receive/Transmit Buffer Register */
#define UART2_SRBR_STHR8_REG \
  (0x50001150) /* Shadow Receive/Transmit Buffer Register */
#define UART2_SRBR_STHR9_REG \
  (0x50001154) /* Shadow Receive/Transmit Buffer Register */
#define UART2_SRBR_STHR10_REG \
  (0x50001158) /* Shadow Receive/Transmit Buffer Register */
#define UART2_SRBR_STHR11_REG \
  (0x5000115C) /* Shadow Receive/Transmit Buffer Register */
#define UART2_SRBR_STHR12_REG \
  (0x50001160) /* Shadow Receive/Transmit Buffer Register */
#define UART2_SRBR_STHR13_REG \
  (0x50001164) /* Shadow Receive/Transmit Buffer Register */
#define UART2_SRBR_STHR14_REG \
  (0x50001168) /* Shadow Receive/Transmit Buffer Register */
#define UART2_SRBR_STHR15_REG \
  (0x5000116C)                     /* Shadow Receive/Transmit Buffer Register */
...
#define WKUP_CTRL_REG (0x50000100) /* Control register for the wakeup counter \
                                    */
#define WKUP_COMPARE_REG \
  (0x50000102) /* Number of events before wakeup interrupt */
#define WKUP_RESET_IRQ_REG (0x50000104) /* Reset wakeup interrupt */
#define WKUP_COUNTER_REG \
  (0x50000106) /* Actual number of events of the wakeup counter */
#define WKUP_RESET_CNTR_REG (0x50000108) /* Reset the event counter */
#define WKUP_SELECT_P0_REG \
  (0x5000010A) /* select which inputs from P0 port can trigger wkup counter */
#define WKUP_SELECT_P1_REG \
  (0x5000010C) /* select which inputs from P1 port can trigger wkup counter */
#define WKUP_SELECT_P2_REG \
  (0x5000010E) /* select which inputs from P2 port can trigger wkup counter */
#define WKUP_SELECT_P3_REG \
  (0x50000110) /* select which inputs from P3 port can trigger wkup counter */
#define WKUP_POL_P0_REG \
  (0x50000112) /* select the sesitivity polarity for each P0 input */
#define WKUP_POL_P1_REG \
  (0x50000114) /* select the sesitivity polarity for each P1 input */
#define WKUP_POL_P2_REG \
  (0x50000116) /* select the sesitivity polarity for each P2 input */
#define WKUP_POL_P3_REG \
  (0x50000118) /* select the sesitivity polarity for each P3 input */
                                                                                              ...
                                                                                              : (a)&0x00008000                                                               \
                                                                                                    ...
                                                                                                    : (a)&0x00010000 ? 16                                                    \
                                                                                                                     : (a)&0x00020000 ? 17                                   \
                                                                                                                                      : (a)&0x00040000 ? 18                  \
                                                                                                                                                       : (a)&0x00080000 ? 19 \
                                                                                                                                                                        : (a)&0x00100000 ? 20 : (a)&0x00200000 ? 21 : (a)&0x00400000 ? 22 : (a)&0x00800000 ? 23 : (a)&0x01000000 ? 24 : (a)&0x02000000 ? 25 : (a)&0x04000000 ? 26 : (a)&0x08000000 ? 27 : (a)&0x10000000 ? 28 : (a)&0x20000000 ? 29 : (a)&0x40000000 ? 30 : 31)
...
#define SetBits16(a, f, d) \
  (SetWord16(              \
      (a), (GetWord16(a) & (~(uint16)(f))) | (((uint16)(d)) << SHIF16((f)))))
#define SetBits32(a, f, d) \
  (SetWord32(              \
      (a), (GetWord32(a) & (~(uint32)(f))) | (((uint32)(d)) << SHIF32((f)))))
