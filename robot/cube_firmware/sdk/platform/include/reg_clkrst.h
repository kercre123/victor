...
__INLINE void clkrst_sysreset_unpack(uint8_t* wdreset, uint8_t* swreset,
                                     uint8_t* pwronreset) {
...
__INLINE void clkrst_softreset_pack(uint8_t rwbtrfreset, uint8_t rwbtreset,
                                    uint8_t softreset) {
  ...
  REG_PL_WR(CLKRST_SOFTRESET_ADDR, ((uint16_t)rwbtrfreset << 2) |
                                       ((uint16_t)rwbtreset << 1) |
                                       ((uint16_t)softreset << 0));
}

__INLINE void clkrst_softreset_rwbtrfreset_setf(uint8_t rwbtrfreset) {
  ASSERT_ERR((((uint16_t)rwbtrfreset << 2) & ~((uint16_t)0x00000004)) == 0);
  REG_PL_WR(CLKRST_SOFTRESET_ADDR,
            (REG_PL_RD(CLKRST_SOFTRESET_ADDR) & ~((uint16_t)0x00000004)) |
                ((uint16_t)rwbtrfreset << 2));
}

__INLINE void clkrst_softreset_rwbtreset_setf(uint8_t rwbtreset) {
  ASSERT_ERR((((uint16_t)rwbtreset << 1) & ~((uint16_t)0x00000002)) == 0);
  REG_PL_WR(CLKRST_SOFTRESET_ADDR,
            (REG_PL_RD(CLKRST_SOFTRESET_ADDR) & ~((uint16_t)0x00000002)) |
                ((uint16_t)rwbtreset << 1));
}
...
__INLINE void clkrst_softreset_softreset_setf(uint8_t softreset) {
  ASSERT_ERR((((uint16_t)softreset << 0) & ~((uint16_t)0x00000001)) == 0);
  REG_PL_WR(CLKRST_SOFTRESET_ADDR,
            (REG_PL_RD(CLKRST_SOFTRESET_ADDR) & ~((uint16_t)0x00000001)) |
                ((uint16_t)softreset << 0));
}
...
__INLINE void clkrst_wdconf_pack(uint8_t wdenable, uint8_t wdclk,
                                 uint8_t wddiv) {
  ...
  REG_PL_WR(CLKRST_WDCONF_ADDR, ((uint16_t)wdenable << 15) |
                                    ((uint16_t)wdclk << 7) |
                                    ((uint16_t)wddiv << 0));
}

__INLINE void clkrst_wdconf_unpack(uint8_t* wdenable, uint8_t* wdclk,
                                   uint8_t* wddiv) {
...
__INLINE void clkrst_wdconf_wdenable_setf(uint8_t wdenable) {
  ASSERT_ERR((((uint16_t)wdenable << 15) & ~((uint16_t)0x00008000)) == 0);
  REG_PL_WR(CLKRST_WDCONF_ADDR,
            (REG_PL_RD(CLKRST_WDCONF_ADDR) & ~((uint16_t)0x00008000)) |
                ((uint16_t)wdenable << 15));
}
...
__INLINE void clkrst_wdconf_wdclk_setf(uint8_t wdclk) {
  ASSERT_ERR((((uint16_t)wdclk << 7) & ~((uint16_t)0x00000080)) == 0);
  REG_PL_WR(CLKRST_WDCONF_ADDR,
            (REG_PL_RD(CLKRST_WDCONF_ADDR) & ~((uint16_t)0x00000080)) |
                ((uint16_t)wdclk << 7));
}
...
__INLINE void clkrst_wdconf_wddiv_setf(uint8_t wddiv) {
  ASSERT_ERR((((uint16_t)wddiv << 0) & ~((uint16_t)0x0000007F)) == 0);
  REG_PL_WR(CLKRST_WDCONF_ADDR,
            (REG_PL_RD(CLKRST_WDCONF_ADDR) & ~((uint16_t)0x0000007F)) |
                ((uint16_t)wddiv << 0));
}
