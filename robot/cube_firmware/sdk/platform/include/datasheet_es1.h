 ...
 *------------------------------------------------------------------------------------------------------------------------
 * Header    : $Header:
 * /services/syncdata/hazelaar/8000/server_vault/bb/tester/development/software_include/sc14580a/datasheet.h.rca
 *1.85 Mon Dec 17 13:23:04 2012 moschopoulos Experimental $ Date      : $Date:
 *Mon Dec 17 13:23:04 2012 $
 *
 *------------------------------------------------------------------------------------------------------------------------
 *
 *  Id       : $Id: datasheet.h.rca 1.85 Mon Dec 17 13:23:04 2012 moschopoulos
 *Experimental $
 *
...
/*
 *  --------------------------------------------------------------------------------------------
 *  The Cortex-M0 Processor Exceptions Numbers and the SC14580 Specific
 * Interrupt Numbers.     -
 *  --------------------------------------------------------------------------------------------
 */
typedef enum IRQn {
  ...
  WUPCT_IRQn =
      9, /* Wakeup Capture Timer interrupt. Generated when a programmable
            threshold of events occure on a GPIO (also programmable).         */
...
//Priority Levels        */ #define __Vendor_SysTickConfig    (0)         /* Set
//to 1 if different SysTick Config is used   */

/*====================== Start of automatic generated code =====================
 */
/* This file is generated from the XML files Output/TMS580.xml
 * Output/reg_file.xml  */
...
#define GP_ADC_RESULT_REG \
  (0x50001506) /* last result of the general-purpose ADC */
...
#define P2_PADPWR_CTRL_REG \
  (0x50003072) /* Port 2 Output Control Power Register */
...
#define OTPC_FFRD_REG \
  (0x4000401C) /* The data which have taken with the latest read from the */
