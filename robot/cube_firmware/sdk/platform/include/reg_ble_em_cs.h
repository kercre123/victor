...
//#define REG_BLE_EM_CS_ADDR_GET(idx) (jump_table_struct[offset_em_cs]  + (idx)
//* REG_BLE_EM_CS_SIZE)
#define REG_BLE_EM_CS_ADDR_GET(idx) \
  (jump_table_struct[offset_em_cs] + (idx)*REG_BLE_EM_CS_SIZE)
/**
...
__INLINE void ble_cntl_pack(int elt_idx, uint8_t pti, uint8_t txbsyen,
                            uint8_t rxbsyen, uint8_t dnabort, uint8_t txcrypten,
                            uint8_t rxcrypten, uint8_t format) {
  ...
  EM_BLE_WR(BLE_CNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            ((uint16_t)pti << 12) | ((uint16_t)txbsyen << 10) |
                ((uint16_t)rxbsyen << 9) | ((uint16_t)dnabort << 8) |
                ((uint16_t)txcrypten << 7) | ((uint16_t)rxcrypten << 6) |
                ((uint16_t)format << 0));
}

__INLINE void ble_cntl_unpack(int elt_idx, uint8_t* pti, uint8_t* txbsyen,
                              uint8_t* rxbsyen, uint8_t* dnabort,
                              uint8_t* txcrypten, uint8_t* rxcrypten,
                              uint8_t* format) {
...
__INLINE void ble_pti_setf(int elt_idx, uint8_t pti) {
  ASSERT_ERR((((uint16_t)pti << 12) & ~((uint16_t)0x0000F000)) == 0);
  EM_BLE_WR(BLE_CNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (EM_BLE_RD(BLE_CNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE) &
             ~((uint16_t)0x0000F000)) |
                ((uint16_t)pti << 12));
}
...
__INLINE void ble_syncwordl_setf(int elt_idx, uint16_t syncwordl) {
  ...
  EM_BLE_WR(BLE_SYNCWL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (uint16_t)syncwordl << 0);
}
...
__INLINE void ble_syncwordh_setf(int elt_idx, uint16_t syncwordh) {
  ...
  EM_BLE_WR(BLE_SYNCWH_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (uint16_t)syncwordh << 0);
}
...
__INLINE uint16_t ble_crcinit0_getf(int elt_idx) {
  uint16_t localVal =
      EM_BLE_RD(BLE_CRCINIT0_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
  ASSERT_ERR((localVal & ~((uint16_t)0x0000FFFF)) == 0);
  return (localVal >> 0);
}
...
__INLINE void ble_crcinit0_setf(int elt_idx, uint16_t crcinit0) {
  ...
  EM_BLE_WR(BLE_CRCINIT0_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (uint16_t)crcinit0 << 0);
}
...
__INLINE void ble_crcinit1_pack(int elt_idx, uint8_t filterpolicy,
                                uint8_t crcinit1) {
  ASSERT_ERR((((uint16_t)filterpolicy << 8) & ~((uint16_t)0x0000FF00)) == 0);
  ASSERT_ERR((((uint16_t)crcinit1 << 0) & ~((uint16_t)0x000000FF)) == 0);
  EM_BLE_WR(BLE_CRCINIT1_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            ((uint16_t)filterpolicy << 8) | ((uint16_t)crcinit1 << 0));
}

__INLINE void ble_crcinit1_unpack(int elt_idx, uint8_t* filterpolicy,
                                  uint8_t* crcinit1) {
  uint16_t localVal =
      EM_BLE_RD(BLE_CRCINIT1_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
...
__INLINE void ble_hopcntl_pack(int elt_idx, uint8_t fhen, uint8_t hopint,
                               uint8_t chidx) {
  ...
  EM_BLE_WR(BLE_HOPCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            ((uint16_t)fhen << 15) | ((uint16_t)hopint << 8) |
                ((uint16_t)chidx << 0));
}

__INLINE void ble_hopcntl_unpack(int elt_idx, uint8_t* fhen, uint8_t* hopint,
                                 uint8_t* chidx) {
  uint16_t localVal =
      EM_BLE_RD(BLE_HOPCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
...
__INLINE void ble_txrxcntl_pack(int elt_idx, uint8_t rxbufffull,
                                uint8_t lastempty, uint8_t sn, uint8_t nesn,
                                uint8_t rxthr, uint8_t txpwr) {
  ...
  EM_BLE_WR(BLE_TXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            ((uint16_t)rxbufffull << 15) | ((uint16_t)lastempty << 14) |
                ((uint16_t)sn << 13) | ((uint16_t)nesn << 12) |
                ((uint16_t)rxthr << 8) | ((uint16_t)txpwr << 0));
}

__INLINE void ble_txrxcntl_unpack(int elt_idx, uint8_t* rxbufffull,
                                  uint8_t* lastempty, uint8_t* sn,
                                  uint8_t* nesn, uint8_t* rxthr,
                                  uint8_t* txpwr) {
  uint16_t localVal =
      EM_BLE_RD(BLE_TXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
...
__INLINE void ble_rxwincntl_pack(int elt_idx, uint8_t rxwide,
                                 uint16_t rxwinsz) {
...
__INLINE void ble_rxwincntl_unpack(int elt_idx, uint8_t* rxwide,
                                   uint16_t* rxwinsz) {
  uint16_t localVal =
      EM_BLE_RD(BLE_RXWINCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
...
__INLINE uint16_t ble_txdescptr_getf(int elt_idx) {
  uint16_t localVal =
      EM_BLE_RD(BLE_TXDESCPTR_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
...
__INLINE void ble_txdescptr_setf(int elt_idx, uint16_t txdescptr) {
  ...
  EM_BLE_WR(BLE_TXDESCPTR_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (uint16_t)txdescptr << 0);
}
...
__INLINE void ble_rxdescptr_pack(int elt_idx, uint8_t rxnrdy,
                                 uint16_t rxdescptr) {
  ASSERT_ERR((((uint16_t)rxnrdy << 15) & ~((uint16_t)0x00008000)) == 0);
  ASSERT_ERR((((uint16_t)rxdescptr << 0) & ~((uint16_t)0x00003FFF)) == 0);
  EM_BLE_WR(BLE_RXDESCPTR_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            ((uint16_t)rxnrdy << 15) | ((uint16_t)rxdescptr << 0));
}

__INLINE void ble_rxdescptr_unpack(int elt_idx, uint8_t* rxnrdy,
                                   uint16_t* rxdescptr) {
  uint16_t localVal =
      EM_BLE_RD(BLE_RXDESCPTR_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
...
__INLINE uint16_t ble_winoffset_getf(int elt_idx) {
  uint16_t localVal =
      EM_BLE_RD(BLE_WINOFFSET_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
  ASSERT_ERR((localVal & ~((uint16_t)0x0000FFFF)) == 0);
  return (localVal >> 0);
}
...
__INLINE void ble_winoffset_setf(int elt_idx, uint16_t winoffset) {
  ...
  EM_BLE_WR(BLE_WINOFFSET_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (uint16_t)winoffset << 0);
}
...
__INLINE uint16_t ble_minevtime_getf(int elt_idx) {
  uint16_t localVal =
      EM_BLE_RD(BLE_MINEVTIME_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
  ASSERT_ERR((localVal & ~((uint16_t)0x0000FFFF)) == 0);
  return (localVal >> 0);
}
...
__INLINE void ble_minevtime_setf(int elt_idx, uint16_t minevtime) {
  ...
  EM_BLE_WR(BLE_MINEVTIME_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (uint16_t)minevtime << 0);
}
...
__INLINE uint16_t ble_maxevtime_getf(int elt_idx) {
  uint16_t localVal =
      EM_BLE_RD(BLE_MAXEVTIME_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
  ASSERT_ERR((localVal & ~((uint16_t)0x0000FFFF)) == 0);
  return (localVal >> 0);
}
...
__INLINE void ble_maxevtime_setf(int elt_idx, uint16_t maxevtime) {
  ...
  EM_BLE_WR(BLE_MAXEVTIME_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (uint16_t)maxevtime << 0);
}
...
__INLINE void ble_llchmap0_setf(int elt_idx, uint16_t llchmap0) {
  ...
  EM_BLE_WR(BLE_CHMAP0_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (uint16_t)llchmap0 << 0);
}
...
__INLINE void ble_llchmap1_setf(int elt_idx, uint16_t llchmap1) {
  ...
  EM_BLE_WR(BLE_CHMAP1_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (uint16_t)llchmap1 << 0);
}
...
__INLINE void ble_chmap2_pack(int elt_idx, uint8_t nbchgoog, uint8_t llchmap3) {
  ...
  EM_BLE_WR(BLE_CHMAP2_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            ((uint16_t)nbchgoog << 8) | ((uint16_t)llchmap3 << 0));
}

__INLINE void ble_chmap2_unpack(int elt_idx, uint8_t* nbchgoog,
                                uint8_t* llchmap3) {
...
__INLINE void ble_nbchgoog_setf(int elt_idx, uint8_t nbchgoog) {
  ASSERT_ERR((((uint16_t)nbchgoog << 8) & ~((uint16_t)0x00003F00)) == 0);
  EM_BLE_WR(BLE_CHMAP2_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (EM_BLE_RD(BLE_CHMAP2_ADDR + elt_idx * REG_BLE_EM_CS_SIZE) &
             ~((uint16_t)0x00003F00)) |
                ((uint16_t)nbchgoog << 8));
}
...
__INLINE uint16_t ble_fcntoffs_getf(int elt_idx) {
  uint16_t localVal =
      EM_BLE_RD(BLE_FCNTOFFSET_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
...
__INLINE void ble_fcntoffs_setf(int elt_idx, uint16_t fcntoffs) {
  ...
  EM_BLE_WR(BLE_FCNTOFFSET_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (uint16_t)fcntoffs << 0);
}
...
__INLINE uint16_t ble_sk_getf(int elt_idx, int reg_idx) {
  ASSERT_ERR(reg_idx <= 7);
  uint16_t localVal =
      EM_BLE_RD(BLE_SK_ADDR + elt_idx * REG_BLE_EM_CS_SIZE + reg_idx * 2);
  ASSERT_ERR((localVal & ~((uint16_t)0x0000FFFF)) == 0);
  return (localVal >> 0);
}
...
__INLINE void ble_sk_setf(int elt_idx, int reg_idx, uint16_t sk) {
  ...
  EM_BLE_WR(BLE_SK_ADDR + elt_idx * REG_BLE_EM_CS_SIZE + reg_idx * 2,
            (uint16_t)sk << 0);
}
...
__INLINE uint16_t ble_adv_bd_addr_get(int elt_idx, int reg_idx) {
  ...
  return EM_BLE_RD(BLE_ADV_BD_ADDR_ADDR + elt_idx * REG_BLE_EM_CS_SIZE +
                   reg_idx * 2);
}

__INLINE void ble_adv_bd_addr_set(int elt_idx, int reg_idx, uint16_t value) {
  ASSERT_ERR(reg_idx <= 2);
  EM_BLE_WR(BLE_ADV_BD_ADDR_ADDR + elt_idx * REG_BLE_EM_CS_SIZE + reg_idx * 2,
            value);
}
...
__INLINE uint16_t ble_adv_bd_addr_getf(int elt_idx, int reg_idx) {
  ASSERT_ERR(reg_idx <= 2);
  uint16_t localVal = EM_BLE_RD(BLE_ADV_BD_ADDR_ADDR +
                                elt_idx * REG_BLE_EM_CS_SIZE + reg_idx * 2);
  ASSERT_ERR((localVal & ~((uint16_t)0x0000FFFF)) == 0);
  return (localVal >> 0);
}

__INLINE void ble_adv_bd_addr_setf(int elt_idx, int reg_idx,
                                   uint16_t advbdaddr) {
  ASSERT_ERR(reg_idx <= 2);
  ASSERT_ERR((((uint16_t)advbdaddr << 0) & ~((uint16_t)0x0000FFFF)) == 0);
  EM_BLE_WR(BLE_ADV_BD_ADDR_ADDR + elt_idx * REG_BLE_EM_CS_SIZE + reg_idx * 2,
            (uint16_t)advbdaddr << 0);
}
...
__INLINE uint8_t ble_adv_bd_addr_type_getf(int elt_idx) {
  uint16_t localVal =
      EM_BLE_RD(BLE_ADV_BD_ADDR_TYPE_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
...
__INLINE void ble_adv_bd_addr_type_setf(int elt_idx, uint8_t advbdaddrtype) {
  ...
  EM_BLE_WR(BLE_ADV_BD_ADDR_TYPE_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (uint16_t)advbdaddrtype << 0);
}
...
__INLINE uint16_t ble_iv_getf(int elt_idx, int reg_idx) {
  ASSERT_ERR(reg_idx <= 3);
  uint16_t localVal =
      EM_BLE_RD(BLE_IV_ADDR + elt_idx * REG_BLE_EM_CS_SIZE + reg_idx * 2);
  ASSERT_ERR((localVal & ~((uint16_t)0x0000FFFF)) == 0);
  return (localVal >> 0);
}
...
__INLINE void ble_iv_setf(int elt_idx, int reg_idx, uint16_t iv) {
  ...
  EM_BLE_WR(BLE_IV_ADDR + elt_idx * REG_BLE_EM_CS_SIZE + reg_idx * 2,
            (uint16_t)iv << 0);
}
...
__INLINE uint16_t ble_txccmpktcnt0_getf(int elt_idx) {
  uint16_t localVal =
      EM_BLE_RD(BLE_TXCCMPKTCNT0_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
  ASSERT_ERR((localVal & ~((uint16_t)0x0000FFFF)) == 0);
  return (localVal >> 0);
}
...
__INLINE void ble_txccmpktcnt0_setf(int elt_idx, uint16_t txccmpktcnt0) {
  ...
  EM_BLE_WR(BLE_TXCCMPKTCNT0_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (uint16_t)txccmpktcnt0 << 0);
}
...
__INLINE uint16_t ble_txccmpktcnt1_getf(int elt_idx) {
  uint16_t localVal =
      EM_BLE_RD(BLE_TXCCMPKTCNT1_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
  ASSERT_ERR((localVal & ~((uint16_t)0x0000FFFF)) == 0);
  return (localVal >> 0);
}
...
__INLINE void ble_txccmpktcnt1_setf(int elt_idx, uint16_t txccmpktcnt1) {
  ...
  EM_BLE_WR(BLE_TXCCMPKTCNT1_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (uint16_t)txccmpktcnt1 << 0);
}
...
__INLINE uint8_t ble_txccmpktcnt2_getf(int elt_idx) {
  uint16_t localVal =
      EM_BLE_RD(BLE_TXCCMPKTCNT2_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
...
__INLINE void ble_txccmpktcnt2_setf(int elt_idx, uint8_t txccmpktcnt2) {
  ...
  EM_BLE_WR(BLE_TXCCMPKTCNT2_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (uint16_t)txccmpktcnt2 << 0);
}
...
__INLINE uint16_t ble_rxccmpktcnt0_getf(int elt_idx) {
  uint16_t localVal =
      EM_BLE_RD(BLE_RXCCMPKTCNT0_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
  ASSERT_ERR((localVal & ~((uint16_t)0x0000FFFF)) == 0);
  return (localVal >> 0);
}
...
__INLINE void ble_rxccmpktcnt0_setf(int elt_idx, uint16_t rxccmpktcnt0) {
  ...
  EM_BLE_WR(BLE_RXCCMPKTCNT0_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (uint16_t)rxccmpktcnt0 << 0);
}
...
__INLINE uint16_t ble_rxccmpktcnt1_getf(int elt_idx) {
  uint16_t localVal =
      EM_BLE_RD(BLE_RXCCMPKTCNT1_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
  ASSERT_ERR((localVal & ~((uint16_t)0x0000FFFF)) == 0);
  return (localVal >> 0);
}
...
__INLINE void ble_rxccmpktcnt1_setf(int elt_idx, uint16_t rxccmpktcnt1) {
  ...
  EM_BLE_WR(BLE_RXCCMPKTCNT1_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (uint16_t)rxccmpktcnt1 << 0);
}
...
__INLINE uint8_t ble_rxccmpktcnt2_getf(int elt_idx) {
  uint16_t localVal =
      EM_BLE_RD(BLE_RXCCMPKTCNT2_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
...
__INLINE void ble_rxccmpktcnt2_setf(int elt_idx, uint8_t rxccmpktcnt2) {
  ...
  EM_BLE_WR(BLE_RXCCMPKTCNT2_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            (uint16_t)rxccmpktcnt2 << 0);
}
...
__INLINE uint16_t ble_btcntsync0_getf(int elt_idx) {
  uint16_t localVal =
      EM_BLE_RD(BLE_BTCNTSYNC0_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
  ASSERT_ERR((localVal & ~((uint16_t)0x0000FFFF)) == 0);
  return (localVal >> 0);
}
...
__INLINE uint8_t ble_btcntsync1_getf(int elt_idx) {
  uint16_t localVal =
      EM_BLE_RD(BLE_BTCNTSYNC1_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
  ASSERT_ERR((localVal & ~((uint16_t)0x0000007F)) == 0);
  return (localVal >> 0);
}
...
__INLINE uint16_t ble_fcntrxsync_getf(int elt_idx) {
  uint16_t localVal =
      EM_BLE_RD(BLE_FCNTSYNC_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
  ASSERT_ERR((localVal & ~((uint16_t)0x000003FF)) == 0);
  return (localVal >> 0);
}
...
__INLINE void ble_txrxdesccnt_unpack(int elt_idx, uint8_t* rxdesccnt,
                                     uint8_t* txdesccnt) {
  uint16_t localVal =
      EM_BLE_RD(BLE_TXRXDESCCNT_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
...
__INLINE void ble_dmpriocntl_pack(int elt_idx, uint8_t prioincstep,
                                  uint8_t minprio, uint8_t conflict,
                                  uint8_t currentprio) {
  ...
  EM_BLE_WR(BLE_DMPRIOCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,
            ((uint16_t)prioincstep << 13) | ((uint16_t)minprio << 8) |
                ((uint16_t)conflict << 7) | ((uint16_t)currentprio << 0));
}

__INLINE void ble_dmpriocntl_unpack(int elt_idx, uint8_t* prioincstep,
                                    uint8_t* minprio, uint8_t* conflict,
                                    uint8_t* currentprio) {
  uint16_t localVal =
      EM_BLE_RD(BLE_DMPRIOCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
