...
uint8_t read_from_3wire_SPI_register(uint8_t registerIndex,
                                     uint8_t is_last_transaction);
void initialize_3wire_spi(struct SPI_Config *cfg, bool enable_interrupt,
                          uint16_t TsradCounterToSet);
