...
#define UART_BAUDRATE_115K2 \
  9  // = 16000000 / (16 * 115200),  actual baud rate = 111111.111,  error =
     // -3.549%
/// Divider for 57600 bits/s
#define UART_BAUDRATE_57K6 \
  17  // = 16000000 / (16 * 57600),   actual baud rate = 58823.529,   error
      // = 2.124%
/// Divider for 38400 bits/s
#define UART_BAUDRATE_38K4 \
  26  // = 16000000 / (16 * 38400),   actual baud rate = 38461.538,   error =
      // 0.16%
/// Divider for 28800 bits/s
#define UART_BAUDRATE_28K8 \
  35  // = 16000000 / (16 * 28800),   actual baud rate = 28571.429,   error =
      // -0.794%
/// Divider for 19200 bits/s
#define UART_BAUDRATE_19K2 \
  52  // = 16000000 / (16 * 19200),   actual baud rate = 19230.769,   error =
      // 0.16%
/// Divider for 9600 bits/s
#define UART_BAUDRATE_9K6 \
  104  // = 16000000 / (16 * 9600),    actual baud rate = 9615.385,    error =
       // 0.16%
/// Divider for 2400 bits/s
#define UART_BAUDRATE_2K4 \
  417  // = 16000000 / (16 * 2400),    actual baud rate = 2398.082,    error =
       // -0.08%
...
/**
 ****************************************************************************************
 * @brief Starts a data reception. As soon as the end of the data transfer or a
 *buffer overflow is detected, the hci_uart_rx_done function is executed.
...
void uart2_write_func(uint8_t *bufptr, uint32_t size,
