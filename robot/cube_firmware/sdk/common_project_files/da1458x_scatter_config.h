...
#if ((BLE_CONNECTION_MAX_USER > 1) && !defined(MSG_HEAP_SZ) && \
     (USE_MEMORY_MAP != EXT_SLEEP_SETUP))
#error \
    "Memory map error! When BLE_CONNECTION_MAX_USER is bigger than 1, the constants from the excel tool must be used in da14580_config_advanced.h"
#endif
...
#if ((BLE_CONNECTION_MAX_USER < 1) || (BLE_CONNECTION_MAX_USER > CFG_CON))
