...
gst-launch v4l2src device=/dev/video6 num-buffers=1 ! 'video/x-raw-yuv,format=(fourcc)UYVY,width=2592,height=1944' ! TIImgenc1 engineName=codecServer codecName=jpegenc resolution=2592x1944 iColorSpace=UYVY oColorSpace=YUV420P qValue=97 ! filesink location=still.jpg
