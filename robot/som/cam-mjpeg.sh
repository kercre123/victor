...
gst-launch v4l2src device=/dev/video6 ! TIImgenc1 engineName=codecServer iColorSpace=UYVY oColorSpace=YUV420P qValue=97 numOutputBufs=2 ! udpsink host=192.168.2.220 port=9000
