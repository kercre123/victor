 ...
 * Created: 22-OCT-2012
 *
 * Some trig functions to supplement incomplete math libraries on embedded
 *targets. Error of all functions is less than +/- 0.01. For bettery accuracy,
 *lookup tables should be regenerated with u16.
 *
 **/
#ifndef _TRIG_FAST_H
#define _TRIG_FAST_H
...
// USE_INTERPOLATION is also automatically defined, since without it answers are
// probably too wrong to be useful. If USE_SMALL_LUT is not defined, a large LUT
// is used.
