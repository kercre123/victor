...
float Point2f::Length() const { return sqrtf(x * x + y * y); }

// ------- Rotation2d class ----------

Rotation2d::Rotation2d() : _angle(0) {}

Rotation2d::Rotation2d(Radians angle_rad) : _angle(angle_rad) {}
...
void Rotation2d::Invert() { _angle *= -1; }
...
Radians Rotation2d::GetAngle() const { return _angle; }
