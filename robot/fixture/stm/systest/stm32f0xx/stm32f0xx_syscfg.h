...
#define EXTI_PortSourceGPIOD \
  ((uint8_t)0x03) /*!< not available for STM32F031 devices */
#define EXTI_PortSourceGPIOE \
  ((uint8_t)0x04) /*!< only available for STM32F072 devices */
...
#define SYSCFG_DMARemap_TIM3                                            \
  SYSCFG_CFGR1_TIM3_DMA_RMP /* Remap TIM3 DMA requests from channel4 to \
                               channel6,                                \
                               available only for STM32F072 devices */
#define SYSCFG_DMARemap_TIM2                                              \
  SYSCFG_CFGR1_TIM2_DMA_RMP /* Remap TIM2 DMA requests from channel3/4 to \
                               channel7,                                  \
                               available only for STM32F072 devices */
#define SYSCFG_DMARemap_TIM1                                                \
  SYSCFG_CFGR1_TIM1_DMA_RMP /* Remap TIM1 DMA requests from channel2/3/4 to \
                               channel6,                                    \
                               available only for STM32F072 devices */
#define SYSCFG_DMARemap_I2C1                                              \
  SYSCFG_CFGR1_I2C1_DMA_RMP /* Remap I2C1 DMA requests from channel3/2 to \
                               channel7/6, available only for STM32F072                                             \
                               devices */
#define SYSCFG_DMARemap_USART3                                                \
  SYSCFG_CFGR1_USART3_DMA_RMP /* Remap USART3 DMA requests from channel6/7 to \
                                 channel3/2, available only for STM32F072                                                 \
                                 devices */
#define SYSCFG_DMARemap_USART2                                                \
  SYSCFG_CFGR1_USART2_DMA_RMP /* Remap USART2 DMA requests from channel4/5 to \
                                 channel6/7, available only for STM32F072                                                 \
                                 devices */
#define SYSCFG_DMARemap_SPI2                                              \
  SYSCFG_CFGR1_SPI2_DMA_RMP /* Remap SPI2 DMA requests from channel4/5 to \
                               channel6/7, available only for STM32F072                                             \
                               devices */
#define SYSCFG_DMARemap_TIM17_2                                              \
  SYSCFG_CFGR1_TIM17_DMA_RMP2 /* Remap TIM17 DMA requests from channel1/2 to \
                                 channel7, available only for STM32F072                                                \
                                 devices */
#define SYSCFG_DMARemap_TIM16_2                                              \
  SYSCFG_CFGR1_TIM16_DMA_RMP2 /* Remap TIM16 DMA requests from channel3/4 to \
                                 channel6, available only for STM32F072                                                \
                                 devices */
#define SYSCFG_DMARemap_TIM17                                             \
  SYSCFG_CFGR1_TIM17_DMA_RMP /* Remap TIM17 DMA requests from channel1 to \
                                channel2 */
#define SYSCFG_DMARemap_TIM16                                             \
  SYSCFG_CFGR1_TIM16_DMA_RMP /* Remap TIM16 DMA requests from channel3 to \
                                channel4 */
#define SYSCFG_DMARemap_USART1Rx                                              \
  SYSCFG_CFGR1_USART1RX_DMA_RMP /* Remap USART1 Rx DMA requests from channel3 \
                                   to channel5 */
#define SYSCFG_DMARemap_USART1Tx                                              \
  SYSCFG_CFGR1_USART1TX_DMA_RMP /* Remap USART1 Tx DMA requests from channel2 \
                                   to channel4 */
...
#define SYSCFG_I2CFastModePlus_I2C1                                           \
  SYSCFG_CFGR1_I2C_FMP_I2C1 /* Enable Fast Mode Plus on PB10, PB11, PF6 and   \
                               PF7(only for STM32F0031 and STM32F030 devices) \
                             */
#define SYSCFG_I2CFastModePlus_I2C2                                          \
  SYSCFG_CFGR1_I2C_FMP_I2C2 /* Enable Fast Mode Plus on I2C2 pins, available \
                               only for STM32F072 devices */
#define SYSCFG_I2CFastModePlus_PA9                                             \
  SYSCFG_CFGR1_I2C_FMP_PA9 /* Enable Fast Mode Plus on PA9 (only for STM32F031 \
                              and STM32F030 devices) */
#define SYSCFG_I2CFastModePlus_PA10                                   \
  SYSCFG_CFGR1_I2C_FMP_PA10 /* Enable Fast Mode Plus on PA10(only for \
                               STM32F031 and STM32F030 devices) */
...
#define SYSCFG_Break_PVD                                                  \
  SYSCFG_CFGR2_PVD_LOCK /*!< Connects the PVD event to the Break Input of \
                           TIM1, not available for STM32F030 devices */
#define SYSCFG_Break_SRAMParity                                               \
  SYSCFG_CFGR2_SRAM_PARITY_LOCK /*!< Connects the SRAM_PARITY error signal to \
                                   the Break Input of TIM1 */
#define SYSCFG_Break_Lockup                                               \
  SYSCFG_CFGR2_LOCKUP_LOCK /*!< Connects Lockup output of CortexM0 to the \
                              break input of TIM1 */
...
#define ITLINE_TIM1_BRK                   \
  ((uint32_t)((SYSCFG_ITLINE13 << 0x18) | \
              SYSCFG_ITLINE13_SR_TIM1_BRK)) /* TIM1 BRK Interrupt */
#define ITLINE_TIM1_UPD                   \
  ((uint32_t)((SYSCFG_ITLINE13 << 0x18) | \
              SYSCFG_ITLINE13_SR_TIM1_UPD)) /* TIM1 UPD Interrupt */
#define ITLINE_TIM1_TRG                   \
  ((uint32_t)((SYSCFG_ITLINE13 << 0x18) | \
              SYSCFG_ITLINE13_SR_TIM1_TRG)) /* TIM1 TRG Interrupt */
#define ITLINE_TIM1_CCU                   \
  ((uint32_t)((SYSCFG_ITLINE13 << 0x18) | \
              SYSCFG_ITLINE13_SR_TIM1_CCU)) /* TIM1 CCU Interrupt */
#define ITLINE_TIM1_CC                    \
  ((uint32_t)((SYSCFG_ITLINE14 << 0x18) | \
              SYSCFG_ITLINE14_SR_TIM1_CC)) /* TIM1 CC Interrupt */
#define ITLINE_TIM2                       \
  ((uint32_t)((SYSCFG_ITLINE15 << 0x18) | \
              SYSCFG_ITLINE15_SR_TIM2_GLB)) /* TIM2 Interrupt */
#define ITLINE_TIM3                       \
  ((uint32_t)((SYSCFG_ITLINE16 << 0x18) | \
              SYSCFG_ITLINE16_SR_TIM3_GLB)) /* TIM3 Interrupt */
#define ITLINE_DAC                        \
  ((uint32_t)((SYSCFG_ITLINE17 << 0x18) | \
              SYSCFG_ITLINE17_SR_DAC)) /* DAC Interrupt */
#define ITLINE_TIM6                       \
  ((uint32_t)((SYSCFG_ITLINE17 << 0x18) | \
              SYSCFG_ITLINE17_SR_TIM6_GLB)) /* TIM6 Interrupt */
#define ITLINE_TIM7                       \
  ((uint32_t)((SYSCFG_ITLINE18 << 0x18) | \
              SYSCFG_ITLINE18_SR_TIM7_GLB)) /* TIM7 Interrupt */
#define ITLINE_TIM14                      \
  ((uint32_t)((SYSCFG_ITLINE19 << 0x18) | \
              SYSCFG_ITLINE19_SR_TIM14_GLB)) /* TIM14 Interrupt */
#define ITLINE_TIM15                      \
  ((uint32_t)((SYSCFG_ITLINE20 << 0x18) | \
              SYSCFG_ITLINE20_SR_TIM15_GLB)) /* TIM15 Interrupt */
#define ITLINE_TIM16                      \
  ((uint32_t)((SYSCFG_ITLINE21 << 0x18) | \
              SYSCFG_ITLINE21_SR_TIM16_GLB)) /* TIM16 Interrupt */
#define ITLINE_TIM17                      \
  ((uint32_t)((SYSCFG_ITLINE22 << 0x18) | \
              SYSCFG_ITLINE22_SR_TIM17_GLB)) /* TIM17 Interrupt */
#define ITLINE_I2C1                       \
  ((uint32_t)((SYSCFG_ITLINE23 << 0x18) | \
              SYSCFG_ITLINE23_SR_I2C1_GLB)) /* I2C1 Interrupt -> exti[23] */
#define ITLINE_I2C2                       \
  ((uint32_t)((SYSCFG_ITLINE24 << 0x18) | \
              SYSCFG_ITLINE24_SR_I2C2_GLB)) /* I2C2 Interrupt */
#define ITLINE_SPI1                       \
  ((uint32_t)((SYSCFG_ITLINE25 << 0x18) | \
              SYSCFG_ITLINE25_SR_SPI1)) /* I2C1 Interrupt -> exti[23] */
#define ITLINE_SPI2                       \
  ((uint32_t)((SYSCFG_ITLINE26 << 0x18) | \
              SYSCFG_ITLINE26_SR_SPI2)) /* SPI1 Interrupt */
#define ITLINE_USART1             \
  ((uint32_t)(                    \
      (SYSCFG_ITLINE27 << 0x18) | \
      SYSCFG_ITLINE27_SR_USART1_GLB)) /*!< USART1 GLB Interrupt -> exti[25] */
#define ITLINE_USART2             \
  ((uint32_t)(                    \
      (SYSCFG_ITLINE28 << 0x18) | \
      SYSCFG_ITLINE28_SR_USART2_GLB)) /*!< USART2 GLB Interrupt -> exti[26] */
#define ITLINE_USART3                     \
  ((uint32_t)((SYSCFG_ITLINE29 << 0x18) | \
              SYSCFG_ITLINE29_SR_USART3_GLB)) /* USART3 Interrupt */
#define ITLINE_USART4                     \
  ((uint32_t)((SYSCFG_ITLINE29 << 0x18) | \
              SYSCFG_ITLINE29_SR_USART4_GLB)) /* USART4 Interrupt */
#define ITLINE_USART5                     \
  ((uint32_t)((SYSCFG_ITLINE29 << 0x18) | \
              SYSCFG_ITLINE29_SR_USART5_GLB)) /* USART5 Interrupt */
#define ITLINE_USART6                     \
  ((uint32_t)((SYSCFG_ITLINE29 << 0x18) | \
              SYSCFG_ITLINE29_SR_USART6_GLB)) /* USART6 Interrupt */
#define ITLINE_USART7                     \
  ((uint32_t)((SYSCFG_ITLINE29 << 0x18) | \
              SYSCFG_ITLINE29_SR_USART7_GLB)) /* USART7 Interrupt */
#define ITLINE_USART8                     \
  ((uint32_t)((SYSCFG_ITLINE29 << 0x18) | \
              SYSCFG_ITLINE29_SR_USART8_GLB)) /* USART8 Interrupt */
#define ITLINE_CAN                        \
  ((uint32_t)((SYSCFG_ITLINE30 << 0x18) | \
              SYSCFG_ITLINE30_SR_CAN)) /* CAN Interrupt */
#define ITLINE_CEC                        \
  ((uint32_t)((SYSCFG_ITLINE30 << 0x18) | \
              SYSCFG_ITLINE30_SR_CEC)) /* CEC Interrupt -> exti[27] */

#define IS_SYSCFG_ITLINE(LINE)                                     \
  (((LINE) == ITLINE_EWDG) || ((LINE) == ITLINE_PVDOUT) ||         \
   ((LINE) == ITLINE_VDDIO2) || ((LINE) == ITLINE_RTC_WAKEUP) ||   \
   ((LINE) == ITLINE_RTC_TSTAMP) || ((LINE) == ITLINE_RTC_ALRA) || \
   ((LINE) == ITLINE_FLASH_ITF) || ((LINE) == ITLINE_CRS) ||       \
   ((LINE) == ITLINE_CLK_CTRL) || ((LINE) == ITLINE_EXTI0) ||      \
   ((LINE) == ITLINE_EXTI1) || ((LINE) == ITLINE_EXTI2) ||         \
   ((LINE) == ITLINE_EXTI3) || ((LINE) == ITLINE_EXTI4) ||         \
   ((LINE) == ITLINE_EXTI5) || ((LINE) == ITLINE_EXTI6) ||         \
   ((LINE) == ITLINE_EXTI7) || ((LINE) == ITLINE_EXTI8) ||         \
   ((LINE) == ITLINE_EXTI9) || ((LINE) == ITLINE_EXTI10) ||        \
   ((LINE) == ITLINE_EXTI11) || ((LINE) == ITLINE_EXTI12) ||       \
   ((LINE) == ITLINE_EXTI13) || ((LINE) == ITLINE_EXTI14) ||       \
   ((LINE) == ITLINE_EXTI15) || ((LINE) == ITLINE_TSC_EOA) ||      \
   ((LINE) == ITLINE_TSC_MCE) || ((LINE) == ITLINE_DMA1_CH1) ||    \
   ((LINE) == ITLINE_DMA1_CH2) || ((LINE) == ITLINE_DMA1_CH3) ||   \
   ((LINE) == ITLINE_DMA1_CH4) || ((LINE) == ITLINE_DMA1_CH5) ||   \
   ((LINE) == ITLINE_DMA1_CH6) || ((LINE) == ITLINE_DMA1_CH7) ||   \
   ((LINE) == ITLINE_DMA2_CH1) || ((LINE) == ITLINE_DMA2_CH2) ||   \
   ((LINE) == ITLINE_DMA2_CH3) || ((LINE) == ITLINE_DMA2_CH4) ||   \
   ((LINE) == ITLINE_DMA2_CH5) || ((LINE) == ITLINE_ADC) ||        \
   ((LINE) == ITLINE_COMP1) || ((LINE) == ITLINE_COMP2) ||         \
   ((LINE) == ITLINE_TIM1_BRK) || ((LINE) == ITLINE_TIM1_UPD) ||   \
   ((LINE) == ITLINE_TIM1_TRG) || ((LINE) == ITLINE_TIM1_CCU) ||   \
   ((LINE) == ITLINE_TIM1_CC) || ((LINE) == ITLINE_TIM2) ||        \
   ((LINE) == ITLINE_TIM3) || ((LINE) == ITLINE_DAC) ||            \
   ((LINE) == ITLINE_TIM6) || ((LINE) == ITLINE_TIM7) ||           \
   ((LINE) == ITLINE_TIM14) || ((LINE) == ITLINE_TIM15) ||         \
   ((LINE) == ITLINE_TIM16) || ((LINE) == ITLINE_TIM17) ||         \
   ((LINE) == ITLINE_I2C1) || ((LINE) == ITLINE_I2C2) ||           \
   ((LINE) == ITLINE_SPI1) || ((LINE) == ITLINE_SPI2) ||           \
   ((LINE) == ITLINE_USART1) || ((LINE) == ITLINE_USART2) ||       \
   ((LINE) == ITLINE_USART3) || ((LINE) == ITLINE_USART4) ||       \
   ((LINE) == ITLINE_USART5) || ((LINE) == ITLINE_USART6) ||       \
   ((LINE) == ITLINE_USART7) || ((LINE) == ITLINE_USART8) ||       \
   ((LINE) == ITLINE_CAN) || ((LINE) == ITLINE_CEC))
 ...
 * @{
 */
#define SYSCFG_IRDA_ENV_SEL_TIM16                                         \
  (SYSCFG_CFGR1_IRDA_ENV_SEL_0 &                                          \
   SYSCFG_CFGR1_IRDA_ENV_SEL_1) /* Timer16 is selected as IRDA Modulation \
                                   envelope source */
#define SYSCFG_IRDA_ENV_SEL_USART1                                       \
  (SYSCFG_CFGR1_IRDA_ENV_SEL_0) /* USART1 is selected as IRDA Modulation \
                                   envelope source.*/
#define SYSCFG_IRDA_ENV_SEL_USART4                                       \
  (SYSCFG_CFGR1_IRDA_ENV_SEL_1) /* USART4 is selected as IRDA Modulation \
                                   envelope source.*/

#define IS_SYSCFG_IRDA_ENV(ENV)             \
  (((ENV) == SYSCFG_IRDA_ENV_SEL_TIM16) ||  \
