...
typedef struct {
  uint32_t I2C_Timing; /*!< Specifies the I2C_TIMINGR_register value.
                            This parameter must be set by referring to
                          I2C_Timing_Config_Tool*/
  ...
  uint32_t
      I2C_OwnAddress1; /*!< Specifies the device own address 1.
  ...
  uint32_t I2C_AcknowledgedAddress; /*!< Specifies if 7-bit or 10-bit address is
...
#define IS_I2C_ACK(ACK) \
  (((ACK) == I2C_Ack_Enable) || ((ACK) == I2C_Ack_Disable))
/**
 * @}
 */
...
#define IS_I2C_DMA_REQ(REQ) \
  ((((REQ) & (uint32_t)0xFFFF3FFF) == 0x00) && ((REQ) != 0x00))
/**
 * @}
 */
...
#define IS_I2C_REGISTER(REGISTER)                                            \
  (((REGISTER) == I2C_Register_CR1) || ((REGISTER) == I2C_Register_CR2) ||   \
   ...
   ((REGISTER) == I2C_Register_ISR) || ((REGISTER) == I2C_Register_ICR) ||   \
   ((REGISTER) == I2C_Register_PECR) || ((REGISTER) == I2C_Register_RXDR) || \
...
#define IS_I2C_CONFIG_IT(IT) \
  ((((IT) & (uint32_t)0xFFFFFF01) == 0x00) && ((IT) != 0x00))
...
#define IS_I2C_CLEAR_IT(IT) \
  ((((IT) & (uint32_t)0xFFFFC001) == 0x00) && ((IT) != 0x00))

#define IS_I2C_GET_IT(IT)                                                     \
  (((IT) == I2C_IT_TXIS) || ((IT) == I2C_IT_RXNE) || ((IT) == I2C_IT_ADDR) || \
   ((IT) == I2C_IT_NACKF) || ((IT) == I2C_IT_STOPF) || ((IT) == I2C_IT_TC) || \
   ((IT) == I2C_IT_TCR) || ((IT) == I2C_IT_BERR) || ((IT) == I2C_IT_ARLO) ||  \
   ((IT) == I2C_IT_OVR) || ((IT) == I2C_IT_PECERR) ||                         \
   ((IT) == I2C_IT_TIMEOUT) || ((IT) == I2C_IT_ALERT))
...
#define IS_START_STOP_MODE(MODE)                                           \
  (((MODE) == I2C_Generate_Stop) || ((MODE) == I2C_Generate_Start_Read) || \
   ((MODE) == I2C_Generate_Start_Write) || ((MODE) == I2C_No_StartStop))
...
void I2C_TransferHandling(I2C_TypeDef* I2Cx, uint16_t Address,
                          uint8_t Number_Bytes, uint32_t ReloadEndMode,
...
void I2C_DMACmd(I2C_TypeDef* I2Cx, uint32_t I2C_DMAReq,
