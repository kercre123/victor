...
typedef struct {
  ...
  GPIOOType_TypeDef
      GPIO_OType; /*!< Specifies the operating output type for the selected
                     pins. This parameter can be a value of @ref
                     GPIOOType_TypeDef  */

  GPIOPuPd_TypeDef GPIO_PuPd; /*!< Specifies the operating Pull-up/Pull down for
                                 the selected pins. This parameter can be a
                                 value of @ref GPIOPuPd_TypeDef   */
} GPIO_InitTypeDef;
 ...
 */
#define GPIO_AF_1                                       \
  ((uint8_t)0x01) /* USART2, CEC, TIM3, USART1, IR,     \
 ...
 */
#define GPIO_AF_2                                        \
  ((uint8_t)0x02) /* TIM2, TIM1, EVENTOUT, TIM16, TIM17, \
                     USB */
/**
 ...
 */
#define GPIO_AF_4                                     \
  ((uint8_t)0x04) /* TIM14, USART4, USART3, CRS, CAN, \
                     I2C1 */
 ...
 */
#define GPIO_AF_5                                     \
  ((uint8_t)0x05) /* TIM16, TIM17, TIM15, SPI2, I2C2, \
                     MCO, I2C1, USB */
...
#define IS_GPIO_AF(AF)                                                  \
  (((AF) == GPIO_AF_0) || ((AF) == GPIO_AF_1) || ((AF) == GPIO_AF_2) || \
   ((AF) == GPIO_AF_3) || ((AF) == GPIO_AF_4) || ((AF) == GPIO_AF_5) || \
...
#define GPIO_Speed_10MHz \
  GPIO_Speed_Level_2 /*!< I/O output speed: Medium 10 MHz */
#define GPIO_Speed_50MHz \
  GPIO_Speed_Level_3 /*!< I/O output speed: High 50 MHz */
