...
typedef struct {
  ...
  uint32_t USART2CLK_Frequency; /*!< Only applicable for STM32F072 and STM32F091
                                   devices */
...
#define RCC_PLLSource_PREDIV1                                                 \
  RCC_CFGR_PLLSRC_HSE_PREDIV /* Old HSEPREDIV1 bit definition, maintained for \
                                legacy purpose */
#define RCC_PLLSource_HSE \
  RCC_CFGR_PLLSRC_HSE_PREDIV /*!< Only applicable for STM32F072 devices */
#define RCC_PLLSource_HSI48 \
  RCC_CFGR_PLLSRC_HSI48_PREDIV /*!< Only applicable for STM32F072 devices */
#define RCC_PLLSource_HSI \
  RCC_CFGR_PLLSRC_HSI_PREDIV /*!< Only applicable for STM32F072 devices */

#define IS_RCC_PLL_SOURCE(SOURCE)                                          \
  (((SOURCE) == RCC_PLLSource_HSI_Div2) ||                                 \
   ((SOURCE) == RCC_PLLSource_HSI48) || ((SOURCE) == RCC_PLLSource_HSI) || \
   ((SOURCE) == RCC_PLLSource_HSE) || ((SOURCE) == RCC_PLLSource_PREDIV1))
/**
 * @}
 */
...
#define RCC_SYSCLKSource_HSI48 \
  RCC_CFGR_SW_HSI48 /*!< Only applicable for STM32F072 devices */
...
Proper ADC clock selection is done within ADC driver by mean of the
ADC_ClockModeConfig() function */
...
#define IS_RCC_CECCLK(CECCLK) \
  (((CECCLK) == RCC_CECCLK_HSI_Div244) || ((CECCLK) == RCC_CECCLK_LSE))
...
#define IS_RCC_I2CCLK(I2CCLK) \
  (((I2CCLK) == RCC_I2C1CLK_HSI) || ((I2CCLK) == RCC_I2C1CLK_SYSCLK))
...
#define IS_RCC_USBCLK(USBCLK) \
  (((USBCLK) == RCC_USBCLK_HSI48) || ((USBCLK) == RCC_USBCLK_PLLCLK))
...
#define RCC_USART2CLK_PCLK                                                \
  ((uint32_t)0x20000000) /*!< Only applicable for STM32F072 and STM32F091 \
                            devices */
#define RCC_USART2CLK_SYSCLK                                              \
  ((uint32_t)0x20010000) /*!< Only applicable for STM32F072 and STM32F091 \
                            devices */
#define RCC_USART2CLK_LSE                                                 \
  ((uint32_t)0x20020000) /*!< Only applicable for STM32F072 and STM32F091 \
                            devices */
#define RCC_USART2CLK_HSI                                                 \
  ((uint32_t)0x20030000) /*!< Only applicable for STM32F072 and STM32F091 \
                            devices */

#define RCC_USART3CLK_PCLK \
  ((uint32_t)0x30000000) /*!< Only applicable for STM32F091 devices */
#define RCC_USART3CLK_SYSCLK \
  ((uint32_t)0x30040000) /*!< Only applicable for STM32F091 devices */
#define RCC_USART3CLK_LSE \
  ((uint32_t)0x30080000) /*!< Only applicable for STM32F091 devices */
#define RCC_USART3CLK_HSI \
  ((uint32_t)0x300C0000) /*!< Only applicable for STM32F091 devices */

#define IS_RCC_USARTCLK(USARTCLK)                                            \
  (((USARTCLK) == RCC_USART1CLK_PCLK) ||                                     \
...
#define RCC_IT_HSI48RDY \
  ((uint8_t)0x40) /*!< Only applicable for STM32F072 devices */
...
#define RCC_AHBPeriph_GPIOE                                                   \
  RCC_AHBENR_GPIOEEN /*!< Only applicable for STM32F072 and STM32F091 devices \
                      */
...
#define IS_RCC_AHB_PERIPH(PERIPH) \
  ((((PERIPH)&0xFE81FFA8) == 0x00) && ((PERIPH) != 0x00))
...
#define IS_RCC_APB2_PERIPH(PERIPH) \
  ((((PERIPH)&0xFFB8A51E) == 0x00) && ((PERIPH) != 0x00))
...
#define RCC_APB1Periph_TIM2                                            \
  RCC_APB1ENR_TIM2EN /*!< Only applicable for STM32F051, STM32F072 and \
                        STM32F091 devices */
#define RCC_APB1Periph_TIM3 RCC_APB1ENR_TIM3EN
#define RCC_APB1Periph_TIM6 RCC_APB1ENR_TIM6EN
#define RCC_APB1Periph_TIM7 \
  RCC_APB1ENR_TIM7EN /*!< Only applicable for STM32F072 devices */
#define RCC_APB1Periph_TIM14 RCC_APB1ENR_TIM14EN
#define RCC_APB1Periph_WWDG RCC_APB1ENR_WWDGEN
#define RCC_APB1Periph_SPI2 RCC_APB1ENR_SPI2EN
#define RCC_APB1Periph_USART2 RCC_APB1ENR_USART2EN
#define RCC_APB1Periph_USART3                                           \
  RCC_APB1ENR_USART3EN /*!< Only applicable for STM32F072 and STM32F091 \
                          devices */
#define RCC_APB1Periph_USART4                                           \
  RCC_APB1ENR_USART4EN /*!< Only applicable for STM32F072 and STM32F091 \
                          devices */
#define RCC_APB1Periph_USART5 \
  RCC_APB1ENR_USART5EN /*!< Only applicable for STM32F091 devices */
#define RCC_APB1Periph_I2C1 RCC_APB1ENR_I2C1EN
#define RCC_APB1Periph_I2C2 RCC_APB1ENR_I2C2EN
#define RCC_APB1Periph_USB                                                   \
  RCC_APB1ENR_USBEN /*!< Only applicable for STM32F072 and STM32F042 devices \
                     */
#define RCC_APB1Periph_CAN                                            \
  RCC_APB1ENR_CANEN /*!< Only applicable for STM32F072, STM32F042 and \
                       STM32F091 devices */
#define RCC_APB1Periph_CRS                                            \
  RCC_APB1ENR_CRSEN /*!< Only applicable for STM32F072, STM32F042 and \
                       STM32F091 devices */
#define RCC_APB1Periph_PWR RCC_APB1ENR_PWREN
#define RCC_APB1Periph_DAC                                            \
  RCC_APB1ENR_DACEN /*!< Only applicable for STM32F051, STM32F072 and \
                       STM32F091 devices */
#define RCC_APB1Periph_CEC                                                   \
  RCC_APB1ENR_CECEN /*!< Only applicable for STM32F051, STM32F042, STM32F072 \
                       and STM32F091 devices */

#define IS_RCC_APB1_PERIPH(PERIPH) \
  ((((PERIPH)&0x8581B6CC) == 0x00) && ((PERIPH) != 0x00))
/**
 * @}
 */
...
#define RCC_MCOSource_HSI48 \
  ((uint8_t)0x08) /*!< Only applicable for STM32F072 devices */
...
#define RCC_FLAG_HSI48RDY \
  ((uint8_t)0x71) /*!< Only applicable for STM32F072 devices */
...
void RCC_HSI48Cmd(
    FunctionalState NewState); /*!< Only applicable for STM32F072 devices */
...
void RCC_ADCCLKConfig(
    uint32_t RCC_ADCCLK); /* This function is obsolete.
...
void RCC_USBCLKConfig(uint32_t RCC_USBCLK); /*!< Only applicable for STM32F042
