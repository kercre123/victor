 ...
 * @brief    This parameters are only applicable for STM32F051 and STM32F072
 * devices
 * @{
 */
...
#define PWR_WakeUpPin_3 \
  PWR_CSR_EWUP3 /*!< only applicable for STM32F072 devices */
#define PWR_WakeUpPin_4 \
  PWR_CSR_EWUP4 /*!< only applicable for STM32F072 devices */
#define PWR_WakeUpPin_5 \
  PWR_CSR_EWUP5 /*!< only applicable for STM32F072 devices */
#define PWR_WakeUpPin_6 \
  PWR_CSR_EWUP6 /*!< only applicable for STM32F072 devices */
#define PWR_WakeUpPin_7 \
  PWR_CSR_EWUP7 /*!< only applicable for STM32F072 devices */
#define PWR_WakeUpPin_8 \
  PWR_CSR_EWUP8 /*!< only applicable for STM32F072 devices */
#define IS_PWR_WAKEUP_PIN(PIN)                                 \
  (((PIN) == PWR_WakeUpPin_1) || ((PIN) == PWR_WakeUpPin_2) || \
...
void PWR_PVDLevelConfig(
    uint32_t PWR_PVDLevel); /*!< only applicable for STM32F051 and STM32F072
                               devices */
void PWR_PVDCmd(FunctionalState NewState); /*!< only applicable for STM32F051
