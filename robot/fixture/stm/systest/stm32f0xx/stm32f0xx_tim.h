...
typedef struct {
  ...
  uint16_t
      TIM_OutputNState; /*!< Specifies the TIM complementary Output Compare
                           state. This parameter can be a value of @ref
                           TIM_Output_Compare_N_state
                             @note This parameter is valid only for TIM1. */

  uint32_t
      TIM_Pulse; /*!< Specifies the pulse value to be loaded into the Capture
                    Compare Register. This parameter can be a number between
                    0x0000 and 0xFFFF ( or 0xFFFFFFFF for TIM2) */
  ...
  uint16_t
      TIM_OCNIdleState; /*!< Specifies the TIM Output Compare pin state during
...
#define IS_TIM_ALL_PERIPH(PERIPH)                                     \
  (((PERIPH) == TIM1) || ((PERIPH) == TIM2) || ((PERIPH) == TIM3) ||  \
   ((PERIPH) == TIM6) || ((PERIPH) == TIM7) || ((PERIPH) == TIM14) || \
...
#define IS_TIM_LIST2_PERIPH(PERIPH)                                    \
  (((PERIPH) == TIM1) || ((PERIPH) == TIM15) || ((PERIPH) == TIM16) || \
   ((PERIPH) == TIM17))
...
#define IS_TIM_LIST4_PERIPH(PERIPH)                                     \
  (((PERIPH) == TIM1) || ((PERIPH) == TIM2) || ((PERIPH) == TIM3) ||    \
   ((PERIPH) == TIM14) || ((PERIPH) == TIM15) || ((PERIPH) == TIM16) || \
   ((PERIPH) == TIM17))
...
#define IS_TIM_LIST9_PERIPH(PERIPH)                                  \
  (((PERIPH) == TIM1) || ((PERIPH) == TIM2) || ((PERIPH) == TIM3) || \
   ((PERIPH) == TIM6) || ((PERIPH) == TIM7) || ((PERIPH) == TIM15))
...
#define IS_TIM_REMAP(TIM_REMAP)                                     \
  (((TIM_REMAP) == TIM14_GPIO) || ((TIM_REMAP) == TIM14_RTC_CLK) || \
   ((TIM_REMAP) == TIM14_HSEDiv32) || ((TIM_REMAP) == TIM14_MCO))
/**
 * @}
 */
