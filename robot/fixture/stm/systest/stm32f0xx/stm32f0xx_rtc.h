...
typedef struct {
  ...
  uint8_t
      RTC_AlarmDateWeekDay; /*!< Specifies the RTC Alarm Date/WeekDay.
                            This parameter must be set to a value in the 1-31
                            range if the Alarm Date is selected. This parameter
                            can be a value of @ref RTC_WeekDay_Definitions if
                            the Alarm WeekDay is selected. */
} RTC_AlarmTypeDef;
...
#define RTC_AlarmSubSecondMask_All                           \
  ((uint8_t)0x00) /*!< All Alarm SS fields are masked.       \
                       There is no comparison on sub seconds \
                       for Alarm */
#define RTC_AlarmSubSecondMask_SS14_1                   \
  ((uint8_t)0x01) /*!< SS[14:1] are don't care in Alarm \
                       comparison. Only SS[0] is compared. */
#define RTC_AlarmSubSecondMask_SS14_2                   \
  ((uint8_t)0x02) /*!< SS[14:2] are don't care in Alarm \
                       comparison. Only SS[1:0] are compared */
#define RTC_AlarmSubSecondMask_SS14_3                   \
  ((uint8_t)0x03) /*!< SS[14:3] are don't care in Alarm \
                       comparison. Only SS[2:0] are compared */
#define RTC_AlarmSubSecondMask_SS14_4                   \
  ((uint8_t)0x04) /*!< SS[14:4] are don't care in Alarm \
                       comparison. Only SS[3:0] are compared */
#define RTC_AlarmSubSecondMask_SS14_5                   \
  ((uint8_t)0x05) /*!< SS[14:5] are don't care in Alarm \
                       comparison. Only SS[4:0] are compared */
#define RTC_AlarmSubSecondMask_SS14_6                   \
  ((uint8_t)0x06) /*!< SS[14:6] are don't care in Alarm \
                       comparison. Only SS[5:0] are compared */
#define RTC_AlarmSubSecondMask_SS14_7                   \
  ((uint8_t)0x07) /*!< SS[14:7] are don't care in Alarm \
                       comparison. Only SS[6:0] are compared */
#define RTC_AlarmSubSecondMask_SS14_8                   \
  ((uint8_t)0x08) /*!< SS[14:8] are don't care in Alarm \
                       comparison. Only SS[7:0] are compared */
#define RTC_AlarmSubSecondMask_SS14_9                   \
  ((uint8_t)0x09) /*!< SS[14:9] are don't care in Alarm \
                       comparison. Only SS[8:0] are compared */
#define RTC_AlarmSubSecondMask_SS14_10                   \
  ((uint8_t)0x0A) /*!< SS[14:10] are don't care in Alarm \
                       comparison. Only SS[9:0] are compared */
#define RTC_AlarmSubSecondMask_SS14_11                   \
  ((uint8_t)0x0B) /*!< SS[14:11] are don't care in Alarm \
                       comparison. Only SS[10:0] are compared */
#define RTC_AlarmSubSecondMask_SS14_12                   \
  ((uint8_t)0x0C) /*!< SS[14:12] are don't care in Alarm \
                       comparison.Only SS[11:0] are compared */
#define RTC_AlarmSubSecondMask_SS14_13                   \
  ((uint8_t)0x0D) /*!< SS[14:13] are don't care in Alarm \
                       comparison. Only SS[12:0] are compared */
#define RTC_AlarmSubSecondMask_SS14                  \
  ((uint8_t)0x0E) /*!< SS[14] is don't care in Alarm \
                       comparison.Only SS[13:0] are compared */
#define RTC_AlarmSubSecondMask_None                         \
  ((uint8_t)0x0F) /*!< SS[14:0] are compared and must match \
                       to activate alarm. */
...
#define RTC_Output_WakeUp \
  ((uint32_t)0x00600000) /*!< available only for STM32F072 devices */
...
#define RTC_TamperSamplingFreq_RTCCLK_Div16384                      \
  ((uint32_t)0x00000100) /*!< Each of the tamper inputs are sampled \
 ...
 */
#define RTC_Tamper_1                                \
  RTC_TAFCR_TAMP1E /*!< Tamper detection enable for \
                   input tamper 1 */
#define RTC_Tamper_2                                \
  RTC_TAFCR_TAMP2E /*!< Tamper detection enable for \
                   input tamper 2 */
#define RTC_Tamper_3                                \
  RTC_TAFCR_TAMP3E /*!< Tamper detection enable for \
                   input tamper 3, available only   \
                   for STM32F072 devices */
#define IS_RTC_TAMPER(TAMPER) \
  ((((TAMPER) & (uint32_t)0xFFFFFFD6) == 0x00) && ((TAMPER) != (uint32_t)RESET))
...
#define IS_RTC_BKP(BKP)                                \
  (((BKP) == RTC_BKP_DR0) || ((BKP) == RTC_BKP_DR1) || \
   ((BKP) == RTC_BKP_DR2) || ((BKP) == RTC_BKP_DR3) || ((BKP) == RTC_BKP_DR4))
/**
 * @}
 */
...
#define RTC_FLAG_TAMP3F \
  RTC_ISR_TAMP3F /*!< Only available for STM32F072 devices */
...
#define RTC_FLAG_WUTWF \
  RTC_ISR_WUTWF /*!< Only available for STM32F072 devices */
...
#define IS_RTC_CLEAR_FLAG(FLAG) \
  (((FLAG) != (uint32_t)RESET) && (((FLAG)&0xFFFF02DF) == (uint32_t)RESET))
...
#define RTC_IT_WUT \
  ((uint32_t)0x00004000) /* Available only for STM32F072 devices */
...
#define RTC_IT_TAMP3 \
  ((uint32_t)0x00080000) /* Available only for STM32F072 devices */

#define IS_RTC_CONFIG_IT(IT) \
  (((IT) != (uint32_t)RESET) && (((IT)&0xFFFF2FFB) == (uint32_t)RESET))
#define IS_RTC_GET_IT(IT)                                                    \
  (((IT) == RTC_IT_TS) || ((IT) == RTC_IT_ALRA) || ((IT) == RTC_IT_TAMP1) || \
   ((IT) == RTC_IT_WUT) || ((IT) == RTC_IT_TAMP2) || ((IT) == RTC_IT_TAMP3))

#define IS_RTC_CLEAR_IT(IT) \
  (((IT) != (uint32_t)RESET) && (((IT)&0xFFF12FFF) == (uint32_t)RESET))
...
void RTC_WakeUpClockConfig(
    uint32_t RTC_WakeUpClock); /*!< available only for STM32F072 devices */
void RTC_SetWakeUpCounter(
    uint32_t RTC_WakeUpCounter); /*!< available only for STM32F072 devices */
uint32_t RTC_GetWakeUpCounter(
    void); /*!< available only for STM32F072 devices */
ErrorStatus RTC_WakeUpCmd(
    FunctionalState NewState); /*!< available only for STM32F072 devices */
