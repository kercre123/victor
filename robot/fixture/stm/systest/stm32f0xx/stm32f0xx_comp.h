 ...
 *firmware library, applicable only for STM32F051 and STM32F072 devices.
 ******************************************************************************
 * @attention
 *
...
typedef struct {
  uint32_t
      COMP_InvertingInput; /*!< Selects the inverting input of the comparator.
                                 This parameter can be a value of @ref
                              COMP_InvertingInput */

  uint32_t
      COMP_Output; /*!< Selects the output redirection of the comparator.
  ...
  uint32_t
      COMP_Hysteresis; /*!< Selects the hysteresis voltage of the comparator.
                             This parameter can be a value of @ref
                          COMP_Hysteresis */
...
#define COMP_InvertingInput_1_4VREFINT                                      \
  ((uint32_t)0x00000000) /*!< 1/4 VREFINT connected to comparator inverting \
                            input */
#define COMP_InvertingInput_1_2VREFINT                                     \
  COMP_CSR_COMP1INSEL_0 /*!< 1/2 VREFINT connected to comparator inverting \
                           input */
#define COMP_InvertingInput_3_4VREFINT                                     \
  COMP_CSR_COMP1INSEL_1 /*!< 3/4 VREFINT connected to comparator inverting \
                           input */
#define COMP_InvertingInput_VREFINT                                           \
  ((uint32_t)0x00000030) /*!< VREFINT connected to comparator inverting input \
                          */
#define COMP_InvertingInput_DAC1                                              \
  COMP_CSR_COMP1INSEL_2 /*!< DAC1_OUT (PA4) connected to comparator inverting \
                           input */
#define COMP_InvertingInput_DAC2                                               \
  ((uint32_t)0x00000050) /*!< DAC2_OUT (PA5) connected to comparator inverting \
                            input, applicable only for STM32F072 devices */
#define COMP_InvertingInput_IO                                                \
  ((uint32_t)0x00000060) /*!< I/O (PA0 for COMP1 and PA2 for COMP2) connected \
...
#define COMP_Output_None                                                       \
  ((uint32_t)0x00000000) /*!< COMP output isn't connected to other peripherals \
                          */
#define COMP_Output_TIM1BKIN                                                   \
  COMP_CSR_COMP1OUTSEL_0 /*!< COMP output connected to TIM1 Break Input (BKIN) \
                          */
#define COMP_Output_TIM1IC1 \
  COMP_CSR_COMP1OUTSEL_1 /*!< COMP output connected to TIM1 Input Capture 1 */
#define COMP_Output_TIM1OCREFCLR \
  ((uint32_t)0x00000300) /*!< COMP output connected to TIM1 OCREF Clear */
#define COMP_Output_TIM2IC4 \
  COMP_CSR_COMP1OUTSEL_2 /*!< COMP output connected to TIM2 Input Capture 4 */
#define COMP_Output_TIM2OCREFCLR \
  ((uint32_t)0x00000500) /*!< COMP output connected to TIM2 OCREF Clear */
#define COMP_Output_TIM3IC1 \
  ((uint32_t)0x00000600) /*!< COMP output connected to TIM3 Input Capture 1 */
#define COMP_Output_TIM3OCREFCLR \
  COMP_CSR_COMP1OUTSEL /*!< COMP output connected to TIM3 OCREF Clear */

#define IS_COMP_OUTPUT(OUTPUT)                                             \
  (((OUTPUT) == COMP_Output_None) || ((OUTPUT) == COMP_Output_TIM1BKIN) || \
...
#define COMP_OutputPol_NonInverted \
  ((uint32_t)0x00000000) /*!< COMP output on GPIO isn't inverted */
#define COMP_OutputPol_Inverted \
  COMP_CSR_COMP1POL /*!< COMP output on GPIO is inverted */

#define IS_COMP_OUTPUT_POL(POL) \
  (((POL) == COMP_OutputPol_NonInverted) || ((POL) == COMP_OutputPol_Inverted))
...
#define COMP_Hysteresis_Medium \
  COMP_CSR_COMP1HYST_1                          /*!< Hysteresis level medium */
...
#define IS_COMP_MODE(MODE)                                                  \
  (((MODE) == COMP_Mode_UltraLowPower) || ((MODE) == COMP_Mode_LowPower) || \
