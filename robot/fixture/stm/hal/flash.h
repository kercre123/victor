...
// The first 128KB of the binary must contain all the code - we keep a backup in
// B to prevent bricked updates This could have been 768KB, since we never used
// 0x08020000
