...
typedef struct {
  uint16_t
      DCMI_CaptureMode; /*!< Specifies the Capture Mode: Continuous or Snapshot.
  ...
  uint16_t DCMI_CaptureRate; /*!< Specifies the frequency of frame capture: All,
                                1/2 or 1/4. This parameter can be a value of
                                @ref DCMI_Capture_Rate */
...
typedef struct {
  uint16_t DCMI_VerticalStartLine; /*!< Specifies the Vertical start line count
                                      from which the image capture will start.
  ...
  uint16_t DCMI_VerticalLineCount; /*!< Specifies the number of lines to be
                                      ...
                                      parameter can be a value between 0x00 and
                                      0x3FFF */
