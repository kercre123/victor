...
MENU_ITEMS(TX7) = {
  MENU_BACK(Main),
  MENU_SHELL("STOP", "STOP"),
  MENU_SHELL("TX 11n  @ 2442MHz", "MCS_65_MBPS 7"),
  MENU_SHELL("TX 11g  @ 2442MHz", "11A_54_MBPS 7"),
  MENU_SHELL("TX 11b  @ 2442MHz", "11B_LONG_11_MBPS 7"),
  MENU_SHELL("Carrier @ 2442MHz", "CW 7"),
