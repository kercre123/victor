...
MENU_ITEMS(TX13) = {
  MENU_BACK(Main),
  MENU_SHELL("STOP", "STOP"),
  MENU_SHELL("TX 11n  @ 2462MHz", "MCS_65_MBPS 13"),
  MENU_SHELL("TX 11g  @ 2462MHz", "11A_54_MBPS 13"),
  MENU_SHELL("TX 11b  @ 2462MHz", "11B_LONG_11_MBPS 13"),
  MENU_SHELL("Carrier @ 2462MHz", "CW 13"),
};
MENU_CREATE(TX13);
