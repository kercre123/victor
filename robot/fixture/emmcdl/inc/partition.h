...
$Header:
//source/qcom/qct/platform/uefi/workspaces/pweber/apps/8x26_emmcdl/emmcdl/main/latest/inc/partition.h#5
...
class Partition : public XMLParser {
 ...
 private:
  ...
  int ParseXMLInt64(char *line, const char *key, __uint64_t &value,
                    PartitionEntry *pe) const;
