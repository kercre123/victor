...
#define APP_DIS_FEATURES                                        \
  (DIS_MANUFACTURER_NAME_CHAR_SUP | DIS_MODEL_NB_STR_CHAR_SUP | \
   DIS_SYSTEM_ID_CHAR_SUP | DIS_SW_REV_STR_CHAR_SUP |           \
   DIS_FIRM_REV_STR_CHAR_SUP | DIS_PNP_ID_CHAR_SUP)
...
/**
 ****************************************************************************************
 * @brief Send Read rssi request to GAPC task instance for the current
 *connection.
 *
 * @return void.
 ****************************************************************************************
...
/**
 ****************************************************************************************
 * @brief Send disconnect request to GAPC task instance for the current
 *connection.
 *
 * @return void.
 ****************************************************************************************
