...
typedef enum { GPIO_ACTIVE_HIGH = 1, GPIO_ACTIVE_LOW = 0 } GPIO_POLARITY;
...
/*************************************************************************************
 * Define CFG_AUDIO439_ADAPTIVE_RATE to enable dynamic * sampling rate and ADPCM
 *configuration                                             *
 *************************************************************************************/
//#define CFG_AUDIO439_ADAPTIVE_RATE

/*************************************************************************************
 * Define CFG_AUDIO439_IMA_ADPCM to use IMA ADPCM encoding. * If not defined
 *aLaw encoding will be used                                        *
 *************************************************************************************/
...
/*************************************************************************************
 * 0: 64 Kbit/s = ima 4Bps, 16 Khz. * 1: 48 Kbit/s = ima 3Bps, 16 Khz. * 2: 32
 *Kbit/s = ima 4Bps, 8 Khz (downsample).                                      *
 * 3: 24 Kbit/s = ima 3Bps, 8 Khz (downsample). * do not use enum. Enums are not
 ...
 ** VDDIO power
 ** AUDIO_VDDIO_CONTROL_PORT, AUDIO_VDDIO_CONTROL_PIN,
 *AUDIO_VDDIO_CONTROL_POLARITY   * must be defined *
 *************************************************************************************/
...
/*************************************************************************************
 * Define HAS_AUDIO_SOFT_START to use a pulse waveform * in order to soft start
 *VDD                                                        *
 *************************************************************************************/
...
#if defined(HAS_AUDIO_MUTE) &&                                \
    (!defined(AUDIO_MUTE_PORT) || !defined(AUDIO_MUTE_PIN) || \
     !defined(AUDIO_MUTE_POLARITY))
#error "AUDIO_MUTE_PORT, AUDIO_MUTE_PIN and AUDIO_MUTE_POLARITY must be defined"
#endif

#if defined(HAS_AUDIO_VDDIO_CONTROL) &&    \
    (!defined(AUDIO_VDDIO_CONTROL_PORT) || \
     !defined(AUDIO_VDDIO_CONTROL_PIN) ||  \
     !defined(AUDIO_VDDIO_CONTROL_POLARITY))
#error \
    "AUDIO_VDDIO_CONTROL_PORT, AUDIO_VDDIO_CONTROL_PIN and AUDIO_VDDIO_CONTROL_POLARITY must be defined"
#endif
