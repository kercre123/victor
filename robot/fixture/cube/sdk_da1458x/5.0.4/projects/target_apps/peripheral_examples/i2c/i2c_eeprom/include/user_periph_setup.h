...
#define UART2_BAUDRATE \
  UART_BAUDRATE_115K2  // Baudrate in bits/s: {9K6, 14K4, 19K2, 28K8, 38K4,
                       // 57K6, 115K2}
#define UART2_DATALENGTH UART_CHARFORMAT_8  // Datalength in bits: {5, 6, 7, 8}
#define UART2_PARITY \
  UART_PARITY_NONE  // Parity: {UART_PARITY_NONE, UART_PARITY_EVEN,
                    // UART_PARITY_ODD}
#define UART2_STOPBITS \
  UART_STOPBITS_1  // Stop bits: {UART_STOPBITS_1, UART_STOPBITS_2}
#define UART2_FLOWCONTROL \
  UART_FLOWCONTROL_DISABLED  // Flow control: {UART_FLOWCONTROL_DISABLED,
...
#define I2C_SPEED_MODE \
  I2C_FAST  // Speed mode: I2C_STANDARD (100 kbits/s), I2C_FAST (400 kbits/s)
#define I2C_ADDRESS_MODE \
  I2C_7BIT_ADDR  // Addressing mode: {I2C_7BIT_ADDR, I2C_10BIT_ADDR}
#define I2C_ADDRESS_SIZE \
  I2C_2BYTES_ADDR  // Address width: {I2C_1BYTE_ADDR, I2C_2BYTES_ADDR,
                   // I2C_3BYTES_ADDR}
