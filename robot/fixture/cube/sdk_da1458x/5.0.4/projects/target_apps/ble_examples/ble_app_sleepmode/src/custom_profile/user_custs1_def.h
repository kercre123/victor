...
#define DEF_CUST1_SVC_UUID_128                                              \
  {                                                                         \
    0x2F, 0x2A, 0x93, 0xA6, 0xBD, 0xD8, 0x41, 0x52, 0xAC, 0x0B, 0x10, 0x99, \
        0x2E, 0xC6, 0xFE, 0xED                                              \
  }

#define DEF_CUST1_CTRL_POINT_UUID_128                                       \
  {                                                                         \
...
#define DEF_CUST1_LED_STATE_UUID_128                                        \
  {                                                                         \
    0x4F, 0x43, 0x31, 0x3C, 0x93, 0x92, 0x42, 0xE6, 0xA8, 0x76, 0xFA, 0x3B, \
        0xEF, 0xB4, 0x87, 0x5A                                              \
  }
#define DEF_CUST1_ADC_VAL_1_UUID_128                                        \
  {                                                                         \
    0x17, 0xB9, 0x67, 0x98, 0x4C, 0x66, 0x4C, 0x01, 0x96, 0x33, 0x31, 0xB1, \
        0x91, 0x59, 0x00, 0x15                                              \
  }
#define DEF_CUST1_ADC_VAL_2_UUID_128                                        \
  {                                                                         \
    0x23, 0x68, 0xEC, 0x52, 0x1E, 0x62, 0x44, 0x74, 0x9A, 0x1B, 0xD1, 0x8B, \
        0xAB, 0x75, 0xB6, 0x6E                                              \
  }
#define DEF_CUST1_BUTTON_STATE_UUID_128                                     \
  {                                                                         \
    0x9E, 0xE7, 0xBA, 0x08, 0xB9, 0xA9, 0x48, 0xAB, 0xA1, 0xAC, 0x03, 0x1C, \
        0x2E, 0x0D, 0x29, 0x6C                                              \
  }
#define DEF_CUST1_INDICATEABLE_UUID_128                                     \
  {                                                                         \
    0x28, 0xD5, 0xE1, 0xC1, 0xE1, 0xC5, 0x47, 0x29, 0xB5, 0x57, 0x65, 0xC3, \
        0xBA, 0x47, 0x15, 0x9E                                              \
  }
#define DEF_CUST1_LONG_VALUE_UUID_128                                       \
  {                                                                         \
