...
#define USER_ADVERTISE_DATA                                                  \
  "\x09" ADV_TYPE_COMPLETE_LIST_16BIT_SERVICE_IDS ADV_UUID_LINK_LOSS_SERVICE \
      ADV_UUID_IMMEDIATE_ALERT_SERVICE ADV_UUID_TX_POWER_SERVICE             \
...
#define USER_ADVERTISE_SCAN_RESPONSE_DATA                                 \
  "\x0a" ADV_TYPE_MANUFACTURER_SPECIFIC_DATA ADV_DIALOG_MANUFACTURER_CODE \
  "DLG-BLE"
...
static const struct default_handlers_configuration user_default_hnd_conf = {
    ...
    // It is measured in timer units (3 min). Use MS_TO_TIMERUNITS macro to
    // convert
...
static const struct security_configuration user_security_conf = {
     ...
     *encryption)
     * - GAP_SEC1_NOAUTH_PAIR_ENC         Unauthenticated pairing with
     *encryption
     * - GAP_SEC1_AUTH_PAIR_ENC           Authenticated pairing with encryption
     * - GAP_SEC2_NOAUTH_DATA_SGN         Unauthenticated pairing with data
     *signing
     * - GAP_SEC2_AUTH_DATA_SGN           Authentication pairing with data
     *signing
