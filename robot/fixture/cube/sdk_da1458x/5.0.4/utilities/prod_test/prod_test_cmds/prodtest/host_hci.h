...
bool __stdcall hci_dialog_tx_test(uint8_t frequency, uint8_t length,
                                  uint8_t payload, uint16_t number_of_packets);
...
bool __stdcall hci_dialog_tx_continuous_start(uint8_t frequency,
                                              uint8_t payload_type);
bool __stdcall hci_dialog_tx_continuous_end();
bool __stdcall hci_dialog_sleep(uint8_t sleep_type, uint8_t minutes,
                                uint8_t seconds);
bool __stdcall hci_dialog_xtal_trimming(uint8_t operation,
                                        uint16_t trim_value_or_delta);
...
bool __stdcall hci_dialog_otp_write(uint16_t otp_address, uint32_t *words,
                                    uint8_t word_count);
