...
#define SPI_POL_MODE \
  SPI_CLK_INIT_HIGH  // 0: SPI clk initially low, 1: SPI clk initially high
#define SPI_PHA_MODE \
  SPI_PHASE_1  // If same with SPI_POL_MODE, data are valid on clk high edge,
               // else on low
#define SPI_MINT_EN \
  SPI_NO_MINT  // (SPI interrupt to the ICU) 0: Disabled, 1: Enabled
#define SPI_CLK_DIV \
  SPI_XTAL_DIV_2  // (SPI clock divider) 0: 8, 1: 4, 2: 2, 3: 14

// UART
// init values
#define UART_PIN_PAIR \
  4  //(0:(P0_0 , P0_1),2:(P0_2 , P0_3),4:(P0_4 , P0_5),6:(P0_6 , P0_7))
