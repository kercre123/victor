 ...
 ****************************************************************************************
 */
__INLINE struct gapc_disconnect_cmd* app_disconnect_msg_create(
    uint8_t connection_idx) {
  struct gapc_disconnect_cmd* cmd =
      KE_MSG_ALLOC(GAPC_DISCONNECT_CMD, KE_BUILD_ID(TASK_GAPC, connection_idx),
 ...
 ****************************************************************************************
 */
__INLINE struct gapc_connection_cfm* app_connect_cfm_msg_create(
    uint8_t connection_idx) {
  // confirm connection
  struct gapc_connection_cfm* cfm =
      KE_MSG_ALLOC(GAPC_CONNECTION_CFM, KE_BUILD_ID(TASK_GAPC, connection_idx),
 ...
 ****************************************************************************************
 */
__INLINE void app_advertise_start_msg_send(
 ...
 ****************************************************************************************
 */
__INLINE struct gapc_param_update_cmd* app_param_update_msg_create(
    uint8_t connection_idx) {
  struct gapc_param_update_cmd* cmd = KE_MSG_ALLOC(
      GAPC_PARAM_UPDATE_CMD, KE_BUILD_ID(TASK_GAPC, connection_idx), TASK_APP,
 ...
 ****************************************************************************************
 */
__INLINE void app_connect_start_msg_send(
 ...
 ****************************************************************************************
 */
__INLINE struct gapc_bond_cfm* app_gapc_bond_cfm_msg_create(
    uint8_t connection_idx) {
  struct gapc_bond_cfm* cmd =
      KE_MSG_ALLOC(GAPC_BOND_CFM, KE_BUILD_ID(TASK_GAPC, connection_idx),
                   TASK_APP, gapc_bond_cfm);
  return cmd;
}
 ...
 ****************************************************************************************
 */
__INLINE struct gapc_bond_cfm* app_gapc_bond_cfm_pairing_rsp_msg_create(
    uint8_t connection_idx) {
 ...
 ****************************************************************************************
 */
__INLINE void app_gapc_bond_cfm_pairing_rsp_msg_send(
    struct gapc_bond_cfm* cmd) {
  ke_msg_send(cmd);
}
 ...
 ****************************************************************************************
 */
__INLINE struct gapc_bond_cfm* app_gapc_bond_cfm_tk_exch_msg_create(
    uint8_t connection_idx) {
  struct gapc_bond_cfm* cmd = app_gapc_bond_cfm_msg_create(connection_idx);
 ...
 ****************************************************************************************
 */
__INLINE struct gapc_bond_cfm* app_gapc_bond_cfm_csrk_exch_msg_create(
    uint8_t connection_idx) {
  struct gapc_bond_cfm* cmd = app_gapc_bond_cfm_msg_create(connection_idx);
 ...
 ****************************************************************************************
 */
__INLINE struct gapc_bond_cfm* app_gapc_bond_cfm_ltk_exch_msg_create(
    uint8_t connection_idx) {
  struct gapc_bond_cfm* cmd = app_gapc_bond_cfm_msg_create(connection_idx);
 ...
 ****************************************************************************************
 */
__INLINE struct gapc_encrypt_cfm* app_gapc_encrypt_cfm_msg_create(
    uint8_t connection_idx) {
  struct gapc_encrypt_cfm* cmd =
      KE_MSG_ALLOC(GAPC_ENCRYPT_CFM, KE_BUILD_ID(TASK_GAPC, connection_idx),
 ...
 ****************************************************************************************
 */
__INLINE struct gapc_security_cmd* app_gapc_security_request_msg_create(
    uint8_t connection_idx, enum gap_auth auth) {
  struct gapc_security_cmd* cmd =
      KE_MSG_ALLOC(GAPC_SECURITY_CMD, KE_BUILD_ID(TASK_GAPC, connection_idx),
 ...
 ****************************************************************************************
 */
__INLINE void app_gapc_security_request_msg_send(
    struct gapc_security_cmd* cmd) {
  ke_msg_send(cmd);
}
 ...
 * @param[in] reason The reason for the disconnection. Could be one of the
 *following: CO_ERROR_AUTH_FAILURE, CO_ERROR_REMOTE_USER_TERM_CON,
 *CO_ERROR_REMOTE_DEV_TERM_LOW_RESOURCES, CO_ERROR_REMOTE_DEV_POWER_OFF,
 *CO_ERROR_UNSUPPORTED_REMOTE_FEATURE, CO_ERROR_PAIRING_WITH_UNIT_KEY_NOT_SUP,
 ...
 ****************************************************************************************
 */
__INLINE void app_connect_confirm_op(uint8_t connection_id, enum gap_auth auth,
 ...
 * @param[in] address_src_type The source address type used during the advertize
 operation.
 * @param[in] interval The advertise interval.
 * @param[in] channel_map The channels used during the advertise operation.
 * @param[in] advertise_mode The advertising mode: GAP_NON_DISCOVERABLE,
 GAP_GEN_DISCOVERABLE, GAP_LIM_DISCOVERABLE, GAP_BROADCASTER_MODE
 * @param[in] adv_filt_policy The advertising filter policy:
 ADV_ALLOW_SCAN_ANY_CON_ANY, ADV_ALLOW_SCAN_WLST_CON_ANY,
 ADV_ALLOW_SCAN_ANY_CON_WLST, ADV_ALLOW_SCAN_WLST_CON_WLST
 ...
 * @param[in] scan_response_data Pointer to an array with the scan response
 data.
 * @param[in] scan_response_data_len The length of the scan response data.
 * @return void
 ****************************************************************************************
 */
__INLINE void app_advertise_undirected_start_op(
    enum gapm_own_addr_src address_src_type, uint16_t interval,
    uint8_t channel_map, enum gap_adv_mode advertise_mode,
    enum adv_filter_policy adv_filt_policy, uint8_t* advertise_data,
    uint8_t advertise_data_len, uint8_t* scan_response_data,
 ...
 ****************************************************************************************
 */
__INLINE void app_advertise_directed_start_op(
    enum gapm_own_addr_src address_src_type, uint16_t interval,
    uint8_t channel_map, enum address_type target_address_type,
 ...
 * @param[in] intv_min The new preferred minimum connection interval measured
 *in 1.25 ms slots.
 * @param[in] intv_max The new preferred maximum connection interval measured
 *in 1.25 ms slots.
 * @param[in] connection_event_len_min The new preferred minimum connection
 *event length measured in 1.25 ms slots.
 * @param[in] connection_event_len_max The new preferred maximum connection
 *event length measured in 1.25 ms slots.
 * @return void
 ****************************************************************************************
 */
__INLINE void app_param_update_op(uint8_t connection_idx, uint16_t intv_min,
                                  uint16_t intv_max, uint16_t latency,
  ...
  struct gapc_param_update_cmd* cmd =
      app_param_update_msg_create(connection_idx);
#ifndef __DA14581__
 ...
 * @param[in] connection_idx The id of the connection.
 * @param[in] latency The slave latency measured in connection event periods.
 * @param[in] intv_min_us The new preferred minimum connection interval measured
 *in us.
 * @param[in] intv_max_us The new preferred maximum connection interval measured
 *in us.
 * @param[in] connection_event_len_min_us The new preferred minimum connection
 *event length measured in us.
 * @param[in] connection_event_len_max_us The new preferred maximum connection
 *event length measured in us.
 * @return void
 ****************************************************************************************
 */

__INLINE void app_param_update_op_us(uint8_t connection_idx,
                                     uint32_t intv_min_us, uint32_t intv_max_us,
                                     uint16_t latency,
                                     uint32_t supervision_time_out_us,
                                     uint32_t connection_event_len_min_us,
                                     uint32_t connection_event_len_max_us) {
  app_param_update_op(connection_idx, (uint16_t)US_TO_DOUBLESLOTS(intv_min_us),
                      (uint16_t)US_TO_DOUBLESLOTS(intv_max_us), latency,
 ...
 * @param[in] role The role of the device: GAP_NO_ROLE, GAP_OBSERVER_SCA,
 *GAP_BROADCASTER_ADV, GAP_CENTRAL_MST, GAP_PERIPHERAL_SLV
 * @param[in] irk Pointer to an array that contains the device Identity Root Key
 *(IRK) .
 ...
 * @param[in] connection_intv_min Preferred minimum connection interval measured
 *in 1.25 ms slots.
 * @param[in] connection_intv_max Preferred maximum connection interval measured
 *in 1.25 ms slots.
 * @param[in] connection_latency Preferred slave latency measured in connection
 *events.
 * @param[in] supervision_timeout Preferred supervision timeout measured in 10
 *ms slots.
 * @param[in] flags Privacy settings.
 * Privacy settings bit field (0b1 = enabled, 0b0 = disabled)
 * - [bit 0]: Privacy Support
 * - [bit 1]: Multiple Bond Support (Peripheral only); If enabled, privacy flag
 *is read only.
 * - [bit 2]: Reconnection address visible.*
 * @return void
 ****************************************************************************************
 */
__INLINE void app_gapm_configure_op(
    enum gap_role role, uint8_t* irk, uint16_t appearance,
    enum gapm_write_att_perm appearance_write_perm,
    enum gapm_write_att_perm name_write_perm, uint16_t max_mtu,
    uint16_t connection_intv_min, uint16_t connection_intv_max,
 ...
 *(IRK) .
 * @param[in] appearance The device appearance fill in according to
 * https://developer.bluetooth.org/gatt/characteristics/Pages/CharacteristicViewer.aspx?u=org.bluetooth.characteristic.gap.appearance.xmlThe
 *new preferred minimum connection interval measured in us.
 * @param[in] appearance_write_perm Appearance write permission requirement.
 * @param[in] name_write_perm Name write permission requirement.
 * @param[in] max_mtu Maximum mtu supported.
 * @param[in] connection_intv_min Preferred minimum connection interval measured
 ...
 ****************************************************************************************
 */
__INLINE void app_gapm_configure_op_us(
    enum gap_role role, uint8_t* irk, uint16_t appearance,
    enum gapm_write_att_perm appearance_write_perm,
    enum gapm_write_att_perm name_write_perm, uint16_t max_mtu,
    uint32_t connection_intv_min_us, uint32_t connection_intv_max_us,
    uint16_t connection_latency, uint32_t supervision_timeout_us,
    uint8_t flags) {
  app_gapm_configure_op(
      role, irk, appearance, appearance_write_perm, name_write_perm, max_mtu,
      (uint16_t)US_TO_DOUBLESLOTS(connection_intv_min_us),
      (uint16_t)US_TO_DOUBLESLOTS(connection_intv_max_us), connection_latency,
      (uint16_t)US_TO_TIMERUNITS(supervision_timeout_us), flags);
}
 ...
 ****************************************************************************************
 */
__INLINE void app_security_request_op(uint8_t connection_idx,
                                      enum gap_auth auth) {
  // Send security request command
  struct gapc_security_cmd* cmd =
      app_gapc_security_request_msg_create(connection_idx, auth);
 ...
 * @param[in] connection_idx The id of the connection.
 * @param[in] io_capabilities Device capabilities: GAP_IO_CAP_DISPLAY_ONLY,
 *GAP_IO_CAP_DISPLAY_YES_NO, GAP_IO_CAP_KB_ONLY, GAP_IO_CAP_NO_INPUT_NO_OUTPUT,
 *GAP_IO_CAP_KB_DISPLAY.
 * @param[in] oob Out of band info: GAP_OOB_AUTH_DATA_NOT_PRESENT,
 *GAP_OOB_AUTH_DATA_PRESENT
 * @param[in] authentication The authentication requirements.
 * @param[in] key_size The key size.
 * @param[in] initiator_key_dist Initiator key distriburion flags:
 *GAP_KDIST_NONE, GAP_KDIST_ENCKEY, GAP_KDIST_IDKEY, GAP_KDIST_SIGNKEY
 * @param[in] responder_key_dist Responder key distriburion flags:
 *GAP_KDIST_NONE, GAP_KDIST_ENCKEY, GAP_KDIST_IDKEY, GAP_KDIST_SIGNKEY
 * @param[in] security_requirements Security definition.
 * @return void
 ****************************************************************************************
 */
__INLINE void app_gapc_bond_cfm_pairing_rsp_op(
    uint8_t connection_idx, enum gap_io_cap io_capabilities, enum gap_oob oob,
    enum gap_auth authentication, uint8_t key_size,
    enum gap_kdist initiator_key_dist, enum gap_kdist responder_key_dist,
    enum gap_sec_req security_requirements) {
 ...
 ****************************************************************************************
 */
__INLINE void app_gapc_bond_cfm_tk_exch_op(uint8_t connection_idx,
                                           uint8_t* temporary_key) {
  struct gapc_bond_cfm* cmd =
      app_gapc_bond_cfm_tk_exch_msg_create(connection_idx);
 ...
 ****************************************************************************************
 */
__INLINE void app_gapc_bond_cfm_csrk_exch_op(uint8_t connection_idx,
                                             uint8_t* csrk) {
  struct gapc_bond_cfm* cmd =
      app_gapc_bond_cfm_csrk_exch_msg_create(connection_idx);
 ...
 ****************************************************************************************
 */
__INLINE void app_gapc_bond_cfm_ltk_exch_op(uint8_t connection_idx,
                                            uint8_t* long_term_key,
                                            uint8_t encryption_key_size,
                                            uint8_t* random_number,
                                            uint16_t encryption_diversifier) {
  struct gapc_bond_cfm* cmd =
      app_gapc_bond_cfm_ltk_exch_msg_create(connection_idx);
 ...
 ****************************************************************************************
 */
__INLINE void app_gapc_encrypt_cfm_op(uint8_t connection_idx, bool found,
                                      uint8_t key_size,
                                      uint8_t* long_term_key) {
  struct gapc_encrypt_cfm* cmd =
      app_gapc_encrypt_cfm_msg_create(connection_idx);
  cmd->found = found;
  if (found == true) {
