...
#define BLE_TX_BUFFER_CNT \
  (BLE_TX_BUFFER_DATA + BLE_TX_BUFFER_CNTL + BLE_TX_BUFFER_ADV)
...
#if defined(CFG_PRF_ACCEL) || defined(CFG_PRF_PXPR) ||           \
    defined(CFG_APP_KEYBOARD) || defined(CFG_PRF_STREAMDATAH) || \
    defined(CFG_PRF_SPOTAR)
...
#ifndef __DA14581__
#define BLE_APP_TASK_SIZE                                                   \
  (BLE_APP_PRESENT + BLE_APP_SEC + BLE_APP_HT + BLE_APP_NEB + BLE_APP_HID + \
   BLE_APP_DIS + BLE_APP_BATT + BLE_APP_ACCEL)
#else
...
#define KE_TASK_SIZE                                                        \
  (DISPLAY_TASK_SIZE + DEBUG_TASK_SIZE + TL_TASK_SIZE + BLE_APP_TASK_SIZE + \
   BLE_TASK_SIZE_ + BLEHL_TASK_SIZE_)
