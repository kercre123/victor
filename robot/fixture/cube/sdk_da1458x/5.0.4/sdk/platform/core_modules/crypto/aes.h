...
int aes_operation(unsigned char *key, int key_len, unsigned char *in,
                  int in_len, unsigned char *out, int out_len, int operation,
                  void (*aes_done_cb)(uint8_t status), unsigned char ble_flags);
 ...
 ****************************************************************************************
 */
void aes_send_cmp_evt(ke_task_id_t cmd_src_id, uint8_t operation,
                      uint8_t status);
