...
#define CO_ERROR_ROLE_SWITCH_PEND \
  0x32 /* LM_ROLE_SWITCH_PENDING               */
#define CO_ERROR_RESERVED_SLOT_VIOLATION \
  0x34 /* LM_RESERVED_SLOT_VIOLATION           */
#define CO_ERROR_ROLE_SWITCH_FAIL \
...
#define CO_ERROR_MASTER_KEY_SLAVE \
  0x80 /* MasterLink not allowed because slave */
#define CO_ERROR_CONNECTION_FILTERED \
  0x83 /* Connection Filtered by the HCI       */
