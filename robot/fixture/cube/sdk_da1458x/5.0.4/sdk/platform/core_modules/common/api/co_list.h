 ...
 */
/// list type
enum { POOL_LINKED_LIST = 0x00, RING_LINKED_LIST, LINK_TYPE_END };
...
/**
 ****************************************************************************************
 * @brief Initialize a pool to default values, and initialize the relative free
 *list.
 *
 * @param list           Pointer to the list structure
 ...
 * @param default_value  Pointer to the default value of each element (may be
 *NULL)
 ...
 *
 * @param list           Pointer to the list structure
 * @param list_hdr       Pointer to the header to add at the beginning of the
 *list
 ****************************************************************************************
 */
 ...
 *
 * @return CO_EMPTY if the list is empty, CO_FAIL if the element not found in
 *the list, CO_OK else.
 ****************************************************************************************
 */
 ...
 *
 * This function appends the list pointed by list2 to the list pointed by list1.
 *Once the merge is done, it empties list2.
 *
 ...
 ****************************************************************************************
 */
__INLINE struct co_list_hdr *co_list_next(
    const struct co_list_hdr *const list_hdr) {
