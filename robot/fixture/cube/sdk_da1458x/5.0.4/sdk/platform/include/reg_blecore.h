...
__INLINE void ble_rwbtlecntl_pack(
    uint8_t mastersoftrst, uint8_t mastertgsoftrst, uint8_t regsoftrst,
    uint8_t rftestabort, uint8_t advertabort, uint8_t scanabort, uint8_t mddsb,
    uint8_t sndsb, uint8_t nesndsb, uint8_t cryptdsb, uint8_t whitdsb,
    uint8_t crcdsb, uint8_t hopremapdsb, uint8_t corrmode, uint8_t txwinoffsel,
    uint8_t rxdescptrsel, uint8_t adverrfilten, uint8_t wlsyncen,
    uint8_t rwbleen, uint8_t rxwinszdef, uint8_t syncerr) {
  ASSERT_ERR((((uint32_t)mastersoftrst << 31) & ~((uint32_t)0x80000000)) == 0);
  ASSERT_ERR((((uint32_t)mastertgsoftrst << 30) & ~((uint32_t)0x40000000)) ==
             0);
  ...
  REG_BLE_WR(
      BLE_RWBTLECNTL_ADDR,
      ((uint32_t)mastersoftrst << 31) | ((uint32_t)mastertgsoftrst << 30) |
          ((uint32_t)regsoftrst << 29) | ((uint32_t)rftestabort << 26) |
          ((uint32_t)advertabort << 25) | ((uint32_t)scanabort << 24) |
          ((uint32_t)mddsb << 22) | ((uint32_t)sndsb << 21) |
          ((uint32_t)nesndsb << 20) | ((uint32_t)cryptdsb << 19) |
          ((uint32_t)whitdsb << 18) | ((uint32_t)crcdsb << 17) |
          ((uint32_t)hopremapdsb << 16) | ((uint32_t)corrmode << 14) |
          ((uint32_t)txwinoffsel << 12) | ((uint32_t)rxdescptrsel << 11) |
          ((uint32_t)adverrfilten << 10) | ((uint32_t)wlsyncen << 9) |
          ((uint32_t)rwbleen << 8) | ((uint32_t)rxwinszdef << 4) |
          ((uint32_t)syncerr << 0));
}

__INLINE void ble_rwbtlecntl_unpack(
    uint8_t* mastersoftrst, uint8_t* mastertgsoftrst, uint8_t* regsoftrst,
    uint8_t* rftestabort, uint8_t* advertabort, uint8_t* scanabort,
    uint8_t* mddsb, uint8_t* sndsb, uint8_t* nesndsb, uint8_t* cryptdsb,
    uint8_t* whitdsb, uint8_t* crcdsb, uint8_t* hopremapdsb, uint8_t* corrmode,
    uint8_t* txwinoffsel, uint8_t* rxdescptrsel, uint8_t* adverrfilten,
    uint8_t* wlsyncen, uint8_t* rwbleen, uint8_t* rxwinszdef,
    uint8_t* syncerr) {
...
__INLINE void ble_master_soft_rst_setf(uint8_t mastersoftrst) {
  ASSERT_ERR((((uint32_t)mastersoftrst << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)mastersoftrst << 31));
}
...
__INLINE void ble_master_tgsoft_rst_setf(uint8_t mastertgsoftrst) {
  ASSERT_ERR((((uint32_t)mastertgsoftrst << 30) & ~((uint32_t)0x40000000)) ==
             0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x40000000)) |
                 ((uint32_t)mastertgsoftrst << 30));
}
...
__INLINE void ble_reg_soft_rst_setf(uint8_t regsoftrst) {
  ASSERT_ERR((((uint32_t)regsoftrst << 29) & ~((uint32_t)0x20000000)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x20000000)) |
                 ((uint32_t)regsoftrst << 29));
}
...
__INLINE void ble_rftest_abort_setf(uint8_t rftestabort) {
  ASSERT_ERR((((uint32_t)rftestabort << 26) & ~((uint32_t)0x04000000)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x04000000)) |
                 ((uint32_t)rftestabort << 26));
}
...
__INLINE void ble_advert_abort_setf(uint8_t advertabort) {
  ASSERT_ERR((((uint32_t)advertabort << 25) & ~((uint32_t)0x02000000)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x02000000)) |
                 ((uint32_t)advertabort << 25));
}
...
__INLINE void ble_scan_abort_setf(uint8_t scanabort) {
  ASSERT_ERR((((uint32_t)scanabort << 24) & ~((uint32_t)0x01000000)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x01000000)) |
                 ((uint32_t)scanabort << 24));
}
...
__INLINE void ble_md_dsb_setf(uint8_t mddsb) {
  ASSERT_ERR((((uint32_t)mddsb << 22) & ~((uint32_t)0x00400000)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x00400000)) |
                 ((uint32_t)mddsb << 22));
}
...
__INLINE void ble_sn_dsb_setf(uint8_t sndsb) {
  ASSERT_ERR((((uint32_t)sndsb << 21) & ~((uint32_t)0x00200000)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x00200000)) |
                 ((uint32_t)sndsb << 21));
}
...
__INLINE void ble_nesn_dsb_setf(uint8_t nesndsb) {
  ASSERT_ERR((((uint32_t)nesndsb << 20) & ~((uint32_t)0x00100000)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x00100000)) |
                 ((uint32_t)nesndsb << 20));
}
...
__INLINE void ble_crypt_dsb_setf(uint8_t cryptdsb) {
  ASSERT_ERR((((uint32_t)cryptdsb << 19) & ~((uint32_t)0x00080000)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x00080000)) |
                 ((uint32_t)cryptdsb << 19));
}
...
__INLINE void ble_whit_dsb_setf(uint8_t whitdsb) {
  ASSERT_ERR((((uint32_t)whitdsb << 18) & ~((uint32_t)0x00040000)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x00040000)) |
                 ((uint32_t)whitdsb << 18));
}
...
__INLINE void ble_crc_dsb_setf(uint8_t crcdsb) {
  ASSERT_ERR((((uint32_t)crcdsb << 17) & ~((uint32_t)0x00020000)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x00020000)) |
                 ((uint32_t)crcdsb << 17));
}
...
__INLINE void ble_hop_remap_dsb_setf(uint8_t hopremapdsb) {
  ASSERT_ERR((((uint32_t)hopremapdsb << 16) & ~((uint32_t)0x00010000)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x00010000)) |
                 ((uint32_t)hopremapdsb << 16));
}
...
__INLINE void ble_corr_mode_setf(uint8_t corrmode) {
  ASSERT_ERR((((uint32_t)corrmode << 14) & ~((uint32_t)0x0000C000)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x0000C000)) |
                 ((uint32_t)corrmode << 14));
}
...
__INLINE void ble_txwinoffsel_setf(uint8_t txwinoffsel) {
  ASSERT_ERR((((uint32_t)txwinoffsel << 12) & ~((uint32_t)0x00001000)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x00001000)) |
                 ((uint32_t)txwinoffsel << 12));
}
...
__INLINE void ble_rxdescptrsel_setf(uint8_t rxdescptrsel) {
  ASSERT_ERR((((uint32_t)rxdescptrsel << 11) & ~((uint32_t)0x00000800)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x00000800)) |
                 ((uint32_t)rxdescptrsel << 11));
}
...
__INLINE void ble_adverrfilt_en_setf(uint8_t adverrfilten) {
  ASSERT_ERR((((uint32_t)adverrfilten << 10) & ~((uint32_t)0x00000400)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x00000400)) |
                 ((uint32_t)adverrfilten << 10));
}
...
__INLINE void ble_wlsync_en_setf(uint8_t wlsyncen) {
  ASSERT_ERR((((uint32_t)wlsyncen << 9) & ~((uint32_t)0x00000200)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x00000200)) |
                 ((uint32_t)wlsyncen << 9));
}
...
__INLINE void ble_rwble_en_setf(uint8_t rwbleen) {
  ASSERT_ERR((((uint32_t)rwbleen << 8) & ~((uint32_t)0x00000100)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x00000100)) |
                 ((uint32_t)rwbleen << 8));
}
...
__INLINE void ble_rxwinszdef_setf(uint8_t rxwinszdef) {
  ASSERT_ERR((((uint32_t)rxwinszdef << 4) & ~((uint32_t)0x000000F0)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x000000F0)) |
...
__INLINE void ble_syncerr_setf(uint8_t syncerr) {
  ASSERT_ERR((((uint32_t)syncerr << 0) & ~((uint32_t)0x00000007)) == 0);
  REG_BLE_WR(BLE_RWBTLECNTL_ADDR,
             (REG_BLE_RD(BLE_RWBTLECNTL_ADDR) & ~((uint32_t)0x00000007)) |
                 ((uint32_t)syncerr << 0));
}
...
__INLINE uint32_t ble_version_get(void) { return REG_BLE_RD(BLE_VERSION_ADDR); }
...
__INLINE void ble_version_unpack(uint8_t* typ, uint8_t* rel, uint8_t* upg,
                                 uint8_t* build) {
...
__INLINE void ble_rwbtleconf_unpack(uint8_t* addwidth, uint8_t* rfif,
                                    uint8_t* clksel, uint8_t* dmmode,
                                    uint8_t* intmode, uint8_t* wlan,
                                    uint8_t* usedbg, uint8_t* usecrypt,
                                    uint8_t* buswidth) {
...
__INLINE uint32_t ble_intcntl_get(void) { return REG_BLE_RD(BLE_INTCNTL_ADDR); }
...
__INLINE void ble_intcntl_pack(uint16_t incscntl, uint8_t cscntdevmsk,
                               uint8_t radiocntlintmsk, uint8_t finetgtimintmsk,
                               uint8_t grosstgtimintmsk, uint8_t errorintmsk,
                               uint8_t cryptintmsk, uint8_t eventintmsk,
                               uint8_t slpintmsk, uint8_t rxintmsk,
                               uint8_t cscntintmsk) {
  ...
  ASSERT_ERR((((uint32_t)grosstgtimintmsk << 6) & ~((uint32_t)0x00000040)) ==
             0);
  ...
  REG_BLE_WR(BLE_INTCNTL_ADDR,
             ((uint32_t)incscntl << 16) | ((uint32_t)cscntdevmsk << 15) |
                 ((uint32_t)radiocntlintmsk << 8) |
                 ((uint32_t)finetgtimintmsk << 7) |
                 ((uint32_t)grosstgtimintmsk << 6) |
                 ((uint32_t)errorintmsk << 5) | ((uint32_t)cryptintmsk << 4) |
                 ((uint32_t)eventintmsk << 3) | ((uint32_t)slpintmsk << 2) |
                 ((uint32_t)rxintmsk << 1) | ((uint32_t)cscntintmsk << 0));
}

__INLINE void ble_intcntl_unpack(uint16_t* incscntl, uint8_t* cscntdevmsk,
                                 uint8_t* radiocntlintmsk,
                                 uint8_t* finetgtimintmsk,
                                 uint8_t* grosstgtimintmsk,
                                 uint8_t* errorintmsk, uint8_t* cryptintmsk,
                                 uint8_t* eventintmsk, uint8_t* slpintmsk,
                                 uint8_t* rxintmsk, uint8_t* cscntintmsk) {
...
__INLINE void ble_incscntl_setf(uint16_t incscntl) {
  ASSERT_ERR((((uint32_t)incscntl << 16) & ~((uint32_t)0xFFFF0000)) == 0);
  REG_BLE_WR(BLE_INTCNTL_ADDR,
             (REG_BLE_RD(BLE_INTCNTL_ADDR) & ~((uint32_t)0xFFFF0000)) |
                 ((uint32_t)incscntl << 16));
}
...
__INLINE void ble_cscntdevmsk_setf(uint8_t cscntdevmsk) {
  ASSERT_ERR((((uint32_t)cscntdevmsk << 15) & ~((uint32_t)0x00008000)) == 0);
  REG_BLE_WR(BLE_INTCNTL_ADDR,
             (REG_BLE_RD(BLE_INTCNTL_ADDR) & ~((uint32_t)0x00008000)) |
                 ((uint32_t)cscntdevmsk << 15));
}
...
__INLINE void ble_radiocntlintmsk_setf(uint8_t radiocntlintmsk) {
  ASSERT_ERR((((uint32_t)radiocntlintmsk << 8) & ~((uint32_t)0x00000100)) == 0);
  REG_BLE_WR(BLE_INTCNTL_ADDR,
             (REG_BLE_RD(BLE_INTCNTL_ADDR) & ~((uint32_t)0x00000100)) |
                 ((uint32_t)radiocntlintmsk << 8));
}
...
__INLINE void ble_finetgtimintmsk_setf(uint8_t finetgtimintmsk) {
  ASSERT_ERR((((uint32_t)finetgtimintmsk << 7) & ~((uint32_t)0x00000080)) == 0);
  REG_BLE_WR(BLE_INTCNTL_ADDR,
             (REG_BLE_RD(BLE_INTCNTL_ADDR) & ~((uint32_t)0x00000080)) |
                 ((uint32_t)finetgtimintmsk << 7));
}
...
__INLINE void ble_grosstgtimintmsk_setf(uint8_t grosstgtimintmsk) {
  ASSERT_ERR((((uint32_t)grosstgtimintmsk << 6) & ~((uint32_t)0x00000040)) ==
             0);
  REG_BLE_WR(BLE_INTCNTL_ADDR,
             (REG_BLE_RD(BLE_INTCNTL_ADDR) & ~((uint32_t)0x00000040)) |
                 ((uint32_t)grosstgtimintmsk << 6));
}
...
__INLINE void ble_errorintmsk_setf(uint8_t errorintmsk) {
  ASSERT_ERR((((uint32_t)errorintmsk << 5) & ~((uint32_t)0x00000020)) == 0);
  REG_BLE_WR(BLE_INTCNTL_ADDR,
             (REG_BLE_RD(BLE_INTCNTL_ADDR) & ~((uint32_t)0x00000020)) |
                 ((uint32_t)errorintmsk << 5));
}
...
__INLINE void ble_cryptintmsk_setf(uint8_t cryptintmsk) {
  ASSERT_ERR((((uint32_t)cryptintmsk << 4) & ~((uint32_t)0x00000010)) == 0);
  REG_BLE_WR(BLE_INTCNTL_ADDR,
             (REG_BLE_RD(BLE_INTCNTL_ADDR) & ~((uint32_t)0x00000010)) |
                 ((uint32_t)cryptintmsk << 4));
}
...
__INLINE void ble_eventintmsk_setf(uint8_t eventintmsk) {
  ASSERT_ERR((((uint32_t)eventintmsk << 3) & ~((uint32_t)0x00000008)) == 0);
  REG_BLE_WR(BLE_INTCNTL_ADDR,
             (REG_BLE_RD(BLE_INTCNTL_ADDR) & ~((uint32_t)0x00000008)) |
                 ((uint32_t)eventintmsk << 3));
}
...
__INLINE void ble_slpintmsk_setf(uint8_t slpintmsk) {
  ASSERT_ERR((((uint32_t)slpintmsk << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_BLE_WR(BLE_INTCNTL_ADDR,
             (REG_BLE_RD(BLE_INTCNTL_ADDR) & ~((uint32_t)0x00000004)) |
                 ((uint32_t)slpintmsk << 2));
}
...
__INLINE void ble_rxintmsk_setf(uint8_t rxintmsk) {
  ASSERT_ERR((((uint32_t)rxintmsk << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_BLE_WR(BLE_INTCNTL_ADDR,
             (REG_BLE_RD(BLE_INTCNTL_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)rxintmsk << 1));
}
...
__INLINE void ble_cscntintmsk_setf(uint8_t cscntintmsk) {
  ASSERT_ERR((((uint32_t)cscntintmsk << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_BLE_WR(BLE_INTCNTL_ADDR,
             (REG_BLE_RD(BLE_INTCNTL_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)cscntintmsk << 0));
}
...
__INLINE uint32_t ble_intstat_get(void) { return REG_BLE_RD(BLE_INTSTAT_ADDR); }
...
__INLINE void ble_intstat_unpack(uint8_t* radiocntlintstat,
                                 uint8_t* finetgtimintstat,
                                 uint8_t* grosstgtimintstat,
                                 uint8_t* errorintstat, uint8_t* cryptintstat,
                                 uint8_t* eventintstat, uint8_t* slpintstat,
                                 uint8_t* rxintstat, uint8_t* cscntintstat) {
...
__INLINE void ble_intrawstat_unpack(
    uint8_t* radiocntlintrawstat, uint8_t* finetgtimintrawstat,
    uint8_t* grosstgtimintrawstat, uint8_t* errorintrawstat,
    uint8_t* cryptintrawstat, uint8_t* eventintrawstat, uint8_t* slpintrawstat,
...
__INLINE uint32_t ble_intack_get(void) { return REG_BLE_RD(BLE_INTACK_ADDR); }
...
__INLINE void ble_intack_pack(uint8_t radiocntlintack, uint8_t finetgtimintack,
                              uint8_t grosstgtimintack, uint8_t errorintack,
                              uint8_t cryptintack, uint8_t eventintack,
                              uint8_t slpintack, uint8_t rxintack,
                              uint8_t cscntintack) {
  ASSERT_ERR((((uint32_t)radiocntlintack << 8) & ~((uint32_t)0x00000100)) == 0);
  ASSERT_ERR((((uint32_t)finetgtimintack << 7) & ~((uint32_t)0x00000080)) == 0);
  ASSERT_ERR((((uint32_t)grosstgtimintack << 6) & ~((uint32_t)0x00000040)) ==
             0);
  ...
  REG_BLE_WR(BLE_INTACK_ADDR,
             ((uint32_t)radiocntlintack << 8) |
                 ((uint32_t)finetgtimintack << 7) |
                 ((uint32_t)grosstgtimintack << 6) |
                 ((uint32_t)errorintack << 5) | ((uint32_t)cryptintack << 4) |
                 ((uint32_t)eventintack << 3) | ((uint32_t)slpintack << 2) |
                 ((uint32_t)rxintack << 1) | ((uint32_t)cscntintack << 0));
}

__INLINE void ble_intack_unpack(uint8_t* radiocntlintack,
                                uint8_t* finetgtimintack,
                                uint8_t* grosstgtimintack, uint8_t* errorintack,
                                uint8_t* cryptintack, uint8_t* eventintack,
                                uint8_t* slpintack, uint8_t* rxintack,
                                uint8_t* cscntintack) {
...
__INLINE uint32_t ble_bdaddrl_get(void) { return REG_BLE_RD(BLE_BDADDRL_ADDR); }
...
__INLINE uint32_t ble_bdaddru_get(void) { return REG_BLE_RD(BLE_BDADDRU_ADDR); }
...
__INLINE void ble_bdaddru_pack(uint8_t privnpub, uint16_t bdaddru) {
  ...
  REG_BLE_WR(BLE_BDADDRU_ADDR,
             ((uint32_t)privnpub << 16) | ((uint32_t)bdaddru << 0));
}
...
__INLINE void ble_priv_npub_setf(uint8_t privnpub) {
  ASSERT_ERR((((uint32_t)privnpub << 16) & ~((uint32_t)0x00010000)) == 0);
  REG_BLE_WR(BLE_BDADDRU_ADDR,
             (REG_BLE_RD(BLE_BDADDRU_ADDR) & ~((uint32_t)0x00010000)) |
                 ((uint32_t)privnpub << 16));
}
...
__INLINE void ble_bdaddru_setf(uint16_t bdaddru) {
  ASSERT_ERR((((uint32_t)bdaddru << 0) & ~((uint32_t)0x0000FFFF)) == 0);
  REG_BLE_WR(BLE_BDADDRU_ADDR,
             (REG_BLE_RD(BLE_BDADDRU_ADDR) & ~((uint32_t)0x0000FFFF)) |
                 ((uint32_t)bdaddru << 0));
}
...
__INLINE void ble_currentrxdescptr_setf(uint16_t currentrxdescptr) {
  ASSERT_ERR((((uint32_t)currentrxdescptr << 0) & ~((uint32_t)0x00003FFF)) ==
             0);
...
__INLINE void ble_deepslcntl_pack(uint8_t extwkupdsb, uint8_t softwakeupreq,
                                  uint8_t deepsleepcorren, uint8_t deepsleepon,
                                  uint8_t radiosleepen, uint8_t oscsleepen) {
  ...
  REG_BLE_WR(BLE_DEEPSLCNTL_ADDR,
             ((uint32_t)extwkupdsb << 31) | ((uint32_t)softwakeupreq << 4) |
                 ((uint32_t)deepsleepcorren << 3) |
                 ((uint32_t)deepsleepon << 2) | ((uint32_t)radiosleepen << 1) |
                 ((uint32_t)oscsleepen << 0));
}

__INLINE void ble_deepslcntl_unpack(uint8_t* extwkupdsb, uint8_t* deepsleepstat,
                                    uint8_t* softwakeupreq,
                                    uint8_t* deepsleepcorren,
                                    uint8_t* deepsleepon, uint8_t* radiosleepen,
                                    uint8_t* oscsleepen) {
...
__INLINE void ble_extwkupdsb_setf(uint8_t extwkupdsb) {
  ASSERT_ERR((((uint32_t)extwkupdsb << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_BLE_WR(BLE_DEEPSLCNTL_ADDR,
             (REG_BLE_RD(BLE_DEEPSLCNTL_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)extwkupdsb << 31));
}
...
__INLINE void ble_soft_wakeup_req_setf(uint8_t softwakeupreq) {
  ASSERT_ERR((((uint32_t)softwakeupreq << 4) & ~((uint32_t)0x00000010)) == 0);
  REG_BLE_WR(BLE_DEEPSLCNTL_ADDR,
             (REG_BLE_RD(BLE_DEEPSLCNTL_ADDR) & ~((uint32_t)0x00000010)) |
                 ((uint32_t)softwakeupreq << 4));
}
...
__INLINE void ble_deep_sleep_corr_en_setf(uint8_t deepsleepcorren) {
  ASSERT_ERR((((uint32_t)deepsleepcorren << 3) & ~((uint32_t)0x00000008)) == 0);
  REG_BLE_WR(BLE_DEEPSLCNTL_ADDR,
             (REG_BLE_RD(BLE_DEEPSLCNTL_ADDR) & ~((uint32_t)0x00000008)) |
                 ((uint32_t)deepsleepcorren << 3));
}
...
__INLINE void ble_deep_sleep_on_setf(uint8_t deepsleepon) {
  ASSERT_ERR((((uint32_t)deepsleepon << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_BLE_WR(BLE_DEEPSLCNTL_ADDR,
             (REG_BLE_RD(BLE_DEEPSLCNTL_ADDR) & ~((uint32_t)0x00000004)) |
                 ((uint32_t)deepsleepon << 2));
}
...
__INLINE void ble_radio_sleep_en_setf(uint8_t radiosleepen) {
  ASSERT_ERR((((uint32_t)radiosleepen << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_BLE_WR(BLE_DEEPSLCNTL_ADDR,
             (REG_BLE_RD(BLE_DEEPSLCNTL_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)radiosleepen << 1));
}
...
__INLINE void ble_osc_sleep_en_setf(uint8_t oscsleepen) {
  ASSERT_ERR((((uint32_t)oscsleepen << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_BLE_WR(BLE_DEEPSLCNTL_ADDR,
             (REG_BLE_RD(BLE_DEEPSLCNTL_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)oscsleepen << 0));
}
...
__INLINE void ble_enbpreset_pack(uint16_t twext, uint16_t twosc,
                                 uint16_t twrm) {
  ...
  REG_BLE_WR(BLE_ENBPRESET_ADDR, ((uint32_t)twext << 21) |
                                     ((uint32_t)twosc << 10) |
                                     ((uint32_t)twrm << 0));
}

__INLINE void ble_enbpreset_unpack(uint16_t* twext, uint16_t* twosc,
                                   uint16_t* twrm) {
...
__INLINE void ble_twext_setf(uint16_t twext) {
  ASSERT_ERR((((uint32_t)twext << 21) & ~((uint32_t)0xFFE00000)) == 0);
  REG_BLE_WR(BLE_ENBPRESET_ADDR,
             (REG_BLE_RD(BLE_ENBPRESET_ADDR) & ~((uint32_t)0xFFE00000)) |
                 ((uint32_t)twext << 21));
}
...
__INLINE void ble_twosc_setf(uint16_t twosc) {
  ASSERT_ERR((((uint32_t)twosc << 10) & ~((uint32_t)0x001FFC00)) == 0);
  REG_BLE_WR(BLE_ENBPRESET_ADDR,
             (REG_BLE_RD(BLE_ENBPRESET_ADDR) & ~((uint32_t)0x001FFC00)) |
                 ((uint32_t)twosc << 10));
}
...
__INLINE void ble_twrm_setf(uint16_t twrm) {
  ASSERT_ERR((((uint32_t)twrm << 0) & ~((uint32_t)0x000003FF)) == 0);
  REG_BLE_WR(BLE_ENBPRESET_ADDR,
             (REG_BLE_RD(BLE_ENBPRESET_ADDR) & ~((uint32_t)0x000003FF)) |
                 ((uint32_t)twrm << 0));
}
...
__INLINE void ble_diagcntl_pack(uint8_t diag3en, uint8_t diag3, uint8_t diag2en,
                                uint8_t diag2, uint8_t diag1en, uint8_t diag1,
                                uint8_t diag0en, uint8_t diag0) {
  ...
  REG_BLE_WR(BLE_DIAGCNTL_ADDR,
             ((uint32_t)diag3en << 31) | ((uint32_t)diag3 << 24) |
                 ((uint32_t)diag2en << 23) | ((uint32_t)diag2 << 16) |
                 ((uint32_t)diag1en << 15) | ((uint32_t)diag1 << 8) |
                 ((uint32_t)diag0en << 7) | ((uint32_t)diag0 << 0));
}

__INLINE void ble_diagcntl_unpack(uint8_t* diag3en, uint8_t* diag3,
                                  uint8_t* diag2en, uint8_t* diag2,
                                  uint8_t* diag1en, uint8_t* diag1,
                                  uint8_t* diag0en, uint8_t* diag0) {
...
__INLINE void ble_diag3_en_setf(uint8_t diag3en) {
  ASSERT_ERR((((uint32_t)diag3en << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_BLE_WR(BLE_DIAGCNTL_ADDR,
             (REG_BLE_RD(BLE_DIAGCNTL_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)diag3en << 31));
}
...
__INLINE void ble_diag3_setf(uint8_t diag3) {
  ASSERT_ERR((((uint32_t)diag3 << 24) & ~((uint32_t)0x3F000000)) == 0);
  REG_BLE_WR(BLE_DIAGCNTL_ADDR,
             (REG_BLE_RD(BLE_DIAGCNTL_ADDR) & ~((uint32_t)0x3F000000)) |
                 ((uint32_t)diag3 << 24));
}
...
__INLINE void ble_diag2_en_setf(uint8_t diag2en) {
  ASSERT_ERR((((uint32_t)diag2en << 23) & ~((uint32_t)0x00800000)) == 0);
  REG_BLE_WR(BLE_DIAGCNTL_ADDR,
             (REG_BLE_RD(BLE_DIAGCNTL_ADDR) & ~((uint32_t)0x00800000)) |
                 ((uint32_t)diag2en << 23));
}
...
__INLINE void ble_diag2_setf(uint8_t diag2) {
  ASSERT_ERR((((uint32_t)diag2 << 16) & ~((uint32_t)0x003F0000)) == 0);
  REG_BLE_WR(BLE_DIAGCNTL_ADDR,
             (REG_BLE_RD(BLE_DIAGCNTL_ADDR) & ~((uint32_t)0x003F0000)) |
                 ((uint32_t)diag2 << 16));
}
...
__INLINE void ble_diag1_en_setf(uint8_t diag1en) {
  ASSERT_ERR((((uint32_t)diag1en << 15) & ~((uint32_t)0x00008000)) == 0);
  REG_BLE_WR(BLE_DIAGCNTL_ADDR,
             (REG_BLE_RD(BLE_DIAGCNTL_ADDR) & ~((uint32_t)0x00008000)) |
                 ((uint32_t)diag1en << 15));
}
...
__INLINE void ble_diag1_setf(uint8_t diag1) {
  ASSERT_ERR((((uint32_t)diag1 << 8) & ~((uint32_t)0x00003F00)) == 0);
  REG_BLE_WR(BLE_DIAGCNTL_ADDR,
             (REG_BLE_RD(BLE_DIAGCNTL_ADDR) & ~((uint32_t)0x00003F00)) |
                 ((uint32_t)diag1 << 8));
}
...
__INLINE void ble_diag0_en_setf(uint8_t diag0en) {
  ASSERT_ERR((((uint32_t)diag0en << 7) & ~((uint32_t)0x00000080)) == 0);
  REG_BLE_WR(BLE_DIAGCNTL_ADDR,
             (REG_BLE_RD(BLE_DIAGCNTL_ADDR) & ~((uint32_t)0x00000080)) |
                 ((uint32_t)diag0en << 7));
}
...
__INLINE void ble_diag0_setf(uint8_t diag0) {
  ASSERT_ERR((((uint32_t)diag0 << 0) & ~((uint32_t)0x0000003F)) == 0);
  REG_BLE_WR(BLE_DIAGCNTL_ADDR,
             (REG_BLE_RD(BLE_DIAGCNTL_ADDR) & ~((uint32_t)0x0000003F)) |
                 ((uint32_t)diag0 << 0));
}
...
__INLINE void ble_diagstat_unpack(uint8_t* diag3stat, uint8_t* diag2stat,
                                  uint8_t* diag1stat, uint8_t* diag0stat) {
...
__INLINE void ble_errortypestat_unpack(
    uint8_t* csformaterror, uint8_t* cstxptrerror, uint8_t* radioemaccerror,
    uint8_t* llchmaperror, uint8_t* ifsunderrun, uint8_t* rxcrypterror,
    uint8_t* whitelisterror, uint8_t* apfmerror, uint8_t* txdescerror,
    uint8_t* pktcntlemaccerror, uint8_t* txcrypterror) {
...
__INLINE void ble_swprofiling_pack(
    uint8_t swprof31, uint8_t swprof30, uint8_t swprof29, uint8_t swprof28,
    uint8_t swprof27, uint8_t swprof26, uint8_t swprof25, uint8_t swprof24,
    uint8_t swprof23, uint8_t swprof22, uint8_t swprof21, uint8_t swprof20,
    uint8_t swprof19, uint8_t swprof18, uint8_t swprof17, uint8_t swprof16,
    uint8_t swprof15, uint8_t swprof14, uint8_t swprof13, uint8_t swprof12,
    uint8_t swprof11, uint8_t swprof10, uint8_t swprof9, uint8_t swprof8,
    uint8_t swprof7, uint8_t swprof6, uint8_t swprof5, uint8_t swprof4,
    uint8_t swprof3, uint8_t swprof2, uint8_t swprof1, uint8_t swprof0) {
  ...
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             ((uint32_t)swprof31 << 31) | ((uint32_t)swprof30 << 30) |
                 ((uint32_t)swprof29 << 29) | ((uint32_t)swprof28 << 28) |
                 ((uint32_t)swprof27 << 27) | ((uint32_t)swprof26 << 26) |
                 ((uint32_t)swprof25 << 25) | ((uint32_t)swprof24 << 24) |
                 ((uint32_t)swprof23 << 23) | ((uint32_t)swprof22 << 22) |
                 ((uint32_t)swprof21 << 21) | ((uint32_t)swprof20 << 20) |
                 ((uint32_t)swprof19 << 19) | ((uint32_t)swprof18 << 18) |
                 ((uint32_t)swprof17 << 17) | ((uint32_t)swprof16 << 16) |
                 ((uint32_t)swprof15 << 15) | ((uint32_t)swprof14 << 14) |
                 ((uint32_t)swprof13 << 13) | ((uint32_t)swprof12 << 12) |
                 ((uint32_t)swprof11 << 11) | ((uint32_t)swprof10 << 10) |
                 ((uint32_t)swprof9 << 9) | ((uint32_t)swprof8 << 8) |
                 ((uint32_t)swprof7 << 7) | ((uint32_t)swprof6 << 6) |
                 ((uint32_t)swprof5 << 5) | ((uint32_t)swprof4 << 4) |
                 ((uint32_t)swprof3 << 3) | ((uint32_t)swprof2 << 2) |
                 ((uint32_t)swprof1 << 1) | ((uint32_t)swprof0 << 0));
}

__INLINE void ble_swprofiling_unpack(
    uint8_t* swprof31, uint8_t* swprof30, uint8_t* swprof29, uint8_t* swprof28,
    uint8_t* swprof27, uint8_t* swprof26, uint8_t* swprof25, uint8_t* swprof24,
    uint8_t* swprof23, uint8_t* swprof22, uint8_t* swprof21, uint8_t* swprof20,
    uint8_t* swprof19, uint8_t* swprof18, uint8_t* swprof17, uint8_t* swprof16,
...
__INLINE void ble_swprof31_setf(uint8_t swprof31) {
  ASSERT_ERR((((uint32_t)swprof31 << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)swprof31 << 31));
}
...
__INLINE void ble_swprof30_setf(uint8_t swprof30) {
  ASSERT_ERR((((uint32_t)swprof30 << 30) & ~((uint32_t)0x40000000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x40000000)) |
                 ((uint32_t)swprof30 << 30));
}
...
__INLINE void ble_swprof29_setf(uint8_t swprof29) {
  ASSERT_ERR((((uint32_t)swprof29 << 29) & ~((uint32_t)0x20000000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x20000000)) |
                 ((uint32_t)swprof29 << 29));
}
...
__INLINE void ble_swprof28_setf(uint8_t swprof28) {
  ASSERT_ERR((((uint32_t)swprof28 << 28) & ~((uint32_t)0x10000000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x10000000)) |
                 ((uint32_t)swprof28 << 28));
}
...
__INLINE void ble_swprof27_setf(uint8_t swprof27) {
  ASSERT_ERR((((uint32_t)swprof27 << 27) & ~((uint32_t)0x08000000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x08000000)) |
                 ((uint32_t)swprof27 << 27));
}
...
__INLINE void ble_swprof26_setf(uint8_t swprof26) {
  ASSERT_ERR((((uint32_t)swprof26 << 26) & ~((uint32_t)0x04000000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x04000000)) |
                 ((uint32_t)swprof26 << 26));
}
...
__INLINE void ble_swprof25_setf(uint8_t swprof25) {
  ASSERT_ERR((((uint32_t)swprof25 << 25) & ~((uint32_t)0x02000000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x02000000)) |
                 ((uint32_t)swprof25 << 25));
}
...
__INLINE void ble_swprof24_setf(uint8_t swprof24) {
  ASSERT_ERR((((uint32_t)swprof24 << 24) & ~((uint32_t)0x01000000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x01000000)) |
                 ((uint32_t)swprof24 << 24));
}
...
__INLINE void ble_swprof23_setf(uint8_t swprof23) {
  ASSERT_ERR((((uint32_t)swprof23 << 23) & ~((uint32_t)0x00800000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00800000)) |
                 ((uint32_t)swprof23 << 23));
}
...
__INLINE void ble_swprof22_setf(uint8_t swprof22) {
  ASSERT_ERR((((uint32_t)swprof22 << 22) & ~((uint32_t)0x00400000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00400000)) |
                 ((uint32_t)swprof22 << 22));
}
...
__INLINE void ble_swprof21_setf(uint8_t swprof21) {
  ASSERT_ERR((((uint32_t)swprof21 << 21) & ~((uint32_t)0x00200000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00200000)) |
                 ((uint32_t)swprof21 << 21));
}
...
__INLINE void ble_swprof20_setf(uint8_t swprof20) {
  ASSERT_ERR((((uint32_t)swprof20 << 20) & ~((uint32_t)0x00100000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00100000)) |
                 ((uint32_t)swprof20 << 20));
}
...
__INLINE void ble_swprof19_setf(uint8_t swprof19) {
  ASSERT_ERR((((uint32_t)swprof19 << 19) & ~((uint32_t)0x00080000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00080000)) |
                 ((uint32_t)swprof19 << 19));
}
...
__INLINE void ble_swprof18_setf(uint8_t swprof18) {
  ASSERT_ERR((((uint32_t)swprof18 << 18) & ~((uint32_t)0x00040000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00040000)) |
                 ((uint32_t)swprof18 << 18));
}
...
__INLINE void ble_swprof17_setf(uint8_t swprof17) {
  ASSERT_ERR((((uint32_t)swprof17 << 17) & ~((uint32_t)0x00020000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00020000)) |
                 ((uint32_t)swprof17 << 17));
}
...
__INLINE void ble_swprof16_setf(uint8_t swprof16) {
  ASSERT_ERR((((uint32_t)swprof16 << 16) & ~((uint32_t)0x00010000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00010000)) |
                 ((uint32_t)swprof16 << 16));
}
...
__INLINE void ble_swprof15_setf(uint8_t swprof15) {
  ASSERT_ERR((((uint32_t)swprof15 << 15) & ~((uint32_t)0x00008000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00008000)) |
                 ((uint32_t)swprof15 << 15));
}
...
__INLINE void ble_swprof14_setf(uint8_t swprof14) {
  ASSERT_ERR((((uint32_t)swprof14 << 14) & ~((uint32_t)0x00004000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00004000)) |
                 ((uint32_t)swprof14 << 14));
}
...
__INLINE void ble_swprof13_setf(uint8_t swprof13) {
  ASSERT_ERR((((uint32_t)swprof13 << 13) & ~((uint32_t)0x00002000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00002000)) |
                 ((uint32_t)swprof13 << 13));
}
...
__INLINE void ble_swprof12_setf(uint8_t swprof12) {
  ASSERT_ERR((((uint32_t)swprof12 << 12) & ~((uint32_t)0x00001000)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00001000)) |
                 ((uint32_t)swprof12 << 12));
}
...
__INLINE void ble_swprof11_setf(uint8_t swprof11) {
  ASSERT_ERR((((uint32_t)swprof11 << 11) & ~((uint32_t)0x00000800)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00000800)) |
                 ((uint32_t)swprof11 << 11));
}
...
__INLINE void ble_swprof10_setf(uint8_t swprof10) {
  ASSERT_ERR((((uint32_t)swprof10 << 10) & ~((uint32_t)0x00000400)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00000400)) |
                 ((uint32_t)swprof10 << 10));
}
...
__INLINE void ble_swprof9_setf(uint8_t swprof9) {
  ASSERT_ERR((((uint32_t)swprof9 << 9) & ~((uint32_t)0x00000200)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00000200)) |
                 ((uint32_t)swprof9 << 9));
}
...
__INLINE void ble_swprof8_setf(uint8_t swprof8) {
  ASSERT_ERR((((uint32_t)swprof8 << 8) & ~((uint32_t)0x00000100)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00000100)) |
                 ((uint32_t)swprof8 << 8));
}
...
__INLINE void ble_swprof7_setf(uint8_t swprof7) {
  ASSERT_ERR((((uint32_t)swprof7 << 7) & ~((uint32_t)0x00000080)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00000080)) |
                 ((uint32_t)swprof7 << 7));
}
...
__INLINE void ble_swprof6_setf(uint8_t swprof6) {
  ASSERT_ERR((((uint32_t)swprof6 << 6) & ~((uint32_t)0x00000040)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00000040)) |
                 ((uint32_t)swprof6 << 6));
}
...
__INLINE void ble_swprof5_setf(uint8_t swprof5) {
  ASSERT_ERR((((uint32_t)swprof5 << 5) & ~((uint32_t)0x00000020)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00000020)) |
                 ((uint32_t)swprof5 << 5));
}
...
__INLINE void ble_swprof4_setf(uint8_t swprof4) {
  ASSERT_ERR((((uint32_t)swprof4 << 4) & ~((uint32_t)0x00000010)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00000010)) |
                 ((uint32_t)swprof4 << 4));
}
...
__INLINE void ble_swprof3_setf(uint8_t swprof3) {
  ASSERT_ERR((((uint32_t)swprof3 << 3) & ~((uint32_t)0x00000008)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00000008)) |
                 ((uint32_t)swprof3 << 3));
}
...
__INLINE void ble_swprof2_setf(uint8_t swprof2) {
  ASSERT_ERR((((uint32_t)swprof2 << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00000004)) |
                 ((uint32_t)swprof2 << 2));
}
...
__INLINE void ble_swprof1_setf(uint8_t swprof1) {
  ASSERT_ERR((((uint32_t)swprof1 << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)swprof1 << 1));
}
...
__INLINE void ble_swprof0_setf(uint8_t swprof0) {
  ASSERT_ERR((((uint32_t)swprof0 << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_BLE_WR(BLE_SWPROFILING_ADDR,
             (REG_BLE_RD(BLE_SWPROFILING_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)swprof0 << 0));
}
...
__INLINE void ble_radiocntl0_pack(
    uint8_t vgacnt, uint8_t lnacnt, uint8_t agcforcemode, uint8_t dpcorren,
    uint8_t spiswaccdbgen, uint8_t corrwinmskdsb, uint8_t forceagcen,
    uint8_t forcebleiq, uint8_t rxlowif, uint8_t bidirclk, uint8_t bidirdata,
    uint8_t spipol, uint8_t spifreq, uint8_t spimode, uint8_t spigo) {
  ...
  REG_BLE_WR(BLE_RADIOCNTL0_ADDR,
             ((uint32_t)vgacnt << 26) | ((uint32_t)lnacnt << 24) |
                 ((uint32_t)agcforcemode << 23) | ((uint32_t)dpcorren << 22) |
                 ((uint32_t)spiswaccdbgen << 21) |
                 ((uint32_t)corrwinmskdsb << 20) |
                 ((uint32_t)forceagcen << 19) | ((uint32_t)forcebleiq << 18) |
                 ((uint32_t)rxlowif << 12) | ((uint32_t)bidirclk << 9) |
                 ((uint32_t)bidirdata << 8) | ((uint32_t)spipol << 7) |
                 ((uint32_t)spifreq << 5) | ((uint32_t)spimode << 4) |
                 ((uint32_t)spigo << 0));
}

__INLINE void ble_radiocntl0_unpack(
    uint8_t* vgacnt, uint8_t* lnacnt, uint8_t* agcforcemode, uint8_t* dpcorren,
    uint8_t* spiswaccdbgen, uint8_t* corrwinmskdsb, uint8_t* forceagcen,
    uint8_t* forcebleiq, uint8_t* rxlowif, uint8_t* bidirclk,
    uint8_t* bidirdata, uint8_t* spipol, uint8_t* spifreq, uint8_t* spimode,
    uint8_t* spicomp, uint8_t* spigo) {
...
__INLINE void ble_vgacnt_setf(uint8_t vgacnt) {
  ASSERT_ERR((((uint32_t)vgacnt << 26) & ~((uint32_t)0xFC000000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL0_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL0_ADDR) & ~((uint32_t)0xFC000000)) |
                 ((uint32_t)vgacnt << 26));
}
...
__INLINE void ble_lnacnt_setf(uint8_t lnacnt) {
  ASSERT_ERR((((uint32_t)lnacnt << 24) & ~((uint32_t)0x03000000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL0_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL0_ADDR) & ~((uint32_t)0x03000000)) |
                 ((uint32_t)lnacnt << 24));
}
...
__INLINE void ble_agcforce_mode_setf(uint8_t agcforcemode) {
  ASSERT_ERR((((uint32_t)agcforcemode << 23) & ~((uint32_t)0x00800000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL0_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL0_ADDR) & ~((uint32_t)0x00800000)) |
                 ((uint32_t)agcforcemode << 23));
}
...
__INLINE void ble_dpcorr_en_setf(uint8_t dpcorren) {
  ASSERT_ERR((((uint32_t)dpcorren << 22) & ~((uint32_t)0x00400000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL0_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL0_ADDR) & ~((uint32_t)0x00400000)) |
                 ((uint32_t)dpcorren << 22));
}
...
__INLINE void ble_spiswaccdbgen_setf(uint8_t spiswaccdbgen) {
  ASSERT_ERR((((uint32_t)spiswaccdbgen << 21) & ~((uint32_t)0x00200000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL0_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL0_ADDR) & ~((uint32_t)0x00200000)) |
                 ((uint32_t)spiswaccdbgen << 21));
}
...
__INLINE void ble_corr_win_msk_dsb_setf(uint8_t corrwinmskdsb) {
  ASSERT_ERR((((uint32_t)corrwinmskdsb << 20) & ~((uint32_t)0x00100000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL0_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL0_ADDR) & ~((uint32_t)0x00100000)) |
                 ((uint32_t)corrwinmskdsb << 20));
}
...
__INLINE void ble_forceagc_en_setf(uint8_t forceagcen) {
  ASSERT_ERR((((uint32_t)forceagcen << 19) & ~((uint32_t)0x00080000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL0_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL0_ADDR) & ~((uint32_t)0x00080000)) |
                 ((uint32_t)forceagcen << 19));
}
...
__INLINE void ble_forcebleiq_setf(uint8_t forcebleiq) {
  ASSERT_ERR((((uint32_t)forcebleiq << 18) & ~((uint32_t)0x00040000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL0_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL0_ADDR) & ~((uint32_t)0x00040000)) |
                 ((uint32_t)forcebleiq << 18));
}
...
__INLINE void ble_rxlowif_setf(uint8_t rxlowif) {
  ASSERT_ERR((((uint32_t)rxlowif << 12) & ~((uint32_t)0x00003000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL0_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL0_ADDR) & ~((uint32_t)0x00003000)) |
                 ((uint32_t)rxlowif << 12));
}
...
__INLINE void ble_bidirclk_setf(uint8_t bidirclk) {
  ASSERT_ERR((((uint32_t)bidirclk << 9) & ~((uint32_t)0x00000200)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL0_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL0_ADDR) & ~((uint32_t)0x00000200)) |
                 ((uint32_t)bidirclk << 9));
}
...
__INLINE void ble_bidirdata_setf(uint8_t bidirdata) {
  ASSERT_ERR((((uint32_t)bidirdata << 8) & ~((uint32_t)0x00000100)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL0_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL0_ADDR) & ~((uint32_t)0x00000100)) |
                 ((uint32_t)bidirdata << 8));
}
...
__INLINE void ble_spipol_setf(uint8_t spipol) {
  ASSERT_ERR((((uint32_t)spipol << 7) & ~((uint32_t)0x00000080)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL0_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL0_ADDR) & ~((uint32_t)0x00000080)) |
                 ((uint32_t)spipol << 7));
}
...
__INLINE void ble_spifreq_setf(uint8_t spifreq) {
  ASSERT_ERR((((uint32_t)spifreq << 5) & ~((uint32_t)0x00000060)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL0_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL0_ADDR) & ~((uint32_t)0x00000060)) |
                 ((uint32_t)spifreq << 5));
}
...
__INLINE void ble_spimode_setf(uint8_t spimode) {
  ASSERT_ERR((((uint32_t)spimode << 4) & ~((uint32_t)0x00000010)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL0_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL0_ADDR) & ~((uint32_t)0x00000010)) |
                 ((uint32_t)spimode << 4));
}
...
__INLINE void ble_spigo_setf(uint8_t spigo) {
  ASSERT_ERR((((uint32_t)spigo << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL0_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL0_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)spigo << 0));
}
...
__INLINE void ble_radiocntl1_pack(uint8_t ramptype, uint8_t rampstep,
                                  uint8_t xrfsel, uint16_t spiptr) {
  ...
  REG_BLE_WR(BLE_RADIOCNTL1_ADDR,
             ((uint32_t)ramptype << 28) | ((uint32_t)rampstep << 24) |
                 ((uint32_t)xrfsel << 16) | ((uint32_t)spiptr << 0));
}

__INLINE void ble_radiocntl1_unpack(uint8_t* ramptype, uint8_t* rampstep,
                                    uint8_t* xrfsel, uint16_t* spiptr) {
...
__INLINE void ble_ramp_type_setf(uint8_t ramptype) {
  ASSERT_ERR((((uint32_t)ramptype << 28) & ~((uint32_t)0x10000000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL1_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL1_ADDR) & ~((uint32_t)0x10000000)) |
                 ((uint32_t)ramptype << 28));
}
...
__INLINE void ble_rampstep_setf(uint8_t rampstep) {
  ASSERT_ERR((((uint32_t)rampstep << 24) & ~((uint32_t)0x0F000000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL1_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL1_ADDR) & ~((uint32_t)0x0F000000)) |
                 ((uint32_t)rampstep << 24));
}
...
__INLINE void ble_xrfsel_setf(uint8_t xrfsel) {
  ASSERT_ERR((((uint32_t)xrfsel << 16) & ~((uint32_t)0x001F0000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL1_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL1_ADDR) & ~((uint32_t)0x001F0000)) |
                 ((uint32_t)xrfsel << 16));
}
...
__INLINE void ble_spiptr_setf(uint16_t spiptr) {
  ASSERT_ERR((((uint32_t)spiptr << 0) & ~((uint32_t)0x0000FFFF)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL1_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL1_ADDR) & ~((uint32_t)0x0000FFFF)) |
                 ((uint32_t)spiptr << 0));
}
...
__INLINE void ble_radiocntl2_pack(uint8_t regupdelay, uint8_t rxdndelay,
                                  uint8_t rxupdelay, uint8_t txdndelay,
                                  uint8_t txupdelay) {
  ...
  REG_BLE_WR(BLE_RADIOCNTL2_ADDR,
             ((uint32_t)regupdelay << 24) | ((uint32_t)rxdndelay << 18) |
                 ((uint32_t)rxupdelay << 12) | ((uint32_t)txdndelay << 6) |
                 ((uint32_t)txupdelay << 0));
}

__INLINE void ble_radiocntl2_unpack(uint8_t* regupdelay, uint8_t* rxdndelay,
                                    uint8_t* rxupdelay, uint8_t* txdndelay,
                                    uint8_t* txupdelay) {
...
__INLINE void ble_regup_delay_setf(uint8_t regupdelay) {
  ASSERT_ERR((((uint32_t)regupdelay << 24) & ~((uint32_t)0x3F000000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL2_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL2_ADDR) & ~((uint32_t)0x3F000000)) |
                 ((uint32_t)regupdelay << 24));
}
...
__INLINE void ble_rxdn_delay_setf(uint8_t rxdndelay) {
  ASSERT_ERR((((uint32_t)rxdndelay << 18) & ~((uint32_t)0x00FC0000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL2_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL2_ADDR) & ~((uint32_t)0x00FC0000)) |
                 ((uint32_t)rxdndelay << 18));
}
...
__INLINE void ble_rxup_delay_setf(uint8_t rxupdelay) {
  ASSERT_ERR((((uint32_t)rxupdelay << 12) & ~((uint32_t)0x0003F000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL2_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL2_ADDR) & ~((uint32_t)0x0003F000)) |
                 ((uint32_t)rxupdelay << 12));
}
...
__INLINE void ble_txdn_delay_setf(uint8_t txdndelay) {
  ASSERT_ERR((((uint32_t)txdndelay << 6) & ~((uint32_t)0x00000FC0)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL2_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL2_ADDR) & ~((uint32_t)0x00000FC0)) |
                 ((uint32_t)txdndelay << 6));
}
...
__INLINE void ble_txup_delay_setf(uint8_t txupdelay) {
  ASSERT_ERR((((uint32_t)txupdelay << 0) & ~((uint32_t)0x0000003F)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL2_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL2_ADDR) & ~((uint32_t)0x0000003F)) |
                 ((uint32_t)txupdelay << 0));
}
...
__INLINE void ble_radiocntl3_pack(uint8_t pbusvalue, uint8_t pstbvalue,
                                  uint8_t pselvalue, uint8_t rxonpol,
                                  uint8_t txenpol, uint8_t paonpol,
                                  uint8_t regonpol, uint8_t rxonvalue,
                                  uint8_t txenvalue, uint8_t paonvalue,
                                  uint8_t regonvalue, uint8_t forcepbus,
                                  uint8_t forcerxon, uint8_t forcetxen,
                                  uint8_t forcepaon, uint8_t forceregon) {
  ...
  REG_BLE_WR(BLE_RADIOCNTL3_ADDR,
             ((uint32_t)pbusvalue << 24) | ((uint32_t)pstbvalue << 18) |
                 ((uint32_t)pselvalue << 16) | ((uint32_t)rxonpol << 15) |
                 ((uint32_t)txenpol << 14) | ((uint32_t)paonpol << 13) |
                 ((uint32_t)regonpol << 12) | ((uint32_t)rxonvalue << 11) |
                 ((uint32_t)txenvalue << 10) | ((uint32_t)paonvalue << 9) |
                 ((uint32_t)regonvalue << 8) | ((uint32_t)forcepbus << 4) |
                 ((uint32_t)forcerxon << 3) | ((uint32_t)forcetxen << 2) |
                 ((uint32_t)forcepaon << 1) | ((uint32_t)forceregon << 0));
}

__INLINE void ble_radiocntl3_unpack(uint8_t* pbusvalue, uint8_t* pstbvalue,
                                    uint8_t* pselvalue, uint8_t* rxonpol,
                                    uint8_t* txenpol, uint8_t* paonpol,
                                    uint8_t* regonpol, uint8_t* rxonvalue,
                                    uint8_t* txenvalue, uint8_t* paonvalue,
...
__INLINE void ble_pbus_value_setf(uint8_t pbusvalue) {
  ASSERT_ERR((((uint32_t)pbusvalue << 24) & ~((uint32_t)0xFF000000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL3_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL3_ADDR) & ~((uint32_t)0xFF000000)) |
                 ((uint32_t)pbusvalue << 24));
}
...
__INLINE void ble_pstb_value_setf(uint8_t pstbvalue) {
  ASSERT_ERR((((uint32_t)pstbvalue << 18) & ~((uint32_t)0x00040000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL3_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL3_ADDR) & ~((uint32_t)0x00040000)) |
                 ((uint32_t)pstbvalue << 18));
}
...
__INLINE void ble_psel_value_setf(uint8_t pselvalue) {
  ASSERT_ERR((((uint32_t)pselvalue << 16) & ~((uint32_t)0x00030000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL3_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL3_ADDR) & ~((uint32_t)0x00030000)) |
                 ((uint32_t)pselvalue << 16));
}
...
__INLINE void ble_rx_on_pol_setf(uint8_t rxonpol) {
  ASSERT_ERR((((uint32_t)rxonpol << 15) & ~((uint32_t)0x00008000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL3_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL3_ADDR) & ~((uint32_t)0x00008000)) |
                 ((uint32_t)rxonpol << 15));
}
...
__INLINE void ble_tx_en_pol_setf(uint8_t txenpol) {
  ASSERT_ERR((((uint32_t)txenpol << 14) & ~((uint32_t)0x00004000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL3_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL3_ADDR) & ~((uint32_t)0x00004000)) |
                 ((uint32_t)txenpol << 14));
}
...
__INLINE void ble_pa_on_pol_setf(uint8_t paonpol) {
  ASSERT_ERR((((uint32_t)paonpol << 13) & ~((uint32_t)0x00002000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL3_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL3_ADDR) & ~((uint32_t)0x00002000)) |
                 ((uint32_t)paonpol << 13));
}
...
__INLINE void ble_reg_on_pol_setf(uint8_t regonpol) {
  ASSERT_ERR((((uint32_t)regonpol << 12) & ~((uint32_t)0x00001000)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL3_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL3_ADDR) & ~((uint32_t)0x00001000)) |
                 ((uint32_t)regonpol << 12));
}
...
__INLINE void ble_rx_on_value_setf(uint8_t rxonvalue) {
  ASSERT_ERR((((uint32_t)rxonvalue << 11) & ~((uint32_t)0x00000800)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL3_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL3_ADDR) & ~((uint32_t)0x00000800)) |
                 ((uint32_t)rxonvalue << 11));
}
...
__INLINE void ble_tx_en_value_setf(uint8_t txenvalue) {
  ASSERT_ERR((((uint32_t)txenvalue << 10) & ~((uint32_t)0x00000400)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL3_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL3_ADDR) & ~((uint32_t)0x00000400)) |
                 ((uint32_t)txenvalue << 10));
}
...
__INLINE void ble_pa_on_value_setf(uint8_t paonvalue) {
  ASSERT_ERR((((uint32_t)paonvalue << 9) & ~((uint32_t)0x00000200)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL3_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL3_ADDR) & ~((uint32_t)0x00000200)) |
                 ((uint32_t)paonvalue << 9));
}
...
__INLINE void ble_reg_on_value_setf(uint8_t regonvalue) {
  ASSERT_ERR((((uint32_t)regonvalue << 8) & ~((uint32_t)0x00000100)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL3_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL3_ADDR) & ~((uint32_t)0x00000100)) |
                 ((uint32_t)regonvalue << 8));
}
...
__INLINE void ble_force_pbus_setf(uint8_t forcepbus) {
  ASSERT_ERR((((uint32_t)forcepbus << 4) & ~((uint32_t)0x00000010)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL3_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL3_ADDR) & ~((uint32_t)0x00000010)) |
                 ((uint32_t)forcepbus << 4));
}
...
__INLINE void ble_force_rx_on_setf(uint8_t forcerxon) {
  ASSERT_ERR((((uint32_t)forcerxon << 3) & ~((uint32_t)0x00000008)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL3_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL3_ADDR) & ~((uint32_t)0x00000008)) |
                 ((uint32_t)forcerxon << 3));
}
...
__INLINE void ble_force_tx_en_setf(uint8_t forcetxen) {
  ASSERT_ERR((((uint32_t)forcetxen << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL3_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL3_ADDR) & ~((uint32_t)0x00000004)) |
                 ((uint32_t)forcetxen << 2));
}
...
__INLINE void ble_force_pa_on_setf(uint8_t forcepaon) {
  ASSERT_ERR((((uint32_t)forcepaon << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL3_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL3_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)forcepaon << 1));
}
...
__INLINE void ble_force_reg_on_setf(uint8_t forceregon) {
  ASSERT_ERR((((uint32_t)forceregon << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_BLE_WR(BLE_RADIOCNTL3_ADDR,
             (REG_BLE_RD(BLE_RADIOCNTL3_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)forceregon << 0));
}
...
__INLINE void ble_radiopwrupdn_pack(uint8_t rtripdelay, uint8_t rxpwrup,
                                    uint8_t txpwrdn, uint8_t txpwrup) {
  ...
  REG_BLE_WR(BLE_RADIOPWRUPDN_ADDR,
             ((uint32_t)rtripdelay << 24) | ((uint32_t)rxpwrup << 16) |
                 ((uint32_t)txpwrdn << 8) | ((uint32_t)txpwrup << 0));
}

__INLINE void ble_radiopwrupdn_unpack(uint8_t* rtripdelay, uint8_t* rxpwrup,
                                      uint8_t* txpwrdn, uint8_t* txpwrup) {
...
__INLINE void ble_rtrip_delay_setf(uint8_t rtripdelay) {
  ASSERT_ERR((((uint32_t)rtripdelay << 24) & ~((uint32_t)0x7F000000)) == 0);
  REG_BLE_WR(BLE_RADIOPWRUPDN_ADDR,
             (REG_BLE_RD(BLE_RADIOPWRUPDN_ADDR) & ~((uint32_t)0x7F000000)) |
                 ((uint32_t)rtripdelay << 24));
}
...
__INLINE void ble_rxpwrup_setf(uint8_t rxpwrup) {
  ASSERT_ERR((((uint32_t)rxpwrup << 16) & ~((uint32_t)0x00FF0000)) == 0);
  REG_BLE_WR(BLE_RADIOPWRUPDN_ADDR,
             (REG_BLE_RD(BLE_RADIOPWRUPDN_ADDR) & ~((uint32_t)0x00FF0000)) |
                 ((uint32_t)rxpwrup << 16));
}
...
__INLINE void ble_txpwrdn_setf(uint8_t txpwrdn) {
  ASSERT_ERR((((uint32_t)txpwrdn << 8) & ~((uint32_t)0x00000F00)) == 0);
  REG_BLE_WR(BLE_RADIOPWRUPDN_ADDR,
             (REG_BLE_RD(BLE_RADIOPWRUPDN_ADDR) & ~((uint32_t)0x00000F00)) |
                 ((uint32_t)txpwrdn << 8));
}
...
__INLINE void ble_txpwrup_setf(uint8_t txpwrup) {
  ASSERT_ERR((((uint32_t)txpwrup << 0) & ~((uint32_t)0x000000FF)) == 0);
  REG_BLE_WR(BLE_RADIOPWRUPDN_ADDR,
             (REG_BLE_RD(BLE_RADIOPWRUPDN_ADDR) & ~((uint32_t)0x000000FF)) |
                 ((uint32_t)txpwrup << 0));
}
...
__INLINE uint32_t ble_advtim_get(void) { return REG_BLE_RD(BLE_ADVTIM_ADDR); }
...
__INLINE uint32_t ble_wlnbdev_get(void) { return REG_BLE_RD(BLE_WLNBDEV_ADDR); }
...
__INLINE void ble_wlnbdev_pack(uint8_t nbprivdev, uint8_t nbpubdev) {
  ...
  REG_BLE_WR(BLE_WLNBDEV_ADDR,
             ((uint32_t)nbprivdev << 8) | ((uint32_t)nbpubdev << 0));
}
...
__INLINE void ble_nbprivdev_setf(uint8_t nbprivdev) {
  ASSERT_ERR((((uint32_t)nbprivdev << 8) & ~((uint32_t)0x0000FF00)) == 0);
  REG_BLE_WR(BLE_WLNBDEV_ADDR,
             (REG_BLE_RD(BLE_WLNBDEV_ADDR) & ~((uint32_t)0x0000FF00)) |
                 ((uint32_t)nbprivdev << 8));
}
...
__INLINE void ble_nbpubdev_setf(uint8_t nbpubdev) {
  ASSERT_ERR((((uint32_t)nbpubdev << 0) & ~((uint32_t)0x000000FF)) == 0);
  REG_BLE_WR(BLE_WLNBDEV_ADDR,
             (REG_BLE_RD(BLE_WLNBDEV_ADDR) & ~((uint32_t)0x000000FF)) |
                 ((uint32_t)nbpubdev << 0));
}
...
__INLINE uint32_t ble_aescntl_get(void) { return REG_BLE_RD(BLE_AESCNTL_ADDR); }
...
__INLINE uint32_t ble_aesptr_get(void) { return REG_BLE_RD(BLE_AESPTR_ADDR); }
...
__INLINE void ble_rftestcntl_pack(uint8_t infiniterx, uint8_t infinitetx,
                                  uint8_t txlengthsrc, uint8_t prbstype,
                                  uint8_t txpldsrc, uint16_t txlength) {
  ...
  REG_BLE_WR(BLE_RFTESTCNTL_ADDR,
             ((uint32_t)infiniterx << 31) | ((uint32_t)infinitetx << 15) |
                 ((uint32_t)txlengthsrc << 14) | ((uint32_t)prbstype << 13) |
                 ((uint32_t)txpldsrc << 12) | ((uint32_t)txlength << 0));
}

__INLINE void ble_rftestcntl_unpack(uint8_t* infiniterx, uint8_t* infinitetx,
                                    uint8_t* txlengthsrc, uint8_t* prbstype,
                                    uint8_t* txpldsrc, uint16_t* txlength) {
...
__INLINE void ble_infiniterx_setf(uint8_t infiniterx) {
  ASSERT_ERR((((uint32_t)infiniterx << 31) & ~((uint32_t)0x80000000)) == 0);
  REG_BLE_WR(BLE_RFTESTCNTL_ADDR,
             (REG_BLE_RD(BLE_RFTESTCNTL_ADDR) & ~((uint32_t)0x80000000)) |
                 ((uint32_t)infiniterx << 31));
}
...
__INLINE void ble_infinitetx_setf(uint8_t infinitetx) {
  ASSERT_ERR((((uint32_t)infinitetx << 15) & ~((uint32_t)0x00008000)) == 0);
  REG_BLE_WR(BLE_RFTESTCNTL_ADDR,
             (REG_BLE_RD(BLE_RFTESTCNTL_ADDR) & ~((uint32_t)0x00008000)) |
...
__INLINE void ble_txlengthsrc_setf(uint8_t txlengthsrc) {
  ASSERT_ERR((((uint32_t)txlengthsrc << 14) & ~((uint32_t)0x00004000)) == 0);
  REG_BLE_WR(BLE_RFTESTCNTL_ADDR,
             (REG_BLE_RD(BLE_RFTESTCNTL_ADDR) & ~((uint32_t)0x00004000)) |
                 ((uint32_t)txlengthsrc << 14));
}
...
__INLINE void ble_prbstype_setf(uint8_t prbstype) {
  ASSERT_ERR((((uint32_t)prbstype << 13) & ~((uint32_t)0x00002000)) == 0);
  REG_BLE_WR(BLE_RFTESTCNTL_ADDR,
             (REG_BLE_RD(BLE_RFTESTCNTL_ADDR) & ~((uint32_t)0x00002000)) |
                 ((uint32_t)prbstype << 13));
}
...
__INLINE void ble_txpldsrc_setf(uint8_t txpldsrc) {
  ASSERT_ERR((((uint32_t)txpldsrc << 12) & ~((uint32_t)0x00001000)) == 0);
  REG_BLE_WR(BLE_RFTESTCNTL_ADDR,
             (REG_BLE_RD(BLE_RFTESTCNTL_ADDR) & ~((uint32_t)0x00001000)) |
                 ((uint32_t)txpldsrc << 12));
}
...
__INLINE void ble_txlength_setf(uint16_t txlength) {
  ASSERT_ERR((((uint32_t)txlength << 0) & ~((uint32_t)0x000001FF)) == 0);
  REG_BLE_WR(BLE_RFTESTCNTL_ADDR,
             (REG_BLE_RD(BLE_RFTESTCNTL_ADDR) & ~((uint32_t)0x000001FF)) |
                 ((uint32_t)txlength << 0));
}
...
__INLINE void ble_wlancntl_pack(uint8_t wlcpthreshold, uint8_t wlcpduration,
                                uint8_t wlcpdelay, uint8_t wlcrxtxpol,
                                uint8_t wlcpriomode, uint8_t wlcmode) {
  ...
  REG_BLE_WR(BLE_WLANCNTL_ADDR,
             ((uint32_t)wlcpthreshold << 24) | ((uint32_t)wlcpduration << 16) |
                 ((uint32_t)wlcpdelay << 8) | ((uint32_t)wlcrxtxpol << 4) |
                 ((uint32_t)wlcpriomode << 2) | ((uint32_t)wlcmode << 0));
}

__INLINE void ble_wlancntl_unpack(uint8_t* wlcpthreshold, uint8_t* wlcpduration,
                                  uint8_t* wlcpdelay, uint8_t* wlcrxtxpol,
                                  uint8_t* wlcpriomode, uint8_t* wlcmode) {
...
__INLINE void ble_wlcpthreshold_setf(uint8_t wlcpthreshold) {
  ASSERT_ERR((((uint32_t)wlcpthreshold << 24) & ~((uint32_t)0x1F000000)) == 0);
  REG_BLE_WR(BLE_WLANCNTL_ADDR,
             (REG_BLE_RD(BLE_WLANCNTL_ADDR) & ~((uint32_t)0x1F000000)) |
                 ((uint32_t)wlcpthreshold << 24));
}
...
__INLINE void ble_wlcpduration_setf(uint8_t wlcpduration) {
  ASSERT_ERR((((uint32_t)wlcpduration << 16) & ~((uint32_t)0x007F0000)) == 0);
  REG_BLE_WR(BLE_WLANCNTL_ADDR,
             (REG_BLE_RD(BLE_WLANCNTL_ADDR) & ~((uint32_t)0x007F0000)) |
                 ((uint32_t)wlcpduration << 16));
}
...
__INLINE void ble_wlcpdelay_setf(uint8_t wlcpdelay) {
  ASSERT_ERR((((uint32_t)wlcpdelay << 8) & ~((uint32_t)0x00007F00)) == 0);
  REG_BLE_WR(BLE_WLANCNTL_ADDR,
             (REG_BLE_RD(BLE_WLANCNTL_ADDR) & ~((uint32_t)0x00007F00)) |
                 ((uint32_t)wlcpdelay << 8));
}
...
__INLINE void ble_wlcrxtxpol_setf(uint8_t wlcrxtxpol) {
  ASSERT_ERR((((uint32_t)wlcrxtxpol << 4) & ~((uint32_t)0x00000010)) == 0);
  REG_BLE_WR(BLE_WLANCNTL_ADDR,
             (REG_BLE_RD(BLE_WLANCNTL_ADDR) & ~((uint32_t)0x00000010)) |
                 ((uint32_t)wlcrxtxpol << 4));
}
...
__INLINE void ble_wlcpriomode_setf(uint8_t wlcpriomode) {
  ASSERT_ERR((((uint32_t)wlcpriomode << 2) & ~((uint32_t)0x0000000C)) == 0);
  REG_BLE_WR(BLE_WLANCNTL_ADDR,
             (REG_BLE_RD(BLE_WLANCNTL_ADDR) & ~((uint32_t)0x0000000C)) |
                 ((uint32_t)wlcpriomode << 2));
}
...
__INLINE void ble_wlcmode_setf(uint8_t wlcmode) {
  ASSERT_ERR((((uint32_t)wlcmode << 0) & ~((uint32_t)0x00000003)) == 0);
  REG_BLE_WR(BLE_WLANCNTL_ADDR,
             (REG_BLE_RD(BLE_WLANCNTL_ADDR) & ~((uint32_t)0x00000003)) |
                 ((uint32_t)wlcmode << 0));
}
...
__INLINE void ble_blemprio0_pack(uint8_t blem7, uint8_t blem6, uint8_t blem5,
                                 uint8_t blem4, uint8_t blem3, uint8_t blem2,
                                 uint8_t blem1, uint8_t blem0) {
  ...
  REG_BLE_WR(BLE_BLEMPRIO0_ADDR,
             ((uint32_t)blem7 << 28) | ((uint32_t)blem6 << 24) |
                 ((uint32_t)blem5 << 20) | ((uint32_t)blem4 << 16) |
                 ((uint32_t)blem3 << 12) | ((uint32_t)blem2 << 8) |
                 ((uint32_t)blem1 << 4) | ((uint32_t)blem0 << 0));
}

__INLINE void ble_blemprio0_unpack(uint8_t* blem7, uint8_t* blem6,
                                   uint8_t* blem5, uint8_t* blem4,
                                   uint8_t* blem3, uint8_t* blem2,
                                   uint8_t* blem1, uint8_t* blem0) {
...
__INLINE void ble_blem7_setf(uint8_t blem7) {
  ASSERT_ERR((((uint32_t)blem7 << 28) & ~((uint32_t)0xF0000000)) == 0);
  REG_BLE_WR(BLE_BLEMPRIO0_ADDR,
             (REG_BLE_RD(BLE_BLEMPRIO0_ADDR) & ~((uint32_t)0xF0000000)) |
                 ((uint32_t)blem7 << 28));
}
...
__INLINE void ble_blem6_setf(uint8_t blem6) {
  ASSERT_ERR((((uint32_t)blem6 << 24) & ~((uint32_t)0x0F000000)) == 0);
  REG_BLE_WR(BLE_BLEMPRIO0_ADDR,
             (REG_BLE_RD(BLE_BLEMPRIO0_ADDR) & ~((uint32_t)0x0F000000)) |
                 ((uint32_t)blem6 << 24));
}
...
__INLINE void ble_blem5_setf(uint8_t blem5) {
  ASSERT_ERR((((uint32_t)blem5 << 20) & ~((uint32_t)0x00F00000)) == 0);
  REG_BLE_WR(BLE_BLEMPRIO0_ADDR,
             (REG_BLE_RD(BLE_BLEMPRIO0_ADDR) & ~((uint32_t)0x00F00000)) |
                 ((uint32_t)blem5 << 20));
}
...
__INLINE void ble_blem4_setf(uint8_t blem4) {
  ASSERT_ERR((((uint32_t)blem4 << 16) & ~((uint32_t)0x000F0000)) == 0);
  REG_BLE_WR(BLE_BLEMPRIO0_ADDR,
             (REG_BLE_RD(BLE_BLEMPRIO0_ADDR) & ~((uint32_t)0x000F0000)) |
                 ((uint32_t)blem4 << 16));
}
...
__INLINE void ble_blem3_setf(uint8_t blem3) {
  ASSERT_ERR((((uint32_t)blem3 << 12) & ~((uint32_t)0x0000F000)) == 0);
  REG_BLE_WR(BLE_BLEMPRIO0_ADDR,
             (REG_BLE_RD(BLE_BLEMPRIO0_ADDR) & ~((uint32_t)0x0000F000)) |
                 ((uint32_t)blem3 << 12));
}
...
__INLINE void ble_blem2_setf(uint8_t blem2) {
  ASSERT_ERR((((uint32_t)blem2 << 8) & ~((uint32_t)0x00000F00)) == 0);
  REG_BLE_WR(BLE_BLEMPRIO0_ADDR,
             (REG_BLE_RD(BLE_BLEMPRIO0_ADDR) & ~((uint32_t)0x00000F00)) |
                 ((uint32_t)blem2 << 8));
}
...
__INLINE void ble_blem1_setf(uint8_t blem1) {
  ASSERT_ERR((((uint32_t)blem1 << 4) & ~((uint32_t)0x000000F0)) == 0);
  REG_BLE_WR(BLE_BLEMPRIO0_ADDR,
             (REG_BLE_RD(BLE_BLEMPRIO0_ADDR) & ~((uint32_t)0x000000F0)) |
                 ((uint32_t)blem1 << 4));
}
...
__INLINE void ble_blem0_setf(uint8_t blem0) {
  ASSERT_ERR((((uint32_t)blem0 << 0) & ~((uint32_t)0x0000000F)) == 0);
  REG_BLE_WR(BLE_BLEMPRIO0_ADDR,
             (REG_BLE_RD(BLE_BLEMPRIO0_ADDR) & ~((uint32_t)0x0000000F)) |
                 ((uint32_t)blem0 << 0));
}
...
__INLINE void ble_bleprioscharb_pack(uint8_t blepriomode, uint8_t blemargin) {
  ...
  REG_BLE_WR(BLE_BLEPRIOSCHARB_ADDR,
             ((uint32_t)blepriomode << 15) | ((uint32_t)blemargin << 0));
}

__INLINE void ble_bleprioscharb_unpack(uint8_t* blepriomode,
                                       uint8_t* blemargin) {
...
__INLINE void ble_blepriomode_setf(uint8_t blepriomode) {
  ASSERT_ERR((((uint32_t)blepriomode << 15) & ~((uint32_t)0x00008000)) == 0);
  REG_BLE_WR(BLE_BLEPRIOSCHARB_ADDR,
             (REG_BLE_RD(BLE_BLEPRIOSCHARB_ADDR) & ~((uint32_t)0x00008000)) |
                 ((uint32_t)blepriomode << 15));
}
...
__INLINE void ble_blemargin_setf(uint8_t blemargin) {
  ASSERT_ERR((((uint32_t)blemargin << 0) & ~((uint32_t)0x000000FF)) == 0);
  REG_BLE_WR(BLE_BLEPRIOSCHARB_ADDR,
             (REG_BLE_RD(BLE_BLEPRIOSCHARB_ADDR) & ~((uint32_t)0x000000FF)) |
                 ((uint32_t)blemargin << 0));
}
