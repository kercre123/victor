...
__INLINE uint32_t mdm_version_get(void) { return REG_RPL_RD(MDM_VERSION_ADDR); }
...
__INLINE void mdm_version_unpack(uint8_t* typ, uint8_t* rel, uint8_t* upg,
                                 uint8_t* build) {
...
__INLINE void mdm_mdm_cntl_pack(uint8_t dualmodeen, uint8_t rxfebypass) {
  ...
  REG_RPL_WR(MDM_MDM_CNTL_ADDR,
             ((uint32_t)dualmodeen << 1) | ((uint32_t)rxfebypass << 0));
}
...
__INLINE void mdm_dual_mode_en_setf(uint8_t dualmodeen) {
  ASSERT_ERR((((uint32_t)dualmodeen << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_RPL_WR(MDM_MDM_CNTL_ADDR,
             (REG_RPL_RD(MDM_MDM_CNTL_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)dualmodeen << 1));
}
...
__INLINE void mdm_rxfe_bypass_setf(uint8_t rxfebypass) {
  ASSERT_ERR((((uint32_t)rxfebypass << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(MDM_MDM_CNTL_ADDR,
             (REG_RPL_RD(MDM_MDM_CNTL_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)rxfebypass << 0));
}
...
__INLINE uint32_t mdm_clkcntl_get(void) { return REG_RPL_RD(MDM_CLKCNTL_ADDR); }
...
__INLINE void mdm_clkcntl_pack(uint8_t forcegclk, uint8_t rxgclken,
                               uint8_t rxdpskgclken, uint8_t rxacdlgclken,
                               uint8_t rxgfskgclken, uint8_t txgclken,
                               uint8_t txdpskgclken, uint8_t txgfskgclken) {
  ...
  REG_RPL_WR(MDM_CLKCNTL_ADDR,
             ((uint32_t)forcegclk << 8) | ((uint32_t)rxgclken << 7) |
                 ((uint32_t)rxdpskgclken << 6) | ((uint32_t)rxacdlgclken << 5) |
                 ((uint32_t)rxgfskgclken << 4) | ((uint32_t)txgclken << 2) |
                 ((uint32_t)txdpskgclken << 1) | ((uint32_t)txgfskgclken << 0));
}

__INLINE void mdm_clkcntl_unpack(uint8_t* forcegclk, uint8_t* rxgclken,
                                 uint8_t* rxdpskgclken, uint8_t* rxacdlgclken,
                                 uint8_t* rxgfskgclken, uint8_t* txgclken,
                                 uint8_t* txdpskgclken, uint8_t* txgfskgclken) {
...
__INLINE void mdm_force_gclk_setf(uint8_t forcegclk) {
  ASSERT_ERR((((uint32_t)forcegclk << 8) & ~((uint32_t)0x00000100)) == 0);
  REG_RPL_WR(MDM_CLKCNTL_ADDR,
             (REG_RPL_RD(MDM_CLKCNTL_ADDR) & ~((uint32_t)0x00000100)) |
                 ((uint32_t)forcegclk << 8));
}
...
__INLINE void mdm_rx_gclk_en_setf(uint8_t rxgclken) {
  ASSERT_ERR((((uint32_t)rxgclken << 7) & ~((uint32_t)0x00000080)) == 0);
  REG_RPL_WR(MDM_CLKCNTL_ADDR,
             (REG_RPL_RD(MDM_CLKCNTL_ADDR) & ~((uint32_t)0x00000080)) |
                 ((uint32_t)rxgclken << 7));
}
...
__INLINE void mdm_rxdpsk_gclk_en_setf(uint8_t rxdpskgclken) {
  ASSERT_ERR((((uint32_t)rxdpskgclken << 6) & ~((uint32_t)0x00000040)) == 0);
  REG_RPL_WR(MDM_CLKCNTL_ADDR,
             (REG_RPL_RD(MDM_CLKCNTL_ADDR) & ~((uint32_t)0x00000040)) |
                 ((uint32_t)rxdpskgclken << 6));
}
...
__INLINE void mdm_rxacdl_gclk_en_setf(uint8_t rxacdlgclken) {
  ASSERT_ERR((((uint32_t)rxacdlgclken << 5) & ~((uint32_t)0x00000020)) == 0);
  REG_RPL_WR(MDM_CLKCNTL_ADDR,
             (REG_RPL_RD(MDM_CLKCNTL_ADDR) & ~((uint32_t)0x00000020)) |
                 ((uint32_t)rxacdlgclken << 5));
}
...
__INLINE void mdm_rxgfsk_gclk_en_setf(uint8_t rxgfskgclken) {
  ASSERT_ERR((((uint32_t)rxgfskgclken << 4) & ~((uint32_t)0x00000010)) == 0);
  REG_RPL_WR(MDM_CLKCNTL_ADDR,
             (REG_RPL_RD(MDM_CLKCNTL_ADDR) & ~((uint32_t)0x00000010)) |
                 ((uint32_t)rxgfskgclken << 4));
}
...
__INLINE void mdm_tx_gclk_en_setf(uint8_t txgclken) {
  ASSERT_ERR((((uint32_t)txgclken << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_RPL_WR(MDM_CLKCNTL_ADDR,
             (REG_RPL_RD(MDM_CLKCNTL_ADDR) & ~((uint32_t)0x00000004)) |
                 ((uint32_t)txgclken << 2));
}
...
__INLINE void mdm_txdpsk_gclk_en_setf(uint8_t txdpskgclken) {
  ASSERT_ERR((((uint32_t)txdpskgclken << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_RPL_WR(MDM_CLKCNTL_ADDR,
             (REG_RPL_RD(MDM_CLKCNTL_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)txdpskgclken << 1));
}
...
__INLINE void mdm_txgfsk_gclk_en_setf(uint8_t txgfskgclken) {
  ASSERT_ERR((((uint32_t)txgfskgclken << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(MDM_CLKCNTL_ADDR,
             (REG_RPL_RD(MDM_CLKCNTL_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)txgfskgclken << 0));
}
...
__INLINE void mdm_rx_startupdel_pack(uint8_t beforerxstart,
                                     uint8_t rxstartupdel) {
  ASSERT_ERR((((uint32_t)beforerxstart << 16) & ~((uint32_t)0x000F0000)) == 0);
  ASSERT_ERR((((uint32_t)rxstartupdel << 0) & ~((uint32_t)0x000000FF)) == 0);
  REG_RPL_WR(MDM_RX_STARTUPDEL_ADDR,
             ((uint32_t)beforerxstart << 16) | ((uint32_t)rxstartupdel << 0));
}

__INLINE void mdm_rx_startupdel_unpack(uint8_t* beforerxstart,
                                       uint8_t* rxstartupdel) {
...
__INLINE void mdm_before_rxstart_setf(uint8_t beforerxstart) {
  ASSERT_ERR((((uint32_t)beforerxstart << 16) & ~((uint32_t)0x000F0000)) == 0);
  REG_RPL_WR(MDM_RX_STARTUPDEL_ADDR,
             (REG_RPL_RD(MDM_RX_STARTUPDEL_ADDR) & ~((uint32_t)0x000F0000)) |
                 ((uint32_t)beforerxstart << 16));
}
...
__INLINE void mdm_rx_startupdel_setf(uint8_t rxstartupdel) {
  ASSERT_ERR((((uint32_t)rxstartupdel << 0) & ~((uint32_t)0x000000FF)) == 0);
  REG_RPL_WR(MDM_RX_STARTUPDEL_ADDR,
             (REG_RPL_RD(MDM_RX_STARTUPDEL_ADDR) & ~((uint32_t)0x000000FF)) |
                 ((uint32_t)rxstartupdel << 0));
}
...
__INLINE void mdm_tx_startupdel_pack(uint8_t beforetxstart,
                                     uint8_t txstartupdel) {
  ASSERT_ERR((((uint32_t)beforetxstart << 16) & ~((uint32_t)0x000F0000)) == 0);
  ASSERT_ERR((((uint32_t)txstartupdel << 0) & ~((uint32_t)0x000000FF)) == 0);
  REG_RPL_WR(MDM_TX_STARTUPDEL_ADDR,
             ((uint32_t)beforetxstart << 16) | ((uint32_t)txstartupdel << 0));
}

__INLINE void mdm_tx_startupdel_unpack(uint8_t* beforetxstart,
                                       uint8_t* txstartupdel) {
...
__INLINE void mdm_before_txstart_setf(uint8_t beforetxstart) {
  ASSERT_ERR((((uint32_t)beforetxstart << 16) & ~((uint32_t)0x000F0000)) == 0);
  REG_RPL_WR(MDM_TX_STARTUPDEL_ADDR,
             (REG_RPL_RD(MDM_TX_STARTUPDEL_ADDR) & ~((uint32_t)0x000F0000)) |
                 ((uint32_t)beforetxstart << 16));
}
...
__INLINE void mdm_tx_startupdel_setf(uint8_t txstartupdel) {
  ASSERT_ERR((((uint32_t)txstartupdel << 0) & ~((uint32_t)0x000000FF)) == 0);
  REG_RPL_WR(MDM_TX_STARTUPDEL_ADDR,
             (REG_RPL_RD(MDM_TX_STARTUPDEL_ADDR) & ~((uint32_t)0x000000FF)) |
                 ((uint32_t)txstartupdel << 0));
}
...
__INLINE void mdm_tx_gfskmode_pack(uint8_t fmtx2pen, uint8_t fmtxen) {
  ...
  REG_RPL_WR(MDM_TX_GFSKMODE_ADDR,
             ((uint32_t)fmtx2pen << 1) | ((uint32_t)fmtxen << 0));
}
...
__INLINE void mdm_fmtx2pen_setf(uint8_t fmtx2pen) {
  ASSERT_ERR((((uint32_t)fmtx2pen << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_RPL_WR(MDM_TX_GFSKMODE_ADDR,
             (REG_RPL_RD(MDM_TX_GFSKMODE_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)fmtx2pen << 1));
}
...
__INLINE void mdm_fmtxen_setf(uint8_t fmtxen) {
  ASSERT_ERR((((uint32_t)fmtxen << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(MDM_TX_GFSKMODE_ADDR,
             (REG_RPL_RD(MDM_TX_GFSKMODE_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)fmtxen << 0));
}
...
__INLINE uint32_t mdm_rx_pwr_get(void) { return REG_RPL_RD(MDM_RX_PWR_ADDR); }
...
__INLINE void mdm_rxfe_cntl_pack(uint8_t fedccen, uint8_t fefocen) {
  ...
  REG_RPL_WR(MDM_RXFE_CNTL_ADDR,
             ((uint32_t)fedccen << 1) | ((uint32_t)fefocen << 0));
}
...
__INLINE void mdm_fe_dccen_setf(uint8_t fedccen) {
  ASSERT_ERR((((uint32_t)fedccen << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_RPL_WR(MDM_RXFE_CNTL_ADDR,
             (REG_RPL_RD(MDM_RXFE_CNTL_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)fedccen << 1));
}
...
__INLINE void mdm_fe_focen_setf(uint8_t fefocen) {
  ASSERT_ERR((((uint32_t)fefocen << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(MDM_RXFE_CNTL_ADDR,
             (REG_RPL_RD(MDM_RXFE_CNTL_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)fefocen << 0));
}
...
__INLINE void mdm_rxgfsk_cntl_pack(uint8_t ledfeforceraw, uint8_t btdfeforceraw,
                                   uint8_t gfoenpl, uint8_t gfoensw,
                                   uint8_t psdavgen) {
  ...
  REG_RPL_WR(MDM_RXGFSK_CNTL_ADDR,
             ((uint32_t)ledfeforceraw << 7) | ((uint32_t)btdfeforceraw << 3) |
                 ((uint32_t)gfoenpl << 2) | ((uint32_t)gfoensw << 1) |
                 ((uint32_t)psdavgen << 0));
}

__INLINE void mdm_rxgfsk_cntl_unpack(uint8_t* ledfeforceraw,
                                     uint8_t* btdfeforceraw, uint8_t* gfoenpl,
                                     uint8_t* gfoensw, uint8_t* psdavgen) {
...
__INLINE void mdm_le_dfe_forceraw_setf(uint8_t ledfeforceraw) {
  ASSERT_ERR((((uint32_t)ledfeforceraw << 7) & ~((uint32_t)0x00000080)) == 0);
  REG_RPL_WR(MDM_RXGFSK_CNTL_ADDR,
             (REG_RPL_RD(MDM_RXGFSK_CNTL_ADDR) & ~((uint32_t)0x00000080)) |
                 ((uint32_t)ledfeforceraw << 7));
}
...
__INLINE void mdm_bt_dfe_forceraw_setf(uint8_t btdfeforceraw) {
  ASSERT_ERR((((uint32_t)btdfeforceraw << 3) & ~((uint32_t)0x00000008)) == 0);
  REG_RPL_WR(MDM_RXGFSK_CNTL_ADDR,
             (REG_RPL_RD(MDM_RXGFSK_CNTL_ADDR) & ~((uint32_t)0x00000008)) |
                 ((uint32_t)btdfeforceraw << 3));
}
...
__INLINE void mdm_gfo_enpl_setf(uint8_t gfoenpl) {
  ASSERT_ERR((((uint32_t)gfoenpl << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_RPL_WR(MDM_RXGFSK_CNTL_ADDR,
             (REG_RPL_RD(MDM_RXGFSK_CNTL_ADDR) & ~((uint32_t)0x00000004)) |
                 ((uint32_t)gfoenpl << 2));
}
...
__INLINE void mdm_gfo_ensw_setf(uint8_t gfoensw) {
  ASSERT_ERR((((uint32_t)gfoensw << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_RPL_WR(MDM_RXGFSK_CNTL_ADDR,
             (REG_RPL_RD(MDM_RXGFSK_CNTL_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)gfoensw << 1));
}
...
__INLINE void mdm_psd_avgen_setf(uint8_t psdavgen) {
  ASSERT_ERR((((uint32_t)psdavgen << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(MDM_RXGFSK_CNTL_ADDR,
             (REG_RPL_RD(MDM_RXGFSK_CNTL_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)psdavgen << 0));
}
...
__INLINE void mdm_gfo_init_pack(uint16_t gfoinitdel, uint16_t gfodplatency) {
  ...
  REG_RPL_WR(MDM_GFO_INIT_ADDR,
             ((uint32_t)gfoinitdel << 16) | ((uint32_t)gfodplatency << 0));
}

__INLINE void mdm_gfo_init_unpack(uint16_t* gfoinitdel,
                                  uint16_t* gfodplatency) {
...
__INLINE void mdm_gfo_initdel_setf(uint16_t gfoinitdel) {
  ASSERT_ERR((((uint32_t)gfoinitdel << 16) & ~((uint32_t)0x03FF0000)) == 0);
  REG_RPL_WR(MDM_GFO_INIT_ADDR,
             (REG_RPL_RD(MDM_GFO_INIT_ADDR) & ~((uint32_t)0x03FF0000)) |
                 ((uint32_t)gfoinitdel << 16));
}
...
__INLINE void mdm_gfo_dplatency_setf(uint16_t gfodplatency) {
  ASSERT_ERR((((uint32_t)gfodplatency << 0) & ~((uint32_t)0x000003FF)) == 0);
  REG_RPL_WR(MDM_GFO_INIT_ADDR,
             (REG_RPL_RD(MDM_GFO_INIT_ADDR) & ~((uint32_t)0x000003FF)) |
                 ((uint32_t)gfodplatency << 0));
}
...
__INLINE void mdm_rxdpsk_cntl_pack(uint16_t rrcgain, uint8_t rrcengain,
                                   uint8_t cocen, uint8_t dfdenfot,
                                   uint8_t foeen) {
  ...
  REG_RPL_WR(MDM_RXDPSK_CNTL_ADDR,
             ((uint32_t)rrcgain << 8) | ((uint32_t)rrcengain << 7) |
                 ((uint32_t)cocen << 2) | ((uint32_t)dfdenfot << 1) |
                 ((uint32_t)foeen << 0));
}

__INLINE void mdm_rxdpsk_cntl_unpack(uint16_t* rrcgain, uint8_t* rrcengain,
                                     uint8_t* cocen, uint8_t* dfdenfot,
                                     uint8_t* foeen) {
...
__INLINE void mdm_rrc_gain_setf(uint16_t rrcgain) {
  ASSERT_ERR((((uint32_t)rrcgain << 8) & ~((uint32_t)0x000FFF00)) == 0);
  REG_RPL_WR(MDM_RXDPSK_CNTL_ADDR,
             (REG_RPL_RD(MDM_RXDPSK_CNTL_ADDR) & ~((uint32_t)0x000FFF00)) |
                 ((uint32_t)rrcgain << 8));
}
...
__INLINE void mdm_rrc_engain_setf(uint8_t rrcengain) {
  ASSERT_ERR((((uint32_t)rrcengain << 7) & ~((uint32_t)0x00000080)) == 0);
  REG_RPL_WR(MDM_RXDPSK_CNTL_ADDR,
             (REG_RPL_RD(MDM_RXDPSK_CNTL_ADDR) & ~((uint32_t)0x00000080)) |
                 ((uint32_t)rrcengain << 7));
}
...
__INLINE void mdm_coc_en_setf(uint8_t cocen) {
  ASSERT_ERR((((uint32_t)cocen << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_RPL_WR(MDM_RXDPSK_CNTL_ADDR,
             (REG_RPL_RD(MDM_RXDPSK_CNTL_ADDR) & ~((uint32_t)0x00000004)) |
                 ((uint32_t)cocen << 2));
}
...
__INLINE void mdm_dfd_enfot_setf(uint8_t dfdenfot) {
  ASSERT_ERR((((uint32_t)dfdenfot << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_RPL_WR(MDM_RXDPSK_CNTL_ADDR,
             (REG_RPL_RD(MDM_RXDPSK_CNTL_ADDR) & ~((uint32_t)0x00000002)) |
                 ((uint32_t)dfdenfot << 1));
}
...
__INLINE void mdm_foe_en_setf(uint8_t foeen) {
  ASSERT_ERR((((uint32_t)foeen << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_RPL_WR(MDM_RXDPSK_CNTL_ADDR,
             (REG_RPL_RD(MDM_RXDPSK_CNTL_ADDR) & ~((uint32_t)0x00000001)) |
                 ((uint32_t)foeen << 0));
}
...
__INLINE void mdm_te_timeinit_pack(uint8_t beforetimeinit,
                                   uint16_t tetimeinit) {
  ASSERT_ERR((((uint32_t)beforetimeinit << 16) & ~((uint32_t)0x003F0000)) == 0);
  ASSERT_ERR((((uint32_t)tetimeinit << 0) & ~((uint32_t)0x000007FF)) == 0);
  REG_RPL_WR(MDM_TE_TIMEINIT_ADDR,
             ((uint32_t)beforetimeinit << 16) | ((uint32_t)tetimeinit << 0));
}

__INLINE void mdm_te_timeinit_unpack(uint8_t* beforetimeinit,
                                     uint16_t* tetimeinit) {
...
__INLINE void mdm_before_timeinit_setf(uint8_t beforetimeinit) {
  ASSERT_ERR((((uint32_t)beforetimeinit << 16) & ~((uint32_t)0x003F0000)) == 0);
  REG_RPL_WR(MDM_TE_TIMEINIT_ADDR,
             (REG_RPL_RD(MDM_TE_TIMEINIT_ADDR) & ~((uint32_t)0x003F0000)) |
                 ((uint32_t)beforetimeinit << 16));
}
...
__INLINE void mdm_te_timeinit_setf(uint16_t tetimeinit) {
  ASSERT_ERR((((uint32_t)tetimeinit << 0) & ~((uint32_t)0x000007FF)) == 0);
  REG_RPL_WR(MDM_TE_TIMEINIT_ADDR,
             (REG_RPL_RD(MDM_TE_TIMEINIT_ADDR) & ~((uint32_t)0x000007FF)) |
                 ((uint32_t)tetimeinit << 0));
}
...
__INLINE uint32_t mdm_coc_thr_get(void) { return REG_RPL_RD(MDM_COC_THR_ADDR); }
...
__INLINE uint32_t mdm_coc_td_get(void) { return REG_RPL_RD(MDM_COC_TD_ADDR); }
...
__INLINE uint32_t mdm_gsg_den_get(void) { return REG_RPL_RD(MDM_GSG_DEN_ADDR); }
...
__INLINE uint32_t mdm_gsg_nom_get(void) { return REG_RPL_RD(MDM_GSG_NOM_ADDR); }
...
__INLINE void mdm_gsg_dphi_den_pack(uint8_t legsgdphiden,
                                    uint8_t btgsgdphiden) {
  ASSERT_ERR((((uint32_t)legsgdphiden << 16) & ~((uint32_t)0x000F0000)) == 0);
  ASSERT_ERR((((uint32_t)btgsgdphiden << 0) & ~((uint32_t)0x0000000F)) == 0);
  REG_RPL_WR(MDM_GSG_DPHI_DEN_ADDR,
             ((uint32_t)legsgdphiden << 16) | ((uint32_t)btgsgdphiden << 0));
}

__INLINE void mdm_gsg_dphi_den_unpack(uint8_t* legsgdphiden,
                                      uint8_t* btgsgdphiden) {
...
__INLINE void mdm_le_gsg_dphi_den_setf(uint8_t legsgdphiden) {
  ASSERT_ERR((((uint32_t)legsgdphiden << 16) & ~((uint32_t)0x000F0000)) == 0);
  REG_RPL_WR(MDM_GSG_DPHI_DEN_ADDR,
             (REG_RPL_RD(MDM_GSG_DPHI_DEN_ADDR) & ~((uint32_t)0x000F0000)) |
                 ((uint32_t)legsgdphiden << 16));
}
...
__INLINE void mdm_bt_gsg_dphi_den_setf(uint8_t btgsgdphiden) {
  ASSERT_ERR((((uint32_t)btgsgdphiden << 0) & ~((uint32_t)0x0000000F)) == 0);
  REG_RPL_WR(MDM_GSG_DPHI_DEN_ADDR,
             (REG_RPL_RD(MDM_GSG_DPHI_DEN_ADDR) & ~((uint32_t)0x0000000F)) |
                 ((uint32_t)btgsgdphiden << 0));
}
...
__INLINE void mdm_gsg_dphi_nom_pack(uint8_t legsgdphinom,
                                    uint8_t btgsgdphinom) {
  ASSERT_ERR((((uint32_t)legsgdphinom << 16) & ~((uint32_t)0x007F0000)) == 0);
  ASSERT_ERR((((uint32_t)btgsgdphinom << 0) & ~((uint32_t)0x0000007F)) == 0);
  REG_RPL_WR(MDM_GSG_DPHI_NOM_ADDR,
             ((uint32_t)legsgdphinom << 16) | ((uint32_t)btgsgdphinom << 0));
}

__INLINE void mdm_gsg_dphi_nom_unpack(uint8_t* legsgdphinom,
                                      uint8_t* btgsgdphinom) {
...
__INLINE void mdm_le_gsg_dphi_nom_setf(uint8_t legsgdphinom) {
  ASSERT_ERR((((uint32_t)legsgdphinom << 16) & ~((uint32_t)0x007F0000)) == 0);
  REG_RPL_WR(MDM_GSG_DPHI_NOM_ADDR,
             (REG_RPL_RD(MDM_GSG_DPHI_NOM_ADDR) & ~((uint32_t)0x007F0000)) |
                 ((uint32_t)legsgdphinom << 16));
}
...
__INLINE void mdm_bt_gsg_dphi_nom_setf(uint8_t btgsgdphinom) {
  ASSERT_ERR((((uint32_t)btgsgdphinom << 0) & ~((uint32_t)0x0000007F)) == 0);
  REG_RPL_WR(MDM_GSG_DPHI_NOM_ADDR,
             (REG_RPL_RD(MDM_GSG_DPHI_NOM_ADDR) & ~((uint32_t)0x0000007F)) |
                 ((uint32_t)btgsgdphinom << 0));
}
...
__INLINE uint32_t mdm_dsg_den_get(void) { return REG_RPL_RD(MDM_DSG_DEN_ADDR); }
...
__INLINE uint32_t mdm_dsg_nom_get(void) { return REG_RPL_RD(MDM_DSG_NOM_ADDR); }
