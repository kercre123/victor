...
#define RESERVE_GPIO(name, port, pin, func)                           \
  {                                                                   \
    ...
    GPIO_status |= ((uint64_t)GPIO[port][pin] << pin) << (port * 16); \
  }
#else
#define RESERVE_GPIO(name, port, pin, func) \
  {}
 ...
 * @param[in] debounce_ms   duration of a debounce sequence before an IRQ is
 *generated
 * @return void
 ****************************************************************************************
 */
extern void GPIO_EnableIRQ(GPIO_PORT port, GPIO_PIN pin, IRQn_Type irq,
                           bool low_input, bool release_wait,
                           uint8_t debounce_ms);
 ...
 * @param[in] level     Input level that triggers the GPIO IRQ (see
 *GPIO_IRQ_INPUT_LEVEL)
 * @return void
 ****************************************************************************************
 */
 ...
 * @param[in] port     GPIO port
 * @param[in] pin      GPIO pin
 * @param[in] mode     GPIO pin mode. INPUT = 0, INPUT_PULLUP = 0x100,
 *INPUT_PULLDOWN = 0x200, OUTPUT = 0x300,
 * @param[in] function GPIO pin usage. GPIO_FUNCTION enumeration.
 * @return void
 ****************************************************************************************
 */
extern void GPIO_SetPinFunction(GPIO_PORT port, GPIO_PIN pin, GPIO_PUPD mode,
                                GPIO_FUNCTION function);

/**
 ****************************************************************************************
 * @brief Combined function to set the state and the type and mode of the GPIO
 *pin.
 * @param[in] port     GPIO port
 * @param[in] pin      GPIO pin
 * @param[in] mode     GPIO pin mode. INPUT = 0, INPUT_PULLUP = 0x100,
 ...
 ****************************************************************************************
 */
extern void GPIO_ConfigurePin(GPIO_PORT port, GPIO_PIN pin, GPIO_PUPD mode,
                              GPIO_FUNCTION function, const bool high);

/**
 ****************************************************************************************
 * @brief Sets a pin high. The GPIO should have been previously configured as
 *output!
 * @param[in] port     GPIO port
 * @param[in] pin      GPIO pin
 * @return void
...
/**
 ****************************************************************************************
 * @brief Sets the GPIO low. The GPIO should have been previously configured as
 *output!
 * @param[in] port     GPIO port
 * @param[in] pin      GPIO pin
 * @return void
...
/**
 ****************************************************************************************
 * @brief Gets the GPIO status. The GPIO should have been previously configured
 *as input!
 * @param[in] port     GPIO port
 * @param[in] pin      GPIO pin
 ...
 ****************************************************************************************
 */
extern void GPIO_ConfigurePinPower(GPIO_PORT port, GPIO_PIN pin,
                                   GPIO_POWER_RAIL power_rail);
