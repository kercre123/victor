...
// CAN'T FIND REGISTER "UART_DLM_ADDR" IN 580 DS, SO NO REPLACEMENT YET?? SEE
// LINE 465 action done DLM IS A divisor latch registers (RW) ->
// UART_DLH_REG(0X50001004) == UART_IER_DLH_REG
...
__INLINE uint32_t uart_rhr_get(void) { return REG_PL_RD(UART_RHR_ADDR); }
__INLINE uint32_t uart2_rhr_get(void) { return REG_PL_RD(UART2_RHR_ADDR); }

__INLINE void uart_rhr_set(uint32_t value) { REG_PL_WR(UART_RHR_ADDR, value); }
...
__INLINE void uart_thr_set(uint32_t value) { REG_PL_WR(UART_THR_ADDR, value); }
...
__INLINE uint32_t uart_dll_get(void) { return REG_PL_RD(UART_DLL_ADDR); }
__INLINE uint32_t uart2_dll_get(void) { return REG_PL_RD(UART2_DLL_ADDR); }

__INLINE void uart_dll_set(uint32_t value) { REG_PL_WR(UART_DLL_ADDR, value); }
 ...
 * </pre>
 */
// REMARK WIK-> I MISS UART_IER_DLH_REG.PTIME_dlh7 (bit7) in above mentioned
...
__INLINE uint32_t uart_ier_get(void) { return REG_PL_RD(UART_IER_ADDR); }
__INLINE uint32_t uart2_ier_get(void) { return REG_PL_RD(UART2_IER_ADDR); }

__INLINE void uart_ier_set(uint32_t value) { REG_PL_WR(UART_IER_ADDR, value); }
...
__INLINE void uart_ier_pack(uint8_t modemstat, uint8_t linestat,
                            uint8_t thrempty, uint8_t recdataavail) {
  ...
  REG_PL_WR(UART_IER_ADDR,
            ((uint32_t)modemstat << 3) | ((uint32_t)linestat << 2) |
                ((uint32_t)thrempty << 1) | ((uint32_t)recdataavail << 0));
}
__INLINE void uart2_ier_pack(uint8_t modemstat, uint8_t linestat,
                             uint8_t thrempty, uint8_t recdataavail) {
  ASSERT_ERR((((uint32_t)modemstat << 3) & ~((uint32_t)0x00000008)) == 0);
  ASSERT_ERR((((uint32_t)linestat << 2) & ~((uint32_t)0x00000004)) == 0);
  ASSERT_ERR((((uint32_t)thrempty << 1) & ~((uint32_t)0x00000002)) == 0);
  ASSERT_ERR((((uint32_t)recdataavail << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_PL_WR(UART2_IER_ADDR,
            ((uint32_t)modemstat << 3) | ((uint32_t)linestat << 2) |
                ((uint32_t)thrempty << 1) | ((uint32_t)recdataavail << 0));
}

__INLINE void uart_ier_unpack(uint8_t* modemstat, uint8_t* linestat,
                              uint8_t* thrempty, uint8_t* recdataavail) {
...
__INLINE void uart2_ier_unpack(uint8_t* modemstat, uint8_t* linestat,
                               uint8_t* thrempty, uint8_t* recdataavail) {
...
__INLINE void uart_modem_stat_setf(uint8_t modemstat) {
  ASSERT_ERR((((uint32_t)modemstat << 3) & ~((uint32_t)0x00000008)) == 0);
  REG_PL_WR(UART_IER_ADDR,
            (REG_PL_RD(UART_IER_ADDR) & ~((uint32_t)0x00000008)) |
                ((uint32_t)modemstat << 3));
}
__INLINE void uart2_modem_stat_setf(uint8_t modemstat) {
  ASSERT_ERR((((uint32_t)modemstat << 3) & ~((uint32_t)0x00000008)) == 0);
  REG_PL_WR(UART2_IER_ADDR,
            (REG_PL_RD(UART2_IER_ADDR) & ~((uint32_t)0x00000008)) |
                ((uint32_t)modemstat << 3));
}
...
__INLINE void uart_line_stat_setf(uint8_t linestat) {
  ASSERT_ERR((((uint32_t)linestat << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_PL_WR(UART_IER_ADDR,
            (REG_PL_RD(UART_IER_ADDR) & ~((uint32_t)0x00000004)) |
                ((uint32_t)linestat << 2));
}
__INLINE void uart2_line_stat_setf(uint8_t linestat) {
  ASSERT_ERR((((uint32_t)linestat << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_PL_WR(UART2_IER_ADDR,
            (REG_PL_RD(UART2_IER_ADDR) & ~((uint32_t)0x00000004)) |
                ((uint32_t)linestat << 2));
}
...
__INLINE void uart_thr_empty_setf(
    uint8_t thrempty)  // enable transmit interrupt
{
  ASSERT_ERR((((uint32_t)thrempty << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_PL_WR(UART_IER_ADDR,
            (REG_PL_RD(UART_IER_ADDR) & ~((uint32_t)0x00000002)) |
                ((uint32_t)thrempty << 1));
}
__INLINE void uart2_thr_empty_setf(
    uint8_t thrempty)  // enable transmit interrupt
{
  ASSERT_ERR((((uint32_t)thrempty << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_PL_WR(UART2_IER_ADDR,
            (REG_PL_RD(UART2_IER_ADDR) & ~((uint32_t)0x00000002)) |
                ((uint32_t)thrempty << 1));
}
...
__INLINE void uart_rec_data_avail_setf(uint8_t recdataavail) {
  ASSERT_ERR((((uint32_t)recdataavail << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_PL_WR(UART_IER_ADDR,
            (REG_PL_RD(UART_IER_ADDR) & ~((uint32_t)0x00000001)) |
                ((uint32_t)recdataavail << 0));
}
__INLINE void uart2_rec_data_avail_setf(uint8_t recdataavail) {
  ASSERT_ERR((((uint32_t)recdataavail << 0) & ~((uint32_t)0x00000001)) == 0);
  REG_PL_WR(UART2_IER_ADDR,
            (REG_PL_RD(UART2_IER_ADDR) & ~((uint32_t)0x00000001)) |
                ((uint32_t)recdataavail << 0));
}
...
__INLINE uint32_t uart_isr_get(void) { return REG_PL_RD(UART_ISR_ADDR); }

__INLINE uint32_t uart2_isr_get(void) { return REG_PL_RD(UART2_ISR_ADDR); }
...
__INLINE uint32_t uart_dlm_get(void) { return REG_PL_RD(UART_DLM_ADDR); }
__INLINE uint32_t uart2_dlm_get(void) { return REG_PL_RD(UART2_DLM_ADDR); }

__INLINE void uart_dlm_set(uint32_t value) { REG_PL_WR(UART_DLM_ADDR, value); }
...
__INLINE uint32_t uart_lcr_get(void) { return REG_PL_RD(UART_LCR_ADDR); }
__INLINE uint32_t uart2_lcr_get(void) { return REG_PL_RD(UART2_LCR_ADDR); }

__INLINE void uart_lcr_set(uint32_t value) { REG_PL_WR(UART_LCR_ADDR, value); }
...
__INLINE void uart_lcr_pack(uint8_t dlab, uint8_t breaktx, uint8_t parity,
                            uint8_t parityen, uint8_t stop, uint8_t wordlen) {
  ...
  REG_PL_WR(UART_LCR_ADDR,
            ((uint32_t)dlab << 7) | ((uint32_t)breaktx << 6) |
                ((uint32_t)parity << 4) | ((uint32_t)parityen << 3) |
                ((uint32_t)stop << 2) | ((uint32_t)wordlen << 0));
}
__INLINE void uart2_lcr_pack(uint8_t dlab, uint8_t breaktx, uint8_t parity,
                             uint8_t parityen, uint8_t stop, uint8_t wordlen) {
  ASSERT_ERR((((uint32_t)dlab << 7) & ~((uint32_t)0x00000080)) == 0);
  ASSERT_ERR((((uint32_t)breaktx << 6) & ~((uint32_t)0x00000040)) == 0);
  ASSERT_ERR((((uint32_t)parity << 4) & ~((uint32_t)0x00000030)) == 0);
  ...
  ASSERT_ERR((((uint32_t)stop << 2) & ~((uint32_t)0x00000004)) == 0);
  ASSERT_ERR((((uint32_t)wordlen << 0) & ~((uint32_t)0x00000003)) == 0);
  REG_PL_WR(UART2_LCR_ADDR,
            ((uint32_t)dlab << 7) | ((uint32_t)breaktx << 6) |
                ((uint32_t)parity << 4) | ((uint32_t)parityen << 3) |
                ((uint32_t)stop << 2) | ((uint32_t)wordlen << 0));
}

__INLINE void uart_lcr_unpack(uint8_t* dlab, uint8_t* breaktx, uint8_t* parity,
                              uint8_t* parityen, uint8_t* stop,
                              uint8_t* wordlen) {
...
__INLINE void uart2_lcr_unpack(uint8_t* dlab, uint8_t* breaktx, uint8_t* parity,
                               uint8_t* parityen, uint8_t* stop,
                               uint8_t* wordlen) {
...
__INLINE void uart_dlab_setf(uint8_t dlab) {
  ASSERT_ERR((((uint32_t)dlab << 7) & ~((uint32_t)0x00000080)) == 0);
  REG_PL_WR(UART_LCR_ADDR,
            (REG_PL_RD(UART_LCR_ADDR) & ~((uint32_t)0x00000080)) |
                ((uint32_t)dlab << 7));
}
__INLINE void uart2_dlab_setf(uint8_t dlab) {
  ASSERT_ERR((((uint32_t)dlab << 7) & ~((uint32_t)0x00000080)) == 0);
  REG_PL_WR(UART2_LCR_ADDR,
            (REG_PL_RD(UART2_LCR_ADDR) & ~((uint32_t)0x00000080)) |
                ((uint32_t)dlab << 7));
}
...
__INLINE void uart_break_tx_setf(uint8_t breaktx) {
  ASSERT_ERR((((uint32_t)breaktx << 6) & ~((uint32_t)0x00000040)) == 0);
  REG_PL_WR(UART_LCR_ADDR,
            (REG_PL_RD(UART_LCR_ADDR) & ~((uint32_t)0x00000040)) |
                ((uint32_t)breaktx << 6));
}
__INLINE void uart2_break_tx_setf(uint8_t breaktx) {
  ASSERT_ERR((((uint32_t)breaktx << 6) & ~((uint32_t)0x00000040)) == 0);
  REG_PL_WR(UART2_LCR_ADDR,
            (REG_PL_RD(UART2_LCR_ADDR) & ~((uint32_t)0x00000040)) |
                ((uint32_t)breaktx << 6));
}
...
__INLINE void uart_parity_setf(uint8_t parity) {
  ASSERT_ERR((((uint32_t)parity << 4) & ~((uint32_t)0x00000030)) == 0);
  REG_PL_WR(UART_LCR_ADDR,
            (REG_PL_RD(UART_LCR_ADDR) & ~((uint32_t)0x00000030)) |
                ((uint32_t)parity << 4));
}
__INLINE void uart2_parity_setf(uint8_t parity) {
  ASSERT_ERR((((uint32_t)parity << 4) & ~((uint32_t)0x00000030)) == 0);
  REG_PL_WR(UART2_LCR_ADDR,
            (REG_PL_RD(UART2_LCR_ADDR) & ~((uint32_t)0x00000030)) |
                ((uint32_t)parity << 4));
}
...
__INLINE void uart_parity_en_setf(uint8_t parityen) {
  ASSERT_ERR((((uint32_t)parityen << 3) & ~((uint32_t)0x00000008)) == 0);
  REG_PL_WR(UART_LCR_ADDR,
            (REG_PL_RD(UART_LCR_ADDR) & ~((uint32_t)0x00000008)) |
                ((uint32_t)parityen << 3));
}
__INLINE void uart2_parity_en_setf(uint8_t parityen) {
  ASSERT_ERR((((uint32_t)parityen << 3) & ~((uint32_t)0x00000008)) == 0);
  REG_PL_WR(UART2_LCR_ADDR,
            (REG_PL_RD(UART2_LCR_ADDR) & ~((uint32_t)0x00000008)) |
                ((uint32_t)parityen << 3));
}
...
__INLINE void uart_stop_setf(uint8_t stop) {
  ASSERT_ERR((((uint32_t)stop << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_PL_WR(UART_LCR_ADDR,
            (REG_PL_RD(UART_LCR_ADDR) & ~((uint32_t)0x00000004)) |
                ((uint32_t)stop << 2));
}
__INLINE void uart2_stop_setf(uint8_t stop) {
  ASSERT_ERR((((uint32_t)stop << 2) & ~((uint32_t)0x00000004)) == 0);
  REG_PL_WR(UART2_LCR_ADDR,
            (REG_PL_RD(UART2_LCR_ADDR) & ~((uint32_t)0x00000004)) |
                ((uint32_t)stop << 2));
}
...
__INLINE void uart_word_len_setf(uint8_t wordlen) {
  ASSERT_ERR((((uint32_t)wordlen << 0) & ~((uint32_t)0x00000003)) == 0);
  REG_PL_WR(UART_LCR_ADDR,
            (REG_PL_RD(UART_LCR_ADDR) & ~((uint32_t)0x00000003)) |
                ((uint32_t)wordlen << 0));
}
__INLINE void uart2_word_len_setf(uint8_t wordlen) {
  ASSERT_ERR((((uint32_t)wordlen << 0) & ~((uint32_t)0x00000003)) == 0);
  REG_PL_WR(UART2_LCR_ADDR,
            (REG_PL_RD(UART2_LCR_ADDR) & ~((uint32_t)0x00000003)) |
                ((uint32_t)wordlen << 0));
}
...
__INLINE uint32_t uart_mcr_get(void) { return REG_PL_RD(UART_MCR_ADDR); }
__INLINE uint32_t uart2_mcr_get(void) { return REG_PL_RD(UART2_MCR_ADDR); }

__INLINE void uart_mcr_set(uint32_t value) { REG_PL_WR(UART_MCR_ADDR, value); }
...
__INLINE void uart_mcr_pack(uint8_t extfunc, uint8_t autorts, uint8_t autocts,
                            uint8_t rts) {
  ...
  REG_PL_WR(UART_MCR_ADDR, ((uint32_t)extfunc << 7) | ((uint32_t)autorts << 6) |
                               ((uint32_t)autocts << 5) | ((uint32_t)rts << 1));
}
__INLINE void uart2_mcr_pack(uint8_t extfunc, uint8_t autorts, uint8_t autocts,
                             uint8_t rts) {
  ASSERT_ERR((((uint32_t)extfunc << 7) & ~((uint32_t)0x00000080)) == 0);
  ASSERT_ERR((((uint32_t)autorts << 6) & ~((uint32_t)0x00000040)) == 0);
  ASSERT_ERR((((uint32_t)autocts << 5) & ~((uint32_t)0x00000020)) == 0);
  ASSERT_ERR((((uint32_t)rts << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_PL_WR(UART2_MCR_ADDR,
            ((uint32_t)extfunc << 7) | ((uint32_t)autorts << 6) |
                ((uint32_t)autocts << 5) | ((uint32_t)rts << 1));
}

__INLINE void uart_mcr_unpack(uint8_t* extfunc, uint8_t* autorts,
                              uint8_t* autocts, uint8_t* rts) {
...
__INLINE void uart2_mcr_unpack(uint8_t* extfunc, uint8_t* autorts,
                               uint8_t* autocts, uint8_t* rts) {
...
__INLINE void uart_ext_func_setf(uint8_t extfunc) {
  ASSERT_ERR((((uint32_t)extfunc << 7) & ~((uint32_t)0x00000080)) == 0);
  REG_PL_WR(UART_MCR_ADDR,
            (REG_PL_RD(UART_MCR_ADDR) & ~((uint32_t)0x00000080)) |
                ((uint32_t)extfunc << 7));
}
__INLINE void uart2_ext_func_setf(uint8_t extfunc) {
  ASSERT_ERR((((uint32_t)extfunc << 7) & ~((uint32_t)0x00000080)) == 0);
  REG_PL_WR(UART2_MCR_ADDR,
            (REG_PL_RD(UART2_MCR_ADDR) & ~((uint32_t)0x00000080)) |
                ((uint32_t)extfunc << 7));
}
...
__INLINE void uart_auto_rts_setf(uint8_t autorts) {
  ASSERT_ERR((((uint32_t)autorts << 6) & ~((uint32_t)0x00000040)) == 0);
  REG_PL_WR(UART_MCR_ADDR,
            (REG_PL_RD(UART_MCR_ADDR) & ~((uint32_t)0x00000040)) |
                ((uint32_t)autorts << 6));
}
__INLINE void uart2_auto_rts_setf(uint8_t autorts) {
  ASSERT_ERR((((uint32_t)autorts << 6) & ~((uint32_t)0x00000040)) == 0);
  REG_PL_WR(UART2_MCR_ADDR,
            (REG_PL_RD(UART2_MCR_ADDR) & ~((uint32_t)0x00000040)) |
                ((uint32_t)autorts << 6));
}
...
__INLINE void uart_auto_cts_setf(uint8_t autocts) {
  ASSERT_ERR((((uint32_t)autocts << 5) & ~((uint32_t)0x00000020)) == 0);
  REG_PL_WR(UART_MCR_ADDR,
            (REG_PL_RD(UART_MCR_ADDR) & ~((uint32_t)0x00000020)) |
                ((uint32_t)autocts << 5));
}
__INLINE void uart2_auto_cts_setf(uint8_t autocts) {
  ASSERT_ERR((((uint32_t)autocts << 5) & ~((uint32_t)0x00000020)) == 0);
  REG_PL_WR(UART2_MCR_ADDR,
            (REG_PL_RD(UART2_MCR_ADDR) & ~((uint32_t)0x00000020)) |
                ((uint32_t)autocts << 5));
}
...
__INLINE void uart_rts_setf(uint8_t rts) {
  ASSERT_ERR((((uint32_t)rts << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_PL_WR(UART_MCR_ADDR,
            (REG_PL_RD(UART_MCR_ADDR) & ~((uint32_t)0x00000002)) |
                ((uint32_t)rts << 1));
}
__INLINE void uart2_rts_setf(uint8_t rts) {
  ASSERT_ERR((((uint32_t)rts << 1) & ~((uint32_t)0x00000002)) == 0);
  REG_PL_WR(UART2_MCR_ADDR,
            (REG_PL_RD(UART2_MCR_ADDR) & ~((uint32_t)0x00000002)) |
                ((uint32_t)rts << 1));
}
...
__INLINE uint32_t uart_lsr_get(void) { return REG_PL_RD(UART_LSR_ADDR); }
__INLINE uint32_t uart2_lsr_get(void) { return REG_PL_RD(UART2_LSR_ADDR); }
...
__INLINE void uart_lsr_unpack(uint8_t* fifoerr, uint8_t* temt, uint8_t* thre,
                              uint8_t* breakrx, uint8_t* frameerr,
                              uint8_t* parityerr, uint8_t* overrun,
                              uint8_t* datardy) {
...
__INLINE void uart2_lsr_unpack(uint8_t* fifoerr, uint8_t* temt, uint8_t* thre,
                               uint8_t* breakrx, uint8_t* frameerr,
                               uint8_t* parityerr, uint8_t* overrun,
                               uint8_t* datardy) {
...
__INLINE uint32_t uart_msr_get(void) { return REG_PL_RD(UART_MSR_ADDR); }
__INLINE uint32_t uart2_msr_get(void) { return REG_PL_RD(UART2_MSR_ADDR); }
