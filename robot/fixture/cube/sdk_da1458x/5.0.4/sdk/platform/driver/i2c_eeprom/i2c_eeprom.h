...
/*      #define I2C_EEPROM_PAGE   8                // EEPROM's page size in
 * bytes          */
...
/*      #define I2C_EEPROM_PAGE   32               // EEPROM's page size in
 * bytes          */
/*      #define I2C_SPEED_MODE    I2C_FAST         // fast mode (400 kbits/s) */
/*      #define I2C_ADDRESS_MODE  I2C_7BIT_ADDR    // 7-bit addressing */
...
/*      #define I2C_EEPROM_PAGE   256               // EEPROM's page size in
 * bytes         */
/*      #define I2C_SPEED_MODE    I2C_FAST          // fast mode (400 kbits/s)
 */
/*      #define I2C_ADDRESS_MODE  I2C_7BIT_ADDR     // 7-bit addressing */
 ...
 ****************************************************************************************
 */
void i2c_eeprom_init(uint16_t dev_address, uint8_t speed, uint8_t address_mode,
 ...
 * @param[in|out] bytes_read  Bytes that were actually read (due to memory size
 *limitation)
 * @return i2c_error_code     Enumeration type that defines the returned error
 *code
 ****************************************************************************************
 */
i2c_error_code i2c_eeprom_read_data(uint8_t *rd_data_ptr, uint32_t address,
 ...
 * @param[in] address           Starting address of memory page (MUST BE
 *MULTIPLE OF I2C_EEPROM_PAGE)
 * @param[in] wr_data_ptr       Pointer to the first of the bytes to be written
 * @param[in] size              Size of the data to be written (MUST BE LESS OR
 *EQUAL TO I2C_EEPROM_PAGE)
 * @param[in|out] bytes_written Bytes that were actually written (due to memory
 *size limitation)
 * @return i2c_error_code       Enumeration type that defines the returned error
 *code
 ****************************************************************************************
 */
i2c_error_code i2c_eeprom_write_page(uint8_t *wr_data_ptr, uint32_t address,
                                     uint16_t size, uint32_t *bytes_written);
 ...
 ****************************************************************************************
 */
i2c_error_code i2c_eeprom_write_data(uint8_t *wr_data_ptr, uint32_t address,
