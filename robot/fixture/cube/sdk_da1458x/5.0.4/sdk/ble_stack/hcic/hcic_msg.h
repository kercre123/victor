 ...
 * @file hci_msg.h
 *
 * @brief Header file containing the definitions and structures corresponding to
 *the standard HCI messages: commands from Host, events from Controller.
 *
 ...
 *
 * This module contains the @ref HOST "HOST" - @ref Controller "Controller"
 *interface functionalities: message IDs and handlers. \n
 *
 * @{
 ****************************************************************************************
 */
...
/**
****************************************************************************************
* @brief HCI command unpack function for commands for which the received
*parameter buffer maps exactly to the structure used in the lower layers
*handler.
*
* @param bufptr Pointer to the buffer containing the received packet. Space is
*part of allocated kernel message prior to reception. This ke_msg will be
...
/**
****************************************************************************************
* @brief HCI Command unpacking function for commands addressed to LLC using
*connection handle only as parameter.
*
* @param bufptr Pointer to the buffer containing the received packet. Space is
*part of allocated kernel message prior to reception. This ke_msg will be
*updated with extracted data.
...
/**
****************************************************************************************
* @brief GENERAL COMMENT FOR hci_..._cmd_unpk : HCI function for LL Command
...
/**
****************************************************************************************
* @brief HCI function for packing basic command complete events, for commands
*with no return parameters or aligned return paramer struct
*
* @param ke_msg Pointer to the ke_msg containing the parameters necessary to
*create the HCI type packet. The ke_msg space is used for packing, and the
*message is queued before TX to avoid loss in case TX needs to be postponed.
*****************************************************************************************
*/
...
/**
****************************************************************************************
* @brief GENERAL COMMENT FOR hci_..._evt_pk : HCI function for Lower Layers
*event packing for transport to HL.
*
* @param ke_msg Pointer to the ke_msg containing the parameters necessary to
*create the HCI type packet. The ke_msg space is used for packing, and the
*message is queued before TX to avoid loss in case TX needs to be postponed.
...
/**
****************************************************************************************
* @brief HCI function for packing basic command status events - they all have
*the same components.
*
* @param ke_msg Pointer to the ke_msg containing the parameters necessary to
*create the HCI type packet. The ke_msg space is used for packing, and the
...
/**
 ****************************************************************************************
 * @brief Function handling the packing of data in view of transport through
 *HCI.
 *
 * This function is used in either of higher or lower layers, where it
 *translates the components of a TX descriptor into the packet contents and
 *respectively of a RX descriptor.
 *
 * @param[in,out] msg Pointer to the kernel message which contains the
 *parameters to send, and whose space is used to pack the HCI ACL packet
 *components.
 *
 *****************************************************************************************
 */
