...
/**
 ****************************************************************************************
 * @brief Check if device is filtered or not when a scan response data is
 *received
 *
 * If device is not filtered (present in filter list), in that case function
 *returns false and device is removed from filtered devices.
 *
 * @param[in] addr       Device address
 * @param[in] addr_type  Device address type
 *
