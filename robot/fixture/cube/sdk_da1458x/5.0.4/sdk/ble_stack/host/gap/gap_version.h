...
/// Major version. This value is coming from the assigned numbers and
/// corresponds to the version of specification that the host is following. For
...
#ifndef __DA14581__
/// Minor version. This value is incremented when new features are added to the
/// host
#define BLE_HOST_VERSION_MIN 7

/// Release number. This value is incremented for every delivery done to the
/// validation team prior to release to customer
