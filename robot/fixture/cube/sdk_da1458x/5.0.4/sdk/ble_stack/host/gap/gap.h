 ...
 *
 * The HOST layer of the stack contains the higher layer protocols (@ref ATT
 *"ATT",
 * @ref SMP "SMP") and transport module (@ref L2C "L2C"). It also includes the
 ...
 *
 * The GAP module is responsible for providing an API to the application in
 *order to configure the device in the desired mode (discoverable, connectable,
 *etc.) and perform required actions (scanning, connection, pairing, etc.). To
 *achieve this, the GAP interfaces with both the @ref SMP "SMP", @ref L2C "L2C"
 *and the @ref CONTROLLER "CONTROLLER"
 *
 * @{
 ****************************************************************************************
 */
