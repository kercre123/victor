 ...
 *
 * The GATT module is responsible for providing an API for all attribute related
 *operations. It is responsible for all the service framework activities using
 *the Attribute protocol for discovering services and for reading and writing
 *characteristic values on a peer device. To achieve this, the GATT interfaces
 *with @ref ATTM "ATTM", @ref ATTC "ATTC" and the
 * @ref ATTS "ATTS".
 *
 * @{
 ****************************************************************************************
