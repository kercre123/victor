 ...
 *
 * The ATTS module is responsible for handling messages intended for the
 *attribute profile server. It has defined interfaces with @ref ATTM "ATTM".
 *
 *
 * @{
 *
 ...
 *
 * After updating the value, the function sends an indication to the upper layer
 *profile or protocol task registered for the specified attribute.
 *
 * @param[in] conidx   connection index
 ...
 * @param[in] last     Informs that it's last request of a multiple prepare
 *write request.
 *
 *
 ****************************************************************************************
 */
void atts_update_elmt(uint8_t conidx, uint8_t *value, uint16_t length,
                      uint16_t offset, uint16_t handle, bool response,
                      bool last);
 ...
 ****************************************************************************************
 */
uint8_t atts_store_prep_data(uint8_t conidx, uint8_t *buf, uint16_t len,
