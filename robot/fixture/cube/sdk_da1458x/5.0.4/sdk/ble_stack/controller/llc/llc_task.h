 ...
 * specific connection with a peer (e.g. Encryption setup, Supervision timeout,
 *etc.). It implements the state machine related to these actions.
 *
 * @{
 ****************************************************************************************
 */
...
enum { TX_LVL_CURRENT, TX_LVL_MAX, TX_LVL_LEN };
...
/// llc command complete event structure for Long Term Key Request Negative
/// Reply Command
...
/// llc command complete event structure for LLC LE read remote used feature
/// Command
...
/// llc command complete event structure for the read transmit power level
/// command
...
/// llc command complete event structure for the read remote information version
/// command
...
#if BLE_STD_MODE
/// Unknown connection handle command complete event with status and connection
/// handle only.
