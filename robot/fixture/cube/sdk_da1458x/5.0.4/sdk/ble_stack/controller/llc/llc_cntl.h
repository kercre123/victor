 ...
 *transmission and reception of the control pdu.
 *
 * @{
 ****************************************************************************************
 */
...
typedef void (*llcp_pdu_unpk_func_t)(uint8_t *pdu, uint8_t parlen,
                                     uint8_t *param);
 ...
 * @param[in] rxdesc        Pointer oh the reception descriptor where the
 ...
 *
 * This function allocates an sets header and parameters of the pdu before
 *pushing it in the tx queue.
 *
 ...
 *
 * @param[in] conhdl        Connection handle on which the PDU will be sent.
 * @param[in] state         State to which the LLC has to be put to wait for the
 *ACK
 ****************************************************************************************
 */
 ...
 *
 * @param[in] conhdl        Connection handle on which the pdu will be sent.
 * @param[in] state         State to which we have to put the LLC after PDU
 *acknowledgment
 ****************************************************************************************
 */
 ...
 ****************************************************************************************
 */
void llc_enc_req_pdu_send(uint16_t conhdl,
                          struct llc_le_start_enc_cmd const *param);
 ...
 *updated parameters useful for the link.
 ****************************************************************************************
 */
 ...
 *
 * This function extracts the parameters from the control packet received and
 *takes the associated actions (new pdu generation, new state , parameters
 *update, etc...).
 *
 * @param[in] conhdl        Connection handle on which the pdu has been
 *received.
 * @param[in] param         Pointer on the received pdu parameters.
 ****************************************************************************************
 */
void llc_con_update_req_ind(uint16_t conhdl,
 ...
 ****************************************************************************************
 */
void llc_ch_map_req_ind(uint16_t conhdl,
                        struct llcp_channel_map_req const *param);
