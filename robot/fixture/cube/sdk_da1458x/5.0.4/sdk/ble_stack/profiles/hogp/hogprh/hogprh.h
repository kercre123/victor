...
/// HOGPRH HID Over GATT Profile Report Host role
...
/// Maximal number of Report Char. that can be added in the DB for one HIDS - Up
/// to 11
...
enum {
  ...
  HOGPRH_RD_HIDS_REPORT_MAP_EXT_REF_REF =
      (HOGPRH_DESC_MASK | HOGPRH_DESC_REPORT_MAP_EXT_REP_REF),
 ...
 ****************************************************************************************
 */
void hogprh_enable_cfm_send(struct hogprh_env_tag *hogprh_env,
 ...
 ****************************************************************************************
 */
void hogprh_char_req_rsp_send(struct hogprh_env_tag *hogprh_env,
