 ...
 * @file cscpc.h
 *
 * @brief Header file - Cycling Speed and Cadence Status Profile - Collector
 *Role.
 *
...
/// Internal codes for reading/writing a CSCS characteristic with one single
/// request
enum cscpc_codes {
 ...
 * descriptors for the Cycling Speed and Cadence Service
 */
...
/**
 ****************************************************************************************
 * @brief Send a CSCPC_CMP_EVT message when no connection exists (no
 *environment)
 ****************************************************************************************
 */
 ...
 ****************************************************************************************
 */
void cscpc_send_cmp_evt(struct cscpc_env_tag *cscpc_env, uint8_t operation,
                        uint8_t status);
