...
enum anps_msg_ids {
  ...
  /// Indicate that the notification configuration has been modified by the peer
  /// device
...
struct anps_enable_req {
  ...
  /// New Alert Characteristic - Saved Client Characteristic Configuration
  /// Descriptor Value
  uint16_t new_alert_ntf_cfg;
  /// Unread Alert Status Characteristic - Saved Client Characteristic
...
struct anps_disable_ind {
  /// Connection Handle
  uint16_t conhdl;
  /// New Alert Characteristic - Current Client Characteristic Configuration
  /// Descriptor Value
  uint16_t new_alert_ntf_cfg;
  /// Unread Alert Status Characteristic - Current Client Characteristic
  /// Configuration Descriptor Value
  uint16_t unread_alert_status_ntf_cfg;
};
...
struct anps_ntf_alert_cmd {
  /// Connection Handle
  uint16_t conhdl;
  /// Operation Code (ANPS_UPD_NEW_ALERT_OP_CODE or
  /// ANPS_UPD_UNREAD_ALERT_STATUS_OP_CODE)
  uint8_t operation;
