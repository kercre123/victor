 ...
 *
 * The Location and Navigation Profile is used to enable a collector device in
 *order to obtain data from a Location and Navigation Sensor (LAN Sensor) that
 *exposes the Location and Navigation Service.
 *
