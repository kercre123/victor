 ...
 *
 * The BMSCTASK is responsible for handling the messages coming in and out of
 *the
...
enum bmsc_msg_id {
  ...
  /// Confirm that cfg connection has finished with discovery results, or that
  /// normal cnx started
  BMSC_ENABLE_CFM,
...
/// Parameters of the @ref BMSC_WR_CTRL_POINT_REQ message - dynamically
/// allocated
