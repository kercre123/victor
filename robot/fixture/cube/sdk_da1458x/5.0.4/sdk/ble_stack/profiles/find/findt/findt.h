 ...
 *
 * In the Find Me BLE Profile, the device that is in Target role will act as
 *GATT server.
 *
 * The Target will react to alert levels written by the Locator in the Alert
 *Level Characteristic of the Immediate Alert Service(IAS) present in the ATT DB
 *of the device.
 *
 ...
 *
 *  The enable/disable of the profile and devices disconnection is handled in
 *the application, depending on its User Input.
 * @{
 ****************************************************************************************
 */
