...
enum {
  ...
  /// Read the value of a Client Characteristic Configuration Descriptor in the
  /// peer device database
  ANCC_READ_CMD,

  /// Write the value of a Client Characteristic Configuration Descriptor in the
  /// peer device database
  ANCC_WRITE_CMD,
  ...
  /// Indicate that a Client Characteristic Configuration Descriptor value has
  /// been read
  ANCC_CL_CFG_VAL_IND,

  /// Indicate that a notification of the Notification Source characteristic has
  /// been received
  ANCC_NTF_SRC_IND,
