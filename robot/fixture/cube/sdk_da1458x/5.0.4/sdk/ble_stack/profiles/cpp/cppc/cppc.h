...
/// CPPC Cycling Power Profile Collector role
...
/// Internal codes for reading/writing a CPS characteristic with one single
/// request
enum cppc_code {
 ...
 * descriptors for the Cycling Power Service
 */
 ...
 ****************************************************************************************
 */
void cppc_send_no_conn_cmp_evt(uint8_t src_id, uint8_t dest_id, uint16_t conhdl,
                               uint8_t operation);
 ...
 ****************************************************************************************
 */
void cppc_send_cmp_evt(struct cppc_env_tag *cppc_env, uint8_t operation,
                       uint8_t status);
