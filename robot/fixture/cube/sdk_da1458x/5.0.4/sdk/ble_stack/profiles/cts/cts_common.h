 ...
 * A value of 254 means Accuracy is out of range (> 31.5s). A value of 255 means
 * Accuracy is unknown.
 */
...
struct cts_ref_time_info {
   ...
   * 255 = 255 or more days (If Days Since Update = 255, then Hours Since Update
   * shall also be set to 255)
   */
