 ...
 * descriptor for the Current Time Service
 */
 ...
 ****************************************************************************************
 */
void ctsc_enable_cfm_send(struct ctsc_env_tag *ctsc_env,
                          struct prf_con_info *con_info, uint8_t status);

/**
 ****************************************************************************************
 * @brief Send error indication from service to Host, with proprietary status
 *codes.
 ...
 ****************************************************************************************
 */
void ctsc_unpack_curr_time_value(struct cts_curr_time *p_ct_val,
                                 uint8_t *packed_ct);
