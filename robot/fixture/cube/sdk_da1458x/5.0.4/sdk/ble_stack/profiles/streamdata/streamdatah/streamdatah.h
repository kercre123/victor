 ...
 *
 * The STREAMDATA module is the responsible block for implementing the
 *StreamData Profile functionalities in the BLE Host.
 *
 * The StreamData Profile defines the functionality required in a device that
 *can alert the user when the user's personal device moves further away or
 *closer together to another communicating device.
 *****************************************************************************************
 */
 ...
 *
 * The STREAMDATAH is responsible for providing StreamData Host Profile
 *functionalities to upper layer module or application. The device using this
 *profile takes the role of a StreamData Host role.
 *
 * @{
 ****************************************************************************************
 */
 ...
 ****************************************************************************************
 */
// void streamdatah_read_char_rsp_send(struct streamdatah_env_tag
// *streamdatah_env,
//                             struct gatt_read_char_resp *param, uint8_t
//                             status);
 ...
 ****************************************************************************************
 */
void streamdatah_write_char_rsp_send(
    struct streamdatah_env_tag *streamdatah_env, uint8_t status);
