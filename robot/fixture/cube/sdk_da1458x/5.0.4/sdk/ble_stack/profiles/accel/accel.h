 ...
 *
 * The ACCEL module is the responsible block for implementing the Accelerator
...
/// Accelerometer Device Server Role
#define BLE_ACCEL 1
...
#define ACCEL_HANDLE(idx) (accel_env.shdl + (idx))

/// Get database attribute index
#define ACCEL_IDX(hdl) ((hdl)-accel_env.shdl)
...
enum { ACCEL_X = 0, ACCEL_Y, ACCEL_Z, ACCEL_MAX };
