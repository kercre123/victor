 ...
 *
 * Heart Rate sensor (HRS) profile provides functionalities to upper layer
 *module application. The device using this profile takes the role of Heart Rate
 *sensor.
 *
 ...
 * is the term used by this profile to describe a device that can perform Heart
 *Rate measurement and notify about on-going measurement and indicate final
...
#define HRPS_IS_SUPPORTED(mask) (((hrps_env.features & mask) == mask))
