...
enum {
  ...
  SPOTAR_SRV_STARTED = 0x01,    // Valid memory device has been configured by
                                // initiator. No sleep state while in this mode
  ...
  SPOTAR_PATCH_LEN_ERR = 0x05,  // Received patch Length not equal to PATCH_LEN
                                // characteristic value
  SPOTAR_EXT_MEM_WRITE_ERR =
      0x06,  // External Mem Error (Writing to external device failed)
