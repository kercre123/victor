 ...
 *
 * The SCPPS_TASK is responsible for handling the messages coming in and out of
 *the
...
enum {
  ...
  /// Indicate to APP that the Scan Interval Window value has been written by
  /// Client
  SCPPS_SCAN_INTV_WD_IND,
  /// Indicate to APP that the Scan Refresh Notification Configuration has been
  /// changed
