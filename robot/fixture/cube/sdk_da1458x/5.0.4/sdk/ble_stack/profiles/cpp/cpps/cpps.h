...
/// CPPS Cycling Power Profile Sensor Role
...
#define CPPS_ENABLE_NTF_IND_BCST(ccc_flag) \
  (cpps_env.prfl_ntf_ind_cfg |= ccc_flag)

#define CPPS_DISABLE_NTF_IND_BCST(ccc_flag) \
  (cpps_env.prfl_ntf_ind_cfg &= ~ccc_flag)

#define CPPS_IS_NTF_IND_BCST_ENABLED(ccc_flag) \
  ((cpps_env.prfl_ntf_ind_cfg & ccc_flag) == ccc_flag)
