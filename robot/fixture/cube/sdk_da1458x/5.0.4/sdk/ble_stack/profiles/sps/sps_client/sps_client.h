...
#define SPS_SERVICE_UUID                                                    \
  {                                                                         \
    0xb7, 0x5c, 0x49, 0xd2, 0x04, 0xa3, 0x40, 0x71, 0xa0, 0xb5, 0x35, 0x85, \
        0x3e, 0xb0, 0x83, 0x07                                              \
  }
#define SPS_SERVER_TX_UUID                                                  \
  {                                                                         \
    0xb8, 0x5c, 0x49, 0xd2, 0x04, 0xa3, 0x40, 0x71, 0xa0, 0xb5, 0x35, 0x85, \
        0x3e, 0xb0, 0x83, 0x07                                              \
  }
#define SPS_SERVER_RX_UUID                                                  \
  {                                                                         \
    0xba, 0x5c, 0x49, 0xd2, 0x04, 0xa3, 0x40, 0x71, 0xa0, 0xb5, 0x35, 0x85, \
        0x3e, 0xb0, 0x83, 0x07                                              \
  }
#define SPS_FLOW_CTRL_UUID                                                  \
  {                                                                         \
    0xb9, 0x5c, 0x49, 0xd2, 0x04, 0xa3, 0x40, 0x71, 0xa0, 0xb5, 0x35, 0x85, \
        0x3e, 0xb0, 0x83, 0x07                                              \
  }
...
/**
 ****************************************************************************************
 * @brief When all handles received correctly it can send and receive data or
 *flow control else it returns an error
 ****************************************************************************************
 */
void sps_client_enable_cfm_send(struct sps_client_env_tag *sps_client_env,
