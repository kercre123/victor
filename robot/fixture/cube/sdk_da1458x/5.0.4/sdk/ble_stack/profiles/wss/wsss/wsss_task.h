...
struct wsss_create_db_cfm {  /// Status
  uint8_t status;
};

/// Feature structure
struct wss_feature {  /// Flags
  uint32_t flags;
};

/// Parameters of the @ref WSSS_MEAS_VAL_SET_REQ message - shall be dynamically
/// allocated
...
/// Parameters of the @ref WSSS_MEAS_SEND_REQ message - shall be dynamically
/// allocated
