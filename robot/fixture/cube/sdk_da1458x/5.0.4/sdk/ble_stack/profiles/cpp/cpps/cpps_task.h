...
struct cpps_create_db_req {
  /**
   * CP Feature Value - Not supposed to be modified during the lifetime of the
   * device This bit field is set in order to decide which features are
   * supported: Supported features (specification) ---------------- Bits 0 to 18
   */
  uint32_t cp_feature;
  /**
   ...
   *     - Offset Compensation
   *     - Server allows to be requested for parameters (CPP_CTNL_PT_REQ...
   * codes)
   */
  uint8_t prfl_config;
  /**
