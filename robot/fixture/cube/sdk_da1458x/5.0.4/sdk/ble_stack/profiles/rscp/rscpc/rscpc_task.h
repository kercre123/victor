...
/// Message IDs
enum rscpc_msg_ids {
  /// Enable the Running Speed and Cadence Profile Collector task - at
  /// connection
  ...
  /// Indicate that an attribute value has been received either upon
  /// notification or read response
  RSCPC_VALUE_IND,
...
enum rscpc_op_codes {
  ...
  /// Wait for the Write Response after having written a Client Char. Cfg.
  /// Descriptor.
  RSCPC_CFG_NTF_IND_OP_CODE,
  /// Wait for the Write Response after having written the SC Control Point
  /// Char.
  RSCPC_CTNL_PT_CFG_WR_OP_CODE,
  /// Wait for the Indication Response after having written the SC Control Point
  /// Char.
