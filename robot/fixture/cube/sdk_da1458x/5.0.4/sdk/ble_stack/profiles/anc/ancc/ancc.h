...
enum ancc_rd_wr_ntf_codes {
  ...
  /// Read/Write ANC Notification Source Client Characteristic Configuration
  /// Descriptor
 ...
 ****************************************************************************************
 */
void ancc_send_no_conn_cmp_evt(uint8_t src_id, uint8_t dest_id, uint16_t conhdl,
                               uint8_t operation);
 ...
 ****************************************************************************************
 */
void ancc_send_cmp_evt(struct ancc_env_tag *ancc_env, uint8_t operation,
                       uint8_t status);
