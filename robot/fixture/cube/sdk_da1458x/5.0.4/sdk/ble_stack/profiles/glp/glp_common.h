 ...
 *
 * The Glucose Profile defines the functionality required in a device that
 *allows the user (Collector device) to configure and recover Glucose
 *measurements from a Glucose device.
 *****************************************************************************************
 */
...
enum glp_meas_state {
  ...
  /// Sample size for blood or control solution insufficient at time of
  /// measurement
  ...
  /// Sensor read interrupted because strip was pulled too soon at time of
  /// measurement
...
enum glp_racp_op_code {
  ...
  /// Number of stored records response (Operator: Null 'value of 0x00 from
  /// Operator Table')
