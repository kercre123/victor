...
enum {
  ...
  CUSTS1_VAL_NTF_REQ,
  /// Response after receiving a CUSTS1_VAL_NTF_REQ message and a notification
  /// is triggered
  CUSTS1_VAL_NTF_CFM,
  /// Set/update characteristic value and trigger an indication
  CUSTS1_VAL_IND_REQ,
  /// Response after receiving a CUSTS1_VAL_IND_REQ message and an indication is
  /// triggered
  CUSTS1_VAL_IND_CFM,
  /// Indicate that the characteristic value has been written
  CUSTS1_VAL_WRITE_IND,
  /// Inform the application that the profile service role task has been
  /// disabled after a disconnection
  CUSTS1_DISABLE_IND,
