 ...
 *
 * The TIPCTASK is responsible for handling the messages coming in and out of
 *the
...
enum {
  ...
  /// normal cnx started
  TIPC_ENABLE_CFM,
  /// Disable Indication - Send when the connection with a peer peripheral has
  /// been turned off
  TIPC_DISABLE_IND,
  ...
  /// Generic message for configuring the Current Time Characteristic on the
  /// Server
  TIPC_CT_NTF_CFG_REQ,
  /// Generic message for writing the Time Update Control Point Characteristic
  /// Value on a peer device
