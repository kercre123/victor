...
#define WPTS_PRU_ALERT_CHAR_LEN \
  1 + 6  // WHEN BT addr is returned it has to be 7(1 + 6byte BT addr)
// NOTE: Remember to change overall attr size in DB as well when changing this
// size
...
#define WPTS_PRU_CHARGING_CTRL_UUID_128                                     \
  {                                                                         \
    0x67, 0x9A, 0x0C, 0x20, 0x00, 0x08, 0x96, 0x9E, 0xE2, 0x11, 0x46, 0xA1, \
        0x70, 0xE6, 0x55, 0x64                                              \
  }
#define WPTS_PTU_STATIC_UUID_128                                            \
  {                                                                         \
    0x68, 0x9A, 0x0C, 0x20, 0x00, 0x08, 0x96, 0x9E, 0xE2, 0x11, 0x46, 0xA1, \
        0x70, 0xE6, 0x55, 0x64                                              \
  }
#define WPTS_PRU_ALERT_UUID_128                                             \
  {                                                                         \
    0x69, 0x9A, 0x0C, 0x20, 0x00, 0x08, 0x96, 0x9E, 0xE2, 0x11, 0x46, 0xA1, \
        0x70, 0xE6, 0x55, 0x64                                              \
  }
#define WPTS_PRU_STATIC_UUID_128                                            \
  {                                                                         \
    0x6A, 0x9A, 0x0C, 0x20, 0x00, 0x08, 0x96, 0x9E, 0xE2, 0x11, 0x46, 0xA1, \
        0x70, 0xE6, 0x55, 0x64                                              \
  }
#define WPTS_PRU_DYNAMIC_UUID_128                                           \
  {                                                                         \
    0x6B, 0x9A, 0x0C, 0x20, 0x00, 0x08, 0x96, 0x9E, 0xE2, 0x11, 0x46, 0xA1, \
        0x70, 0xE6, 0x55, 0x64                                              \
  }
...
enum {
  ...
  WPTS_STATIC_CATEGORY_5,  // NOTE: Category 6 & 7 are mentioned in spec, but
                           // not in definition of Category field in PRU static
...
extern const uint16_t ptu_max_src_imp[WPTC_STATIC_MAX_SRC_IMPEDANCE_END >>
                                      WPTC_STATIC_IMP_RESIS_SHIFT];
#define WPTC_GET_MAX_SRC_IMPEDANCE(A) \
  ptu_max_src_imp[A >> WPTC_STATIC_IMP_RESIS_SHIFT]
...
extern const uint8_t
    ptu_max_load_resistance[WPTC_STATIC_MAX_LOAD_RESISTANCE_END >>
                            WPTC_STATIC_IMP_RESIS_SHIFT];
#define WPTC_GET_MAX_LOAD_RESISTANCE(A) \
  ptu_max_load_resistance[A >> WPTC_STATIC_IMP_RESIS_SHIFT]

/// PTU Number of Devices
#define WPTC_MAX_SUPPORTED_DEV 8
#define WPTC_GET_SUPPORTED_DEV_NUMBER(A) \
  (A < WPTC_MAX_SUPPORTED_DEV) ? A + 1 : 0
