...
/// Parameters of the @ref UDSS_SET_CHAR_VAL_REQ message - shall be dynamically
/// allocated
...
/// Parameters of the @ref UDSS_CHAR_VAL_IND message - shall be dynamically
/// allocated
 ...
 *  - @ref READ_CLB_RESPOND_WITH_DB_VALUE if value should be taken from the
 *database,
