...
void hal_timer_register_callback(
    void (*callback)(void));  // intterrupt on internal tmr counter overflow
void hal_timer_set_led_callback(
    void (*callback)(void),
    uint16_t period_us);  // callback at specified period
