...
#define BMA2x2_BURST_READ_FUNC(device_addr, register_addr, register_data, \
                               rd_len)                                    \
 ...
 *
 */
BMA2x2_RETURN_FUNCTION_TYPE bma2x2_burst_read(u8 addr_u8, u8 *data_u8,
                                              u32 len_u32);
/******************************************/
...
/******************************************/
/*!
 *	@brief This API is used to get the bandwidth of the sensor in the
 *register 0x10 bit from 0 to 4
 *
 *
...
/*!
 *	@brief This API is used to set the bandwidth of the sensor in the
 *register 0x10 bit from 0 to 4
 *
 *
 *  @param bw_u8 : The value of bandwidth
 ...
 *
 */
BMA2x2_RETURN_FUNCTION_TYPE bma2x2_get_intr_slow_no_motion(
    u8 channel_u8, u8 *intr_slow_no_motion_u8);
/*!
 * @brief This API is used to set
 * the interrupt enable of slow/no motion interrupt in
 * the register 0x19 and 0x1B
 ...
 *
 */
BMA2x2_RETURN_FUNCTION_TYPE bma2x2_set_intr_slow_no_motion(
    u8 channel_u8, u8 intr_slow_no_motion_u8);
/*!
 * @brief This API is used to get
 ...
 *
 */
BMA2x2_RETURN_FUNCTION_TYPE bma2x2_get_intr_output_type(
 ...
 *
 */
BMA2x2_RETURN_FUNCTION_TYPE bma2x2_extract_accel(
    union fifo_frame *accel_frame, u8 *accel_frame_count,
    struct fifo_configuration *fifo_conf);
/******************************************/
