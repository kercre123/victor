...
#ifndef FLT_NEAR
#define FLT_NEAR(x, y)                                                     \
  (((x) == (y)) || (((x) > (y) - (FLOATING_POINT_COMPARISON_TOLERANCE)) && \
                    ((x) < (y) + (FLOATING_POINT_COMPARISON_TOLERANCE))))
#endif
#ifndef DBL_NEAR
#define DBL_NEAR(x, y)                                             \
  (((x) == (y)) ||                                                 \
   (((x) > (y) - ((double)FLOATING_POINT_COMPARISON_TOLERANCE)) && \
    ((x) < (y) + ((double)FLOATING_POINT_COMPARISON_TOLERANCE))))
#endif
...
#ifndef FLT_LE
#define FLT_LE(x, y) \
  ((x) >= (y) || (((x) - (FLOATING_POINT_COMPARISON_TOLERANCE) <= (y))))
#endif
