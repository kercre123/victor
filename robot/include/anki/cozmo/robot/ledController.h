...
u32 GetCurrentLEDcolor(
    const LightState& ledParams,    // The ledParams struct for this LED
    const TimeStamp_t currentTime,  // current timestamp
    const TimeStamp_t phaseTime,  // timestamp indicating the 'beginning' of the
                                  // light animation
