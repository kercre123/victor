...
tyDcVoltageCfg mv0155DCVoltageCfg =
{
    .voltCfgU15 =
    {                                 // See comments on definition of tyLT3906Config for description of voltage config
        ...
        .ldoVoltage1       =  11,     // 1.300V -> MV0155 Rail LDOA   [Bridge Core Voltage + Analog  ] TP15
...
int brdMv0155DcStartupVoltages(void)
{
    int camVoltStartupFail;
    camVoltStartupFail = brd153CfgDaughterCardVoltages(&mv0155DCVoltageCfg);
