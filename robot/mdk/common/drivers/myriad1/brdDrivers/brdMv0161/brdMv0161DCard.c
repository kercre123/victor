...
///
/// @brief     Driver for use on MV0153 to configure MV0161 Daughtercard
/// 
/// 
/// 
/// 
...
tyDcVoltageCfg mv0161DCVoltageCfg =
{
    .voltCfgU15 =
    ...
    .voltCfgU17 =
    {
        ...
        .ldoVoltage2       =  15,     // 2.500V -> MV0155 Rail LDOD   [Not Used on MV0155                      ]
        {0,0,0,0,0}                   // Voltage register cache initilised to zero
    },
};
...
int brdMv0161DcStartupVoltages(void)
{
    ...
    camVoltStartupFail = brd153CfgDaughterCardVoltages(&mv0161DCVoltageCfg);
