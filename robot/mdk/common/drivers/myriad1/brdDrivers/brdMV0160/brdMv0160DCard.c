...
tyDcVoltageCfg mv0160DCVoltageCfg =
{
    .voltCfgU15 =
    {                                 // See comments on definition of tyLT3906Config for description of voltage config
        ...
        .ldoVoltage1       =  12,     // 1.200V -> MV0155 Rail LDOA   [Bridge Core Voltage + Analog  ] TP15
        .ldoVoltage2       =  18,     // 1.800V -> MV0155 Rail LDOB   [Bridge IO Voltage, Cam I/O    ] C91
...
int brdMv0160DcStartupVoltages(void)
{
    ...
    camVoltStartupFail = brd153CfgDaughterCardVoltages(&mv0160DCVoltageCfg);
