...
******************************************************************************************  */
// --- bits 0:3
#define D_LCD_OUTF_FORMAT_RGB888         (0x0000)
#define D_LCD_OUTF_FORMAT_RGB666         (0x0001)
#define D_LCD_OUTF_FORMAT_RGB565         (0x0002)
#define D_LCD_OUTF_FORMAT_RGB444         (0x0003)
#define D_LCD_OUTF_FORMAT_YCBCR444       (0x0004)      // 24 bits
#define D_LCD_OUTF_FORMAT_YCBCR422       (0x0005)      // 16 bits
#define D_LCD_OUTF_FORMAT_MUX_RGB888     (0x0008)      // multiplexed
#define D_LCD_OUTF_FORMAT_MUX_RGB666     (0x0009)      // multiplexed
#define D_LCD_OUTF_FORMAT_MUX_RGB565     (0x000A)      // multiplexed
#define D_LCD_OUTF_FORMAT_YCBCR444_BT601 (0x000B)      // 16 bit, multiplexed
#define D_LCD_OUTF_FORMAT_YCBCR422_BT601 (0x000C)      // 8 bit, multiplexed
// --- bit 4
#define D_LCD_OUTF_BGR_ORDER    (0x10)   // default is 0, RGB order
// --- bit 5
#define D_LCD_OUTF_Y_ORDER      (0x20)   // Y after CB/Cr, default is Y before CB/CR
// --- bit 6
#define D_LCD_OUTF_CRCB_ORDER   (0x40)   // Cr before  Cb, default is Cb before Cr
// --- bit  7
#define D_LCD_OUTF_PCLK_EXT     (0x80) // use external clock, input from LCD, default is clock from CPR
// --- bit  8:10
...
// --- bit 11
#define D_LCD_OUTF_EMBED_SYNC_MODE (0x0800)   // ITU-R BT.656 embeded sincronization, default is with VSINC, HSINC signals
// ---bit 12
#define D_LCD_OUTF_ENABLE_CLIPPING (0x1000)   // for YCrCb clip Y between 16 and 235 , Cr/Cb between 16 and 240, for RGB between 16 and 235, default is no clipping
// ---bit 13:14
#define D_LCD_OUTF_RGB_CONV_TRUNC             (0x0000)  // default mode for RGB conversion is truncation
#define D_LCD_OUTF_RGB_CONV_EQUATIONS         (0x2000)  // RGB conversion equations
#define D_LCD_OUTF_RGB_CONV_LSB_DIETHER_ERR   (0x4000)  // LSB ditherring, accumulated errors
#define D_LCD_OUTF_RGB_CONV_LSB_DIETHER_RAN   (0x6000)  // LSB ditherring, random number
// --- bit 15
#define D_LCD_OUTF_FIELD_SETTINGS    (0x8000)  // use field settings, default is odd settins
