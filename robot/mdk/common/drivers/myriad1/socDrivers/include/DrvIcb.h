#ifndef _BRINGUP_SABRE_ICB_H_
#define _BRINGUP_SABRE_ICB_H_
 ...
 * @brief Configures the way an irq is generated( eg. edge/level positive/negative )
 ...
 * @brief Assigns a handler function to a specific hardware irq source
 ...
 * @brief Clears the Pending Flag for the Source IRQ\n
 ...
 * @brief Forces an interrupt to trigger for the Source IRQ\n
 ...
 * @brief Gives the Pending Flag for the Source IRQ\n
 ...
 * @param  Gives the Current Interupt Source
...
/**
 * @name Get IRQ Level
 * @brief Returns PIL field from the Leon's PSR.
 *
 ...
 * @brief  Use to read the ET flag from Leon's PSR
