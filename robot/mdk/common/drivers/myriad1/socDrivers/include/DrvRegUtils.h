...
/// @param[in] registerAddress Address of register to Poll
/// @param[in] bitSetMask 32 bit mask for bits to be tested
/// @param[in] timeOutMicroSecs Delay in micoseconds after which this function will timeout
