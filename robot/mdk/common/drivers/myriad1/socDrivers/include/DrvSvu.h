...
extern u32 SVU_BASE_ADDR[8];
extern u32 SVU_CTRL_ADDR[8];
extern u32 SVU_DATA_ADDR[8];
extern u32 SVU_INST_BASE[8];
...
/// Read the value of a S-Register from a specific Shave
/// @param[in] svu - shave number to read S-Register value from
/// @param[in] srfLoc - S-Register position to read
/// @return    - u32 value of the read register
///
u32 DrvSvutSrfRead(u32 svu, u32 srfLoc);
...
/// @param[in] shaveNumber - shave number to read T-Register value from
/// @param[in] registerOffset - T-Register position to read
/// @return    - u32 value of the read register
///
...
/// Write the value to a S-Register from a specific Shave
/// @param[in] svu - shave number to read S-Register value from
/// @param[in] srfLoc - S-Register position to write to
/// @param[in] srfVal - value to write
/// @return    - void
///
void DrvSvutSrfWrite(u32 svu, u32 srfLoc, u32 srfVal);
...
/// @param[in] shaveNumber - shave number to read T-Register value from
/// @param[in] registerOffset - T-Register position to write to
