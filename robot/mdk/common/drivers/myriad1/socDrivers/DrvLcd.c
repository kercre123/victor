...
{
   SET_REG_WORD(lcdBase + LCD_BG_COLOUR_OFFSET,      background);           //Background color:
...
{
    SET_REG_WORD(lcdBase + layerNo*0x100 + LCD_LAYER0_CSC_COEFF11_OFFSET, table[0]);
    SET_REG_WORD(lcdBase + layerNo*0x100 + LCD_LAYER0_CSC_COEFF12_OFFSET, table[1]);
    SET_REG_WORD(lcdBase + layerNo*0x100 + LCD_LAYER0_CSC_COEFF13_OFFSET, table[2]);
    SET_REG_WORD(lcdBase + layerNo*0x100 + LCD_LAYER0_CSC_COEFF21_OFFSET, table[3]);
    SET_REG_WORD(lcdBase + layerNo*0x100 + LCD_LAYER0_CSC_COEFF22_OFFSET, table[4]);
    SET_REG_WORD(lcdBase + layerNo*0x100 + LCD_LAYER0_CSC_COEFF23_OFFSET, table[5]);
    SET_REG_WORD(lcdBase + layerNo*0x100 + LCD_LAYER0_CSC_COEFF31_OFFSET, table[6]);
    SET_REG_WORD(lcdBase + layerNo*0x100 + LCD_LAYER0_CSC_COEFF32_OFFSET, table[7]);
    SET_REG_WORD(lcdBase + layerNo*0x100 + LCD_LAYER0_CSC_COEFF33_OFFSET, table[8]);
    SET_REG_WORD(lcdBase + layerNo*0x100 + LCD_LAYER0_CSC_OFF1_OFFSET, table[9]);
    SET_REG_WORD(lcdBase + layerNo*0x100 + LCD_LAYER0_CSC_OFF2_OFFSET, table[10]);
    SET_REG_WORD(lcdBase + layerNo*0x100 + LCD_LAYER0_CSC_OFF3_OFFSET, table[11]);
}
...
void DrvLcdLut(u32 lcdBase, u32 layerNo, u32 *table, u32 noEnt)
{
     ...
     { 
       for (i=0 ; i<noEnt ; ++i)
           SET_REG_WORD(lcdBase + LCD_LAYER2_CLUT0_OFFSET + 8*i, table[i]);
     } 
     else
     if (layerNo == 3)
     { 
       for (i=0 ; i<noEnt ; ++i)
           SET_REG_WORD(lcdBase + LCD_LAYER3_CLUT0_OFFSET + 8*i, table[i]);
     }           
}
...
{
           SET_REG_WORD(lcdBase + layerNo*0x100 + LCD_LAYER0_ALPHA_OFFSET, alpha);
           SET_REG_WORD(lcdBase + layerNo*0x100 + LCD_LAYER0_TRANS_COLOUR_OFFSET, transpColor);
}
...
{
  SET_REG_WORD(lcdBase + 0x100*layerNo + LCD_LAYER0_COL_START_OFFSET, x);
  SET_REG_WORD(lcdBase + 0x100*layerNo + LCD_LAYER0_ROW_START_OFFSET, y);
}
