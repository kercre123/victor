...
u32 SVU_BASE_ADDR[8] = {LHB_CMX_SLICE_0_BASE_ADR,
                        LHB_CMX_SLICE_1_BASE_ADR,
                        LHB_CMX_SLICE_2_BASE_ADR,
                        LHB_CMX_SLICE_3_BASE_ADR,
                        LHB_CMX_SLICE_4_BASE_ADR,
                        LHB_CMX_SLICE_5_BASE_ADR,
                        LHB_CMX_SLICE_6_BASE_ADR,
                        LHB_CMX_SLICE_7_BASE_ADR
                         };

u32 SVU_CTRL_ADDR[8] = {SHAVE_0_BASE_ADR,
                        SHAVE_1_BASE_ADR,
                        SHAVE_2_BASE_ADR,
                        SHAVE_3_BASE_ADR,
                        SHAVE_4_BASE_ADR,
...
u32 SVU_DATA_ADDR[8] = {LHB_CMX_SLICE_0_BASE_ADR,
                        LHB_CMX_SLICE_1_BASE_ADR,
                        LHB_CMX_SLICE_2_BASE_ADR,
                        LHB_CMX_SLICE_3_BASE_ADR,
                        LHB_CMX_SLICE_4_BASE_ADR,
...
u32 SVU_INST_BASE[8] = {LHB_CMX_SLICE_0_BASE_ADR,
                        LHB_CMX_SLICE_1_BASE_ADR,
                        LHB_CMX_SLICE_2_BASE_ADR,
                        LHB_CMX_SLICE_3_BASE_ADR,
                        LHB_CMX_SLICE_4_BASE_ADR,
...
void DrvSvutSrfWrite(u32 svu, u32 srfLoc, u32 srfVal) {
   SET_REG_WORD(SVU_CTRL_ADDR[svu]+SLC_OFFSET_SVU+SRF_BASE+(srfLoc<<2), srfVal);
}

u32 DrvSvutSrfRead(u32 svu, u32 srfLoc) {
  u32 retValue;
   retValue =    GET_REG_WORD_VAL(SVU_CTRL_ADDR[svu]+SLC_OFFSET_SVU+SRF_BASE+(srfLoc<<2));
return retValue;
}
...
void DrvSvutZeroRfs(u32 svu) {
  ...
  for (i=0; i<32; i++) {
    ...
    DrvSvutSrfWrite(0, i, 0x00000000);
      for (k=0; k<4; k++) {
