/******************************************************************************
 ...
 @Brief        : Revised I2C Master Driver
 Date          : 07-Feb-2012
 E-mail        : david.nicholls@movidius.com
...
static inline void waitTicks(u32 ticks)
{
    ...
    t0 = GET_REG_WORD_VAL(TIM0_FREE_CNT0_ADR);  
    do
    {
        t1 = GET_REG_WORD_VAL(TIM0_FREE_CNT0_ADR);  
        if (t1 < t0)
...
I2CM_StatusType DrvI2cMInit(I2CM_Device * dev,I2CMModuleOption module, u32 sclPin,u32 sdaPin,u32 speedKhz,I2CMAddrType addrType)
{
    ...
    case IIC1_DEVICE:
        DPRINTF3("\nIIC0 Configure\n");
        DrvCprSysDeviceAction(RESET_DEVICES, DEV_CSS_I2C0);
    ...
    case IIC2_DEVICE:
        DPRINTF3("\nIIC1 Configure\n");
        DrvCprSysDeviceAction(RESET_DEVICES, DEV_CSS_I2C1);
        ...
        if (dev->sdaPin == 13) sdaPinMode = D_GPIO_MODE_2;
             ...
             else if (dev->sdaPin == 63) sdaPinMode = D_GPIO_MODE_0;        
    ...
    case IIC3_DEVICE:
        DPRINTF3("\nIIC2 Configure\n");
        DrvCprSysDeviceAction(RESET_DEVICES,DEV_CSS_I2C2);
...
//    DRV_CPR_enableClocks(enableClocks);
    ...
    DrvCprSysDeviceAction(ENABLE_CLKS,enableClocks);   // commented for testing in VCS
