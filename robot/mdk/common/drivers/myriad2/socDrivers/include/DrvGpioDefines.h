...
// ----------------------------------------------------------------------------
#define D_GPIO_NUMBER (85)
// ---------------------------------------------------------------------------------------------
//                                  GPIO PIN Definitions 
// ---------------------------------------------------------------------------------------------

// Bits 16,17 define the IRQ source which the GPIO can be optionally routed to
// On Myriad2 bits 16,17 are no longer use to control IRQ selection
//#define D_GPIO_IRQ_SRC_1            (1 << 17)
//#define D_GPIO_IRQ_SRC_0            (1 << 16)
//#define D_GPIO_IRQ_SRC_NONE         (0)

// bit 15                           
// Note: On Myriad2 the logic of the GPIO_WAKEUP bit has been inverted from myriad1. It is now active high.
#define D_GPIO_WAKEUP_ON            (1 << 15)  
...
// for the FPGA current build 17b, bit 6 is the enable 
#define D_GPIO_INT_EN_0 (1<<6)
#define D_GPIO_INT_EN_1 (1<<14)
#define D_GPIO_INT_EN_2 (1<<22)
#define D_GPIO_INT_EN_3 (1<<30)
#define D_GPIO_INT_GPIO_MASK_0 (0x3f<<0)
#define D_GPIO_INT_GPIO_MASK_1 (0x3f<<8)
#define D_GPIO_INT_GPIO_MASK_2 (0x3f<<16)
#define D_GPIO_INT_GPIO_MASK_3 (0x3f<<24)
