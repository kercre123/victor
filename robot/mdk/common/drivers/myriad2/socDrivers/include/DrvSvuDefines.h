...
#define SVU_RF_CFG     0x058       // Register file RAM configuration
...
#define SVU_BRUCTL     0x0e0       // BRU Control Register
#define SVU_IDCCRC     0x0e4       // IDC CRC
...
#define SVU_DBRK_BYTE  0x840       // Write to first byte in instruction to fix software instruction breakpoint
...
#define DCU_DSR_DM 		(0x001) // debug mode
#define DCU_DSR_SG 		(0x002) // dbg_halt
#define DCU_DSR_SBP     (0x008) // software breakpoint triggered
#define DCU_DSR_IBP0    (0x010) // Instruction breakpoint 0 triggered
#define DCU_DSR_IBP1    (0x020) // Instruction breakpoint 1 triggered
#define DCU_DSR_DBP0    (0x040) // Data breakpoint 0 triggered
#define DCU_DSR_DBP1    (0x080) // Data breakpoint 1 triggered
#define DCU_DSR_EXT     (0x100) // Halted due to external debug interrupt
#define DCU_DSR_BT      (0x200) // Halted due to branch taken
...
#define SW_BP_INST      (0x01) // Changed from 0xF9 on myriad1
...
// Data Breakpoint control register macros
#define DBC_EN                (0x01)
#define DBC_ADR_COMP_EN       (0x02)
#define DBC_DATA_COMP_EN      (0x04)
#define DBC_TYPE_RDWR         (0x00)
#define DBC_TYPE_RD           (0x08)
#define DBC_TYPE_WR           (0x10)
#define DBC_LEN_LSF            (5) // the length will be shifted with this value
#define DBC_TS_ALL             (0x000)
#define DBC_TS_8B              (0x200)
#define DBC_TS_16B             (0x400)
#define DBC_TS_32B             (0x600)
#define DBC_TS_64B             (0x800)
#define DBC_LANE_MASK_LSF      (21) // the value of mask have to be shifted with this value
#define DBC_BC_INDIVIDUAL      (0x00000000)
#define DBC_BC_INCLUSIVE       (0x02000000)
#define DBC_BC_EXCLUSIVE       (0x04000000)
#define DBC_LIMIT_EXCLUSIVE    (0x08000000)
#define DBC_PREFETCH           (0x10000000)
#define DBC_INC_PC             (0x20000000)
...
#define PC_GO_EN       (u32)0x00000100
#define PC_SHIH_EN     (u32)0x00010000
#define PC_INT_EN      (u32)0x00020000
#define PC_LSU0_WD_EN  (u32)0x00040000
#define PC_LSU1_WD_EN  (u32)0x00080000
#define PC_LSU0_AS_EN  (u32)0x00100000
#define PC_LSU1_AS_EN  (u32)0x00200000
#define PC_IDC_BUFF_EN (u32)0x00400000
#define PC_FETCH_EN    (u32)0x00800000
#define PC_DECODE_EN   (u32)0x01000000
#define PC_STARVE_EN   (u32)0x02000000
#define PC_IDC_DISC_EN (u32)0x04000000
