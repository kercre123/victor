...
# BR does rtems need * on both sides??
ifeq ($(MV_SOC_OS), rtems)
  CC_INCLUDE      += $(patsubst %,-I%,$(wildcard    $(DirAppRoot)/*rtems* \
                                                    $(DirAppRoot)/shared))
                                                    
  CC_INCLUDE      += $(patsubst %,-I%,$(wildcard    $(MV_SWCOMMON_BASE)/include )) 
endif
