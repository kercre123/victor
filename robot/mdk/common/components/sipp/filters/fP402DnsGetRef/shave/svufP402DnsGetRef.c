...
#include <filters/fP402DnsGetRef/fP402DnsGetRef.h>

//##########################################################################################
void svufP402DnsGetRef(SippFilter *fptr, int svuNo, int runNo)
{
    UInt32 x;
    ...
    FP402DnsGetRefParam *param = (FP402DnsGetRefParam *)fptr->params;

  //Input Y line
    UInt8 *inY  = (UInt8*)WRESOLVE((void*)fptr->dbLinesIn[0][runNo&1][0], svuNo);
