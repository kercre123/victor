...
const unsigned short APT_AR0330_cfg_852x480p60[][2] = 
{
		//Reset
		...
		//PLL Config - Assuming Input Clock of 24MHz.  Output Clock will be 98MHz
...
CamSpec camSpec852x480p60 = {
    ...
    .regNumber           = sizeof(APT_AR0330_cfg_852x480p60)/(sizeof(unsigned short[2])),
    .regSize             = 2,
    .regValues           = APT_AR0330_cfg_852x480p60
};
