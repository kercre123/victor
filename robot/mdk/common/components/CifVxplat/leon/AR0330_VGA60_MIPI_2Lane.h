...
//# 752x480p @ 60fps 12bit MIPI - 2 Lane

#include "CIFGenericApiDefines.h"
#include "icMipiTC358746Defines.h"

const unsigned short APT_AR0330_cfg_VGA60_MIPI[][2] =
{
/*
==============
...
*/
		...
		{0x3002, 0x0036}, // Y_ADDR_START = 54
		{0x3004, 0x001E}, // X_ADDR_START = 30
		{0x3006, 0x05D5}, // Y_ADDR_END = 1493
		{0x3008, 0x08ED}, // X_ADDR_END = 2285
		
		//Frame-timing
		{0x300A, 0x0318}, // FRAME_LENGTH_LINES = 792
		...
		//Sub-sampling
		{0x30A2, 0x0005}, // X_ODD_INC = 5
		{0x30A6, 0x0005}, // Y_ODD_INC = 5
...
CamSpec camSpecVGA60_MIPI = {
        ...
        .regNumber           = sizeof(APT_AR0330_cfg_VGA60_MIPI)/(sizeof(unsigned short[2])),
        .regSize             = 2,
        .regValues           = APT_AR0330_cfg_VGA60_MIPI
};
