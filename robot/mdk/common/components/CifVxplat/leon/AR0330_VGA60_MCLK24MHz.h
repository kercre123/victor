...
//# 752x480p @ 60fps 12bit Parallel 96MPixel/s
...
const unsigned short APT_AR0330_cfg_VGA60[][2] = 
{
		...
		//PLL Config - Assuming Input Clock of 24MHz.
		...
		{0x3002, 0x0035}, //y_addr_start
		{0x3004, 0x001E}, //x_addr_start
		{0x3006, 0x05D5}, //y_addr_end
		{0x3008, 0x08ED}, //x_addr_end
		
		//Frame-timing
		{0x300A, 0x0291}, //frame_length_lines
