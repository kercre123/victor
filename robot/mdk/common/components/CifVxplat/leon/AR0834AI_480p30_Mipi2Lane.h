...
//# 640x480 @ 30 fps 10bit MIPI

#include "icMipiTC358746Defines.h"

#define RES_WIDTH		640
#define RES_HEIGHT		480
#define LINEBUFF_HEIGHT	1

#define FOV_CENTER		((240/LINEBUFF_HEIGHT)) //HW spec
...
*/
		...
		//Frame Timing
		{0x0342, 0x1C7C},			//LINE_LENGTH_PCK
		{0x0340, 0x539},			//FRAME_LENGTH_LINES
		{0x0202, INTEG_TIME},		//COARSE_INTEGRATION_TIME

		{0x303E, 0x0000},			//HDR OFF

		//Array Readout Settings
		{0x0344, 0x17E},			//X_ADDR_START
		{0x0348, 0xb7D},			//X_ADDR_END
		{0x0346, 0xF8},				//Y_ADDR_START
		{0x034A, 0x877},			//Y_ADDR_END
		{0x034C, 0x280},			//X_OUTPUT_SIZE
		{0x034E, 0x1E0},			//Y_OUTPUT_SIZE
		{0x3040, 0x41C7},			//X_ODD_INC and Y_ODD_INC

		//Sub-sampling
		{0x0400, 0x0},			 	//Scaling Enabling: 0= disable, 1= x-dir, 2= xy-dir
		{0x0402, 0x0},			 	//Co-Site Scaling
		{0x0404, 0x27},				//Scale_M = 20
		{0x0408, 0x2828},
		{0x040A, 0xC6},
		{0x306E, 0x9080	},			//Data Path Select
		//{0x306E, 0x90E0	},			//Data Path Select
