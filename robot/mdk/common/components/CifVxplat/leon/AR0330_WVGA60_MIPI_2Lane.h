...
//# 1152x648p @ 60fps 12bit MIPI - 2 Lane

#include "icMipiTC358746Defines.h"

const unsigned short APT_AR0330_cfg_WVGA60_MIPI[][2] =
{
/*
==============
...
*/
		...
		//Frame-timing
		{0x300A, 0x0317}, // FRAME_LENGTH_LINES = 791
		{0x300C, 0x04DA}, // LINE_LENGTH_PCK = 1242
		
		//Exposure
		{0x3012, 0x0316}, // COARSE_INTEGRATION_TIME = 790
		{0x3014, 0x0000}, // FINE_INTEGRATION_TIME = 0
		{0x3060, 0x0016}, // Analog gain: Coarse Gain[5:4] - Fine Gain [3:0]
		{0x305E, 0x0128}, // Digtal Gain
		
		//Sub-sampling
		{0x30A2, 0x0003}, // X_ODD_INC = 3
		{0x30A6, 0x0003}, // Y_ODD_INC = 3
		{0x3040, 0x3000}, // READ_MODE = 12288
		{0x3042, 0x038F}, // EXTRA_DELAY = 911
...
CamSpec camSpecWVGA60_MIPI = {
    ...
    .regNumber           = sizeof(APT_AR0330_cfg_WVGA60_MIPI)/(sizeof(unsigned short[2])),
    .regSize             = 2,
    .regValues           = APT_AR0330_cfg_WVGA60_MIPI
};
