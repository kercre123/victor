...
//# 752x480p @ 30fps 12bit Parallel

const unsigned short APT_AR0330_cfg_VGA30[][2] =
{
		//Reset
...
CamSpec camSpecVGA30 = {
    ...
    .regNumber           = sizeof(APT_AR0330_cfg_VGA30)/(sizeof(unsigned short[2])),
    .regSize             = 2,
    .regValues           = APT_AR0330_cfg_VGA30
};
