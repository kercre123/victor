...
//# 1152x648p @ 60fps 12bit Parallel 96MPixel/s

const unsigned short APT_AR0330_cfg_WVGA60[][2] = 
{
		//Reset
		...
		//PLL Config - Assuming Input Clock of 27MHz.  Output Clock will be 98MHz
		{0x302A, 0x0006}, //VT_PIX_CLK_DIV
		{0x302C, 0x0001}, //VT_SYS_CLK_DIV
		{0x302E, 0x0009}, //PRE_PLL_CLK_DIV
		{0x3030, 0x00C4}, //PLL_MULTIPLIER
		...
		//Frame-timing
		{0x300A, 0x0294}, //frame_length_lines
		...
		{0x3012, 0x0293}, //Coarse integration time
		{0x3060, 0x0016}, //Analog gain: Coarse Gain[5:4] - Fine Gain [3:0] - 2x
		{0x305E, 0x0128}, //Digtal Gain 1x
...
CamSpec camSpecWVGA60 = {
    ...
    .regNumber           = sizeof(APT_AR0330_cfg_WVGA60)/(sizeof(unsigned short[2])),
    .regSize             = 2,
    .regValues           = APT_AR0330_cfg_WVGA60
};
