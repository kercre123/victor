...
#define RES_WIDTH		3264
#define RES_HEIGHT		2448
#define LINEBUFF_HEIGHT	4

#define FOV_CENTER		((1204/LINEBUFF_HEIGHT)) //HW spec
#define FOV3_START		((2404/LINEBUFF_HEIGHT)) //HW spec

#define INTEG_TIME		0x100
...
*/
		...
		//Frame Timing
		{0x0342, 0x3500},			//LINE_LENGTH_PCK
		{0x340, 0xA10},				//FRAME_LENGTH_LINES
		{0x202, INTEG_TIME},		//COARSE_INTEGRATION_TIME

		{0x303E, 0x0000},			//HDR OFF

		//Array Readout Settings
		{0x0344, 0x8}, 				//X_ADDR_START 8
		{0x0348, 0xCC7}, 			//X_ADDR_END 3271
		{0x0346, 0x8}, 				//Y_ADDR_START 8
		{0x034A, 0x997}, 			//Y_ADDR_END 2455
		{0x034C, 0xCC0}, 			//X_OUTPUT_SIZE 3264
		{0x034E, 0x990}, 			//Y_OUTPUT_SIZE 2448
		{0x3040, 0x4041}, 			//X_ODD_INC & Y_ODD_INC

		//Sub-sampling
		{0x0400, 0x00},			 	//Scaling Enabling: 0= disable, 1= x-dir, 2= xy-dir
		{0x0402, 0x0},			 	//Co-Site Scaling
		{0x0404, 0x10},				//Scale_M = 20
		{0x0408, 0x1010},
		{0x040A, 0x0210},
