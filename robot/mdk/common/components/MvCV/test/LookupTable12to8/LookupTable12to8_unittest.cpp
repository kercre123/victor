...
//    LUT12to8_asm(u16** src, u8** dest, const u16* lut, u32 width, u32 height);
//
//Asm test function prototype:
//    void LUT12to8_asm_test(u16** src, u8** dest, const u16* lut, u32 width, u32 height);
//    - restrictions: works only for line size multiple of 16
//
//C function prototype:
//    void LUT12to8(u16** src, u8** dest, const u16* lut, u32 width, u32 height);
//
...
#include "LookupTable12to8_asm_test.h"
...
class LookupTable12to8Test : public ::testing::Test {
 protected:
...
TEST_F(LookupTable12to8Test, TestUniformInputLinesAll0)
{
    width = 320;
    ...
    LUT12to8_asm_test(inLines, outLinesAsm, lut, width, 1);
    LUT12to8(inLines, outLinesC, lut, width, 1);
    RecordProperty("CycleCount", LookupTable12to8CycleCount);
...
TEST_F(LookupTable12to8Test, TestUniformInputLinesAll255)
{
    width = 32;
    inputGen.SelectGenerator("uniform");
...
TEST_F(LookupTable12to8Test, TestLowestLineSize)
{
    width = 16;
...
TEST_F(LookupTable12to8Test, TestOnlyOneMaskedValue)
{
    width = 32;
...
TEST_F(LookupTable12to8Test, TestMaskedValues)
{
    width = 32;
...
TEST_F(LookupTable12to8Test, TestWidth240RandomData)
{
    width = 240;
...
TEST_F(LookupTable12to8Test, TestWidth320RandomData)
{
    width = 320;
...
TEST_F(LookupTable12to8Test, TestWidth640RandomData)
{
    width = 640;
...
TEST_F(LookupTable12to8Test, TestWidth1280RandomData)
{
    width = 1280;
...
TEST_F(LookupTable12to8Test, TestWidth1920RandomData)
{
    width = 1920;
...
TEST_F(LookupTable12to8Test, TestRandomWidthRandomData)
{
    inputGen.SelectGenerator("random");
