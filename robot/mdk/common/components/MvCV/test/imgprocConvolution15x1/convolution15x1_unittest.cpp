...
//     void Convolution15x1_asm(unsigned char** in, unsigned char** out, half* conv, unsigned long inWidth);
//
...
class Convolution15x1KernelTest : public ::testing::TestWithParam< unsigned long > {
protected:
...
TEST_F(Convolution15x1KernelTest, TestUniformInputLinesWidthAll0)
{
	...
	Convolution15x1(inLines, outLinesC, convFilterC, width);
	Convolution15x1_asm_test(inLines, outLinesAsm, convFilterAsm, width);
...
TEST_F(Convolution15x1KernelTest, TestUniformInputDifferentFilter)
{
	...
	outLinesC = inputGen.GetEmptyLines(width, 1);
	outLinesAsm = inputGen.GetEmptyLines(width, 1);
	float convFilterC[KERNEL_SIZE] = {0.1, 1.0, -3.0, 4.0, -6.5, 8.0, -11.0, 30.0, -11.0, 8.0, -6.5, 4.0, -3.0, 1.0, 0.1};
	half convFilterAsm[KERNEL_SIZE] = {0.1, 1.0, -3.0, 4.0, -6.5, 8.0, -11.0, 30.0, -11.0, 8.0, -6.5, 4.0, -3.0, 1.0, 0.1};
