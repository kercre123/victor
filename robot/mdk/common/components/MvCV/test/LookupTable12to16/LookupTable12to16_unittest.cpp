...
//    void LUT12to16_asm_test(u16** src, u16** dest, const u16* lut, u32 width, u32 height);
...
#include "LookupTable12to16_asm_test.h"
...
class LookupTable12to16Test : public ::testing::Test {
 protected:
...
TEST_F(LookupTable12to16Test, TestUniformInputLinesAll0)
{
    width = 320;
    inputGen.SelectGenerator("uniform");
    inLines = (u16**)inputGen.GetLines(width * 2, 1, 0);
    lut = (u16*)inputGen.GetLine(256 * 2, 0);
    outLinesC = (u16**)inputGen.GetEmptyLines(width * 2, 1);
    outLinesAsm = (u16**)inputGen.GetEmptyLines(width * 2, 1);
 
    lut[0] = 100;

    LUT12to16_asm_test(inLines, outLinesAsm, lut, width, 1);
    LUT12to16(inLines, outLinesC, lut, width, 1);
    RecordProperty("CycleCount", LookupTable12to16CycleCount);
...
TEST_F(LookupTable12to16Test, TestUniformInputLinesAll255)
{
    width = 32;
    inputGen.SelectGenerator("uniform");
...
TEST_F(LookupTable12to16Test, TestLowestLineSize)
{
    width = 16;
...
TEST_F(LookupTable12to16Test, TestOnlyOneMaskedValue)
{
    width = 32;
    
    inputGen.SelectGenerator("uniform");
    inLines = (u16**)inputGen.GetLines(width * 2, 1, 0);
    lut = (u16*)inputGen.GetLine(4096 * 2, 0);
    outLinesC = (u16**)inputGen.GetEmptyLines(width * 2, 1);
    outLinesAsm = (u16**)inputGen.GetEmptyLines(width * 2, 1);
...
TEST_F(LookupTable12to16Test, TestMaskedValues)
{
    width = 32;
...
TEST_F(LookupTable12to16Test, TestWidth240RandomData)
{
    width = 240;
...
TEST_F(LookupTable12to16Test, TestWidth320RandomData)
{
    width = 320;
...
TEST_F(LookupTable12to16Test, TestWidth640RandomData)
{
    width = 640;
...
TEST_F(LookupTable12to16Test, TestWidth1280RandomData)
{
    width = 1280;
...
TEST_F(LookupTable12to16Test, TestWidth1920RandomData)
{
    width = 1920;
...
TEST_F(LookupTable12to16Test, TestRandomWidthRandomData)
{
    inputGen.SelectGenerator("random");
