...
//      void Erode5x5(u8** src, u8** dst, u8** kernel, u16 width, u16 height, u8 k)

//Asm test function prototype:
//      void Erode5x5_asm_test(u8** src, u8** dst, u8** kernel, u16 width, u16 height, u8 k)

//C function prototype:
//      void Erode5x5(u8** src, u8** dst, u8** kernel, u16 width, u16 height)
...
TEST_F(Erode5x5Test, TestUniformInputAll0)
{
	...
	Erode5x5(inLines, outLinesC, kernel, width, height);
	Erode5x5_asm_test(inLines, outLinesAsm, kernel, width, height);
...
TEST_F(Erode5x5Test, TestNonUniformInput)
{
	...
	inLines[0][0] = 7;  inLines[0][1] = 13; inLines[0][2] = 4; inLines[0][3] = 4;  inLines[0][4] = 8;  inLines[0][5] = 16;
	inLines[1][0] = 5;  inLines[1][1] = 2;  inLines[1][2] = 6; inLines[1][3] = 3;  inLines[1][4] = 10; inLines[1][5] = 20;
	inLines[2][0] = 9;  inLines[2][1] = 8;  inLines[2][2] = 4; inLines[2][3] = 7;  inLines[2][4] = 8;  inLines[2][5] = 0;
	inLines[3][0] = 2;  inLines[3][1] = 10; inLines[3][2] = 1; inLines[3][3] = 11; inLines[3][4] = 16;  inLines[3][5] = 11;
	inLines[4][0] = 6;  inLines[4][1] = 20; inLines[4][2] = 9; inLines[4][3] = 30; inLines[4][4] = 18;  inLines[4][5] = 9;
