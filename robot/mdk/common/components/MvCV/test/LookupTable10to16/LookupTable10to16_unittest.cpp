...
//    void LUT10to16_asm_test(u16** src, u16** dest, const u16* lut, u32 width, u32 height);
...
#include "LookupTable10to16_asm_test.h"
...
class LookupTable10to16Test : public ::testing::Test {
 protected:
...
TEST_F(LookupTable10to16Test, TestUniformInputLinesAll0)
{
    width = 320;
    ...
    LUT10to16_asm_test(inLines, outLinesAsm, lut, width, 1);
    LUT10to16(inLines, outLinesC, lut, width, 1);
    RecordProperty("CycleCount", LookupTable10to16CycleCount);
...
TEST_F(LookupTable10to16Test, TestUniformInputLinesAll255)
{
    width = 32;
    inputGen.SelectGenerator("uniform");
...
TEST_F(LookupTable10to16Test, TestLowestLineSize)
{
    width = 16;
...
TEST_F(LookupTable10to16Test, TestOnlyOneMaskedValue)
{
    width = 32;
...
TEST_F(LookupTable10to16Test, TestMaskedValues)
{
    width = 32;
...
TEST_F(LookupTable10to16Test, TestWidth240RandomData)
{
    width = 240;
...
TEST_F(LookupTable10to16Test, TestWidth320RandomData)
{
    width = 320;
...
TEST_F(LookupTable10to16Test, TestWidth640RandomData)
{
    width = 640;
...
TEST_F(LookupTable10to16Test, TestWidth1280RandomData)
{
    width = 1280;
...
TEST_F(LookupTable10to16Test, TestWidth1920RandomData)
{
    width = 1920;
...
TEST_F(LookupTable10to16Test, TestRandomWidthRandomData)
{
    inputGen.SelectGenerator("random");
