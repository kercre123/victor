...
//      void Erode7x7(u8** src, u8** dst, u8** kernel, u16 width, u16 height)
...
TEST_F(Erode7x7Test, TestUniformInputAll0)
{
	...
	Erode7x7(inLines, outLinesC, kernel, width, height);
	Erode7x7_asm_test(inLines, outLinesAsm, kernel, width, height);
...
TEST_F(Erode7x7Test, TestDiagonalKernel)
{
	...
	height = 7;
	inputGen.SelectGenerator("uniform");
	inLines = inputGen.GetLines(width + PADDING, height, 5);
	kernel = inputGen.GetLines(7, 7, 0);
