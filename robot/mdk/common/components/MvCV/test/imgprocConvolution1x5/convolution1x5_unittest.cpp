...
//     void Convolution1x5_asm(unsigned char** in, unsigned char** out, half* conv, unsigned long inWidth);
//
...
class Convolution1x5KernelTest : public ::testing::TestWithParam< unsigned long > {
protected:
...
TEST_F(Convolution1x5KernelTest, TestUniformInputLinesWidthAll0)
{
	...
	Convolution1x5(inLines, outLinesC, convFilterC, width);
	Convolution1x5_asm_test(inLines, outLinesAsm, convFilterAsm, width);
...
TEST_F(Convolution1x5KernelTest, TestIndividualValues)
{
	...
	inLines[0][0] = 4;  inLines[0][1] = 2; inLines[0][2] =  23;
	inLines[0][3] = 8;  inLines[0][4] = 9; inLines[0][5] = 255;
	inLines[0][6] = 7;
	...
	EXPECT_EQ(206, outLinesAsm[0][0]);
	EXPECT_EQ( 25, outLinesAsm[0][1]);
