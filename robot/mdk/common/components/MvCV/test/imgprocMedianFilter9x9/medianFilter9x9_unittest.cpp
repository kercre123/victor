...
unsigned char inLinesTest[9][9]  = {{1, 9, 3, 4, 5, 6, 7, 8, 9},
                                   {2, 8, 9, 9, 7, 3, 3, 9, 9},
                                   {3, 7, 2, 1, 0, 3, 4, 4, 8},
                                   {4, 6, 5, 4, 3, 2, 0, 0, 8},
                                   {5, 5, 4, 4, 7, 7, 1, 1, 3},
...
TEST_F(medianFilter9x9Test, TestUniformInput0Size9x9)
{
    width = 9;
    height = 9;
    ...
    medianFilter9x9(width, outLinesC, inLinesC);
...
TEST_F(medianFilter9x9Test, TestUniformInput255Size9x9)
{
    width = 9;
    height = 9;
...
TEST_F(medianFilter9x9Test, TestUniformInput198Size9x9)
{
    width = 9;
    height = 9;
...
TEST_F(medianFilter9x9Test, TestPseudoRandomInputSize9x9)
{
    width = 9;
    height = 9;
    inputGen.SelectGenerator("uniform");
...
TEST_F(medianFilter9x9Test, TestRandomInputSize8x9)
{
    width = 8;
    height = 9;
...
// 6. all pixels value = random, width=9
TEST_F(medianFilter9x9Test, TestRandomInputSize9x9)
{
    width = 9;
    height = 9;
...
TEST_F(medianFilter9x9Test, TestRandomInputSize640x9)
{
    width = 640;
    height = 9;
    inputGen.SelectGenerator("random");
...
TEST_F(medianFilter9x9Test, TestRandomInputSize800x9)
{
    width = 800;
    height = 9;
...
TEST_F(medianFilter9x9Test, TestRandomInputSize1200x9)
{
    width = 1200;
    height = 9;
...
TEST_F(medianFilter9x9Test, TestRandomInputSize1920x9)
{
    width = 1920;
    height = 9;
