...
Convolution1x9_asm:
    ...
    LSU0.LDO64.l v10 i16 0    || LSU1.LDO64.h v10 i16 8  ; load the filter in v10 and v11
    LSU0.LDO64.l v11 i16 16
    ...
    VAU.ALIGNVEC v6, v0, v15, 12 || CMU.CPVV v8, v15
    VAU.ALIGNVEC v7, v0, v15, 14 || LSU0.LD128.u8.f16 v15, i18 || IAU.ADD i18, i18, 8
...
__loopEnd1x9:
    ...
    VAU.MACP.f16 v6, v10         || LSU1.SWZV8 [66666666]
    VAU.MACP.f16 v7, v10         || LSU1.SWZV8 [77777777]
    VAU.MACPW.f16 v20, v8, v11   || LSU1.SWZV8 [00000000]      || LSU0.ST128.f16.u8 v20, i17 || IAU.ADD i17, i17, i7
    LSU0.LDIL i7, 8
    NOP 6
