...
LSU0.LDO32 i1  i18 0 || VAU.SUB.i8  v22 v22 v22 || LSU1.LDIL i3 48
...
LSU0.LD32  i17 i17   || CMU.CPII i5 i15    || SAU.DIV.u32 i3  i15  i3
...
LSU0.LDO8 i12 i6 1 || VAU.SUB.i8 v3  v0  v3
LSU0.LDO8 i13 i6 2 || VAU.SUB.i8 v4  v0  v4
LSU0.LDO8 i14 i6 3 || CMU.VROT   v11 v1  1 
LSU0.LDO8 i15 i6 4 || CMU.VROT   v12 v1  2    || IAU.ADD    i18 i18 4 
CMU.VROT  v13 v1 3 || LSU1.LDO32 i1  i18 0
CMU.VROT  v14 v1 4
...
CMU.CPII   i18 i10 
LSU0.LDO32 i1  i18 0    || CMU.CPII i16 i9        ||  IAU.ADD i2 i2 i4   || VAU.SUB.i8 v28 v0 v28
VAU.SUB.i8 v22 v0 v22


___Store_Values:
LSU0.LDIL   i8 5        || LSU1.LDO32 i6 i16 0    ||  IAU.SUB i5 i5 i4   || VAU.SUB.i8 v25 v0 v25
LSU0.ST64.l v22 i17     || LSU1.STO64.h v22 i17 8 ||  IAU.ADD i17 i17 i0 || VAU.SUB.i8 v31 v0 v31
