...
Convolution7x1_asm:
    ...
    LSU0.LD32 in6, i18 || IAU.SHR.u32 i15, i15, 3 || LSU1.LD32 i17, i17
...
__loopEnd7x1:
    ...
    VAU.MACP.f16 P4, v15       || LSU1.SWZV8 [44444444] || CMU.CLAMP0.f16 v20 v20 v22
    VAU.MACP.f16 P5, v15       || LSU1.SWZV8 [55555555]
    VAU.MACPW.f16 v20, P6, v15 || LSU1.SWZV8 [66666666] || LSU0.ST128.f16.u8 v20, i17 || IAU.ADD i17, i17, i10
    LSU0.LDIL i10, 8
    NOP
