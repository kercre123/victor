...
.lalign
minMaxPos_asm:
LSU0.LD32 i18 i18            ; loads input img
LSU0.LDIL i3 0x000f
CMU.CMII.u32 i17, i3
...
CMU.CPIS s0 i12              || SAU.SUB.u32s i8 i17 i6
CMU.CPIS s1 i18
...
___min_max_loop_head:
    LSU0.LDO64.l v4 i18 0 || LSU1.LDO64.h v4 i18 8 || BRU.RPL i4 i3
    LSU0.LDO64.l v5 i18 0 || LSU1.LDO64.h v5 i18 8 || IAU.ADD i18 i18 16
    LSU0.LDO64.l v6 i12 0 || LSU1.LDO64.h v6 i12 8 || IAU.ADD i12 i12 16	
    nop 4
    CMU.CPIVR.x8 v7 i1
    VAU.SUB.i8 v7 v6 v7    
    ...
    ___store_min_max:
        CMU.MAX.u8 v1, v1, v1 || LSU0.SWZC4BYTE [2301]
        CMU.MIN.u8 v2, v2, v2 || LSU1.SWZC4BYTE [2301]
        CMU.MAX.u8 v1, v1, v1 || LSU0.SWZC4BYTE [1032]
        CMU.MIN.u8 v2, v2, v2 || LSU1.SWZC4BYTE [1032]
        CMU.MAX.u8 v1, v1, v1 || LSU0.SWZC4WORD [2301]
        CMU.MIN.u8 v2, v2, v2 || LSU1.SWZC4WORD [2301]
        CMU.MAX.u8 v1, v1, v1 || LSU0.SWZC4WORD [1032]
        CMU.MIN.u8 v2, v2, v2 || LSU1.SWZC4WORD [1032] ;last performed swizzle operation leads to a vrf
        ...
        LSU0.ST8 i5 i15 ;stores the smallest value found in the img
        LSU0.ST8 i4 i16 ; stores the highest value found in the img
    ...
    ___compensation:
        ...
        LSU0.LD8 i1 i18 || IAU.ADD i18 i18 1 || bru.rpl i7 i6
        LSU0.LD8 i2 i12 || IAU.ADD i12 i12 1
     	nop 4
	    CMU.CPII i3, i1
	...
	LSU0.ST8 i5 i15   || LSU1.ST8 i4 i16 ;stores the smallest and highest values found in the img
	CMU.CMZ.i8 i9
	PEU.PC1C NEQ      || LSU0.ST32 i10 i14 || LSU1.ST32 i11 i13
...
IAU.XOR i4  i4  i4  || CMU.CPSI i12 s0 || LSU0.LDIL i5 0x10
IAU.XOR i9  i9  i9  || CMU.CPSI i18 s1
...
.lalign
___min_pos_loop:
    LSU0.LDO64.l v8 i18 0 || LSU1.LDO64.h v8 i18 8 || IAU.ADD i18 i18 16
    LSU0.LDO64.l v10 i12 0 || LSU1.LDO64.h v10 i12 8 || IAU.ADD i12 i12 16
    nop 5
    ...
    CMU.CMII.u8 i11 i7
    PEU.PC1C EQ || LSU0.ST32 i8 i14 || IAU.ADD i4 i4 0xFF
    IAU.ADD    i10 i10 1
    IAU.ADD i4 i4 1
    CMU.CMII.u32 i4 i3
...
IAU.XOR i0  i0  i0 || cmu.cpsi i12 s0
IAU.XOR i8  i8  i8
IAU.XOR i1  i1  i1
IAU.XOR i4  i4  i4
IAU.XOR i9  i9  i9
...
.lalign
    ___maxim_pos_loop:
    LSU0.LDO64.l v9 i18 0 || LSU1.LDO64.h v9 i18 8 || IAU.ADD i18 i18 16
    LSU0.LDO64.l v10 i12 0 || LSU1.LDO64.h v10 i12 8 || IAU.ADD i12 i12 16
    nop 5
    ...
    PEU.PC1C LT || IAU.ADD i11 i11 1
    CMU.CMII.u8 i11 i7	
    PEU.PC1C EQ || LSU0.ST32 i8 i13 || IAU.ADD i4 i4 0xFF
    IAU.ADD    i10 i10 1
    IAU.ADD i4 i4 1
    CMU.CMII.u32 i4 i3
    PEU.PC1C LT || BRU.JMP i6
