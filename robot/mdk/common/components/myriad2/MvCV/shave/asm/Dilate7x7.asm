...
LSU0.LDO.32 i1  i18 0    || LSU1.LDIL i0   40       || CMU.CPII i22 i15         || VAU.SUB.i8  v19 v19 v19

;If width < 40 then
CMU.CMII.u32 i15 i0
PEU.PC1C LT || CMU.CPII i15 i0 

LSU0.LD.32  i17 i17      || LSU1.LDO.32 i8  i16 0   || SAU.DIV.u32 i3 i15 i0    || CMU.CPII i6 i16 || VAU.SUB.i8  v20 v20 v20
...
LSU0.LDO.8    i13 i8  4   || LSU1.LDO.8 i14 i8 5     
LSU0.LDO.8    i15 i8  6   || CMU.ALIGNVEC  v2  V1, v1 1 
CMU.ALIGNVEC  v4  V1, v1 3 
CMU.ALIGNVEC  v3  V1, v1  2 


; Load source values
CMU.ALIGNVEC     v5  V1, v1  4 
CMU.ALIGNVEC     v6  V1, v1  5 
CMU.ALIGNVEC     v7  V1, v1  6 
...
___Store_Values:
LSU0.STO.64.L v26 i17   0  || LSU1.STO.64.H v26 i17  8     || IAU.ADD    i17 i17 i24   || CMU.CPII   i18 i5
LSU0.STO.64.L v27 i17   0  || LSU1.STO.64.H v27 i17  8     || IAU.ADD    i17 i17 i23
