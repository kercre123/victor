...
cvtColorKernelYUVToRGB_asm:
	...
	;coeficients loading
	LSU0.LD.64.L v5, i5 || iau.add i5, i5, 8 ; coeficients for u (Cu)
	LSU0.LD.64.L v6, i5                      ; coeficients for v (Cv)
...
nop
	...
	;first y, u, v load
	sau.xor i6, i6, i6
	LSU0.LD.8 i6, i17 || iau.add i17, i17, 1 || sau.xor i7, i7, i7 ; u 
	LSU1.LD.8 i7, i16 || iau.add i16, i16, 1                       ; v
	iau.xor i1, i1, i1
	LSU0.LD.8 i1, i18 || iau.add i18, i18, 1 || sau.xor i2, i2, i2 ; y1
	LSU0.LD.8 i2, i18 || iau.add i18, i18, 1 || sau.xor i3, i3, i3 ; y2
	LSU0.LD.8 i3, i0  || iau.add i0,  i0,  1 || sau.xor i4, i4, i4 ; y3
	LSU1.LD.8 i4, i0  || iau.add i0,  i0,  1                       ; y4
...
___main_loop:
		...
		LSU0.LD.8 i6, i17 || iau.add i17, i17, 1 || sau.xor i7, i7, i7 ; u
		vau.add.f16 v10, v1, v9 || LSU1.LD.8 i7, i16 || iau.add i16, i16, 1 || sau.xor i1, i1, i1 ; v
		vau.add.f16 v11, v2, v9 || LSU0.LD.8 i1, i18 || iau.add i18, i18, 1 || sau.xor i2, i2, i2 ; y1  
		vau.add.f16 v12, v3, v9 || LSU0.LD.8 i2, i18 || iau.add i18, i18, 1 || sau.xor i3, i3, i3 ; y2
		vau.add.f16 v13, v4, v9 || LSU0.LD.8 i3, i0  || iau.add i0,  i0,  1 || sau.xor i4, i4, i4 || cmu.cpvv.f16.i32s v10, v10 ; y3 
		LSU0.LD.8 i4, i0  || iau.add i0,  i0,  1     || cmu.cpvv.f16.i32s v11, v11                ; y4 
		...
		cmu.cpvi i20, v10.2 || iau.clamp0.i32 i21, i21, i23 || LSU0.ST.8  i22, i10 
                               iau.clamp0.i32 i20, i20, i23 || LSU1.STO.8 i21, i10, 1		
		cmu.cpvi i22, v11.0 || LSU0.STO.8 i20, i10, 2 || iau.add i10, i10, 3
		cmu.cpvi i21, v11.1 || iau.clamp0.i32 i22, i22, i23
		cmu.cpvi i20, v11.2 || iau.clamp0.i32 i21, i21, i23 || LSU0.ST.8  i22, i10
		                       iau.clamp0.i32 i20, i20, i23 || LSU1.STO.8 i21, i10, 1
		cmu.cpvi i22, v12.0 || LSU0.STO.8 i20, i10, 2 || iau.add i10, i10, 3
		cmu.cpvi i21, v12.1 || iau.clamp0.i32 i22, i22, i23
		cmu.cpvi i20, v12.2 || iau.clamp0.i32 i21, i21, i23 || LSU0.ST.8  i22, i11
                               iau.clamp0.i32 i20, i20, i23 || LSU1.STO.8 i21, i11, 1
        peu.pc1c LT || bru.jmp i8
		cmu.cpvi i22, v13.0 || LSU0.STO.8 i20, i11, 2 || iau.add i11, i11, 3
		cmu.cpvi i21, v13.1 || iau.clamp0.i32 i22, i22, i23 
		cmu.cpvi i20, v13.2 || iau.clamp0.i32 i21, i21, i23 || LSU0.ST.8  i22, i11
                               iau.clamp0.i32 i20, i20, i23 || LSU1.STO.8 i21, i11, 1
	    LSU0.STO.8 i20, i11, 2 || iau.add i11, i11, 3
		nop
