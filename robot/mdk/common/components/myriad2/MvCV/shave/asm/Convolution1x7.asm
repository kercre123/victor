...
Convolution1x7_asm:
    ...
    LSU0.LDO.64.L v10 i16 0    || LSU1.LDO.64.H v10 i16 8  ; load the filter in v10
    CMU.CPIVR.x16 v22, i5                              ; load clamp value in v22
    CMU.CPVV.i16.f16 v22, v22
    IAU.SHR.u32 i15, i15, 3        
    ; divide line width by 8 (number of pixels processed in one batch)
    NOP
...
NOP 4
    ...
    CMU.ALIGNVEC v6, v0, v15, 12 || LSU0.LD.128.U8.F16 v15, i18 || IAU.ADD i18, i18, 8
...
__loopEnd1x7:
    ...
    VAU.MACPW.f16 v20, v10, v6  || LSU1.SWZV8 [66666666]     || LSU0.ST.128.F16.U8 v20, i17 || IAU.ADD i17, i17, i7
    LSU0.LDIL i7, 8
NOP 6
