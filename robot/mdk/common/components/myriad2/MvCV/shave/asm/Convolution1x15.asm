...
Convolution1x15_asm:
    ...
    LSU0.LDO.64.L v17, i16, 0    || LSU1.LDO.64.H v17, i16, 8  ; load the filter in v17 and v18
    LSU0.LDO.64.L v18, i16, 16   || LSU1.LDO.64.H v18, i16, 24
    ...
    LSU0.LD.128.U8.F16 v16, i18  || IAU.ADD i18, i18, 8
NOP 4
    ...
    CMU.ALIGNVEC v7, v0, v15, 14
    CMU.ALIGNVEC v9, v15, v16, 2
    CMU.ALIGNVEC v10, v15, v16, 4
    CMU.ALIGNVEC v11, v15, v16, 6
    CMU.ALIGNVEC v12, v15, v16, 8
    CMU.ALIGNVEC v13, v15, v16, 10
    CMU.CPVV v8, v15
    CMU.ALIGNVEC v14, v15, v16, 12|| LSU0.LD.128.U8.F16 v16, i18 || IAU.ADD i18, i18, 8
    VAU.MACPZ.f16 v17, v0         || LSU1.SWZV8 [00000000]      || CMU.CPVV v15, v16
    VAU.MACP.f16 v17, v1          || LSU1.SWZV8 [11111111]      || CMU.CPVV v0, v8
    VAU.MACP.f16 v17, v2          || LSU1.SWZV8 [22222222]      || CMU.CLAMP0.f16 v20 v20 v22
    VAU.MACP.f16 v17, v3          || LSU1.SWZV8 [33333333]
    VAU.MACP.f16 v17, v4          || LSU1.SWZV8 [44444444]
    VAU.MACP.f16 v17, v5          || LSU1.SWZV8 [55555555]
    VAU.MACP.f16 v17, v6          || LSU1.SWZV8 [66666666]
    VAU.MACP.f16 v17, v7          || LSU1.SWZV8 [77777777]
    VAU.MACP.f16 v18, v8          || LSU1.SWZV8 [00000000]

__loopEnd1x15:
    VAU.MACP.f16 v18, v9          || LSU1.SWZV8 [11111111]
    VAU.MACP.f16 v18, v10         || LSU1.SWZV8 [22222222]
    VAU.MACP.f16 v18, v11         || LSU1.SWZV8 [33333333]
    VAU.MACP.f16 v18, v12         || LSU1.SWZV8 [44444444]
    VAU.MACP.f16 v18, v13         || LSU1.SWZV8 [55555555]
    VAU.MACPW.f16 v20, v18, v14   || LSU1.SWZV8 [66666666]      || LSU0.ST.128.F16.U8 v20, i17 || IAU.ADD i17, i17, i7
    LSU0.LDIL i7, 8
