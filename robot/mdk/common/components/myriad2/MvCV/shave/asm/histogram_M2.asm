...
LSU1.LD.32  i18  i18  ;load adress for line
nop 5
...
nop 6
	...
	nop
	LSU0.LDI.128.U8.U16 v7 i18 || CMU.CPVI.x16      i6.l   v1.0
	LSU0.LDI.128.U8.U16 v8 i18 || CMU.CPVI.x16      i7.l   v1.1 || IAU.SHL i6 i6 2
