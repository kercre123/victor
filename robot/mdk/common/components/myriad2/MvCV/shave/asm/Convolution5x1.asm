...
Convolution5x1_asm:
    ...
    LSU0.LD.32 in4, i18 || IAU.SHR.u32 i15, i15, 3 || LSU1.LD.32 i17, i17
...
__loopEnd5x1:
    ...
    VAU.MACP.f16  v15, P2        || LSU1.SWZV8 [22222222] || CMU.CLAMP0.f16 v20 v20 v22
    VAU.MACP.f16  v15, P3        || LSU1.SWZV8 [33333333]
    VAU.MACPW.f16 v20, v15, P4   || LSU1.SWZV8 [44444444] || LSU0.ST.128.F16.U8 v20, i17 || IAU.ADD i17, i17, i10
    LSU0.LDIL i10, 8
