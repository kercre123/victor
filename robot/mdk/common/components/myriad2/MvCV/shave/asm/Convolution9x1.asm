...
Convolution9x1_asm:
    ...
    LSU0.LD.32 in8, i18 || IAU.SHR.u32 i15, i15, 3 || LSU1.LD.32 i17, i17
...
__loopEnd9x1:
    ...
    VAU.MACP.f16  v15, P4        || LSU1.SWZV8 [44444444]
    VAU.MACP.f16 v15, P5         || LSU1.SWZV8 [55555555] || CMU.CLAMP0.f16 v20 v20 v22
    VAU.MACP.f16 v15, P6         || LSU1.SWZV8 [66666666]
    VAU.MACP.f16 v15, P7         || LSU1.SWZV8 [77777777] || LSU0.ST.128.F16.U8 v20, i17 || IAU.ADD i17, i17, i10

    VAU.MACPW.f16 v20, v16, P8   || LSU1.SWZV8 [00000000] || LSU0.LDIL i10, 8
