...
cvtColorKernelYUV422ToRGB_asm:
	...
	LSU0.LD16r v2, i13 				|| LSU1.LD16r v10, i11
	NOP
	LSU0.LD64.l v0 i12 
	LSU0.LDIL i6, ___loop 			|| LSU1.LDIH i6, ___loop || IAU.SHR.u32 i7 i14 3 || VAU.XOR v11, v11, v11 
	
	LSU0.LDI128.u8.f16 v1 i18 ;load first 8 values
	NOP 5
	LSU0.LDI128.u8.f16 v15 i18 ;;load the next 8 values		
	VAU.SUB.f16 v3 v1 v2   ;substract 128 from the first 8 values
	NOP 4
	
	VAU.SUB.f16 v16 v15 v2  ;substract 128 from the second 8 values
	VAU.MUL.f16 v4 v3 v0 	|| LSU0.SWZV8 [00300030] 
	VAU.MUL.f16 v5 v3 v0 	|| LSU0.SWZV8 [20102010]  	
	VAU.MUL.f16 v17 v16 v0 	|| LSU0.SWZV8 [00300030] 
	VAU.MUL.f16 v18 v16 v0 	|| LSU0.SWZV8 [20102010]
	VAU.ADD.f16 v6 v1 v4 	|| LSU0.SWZV8 [05050101]
	
	;;######################################################################## BEBINE LOOP ###############################
	.lalign
	VAU.ADD.f16 v19 v15 v17 	|| LSU0.SWZV8 [05050101] || BRU.RPL i6 i7	
	
	VAU.ADD.f16 v7 v1 v4 		|| LSU0.SWZV8 [07070303]
	VAU.ADD.f16 v8 v5 v5 		|| LSU0.SWZV8 [50701030]
	VAU.ADD.f16 v20 v15 v17 	|| LSU0.SWZV8 [07070303]	
	VAU.ADD.f16 v21 v18 v18	 	|| LSU0.SWZV8 [50701030] 	|| CMU.CLAMP0.f16 v6 v6 v10		|| LSU1.LDI128.u8.f16 v1 i18
	VAU.SUB.f16 v9 v1 v8 		|| LSU0.SWZV8 [05050101] 	|| CMU.CLAMP0.f16 v7 v7 v10 	|| LSU1.LDI128.u8.f16 v15 i18
	VAU.ADD.f16 v12 v11 v6  	|| LSU0.SWZV8 [00006420] 	|| CMU.CLAMP0.f16 v20 v20 v10
	VAU.SUB.f16 v22 v15 v21 	|| LSU0.SWZV8 [05050101]  	
	VAU.ADD.f16 v13 v11 v7 		|| LSU0.SWZV8 [00006420]	|| CMU.CLAMP0.f16 v9 v9 v10	
	VAU.ADD.f16 v14 v11 v9		|| LSU0.SWZV8 [00006420] 	|| CMU.CLAMP0.f16 v19 v19 v10
	VAU.ADD.f16 v23 v11 v19		|| LSU0.SWZV8 [00006420]
	VAU.ADD.f16 v24 v11 v20 	|| LSU0.SWZV8 [00006420]
	CMU.CLAMP0.f16 v22 v22 v10 	|| VAU.SUB.f16 v3 v1 v2	
	VAU.ADD.f16 v25 v11 v22 	|| LSU0.SWZV8 [00006420]
	
	___loop:
	CMU.VSZMWORD v13 v24 [10DD] || VAU.SUB.f16 v16 v15 v2
	CMU.VSZMWORD v12 v23 [10DD] || VAU.MUL.f16 v4 v3 v0 	|| LSU1.SWZV8 [00300030]	
	;store the results
	LSU0.ST128.f16.u8 v12 i15 	|| IAU.ADD i15, i15, 8 		|| VAU.MUL.f16 v5 v3 v0 		|| LSU1.SWZV8 [20102010] 	|| CMU.VSZMWORD v14 v25 [10DD]	
	LSU0.ST128.f16.u8 v13 i17 	|| IAU.ADD i17, i17, 8 		|| VAU.MUL.f16 v17 v16 v0 		|| LSU1.SWZV8 [00300030] 
	LSU0.ST128.f16.u8 v14 i16 	|| IAU.ADD i16, i16, 8 		|| VAU.MUL.f16 v18 v16 v0 		|| LSU1.SWZV8 [20102010]
	VAU.ADD.f16 v6 v1 v4 		|| LSU0.SWZV8 [05050101]
