...
LSU0.ST32  i29  i19 
	...
	LSU0.LD32  i0  i18 || IAU.ADD i18 i18 4 ;line 0
	LSU0.LD32  i1  i18 || IAU.ADD i18 i18 4 ;line 1
	LSU0.LD32  i2  i18 || IAU.ADD i18 i18 4 ;line 2
	LSU0.LD32  i3  i18 || IAU.ADD i18 i18 4 ;line 3
	LSU0.LD32  i4  i18 || IAU.ADD i18 i18 4 ;line 4
	LSU0.LD32  i17  i17
	nop 5
...
;making room for interm buffers	
	...
	LSU0.LDi128.u8.f16 v0 i0  
	LSU0.LDi128.u8.f16 v1 i1 
	LSU0.LDi128.u8.f16 v2 i2 
	LSU0.LDi128.u8.f16 v3 i3 
	LSU0.LDi128.u8.f16 v4 i4 
	LSU1.LD128.u8.f16 v5 i0 
	...
	VAU.ALIGNVEC v10 v0 v5 2 || bru.rpl i11 i14
	VAU.ALIGNVEC v11 v0 v5 4
	VAU.ALIGNVEC v12 v1 v6 2
	VAU.ALIGNVEC v13 v1 v6 4
	VAU.ALIGNVEC v14 v2 v7 2
	VAU.ALIGNVEC v15 v2 v7 4
	VAU.ALIGNVEC v16 v3 v8 2
	VAU.ALIGNVEC v17 v3 v8 4
	VAU.ALIGNVEC v18 v4 v9 2
	VAU.ALIGNVEC v19 v4 v9 4
	...
	VAU.sub.f16 v23 v22 v23 || LSU0.LDi128.u8.f16 v0 i0 
	nop 2
	...
	VAU.sub.f16 v23 v22 v23 || LSU0.LDi128.u8.f16 v1 i1 
	nop 2
	...
	VAU.ADD.f16 v23 v17 v17 || LSU0.LDi128.u8.f16 v3 i3 
	VAU.ADD.f16 v21 v20 v21
	VAU.sub.f16 v20 v2 v4
	VAU.sub.f16 v23 v22 v23 || LSU0.LDi128.u8.f16 v2 i2 
	LSU0.LDi128.u8.f16 v4 i4
	nop
	...
	LSU0.STi64.l   v5   i5 
	LSU0.STi64.h   v5   i5 ;dx1

	LSU0.STi64.l   v6   i8 || LSU1.LD128.u8.f16 v5 i0
	LSU0.STi64.h   v6   i8 ;dy1
	LSU0.STi64.l   v7   i6 || LSU1.LD128.u8.f16 v6 i1
	LSU0.STi64.h   v7   i6 ;dx2
	___loop:
	LSU0.STi64.l   v8   i9 || LSU1.LD128.u8.f16 v7 i2
	LSU0.STi64.h   v8   i9 ;dy2
	LSU0.STi64.l   v9   i7 || LSU1.LD128.u8.f16 v8 i3
	LSU0.STi64.h   v9   i7 ;dx3
	LSU0.STi64.l   v10  i10 || LSU1.LD128.u8.f16 v9 i4 
	LSU0.STi64.h   v10  i10 ;dy3
...
lsu0.ld32r v0 i13 || IAU.ADD i13 i13 4
...
LSU0.LD128.f16.f32  v1  i5  || IAU.ADD i5  i5  8 || bru.rpl i11 i14                             ;dx1
LSU0.LD128.f16.f32  v2  i6  || IAU.ADD i6  i6  8 || LSU1.LD128.f16.f32  v7  i5  ;dx2
LSU0.LD128.f16.f32  v3  i7  || IAU.ADD i7  i7  8 || LSU1.LD128.f16.f32  v8  i6  ;dx3
LSU0.LD128.f16.f32  v4  i8  || IAU.ADD i8  i8  8 || LSU1.LD128.f16.f32  v9  i7  ;dy1
LSU0.LD128.f16.f32  v5  i9  || IAU.ADD i9  i9  8 || LSU1.LD128.f16.f32  v10 i8  ;dy2
LSU0.LD128.f16.f32  v6  i10 || IAU.ADD i10 i10 8 || LSU1.LD128.f16.f32  v11 i9  ;dy3
LSU1.LD128.f16.f32  v12 i10                                                     ;
...
VAU.ALIGNVEC v1  v13 v19 4 ;dxx
VAU.ALIGNVEC v2  v13 v19 8
VAU.ALIGNVEC v3  v14 v20 4
VAU.ALIGNVEC v4  v14 v20 8
VAU.ALIGNVEC v5  v15 v21 4
VAU.ALIGNVEC v6  v15 v21 8
                 
VAU.ALIGNVEC v7  v16 v22 4 ;dyy
VAU.ALIGNVEC v8  v16 v22 8
VAU.ALIGNVEC v9  v17 v23 4
VAU.ALIGNVEC v10 v17 v23 8
VAU.ALIGNVEC v11 v18 v24 4
VAU.ALIGNVEC v12 v18 v24 8


VAU.ALIGNVEC v19  v25 v28 4 ;dxy
VAU.ALIGNVEC v20  v25 v28 8
VAU.ALIGNVEC v21  v26 v29 4
VAU.ALIGNVEC v22  v26 v29 8
VAU.ALIGNVEC v23  v27 v30 4
VAU.ALIGNVEC v24  v27 v30 8
...
vau.add.f32 v7 v31 v7 || lsu0.sti64.l v1  i1
vau.add.f32 v29 v20 v26 || lsu0.sti64.h v1  i1 
...
nop
vau.add.f32 v19 v31 v19 || lsu0.sti64.l v7  i3 
lsu0.sti64.h v7  i3
nop
...
lsu0.ld32r v4 i13  || iau.add i13 i13 4 ;0.5
lsu0.ld32r v14 i13 || iau.add i13 i13 4 ;1.5
lsu0.ld32r v30 i13
IAU.SUB i11 i16 4
...
LSU0.LD64.l v2 i2  || IAU.ADD i2 i2 8      
LSU0.LD64.h v2 i2  || IAU.ADD i2 i2 8      
LSU0.LD64.l v3 i3  || IAU.ADD i3 i3 8      
LSU0.LD64.h v3 i3  || IAU.ADD i3 i3 8    
nop 4
...
CMU.CPVi.x32 i21  v28.1 || lsu0.sti8 i20 i17
CMU.CPVi.x32 i22  v28.2 || lsu0.sti8 i21 i17
CMU.CPVi.x32 i23  v28.3 || lsu0.sti8 i22 i17
lsu0.sti8 i23 i17
...
nop
CMU.CPVi.x32 i20  v28.0
CMU.CPVi.x32 i21  v28.1 || lsu0.sti8 i20 i26
CMU.CPVi.x32 i22  v28.2 || lsu0.sti8 i21 i26
CMU.CPVi.x32 i23  v28.3 || lsu0.sti8 i22 i26
lsu0.sti8 i23 i26

LSU0.ldil i8, ___compensate_loop || LSU1.ldih i8, ___compensate_loop

lsu0.ldi8 i7, i6 || bru.rpl i8 i5
___compensate_loop:
nop 5
