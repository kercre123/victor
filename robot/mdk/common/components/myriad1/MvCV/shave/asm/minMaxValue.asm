...
minMaxKernel_asm:
LSU0.LD32 i10 i18 || IAU.SUB i4 i4 i4; loads input img
LSU0.LDIL i0 ___minMax_loop || LSU1.LDIH i0 ___minMax_loop  || IAU.SUB i2 i2 i2
IAU.SUB i5 i5 i5
LSU0.LD8 i5 i15   ;minVal
LSU0.LD8 i4 i14  || IAU.SUB i7 i7 i7    ;maxVal
...
___minMax_loop_head:
    LSU0.LDO64.l v3 i10 0 || LSU1.LDO64.h v3 i10 8 || BRU.RPL i0 i1
    LSU0.LDO64.l v1 i10 0 || LSU1.LDO64.h v1 i10 8 || IAU.ADD i10 i10 16
    LSU0.LDO64.l v2 i13 0 || LSU1.LDO64.h v2 i13 8 || IAU.ADD i13 i13 16
    nop 5
    ...
    ___store_minMax:
        CMU.MAX.u8 v7, v7, v7 || LSU0.SWZC4BYTE [2301]
        CMU.MAX.u8 v8, v8, v8 || LSU1.SWZC4BYTE [2301]
        CMU.MAX.u8 v7, v7, v7 || LSU0.SWZC4BYTE [1032]
        CMU.MAX.u8 v8, v8, v8 || LSU1.SWZC4BYTE [1032]
        CMU.MAX.u8 v7, v7, v7 || LSU0.SWZC4WORD [2301]
        CMU.MAX.u8 v8, v8, v8 || LSU1.SWZC4WORD [2301]
        CMU.MAX.u8 v7, v7, v7 || LSU0.SWZC4WORD [1032]
        CMU.MAX.u8 v8, v8, v8 || LSU1.SWZC4WORD [1032] ;last performed swizzle operation leads to a vrf
        ...
        LSU1.ST8 i4 i14 ; stores the highest value found in the img
