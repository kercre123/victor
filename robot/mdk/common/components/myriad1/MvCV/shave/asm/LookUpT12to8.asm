...
lsu0.sti8 i4, i17 ||cmu.cpvi i0, v3.0  || vau.and v1, v0, v6
___loop_end:
lsu0.sti8 i5, i17 ||cmu.cpvi i10, v3.1  || lsu1.ld16 i4, i0
lsu0.sti8 i6, i17 ||cmu.cpvi i11, v3.2  || lsu1.ld16 i5, i10
lsu0.sti8 i7, i17 ||cmu.cpvi i3, v3.3   || lsu1.ld16 i6, i11 || vau.add.i32 v3, v1, v5
lsu1.ld16 i7, i3
nop 2
