...
LSU0.LDO32 i1  i18 0 || VAU.SUB.i8  v21 v21 v21   

;If width < 40 then
CMU.CMII.u32 i15 i0
PEU.PC1C LT || CMU.CPII i0 i15 

LSU0.LD32  i17 i17      || LSU1.LDO32 i8  i16 0   || SAU.DIV.u32 i3 i15 i0    || CMU.CPII i6 i16 || VAU.SUB.i8  v22 v22 v22
...
LSU0.LDO8    i13 i8  4   || LSU1.LDO8 i14 i8 5  || VAU.SUB.i8 v1 v31 v1
...
; Load source values
CMU.VROT     v5  v1  4   || VAU.SUB.i8 v0  v31 v0 
CMU.VROT     v6  v1  5   || VAU.SUB.i8 v25 v31 v25 
CMU.VROT     v7  v1  6   || VAU.SUB.i8 v29 v31 v29
...
LSU0.LDO32   i1  i5    0  || VAU.SUB.i8 v27 v31 v27
LSU0.STO64.l v26 i17   0  || LSU1.STO64.h v26 i17  8     || IAU.ADD    i17 i17 i24  || CMU.CPII   i18 i5  || VAU.SUB.i8 v28 v31 v28
NOP
; Store the kernel maximum
___Store_Values:
LSU0.STO64.l v27 i17   0  || LSU1.STO64.h v27 i17  8     || IAU.ADD    i17 i17 i23  || VAU.SUB.i8 v30 v31 v30
