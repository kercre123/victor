...
#define REG_TX_PGCOLOR_CTRL 0xA9
#define REG_TX_PG_R_INIT 0xAA
#define REG_TX_PG_G_INIT 0xAB
#define REG_TX_PG_B_INIT 0xAC
#define REG_TX_PG_BLANK 0xAD
#define REG_TX_PG_BLANKY 0xAE
#define REG_TX_PG_H_COLOR_VALUE_INCREMENT 0xAF
#define REG_TX_PG_V_COLOR_VALUE_INCREMENT 0xB0
...
#define REG_TX_AUDIO_HBR 0xE5
    #define B_AUD_HBR (1<<3)
	#define B_AUD_SPDIF_READ_BACK (1<<4)
    #define B_AUD_Baud (1<<1)
...
#define     ENABLE_NULL_PKT()           HDMITX_WriteI2C_Byte (REG_TX_NULL_CTRL,         B_ENABLE_PKT | B_REPEAT_PKT)
#define     ENABLE_ACP_PKT()            HDMITX_WriteI2C_Byte (REG_TX_ACP_CTRL,          B_ENABLE_PKT | B_REPEAT_PKT)
#define     ENABLE_ISRC1_PKT()          HDMITX_WriteI2C_Byte (REG_TX_ISRC1_CTRL,        B_ENABLE_PKT | B_REPEAT_PKT)
#define     ENABLE_ISRC2_PKT()          HDMITX_WriteI2C_Byte (REG_TX_ISRC2_CTRL,        B_ENABLE_PKT | B_REPEAT_PKT)
#define     ENABLE_AVI_INFOFRM_PKT()    HDMITX_WriteI2C_Byte (REG_TX_AVI_INFOFRM_CTRL,  B_ENABLE_PKT | B_REPEAT_PKT)
#define     ENABLE_AUD_INFOFRM_PKT()    HDMITX_WriteI2C_Byte (REG_TX_AUD_INFOFRM_CTRL,  B_ENABLE_PKT | B_REPEAT_PKT)
#define     ENABLE_SPD_INFOFRM_PKT()    HDMITX_WriteI2C_Byte (REG_TX_SPD_INFOFRM_CTRL,  B_ENABLE_PKT | B_REPEAT_PKT)
#define     ENABLE_MPG_INFOFRM_PKT()    HDMITX_WriteI2C_Byte (REG_TX_MPG_INFOFRM_CTRL,  B_ENABLE_PKT | B_REPEAT_PKT)

#define     DISABLE_NULL_PKT()          HDMITX_WriteI2C_Byte (REG_TX_NULL_CTRL,         0)
#define     DISABLE_ACP_PKT()           HDMITX_WriteI2C_Byte (REG_TX_ACP_CTRL,          0)
#define     DISABLE_ISRC1_PKT()         HDMITX_WriteI2C_Byte (REG_TX_ISRC1_CTRL,        0)
#define     DISABLE_ISRC2_PKT()         HDMITX_WriteI2C_Byte (REG_TX_ISRC2_CTRL,        0)
#define     DISABLE_AVI_INFOFRM_PKT()   HDMITX_WriteI2C_Byte (REG_TX_AVI_INFOFRM_CTRL,  0)
#define     DISABLE_AUD_INFOFRM_PKT()   HDMITX_WriteI2C_Byte (REG_TX_AUD_INFOFRM_CTRL,  0)
#define     DISABLE_SPD_INFOFRM_PKT()   HDMITX_WriteI2C_Byte (REG_TX_SPD_INFOFRM_CTRL,  0)
#define     DISABLE_MPG_INFOFRM_PKT()   HDMITX_WriteI2C_Byte (REG_TX_MPG_INFOFRM_CTRL,  0)
...
#define ReadTxIntPin() ((HDMITX_ReadI2C_Byte(REG_TX_SYS_STATUS)&(B_INT_ACTIVE|B_RXSENDETECT)) ? TRUE:FALSE)
#define IsRxSense() ((HDMITX_ReadI2C_Byte(REG_TX_SYS_STATUS)&B_RXSENDETECT) ? TRUE:FALSE)
#define IsHPDetect() ((HDMITX_ReadI2C_Byte(REG_TX_SYS_STATUS)&B_HPDETECT) ? TRUE:FALSE)
