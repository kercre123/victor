...
void reorder( unsigned short *r, float *x, int logm)
{
    int i;
    int size = 1 << logm;
    ...
    // {
        ...
        // /*
        // fft_tables->reordertbl[logm] = AllocMemory(size * sizeof(*(fft_tables->reordertbl[0])), "fft_tables->reordertbl[logm]");
        ...
        // {
            ...
            // //andreil: logm = 6 or 9; so need shorts for reordertbl[]
            // for (b0 = 0; b0 < logm; b0++)
            // {
        ...
        // switch(logm)
        // {
        // case 6: DUMP_u16_tbl(fft_tables->reordertbl[logm], size, "reordertbl_6", "reordertbl_6.hh"); break;
        // case 8: DUMP_u16_tbl(fft_tables->reordertbl[logm], size, "reordertbl_8", "reordertbl_8.hh"); break;
        // case 9: DUMP_u16_tbl(fft_tables->reordertbl[logm], size, "reordertbl_9", "reordertbl_9.hh"); break;
        // default: exit(0);
        // }
        // */
        ...
        // switch(logm)
        // {
        // case 6: fft_tables->reordertbl[logm] = reordertbl_6; break;
        // case 8: fft_tables->reordertbl[logm] = reordertbl_8; break;
        // case 9: fft_tables->reordertbl[logm] = reordertbl_9; break;
        // default: break;//ERROR
        // }
...
void fft( FFT_Tables *fft_tables, float *xr, float *xi, int logm)
{
   ...
   //andreil: logm = 6, or 9, can skip these tests...
    ...
    //andriel: jsut pass the TABLE, as we're going to do this in ASM !!!
      reorder( fft_tables->reordertbl[logm], xr, logm);
	  reorder( fft_tables->reordertbl[logm], xi, logm);
