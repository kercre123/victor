...
///This is not just one instruction because moviCompile is completely blind
///to inline assembly blocks and therefore would not know if a register was loaded
///@param[in] var u32 variable to switch contents to
#define swcShaveSwapU32VarContents(var) __asm("nop 5\nSAU.SWZBYTE %0, %1, [0123]\nnop 5\n":"=r"(var):"r"(var))

///Switch u32 contents of variable and place results in a different variable
///This is not just one instruction because moviCompile is completely blind
///to inline assembly blocks and therefore would not know if a register was loaded
///@param[in]  varin u32 variable to switch contents
///@param[out] varout u32 variable to place switched contents into
#define swcShaveSwapU32VarsContents(varin,varout) __asm("nop 5\nSAU.SWZBYTE %0, %1, [0123]\nnop 5\n":"=r"(varout):"r"(varin))
...
#define scFifoRead() \
    int t; \
    __asm ("nop 5\nlsu0.lda32 %0, SLICE_LOCAL, FIFO_RD_FRONT_L\nnop 5\n": "=r"(t): : );
...
/// @return    - void
#define scDmaStart(taskNum) __asm ("NOP 5\nLSU0.STA32 %0, SLICE_LOCAL, DMA_TASK_REQ\nNOP 5\n" : : "r"(taskNum): );
...
/// @param[in]  dst - destination for task
/// @param[in]  numBytes - length in bytes
/// @param[in]  width  - line width in bytes
/// @param[in]  stride - stride length in bytes
/// @return     void
///
#ifdef __cplusplus
extern "C"
...
/// @param[in]  numBytes - length in bytes
/// @param[in]  line_width  - line width in bytes
/// @param[in]  stride - stride length in bytes
/// @return     void
///
#ifdef __cplusplus
extern "C"
#endif
void scDmaMemsetDDR(void *dst, unsigned char val, unsigned int numBytes, unsigned int line_width, int stride);
