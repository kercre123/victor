...
///
/// @brief     Gauss Horizontal x2 subsample
///
///  Contains a function that applay downscale 2x horizontal with a gaussian filters with kernel 5x5. 
...
#ifndef __GAUSS_H_X2_H__
#define __GAUSS_H_X2_H__
