...
void vPortFree( void *pv, const char* fileName, const int line );
void *pvPortMalloc( size_t xWantedSize, const char* fileName, const int line );
void *pvPortCalloc(size_t size, const char* fileName, const int line );
void *pvPortRealloc(size_t size, const char* fileName, const int line );
void *pvPortZalloc(size_t size, const char* fileName, const int line );
