...
static uint64_t Sigma0(uint64_t x) { return Rt(x, 28) ^ Rt(x, 34) ^ Rt(x, 39); }

static uint64_t Sigma1(uint64_t x) { return Rt(x, 14) ^ Rt(x, 18) ^ Rt(x, 41); }

static uint64_t Gamma0(uint64_t x) { return Rt(x, 1) ^ Rt(x, 8) ^ Rs(x, 7); }

static uint64_t Gamma1(uint64_t x) { return Rt(x, 19) ^ Rt(x, 61) ^ Rs(x, 6); }

static void Sha512Round(uint64_t* W, uint64_t i, uint64_t a, uint64_t b,
