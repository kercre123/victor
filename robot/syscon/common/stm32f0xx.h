...
/* #define STM32F091 */
/* #define STM32F030xC */
#endif /* STM32F030 || STM32F031 || STM32F051 || STM32F072 || STM32F042 || \
          STM32F091 || STM32F070xB || STM32F070x6 || STM32F030xC */
...
typedef enum IRQn {
  ...
  WWDG_IRQn = 0,       /*!< Window WatchDog Interrupt       */
  PVD_VDDIO2_IRQn = 1, /*!< PVD and VDDIO2 supply comparator through EXTI Line
                          detect Interrupt */
  RTC_IRQn = 2,        /*!< RTC through EXTI Line Interrupt        */
  FLASH_IRQn = 3,      /*!< FLASH Interrupt      */
  ...
  WWDG_IRQn = 0, /*!< Window WatchDog Interrupt */
  PVD_VDDIO2_IRQn =
      1, /*!< PVD & VDDIO2 Interrupts through EXTI Lines 16 and 31            */
  ...
  DMA1_Ch2_3_DMA2_Ch1_2_IRQn =
      10, /*!< DMA1 Channel 2 and 3 & DMA2 Channel 1 and 2 Interrupts */
  DMA1_Ch4_7_DMA2_Ch3_5_IRQn =
      11, /*!< DMA1 Channel 4 to 7 & DMA2 Channel 3 to 5 Interrupts */
  ADC1_COMP_IRQn =
      12, /*!< ADC, COMP1 and COMP2 Interrupts (EXTI Lines 21 and 22) */
  TIM1_BRK_UP_TRG_COM_IRQn =
      13, /*!< TIM1 Break, Update, Trigger and Commutation Interrupts */
  TIM1_CC_IRQn = 14, /*!< TIM1 Capture Compare Interrupt */
  ...
  I2C2_IRQn =
      24, /*!< I2C2 Event Interrupt & EXTI Line24 Interrupt (I2C2 wakeup) */
  SPI1_IRQn = 25,   /*!< SPI1 global Interrupt   */
  SPI2_IRQn = 26,   /*!< SPI2 global Interrupt   */
  USART1_IRQn = 27, /*!< USART1 global Interrupt & EXTI Line25 Interrupt (USART1
                       wakeup) */
  USART2_IRQn = 28, /*!< USART2 global Interrupt & EXTI Line26 Interrupt (USART2
                       wakeup) */
  ...
  DMA1_Channel2_3_IRQn = 10, /*!< DMA1 Channel 2 and Channel 3 Interrupts */
  DMA1_Channel4_5_IRQn = 11, /*!< DMA1 Channel 4 and Channel 5 Interrupts */
  ADC1_IRQn = 12, /*!< ADC1 interrupts (ADC interrupt combined with EXTI Lines
                     21 and 22 */
  TIM1_BRK_UP_TRG_COM_IRQn =
      13, /*!< TIM1 Break, Update, Trigger and Commutation Interrupts */
  TIM1_CC_IRQn = 14, /*!< TIM1 Capture Compare Interrupt */
...
typedef struct {
  ...
  uint32_t RESERVED0[40]; /*!< Reserved as declared by channel typedef 0x08 -
                             0xA4*/
...
typedef struct {
  __IO uint16_t RDP; /*!< FLASH option byte Read protection,             Address
                        offset: 0x00 */
  __IO uint16_t USER;  /*!< FLASH option byte user options,  Address offset:
                          0x02 */
...
typedef struct {
  ...
  uint32_t RESERVED1[25];       /*!< Reserved + COMP,
                                   0x1C */
...
typedef struct {
  ...
  __IO uint32_t WUTR;   /*!< RTC wakeup timer register,(only for STM32F072
                           devices)    Address offset: 0x14 */
...
#define ADC_CFGR2_CKMODE_1 \
  ((uint32_t)0x80000000) /*!< ADC clocked by PCLK div4 */
#define ADC_CFGR2_CKMODE_0 \
  ((uint32_t)0x40000000) /*!< ADC clocked by PCLK div2 */
...
#define ADC_SMPR_SMP \
  ((uint32_t)0x00000007) /*!< SMP[2:0] bits (Sampling time selection) */
...
#define CRC_CR_POLSIZE                                                 \
  ((uint32_t)0x00000018) /*!< Polynomial size bits (only for STM32F072 \
                            devices)*/
#define CRC_CR_POLSIZE_0                                                \
  ((uint32_t)0x00000008) /*!< Polynomial size bit 0 (only for STM32F072 \
                            devices) */
#define CRC_CR_POLSIZE_1                                                \
  ((uint32_t)0x00000010) /*!< Polynomial size bit 1 (only for STM32F072 \
                            devices) */
...
#define CRC_POL_POL                                                    \
  ((uint32_t)0xFFFFFFFF) /*!< Coefficients of the polynomial (only for \
                            STM32F072 devices) */
...
#define CRS_CR_SYNCOKIE \
  ((uint32_t)0x00000001) /* SYNC event OK interrupt enable        */
#define CRS_CR_SYNCWARNIE \
  ((uint32_t)0x00000002) /* SYNC warning interrupt enable         */
#define CRS_CR_ERRIE \
  ((uint32_t)0x00000004) /* SYNC error interrupt enable           */
#define CRS_CR_ESYNCIE \
  ((uint32_t)0x00000008) /* Expected SYNC(ESYNCF) interrupt Enable*/
#define CRS_CR_CEN \
  ((uint32_t)0x00000020) /* Frequency error counter enable        */
#define CRS_CR_AUTOTRIMEN \
  ((uint32_t)0x00000040) /* Automatic trimming enable             */
#define CRS_CR_SWSYNC \
  ((uint32_t)0x00000080) /* A Software SYNC event is generated    */
#define CRS_CR_TRIM \
  ((uint32_t)0x00003F00) /* HSI48 oscillator smooth trimming      */

/*******************  Bit definition for CRS_CFGR register
 * *********************/
#define CRS_CFGR_RELOAD \
  ((uint32_t)0x0000FFFF) /* Counter reload value               */
#define CRS_CFGR_FELIM \
  ((uint32_t)0x00FF0000) /* Frequency error limit              */
#define CRS_CFGR_SYNCDIV \
  ((uint32_t)0x07000000) /* SYNC divider                       */
...
#define CRS_CFGR_SYNCSRC \
  ((uint32_t)0x30000000) /* SYNC signal source selection       */
#define CRS_CFGR_SYNCSRC_0 \
  ((uint32_t)0x10000000) /* Bit 0                              */
#define CRS_CFGR_SYNCSRC_1 \
  ((uint32_t)0x20000000) /* Bit 1                              */
#define CRS_CFGR_SYNCPOL \
  ((uint32_t)0x80000000) /* SYNC polarity selection            */

/*******************  Bit definition for CRS_ISR register *********************/
#define CRS_ISR_SYNCOKF \
  ((uint32_t)0x00000001) /* SYNC event OK flag             */
#define CRS_ISR_SYNCWARNF \
  ((uint32_t)0x00000002)                    /* SYNC warning                   */
#define CRS_ISR_ERRF ((uint32_t)0x00000004) /* SYNC error flag */
#define CRS_ISR_ESYNCF \
  ((uint32_t)0x00000008) /* Expected SYNC flag             */
#define CRS_ISR_SYNCERR \
  ((uint32_t)0x00000100) /* SYNC error                     */
#define CRS_ISR_SYNCMISS \
  ((uint32_t)0x00000200) /* SYNC missed                    */
#define CRS_ISR_TRIMOVF \
  ((uint32_t)0x00000400) /* Trimming overflow or underflow */
#define CRS_ISR_FEDIR \
  ((uint32_t)0x00008000) /* Frequency error direction      */
#define CRS_ISR_FECAP \
  ((uint32_t)0xFFFF0000) /* Frequency error capture        */

/*******************  Bit definition for CRS_ICR register *********************/
#define CRS_ICR_SYNCOKC \
  ((uint32_t)0x00000001) /* SYNC event OK clear flag     */
#define CRS_ICR_SYNCWARNC \
  ((uint32_t)0x00000002)                      /* SYNC warning clear flag      */
...
#define DAC_CR_WAVE1                                                       \
  ((uint32_t)0x000000C0) /*!< WAVE1[1:0] (DAC channel1 noise/triangle wave \
                            generation enable)(only for STM32F072 devices) */
#define DAC_CR_WAVE1_0 ((uint32_t)0x00000040) /*!< Bit 0 */
#define DAC_CR_WAVE1_1 ((uint32_t)0x00000080) /*!< Bit 1 */

#define DAC_CR_MAMP1                                                  \
  ((uint32_t)0x00000F00) /*!< MAMP1[3:0] (DAC channel1 Mask/Amplitude \
                            selector) (only for STM32F072 devices) */
...
#define DAC_SWTRIGR_SWTRIG2 \
  ((uint32_t)0x00000002) /*!<DAC channel2 software trigger */
...
#define DAC_SR_DMAUDR2                                                 \
  ((uint32_t)0x20000000) /*!< DAC channel2 DMA underrun flag (only for \
                            STM32F072 and STM32F042 devices) */
...
#define DBGMCU_APB1_FZ_DBG_TIM6_STOP                                        \
  ((uint32_t)0x00000010) /*!< TIM6 counter stopped when core is halted (not \
                            available on STM32F042 devices)*/
#define DBGMCU_APB1_FZ_DBG_TIM7_STOP                                         \
  ((uint32_t)0x00000020) /*!< TIM7 counter stopped when core is halted (only \
...
#define DBGMCU_APB1_FZ_DBG_I2C1_SMBUS_TIMEOUT                              \
  ((uint32_t)0x00200000) /*!< I2C1 SMBUS timeout mode stopped when Core is \
                            halted */
#define DBGMCU_APB1_FZ_DBG_CAN_STOP                                           \
  ((uint32_t)0x02000000) /*!< CAN debug stopped when Core is halted (only for \
                            STM32F072 devices) */
...
#define DBGMCU_APB2_FZ_DBG_TIM15_STOP                                        \
  ((uint32_t)0x00010000) /*!< TIM15 counter stopped when core is halted (not \
                            available on STM32F042 devices) */
...
#define DMA_ISR_GIF6                                                    \
  ((uint32_t)0x00100000) /*!< Channel 6 Global interrupt flag (only for \
                            STM32F072 devices) */
#define DMA_ISR_TCIF6                                                    \
  ((uint32_t)0x00200000) /*!< Channel 6 Transfer Complete flag (only for \
                            STM32F072 devices) */
#define DMA_ISR_HTIF6                                                          \
  ((uint32_t)0x00400000) /*!< Channel 6 Half Transfer flag (only for STM32F072 \
                            devices) */
#define DMA_ISR_TEIF6                                                 \
  ((uint32_t)0x00800000) /*!< Channel 6 Transfer Error flag (only for \
                            STM32F072 devices) */
#define DMA_ISR_GIF7                                                    \
  ((uint32_t)0x01000000) /*!< Channel 7 Global interrupt flag (only for \
                            STM32F072 devices) */
#define DMA_ISR_TCIF7                                                    \
  ((uint32_t)0x02000000) /*!< Channel 7 Transfer Complete flag (only for \
                            STM32F072 devices) */
#define DMA_ISR_HTIF7                                                          \
  ((uint32_t)0x04000000) /*!< Channel 7 Half Transfer flag (only for STM32F072 \
                            devices) */
#define DMA_ISR_TEIF7                                                 \
  ((uint32_t)0x08000000) /*!< Channel 7 Transfer Error flag (only for \
                            STM32F072 devices) */
...
#define DMA_IFCR_CGIF6                                                   \
  ((uint32_t)0x00100000) /*!< Channel 6 Global interrupt clear (only for \
                            STM32F072 devices) */
#define DMA_IFCR_CTCIF6                                                   \
  ((uint32_t)0x00200000) /*!< Channel 6 Transfer Complete clear (only for \
                            STM32F072 devices) */
#define DMA_IFCR_CHTIF6                                               \
  ((uint32_t)0x00400000) /*!< Channel 6 Half Transfer clear (only for \
                            STM32F072 devices) */
#define DMA_IFCR_CTEIF6                                                \
  ((uint32_t)0x00800000) /*!< Channel 6 Transfer Error clear (only for \
                            STM32F072 devices) */
#define DMA_IFCR_CGIF7                                                   \
  ((uint32_t)0x01000000) /*!< Channel 7 Global interrupt clear (only for \
                            STM32F072 devices) */
#define DMA_IFCR_CTCIF7                                                   \
  ((uint32_t)0x02000000) /*!< Channel 7 Transfer Complete clear (only for \
                            STM32F072 devices) */
#define DMA_IFCR_CHTIF7                                               \
  ((uint32_t)0x04000000) /*!< Channel 7 Half Transfer clear (only for \
                            STM32F072 devices) */
#define DMA_IFCR_CTEIF7                                                \
  ((uint32_t)0x08000000) /*!< Channel 7 Transfer Error clear (only for \
                            STM32F072 devices) */
 ...
 * ********************/
#define DMA_RMPCR1_DEFAULT \
  ((uint32_t)0x00000000) /*!< Default remap position for DMA1 */
#define DMA_RMPCR1_CH1_ADC \
  ((uint32_t)0x00000001) /*!< Remap ADC on DMA1 Channel 1*/
#define DMA_RMPCR1_CH1_TIM17_CH1 \
  ((uint32_t)0x00000007) /*!< Remap TIM17 channel 1 on DMA1 channel 1 */
#define DMA_RMPCR1_CH1_TIM17_UP \
  ((uint32_t)0x00000007) /*!< Remap TIM17 up on DMA1 channel 1 */
#define DMA_RMPCR1_CH1_USART1_RX \
  ((uint32_t)0x00000008) /*!< Remap USART1 Rx on DMA1 channel 1 */
#define DMA_RMPCR1_CH1_USART2_RX \
  ((uint32_t)0x00000009) /*!< Remap USART2 Rx on DMA1 channel 1 */
#define DMA_RMPCR1_CH1_USART3_RX \
  ((uint32_t)0x0000000A) /*!< Remap USART3 Rx on DMA1 channel 1 */
#define DMA_RMPCR1_CH1_USART4_RX \
  ((uint32_t)0x0000000B) /*!< Remap USART4 Rx on DMA1 channel 1 */
#define DMA_RMPCR1_CH1_USART5_RX \
  ((uint32_t)0x0000000C) /*!< Remap USART5 Rx on DMA1 channel 1 */
#define DMA_RMPCR1_CH1_USART6_RX \
  ((uint32_t)0x0000000D) /*!< Remap USART6 Rx on DMA1 channel 1 */
#define DMA_RMPCR1_CH1_USART7_RX \
  ((uint32_t)0x0000000E) /*!< Remap USART7 Rx on DMA1 channel 1 */
#define DMA_RMPCR1_CH1_USART8_RX \
  ((uint32_t)0x0000000F) /*!< Remap USART8 Rx on DMA1 channel 1 */
#define DMA_RMPCR1_CH2_ADC \
  ((uint32_t)0x00000010) /*!< Remap ADC on DMA1 channel 2 */
#define DMA_RMPCR1_CH2_I2C1_TX \
  ((uint32_t)0x00000020) /*!< Remap I2C1 Tx on DMA1 channel 2 */
#define DMA_RMPCR1_CH2_SPI_1RX \
  ((uint32_t)0x00000030) /*!< Remap SPI1 Rx on DMA1 channel 2 */
#define DMA_RMPCR1_CH2_TIM1_CH1 \
  ((uint32_t)0x00000040) /*!< Remap TIM1 channel 1 on DMA1 channel 2 */
#define DMA_RMPCR1_CH2_TIM17_CH1 \
  ((uint32_t)0x00000070) /*!< Remap TIM17 channel 1 on DMA1 channel 2 */
#define DMA_RMPCR1_CH2_TIM17_UP \
  ((uint32_t)0x00000070) /*!< Remap TIM17 up on DMA1 channel 2 */
#define DMA_RMPCR1_CH2_USART1_TX \
  ((uint32_t)0x00000080) /*!< Remap USART1 Tx on DMA1 channel 2 */
#define DMA_RMPCR1_CH2_USART2_TX \
  ((uint32_t)0x00000090) /*!< Remap USART2 Tx on DMA1 channel 2 */
#define DMA_RMPCR1_CH2_USART3_TX \
  ((uint32_t)0x000000A0) /*!< Remap USART3 Tx on DMA1 channel 2 */
#define DMA_RMPCR1_CH2_USART4_TX \
  ((uint32_t)0x000000B0) /*!< Remap USART4 Tx on DMA1 channel 2 */
#define DMA_RMPCR1_CH2_USART5_TX \
  ((uint32_t)0x000000C0) /*!< Remap USART5 Tx on DMA1 channel 2 */
#define DMA_RMPCR1_CH2_USART6_TX \
  ((uint32_t)0x000000D0) /*!< Remap USART6 Tx on DMA1 channel 2 */
#define DMA_RMPCR1_CH2_USART7_TX \
  ((uint32_t)0x000000E0) /*!< Remap USART7 Tx on DMA1 channel 2 */
#define DMA_RMPCR1_CH2_USART8_TX \
  ((uint32_t)0x000000F0) /*!< Remap USART8 Tx on DMA1 channel 2 */
#define DMA_RMPCR1_CH3_TIM6_UP \
  ((uint32_t)0x00000100) /*!< Remap TIM6 up on DMA1 channel 3 */
#define DMA_RMPCR1_CH3_DAC_CH1 \
  ((uint32_t)0x00000100) /*!< Remap DAC Channel 1on DMA1 channel 3 */
#define DMA_RMPCR1_CH3_I2C1_RX \
  ((uint32_t)0x00000200) /*!< Remap I2C1 Rx on DMA1 channel 3 */
#define DMA_RMPCR1_CH3_SPI1_TX \
  ((uint32_t)0x00000300) /*!< Remap SPI1 Tx on DMA1 channel 3 */
#define DMA_RMPCR1_CH3_TIM1_CH2 \
  ((uint32_t)0x00000400) /*!< Remap TIM1 channel 2 on DMA1 channel 3 */
#define DMA_RMPCR1_CH3_TIM2_CH2 \
  ((uint32_t)0x00000500) /*!< Remap TIM2 channel 2 on DMA1 channel 3 */
#define DMA_RMPCR1_CH3_TIM16_CH1 \
  ((uint32_t)0x00000700) /*!< Remap TIM16 channel 1 on DMA1 channel 3 */
#define DMA_RMPCR1_CH3_TIM16_UP \
  ((uint32_t)0x00000700) /*!< Remap TIM16 up on DMA1 channel 3 */
#define DMA_RMPCR1_CH3_USART1_RX \
  ((uint32_t)0x00000800) /*!< Remap USART1 Rx on DMA1 channel 3 */
#define DMA_RMPCR1_CH3_USART2_RX \
  ((uint32_t)0x00000900) /*!< Remap USART2 Rx on DMA1 channel 3 */
#define DMA_RMPCR1_CH3_USART3_RX \
  ((uint32_t)0x00000A00) /*!< Remap USART3 Rx on DMA1 channel 3 */
#define DMA_RMPCR1_CH3_USART4_RX \
  ((uint32_t)0x00000B00) /*!< Remap USART4 Rx on DMA1 channel 3 */
#define DMA_RMPCR1_CH3_USART5_RX \
  ((uint32_t)0x00000C00) /*!< Remap USART5 Rx on DMA1 channel 3 */
#define DMA_RMPCR1_CH3_USART6_RX \
  ((uint32_t)0x00000D00) /*!< Remap USART6 Rx on DMA1 channel 3 */
#define DMA_RMPCR1_CH3_USART7_RX \
  ((uint32_t)0x00000E00) /*!< Remap USART7 Rx on DMA1 channel 3 */
#define DMA_RMPCR1_CH3_USART8_RX \
  ((uint32_t)0x00000F00) /*!< Remap USART8 Rx on DMA1 channel 3 */
#define DMA_RMPCR1_CH4_TIM7_UP \
  ((uint32_t)0x00001000) /*!< Remap TIM7 up on DMA1 channel 4 */
#define DMA_RMPCR1_CH4_DAC_CH2 \
  ((uint32_t)0x00001000) /*!< Remap DAC Channel 2 on DMA1 channel 4 */
#define DMA_RMPCR1_CH4_I2C2_TX \
  ((uint32_t)0x00002000) /*!< Remap I2C2 Tx on DMA1 channel 4 */
#define DMA_RMPCR1_CH4_SPI2_RX \
  ((uint32_t)0x00003000) /*!< Remap SPI2 Rx on DMA1 channel 4 */
#define DMA_RMPCR1_CH4_TIM2_CH4 \
  ((uint32_t)0x00005000) /*!< Remap TIM2 channel 4 on DMA1 channel 4 */
#define DMA_RMPCR1_CH4_TIM3_CH1 \
  ((uint32_t)0x00006000) /*!< Remap TIM3 channel 1 on DMA1 channel 4 */
#define DMA_RMPCR1_CH4_TIM3_TRIG \
  ((uint32_t)0x00006000) /*!< Remap TIM3 Trig on DMA1 channel 4 */
#define DMA_RMPCR1_CH4_TIM16_CH1 \
  ((uint32_t)0x00007000) /*!< Remap TIM16 channel 1 on DMA1 channel 4 */
#define DMA_RMPCR1_CH4_TIM16_UP \
  ((uint32_t)0x00007000) /*!< Remap TIM16 up on DMA1 channel 4 */
#define DMA_RMPCR1_CH4_USART1_TX \
  ((uint32_t)0x00008000) /*!< Remap USART1 Tx on DMA1 channel 4 */
#define DMA_RMPCR1_CH4_USART2_TX \
  ((uint32_t)0x00009000) /*!< Remap USART2 Tx on DMA1 channel 4 */
#define DMA_RMPCR1_CH4_USART3_TX \
  ((uint32_t)0x0000A000) /*!< Remap USART3 Tx on DMA1 channel 4 */
#define DMA_RMPCR1_CH4_USART4_TX \
  ((uint32_t)0x0000B000) /*!< Remap USART4 Tx on DMA1 channel 4 */
#define DMA_RMPCR1_CH4_USART5_TX \
  ((uint32_t)0x0000C000) /*!< Remap USART5 Tx on DMA1 channel 4 */
#define DMA_RMPCR1_CH4_USART6_TX \
  ((uint32_t)0x0000D000) /*!< Remap USART6 Tx on DMA1 channel 4 */
#define DMA_RMPCR1_CH4_USART7_TX \
  ((uint32_t)0x0000E000) /*!< Remap USART7 Tx on DMA1 channel 4 */
#define DMA_RMPCR1_CH4_USART8_TX \
  ((uint32_t)0x0000F000) /*!< Remap USART8 Tx on DMA1 channel 4 */
#define DMA_RMPCR1_CH5_I2C2_RX \
  ((uint32_t)0x00020000) /*!< Remap I2C2 Rx on DMA1 channel 5 */
#define DMA_RMPCR1_CH5_SPI2_TX \
  ((uint32_t)0x00030000) /*!< Remap SPI1 Tx on DMA1 channel 5 */
#define DMA_RMPCR1_CH5_TIM1_CH3 \
  ((uint32_t)0x00040000) /*!< Remap TIM1 channel 3 on DMA1 channel 5 */
#define DMA_RMPCR1_CH5_USART1_RX \
  ((uint32_t)0x00080000) /*!< Remap USART1 Rx on DMA1 channel 5 */
#define DMA_RMPCR1_CH5_USART2_RX \
  ((uint32_t)0x00090000) /*!< Remap USART2 Rx on DMA1 channel 5 */
#define DMA_RMPCR1_CH5_USART3_RX \
  ((uint32_t)0x000A0000) /*!< Remap USART3 Rx on DMA1 channel 5 */
#define DMA_RMPCR1_CH5_USART4_RX \
  ((uint32_t)0x000B0000) /*!< Remap USART4 Rx on DMA1 channel 5 */
#define DMA_RMPCR1_CH5_USART5_RX \
  ((uint32_t)0x000C0000) /*!< Remap USART5 Rx on DMA1 channel 5 */
#define DMA_RMPCR1_CH5_USART6_RX \
  ((uint32_t)0x000D0000) /*!< Remap USART6 Rx on DMA1 channel 5 */
#define DMA_RMPCR1_CH5_USART7_RX \
  ((uint32_t)0x000E0000) /*!< Remap USART7 Rx on DMA1 channel 5 */
#define DMA_RMPCR1_CH5_USART8_RX \
  ((uint32_t)0x000F0000) /*!< Remap USART8 Rx on DMA1 channel 5 */
#define DMA_RMPCR1_CH6_I2C1_TX \
  ((uint32_t)0x00200000) /*!< Remap I2C1 Tx on DMA1 channel 6 */
#define DMA_RMPCR1_CH6_SPI2_RX \
  ((uint32_t)0x00300000) /*!< Remap SPI2 Rx on DMA1 channel 6 */
#define DMA_RMPCR1_CH6_TIM1_CH1 \
  ((uint32_t)0x00400000) /*!< Remap TIM1 channel 1 on DMA1 channel 6 */
#define DMA_RMPCR1_CH6_TIM1_CH2 \
  ((uint32_t)0x00400000) /*!< Remap TIM1 channel 2 on DMA1 channel 6 */
#define DMA_RMPCR1_CH6_TIM1_CH3 \
  ((uint32_t)0x00400000) /*!< Remap TIM1 channel 3 on DMA1 channel 6 */
#define DMA_RMPCR1_CH6_TIM3_CH1 \
  ((uint32_t)0x00600000) /*!< Remap TIM3 channel 1 on DMA1 channel 6 */
#define DMA_RMPCR1_CH6_TIM3_TRIG \
  ((uint32_t)0x00600000) /*!< Remap TIM3 Trig on DMA1 channel 6 */
#define DMA_RMPCR1_CH6_TIM16_CH1 \
  ((uint32_t)0x00700000) /*!< Remap TIM16 channel 1 on DMA1 channel 6 */
#define DMA_RMPCR1_CH6_TIM16_UP \
  ((uint32_t)0x00700000) /*!< Remap TIM16 up on DMA1 channel 6 */
#define DMA_RMPCR1_CH6_USART1_RX \
  ((uint32_t)0x00800000) /*!< Remap USART1 Rx on DMA1 channel 6 */
#define DMA_RMPCR1_CH6_USART2_RX \
  ((uint32_t)0x00900000) /*!< Remap USART2 Rx on DMA1 channel 6 */
#define DMA_RMPCR1_CH6_USART3_RX \
  ((uint32_t)0x00A00000) /*!< Remap USART3 Rx on DMA1 channel 6 */
#define DMA_RMPCR1_CH6_USART4_RX \
  ((uint32_t)0x00B00000) /*!< Remap USART4 Rx on DMA1 channel 6 */
#define DMA_RMPCR1_CH6_USART5_RX \
  ((uint32_t)0x00C00000) /*!< Remap USART5 Rx on DMA1 channel 6 */
#define DMA_RMPCR1_CH6_USART6_RX \
  ((uint32_t)0x00D00000) /*!< Remap USART6 Rx on DMA1 channel 6 */
#define DMA_RMPCR1_CH6_USART7_RX \
  ((uint32_t)0x00E00000) /*!< Remap USART7 Rx on DMA1 channel 6 */
#define DMA_RMPCR1_CH6_USART8_RX \
  ((uint32_t)0x00F00000) /*!< Remap USART8 Rx on DMA1 channel 6 */
#define DMA_RMPCR1_CH7_I2C1_RX \
  ((uint32_t)0x02000000) /*!< Remap I2C1 Rx on DMA1 channel 7 */
#define DMA_RMPCR1_CH7_SPI2_TX \
  ((uint32_t)0x03000000) /*!< Remap SPI2 Tx on DMA1 channel 7 */
#define DMA_RMPCR1_CH7_TIM2_CH2 \
  ((uint32_t)0x05000000) /*!< Remap TIM2 channel 2 on DMA1 channel 7 */
#define DMA_RMPCR1_CH7_TIM2_CH4 \
  ((uint32_t)0x05000000) /*!< Remap TIM2 channel 4 on DMA1 channel 7 */
#define DMA_RMPCR1_CH7_TIM17_CH1 \
  ((uint32_t)0x07000000) /*!< Remap TIM17 channel 1 on DMA1 channel 7 */
#define DMA_RMPCR1_CH7_TIM17_UP \
  ((uint32_t)0x07000000) /*!< Remap TIM17 up on DMA1 channel 7 */
#define DMA_RMPCR1_CH7_USART1_TX \
  ((uint32_t)0x08000000) /*!< Remap USART1 Tx on DMA1 channel 7 */
#define DMA_RMPCR1_CH7_USART2_TX \
  ((uint32_t)0x09000000) /*!< Remap USART2 Tx on DMA1 channel 7 */
#define DMA_RMPCR1_CH7_USART3_TX \
  ((uint32_t)0x0A000000) /*!< Remap USART3 Tx on DMA1 channel 7 */
#define DMA_RMPCR1_CH7_USART4_TX \
  ((uint32_t)0x0B000000) /*!< Remap USART4 Tx on DMA1 channel 7 */
#define DMA_RMPCR1_CH7_USART5_TX \
  ((uint32_t)0x0C000000) /*!< Remap USART5 Tx on DMA1 channel 7 */
#define DMA_RMPCR1_CH7_USART6_TX \
  ((uint32_t)0x0D000000) /*!< Remap USART6 Tx on DMA1 channel 7 */
#define DMA_RMPCR1_CH7_USART7_TX \
  ((uint32_t)0x0E000000) /*!< Remap USART7 Tx on DMA1 channel 7 */
#define DMA_RMPCR1_CH7_USART8_TX \
  ((uint32_t)0x0F000000) /*!< Remap USART8 Tx on DMA1 channel 7 */

/******************  Bit definition for DMA_RMPCR2 register
 * ********************/
#define DMA_RMPCR2_DEFAULT \
  ((uint32_t)0x00000000) /*!< Default remap position for DMA2 */
#define DMA_RMPCR2_CH1_I2C2_TX \
  ((uint32_t)0x00000002) /*!< Remap I2C2 TX on DMA2 channel 1 */
#define DMA_RMPCR2_CH1_USART1_TX \
  ((uint32_t)0x00000008) /*!< Remap USART1 Tx on DMA2 channel 1 */
#define DMA_RMPCR2_CH1_USART2_TX \
  ((uint32_t)0x00000009) /*!< Remap USART2 Tx on DMA2 channel 1 */
#define DMA_RMPCR2_CH1_USART3_TX \
  ((uint32_t)0x0000000A) /*!< Remap USART3 Tx on DMA2 channel 1 */
#define DMA_RMPCR2_CH1_USART4_TX \
  ((uint32_t)0x0000000B) /*!< Remap USART4 Tx on DMA2 channel 1 */
#define DMA_RMPCR2_CH1_USART5_TX \
  ((uint32_t)0x0000000C) /*!< Remap USART5 Tx on DMA2 channel 1 */
#define DMA_RMPCR2_CH1_USART6_TX \
  ((uint32_t)0x0000000D) /*!< Remap USART6 Tx on DMA2 channel 1 */
#define DMA_RMPCR2_CH1_USART7_TX \
  ((uint32_t)0x0000000E) /*!< Remap USART7 Tx on DMA2 channel 1 */
#define DMA_RMPCR2_CH1_USART8_TX \
  ((uint32_t)0x0000000F) /*!< Remap USART8 Tx on DMA2 channel 1 */
#define DMA_RMPCR2_CH2_I2C2_RX \
  ((uint32_t)0x00000020) /*!< Remap I2C2 Rx on DMA2 channel 2 */
#define DMA_RMPCR2_CH2_USART1_RX \
  ((uint32_t)0x00000080) /*!< Remap USART1 Rx on DMA2 channel 2 */
#define DMA_RMPCR2_CH2_USART2_RX \
  ((uint32_t)0x00000090) /*!< Remap USART2 Rx on DMA2 channel 2 */
#define DMA_RMPCR2_CH2_USART3_RX \
  ((uint32_t)0x000000A0) /*!< Remap USART3 Rx on DMA2 channel 2 */
#define DMA_RMPCR2_CH2_USART4_RX \
  ((uint32_t)0x000000B0) /*!< Remap USART4 Rx on DMA2 channel 2 */
#define DMA_RMPCR2_CH2_USART5_RX \
  ((uint32_t)0x000000C0) /*!< Remap USART5 Rx on DMA2 channel 2 */
#define DMA_RMPCR2_CH2_USART6_RX \
  ((uint32_t)0x000000D0) /*!< Remap USART6 Rx on DMA2 channel 2 */
#define DMA_RMPCR2_CH2_USART7_RX \
  ((uint32_t)0x000000E0) /*!< Remap USART7 Rx on DMA2 channel 2 */
#define DMA_RMPCR2_CH2_USART8_RX \
  ((uint32_t)0x000000F0) /*!< Remap USART8 Rx on DMA2 channel 2 */
#define DMA_RMPCR2_CH3_TIM6_UP \
  ((uint32_t)0x00000100) /*!< Remap TIM6 up on DMA2 channel 3 */
#define DMA_RMPCR2_CH3_DAC_CH1 \
  ((uint32_t)0x00000100) /*!< Remap DAC channel 1 on DMA2 channel 3 */
#define DMA_RMPCR2_CH3_SPI1_RX \
  ((uint32_t)0x00000300) /*!< Remap SPI1 Rx on DMA2 channel 3 */
#define DMA_RMPCR2_CH3_USART1_RX \
  ((uint32_t)0x00000800) /*!< Remap USART1 Rx on DMA2 channel 3 */
#define DMA_RMPCR2_CH3_USART2_RX \
  ((uint32_t)0x00000900) /*!< Remap USART2 Rx on DMA2 channel 3 */
#define DMA_RMPCR2_CH3_USART3_RX \
  ((uint32_t)0x00000A00) /*!< Remap USART3 Rx on DMA2 channel 3 */
#define DMA_RMPCR2_CH3_USART4_RX \
  ((uint32_t)0x00000B00) /*!< Remap USART4 Rx on DMA2 channel 3 */
#define DMA_RMPCR2_CH3_USART5_RX \
  ((uint32_t)0x00000C00) /*!< Remap USART5 Rx on DMA2 channel 3 */
#define DMA_RMPCR2_CH3_USART6_RX \
  ((uint32_t)0x00000D00) /*!< Remap USART6 Rx on DMA2 channel 3 */
#define DMA_RMPCR2_CH3_USART7_RX \
  ((uint32_t)0x00000E00) /*!< Remap USART7 Rx on DMA2 channel 3 */
#define DMA_RMPCR2_CH3_USART8_RX \
  ((uint32_t)0x00000F00) /*!< Remap USART8 Rx on DMA2 channel 3 */
#define DMA_RMPCR2_CH4_TIM7_UP \
  ((uint32_t)0x00001000) /*!< Remap TIM7 up on DMA2 channel 4 */
#define DMA_RMPCR2_CH4_DAC_CH2 \
  ((uint32_t)0x00001000) /*!< Remap DAC channel 2 on DMA2 channel 4 */
#define DMA_RMPCR2_CH4_SPI1_TX \
  ((uint32_t)0x00003000) /*!< Remap SPI1 Tx on DMA2 channel 4 */
#define DMA_RMPCR2_CH4_USART1_TX \
  ((uint32_t)0x00008000) /*!< Remap USART1 Tx on DMA2 channel 4 */
#define DMA_RMPCR2_CH4_USART2_TX \
  ((uint32_t)0x00009000) /*!< Remap USART2 Tx on DMA2 channel 4 */
#define DMA_RMPCR2_CH4_USART3_TX \
  ((uint32_t)0x0000A000) /*!< Remap USART3 Tx on DMA2 channel 4 */
#define DMA_RMPCR2_CH4_USART4_TX \
  ((uint32_t)0x0000B000) /*!< Remap USART4 Tx on DMA2 channel 4 */
#define DMA_RMPCR2_CH4_USART5_TX \
  ((uint32_t)0x0000C000) /*!< Remap USART5 Tx on DMA2 channel 4 */
#define DMA_RMPCR2_CH4_USART6_TX \
  ((uint32_t)0x0000D000) /*!< Remap USART6 Tx on DMA2 channel 4 */
#define DMA_RMPCR2_CH4_USART7_TX \
  ((uint32_t)0x0000E000) /*!< Remap USART7 Tx on DMA2 channel 4 */
#define DMA_RMPCR2_CH4_USART8_TX \
  ((uint32_t)0x0000F000) /*!< Remap USART8 Tx on DMA2 channel 4 */
#define DMA_RMPCR2_CH5_ADC \
  ((uint32_t)0x00010000) /*!< Remap ADC on DMA2 channel 5 */
#define DMA_RMPCR2_CH5_USART1_TX \
  ((uint32_t)0x00080000) /*!< Remap USART1 Tx on DMA2 channel 5 */
#define DMA_RMPCR2_CH5_USART2_TX \
  ((uint32_t)0x00090000) /*!< Remap USART2 Tx on DMA2 channel 5 */
#define DMA_RMPCR2_CH5_USART3_TX \
  ((uint32_t)0x000A0000) /*!< Remap USART3 Tx on DMA2 channel 5 */
#define DMA_RMPCR2_CH5_USART4_TX \
  ((uint32_t)0x000B0000) /*!< Remap USART4 Tx on DMA2 channel 5 */
#define DMA_RMPCR2_CH5_USART5_TX \
  ((uint32_t)0x000C0000) /*!< Remap USART5 Tx on DMA2 channel 5 */
#define DMA_RMPCR2_CH5_USART6_TX \
  ((uint32_t)0x000D0000) /*!< Remap USART6 Tx on DMA2 channel 5 */
#define DMA_RMPCR2_CH5_USART7_TX \
  ((uint32_t)0x000E0000) /*!< Remap USART7 Tx on DMA2 channel 5 */
#define DMA_RMPCR2_CH5_USART8_TX \
  ((uint32_t)0x000F0000) /*!< Remap USART8 Tx on DMA2 channel 5 */
...
#define FLASH_OBR_RDPRT1 \
  ((uint32_t)0x00000002) /*!< Read protection Level bit 1 */
#define FLASH_OBR_RDPRT2 \
  ((uint32_t)0x00000004) /*!< Read protection Level bit 2 */
...
#define FLASH_OBR_RAM_PARITY_CHECK \
  ((uint32_t)0x00004000) /*!< RAM Parity Check */
#define FLASH_OBR_nBOOT0_SW                                               \
  ((uint32_t)0x00008000) /*!< nBOOT0 SW  (available only in the STM32F042 \
                            devices)*/
...
#define OB_WRP2_WRP2                                                           \
  ((uint32_t)0x000000FF) /*!< Flash memory write protection option bytes (only \
                            for STM32F072 devices) */
#define OB_WRP2_nWRP2                                                    \
  ((uint32_t)0x0000FF00) /*!< Flash memory write protection complemented \
                            option bytes (only for STM32F072 devices) */

/******************  Bit definition for OB_WRP3 register  *********************/
#define OB_WRP3_WRP3                                                           \
  ((uint32_t)0x00FF0000) /*!< Flash memory write protection option bytes (only \
                            for STM32F072 devices) */
...
#define PWR_CSR_VREFINTRDY \
  ((uint16_t)0x0008) /*!< Internal voltage reference (VREFINT) ready */
...
#define PWR_CSR_VREFINTRDYF \
  PWR_CSR_VREFINTRDY /*!< Internal voltage reference (VREFINT) ready flag */
/******************************************************************************/
/*                                                                            */
...
#define RCC_CFGR_SW_HSI48 \
  ((uint32_t)0x00000003) /*!< HSI48 selected as system clock */
...
#define RCC_CFGR_SWS_HSI48 \
  ((uint32_t)0x0000000C) /*!< HSI48 used as system clock */
...
#define RCC_CFGR_ADCPRE                                                 \
  ((uint32_t)0x00004000) /*!< ADC prescaler: Obsolete. Proper ADC clock \
                            selection is done inside the ADC_CFGR2 */

#define RCC_CFGR_PLLSRC ((uint32_t)0x00018000) /*!< PLL entry clock source */
#define RCC_CFGR_PLLSRC_0                                                     \
  ((uint32_t)0x00008000) /*!< Bit 0 (available only in the STM32F072 devices) \
                          */
...
#define RCC_CFGR_PLLSRC_PREDIV1                                           \
  ((                                                                      \
      uint32_t)0x00010000) /*!< PREDIV1 clock selected as PLL entry clock \
                              source; Old PREDIV1 bit definition, maintained                                   \
                              for legacy purpose */
...
#define RCC_CFGR_PLLSRC_HSI_PREDIV                                         \
  ((uint32_t)0x00008000) /*!< HSI PREDIV clock selected as PLL entry clock \
                            source (This bit and configuration is only                                       \
                            available for STM32F072 devices)*/
#define RCC_CFGR_PLLSRC_HSE_PREDIV                                         \
  ((uint32_t)0x00010000) /*!< HSE PREDIV clock selected as PLL entry clock \
                            source */
#define RCC_CFGR_PLLSRC_HSI48_PREDIV                                         \
  ((uint32_t)0x00018000) /*!< HSI48 PREDIV clock selected as PLL entry clock \
                            source */
...
#define RCC_CFGR_PLLMULL \
  RCC_CFGR_PLLMUL /*!< PLLMUL[3:0] bits (PLL multiplication factor) */
...
#define RCC_CFGR_MCO \
  ((uint32_t)0x0F000000) /*!< MCO[2:0] bits (Microcontroller Clock Output) */
...
#define RCC_CFGR_MCO_PLL \
  ((uint32_t)0x07000000) /*!< PLL clock selected as MCO source */
#define RCC_CFGR_MCO_HSI48 \
  ((uint32_t)0x08000000) /*!< HSI48 clock selected as MCO source */

#define RCC_CFGR_MCO_PRE                                                     \
  ((uint32_t)0x70000000) /*!< MCO prescaler (these bits are not available in \
                            the STM32F051 devices)*/
#define RCC_CFGR_MCO_PRE_1                                                    \
  ((uint32_t)0x00000000) /*!< MCO is divided by 1 (this bit are not available \
                            in the STM32F051 devices)*/
#define RCC_CFGR_MCO_PRE_2                                                    \
  ((uint32_t)0x10000000) /*!< MCO is divided by 2 (this bit are not available \
                            in the STM32F051 devices)*/
#define RCC_CFGR_MCO_PRE_4                                                    \
  ((uint32_t)0x20000000) /*!< MCO is divided by 4 (this bit are not available \
                            in the STM32F051 devices)*/
#define RCC_CFGR_MCO_PRE_8                                                    \
  ((uint32_t)0x30000000) /*!< MCO is divided by 8 (this bit are not available \
                            in the STM32F051 devices)*/
#define RCC_CFGR_MCO_PRE_16                                                    \
  ((uint32_t)0x40000000) /*!< MCO is divided by 16 (this bit are not available \
                            in the STM32F051 devices)*/
#define RCC_CFGR_MCO_PRE_32                                                    \
  ((uint32_t)0x50000000) /*!< MCO is divided by 32 (this bit are not available \
                            in the STM32F051 devices)*/
#define RCC_CFGR_MCO_PRE_64                                                    \
  ((uint32_t)0x60000000) /*!< MCO is divided by 64 (this bit are not available \
                            in the STM32F051 devices)*/
#define RCC_CFGR_MCO_PRE_128                                          \
  ((uint32_t)0x70000000) /*!< MCO is divided by 128 (this bit are not \
                            available in the STM32F051 devices)*/

#define RCC_CFGR_PLLNODIV                                                 \
  ((uint32_t)0x80000000) /*!< PLL is not divided to MCO (this bit are not \
                            available in the STM32F051 devices) */
...
#define RCC_CIR_HSI48RDYF \
  ((uint32_t)0x00000040) /*!< HSI48 Ready Interrupt flag */
#define RCC_CIR_CSSF \
...
#define RCC_CIR_HSI48RDYIE \
  ((uint32_t)0x00004000) /*!< HSI48 Ready Interrupt Enable */
...
#define RCC_CIR_HSI48RDYC \
  ((uint32_t)0x00400000) /*!< HSI48 Ready Interrupt Clear */
#define RCC_CIR_CSSC \
...
#define RCC_APB1RSTR_USART3RST \
  ((uint32_t)0x00040000) /*!< USART 3 clock reset */
#define RCC_APB1RSTR_USART4RST \
  ((uint32_t)0x00080000) /*!< USART 4 clock reset */
#define RCC_APB1RSTR_USART5RST \
  ((uint32_t)0x00100000)                            /*!< USART 5 clock reset */
...
#define RCC_AHBENR_TSCEN \
  ((uint32_t)0x01000000) /*!< TS controller clock enable */
...
#define RCC_APB2ENR_SYSCFGCOMPEN \
  ((uint32_t)0x00000001) /*!< SYSCFG and comparator clock enable */
...
#define RCC_CR2_HSI48ON \
  ((uint32_t)0x00010000) /*!< Internal High Speed 48MHz clock enable */
#define RCC_CR2_HSI48RDY \
  ((uint32_t)0x00020000) /*!< Internal High Speed 48MHz clock ready flag */
#define RCC_CR2_HSI48CAL \
  ((uint32_t)0xFF000000) /*!< Internal High Speed 48MHz clock Calibration */
...
#define SYSCFG_CFGR1_IRDA_ENV_SEL \
  ((uint32_t)0x000000C0) /*!< IRDA_SEL_ENV config */
#define SYSCFG_CFGR1_IRDA_ENV_SEL_0 \
  ((uint32_t)0x00000040) /*!< IRDA_SEL_ENV Bit 0 */
#define SYSCFG_CFGR1_IRDA_ENV_SEL_1 \
  ((uint32_t)0x00000080) /*!< IRDA_SEL_ENV Bit 1 */
#define SYSCFG_CFGR1_PA11_PA12_RMP                                     \
  ((uint32_t)0x00000010) /*!< PA11 and PA12 remap on QFN28 and TSSOP20 \
                            packages (only for STM32F042 devices)*/
...
#define SYSCFG_CFGR1_TIM16_DMA_RMP2 \
  ((uint32_t)0x00002000) /*!< Timer 16 DMA remap 2 (only for STM32F072) */
#define SYSCFG_CFGR1_TIM17_DMA_RMP2 \
  ((uint32_t)0x00004000) /*!< Timer 17 DMA remap 2 (only for STM32F072) */
...
#define SYSCFG_CFGR1_I2C_FMP_I2C1                                           \
  ((uint32_t)0x00100000) /*!< Enable Fast Mode Plus on PB10, PB11, PF6 and  \
                            PF7(only for STM32F030, STM32F031 and STM32F072 \
                            devices) */
#define SYSCFG_CFGR1_I2C_FMP_I2C2                                             \
  ((uint32_t)0x00200000) /*!< Enable I2C2 Fast mode plus (only for STM32F072) \
                          */
#define SYSCFG_CFGR1_I2C_FMP_PA9                                           \
  ((uint32_t)0x00400000) /*!< Enable Fast Mode Plus on PA9 (only for       \
                            STM32F030, STM32F031, STM32F042, STM32F072 and \
                            STM32F091 devices) */
#define SYSCFG_CFGR1_I2C_FMP_PA10                                          \
  ((uint32_t)0x00800000) /*!< Enable Fast Mode Plus on PA10(only for       \
                            STM32F030, STM32F031, STM32F042, STM32F072 and \
                            STM32F091 devices) */
#define SYSCFG_CFGR1_SPI2_DMA_RMP \
  ((uint32_t)0x01000000) /*!< SPI2 DMA remap (only for STM32F072) */
#define SYSCFG_CFGR1_USART2_DMA_RMP \
  ((uint32_t)0x02000000) /*!< USART2 DMA remap (only for STM32F072) */
#define SYSCFG_CFGR1_USART3_DMA_RMP \
  ((uint32_t)0x04000000) /*!< USART3 DMA remap (only for STM32F072) */
#define SYSCFG_CFGR1_I2C1_DMA_RMP \
  ((uint32_t)0x08000000) /*!< I2C1 DMA remap (only for STM32F072) */
#define SYSCFG_CFGR1_TIM1_DMA_RMP \
  ((uint32_t)0x10000000) /*!< TIM1 DMA remap (only for STM32F072) */
#define SYSCFG_CFGR1_TIM2_DMA_RMP \
  ((uint32_t)0x20000000) /*!< TIM2 DMA remap (only for STM32F072) */
#define SYSCFG_CFGR1_TIM3_DMA_RMP \
  ((uint32_t)0x40000000) /*!< TIM3 DMA remap (only for STM32F072) */
...
#define SYSCFG_ITLINE1_SR_PVDOUT \
  ((uint32_t)0x00000001) /*!< Power voltage detection -> exti[31] Interrupt */
#define SYSCFG_ITLINE1_SR_VDDIO2 \
  ((uint32_t)0x00000002) /*!< VDDIO2 -> exti[16] Interrupt */
#define SYSCFG_ITLINE2_SR_RTC_WAKEUP \
  ((uint32_t)0x00000001) /*!< RTC WAKEUP -> exti[20] Interrupt */
#define SYSCFG_ITLINE2_SR_RTC_TSTAMP \
  ((uint32_t)0x00000002) /*!< RTC Time Stamp -> exti[19] interrupt */
#define SYSCFG_ITLINE2_SR_RTC_ALRA \
  ((uint32_t)0x00000003) /*!< RTC Alarm -> exti[17] interrupt .... */
#define SYSCFG_ITLINE3_SR_FLASH_ITF \
  ((uint32_t)0x00000001)                             /*!< Flash ITF Interrupt */
#define SYSCFG_ITLINE4_SR_CRS ((uint32_t)0x00000001) /*!< CRS interrupt */
#define SYSCFG_ITLINE4_SR_CLK_CTRL \
  ((uint32_t)0x00000002) /*!< CLK CTRL interrupt */
#define SYSCFG_ITLINE5_SR_EXTI0 \
  ((uint32_t)0x00000001) /*!< External Interrupt 0 */
#define SYSCFG_ITLINE5_SR_EXTI1 \
  ((uint32_t)0x00000002) /*!< External Interrupt 1 */
#define SYSCFG_ITLINE6_SR_EXTI2 \
  ((uint32_t)0x00000001) /*!< External Interrupt 2 */
#define SYSCFG_ITLINE6_SR_EXTI3 \
  ((uint32_t)0x00000002) /*!< External Interrupt 3 */
#define SYSCFG_ITLINE7_SR_EXTI4 \
  ((uint32_t)0x00000001) /*!< External Interrupt 15 to 4 */
#define SYSCFG_ITLINE7_SR_EXTI5 \
  ((uint32_t)0x00000002) /*!< External Interrupt 15 to 4 */
#define SYSCFG_ITLINE7_SR_EXTI6 \
  ((uint32_t)0x00000004) /*!< External Interrupt 15 to 4 */
#define SYSCFG_ITLINE7_SR_EXTI7 \
  ((uint32_t)0x00000008) /*!< External Interrupt 15 to 4 */
#define SYSCFG_ITLINE7_SR_EXTI8 \
  ((uint32_t)0x00000010) /*!< External Interrupt 15 to 4 */
#define SYSCFG_ITLINE7_SR_EXTI9 \
  ((uint32_t)0x00000020) /*!< External Interrupt 15 to 4 */
#define SYSCFG_ITLINE7_SR_EXTI10 \
  ((uint32_t)0x00000040) /*!< External Interrupt 15 to 4 */
#define SYSCFG_ITLINE7_SR_EXTI11 \
  ((uint32_t)0x00000080) /*!< External Interrupt 15 to 4 */
#define SYSCFG_ITLINE7_SR_EXTI12 \
  ((uint32_t)0x00000100) /*!< External Interrupt 15 to 4 */
#define SYSCFG_ITLINE7_SR_EXTI13 \
  ((uint32_t)0x00000200) /*!< External Interrupt 15 to 4 */
#define SYSCFG_ITLINE7_SR_EXTI14 \
  ((uint32_t)0x00000400) /*!< External Interrupt 15 to 4 */
#define SYSCFG_ITLINE7_SR_EXTI15 \
  ((uint32_t)0x00000800) /*!< External Interrupt 15 to 4 */
#define SYSCFG_ITLINE8_SR_TSC_EOA \
  ((uint32_t)0x00000001) /*!< Touch control EOA Interrupt */
#define SYSCFG_ITLINE8_SR_TSC_MCE \
  ((uint32_t)0x00000002) /*!< Touch control MCE Interrupt */
#define SYSCFG_ITLINE9_SR_DMA1_CH1 \
  ((uint32_t)0x00000001) /*!< DMA1 Channel 1 Interrupt */
#define SYSCFG_ITLINE10_SR_DMA1_CH2 \
  ((uint32_t)0x00000001) /*!< DMA1 Channel 2 Interrupt */
#define SYSCFG_ITLINE10_SR_DMA1_CH3 \
  ((uint32_t)0x00000002) /*!< DMA2 Channel 3 Interrupt */
#define SYSCFG_ITLINE10_SR_DMA2_CH1 \
  ((uint32_t)0x00000004) /*!< DMA2 Channel 1 Interrupt */
#define SYSCFG_ITLINE10_SR_DMA2_CH2 \
  ((uint32_t)0x00000008) /*!< DMA2 Channel 2 Interrupt */
#define SYSCFG_ITLINE11_SR_DMA1_CH4 \
  ((uint32_t)0x00000001) /*!< DMA1 Channel 4 Interrupt */
#define SYSCFG_ITLINE11_SR_DMA1_CH5 \
  ((uint32_t)0x00000002) /*!< DMA1 Channel 5 Interrupt */
#define SYSCFG_ITLINE11_SR_DMA1_CH6 \
  ((uint32_t)0x00000004) /*!< DMA1 Channel 6 Interrupt */
#define SYSCFG_ITLINE11_SR_DMA1_CH7 \
  ((uint32_t)0x00000008) /*!< DMA1 Channel 7 Interrupt */
#define SYSCFG_ITLINE11_SR_DMA2_CH3 \
  ((uint32_t)0x00000010) /*!< DMA2 Channel 3 Interrupt */
#define SYSCFG_ITLINE11_SR_DMA2_CH4 \
  ((uint32_t)0x00000020) /*!< DMA2 Channel 4 Interrupt */
#define SYSCFG_ITLINE11_SR_DMA2_CH5 \
  ((uint32_t)0x00000040) /*!< DMA2 Channel 5 Interrupt */
...
#define SYSCFG_ITLINE12_SR_COMP2 \
  ((uint32_t)0x00000004) /*!< COMP2 Interrupt -> exti[22] */
#define SYSCFG_ITLINE13_SR_TIM1_BRK \
  ((uint32_t)0x00000001) /*!< TIM1 BRK Interrupt */
#define SYSCFG_ITLINE13_SR_TIM1_UPD \
  ((uint32_t)0x00000002) /*!< TIM1 UPD Interrupt */
#define SYSCFG_ITLINE13_SR_TIM1_TRG \
  ((uint32_t)0x00000004) /*!< TIM1 TRG Interrupt */
#define SYSCFG_ITLINE13_SR_TIM1_CCU \
  ((uint32_t)0x00000008) /*!< TIM1 CCU Interrupt */
#define SYSCFG_ITLINE14_SR_TIM1_CC \
  ((uint32_t)0x00000001) /*!< TIM1 CC Interrupt */
#define SYSCFG_ITLINE15_SR_TIM2_GLB \
  ((uint32_t)0x00000001) /*!< TIM2 GLB Interrupt */
#define SYSCFG_ITLINE16_SR_TIM3_GLB \
  ((uint32_t)0x00000001)                              /*!< TIM3 GLB Interrupt */
#define SYSCFG_ITLINE17_SR_DAC ((uint32_t)0x00000001) /*!< DAC Interrupt */
#define SYSCFG_ITLINE17_SR_TIM6_GLB \
  ((uint32_t)0x00000002) /*!< TIM6 GLB Interrupt */
#define SYSCFG_ITLINE18_SR_TIM7_GLB \
  ((uint32_t)0x00000001) /*!< TIM7 GLB Interrupt */
#define SYSCFG_ITLINE19_SR_TIM14_GLB \
  ((uint32_t)0x00000001) /*!< TIM14 GLB Interrupt */
#define SYSCFG_ITLINE20_SR_TIM15_GLB \
  ((uint32_t)0x00000001) /*!< TIM15 GLB Interrupt */
#define SYSCFG_ITLINE21_SR_TIM16_GLB \
  ((uint32_t)0x00000001) /*!< TIM16 GLB Interrupt */
#define SYSCFG_ITLINE22_SR_TIM17_GLB \
  ((uint32_t)0x00000001) /*!< TIM17 GLB Interrupt */
#define SYSCFG_ITLINE23_SR_I2C1_GLB \
  ((uint32_t)0x00000001) /*!< I2C1 GLB Interrupt -> exti[23] */
#define SYSCFG_ITLINE24_SR_I2C2_GLB \
  ((uint32_t)0x00000001) /*!< I2C2 GLB Interrupt */
...
#define SYSCFG_ITLINE27_SR_USART1_GLB \
  ((uint32_t)0x00000001) /*!< USART1 GLB Interrupt -> exti[25] */
#define SYSCFG_ITLINE28_SR_USART2_GLB \
  ((uint32_t)0x00000001) /*!< USART2 GLB Interrupt -> exti[26] */
#define SYSCFG_ITLINE29_SR_USART3_GLB \
  ((uint32_t)0x00000001) /*!< USART3 GLB Interrupt -> exti[28] */
#define SYSCFG_ITLINE29_SR_USART4_GLB \
  ((uint32_t)0x00000002) /*!< USART4 GLB Interrupt */
#define SYSCFG_ITLINE29_SR_USART5_GLB \
  ((uint32_t)0x00000004) /*!< USART5 GLB Interrupt */
#define SYSCFG_ITLINE29_SR_USART6_GLB \
  ((uint32_t)0x00000008) /*!< USART6 GLB Interrupt */
#define SYSCFG_ITLINE29_SR_USART7_GLB \
  ((uint32_t)0x00000010) /*!< USART7 GLB Interrupt */
#define SYSCFG_ITLINE29_SR_USART8_GLB \
  ((uint32_t)0x00000020) /*!< USART8 GLB Interrupt */
