...
static const uint16_t MAIN_EXEC_OVERFLOW = AUDIO_SAMPLES_PER_FRAME *
                                           AUDIO_DECIMATION * 2 *
                                           AUDIO_PRESCALE / MAIN_EXEC_PRESCALE;

namespace Timer {
extern uint32_t clock;
void init();

static inline uint32_t getTime(void) { return SysTick->VAL << 8; }
}  // namespace Timer
