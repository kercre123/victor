...
ifeq ($(MV_SOC_OS), none)
  DirSparcDefaultLibs  ?= $(MV_TOOLS_BASE)/$(DETECTED_PLATFORM)/$(SPARC_DIR)/lib/gcc/sparc-elf/$(GCCVERSION_NO_ENDIAN_SUFFIX)$(if $(subst LEND,,$(LEON_ENDIAN)),,/le)
endif
...
ifeq ($(wildcard $(DirAppScripts)/debug_run.scr),) 
   SourceDebugScript   ?= $(DirDbgScrCommon)/default_debug_run.scr
else
   SourceDebugScript   ?= $(DirAppScripts)/debug_run.scr
endif
