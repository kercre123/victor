...
Anki::Util::GraphEvaluator2d kTestDefaultRepetitionPenaltyGraph(
    {{0.0f, 0.0}, {10.0f, 1.0f}});  // no-repetition penalty

Anki::Util::GraphEvaluator2d kTestGraphTimeRatio({{0.0f, 1.0f},
                                                  {0.5f, 1.0f},
                                                  {1.0f, 0.9f},
                                                  {1.5f, 0.8f},
                                                  {2.0f, 0.5f},
...
Anki::Util::GraphEvaluator2d kTestGraphValueSlope({{-1.0f, 60.0f},
                                                   {-0.8f, 6.0f},
                                                   {-0.2f, 6.0f},
                                                   {0.0f, 0.6f},
                                                   {0.93999f, 0.6f},
...
void TickMoodManager(MoodManager& moodManager, uint32_t numTicks,
                     float tickTimeStep) {
  DependencyManagedEntity<RobotComponentID> dependencies;
  for (uint32_t i = 0; i < numTicks; ++i) {
    gCurrentTime += tickTimeStep;
    BaseStationTimer::getInstance()->UpdateTime(
        Util::SecToNanoSec(gCurrentTime));
...
void InitStaticMoodData(const MoodDecayEvaulator::DecayGraphType graphType) {
  ...
  switch (graphType) {
    case DGT::TimeRatio:
      staticMoodData.SetDecayEvaluator(kTestEmoType0, kTestGraphTimeRatio,
                                       DGT::TimeRatio);
      break;
    case DGT::ValueSlope:
      staticMoodData.SetDecayEvaluator(kTestEmoType0, kTestGraphValueSlope,
                                       DGT::ValueSlope);
      break;
  }

  staticMoodData.SetDefaultRepetitionPenalty(
      kTestDefaultRepetitionPenaltyGraph);
}
...
TEST(MoodManager, AddEmotionNoPenalty) {
  ...
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 1), 0.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType1, 1), 0.0f,
              0.0f);
  ...
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 1), 0.5f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType1, 1), 0.1f,
              0.0f);
  moodManager.AddToEmotion(kTestEmoType0, 0.5f, "Test2", gCurrentTime);
  EXPECT_EQ(moodManager.GetEmotionValue(kTestEmoType0), 1.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 1), 1.0f,
              0.0f);
...
TEST(MoodManager, AddEmotionRepeatPenalty) {
  ...
  // Repeat at t=0
  moodManager.AddToEmotion(
      kTestEmoType0, 0.5f, "Test1",
      gCurrentTime);  // 0 second since last Test1 -> only +0
  EXPECT_EQ(moodManager.GetEmotionValue(kTestEmoType0), 0.5f);
  ...
  moodManager.AddToEmotion(
      kTestEmoType0, 0.5f, "Test1",
      gCurrentTime);  // 5 second since last Test1 -> only +0.25
  EXPECT_EQ(moodManager.GetEmotionValue(kTestEmoType0), 0.75f);

  // Repeat at t=15
  gCurrentTime += 10.0f;
  moodManager.AddToEmotion(
      kTestEmoType0, 0.24f, "Test1",
      gCurrentTime);  // 10 second since last Test1 -> full 0.24
...
TEST(MoodManager, AddEmotionNoPenaltyEachTick) {
  ...
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 1), 0.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 99), 0.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType1, 1), 0.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType1, 99), 0.0f,
              0.0f);
  ...
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 1), 0.5f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 99), 0.5f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType1, 1), 0.1f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType1, 99), 0.1f,
              0.0f);
  TickMoodManager(moodManager, 1, kTickTimestep);
  EXPECT_EQ(moodManager.GetEmotionValue(kTestEmoType0), 0.5f);
  EXPECT_EQ(moodManager.GetEmotionValue(kTestEmoType1), 0.1f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 0), 0.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 1), 0.5f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 98), 0.5f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType1, 0), 0.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType1, 1), 0.1f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType1, 98), 0.1f,
              0.0f);
  ...
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 1), 1.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 98), 1.0f,
              0.0f);
  TickMoodManager(moodManager, 1, kTickTimestep);
  EXPECT_EQ(moodManager.GetEmotionValue(kTestEmoType0), 1.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 1), 0.5f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 2), 1.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 99), 1.0f,
              0.0f);
  ...
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 1), 0.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 2), 0.5f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 3), 1.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 99), 1.0f,
              0.0f);
  ...
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 0), 0.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 1), -1.5f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 2), -1.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 3), -0.5f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 98), -0.5f,
              0.0f);
  TickMoodManager(moodManager, 1, kTickTimestep);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 1), -1.5f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 2), -1.5f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 3), -1.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 4), -0.5f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 99), -0.5f,
              0.0f);
  ...
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 0), 0.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 1), -2.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 2), -2.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 3), -1.5f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 4), -1.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 98), -1.0f,
              0.0f);
  TickMoodManager(moodManager, 1, kTickTimestep);
  ...
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 2), -2.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 3), -2.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 4), -1.5f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 5), -1.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 98), -1.0f,
              0.0f);
}
...
TEST(MoodManager, DecayFromPositive) {
  ...
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 10), 1.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 9), 0.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 1), 0.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 0), 0.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentSeconds(kTestEmoType0, 0.2f),
              1.0f, 0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentSeconds(kTestEmoType0, 0.091f),
              1.0f, 0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentSeconds(kTestEmoType0, 0.09f),
              0.0f, 0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentSeconds(kTestEmoType0, 0.0f),
              0.0f, 0.0f);

  TickMoodManager(moodManager, 30, kTickTimestep);  // now = 0.4f
  EXPECT_NEAR(moodManager.GetEmotionValue(kTestEmoType0), 1.0f, 0.000001f);

  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 41), 1.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 40), 1.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 39), 0.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentSeconds(kTestEmoType0, 0.391f),
              1.0f, 0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentSeconds(kTestEmoType0, 0.39f),
              0.0f, 0.0f);

  TickMoodManager(moodManager, 10, kTickTimestep);  // now = 0.5f
  EXPECT_NEAR(moodManager.GetEmotionValue(kTestEmoType0), 1.0f, 0.000001f);

  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 50), 1.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 49), 0.0f,
              0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentSeconds(kTestEmoType0, 0.491f),
              1.0f, 0.0f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentSeconds(kTestEmoType0, 0.49f),
              0.0f, 0.0f);
  ...
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 80), 0.94f,
              0.0001f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 79), -0.06f,
              0.0001f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 30), -0.06f,
              0.0001f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 15), -0.03f,
              0.0001f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentTicks(kTestEmoType0, 0), 0.00f,
              0.0001f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentSeconds(kTestEmoType0, 0.791f),
              0.94f, 0.0001f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentSeconds(kTestEmoType0, 0.79f),
              -0.06f, 0.0001f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentSeconds(kTestEmoType0, 0.3f),
              -0.06f, 0.0001f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentSeconds(kTestEmoType0, 0.15f),
              -0.03f, 0.0001f);
  EXPECT_NEAR(moodManager.GetEmotionDeltaRecentSeconds(kTestEmoType0, 0.0f),
              0.0f, 0.0001f);
...
TEST(MoodManager, DecayResetFromAwards) {
  ...
  // Note: due to the decrease this is equivalent to a 0.25 initial value
  // dropped to 0.125 after 2 seconds
...
TEST(MoodManager, EmotionScorerRoundTripJson) {
  EmotionScorer testScorer(
      kTestEmoType0,
      Anki::Util::GraphEvaluator2d({{-1.0f, 0.0f}, {0.5f, 1.0f}, {1.0f, 0.6f}}),
      true);
...
TEST(MoodManager, EmotionScorerReadJson) {
  ...
  Json::Reader reader;
  const bool parsedOK =
      reader.parse(kTestEmotionScorerJson, emotionScorerJson, false);
...
TEST(MoodManager, EmotionScorerReadBadJson3) {
  ...
  Json::Reader reader;
  const bool parsedOK =
      reader.parse(kBad3TestEmotionScorerJson, emotionScorerJson, false);
  ASSERT_TRUE(parsedOK);

  EmotionScorer testScorer(kTestEmoType2, Anki::Util::GraphEvaluator2d(),
                           false);
...
TEST(MoodManager, EmotionScorerReadBadJson4) {
  ...
  Json::Reader reader;
  const bool parsedOK =
      reader.parse(kBad4TestEmotionScorerJson, emotionScorerJson, false);
  ASSERT_TRUE(parsedOK);
...
TEST(MoodManager, EmotionAffectorReadJson) {
  ...
  Json::Reader reader;
  const bool parsedOK =
      reader.parse(kTestEmotionAffectorJson, emotionAffectorJson, false);
  ASSERT_TRUE(parsedOK);
...
TEST(MoodManager, EmotionEventReadJson) {
  ...
  Json::Reader reader;
  const bool parsedOK =
      reader.parse(kTestEmotionEventJson, emotionEventJson, false);
  ASSERT_TRUE(parsedOK);
...
TEST(MoodManager, EmotionEventMapperReadJson) {
  ...
  Json::Reader reader;
  const bool parsedOK =
      reader.parse(kTestEmotionEventMapperJson, emotionEventMapperJson, false);
  ASSERT_TRUE(parsedOK);
  ...
  // Load an additional loose event
  {
    ...
    const bool readLooseRes =
        testEventMapper.LoadEmotionEvents(emotionEventJson);
  ...
  // Load an additional set of loose events
  {
    ...
    Json::Reader reader;
    const bool parsedOK =
        reader.parse(kTestEmotionEventMapperJson2, emotionEventsJson, false);
    ASSERT_TRUE(parsedOK);

    const bool readLooseRes =
        testEventMapper.LoadEmotionEvents(emotionEventsJson);
    EXPECT_TRUE(readLooseRes);
  }
...
TEST(MoodManager, StaticMoodDataRoundTripJson) {
  ...
  testStaticData.SetDecayEvaluator(kTestEmoType0, kTestGraphTimeRatio,
                                   DGT::TimeRatio);
  testStaticData.SetDecayEvaluator(kTestEmoType1, kTestNoDecayGraph,
                                   DGT::TimeRatio);
  // leave 2 at default
  testStaticData.SetDecayEvaluator(kTestEmoType3, kTestLinearGraph,
                                   DGT::ValueSlope);
  testStaticData.SetDefaultRepetitionPenalty(
      kTestDefaultRepetitionPenaltyGraph);
  ...
  auto moodTestHelper = [](const StaticMoodData& smd) {
    ...
    float wasteAccel = 0.0f;
    {
      ...
      EXPECT_FLOAT_EQ(
          eval.EvaluateDecay(1.0f, 0.0f, 0.1f, wasteRate, wasteAccel), 1.0f);
      EXPECT_FLOAT_EQ(
          eval.EvaluateDecay(1.0f, 0.4f, 0.1f, wasteRate, wasteAccel), 1.0f);
      EXPECT_FLOAT_EQ(
          eval.EvaluateDecay(0.9f, 1.0f, 0.5f, wasteRate, wasteAccel), 0.8f);
    }

    {
      ...
      EXPECT_FLOAT_EQ(
          eval.EvaluateDecay(1.0f, 0.4f, 0.1f, wasteRate, wasteAccel), 1.0f);
      EXPECT_FLOAT_EQ(
          eval.EvaluateDecay(1.0f, 100.0f, 0.5f, wasteRate, wasteAccel), 1.0f);
    }

    {
      ...
      EXPECT_FLOAT_EQ(
          eval.EvaluateDecay(1.0f, 0.0f, 0.1f, wasteRate, wasteAccel), 1.0f);
      EXPECT_FLOAT_EQ(
          eval.EvaluateDecay(1.0f, 10.0f, 0.1f, wasteRate, wasteAccel), 1.0f);
      EXPECT_FLOAT_EQ(
          eval.EvaluateDecay(1.0f, 15.0f, 45.0f, wasteRate, wasteAccel), 0.9f);
      EXPECT_FLOAT_EQ(
          eval.EvaluateDecay(0.9f, 60.0f, 90.0f, wasteRate, wasteAccel), 0.6f);
      EXPECT_FLOAT_EQ(
          eval.EvaluateDecay(0.6f, 150.0f, 150.0f, wasteRate, wasteAccel),
          0.0f);
    }

    {
      ...
      ASSERT_FALSE(eval.Empty());
      EXPECT_FLOAT_EQ(
          eval.EvaluateDecay(1.0f, 0.0f, 15.0f, wasteRate, wasteAccel), 0.75);
      EXPECT_FLOAT_EQ(
          eval.EvaluateDecay(1.0f, 1000.0f, 15.0f, wasteRate, wasteAccel),
          0.75);
    }
  };
  ...
  {
    const EmotionEvent* foundEvent1 =
        testStaticData2.GetEmotionEventMapper().FindEvent("TestEvent1");
    ASSERT_NE(foundEvent1, nullptr);
    ...
    const EmotionEvent* foundEvent2 =
        testStaticData2.GetEmotionEventMapper().FindEvent("TestEvent2");
    ASSERT_NE(foundEvent2, nullptr);
...
TEST(MoodManager, StaticMoodDataReadJson) {
  ...
  Json::Reader reader;
  const bool parsedOK =
      reader.parse(kTestStaticMoodDataJson, staticMoodDataJson, false);
  ASSERT_TRUE(parsedOK);
  ...
  // only check Social and Stimulated rate and accel values (to hit distinct
  // decay evaluators), and the rest are dummy params
  float wasteRate = 0.0f;
  float wasteAccel = 0.0f;

  auto compare = [](const MoodDecayEvaulator& eval, float currentVal,
                    float timeSinceEvent, float deltaTime_s,
                    float expectedValue, float expectedRate,
                    float expectedAccel) {
    float rate;
    float accel;
    EXPECT_FLOAT_EQ(eval.EvaluateDecay(currentVal, timeSinceEvent, deltaTime_s,
                                       rate, accel),
                    expectedValue);
  ...
  {
    const auto& eval =
        testStaticMoodData.GetDecayEvaluator(EmotionType::Social);
    ASSERT_FALSE(eval.Empty());
...

  {
    ...
    ASSERT_FALSE(eval.Empty());
    EXPECT_FLOAT_EQ(eval.EvaluateDecay(1.0f, 0.0f, 0.1f, wasteRate, wasteAccel),
                    1.0f);
    EXPECT_FLOAT_EQ(eval.EvaluateDecay(1.0f, 9.0f, 0.1f, wasteRate, wasteAccel),
                    1.0f);
    EXPECT_NEAR(eval.EvaluateDecay(0.9f, 30.0f, 10.0f, wasteRate, wasteAccel),
                0.8f, kNearTolerance);
    EXPECT_FLOAT_EQ(
        eval.EvaluateDecay(1.0f, 140.0f, 0.1f, wasteRate, wasteAccel), 0.0f);
    EXPECT_FLOAT_EQ(
        eval.EvaluateDecay(0.0f, 30.0f, 0.1f, wasteRate, wasteAccel), 0.0f);
  }

  {
    const auto& eval =
        testStaticMoodData.GetDecayEvaluator(EmotionType::Stimulated);
    ASSERT_FALSE(eval.Empty());
...
TEST(MoodManager, SimpleMood) {
  ...
  for (const auto& tpl : expectations) {
    ...
    EXPECT_EQ(moodManager.GetSimpleMood(), std::get<2>(tpl))
        << "before tick: stim=" << std::get<0>(tpl)
        << " conf=" << std::get<1>(tpl) << " expcted "
        << SimpleMoodTypeToString(std::get<2>(tpl)) << " got "
        << SimpleMoodTypeToString(moodManager.GetSimpleMood());

    TickMoodManager(moodManager, 1, kTickTimestep);
    EXPECT_EQ(moodManager.GetSimpleMood(), std::get<2>(tpl))
        << "after tick: stim=" << std::get<0>(tpl)
        << " conf=" << std::get<1>(tpl) << " expcted "
        << SimpleMoodTypeToString(std::get<2>(tpl)) << " got "
        << SimpleMoodTypeToString(moodManager.GetSimpleMood());
  }
