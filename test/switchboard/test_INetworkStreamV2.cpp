...
void Test_INetworkStream::ReceiveMessage(const Anki::Vector::ExternalComms::RtsConnection_2& msg) {
  _queue.push(msg);
}
    ...
    switch(msg.GetTag()) {
      ...
      case Anki::Vector::ExternalComms::RtsConnection_2Tag::RtsNonceMessage: {
        ...
        SendRtsMessage<Vector::ExternalComms::RtsAck>
          ((uint8_t)Anki::Vector::ExternalComms::RtsConnection_2Tag::RtsNonceMessage);
