...
// to be within (-PI, PI]. Since the object can be cast directly to the double,
// it can be used with any trigonometry functions.
class Radians {
...
public:
  ...
  Radians(double initRad); // Constructs Radians object from input double (rescales accordingly)
  ...
  friend Radians operator+(const Radians& a, double b);         // Addition
  friend Radians operator+(double a, const Radians& b);         // Addition
  void operator+=(double b);                                    // Addition
  void operator+=(const Radians& b);                            // Addition
  friend Radians operator-(const Radians& a, const Radians& b); // Subtraction
  friend Radians operator-(const Radians& a, double b);         // Subtraction
  friend Radians operator-(double a, const Radians& b);         // Subtraction
  void operator-=(double b);                                    // Subtraction
  void operator-=(const Radians& b);                            // Subtraction
  friend Radians operator*(const Radians& a, double b);         // Multiplication
  friend Radians operator*(double a, const Radians& b);         // Multiplication
  void operator*=(double b);                                    // Multiplication
  friend Radians operator/(const Radians& a, double b);         // Division
  void operator/=(double b);                                    // Division
  ...
  double ToDouble() const { return radians_; };

  // Operator to cast the radian to a double
  float ToFloat() const { return (float)radians_;};
  ...
  // Does not rescale.
  double angularDistance(const Radians& destAngle, bool clockwise);
...
public:
  ...
  Radians_noRescale(double initRad) 
  : Radians(initRad)
  {
    doRescaling_ = false;
  }
