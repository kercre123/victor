...
// CamImage
#define MAX_VIZ_CAM_IMAGE_SIZE (4800)
START_MESSAGE_DEFINITION(VizCamImage, 1)
ADD_MESSAGE_MEMBER(u16, width)
ADD_MESSAGE_MEMBER(u16, height)
ADD_MESSAGE_MEMBER_ARRAY(u8, data, MAX_VIZ_CAM_IMAGE_SIZE)
END_MESSAGE_DEFINITION(VizCamImage)

// The maximum size of a VizMsg
#define MAX_VIZ_MSG_SIZE (MAX_VIZ_CAM_IMAGE_SIZE+8)