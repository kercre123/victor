...
#define MESSAGE_UI_PROCESS_METHODS_MODE       9
#define MESSAGE_CREATE_JSON_MODE              10
#define MESSAGE_CLASS_JSON_CONSTRUCTOR_MODE   11
#define MESSAGE_CREATEFROMJSON_LADDER_MODE    12
...
#define START_MESSAGE_DEFINITION(__MSG_TYPE__, __PRIORITY__) \
Result ProcessMessage(RobotID_t id, const GET_MESSAGE_CLASSNAME(__MSG_TYPE__)& msg); \
inline Result GET_DISPATCH_FCN_NAME(__MSG_TYPE__)(RobotID_t id, const u8* buffer) \
{ \
const GET_MESSAGE_CLASSNAME(__MSG_TYPE__) msg(buffer); \
return ProcessMessage(id, msg); \
}
