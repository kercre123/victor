...
// PlaceBlockOnGround
START_MESSAGE_DEFINITION(U2G_PlaceBlockOnGround, 1)
ADD_MESSAGE_MEMBER(f32, x_mm)
ADD_MESSAGE_MEMBER(f32, y_mm)
ADD_MESSAGE_MEMBER(f32, rad)
ADD_MESSAGE_MEMBER(u8, level)
END_MESSAGE_DEFINITION(U2G_PlaceBlockOnGround)
...
// SelectNextBlock
START_MESSAGE_DEFINITION(U2G_SelectNextBlock, 1)
END_MESSAGE_DEFINITION(U2G_SelectNextBlock)
