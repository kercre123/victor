...
ADD_FACE_CODE(FRONT_FACE, 32, 115, 117, 167, 238, 206, 221, 156, 168,  58, 114, 118)
END_BLOCK_DEFINITION

START_BLOCK_DEFINITION(TEMP2x1)
SET_COLOR(0.f, 0.f, 1.f) // Blue
SET_SIZE(120.f, 60.f, 60.f)
ADD_FACE_CODE(FRONT_FACE, 32, 115, 117, 167, 238, 206, 221, 156, 168,  58, 114, 118)
ADD_FACE_CODE(LEFT_FACE, 32, 115, 117, 167, 238, 206, 221, 156, 168,  58, 114, 118)
END_BLOCK_DEFINITION