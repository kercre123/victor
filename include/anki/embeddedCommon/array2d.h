...
namespace Anki
{
  namespace Embedded
  {
    ...
    public:
      ...
      inline const u8* Pointer(const s32 index0, const s32 index1) const;

      // Pointer to the data, at a given (y,x) location
      inline u8* Pointer(const s32 index0, const s32 index1);

      // Pointer to the data, at a given (y,x) location
      inline const u8* Pointer(const Point_s16 &point) const;
    ...
    public:
      ...
      // Pointer to the data, at a given (y,x) location
      inline const s8* Pointer(const s32 index0, const s32 index1) const;

      // Pointer to the data, at a given (y,x) location
      inline s8* Pointer(const s32 index0, const s32 index1);

      // Pointer to the data, at a given (y,x) location
      inline const s8* Pointer(const Point_s16 &point) const;
    ...
    public:
      ...
      // Pointer to the data, at a given (y,x) location
      inline const u16* Pointer(const s32 index0, const s32 index1) const;

      // Pointer to the data, at a given (y,x) location
      inline u16* Pointer(const s32 index0, const s32 index1);

      // Pointer to the data, at a given (y,x) location
      inline const u16* Pointer(const Point_s16 &point) const;
    ...
    public:
      ...
      // Pointer to the data, at a given (y,x) location
      inline const s16* Pointer(const s32 index0, const s32 index1) const;

      // Pointer to the data, at a given (y,x) location
      inline s16* Pointer(const s32 index0, const s32 index1);

      // Pointer to the data, at a given (y,x) location
      inline const s16* Pointer(const Point_s16 &point) const;
    ...
    public:
      ...
      // Pointer to the data, at a given (y,x) location
      inline const u32* Pointer(const s32 index0, const s32 index1) const;

      // Pointer to the data, at a given (y,x) location
      inline u32* Pointer(const s32 index0, const s32 index1);

      // Pointer to the data, at a given (y,x) location
      inline const u32* Pointer(const Point_s16 &point) const;
    ...
    public:
      ...
      // Pointer to the data, at a given (y,x) location
      inline const s32* Pointer(const s32 index0, const s32 index1) const;

      // Pointer to the data, at a given (y,x) location
      inline s32* Pointer(const s32 index0, const s32 index1);

      // Pointer to the data, at a given (y,x) location
      inline const s32* Pointer(const Point_s16 &point) const;
    ...
    public:
      ...
      // Pointer to the data, at a given (y,x) location
      inline const f32* Pointer(const s32 index0, const s32 index1) const;

      // Pointer to the data, at a given (y,x) location
      inline f32* Pointer(const s32 index0, const s32 index1);

      // Pointer to the data, at a given (y,x) location
      inline const f32* Pointer(const Point_s16 &point) const;
    ...
    public:
      ...
      // Pointer to the data, at a given (y,x) location
      inline const f64* Pointer(const s32 index0, const s32 index1) const;

      // Pointer to the data, at a given (y,x) location
      inline f64* Pointer(const s32 index0, const s32 index1);

      // Pointer to the data, at a given (y,x) location
      inline const f64* Pointer(const Point_s16 &point) const;
