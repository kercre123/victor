// Simple UDP server that "accepts" as clients anyone that sends a datagram to
// it. Send()s go to all clients.
...
class UdpServer {
 ...
 private:
  ...
  // struct addrinfo *host_info_list; // Pointer to the to the linked list of
  // host_info's.
