 ...
 * Date:   12/1/2018
 *
 * Description: Evaluates face "identification": Some number of faces are
 *pre-enrolled and a new face image is presented in order to see if it is one of
 *the enrolled set.
 *
...
class FaceEvalIdentify : public IFaceEval {
 ...
 private:
  ...
  bool ReadEnrollList(const std::string& dir,
