 ...
 * Date:   12/1/2018
 *
 * Description: Provides some common functionality for various Face Evaluation
 *tests, including shuffling and display.
 *
...
class IFaceEval {
 public:
  ...
  void DrawFaces(const Image& img, const std::list<TrackedFace>& faces,
                 ...
                 const std::string& displayStr = "", int pauseTime_ms = 0,
