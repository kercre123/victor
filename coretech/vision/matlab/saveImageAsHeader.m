...
fprintf(fileId,...
    ['// Autogenerated by saveImageAsHeader.m on ', sprintf('%d-%d-%d at %d:%d:%d', curDateAndTime(1), curDateAndTime(2), curDateAndTime(3), curDateAndTime(4), curDateAndTime(5), curDateAndTime(6)), '\n',...
    '\n',...
