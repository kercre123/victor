...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]) {
  ...
  Vision::CameraCalibration calib(
      static_cast<u16>(mxDims[0]), static_cast<u16>(mxDims[1]),
      static_cast<f32>(mxFocalLength[0]), static_cast<f32>(mxFocalLength[1]),
      static_cast<f32>(mxCenter[0]), static_cast<f32>(mxCenter[1]));
  ...
  Quad3f worldQuad(
      Point3f(mxWorldCorners[0], mxWorldCorners[4], mxWorldCorners[8]),
