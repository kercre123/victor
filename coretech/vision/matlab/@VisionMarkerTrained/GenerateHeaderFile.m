...
outputString = sprintf( [...
    ...
    datestr(now), 15-numFractionalBits, numFractionalBits, numFractionalBits);
...
outputString = [outputString sprintf('} // namespace VisionMarkerDecisionTree\n\n')];
    
%% Move outside DTree namespace
...
%% Move back into DTree namespace
outputString = [outputString sprintf([ ...
    'namespace VisionMarkerDecisionTree {\n\n' ...
