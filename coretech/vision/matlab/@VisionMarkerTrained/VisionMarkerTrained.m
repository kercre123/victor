classdef VisionMarkerTrained
    ...
    properties(Constant = true)
        ...
        RootImageDir = fullfile(fileparts(mfilename('fullpath')), '../../../../../products-cozmo-assets/VisionMarkers');
        
        TrainingImageDir = { ...
            fullfile(VisionMarkerTrained.RootImageDir, 'letters/withThinFiducials/rotated'), ... '~/Box Sync/Cozmo SE/VisionMarkers/matWithFiducials/unpadded/rotated', ...
            fullfile(VisionMarkerTrained.RootImageDir, 'symbols/withThinFiducials/rotated'), ...
            fullfile(VisionMarkerTrained.RootImageDir, 'lightCubeH/withThinFiducials/rotated'), ... 
            fullfile(VisionMarkerTrained.RootImageDir, 'matGears/withThinFiducials/rotated'), ... 
