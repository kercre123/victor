...
if all(isfield(VisionMarkerTrained.ProbeTree, {'verifyTreeRed', 'verifyTreeBlack'}))
    % "Red" Tree
    [array,maxDepth,leafLabels] = CreateTreeArray(VisionMarkerTrained.ProbeTree.verifyTreeRed);
    ...
    % "Black" Tree
    [array,maxDepth,leafLabels] = CreateTreeArray(VisionMarkerTrained.ProbeTree.verifyTreeBlack);
...
markerDefString = [markerDefString, sprintf('    enum MarkerType {\n')];
for i = 1:length(enumString)
  markerDefString = [markerDefString, '      ', enumString{i}(1:(end-2)), ' = ', sprintf('%d,\n', i-1)];
end
markerDefString = [markerDefString,...
  sprintf(['      NUM_MARKER_TYPES = %d,\n' ...
    '      MARKER_UNKNOWN = NUM_MARKER_TYPES\n' ...
    '    };\n\n'], length(enumString))];
