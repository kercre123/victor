...
nearestNeighborString = sprintf( [...
    ...
    numDataPoints, numDimensions, numFractionalBits);
...
nearestNeighborString = [nearestNeighborString sprintf([ ...
  ...
  '%s' ...
  '};\n\n'], sprintf('%d, ', nnLibrary.probeValues'))];
...
if writeFiles 
    ...
    if fid == -1
        error('Could not open "%s" for writing decision tree file.', nearestNeighborDataFile);
    else
