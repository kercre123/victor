...
% difference = interpolateAndDifference_affine(templateImage, templateQuad, newImage, homography, 1);

function differences = interpolateAndDifference_affine(templateImage, templateQuad, newImage, homography, scale, debugDisplay)
