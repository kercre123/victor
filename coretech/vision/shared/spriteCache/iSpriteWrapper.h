...
public:
  // Returns true if content is cached - this allows functions with no knowledge
  // of the wrapper they're working with and wheather it's cached or not to
  // gracefully use the best available function
  virtual bool IsContentCached() = 0;
  // Returns a copy of the image - this function can be called whether
  // the image has been cached or not
  virtual ImageRGBA GetSpriteContentsRGBA() = 0;
  ...
  virtual const ImageRGBA& GetCachedSpriteContentsRGBA() = 0;
