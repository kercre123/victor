...
class SpriteSequence {
 public:
  ...
  // This parameter was meant to be populated from a definition.json file
  // included in the folder for the spriteSequence. Since those files do not
  // currenlty make it to the robot due to a build system oversight, this
  // parameter always defaults to "Hold". As such, this functionality can be
  // removed and handed off to the SpriteBoxKeyFrame infrastructure which allows
  // for more dynamic usage of SpriteSequence assets from animation to animation
  // instead of hardcoding it into the SpriteSequence itself.
  enum class LoopConfig { Loop, Hold, DoNothing, Error };
  ...
  void CacheSequence(SpriteCache* cache, ImgTypeCacheSpec cacheSpec,
