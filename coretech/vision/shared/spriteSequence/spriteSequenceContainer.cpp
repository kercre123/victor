 ...
 * Date:   7/7/2015
 *
 * Description: Implements container for managing available sequences for the
...
SpriteSequenceContainer::SpriteSequenceContainer(
    SpriteSequenceMap&& spriteSequenceMap) {
  _spriteSequenceMap = std::move(spriteSequenceMap);
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
bool SpriteSequenceContainer::IsValidSpriteSequenceID(
