...
namespace Anki
{
  namespace Embedded
  {
    ...
    public:
      ...
      FiducialMarkerDecisionTree(const void * restrict treeData, const s32 treeDataLength, const s32 treeDataNumFractionalBits, const s32 treeMaxDepth, const s16 * restrict probeXOffsets, const s16 * restrict probeYOffsets, const s32 numProbeOffsets);
      ...
      Result Classify(const Array<u8> &image, const Array<f32> &homography, u8 meanGrayvalueThreshold, s32 &label) const;
