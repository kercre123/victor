...
#include "anki/vision/robot/cInterfaces_vision_c.h"
  ...
  // output_rowPointer must point to a buffer with at least sizeof(s32) bytes.
  void ScrollingIntegralImage_u8_s32_FilterRow_innerLoop_emulateShave(const s32 * restrict integralImage_00, const s32 * restrict integralImage_01, const s32 * restrict integralImage_10, const s32 * restrict integralImage_11, const s32 minX, const s32 maxX, const s32 imageWidth, s32 * restrict output_rowPointer);
