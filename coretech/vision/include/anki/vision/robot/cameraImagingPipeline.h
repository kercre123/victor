...
namespace Anki
{
  namespace Embedded
  {
    ...
    Result ComputeBestCameraParameters(
      ...
      const u8 highValue, // Values equal-to or greater than highValue are considered high
      const f32 percentileToMakeHigh, // Can be in the range [0.0, 1.0]. 0.95 is a good value
