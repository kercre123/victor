...
#pragma mark --- ScrollingIntegralImage Class Definition ---
    ...
    public:
      ...
      ScrollingIntegralImage_u8_s32(const s32 bufferHeight, const s32 imageWidth, const s32 numBorderPixels, MemoryStack &memory, const bool useBoundaryFillPatterns=false);
