 ...
 * Date: 03/25/2019
 *
 * Description: Debayering for RAW10 on Vector. This contains Debayer::Op
 * instances that run on CPU using Neon acceleration.
 *
 *
...
class RAW10toRGB24 : public Debayer::Op {
 public:
  ...
  Result operator()(const Debayer::InArgs& inArgs,
                    Debayer::OutArgs& outArgs) const override;
