...
enum class RotationAngle { None = 0, LeftRight1, LeftRight2, All, _Count };

enum class SearchDensity { Highest = 0, High, Normal, Low, Lowest, _Count };
...
enum class TrackingAccuracy { Normal = 0, High, _Count };
