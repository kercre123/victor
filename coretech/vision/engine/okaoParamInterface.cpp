...
typename ParamTraits<PoseAngle>::EnumArray ParamTraits<PoseAngle>::GetEnums() {
  return {{{PoseAngle::Unspecified, POSE_ANGLE_UNSPECIFIED, "Unspecified"},
...
typename ParamTraits<RollAngle>::EnumArray ParamTraits<RollAngle>::GetEnums() {
  return {{{RollAngle::Upper0, ROLL_ANGLE_0, "Upper (0)"},
           ...
           {RollAngle::UpperPm60, ROLL_ANGLE_U45 | ROLL_ANGLE_2 | ROLL_ANGLE_10,
            "Upper +- 60"},
           {RollAngle::UpperLeftRightPm15, ROLL_ANGLE_ULR15,
            "Upper Left Right +- 15"},
           {RollAngle::UpperLeftRightPm45, ROLL_ANGLE_ULR45,
            "Upper Left Right +- 45"}}};
}

// Specializations for RotationAngle
template <>
typename ParamTraits<RotationAngle>::EnumArray
ParamTraits<RotationAngle>::GetEnums() {
  return {{{RotationAngle::None, ROTATION_ANGLE_EXT0, "None"},
...
template <>
typename ParamTraits<SearchDensity>::EnumArray
ParamTraits<SearchDensity>::GetEnums() {
  return {{{SearchDensity::Highest, DENSITY_HIGHEST, "Highest"},
...
template <>
typename ParamTraits<DetectionMode>::EnumArray
ParamTraits<DetectionMode>::GetEnums() {
  return {{{DetectionMode::Default, DETECTION_MODE_DEFAULT, "Default"},
...
template <>
typename ParamTraits<TrackingAccuracy>::EnumArray
ParamTraits<TrackingAccuracy>::GetEnums() {
  return {{{TrackingAccuracy::Normal, TRACKING_ACCURACY_NORMAL, "Normal"},
