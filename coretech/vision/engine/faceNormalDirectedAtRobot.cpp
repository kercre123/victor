                                       ...
                                       const TimeStamp_t timeStamp)
{
  ...
  PRINT_NAMED_INFO("FaceNormalDirectedAtRobot.Update.YawPitch", "Yaw=%.3f, Pitch=%.3f", RAD_TO_DEG(_face.GetHeadYaw().ToFloat()), RAD_TO_DEG(_face.GetHeadPitch().ToFloat()));
  ...
  PRINT_NAMED_INFO("FaceNormalDirectedAtRobot.Update.AverageYawAndPitch", "average yaw=%.3f, average pitch=%.3f", _faceDirectionAverage.x(), _faceDirectionAverage.y());
  _numberOfInliers = FindInliers(_faceDirectionAverage);
  PRINT_NAMED_INFO("FaceNormalDirectedAtRobot.Update.NumberOfInliers", "Number of Inliers = %d", _numberOfInliers);
  _faceDirectionAverage = RecomputeFaceDirectionAverage();
  PRINT_NAMED_INFO("FaceNormalDirectedAtRobot.Update.RecomputedAverageYawAndPitch", "average yaw=%.3f, average pitch=%.3f", _faceDirectionAverage.x(), _faceDirectionAverage.y());
...
bool FaceNormalDirectedAtRobot::DetermineFaceDirectedAtRobot()
{
  bool faceDirectedAtRobot = false;
...
bool FaceNormalDirectedAtRobot::DetermineFaceDirectedRightOfRobot()
{
  ...
  return faceDirectedRightOfRobot;
}

bool FaceNormalDirectedAtRobot::DetermineFaceDirectedLeftOfRobot()
{
  ...
  return faceDirectedLeftOfRobot;
}
