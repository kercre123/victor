...
class OccluderList {
 public:
  ...
  void AddOccluder(const std::array<Point2f, NumPoints>& points,
 ...
 protected:
  // std::priority_queue<std::pair<Quad2f,f32>, CompareSecond<Quad2f,f32>() >
  // quadDepthPairs_;
...
inline bool OccluderList::IsEmpty() const { return rectDepthPairs_.empty(); }
