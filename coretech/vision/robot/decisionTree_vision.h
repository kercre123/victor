...
class FiducialMarkerDecisionTree : public DecisionTree {
 public:
  ...
  // Warning: The input treeData buffer is not copied, and must be globally
  // available
  FiducialMarkerDecisionTree(
  ...
  // If the mean of all probes if greater than grayvalueThreshold, then that
  // point is considered white
