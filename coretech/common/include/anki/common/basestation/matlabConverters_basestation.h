...
#ifndef _ANKI_CORETECH_BASESTATION_MATLAB_CONVERTERS_H_
#define _ANKI_CORETECH_BASESTATION_MATLAB_CONVERTERS_H_
...
#endif // _ANKI_CORETECH_BASESTATION_MATLAB_CONVERTERS_H_