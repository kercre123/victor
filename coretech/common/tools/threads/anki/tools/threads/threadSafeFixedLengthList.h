...
namespace Anki
{
  namespace Embedded
  {
    ...
    template<typename Type> ThreadSafeFixedLengthList<Type>::ThreadSafeFixedLengthList(s32 maximumSize, MemoryStack &memory, const Flags::Buffer flags=Flags::Buffer(true,false,false))
    {
#ifdef _MSC_VER
