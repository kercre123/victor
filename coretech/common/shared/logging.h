...
//
// Logging functions that provide a thin wrapper around Anki::Util macros,
// without bringing Anki::Util macros into the CoreTech namespace.
//
...
#define CORETECH_LOG_ERROR(name, format, ...) \
  Anki::CoreTech::LogError(name, format, ##__VA_ARGS__)
#else
#define CORETECH_LOG_ERROR(name, format, ...) \
  {}
#endif
...
#define CORETECH_LOG_WARNING(name, format, ...) \
  Anki::CoreTech::LogWarning(name, format, ##__VA_ARGS__)
#else
#define CORETECH_LOG_WARNING(name, format, ...) \
  {}
#endif
...
#define CORETECH_LOG_INFO(channel, name, format, ...) \
  Anki::CoreTech::LogInfo(channel, name, format, ##__VA_ARGS__)
#else
#define CORETECH_LOG_INFO(channel, name, format, ...) \
  {}
#endif
...
#define CORETECH_LOG_DEBUG(channel, name, format, ...) \
  Anki::CoreTech::LogDebug(channel, name, format, ##__VA_ARGS__)
#else
#define CORETECH_LOG_DEBUG(channel, name, format, ...) \
  {}
#endif
