...
This host intrinsics functions allow for compilation of ARM m4 intrinsics on any
platform. This set is incomplete, and there is no guarantee of correctness.
...
// Dual 16-bit unsigned addition and subtraction with halved results and
// exchange. u32 __UHASX(const u32 val1, const u32 val2);
...
// Dual 16-bit unsigned subtraction and addition with halved results and
// exchange. u32 __UHSAX(const u32 val1, const u32 val2);
...
// accumulate. u32 __USADA8(const u32 val1, const u32 val2, const u32 val3);
...
// Q setting pre-exchanged dual 16-bit signed multiply with single 32-bit
// accumulator. u32 __SMLADX(const u32 val1, const u32 val2, const u32 val3);
...
// Q setting dual 16-bit signed multiply with exchange subtract with 32-bit
// accumulate. u32 __SMLSDX(const u32 val1, const u32 val2, const u32 val3);

// Q setting dual 16-bit signed multiply subtract with 64-bit accumulate.
// u64 __SMLSLD(const u32 val1, const u32 val2, u64 val3);

// Q setting dual 16-bit signed multiply with exchange subtract with 64-bit
// accumulate. u64 __SMLSLDX(const u32 val1, const u32 val2, u64 val3);
...
// Halfword packing instruction. Combines bits[15:0] of val1 with bits[31:16] of
// val2 levitated with the val3. u32 __PKHBT(const u32 val1, const u32 val2,
// const u32 val3);

// Halfword packing instruction. Combines bits[31:16] of val1 with bits[15:0] of
// val2 right-shifted with the val3. u32 __PKHTB(const u32 val1, const u32 val2,
// const u32 val3);
}  // namespace Embedded
}  // namespace Anki
