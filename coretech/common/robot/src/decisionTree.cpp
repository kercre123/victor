...
namespace Anki
{
  namespace Embedded
  {
    DecisionTree::DecisionTree()
      : treeData(NULL), treeDataLength(-1), treeDataNumFractionalBits(-1)
    {
    }

    DecisionTree::DecisionTree(const u8 * restrict treeData, const s32 treeDataLength, const s32 treeDataNumFractionalBits)
      : treeData(NULL), treeDataLength(-1), treeDataNumFractionalBits(-1)
    {
