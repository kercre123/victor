...
u32 __SADD8(const u32 val1, const u32 val2) {
  ...
  for (s32 i = 0; i < 4; i++) {
    s32 sum = static_cast<s32>(register1._s8x4.v[i]) +
              static_cast<s32>(register2._s8x4.v[i]);
    ...
    AnkiAssert(CLIP(sum, static_cast<s32>(std::numeric_limits<s8>::min()),
                    static_cast<s32>(std::numeric_limits<s8>::max())) == sum);
...
u32 __QADD8(const u32 val1, const u32 val2) {
  ...
  for (s32 i = 0; i < 4; i++) {
    const s32 result = static_cast<s32>(register1._s8x4.v[i]) +
                       static_cast<s32>(register2._s8x4.v[i]);
    register1._s8x4.v[i] =
        CLIP(result, static_cast<s32>(std::numeric_limits<s8>::min()),
             static_cast<s32>(std::numeric_limits<s8>::max()));
  }
...
u32 __UADD8(const u32 val1, const u32 val2) {
  ...
  for (s32 i = 0; i < 4; i++) {
    u32 sum = static_cast<u32>(register1._u8x4.v[i]) +
              static_cast<u32>(register2._u8x4.v[i]);
    ...
    AnkiAssert(CLIP(sum, static_cast<u32>(0),
                    static_cast<u32>(std::numeric_limits<u8>::max())) == sum);
...
u32 __UQADD8(const u32 val1, const u32 val2) {
  ...
  for (s32 i = 0; i < 4; i++) {
    const u32 result = static_cast<u32>(register1._u8x4.v[i]) +
                       static_cast<u32>(register2._u8x4.v[i]);
    register1._u8x4.v[i] =
        MIN(result, static_cast<u32>(std::numeric_limits<u8>::max()));
  }
...
u32 __SHSUB8(const u32 val1, const u32 val2) {
  ...
  for (s32 i = 0; i < 4; i++) {
    s32 result = static_cast<s32>(register1._s8x4.v[i]) -
                 static_cast<s32>(register2._s8x4.v[i]);

    result >>= 1;

    AnkiAssert(CLIP(result, static_cast<s32>(std::numeric_limits<s8>::min()),
                    static_cast<s32>(std::numeric_limits<s8>::max())) ==
               result);
...
u32 __UHSUB8(const u32 val1, const u32 val2) {
  ...
  for (s32 i = 0; i < 4; i++) {
    s32 result = static_cast<s32>(register1._u8x4.v[i]) -
                 static_cast<s32>(register2._u8x4.v[i]);
...
u32 __SADD16(const u32 val1, const u32 val2) {
  ...
  for (s32 i = 0; i < 2; i++) {
    s32 sum = static_cast<s32>(register1._s16x2.v[i]) +
              static_cast<s32>(register2._s16x2.v[i]);
    ...
    AnkiAssert(CLIP(sum, static_cast<s32>(std::numeric_limits<s16>::min()),
                    static_cast<s32>(std::numeric_limits<s16>::max())) == sum);
...
u32 __QADD16(const u32 val1, const u32 val2) {
  ...
  for (s32 i = 0; i < 2; i++) {
    const s32 result = static_cast<s32>(register1._s16x2.v[i]) +
                       static_cast<s32>(register2._s16x2.v[i]);
    register1._s16x2.v[i] =
        CLIP(result, static_cast<s32>(std::numeric_limits<s16>::min()),
...
u32 __UADD16(const u32 val1, const u32 val2) {
  ...
  for (s32 i = 0; i < 2; i++) {
    u32 sum = static_cast<u32>(register1._u16x2.v[i]) +
              static_cast<u32>(register2._u16x2.v[i]);
    ...
    AnkiAssert(CLIP(sum, static_cast<u32>(0),
                    static_cast<u32>(std::numeric_limits<u16>::max())) == sum);
...
u32 __UQADD16(const u32 val1, const u32 val2) {
  ...
  for (s32 i = 0; i < 2; i++) {
    const u32 result = static_cast<u32>(register1._u16x2.v[i]) +
                       static_cast<u32>(register2._u16x2.v[i]);
    register1._u16x2.v[i] =
        MIN(result, static_cast<u32>(std::numeric_limits<u16>::max()));
  }
