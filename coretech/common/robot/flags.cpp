...
Buffer& Buffer::set_zeroAllocatedMemory(bool value) {
  ...
  if (value) this->flags |= Buffer::ZERO_ALLOCATED_MEMORY;
...
Buffer& Buffer::set_useBoundaryFillPatterns(bool value) {
  ...
  if (value) this->flags |= Buffer::USE_BOUNDARY_FILL_PATTERNS;
...
Buffer& Buffer::set_isFullyAllocated(bool value) {
  ...
  if (value) this->flags |= Buffer::IS_FULLY_ALLOCATED;
...
u32 Buffer::get_rawFlags() const { return this->flags; }
}  // namespace Flags
}  // namespace Embedded
}  // namespace Anki
