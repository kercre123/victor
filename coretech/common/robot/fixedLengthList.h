...
inline Type* FixedLengthList<Type>::Pointer(const s32 index) {
...
template <typename Type>
inline const Type* FixedLengthList<Type>::Pointer(const s32 index) const {
  AnkiAssert(index >= 0 && index < this->array.get_size(1));
...
template <typename Type>
inline const Type& FixedLengthList<Type>::operator[](const s32 index) const {
  AnkiAssert(index >= 0 && index < this->array.get_size(1));
...
template <typename Type>
inline Type& FixedLengthList<Type>::operator[](const s32 index) {
  AnkiAssert(index >= 0 && index < this->array.get_size(1));
...
template <typename Type>
FixedLengthList<Type>::FixedLengthList() : ArraySlice<Type>() {
  this->arrayData = NULL;
  this->set_size(0);
}  // FixedLengthList<Type>::FixedLengthList()

template <typename Type>
FixedLengthList<Type>::FixedLengthList(s32 maximumSize, void* data,
                                       s32 dataLength,
                                       const Flags::Buffer flags)
    : ArraySlice<Type>(Array<Type>(1, maximumSize, data, dataLength, flags),
                       LinearSequence<s32>(0, 0), LinearSequence<s32>(0, 0)) {
...
}  // FixedLengthList<Type>::FixedLengthList(s32 maximumSize, void * data, s32
   // dataLength, const Flags::Buffer flags)

template <typename Type>
FixedLengthList<Type>::FixedLengthList(s32 maximumSize, MemoryStack& memory,
                                       const Flags::Buffer flags)
    : ArraySlice<Type>(Array<Type>(1, maximumSize, memory, flags),
                       LinearSequence<s32>(0, 0), LinearSequence<s32>(0, 0)) {
  if (this->array.get_numElements() == 0) {
    this->arrayData = NULL;
  } else {
...
}  // FixedLengthList<Type>::FixedLengthList(s32 maximumSize, MemoryStack
   // &memory, const Flags::Buffer flags)
...
template <typename Type>
Result FixedLengthList<Type>::Resize(s32 maximumSize, MemoryStack& memory) {
  const Result resizeResult = this->array.Resize(1, maximumSize, memory);

  if (resizeResult != RESULT_OK) return resizeResult;

  this->xSlice =
      LinearSequence<s32>(0, 1, -1, MIN(this->xSlice.get_size(), maximumSize));
...
template <typename Type>
inline void FixedLengthList<Type>::Clear() {
  this->set_size(0);
}  // void FixedLengthList<Type>::Clear()

template <typename Type>
inline s32 FixedLengthList<Type>::SetZero() {
  return this->array.SetZero();
}

template <typename Type>
template <typename InType>
s32 FixedLengthList<Type>::SetCast(const FixedLengthList<InType>& input,
...
template <typename Type>
inline s32 FixedLengthList<Type>::get_maximumSize() const {
  return this->array.get_size(1);
}  // s32 FixedLengthList<Type>::get_maximumSize() const

template <typename Type>
inline s32 FixedLengthList<Type>::get_size() const {
...
template <typename Type>
Result FixedLengthList<Type>::Print(const char* const variableName,
                                    const s32 minIndex,
                                    const s32 maxIndex) const {
  return this->array.Print(variableName, 0, 0, MAX(0, minIndex),
                           MIN(maxIndex, this->get_size() - 1));
}  // Result FixedLengthList<Type>::Print(const char * const variableName, const
   // s32 minIndex, const s32 maxIndex) const
}  // namespace Embedded
}  // namespace Anki
