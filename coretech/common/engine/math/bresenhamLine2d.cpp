...
BresenhamLinePixelIterator::BresenhamLinePixelIterator(const Point2i& p,
                                                       const Point2i& q) {
  _curr = p;
...
bool BresenhamLinePixelIterator::Done() const { return _counter < 0; }

const Point2i& BresenhamLinePixelIterator::Get() const { return _curr; }
