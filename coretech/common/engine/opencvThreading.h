...
// Tells OpenCV to use the specified number of threads in addition to the main
// thread Note that 0 means to use sequential operations only
Result SetNumOpencvThreads(unsigned int n, const std::string& debugName);

// Returns the number of threads OpenCV is allowed to use, including the main
// thread
