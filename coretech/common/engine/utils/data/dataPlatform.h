...
class DataPlatform {
 public:
  DataPlatform(const std::string& persistentPath, const std::string& cachePath,
               const std::string& resourcesPath);

  std::string pathToResource(const Scope& resourceScope,
  ...
  bool readAsJson(const Scope& resourceScope, const std::string& resourceName,
  ...
  bool writeAsJson(const Scope& resourceScope, const std::string& resourceName,
                   const Json::Value& data) const;

  // write data to json file. returns true if successful.
  bool writeAsJson(const std::string& resourceName,
                   const Json::Value& data) const;
