 ...
 * Date:   6/29/2017
 *
 * Description: Asynchronous wrapper for running forward inference with a deep
 *neural network on an image. Currently supports detection of SalientPoints, but
 *API could be extended to get other types of outputs later.
 *
 *              Abstracts away the private implementation around what kind of
 *inference engine is used and runs asynchronously since forward inference
 *through deep networks is generally "slow".
 *
