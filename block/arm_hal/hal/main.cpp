...
//  printf("spine..");
  ...
  for (int i=0; i<8; ++i) {
	...
	//SetLED(LED_LEFT_EYE_TOP, 0x000001FF);
	//SetLED(LED_RIGHT_EYE_TOP, 0x000001FF);
	
	SetLED(LED_RIGHT_EYE_TOP, 0x05F << 16 | 0x05F << 8 | 0x05F);
	SetLED(LED_RIGHT_EYE_BOTTOM, 0x05F << 16 | 0x05F << 8 | 0x05F);
	SetLED(LED_RIGHT_EYE_LEFT, 0x05F << 16 | 0x05F << 8 | 0x05F);
	SetLED(LED_RIGHT_EYE_RIGHT, 0x05F << 16 | 0x05F << 8 | 0x05F);

	/*
	SetLED(LED_RIGHT_EYE_TOP, 0x00 << 16 | 0x05F << 8 | 0x05F);
	SetLED(LED_RIGHT_EYE_BOTTOM, 0x0 << 16 | 0x05F << 8 | 0x05F);
	SetLED(LED_RIGHT_EYE_LEFT, 0x0<< 16 | 0x05F << 8 | 0x05F);
	SetLED(LED_RIGHT_EYE_RIGHT, 0x0 << 16 | 0x05F << 8 | 0x05F);
	*/
