...
class BLEPairingController {
 public:
  ...
  BLEConnectedSignal& OnBLEConnectedEvent() { return _BLEConnectedSignal; }

  BLEConnectedSignal& OnBLEDisconnectedEvent() { return _BLEDisconnectedSignal; }

 private:
  const char* PAIRING_SERVICE = "00112233-4455-6677-8899-887766554433";
  const char* LOCAL_NAME =
      "Victor D0G3";  // TODO: This needs to be random generated, and not permanent
