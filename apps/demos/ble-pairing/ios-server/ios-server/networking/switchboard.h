...
class SwitchboardDaemon {
 public:
  ...
  // Methods
  static PinUpdatedSignal& OnPinUpdatedEvent() { return sPinUpdatedSignal; }

  static void SetQueue(dispatch_queue_t q) { sSwitchboardQueue = q; }
 ...
 private:
  ...
  static void OnTimerTick(struct ev_loop* loop, struct ev_timer* w,
                          int revents);
