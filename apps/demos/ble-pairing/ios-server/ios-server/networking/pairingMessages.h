...
SB_PackedStruct CancelMessage : Message {
 public:
  CancelMessage() { type = SetupMessage::MSG_CANCEL_SETUP; }
}
CancelMessage;
...
SB_PackedStruct ChallengeAcceptedMessage_crypto : Message {
 public:
  ...
  ChallengeAcceptedMessage_crypto() { type = SecureMessage::CRYPTO_ACCEPTED; }
}
...
SB_PackedStruct WifiStatusMessage_crypto : Message {
 public:
  ...
  WifiStatusMessage_crypto() { type = SecureMessage::CRYPTO_WIFI_STATUS; }
}
