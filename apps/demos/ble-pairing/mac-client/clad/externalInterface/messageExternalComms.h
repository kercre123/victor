...
inline const char* RtsConnTypeToString(const RtsConnType m) {
...
inline const char* RtsResponseCodeToString(const RtsResponseCode m) {
  return EnumToString(m);
}
...
inline const char* RtsCloudStatusToString(const RtsCloudStatus m) {
  return EnumToString(m);
}
...
struct RtsWifiScanResult {
  ...
  explicit RtsWifiScanResult(uint8_t authType, uint8_t signalStrength,
...
struct RtsWifiScanResult_2 {
  ...
  explicit RtsWifiScanResult_2(uint8_t authType, uint8_t signalStrength,
                               const std::string& wifiSsidHex, bool hidden)
      : authType(authType),
        signalStrength(signalStrength),
        wifiSsidHex(wifiSsidHex),
        hidden(hidden) {}
...
struct RtsWifiScanResult_3 {
  ...
  explicit RtsWifiScanResult_3(uint8_t authType, uint8_t signalStrength,
                               const std::string& wifiSsidHex, bool hidden,
                               bool provisioned)
      : authType(authType),
        signalStrength(signalStrength),
...
struct RtsConnResponse {
  ...
  explicit RtsConnResponse(
      Anki::Vector::ExternalComms::RtsConnType connectionType,
      const std::array<uint8_t, 32>& publicKey)
      : connectionType(connectionType), publicKey(publicKey) {}
...
struct RtsNonceMessage {
  ...
  explicit RtsNonceMessage(const std::array<uint8_t, 24>& toRobotNonce,
      ...
      : toRobotNonce(toRobotNonce), toDeviceNonce(toDeviceNonce) {}
...
struct RtsChallengeMessage {
  ...
  explicit RtsChallengeMessage(uint32_t number) : number(number) {}
...
struct RtsChallengeSuccessMessage {
  ...
  RtsChallengeSuccessMessage(RtsChallengeSuccessMessage&& other) noexcept =
      default;
  RtsChallengeSuccessMessage& operator=(
      const RtsChallengeSuccessMessage& other) = default;
  RtsChallengeSuccessMessage& operator=(RtsChallengeSuccessMessage&& other) =
      default;
...
struct RtsWifiForgetRequest {
  ...
  explicit RtsWifiForgetRequest(bool deleteAll, const std::string& wifiSsidHex)
      : deleteAll(deleteAll), wifiSsidHex(wifiSsidHex) {}
...
struct RtsWifiForgetResponse {
  ...
  RtsWifiForgetResponse& operator=(const RtsWifiForgetResponse& other) =
      default;
  RtsWifiForgetResponse& operator=(RtsWifiForgetResponse&& other) = default;

  explicit RtsWifiForgetResponse(bool didDelete, const std::string& wifiSsidHex)
      : didDelete(didDelete), wifiSsidHex(wifiSsidHex) {}
...
struct RtsWifiConnectRequest {
  ...
  RtsWifiConnectRequest& operator=(const RtsWifiConnectRequest& other) =
      default;
  ...
  explicit RtsWifiConnectRequest(const std::string& wifiSsidHex,
                                 const std::string& password, uint8_t timeout,
                                 uint8_t authType, bool hidden)
      : wifiSsidHex(wifiSsidHex),
        password(password),
        timeout(timeout),
        authType(authType),
...
struct RtsWifiConnectResponse {
  ...
  RtsWifiConnectResponse& operator=(const RtsWifiConnectResponse& other) =
      default;
  ...
  explicit RtsWifiConnectResponse(const std::string& wifiSsidHex,
                                  uint8_t wifiState)
      : wifiSsidHex(wifiSsidHex), wifiState(wifiState) {}
...
struct RtsWifiConnectResponse_3 {
  ...
  RtsWifiConnectResponse_3& operator=(const RtsWifiConnectResponse_3& other) =
      default;
  RtsWifiConnectResponse_3& operator=(RtsWifiConnectResponse_3&& other) =
      default;

  explicit RtsWifiConnectResponse_3(const std::string& wifiSsidHex,
                                    uint8_t wifiState, uint8_t connectResult)
      : wifiSsidHex(wifiSsidHex),
        wifiState(wifiState),
...
struct RtsWifiIpResponse {
  ...
  explicit RtsWifiIpResponse(uint8_t hasIpV4, uint8_t hasIpV6,
                             const std::array<uint8_t, 4>& ipV4,
                             const std::array<uint8_t, 16>& ipV6)
      : hasIpV4(hasIpV4), hasIpV6(hasIpV6), ipV4(ipV4), ipV6(ipV6) {}
...
struct RtsStatusResponse {
  ...
  explicit RtsStatusResponse(const std::string& wifiSsidHex, uint8_t wifiState,
                             bool accessPoint, uint8_t bleState,
                             uint8_t batteryState)
      : wifiSsidHex(wifiSsidHex),
        wifiState(wifiState),
...
struct RtsStatusResponse_2 {
  ...
  explicit RtsStatusResponse_2(const std::string& wifiSsidHex,
                               uint8_t wifiState, bool accessPoint,
                               uint8_t bleState, uint8_t batteryState,
                               const std::string& version, bool otaInProgress)
      : wifiSsidHex(wifiSsidHex),
        wifiState(wifiState),
        accessPoint(accessPoint),
        bleState(bleState),
...
struct RtsStatusResponse_4 {
  ...
  explicit RtsStatusResponse_4(const std::string& wifiSsidHex,
                               ...
                               const std::string& esn, bool otaInProgress,
                               bool hasOwner)
      : wifiSsidHex(wifiSsidHex),
        wifiState(wifiState),
        accessPoint(accessPoint),
...
struct RtsStatusResponse_5 {
  ...
  explicit RtsStatusResponse_5(const std::string& wifiSsidHex,
                               ...
                               const std::string& version,
                               const std::string& esn, bool otaInProgress,
                               bool hasOwner, bool isCloudAuthed)
      : wifiSsidHex(wifiSsidHex),
        wifiState(wifiState),
        accessPoint(accessPoint),
        bleState(bleState),
  ...
  void Invoke(Callable&& func) const {
    func(wifiSsidHex, wifiState, accessPoint, bleState, batteryState, version,
         esn, otaInProgress, hasOwner, isCloudAuthed);
  }
};
...
struct RtsWifiScanResponse {
  ...
  explicit RtsWifiScanResponse(
      uint8_t statusCode,
      const std::vector<Anki::Vector::ExternalComms::RtsWifiScanResult>&
          scanResult)
      : statusCode(statusCode), scanResult(scanResult) {}
...
struct RtsWifiScanResponse_2 {
  ...
  RtsWifiScanResponse_2& operator=(const RtsWifiScanResponse_2& other) =
      default;
  RtsWifiScanResponse_2& operator=(RtsWifiScanResponse_2&& other) = default;

  explicit RtsWifiScanResponse_2(
      uint8_t statusCode,
      const std::vector<Anki::Vector::ExternalComms::RtsWifiScanResult_2>&
          scanResult)
      : statusCode(statusCode), scanResult(scanResult) {}
...
struct RtsWifiScanResponse_3 {
  ...
  RtsWifiScanResponse_3& operator=(const RtsWifiScanResponse_3& other) =
      default;
  RtsWifiScanResponse_3& operator=(RtsWifiScanResponse_3&& other) = default;

  explicit RtsWifiScanResponse_3(
      uint8_t statusCode,
      const std::vector<Anki::Vector::ExternalComms::RtsWifiScanResult_3>&
          scanResult)
      : statusCode(statusCode), scanResult(scanResult) {}
...
struct RtsOtaUpdateRequest {
  ...
  explicit RtsOtaUpdateRequest(const std::string& url) : url(url) {}
...
struct RtsOtaUpdateResponse {
  ...
  explicit RtsOtaUpdateResponse(uint8_t status, uint64_t current,
                                uint64_t expected)
      : status(status), current(current), expected(expected) {}
...
struct RtsWifiAccessPointRequest {
  ...
  RtsWifiAccessPointRequest(RtsWifiAccessPointRequest&& other) noexcept =
      default;
  RtsWifiAccessPointRequest& operator=(const RtsWifiAccessPointRequest& other) =
      default;
  RtsWifiAccessPointRequest& operator=(RtsWifiAccessPointRequest&& other) =
      default;

  explicit RtsWifiAccessPointRequest(bool enable) : enable(enable) {}
...
struct RtsWifiAccessPointResponse {
  ...
  RtsWifiAccessPointResponse(RtsWifiAccessPointResponse&& other) noexcept =
      default;
  RtsWifiAccessPointResponse& operator=(
      const RtsWifiAccessPointResponse& other) = default;
  RtsWifiAccessPointResponse& operator=(RtsWifiAccessPointResponse&& other) =
      default;

  explicit RtsWifiAccessPointResponse(bool enabled, const std::string& ssid,
...
struct RtsLogRequest {
  ...
  explicit RtsLogRequest(uint8_t mode, const std::vector<std::string>& filter)
...
struct RtsLogResponse {
  ...
  explicit RtsLogResponse(uint8_t exitCode, uint32_t fileId)
      : exitCode(exitCode), fileId(fileId) {}
...
struct RtsFileDownload {
  ...
  explicit RtsFileDownload(uint8_t status, uint32_t fileId,
                           uint32_t packetNumber, uint32_t packetTotal,
...
struct RtsCloudSessionRequest {
  ...
  RtsCloudSessionRequest& operator=(const RtsCloudSessionRequest& other) =
      default;
...
struct RtsCloudSessionRequest_2 {
  ...
  RtsCloudSessionRequest_2& operator=(const RtsCloudSessionRequest_2& other) =
      default;
  RtsCloudSessionRequest_2& operator=(RtsCloudSessionRequest_2&& other) =
      default;

  explicit RtsCloudSessionRequest_2(const std::string& sessionToken,
                                    const std::string& clientName,
                                    const std::string& appId)
      : sessionToken(sessionToken), clientName(clientName), appId(appId) {}
...
struct RtsCloudSessionResponse {
  ...
  RtsCloudSessionResponse& operator=(const RtsCloudSessionResponse& other) =
      default;
  RtsCloudSessionResponse& operator=(RtsCloudSessionResponse&& other) = default;

  explicit RtsCloudSessionResponse(
      bool success, Anki::Vector::ExternalComms::RtsCloudStatus statusCode,
...
struct RtsAppConnectionIdRequest {
  ...
  RtsAppConnectionIdRequest(RtsAppConnectionIdRequest&& other) noexcept =
      default;
  RtsAppConnectionIdRequest& operator=(const RtsAppConnectionIdRequest& other) =
      default;
  RtsAppConnectionIdRequest& operator=(RtsAppConnectionIdRequest&& other) =
      default;
...
struct RtsAppConnectionIdResponse {
  ...
  RtsAppConnectionIdResponse(RtsAppConnectionIdResponse&& other) noexcept =
      default;
  RtsAppConnectionIdResponse& operator=(
      const RtsAppConnectionIdResponse& other) = default;
  RtsAppConnectionIdResponse& operator=(RtsAppConnectionIdResponse&& other) =
      default;
...
struct RtsResponse {
  ...
  explicit RtsResponse(Anki::Vector::ExternalComms::RtsResponseCode code,
      ...
      : code(code), responseMessage(responseMessage) {}
...
template <>
struct RtsConnection_2_TagToType<
    RtsConnection_2Tag::RtsChallengeSuccessMessage> {
...
template <>
struct RtsConnection_2_TagToType<
    RtsConnection_2Tag::RtsWifiAccessPointRequest> {
  using type = Anki::Vector::ExternalComms::RtsWifiAccessPointRequest;
};
template <>
struct RtsConnection_2_TagToType<
    RtsConnection_2Tag::RtsWifiAccessPointResponse> {
...
class RtsConnection_2 {
 public:
  ...
  // NOTE: Always returns a reference, even for trivial types, unlike
  // untemplated version
  template <Tag tag>
  ...
  template <Tag tag>
  static RtsConnection_2 Create_(
      typename RtsConnection_2_TagToType<tag>::type member);

  /** Error **/
  static RtsConnection_2 CreateError(
  ...
  static RtsConnection_2 CreateRtsChallengeSuccessMessage(
  ...
  Get_RtsChallengeSuccessMessage() const;
  void Set_RtsChallengeSuccessMessage(
      const Anki::Vector::ExternalComms::RtsChallengeSuccessMessage&
          new_RtsChallengeSuccessMessage);
  void Set_RtsChallengeSuccessMessage(
      Anki::Vector::ExternalComms::RtsChallengeSuccessMessage&&
  ...
  static RtsConnection_2 CreateRtsWifiConnectRequest(
      Anki::Vector::ExternalComms::RtsWifiConnectRequest&&
          new_RtsWifiConnectRequest);
  explicit RtsConnection_2(Anki::Vector::ExternalComms::RtsWifiConnectRequest&&
                               new_RtsWifiConnectRequest);
  const Anki::Vector::ExternalComms::RtsWifiConnectRequest&
  Get_RtsWifiConnectRequest() const;
  void Set_RtsWifiConnectRequest(
      const Anki::Vector::ExternalComms::RtsWifiConnectRequest&
          new_RtsWifiConnectRequest);
  void Set_RtsWifiConnectRequest(
      Anki::Vector::ExternalComms::RtsWifiConnectRequest&&
  ...
  static RtsConnection_2 CreateRtsWifiConnectResponse(
      Anki::Vector::ExternalComms::RtsWifiConnectResponse&&
          new_RtsWifiConnectResponse);
  explicit RtsConnection_2(Anki::Vector::ExternalComms::RtsWifiConnectResponse&&
                               new_RtsWifiConnectResponse);
  const Anki::Vector::ExternalComms::RtsWifiConnectResponse&
  Get_RtsWifiConnectResponse() const;
  void Set_RtsWifiConnectResponse(
      const Anki::Vector::ExternalComms::RtsWifiConnectResponse&
          new_RtsWifiConnectResponse);
  void Set_RtsWifiConnectResponse(
      Anki::Vector::ExternalComms::RtsWifiConnectResponse&&
  ...
  /** RtsWifiIpRequest **/
  static RtsConnection_2 CreateRtsWifiIpRequest(
      Anki::Vector::ExternalComms::RtsWifiIpRequest&& new_RtsWifiIpRequest);
  explicit RtsConnection_2(
      Anki::Vector::ExternalComms::RtsWifiIpRequest&& new_RtsWifiIpRequest);
  const Anki::Vector::ExternalComms::RtsWifiIpRequest& Get_RtsWifiIpRequest()
      const;
  void Set_RtsWifiIpRequest(const Anki::Vector::ExternalComms::RtsWifiIpRequest&
                                new_RtsWifiIpRequest);
  void Set_RtsWifiIpRequest(
      Anki::Vector::ExternalComms::RtsWifiIpRequest&& new_RtsWifiIpRequest);

  /** RtsWifiIpResponse **/
  static RtsConnection_2 CreateRtsWifiIpResponse(
      Anki::Vector::ExternalComms::RtsWifiIpResponse&& new_RtsWifiIpResponse);
  explicit RtsConnection_2(
      Anki::Vector::ExternalComms::RtsWifiIpResponse&& new_RtsWifiIpResponse);
  const Anki::Vector::ExternalComms::RtsWifiIpResponse& Get_RtsWifiIpResponse()
      const;
  void Set_RtsWifiIpResponse(
  ...
  /** RtsStatusRequest **/
  static RtsConnection_2 CreateRtsStatusRequest(
      Anki::Vector::ExternalComms::RtsStatusRequest&& new_RtsStatusRequest);
  explicit RtsConnection_2(
      Anki::Vector::ExternalComms::RtsStatusRequest&& new_RtsStatusRequest);
  const Anki::Vector::ExternalComms::RtsStatusRequest& Get_RtsStatusRequest()
      const;
  void Set_RtsStatusRequest(const Anki::Vector::ExternalComms::RtsStatusRequest&
                                new_RtsStatusRequest);
  void Set_RtsStatusRequest(
      Anki::Vector::ExternalComms::RtsStatusRequest&& new_RtsStatusRequest);

  /** RtsStatusResponse_2 **/
  static RtsConnection_2 CreateRtsStatusResponse_2(
      Anki::Vector::ExternalComms::RtsStatusResponse_2&&
          new_RtsStatusResponse_2);
  explicit RtsConnection_2(Anki::Vector::ExternalComms::RtsStatusResponse_2&&
                               new_RtsStatusResponse_2);
  const Anki::Vector::ExternalComms::RtsStatusResponse_2&
  Get_RtsStatusResponse_2() const;
  void Set_RtsStatusResponse_2(
      const Anki::Vector::ExternalComms::RtsStatusResponse_2&
          new_RtsStatusResponse_2);
  void Set_RtsStatusResponse_2(
      Anki::Vector::ExternalComms::RtsStatusResponse_2&&
  ...
  static RtsConnection_2 CreateRtsWifiScanResponse_2(
      Anki::Vector::ExternalComms::RtsWifiScanResponse_2&&
          new_RtsWifiScanResponse_2);
  explicit RtsConnection_2(Anki::Vector::ExternalComms::RtsWifiScanResponse_2&&
                               new_RtsWifiScanResponse_2);
  const Anki::Vector::ExternalComms::RtsWifiScanResponse_2&
  Get_RtsWifiScanResponse_2() const;
  void Set_RtsWifiScanResponse_2(
      const Anki::Vector::ExternalComms::RtsWifiScanResponse_2&
          new_RtsWifiScanResponse_2);
  void Set_RtsWifiScanResponse_2(
      Anki::Vector::ExternalComms::RtsWifiScanResponse_2&&
  ...
  /** RtsOtaUpdateRequest **/
  static RtsConnection_2 CreateRtsOtaUpdateRequest(
      Anki::Vector::ExternalComms::RtsOtaUpdateRequest&&
          new_RtsOtaUpdateRequest);
  explicit RtsConnection_2(Anki::Vector::ExternalComms::RtsOtaUpdateRequest&&
                               new_RtsOtaUpdateRequest);
  const Anki::Vector::ExternalComms::RtsOtaUpdateRequest&
  Get_RtsOtaUpdateRequest() const;
  void Set_RtsOtaUpdateRequest(
      const Anki::Vector::ExternalComms::RtsOtaUpdateRequest&
          new_RtsOtaUpdateRequest);
  void Set_RtsOtaUpdateRequest(
      Anki::Vector::ExternalComms::RtsOtaUpdateRequest&&
  ...
  static RtsConnection_2 CreateRtsOtaUpdateResponse(
      Anki::Vector::ExternalComms::RtsOtaUpdateResponse&&
          new_RtsOtaUpdateResponse);
  explicit RtsConnection_2(Anki::Vector::ExternalComms::RtsOtaUpdateResponse&&
                               new_RtsOtaUpdateResponse);
  const Anki::Vector::ExternalComms::RtsOtaUpdateResponse&
  Get_RtsOtaUpdateResponse() const;
  void Set_RtsOtaUpdateResponse(
      const Anki::Vector::ExternalComms::RtsOtaUpdateResponse&
          new_RtsOtaUpdateResponse);
  void Set_RtsOtaUpdateResponse(
      Anki::Vector::ExternalComms::RtsOtaUpdateResponse&&
  ...
  /** RtsCancelPairing **/
  static RtsConnection_2 CreateRtsCancelPairing(
      Anki::Vector::ExternalComms::RtsCancelPairing&& new_RtsCancelPairing);
  explicit RtsConnection_2(
      Anki::Vector::ExternalComms::RtsCancelPairing&& new_RtsCancelPairing);
  const Anki::Vector::ExternalComms::RtsCancelPairing& Get_RtsCancelPairing()
      const;
  void Set_RtsCancelPairing(const Anki::Vector::ExternalComms::RtsCancelPairing&
                                new_RtsCancelPairing);
  void Set_RtsCancelPairing(
      Anki::Vector::ExternalComms::RtsCancelPairing&& new_RtsCancelPairing);

  /** RtsForceDisconnect **/
  static RtsConnection_2 CreateRtsForceDisconnect(
      Anki::Vector::ExternalComms::RtsForceDisconnect&& new_RtsForceDisconnect);
  explicit RtsConnection_2(
      Anki::Vector::ExternalComms::RtsForceDisconnect&& new_RtsForceDisconnect);
  const Anki::Vector::ExternalComms::RtsForceDisconnect&
  Get_RtsForceDisconnect() const;
  void Set_RtsForceDisconnect(
      const Anki::Vector::ExternalComms::RtsForceDisconnect&
  ...
  /** RtsAck **/
  static RtsConnection_2 CreateRtsAck(
  ...
  static RtsConnection_2 CreateRtsWifiAccessPointRequest(
  ...
  Get_RtsWifiAccessPointRequest() const;
  void Set_RtsWifiAccessPointRequest(
      const Anki::Vector::ExternalComms::RtsWifiAccessPointRequest&
          new_RtsWifiAccessPointRequest);
  void Set_RtsWifiAccessPointRequest(
      Anki::Vector::ExternalComms::RtsWifiAccessPointRequest&&
  ...
  static RtsConnection_2 CreateRtsWifiAccessPointResponse(
  ...
  Get_RtsWifiAccessPointResponse() const;
  void Set_RtsWifiAccessPointResponse(
      const Anki::Vector::ExternalComms::RtsWifiAccessPointResponse&
          new_RtsWifiAccessPointResponse);
  void Set_RtsWifiAccessPointResponse(
      Anki::Vector::ExternalComms::RtsWifiAccessPointResponse&&
  ...
  /** RtsSshRequest **/
  static RtsConnection_2 CreateRtsSshRequest(
  ...
  void Set_RtsSshRequest(
      const Anki::Vector::ExternalComms::RtsSshRequest& new_RtsSshRequest);
  void Set_RtsSshRequest(
      Anki::Vector::ExternalComms::RtsSshRequest&& new_RtsSshRequest);

  /** RtsSshResponse **/
  static RtsConnection_2 CreateRtsSshResponse(
  ...
  void Set_RtsSshResponse(
      const Anki::Vector::ExternalComms::RtsSshResponse& new_RtsSshResponse);
  void Set_RtsSshResponse(
      Anki::Vector::ExternalComms::RtsSshResponse&& new_RtsSshResponse);

  /** RtsOtaCancelRequest **/
  static RtsConnection_2 CreateRtsOtaCancelRequest(
      Anki::Vector::ExternalComms::RtsOtaCancelRequest&&
          new_RtsOtaCancelRequest);
  explicit RtsConnection_2(Anki::Vector::ExternalComms::RtsOtaCancelRequest&&
                               new_RtsOtaCancelRequest);
  const Anki::Vector::ExternalComms::RtsOtaCancelRequest&
  Get_RtsOtaCancelRequest() const;
  void Set_RtsOtaCancelRequest(
      const Anki::Vector::ExternalComms::RtsOtaCancelRequest&
          new_RtsOtaCancelRequest);
  void Set_RtsOtaCancelRequest(
      Anki::Vector::ExternalComms::RtsOtaCancelRequest&&
  ...
  /** RtsLogRequest **/
  static RtsConnection_2 CreateRtsLogRequest(
  ...
  void Set_RtsLogRequest(
      const Anki::Vector::ExternalComms::RtsLogRequest& new_RtsLogRequest);
  void Set_RtsLogRequest(
      Anki::Vector::ExternalComms::RtsLogRequest&& new_RtsLogRequest);

  /** RtsLogResponse **/
  static RtsConnection_2 CreateRtsLogResponse(
  ...
  void Set_RtsLogResponse(
      const Anki::Vector::ExternalComms::RtsLogResponse& new_RtsLogResponse);
  void Set_RtsLogResponse(
      Anki::Vector::ExternalComms::RtsLogResponse&& new_RtsLogResponse);

  /** RtsFileDownload **/
  static RtsConnection_2 CreateRtsFileDownload(
      Anki::Vector::ExternalComms::RtsFileDownload&& new_RtsFileDownload);
  explicit RtsConnection_2(
      Anki::Vector::ExternalComms::RtsFileDownload&& new_RtsFileDownload);
  const Anki::Vector::ExternalComms::RtsFileDownload& Get_RtsFileDownload()
      const;
  void Set_RtsFileDownload(
 ...
 private:
  ...
  union {
    ...
    Anki::Vector::ExternalComms::RtsWifiAccessPointRequest
        _RtsWifiAccessPointRequest;
    Anki::Vector::ExternalComms::RtsWifiAccessPointResponse
        _RtsWifiAccessPointResponse;
...
template <>
struct RtsConnection_3_TagToType<
    RtsConnection_3Tag::RtsChallengeSuccessMessage> {
  using type = Anki::Vector::ExternalComms::RtsChallengeSuccessMessage;
};
template <>
...
template <>
struct RtsConnection_3_TagToType<
    RtsConnection_3Tag::RtsWifiAccessPointRequest> {
  using type = Anki::Vector::ExternalComms::RtsWifiAccessPointRequest;
};
template <>
struct RtsConnection_3_TagToType<
    RtsConnection_3Tag::RtsWifiAccessPointResponse> {
  using type = Anki::Vector::ExternalComms::RtsWifiAccessPointResponse;
};
template <>
...
class RtsConnection_3 {
 public:
  ...
  // Templated creator for making a union object out of one if its members
  template <Tag tag>
  static RtsConnection_3 Create_(
      typename RtsConnection_3_TagToType<tag>::type member);

  /** Error **/
  static RtsConnection_3 CreateError(
      Anki::Vector::ExternalComms::Error&& new_Error);
  ...
  /** RtsConnRequest **/
  static RtsConnection_3 CreateRtsConnRequest(
      Anki::Vector::ExternalComms::RtsConnRequest&& new_RtsConnRequest);
  explicit RtsConnection_3(
      Anki::Vector::ExternalComms::RtsConnRequest&& new_RtsConnRequest);
  const Anki::Vector::ExternalComms::RtsConnRequest& Get_RtsConnRequest() const;
  void Set_RtsConnRequest(
      const Anki::Vector::ExternalComms::RtsConnRequest& new_RtsConnRequest);
  ...
  /** RtsConnResponse **/
  static RtsConnection_3 CreateRtsConnResponse(
      Anki::Vector::ExternalComms::RtsConnResponse&& new_RtsConnResponse);
  explicit RtsConnection_3(
      Anki::Vector::ExternalComms::RtsConnResponse&& new_RtsConnResponse);
  const Anki::Vector::ExternalComms::RtsConnResponse& Get_RtsConnResponse()
  ...
  /** RtsNonceMessage **/
  static RtsConnection_3 CreateRtsNonceMessage(
      Anki::Vector::ExternalComms::RtsNonceMessage&& new_RtsNonceMessage);
  explicit RtsConnection_3(
      Anki::Vector::ExternalComms::RtsNonceMessage&& new_RtsNonceMessage);
  const Anki::Vector::ExternalComms::RtsNonceMessage& Get_RtsNonceMessage()
  ...
  /** RtsChallengeMessage **/
  static RtsConnection_3 CreateRtsChallengeMessage(
      Anki::Vector::ExternalComms::RtsChallengeMessage&&
          new_RtsChallengeMessage);
  explicit RtsConnection_3(Anki::Vector::ExternalComms::RtsChallengeMessage&&
                               new_RtsChallengeMessage);
  const Anki::Vector::ExternalComms::RtsChallengeMessage&
  Get_RtsChallengeMessage() const;
  void Set_RtsChallengeMessage(
  ...
  /** RtsChallengeSuccessMessage **/
  static RtsConnection_3 CreateRtsChallengeSuccessMessage(
      Anki::Vector::ExternalComms::RtsChallengeSuccessMessage&&
          new_RtsChallengeSuccessMessage);
  explicit RtsConnection_3(
      Anki::Vector::ExternalComms::RtsChallengeSuccessMessage&&
  ...
  /** RtsWifiConnectRequest **/
  static RtsConnection_3 CreateRtsWifiConnectRequest(
      Anki::Vector::ExternalComms::RtsWifiConnectRequest&&
          new_RtsWifiConnectRequest);
  explicit RtsConnection_3(Anki::Vector::ExternalComms::RtsWifiConnectRequest&&
                               new_RtsWifiConnectRequest);
  const Anki::Vector::ExternalComms::RtsWifiConnectRequest&
  Get_RtsWifiConnectRequest() const;
  void Set_RtsWifiConnectRequest(
  ...
  static RtsConnection_3 CreateRtsWifiConnectResponse_3(
  ...
  Get_RtsWifiConnectResponse_3() const;
  void Set_RtsWifiConnectResponse_3(
      const Anki::Vector::ExternalComms::RtsWifiConnectResponse_3&
          new_RtsWifiConnectResponse_3);
  void Set_RtsWifiConnectResponse_3(
      Anki::Vector::ExternalComms::RtsWifiConnectResponse_3&&
  ...
  /** RtsWifiIpRequest **/
  static RtsConnection_3 CreateRtsWifiIpRequest(
      Anki::Vector::ExternalComms::RtsWifiIpRequest&& new_RtsWifiIpRequest);
  explicit RtsConnection_3(
      Anki::Vector::ExternalComms::RtsWifiIpRequest&& new_RtsWifiIpRequest);
  const Anki::Vector::ExternalComms::RtsWifiIpRequest& Get_RtsWifiIpRequest()
  ...
  /** RtsWifiIpResponse **/
  static RtsConnection_3 CreateRtsWifiIpResponse(
      Anki::Vector::ExternalComms::RtsWifiIpResponse&& new_RtsWifiIpResponse);
  explicit RtsConnection_3(
      Anki::Vector::ExternalComms::RtsWifiIpResponse&& new_RtsWifiIpResponse);
  const Anki::Vector::ExternalComms::RtsWifiIpResponse& Get_RtsWifiIpResponse()
  ...
  /** RtsStatusRequest **/
  static RtsConnection_3 CreateRtsStatusRequest(
      Anki::Vector::ExternalComms::RtsStatusRequest&& new_RtsStatusRequest);
  explicit RtsConnection_3(
      Anki::Vector::ExternalComms::RtsStatusRequest&& new_RtsStatusRequest);
  const Anki::Vector::ExternalComms::RtsStatusRequest& Get_RtsStatusRequest()
  ...
  /** RtsStatusResponse_3 **/
  static RtsConnection_3 CreateRtsStatusResponse_3(
      Anki::Vector::ExternalComms::RtsStatusResponse_3&&
          new_RtsStatusResponse_3);
  explicit RtsConnection_3(Anki::Vector::ExternalComms::RtsStatusResponse_3&&
                               new_RtsStatusResponse_3);
  const Anki::Vector::ExternalComms::RtsStatusResponse_3&
  Get_RtsStatusResponse_3() const;
  void Set_RtsStatusResponse_3(
      const Anki::Vector::ExternalComms::RtsStatusResponse_3&
          new_RtsStatusResponse_3);
  void Set_RtsStatusResponse_3(
      Anki::Vector::ExternalComms::RtsStatusResponse_3&&
  ...
  /** RtsWifiScanRequest **/
  static RtsConnection_3 CreateRtsWifiScanRequest(
      Anki::Vector::ExternalComms::RtsWifiScanRequest&& new_RtsWifiScanRequest);
  explicit RtsConnection_3(
      Anki::Vector::ExternalComms::RtsWifiScanRequest&& new_RtsWifiScanRequest);
  const Anki::Vector::ExternalComms::RtsWifiScanRequest&
  ...
  static RtsConnection_3 CreateRtsWifiScanResponse_3(
      Anki::Vector::ExternalComms::RtsWifiScanResponse_3&&
          new_RtsWifiScanResponse_3);
  explicit RtsConnection_3(Anki::Vector::ExternalComms::RtsWifiScanResponse_3&&
                               new_RtsWifiScanResponse_3);
  const Anki::Vector::ExternalComms::RtsWifiScanResponse_3&
  Get_RtsWifiScanResponse_3() const;
  void Set_RtsWifiScanResponse_3(
      const Anki::Vector::ExternalComms::RtsWifiScanResponse_3&
          new_RtsWifiScanResponse_3);
  void Set_RtsWifiScanResponse_3(
      Anki::Vector::ExternalComms::RtsWifiScanResponse_3&&
  ...
  /** RtsOtaUpdateRequest **/
  static RtsConnection_3 CreateRtsOtaUpdateRequest(
      Anki::Vector::ExternalComms::RtsOtaUpdateRequest&&
          new_RtsOtaUpdateRequest);
  explicit RtsConnection_3(Anki::Vector::ExternalComms::RtsOtaUpdateRequest&&
                               new_RtsOtaUpdateRequest);
  const Anki::Vector::ExternalComms::RtsOtaUpdateRequest&
  Get_RtsOtaUpdateRequest() const;
  void Set_RtsOtaUpdateRequest(
  ...
  /** RtsOtaUpdateResponse **/
  static RtsConnection_3 CreateRtsOtaUpdateResponse(
      Anki::Vector::ExternalComms::RtsOtaUpdateResponse&&
          new_RtsOtaUpdateResponse);
  explicit RtsConnection_3(Anki::Vector::ExternalComms::RtsOtaUpdateResponse&&
                               new_RtsOtaUpdateResponse);
  const Anki::Vector::ExternalComms::RtsOtaUpdateResponse&
  Get_RtsOtaUpdateResponse() const;
  void Set_RtsOtaUpdateResponse(
  ...
  /** RtsCancelPairing **/
  static RtsConnection_3 CreateRtsCancelPairing(
      Anki::Vector::ExternalComms::RtsCancelPairing&& new_RtsCancelPairing);
  explicit RtsConnection_3(
      Anki::Vector::ExternalComms::RtsCancelPairing&& new_RtsCancelPairing);
  const Anki::Vector::ExternalComms::RtsCancelPairing& Get_RtsCancelPairing()
  ...
  /** RtsForceDisconnect **/
  static RtsConnection_3 CreateRtsForceDisconnect(
      Anki::Vector::ExternalComms::RtsForceDisconnect&& new_RtsForceDisconnect);
  explicit RtsConnection_3(
      Anki::Vector::ExternalComms::RtsForceDisconnect&& new_RtsForceDisconnect);
  const Anki::Vector::ExternalComms::RtsForceDisconnect&
  ...
  /** RtsAck **/
  static RtsConnection_3 CreateRtsAck(
      Anki::Vector::ExternalComms::RtsAck&& new_RtsAck);
  ...
  /** RtsWifiAccessPointRequest **/
  static RtsConnection_3 CreateRtsWifiAccessPointRequest(
      Anki::Vector::ExternalComms::RtsWifiAccessPointRequest&&
          new_RtsWifiAccessPointRequest);
  explicit RtsConnection_3(
      Anki::Vector::ExternalComms::RtsWifiAccessPointRequest&&
  ...
  /** RtsWifiAccessPointResponse **/
  static RtsConnection_3 CreateRtsWifiAccessPointResponse(
      Anki::Vector::ExternalComms::RtsWifiAccessPointResponse&&
          new_RtsWifiAccessPointResponse);
  explicit RtsConnection_3(
      Anki::Vector::ExternalComms::RtsWifiAccessPointResponse&&
  ...
  /** RtsSshRequest **/
  static RtsConnection_3 CreateRtsSshRequest(
      Anki::Vector::ExternalComms::RtsSshRequest&& new_RtsSshRequest);
  explicit RtsConnection_3(
      Anki::Vector::ExternalComms::RtsSshRequest&& new_RtsSshRequest);
  const Anki::Vector::ExternalComms::RtsSshRequest& Get_RtsSshRequest() const;
  ...
  /** RtsSshResponse **/
  static RtsConnection_3 CreateRtsSshResponse(
      Anki::Vector::ExternalComms::RtsSshResponse&& new_RtsSshResponse);
  explicit RtsConnection_3(
      Anki::Vector::ExternalComms::RtsSshResponse&& new_RtsSshResponse);
  const Anki::Vector::ExternalComms::RtsSshResponse& Get_RtsSshResponse() const;
  ...
  /** RtsOtaCancelRequest **/
  static RtsConnection_3 CreateRtsOtaCancelRequest(
      Anki::Vector::ExternalComms::RtsOtaCancelRequest&&
          new_RtsOtaCancelRequest);
  explicit RtsConnection_3(Anki::Vector::ExternalComms::RtsOtaCancelRequest&&
                               new_RtsOtaCancelRequest);
  const Anki::Vector::ExternalComms::RtsOtaCancelRequest&
  Get_RtsOtaCancelRequest() const;
  void Set_RtsOtaCancelRequest(
  ...
  /** RtsLogRequest **/
  static RtsConnection_3 CreateRtsLogRequest(
      Anki::Vector::ExternalComms::RtsLogRequest&& new_RtsLogRequest);
  explicit RtsConnection_3(
      Anki::Vector::ExternalComms::RtsLogRequest&& new_RtsLogRequest);
  const Anki::Vector::ExternalComms::RtsLogRequest& Get_RtsLogRequest() const;
  ...
  /** RtsLogResponse **/
  static RtsConnection_3 CreateRtsLogResponse(
      Anki::Vector::ExternalComms::RtsLogResponse&& new_RtsLogResponse);
  explicit RtsConnection_3(
      Anki::Vector::ExternalComms::RtsLogResponse&& new_RtsLogResponse);
  const Anki::Vector::ExternalComms::RtsLogResponse& Get_RtsLogResponse() const;
  ...
  /** RtsFileDownload **/
  static RtsConnection_3 CreateRtsFileDownload(
      Anki::Vector::ExternalComms::RtsFileDownload&& new_RtsFileDownload);
  explicit RtsConnection_3(
      Anki::Vector::ExternalComms::RtsFileDownload&& new_RtsFileDownload);
  const Anki::Vector::ExternalComms::RtsFileDownload& Get_RtsFileDownload()
  ...
  static RtsConnection_3 CreateRtsWifiForgetRequest(
      Anki::Vector::ExternalComms::RtsWifiForgetRequest&&
          new_RtsWifiForgetRequest);
  explicit RtsConnection_3(Anki::Vector::ExternalComms::RtsWifiForgetRequest&&
                               new_RtsWifiForgetRequest);
  const Anki::Vector::ExternalComms::RtsWifiForgetRequest&
  Get_RtsWifiForgetRequest() const;
  void Set_RtsWifiForgetRequest(
      const Anki::Vector::ExternalComms::RtsWifiForgetRequest&
          new_RtsWifiForgetRequest);
  void Set_RtsWifiForgetRequest(
      Anki::Vector::ExternalComms::RtsWifiForgetRequest&&
  ...
  static RtsConnection_3 CreateRtsWifiForgetResponse(
      Anki::Vector::ExternalComms::RtsWifiForgetResponse&&
          new_RtsWifiForgetResponse);
  explicit RtsConnection_3(Anki::Vector::ExternalComms::RtsWifiForgetResponse&&
                               new_RtsWifiForgetResponse);
  const Anki::Vector::ExternalComms::RtsWifiForgetResponse&
  Get_RtsWifiForgetResponse() const;
  void Set_RtsWifiForgetResponse(
      const Anki::Vector::ExternalComms::RtsWifiForgetResponse&
          new_RtsWifiForgetResponse);
  void Set_RtsWifiForgetResponse(
      Anki::Vector::ExternalComms::RtsWifiForgetResponse&&
  ...
  static RtsConnection_3 CreateRtsCloudSessionRequest(
      Anki::Vector::ExternalComms::RtsCloudSessionRequest&&
          new_RtsCloudSessionRequest);
  explicit RtsConnection_3(Anki::Vector::ExternalComms::RtsCloudSessionRequest&&
                               new_RtsCloudSessionRequest);
  const Anki::Vector::ExternalComms::RtsCloudSessionRequest&
  Get_RtsCloudSessionRequest() const;
  void Set_RtsCloudSessionRequest(
      const Anki::Vector::ExternalComms::RtsCloudSessionRequest&
          new_RtsCloudSessionRequest);
  void Set_RtsCloudSessionRequest(
      Anki::Vector::ExternalComms::RtsCloudSessionRequest&&
  ...
  static RtsConnection_3 CreateRtsCloudSessionResponse(
  ...
  Get_RtsCloudSessionResponse() const;
  void Set_RtsCloudSessionResponse(
      const Anki::Vector::ExternalComms::RtsCloudSessionResponse&
          new_RtsCloudSessionResponse);
  void Set_RtsCloudSessionResponse(
      Anki::Vector::ExternalComms::RtsCloudSessionResponse&&
...
template <>
struct RtsConnection_4_TagToType<
    RtsConnection_4Tag::RtsChallengeSuccessMessage> {
  using type = Anki::Vector::ExternalComms::RtsChallengeSuccessMessage;
};
template <>
...
template <>
struct RtsConnection_4_TagToType<
    RtsConnection_4Tag::RtsWifiAccessPointRequest> {
  using type = Anki::Vector::ExternalComms::RtsWifiAccessPointRequest;
};
template <>
struct RtsConnection_4_TagToType<
    RtsConnection_4Tag::RtsWifiAccessPointResponse> {
  using type = Anki::Vector::ExternalComms::RtsWifiAccessPointResponse;
};
template <>
...
template <>
struct RtsConnection_4_TagToType<
    RtsConnection_4Tag::RtsAppConnectionIdRequest> {
  using type = Anki::Vector::ExternalComms::RtsAppConnectionIdRequest;
};
template <>
struct RtsConnection_4_TagToType<
    RtsConnection_4Tag::RtsAppConnectionIdResponse> {
...
class RtsConnection_4 {
 public:
  ...
  // Templated creator for making a union object out of one if its members
  template <Tag tag>
  static RtsConnection_4 Create_(
      typename RtsConnection_4_TagToType<tag>::type member);

  /** Error **/
  static RtsConnection_4 CreateError(
      Anki::Vector::ExternalComms::Error&& new_Error);
  ...
  /** RtsConnRequest **/
  static RtsConnection_4 CreateRtsConnRequest(
      Anki::Vector::ExternalComms::RtsConnRequest&& new_RtsConnRequest);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsConnRequest&& new_RtsConnRequest);
  const Anki::Vector::ExternalComms::RtsConnRequest& Get_RtsConnRequest() const;
  void Set_RtsConnRequest(
      const Anki::Vector::ExternalComms::RtsConnRequest& new_RtsConnRequest);
  ...
  /** RtsConnResponse **/
  static RtsConnection_4 CreateRtsConnResponse(
      Anki::Vector::ExternalComms::RtsConnResponse&& new_RtsConnResponse);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsConnResponse&& new_RtsConnResponse);
  const Anki::Vector::ExternalComms::RtsConnResponse& Get_RtsConnResponse()
  ...
  /** RtsNonceMessage **/
  static RtsConnection_4 CreateRtsNonceMessage(
      Anki::Vector::ExternalComms::RtsNonceMessage&& new_RtsNonceMessage);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsNonceMessage&& new_RtsNonceMessage);
  const Anki::Vector::ExternalComms::RtsNonceMessage& Get_RtsNonceMessage()
  ...
  /** RtsChallengeMessage **/
  static RtsConnection_4 CreateRtsChallengeMessage(
      Anki::Vector::ExternalComms::RtsChallengeMessage&&
          new_RtsChallengeMessage);
  explicit RtsConnection_4(Anki::Vector::ExternalComms::RtsChallengeMessage&&
                               new_RtsChallengeMessage);
  const Anki::Vector::ExternalComms::RtsChallengeMessage&
  Get_RtsChallengeMessage() const;
  void Set_RtsChallengeMessage(
  ...
  /** RtsChallengeSuccessMessage **/
  static RtsConnection_4 CreateRtsChallengeSuccessMessage(
      Anki::Vector::ExternalComms::RtsChallengeSuccessMessage&&
          new_RtsChallengeSuccessMessage);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsChallengeSuccessMessage&&
  ...
  /** RtsWifiConnectRequest **/
  static RtsConnection_4 CreateRtsWifiConnectRequest(
      Anki::Vector::ExternalComms::RtsWifiConnectRequest&&
          new_RtsWifiConnectRequest);
  explicit RtsConnection_4(Anki::Vector::ExternalComms::RtsWifiConnectRequest&&
                               new_RtsWifiConnectRequest);
  const Anki::Vector::ExternalComms::RtsWifiConnectRequest&
  Get_RtsWifiConnectRequest() const;
  void Set_RtsWifiConnectRequest(
  ...
  /** RtsWifiConnectResponse_3 **/
  static RtsConnection_4 CreateRtsWifiConnectResponse_3(
      Anki::Vector::ExternalComms::RtsWifiConnectResponse_3&&
          new_RtsWifiConnectResponse_3);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsWifiConnectResponse_3&&
  ...
  /** RtsWifiIpRequest **/
  static RtsConnection_4 CreateRtsWifiIpRequest(
      Anki::Vector::ExternalComms::RtsWifiIpRequest&& new_RtsWifiIpRequest);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsWifiIpRequest&& new_RtsWifiIpRequest);
  const Anki::Vector::ExternalComms::RtsWifiIpRequest& Get_RtsWifiIpRequest()
  ...
  /** RtsWifiIpResponse **/
  static RtsConnection_4 CreateRtsWifiIpResponse(
      Anki::Vector::ExternalComms::RtsWifiIpResponse&& new_RtsWifiIpResponse);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsWifiIpResponse&& new_RtsWifiIpResponse);
  const Anki::Vector::ExternalComms::RtsWifiIpResponse& Get_RtsWifiIpResponse()
  ...
  /** RtsStatusRequest **/
  static RtsConnection_4 CreateRtsStatusRequest(
      Anki::Vector::ExternalComms::RtsStatusRequest&& new_RtsStatusRequest);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsStatusRequest&& new_RtsStatusRequest);
  const Anki::Vector::ExternalComms::RtsStatusRequest& Get_RtsStatusRequest()
  ...
  /** RtsStatusResponse_4 **/
  static RtsConnection_4 CreateRtsStatusResponse_4(
      Anki::Vector::ExternalComms::RtsStatusResponse_4&&
          new_RtsStatusResponse_4);
  explicit RtsConnection_4(Anki::Vector::ExternalComms::RtsStatusResponse_4&&
                               new_RtsStatusResponse_4);
  const Anki::Vector::ExternalComms::RtsStatusResponse_4&
  Get_RtsStatusResponse_4() const;
  void Set_RtsStatusResponse_4(
      const Anki::Vector::ExternalComms::RtsStatusResponse_4&
          new_RtsStatusResponse_4);
  void Set_RtsStatusResponse_4(
      Anki::Vector::ExternalComms::RtsStatusResponse_4&&
  ...
  /** RtsWifiScanRequest **/
  static RtsConnection_4 CreateRtsWifiScanRequest(
      Anki::Vector::ExternalComms::RtsWifiScanRequest&& new_RtsWifiScanRequest);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsWifiScanRequest&& new_RtsWifiScanRequest);
  const Anki::Vector::ExternalComms::RtsWifiScanRequest&
  ...
  /** RtsWifiScanResponse_3 **/
  static RtsConnection_4 CreateRtsWifiScanResponse_3(
      Anki::Vector::ExternalComms::RtsWifiScanResponse_3&&
          new_RtsWifiScanResponse_3);
  explicit RtsConnection_4(Anki::Vector::ExternalComms::RtsWifiScanResponse_3&&
                               new_RtsWifiScanResponse_3);
  const Anki::Vector::ExternalComms::RtsWifiScanResponse_3&
  Get_RtsWifiScanResponse_3() const;
  void Set_RtsWifiScanResponse_3(
  ...
  /** RtsOtaUpdateRequest **/
  static RtsConnection_4 CreateRtsOtaUpdateRequest(
      Anki::Vector::ExternalComms::RtsOtaUpdateRequest&&
          new_RtsOtaUpdateRequest);
  explicit RtsConnection_4(Anki::Vector::ExternalComms::RtsOtaUpdateRequest&&
                               new_RtsOtaUpdateRequest);
  const Anki::Vector::ExternalComms::RtsOtaUpdateRequest&
  Get_RtsOtaUpdateRequest() const;
  void Set_RtsOtaUpdateRequest(
  ...
  /** RtsOtaUpdateResponse **/
  static RtsConnection_4 CreateRtsOtaUpdateResponse(
      Anki::Vector::ExternalComms::RtsOtaUpdateResponse&&
          new_RtsOtaUpdateResponse);
  explicit RtsConnection_4(Anki::Vector::ExternalComms::RtsOtaUpdateResponse&&
                               new_RtsOtaUpdateResponse);
  const Anki::Vector::ExternalComms::RtsOtaUpdateResponse&
  Get_RtsOtaUpdateResponse() const;
  void Set_RtsOtaUpdateResponse(
  ...
  /** RtsCancelPairing **/
  static RtsConnection_4 CreateRtsCancelPairing(
      Anki::Vector::ExternalComms::RtsCancelPairing&& new_RtsCancelPairing);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsCancelPairing&& new_RtsCancelPairing);
  const Anki::Vector::ExternalComms::RtsCancelPairing& Get_RtsCancelPairing()
  ...
  /** RtsForceDisconnect **/
  static RtsConnection_4 CreateRtsForceDisconnect(
      Anki::Vector::ExternalComms::RtsForceDisconnect&& new_RtsForceDisconnect);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsForceDisconnect&& new_RtsForceDisconnect);
  const Anki::Vector::ExternalComms::RtsForceDisconnect&
  ...
  /** RtsAck **/
  static RtsConnection_4 CreateRtsAck(
      Anki::Vector::ExternalComms::RtsAck&& new_RtsAck);
  ...
  /** RtsWifiAccessPointRequest **/
  static RtsConnection_4 CreateRtsWifiAccessPointRequest(
      Anki::Vector::ExternalComms::RtsWifiAccessPointRequest&&
          new_RtsWifiAccessPointRequest);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsWifiAccessPointRequest&&
  ...
  /** RtsWifiAccessPointResponse **/
  static RtsConnection_4 CreateRtsWifiAccessPointResponse(
      Anki::Vector::ExternalComms::RtsWifiAccessPointResponse&&
          new_RtsWifiAccessPointResponse);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsWifiAccessPointResponse&&
  ...
  /** RtsSshRequest **/
  static RtsConnection_4 CreateRtsSshRequest(
      Anki::Vector::ExternalComms::RtsSshRequest&& new_RtsSshRequest);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsSshRequest&& new_RtsSshRequest);
  const Anki::Vector::ExternalComms::RtsSshRequest& Get_RtsSshRequest() const;
  ...
  /** RtsSshResponse **/
  static RtsConnection_4 CreateRtsSshResponse(
      Anki::Vector::ExternalComms::RtsSshResponse&& new_RtsSshResponse);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsSshResponse&& new_RtsSshResponse);
  const Anki::Vector::ExternalComms::RtsSshResponse& Get_RtsSshResponse() const;
  ...
  /** RtsOtaCancelRequest **/
  static RtsConnection_4 CreateRtsOtaCancelRequest(
      Anki::Vector::ExternalComms::RtsOtaCancelRequest&&
          new_RtsOtaCancelRequest);
  explicit RtsConnection_4(Anki::Vector::ExternalComms::RtsOtaCancelRequest&&
                               new_RtsOtaCancelRequest);
  const Anki::Vector::ExternalComms::RtsOtaCancelRequest&
  Get_RtsOtaCancelRequest() const;
  void Set_RtsOtaCancelRequest(
  ...
  /** RtsLogRequest **/
  static RtsConnection_4 CreateRtsLogRequest(
      Anki::Vector::ExternalComms::RtsLogRequest&& new_RtsLogRequest);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsLogRequest&& new_RtsLogRequest);
  const Anki::Vector::ExternalComms::RtsLogRequest& Get_RtsLogRequest() const;
  ...
  /** RtsLogResponse **/
  static RtsConnection_4 CreateRtsLogResponse(
      Anki::Vector::ExternalComms::RtsLogResponse&& new_RtsLogResponse);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsLogResponse&& new_RtsLogResponse);
  const Anki::Vector::ExternalComms::RtsLogResponse& Get_RtsLogResponse() const;
  ...
  /** RtsFileDownload **/
  static RtsConnection_4 CreateRtsFileDownload(
      Anki::Vector::ExternalComms::RtsFileDownload&& new_RtsFileDownload);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsFileDownload&& new_RtsFileDownload);
  const Anki::Vector::ExternalComms::RtsFileDownload& Get_RtsFileDownload()
  ...
  /** RtsWifiForgetRequest **/
  static RtsConnection_4 CreateRtsWifiForgetRequest(
      Anki::Vector::ExternalComms::RtsWifiForgetRequest&&
          new_RtsWifiForgetRequest);
  explicit RtsConnection_4(Anki::Vector::ExternalComms::RtsWifiForgetRequest&&
                               new_RtsWifiForgetRequest);
  const Anki::Vector::ExternalComms::RtsWifiForgetRequest&
  Get_RtsWifiForgetRequest() const;
  void Set_RtsWifiForgetRequest(
  ...
  /** RtsWifiForgetResponse **/
  static RtsConnection_4 CreateRtsWifiForgetResponse(
      Anki::Vector::ExternalComms::RtsWifiForgetResponse&&
          new_RtsWifiForgetResponse);
  explicit RtsConnection_4(Anki::Vector::ExternalComms::RtsWifiForgetResponse&&
                               new_RtsWifiForgetResponse);
  const Anki::Vector::ExternalComms::RtsWifiForgetResponse&
  Get_RtsWifiForgetResponse() const;
  void Set_RtsWifiForgetResponse(
  ...
  /** RtsCloudSessionRequest **/
  static RtsConnection_4 CreateRtsCloudSessionRequest(
      Anki::Vector::ExternalComms::RtsCloudSessionRequest&&
          new_RtsCloudSessionRequest);
  explicit RtsConnection_4(Anki::Vector::ExternalComms::RtsCloudSessionRequest&&
                               new_RtsCloudSessionRequest);
  const Anki::Vector::ExternalComms::RtsCloudSessionRequest&
  Get_RtsCloudSessionRequest() const;
  void Set_RtsCloudSessionRequest(
  ...
  /** RtsCloudSessionResponse **/
  static RtsConnection_4 CreateRtsCloudSessionResponse(
      Anki::Vector::ExternalComms::RtsCloudSessionResponse&&
          new_RtsCloudSessionResponse);
  explicit RtsConnection_4(
      Anki::Vector::ExternalComms::RtsCloudSessionResponse&&
  ...
  static RtsConnection_4 CreateRtsAppConnectionIdRequest(
  ...
  Get_RtsAppConnectionIdRequest() const;
  void Set_RtsAppConnectionIdRequest(
      const Anki::Vector::ExternalComms::RtsAppConnectionIdRequest&
          new_RtsAppConnectionIdRequest);
  void Set_RtsAppConnectionIdRequest(
      Anki::Vector::ExternalComms::RtsAppConnectionIdRequest&&
  ...
  static RtsConnection_4 CreateRtsAppConnectionIdResponse(
  ...
  Get_RtsAppConnectionIdResponse() const;
  void Set_RtsAppConnectionIdResponse(
      const Anki::Vector::ExternalComms::RtsAppConnectionIdResponse&
          new_RtsAppConnectionIdResponse);
  void Set_RtsAppConnectionIdResponse(
      Anki::Vector::ExternalComms::RtsAppConnectionIdResponse&&
 ...
 private:
  ...
  union {
    ...
    Anki::Vector::ExternalComms::RtsCloudSessionResponse
        _RtsCloudSessionResponse;
    Anki::Vector::ExternalComms::RtsAppConnectionIdRequest
        _RtsAppConnectionIdRequest;
    Anki::Vector::ExternalComms::RtsAppConnectionIdResponse
        _RtsAppConnectionIdResponse;
...
template <>
struct RtsConnection_5_TagToType<
    RtsConnection_5Tag::RtsChallengeSuccessMessage> {
  using type = Anki::Vector::ExternalComms::RtsChallengeSuccessMessage;
};
template <>
...
template <>
struct RtsConnection_5_TagToType<
    RtsConnection_5Tag::RtsWifiAccessPointRequest> {
  using type = Anki::Vector::ExternalComms::RtsWifiAccessPointRequest;
};
template <>
struct RtsConnection_5_TagToType<
    RtsConnection_5Tag::RtsWifiAccessPointResponse> {
  using type = Anki::Vector::ExternalComms::RtsWifiAccessPointResponse;
};
template <>
...
template <>
struct RtsConnection_5_TagToType<
    RtsConnection_5Tag::RtsAppConnectionIdRequest> {
  using type = Anki::Vector::ExternalComms::RtsAppConnectionIdRequest;
};
template <>
struct RtsConnection_5_TagToType<
    RtsConnection_5Tag::RtsAppConnectionIdResponse> {
  using type = Anki::Vector::ExternalComms::RtsAppConnectionIdResponse;
};
template <>
...
class RtsConnection_5 {
 public:
  ...
  // Templated creator for making a union object out of one if its members
  template <Tag tag>
  static RtsConnection_5 Create_(
      typename RtsConnection_5_TagToType<tag>::type member);

  /** Error **/
  static RtsConnection_5 CreateError(
      Anki::Vector::ExternalComms::Error&& new_Error);
  ...
  /** RtsConnRequest **/
  static RtsConnection_5 CreateRtsConnRequest(
      Anki::Vector::ExternalComms::RtsConnRequest&& new_RtsConnRequest);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsConnRequest&& new_RtsConnRequest);
  const Anki::Vector::ExternalComms::RtsConnRequest& Get_RtsConnRequest() const;
  void Set_RtsConnRequest(
      const Anki::Vector::ExternalComms::RtsConnRequest& new_RtsConnRequest);
  ...
  /** RtsConnResponse **/
  static RtsConnection_5 CreateRtsConnResponse(
      Anki::Vector::ExternalComms::RtsConnResponse&& new_RtsConnResponse);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsConnResponse&& new_RtsConnResponse);
  const Anki::Vector::ExternalComms::RtsConnResponse& Get_RtsConnResponse()
  ...
  /** RtsNonceMessage **/
  static RtsConnection_5 CreateRtsNonceMessage(
      Anki::Vector::ExternalComms::RtsNonceMessage&& new_RtsNonceMessage);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsNonceMessage&& new_RtsNonceMessage);
  const Anki::Vector::ExternalComms::RtsNonceMessage& Get_RtsNonceMessage()
  ...
  /** RtsChallengeMessage **/
  static RtsConnection_5 CreateRtsChallengeMessage(
      Anki::Vector::ExternalComms::RtsChallengeMessage&&
          new_RtsChallengeMessage);
  explicit RtsConnection_5(Anki::Vector::ExternalComms::RtsChallengeMessage&&
                               new_RtsChallengeMessage);
  const Anki::Vector::ExternalComms::RtsChallengeMessage&
  Get_RtsChallengeMessage() const;
  void Set_RtsChallengeMessage(
  ...
  /** RtsChallengeSuccessMessage **/
  static RtsConnection_5 CreateRtsChallengeSuccessMessage(
      Anki::Vector::ExternalComms::RtsChallengeSuccessMessage&&
          new_RtsChallengeSuccessMessage);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsChallengeSuccessMessage&&
  ...
  /** RtsWifiConnectRequest **/
  static RtsConnection_5 CreateRtsWifiConnectRequest(
      Anki::Vector::ExternalComms::RtsWifiConnectRequest&&
          new_RtsWifiConnectRequest);
  explicit RtsConnection_5(Anki::Vector::ExternalComms::RtsWifiConnectRequest&&
                               new_RtsWifiConnectRequest);
  const Anki::Vector::ExternalComms::RtsWifiConnectRequest&
  Get_RtsWifiConnectRequest() const;
  void Set_RtsWifiConnectRequest(
  ...
  /** RtsWifiConnectResponse_3 **/
  static RtsConnection_5 CreateRtsWifiConnectResponse_3(
      Anki::Vector::ExternalComms::RtsWifiConnectResponse_3&&
          new_RtsWifiConnectResponse_3);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsWifiConnectResponse_3&&
  ...
  /** RtsWifiIpRequest **/
  static RtsConnection_5 CreateRtsWifiIpRequest(
      Anki::Vector::ExternalComms::RtsWifiIpRequest&& new_RtsWifiIpRequest);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsWifiIpRequest&& new_RtsWifiIpRequest);
  const Anki::Vector::ExternalComms::RtsWifiIpRequest& Get_RtsWifiIpRequest()
  ...
  /** RtsWifiIpResponse **/
  static RtsConnection_5 CreateRtsWifiIpResponse(
      Anki::Vector::ExternalComms::RtsWifiIpResponse&& new_RtsWifiIpResponse);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsWifiIpResponse&& new_RtsWifiIpResponse);
  const Anki::Vector::ExternalComms::RtsWifiIpResponse& Get_RtsWifiIpResponse()
  ...
  /** RtsStatusRequest **/
  static RtsConnection_5 CreateRtsStatusRequest(
      Anki::Vector::ExternalComms::RtsStatusRequest&& new_RtsStatusRequest);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsStatusRequest&& new_RtsStatusRequest);
  const Anki::Vector::ExternalComms::RtsStatusRequest& Get_RtsStatusRequest()
  ...
  /** RtsStatusResponse_5 **/
  static RtsConnection_5 CreateRtsStatusResponse_5(
      Anki::Vector::ExternalComms::RtsStatusResponse_5&&
          new_RtsStatusResponse_5);
  explicit RtsConnection_5(Anki::Vector::ExternalComms::RtsStatusResponse_5&&
                               new_RtsStatusResponse_5);
  const Anki::Vector::ExternalComms::RtsStatusResponse_5&
  Get_RtsStatusResponse_5() const;
  void Set_RtsStatusResponse_5(
      const Anki::Vector::ExternalComms::RtsStatusResponse_5&
          new_RtsStatusResponse_5);
  void Set_RtsStatusResponse_5(
      Anki::Vector::ExternalComms::RtsStatusResponse_5&&
  ...
  /** RtsWifiScanRequest **/
  static RtsConnection_5 CreateRtsWifiScanRequest(
      Anki::Vector::ExternalComms::RtsWifiScanRequest&& new_RtsWifiScanRequest);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsWifiScanRequest&& new_RtsWifiScanRequest);
  const Anki::Vector::ExternalComms::RtsWifiScanRequest&
  ...
  /** RtsWifiScanResponse_3 **/
  static RtsConnection_5 CreateRtsWifiScanResponse_3(
      Anki::Vector::ExternalComms::RtsWifiScanResponse_3&&
          new_RtsWifiScanResponse_3);
  explicit RtsConnection_5(Anki::Vector::ExternalComms::RtsWifiScanResponse_3&&
                               new_RtsWifiScanResponse_3);
  const Anki::Vector::ExternalComms::RtsWifiScanResponse_3&
  Get_RtsWifiScanResponse_3() const;
  void Set_RtsWifiScanResponse_3(
  ...
  /** RtsOtaUpdateRequest **/
  static RtsConnection_5 CreateRtsOtaUpdateRequest(
      Anki::Vector::ExternalComms::RtsOtaUpdateRequest&&
          new_RtsOtaUpdateRequest);
  explicit RtsConnection_5(Anki::Vector::ExternalComms::RtsOtaUpdateRequest&&
                               new_RtsOtaUpdateRequest);
  const Anki::Vector::ExternalComms::RtsOtaUpdateRequest&
  Get_RtsOtaUpdateRequest() const;
  void Set_RtsOtaUpdateRequest(
  ...
  /** RtsOtaUpdateResponse **/
  static RtsConnection_5 CreateRtsOtaUpdateResponse(
      Anki::Vector::ExternalComms::RtsOtaUpdateResponse&&
          new_RtsOtaUpdateResponse);
  explicit RtsConnection_5(Anki::Vector::ExternalComms::RtsOtaUpdateResponse&&
                               new_RtsOtaUpdateResponse);
  const Anki::Vector::ExternalComms::RtsOtaUpdateResponse&
  Get_RtsOtaUpdateResponse() const;
  void Set_RtsOtaUpdateResponse(
  ...
  /** RtsCancelPairing **/
  static RtsConnection_5 CreateRtsCancelPairing(
      Anki::Vector::ExternalComms::RtsCancelPairing&& new_RtsCancelPairing);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsCancelPairing&& new_RtsCancelPairing);
  const Anki::Vector::ExternalComms::RtsCancelPairing& Get_RtsCancelPairing()
  ...
  /** RtsForceDisconnect **/
  static RtsConnection_5 CreateRtsForceDisconnect(
      Anki::Vector::ExternalComms::RtsForceDisconnect&& new_RtsForceDisconnect);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsForceDisconnect&& new_RtsForceDisconnect);
  const Anki::Vector::ExternalComms::RtsForceDisconnect&
  ...
  /** RtsAck **/
  static RtsConnection_5 CreateRtsAck(
      Anki::Vector::ExternalComms::RtsAck&& new_RtsAck);
  ...
  /** RtsWifiAccessPointRequest **/
  static RtsConnection_5 CreateRtsWifiAccessPointRequest(
      Anki::Vector::ExternalComms::RtsWifiAccessPointRequest&&
          new_RtsWifiAccessPointRequest);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsWifiAccessPointRequest&&
  ...
  /** RtsWifiAccessPointResponse **/
  static RtsConnection_5 CreateRtsWifiAccessPointResponse(
      Anki::Vector::ExternalComms::RtsWifiAccessPointResponse&&
          new_RtsWifiAccessPointResponse);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsWifiAccessPointResponse&&
  ...
  /** RtsSshRequest **/
  static RtsConnection_5 CreateRtsSshRequest(
      Anki::Vector::ExternalComms::RtsSshRequest&& new_RtsSshRequest);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsSshRequest&& new_RtsSshRequest);
  const Anki::Vector::ExternalComms::RtsSshRequest& Get_RtsSshRequest() const;
  ...
  /** RtsSshResponse **/
  static RtsConnection_5 CreateRtsSshResponse(
      Anki::Vector::ExternalComms::RtsSshResponse&& new_RtsSshResponse);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsSshResponse&& new_RtsSshResponse);
  const Anki::Vector::ExternalComms::RtsSshResponse& Get_RtsSshResponse() const;
  ...
  /** RtsOtaCancelRequest **/
  static RtsConnection_5 CreateRtsOtaCancelRequest(
      Anki::Vector::ExternalComms::RtsOtaCancelRequest&&
          new_RtsOtaCancelRequest);
  explicit RtsConnection_5(Anki::Vector::ExternalComms::RtsOtaCancelRequest&&
                               new_RtsOtaCancelRequest);
  const Anki::Vector::ExternalComms::RtsOtaCancelRequest&
  Get_RtsOtaCancelRequest() const;
  void Set_RtsOtaCancelRequest(
  ...
  /** RtsLogRequest **/
  static RtsConnection_5 CreateRtsLogRequest(
      Anki::Vector::ExternalComms::RtsLogRequest&& new_RtsLogRequest);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsLogRequest&& new_RtsLogRequest);
  const Anki::Vector::ExternalComms::RtsLogRequest& Get_RtsLogRequest() const;
  ...
  /** RtsLogResponse **/
  static RtsConnection_5 CreateRtsLogResponse(
      Anki::Vector::ExternalComms::RtsLogResponse&& new_RtsLogResponse);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsLogResponse&& new_RtsLogResponse);
  const Anki::Vector::ExternalComms::RtsLogResponse& Get_RtsLogResponse() const;
  ...
  /** RtsFileDownload **/
  static RtsConnection_5 CreateRtsFileDownload(
      Anki::Vector::ExternalComms::RtsFileDownload&& new_RtsFileDownload);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsFileDownload&& new_RtsFileDownload);
  const Anki::Vector::ExternalComms::RtsFileDownload& Get_RtsFileDownload()
  ...
  /** RtsWifiForgetRequest **/
  static RtsConnection_5 CreateRtsWifiForgetRequest(
      Anki::Vector::ExternalComms::RtsWifiForgetRequest&&
          new_RtsWifiForgetRequest);
  explicit RtsConnection_5(Anki::Vector::ExternalComms::RtsWifiForgetRequest&&
                               new_RtsWifiForgetRequest);
  const Anki::Vector::ExternalComms::RtsWifiForgetRequest&
  Get_RtsWifiForgetRequest() const;
  void Set_RtsWifiForgetRequest(
  ...
  /** RtsWifiForgetResponse **/
  static RtsConnection_5 CreateRtsWifiForgetResponse(
      Anki::Vector::ExternalComms::RtsWifiForgetResponse&&
          new_RtsWifiForgetResponse);
  explicit RtsConnection_5(Anki::Vector::ExternalComms::RtsWifiForgetResponse&&
                               new_RtsWifiForgetResponse);
  const Anki::Vector::ExternalComms::RtsWifiForgetResponse&
  Get_RtsWifiForgetResponse() const;
  void Set_RtsWifiForgetResponse(
  ...
  static RtsConnection_5 CreateRtsCloudSessionRequest_2(
  ...
  Get_RtsCloudSessionRequest_2() const;
  void Set_RtsCloudSessionRequest_2(
      const Anki::Vector::ExternalComms::RtsCloudSessionRequest_2&
          new_RtsCloudSessionRequest_2);
  void Set_RtsCloudSessionRequest_2(
      Anki::Vector::ExternalComms::RtsCloudSessionRequest_2&&
  ...
  /** RtsCloudSessionResponse **/
  static RtsConnection_5 CreateRtsCloudSessionResponse(
      Anki::Vector::ExternalComms::RtsCloudSessionResponse&&
          new_RtsCloudSessionResponse);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsCloudSessionResponse&&
  ...
  /** RtsAppConnectionIdRequest **/
  static RtsConnection_5 CreateRtsAppConnectionIdRequest(
      Anki::Vector::ExternalComms::RtsAppConnectionIdRequest&&
          new_RtsAppConnectionIdRequest);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsAppConnectionIdRequest&&
  ...
  /** RtsAppConnectionIdResponse **/
  static RtsConnection_5 CreateRtsAppConnectionIdResponse(
      Anki::Vector::ExternalComms::RtsAppConnectionIdResponse&&
          new_RtsAppConnectionIdResponse);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsAppConnectionIdResponse&&
  ...
  /** RtsResponse **/
  static RtsConnection_5 CreateRtsResponse(
      Anki::Vector::ExternalComms::RtsResponse&& new_RtsResponse);
  explicit RtsConnection_5(
      Anki::Vector::ExternalComms::RtsResponse&& new_RtsResponse);
  const Anki::Vector::ExternalComms::RtsResponse& Get_RtsResponse() const;
  ...
  /** RtsSdkProxyResponse **/
  static RtsConnection_5 CreateRtsSdkProxyResponse(
      Anki::Vector::ExternalComms::RtsSdkProxyResponse&&
          new_RtsSdkProxyResponse);
  explicit RtsConnection_5(Anki::Vector::ExternalComms::RtsSdkProxyResponse&&
                               new_RtsSdkProxyResponse);
  const Anki::Vector::ExternalComms::RtsSdkProxyResponse&
  Get_RtsSdkProxyResponse() const;
  void Set_RtsSdkProxyResponse(
      const Anki::Vector::ExternalComms::RtsSdkProxyResponse&
          new_RtsSdkProxyResponse);
  void Set_RtsSdkProxyResponse(
      Anki::Vector::ExternalComms::RtsSdkProxyResponse&&
...
template <>
struct RtsConnection_1_TagToType<
    RtsConnection_1Tag::RtsChallengeSuccessMessage> {
  using type = Anki::Vector::ExternalComms::RtsChallengeSuccessMessage;
};
template <>
...
template <>
struct RtsConnection_1_TagToType<
    RtsConnection_1Tag::RtsWifiAccessPointRequest> {
  using type = Anki::Vector::ExternalComms::RtsWifiAccessPointRequest;
};
template <>
struct RtsConnection_1_TagToType<
    RtsConnection_1Tag::RtsWifiAccessPointResponse> {
  using type = Anki::Vector::ExternalComms::RtsWifiAccessPointResponse;
};
template <>
...
class RtsConnection_1 {
 public:
  ...
  // Templated creator for making a union object out of one if its members
  template <Tag tag>
  static RtsConnection_1 Create_(
      typename RtsConnection_1_TagToType<tag>::type member);

  /** Error **/
  static RtsConnection_1 CreateError(
      Anki::Vector::ExternalComms::Error&& new_Error);
  ...
  /** RtsConnRequest **/
  static RtsConnection_1 CreateRtsConnRequest(
      Anki::Vector::ExternalComms::RtsConnRequest&& new_RtsConnRequest);
  explicit RtsConnection_1(
      Anki::Vector::ExternalComms::RtsConnRequest&& new_RtsConnRequest);
  const Anki::Vector::ExternalComms::RtsConnRequest& Get_RtsConnRequest() const;
  void Set_RtsConnRequest(
      const Anki::Vector::ExternalComms::RtsConnRequest& new_RtsConnRequest);
  ...
  /** RtsConnResponse **/
  static RtsConnection_1 CreateRtsConnResponse(
      Anki::Vector::ExternalComms::RtsConnResponse&& new_RtsConnResponse);
  explicit RtsConnection_1(
      Anki::Vector::ExternalComms::RtsConnResponse&& new_RtsConnResponse);
  const Anki::Vector::ExternalComms::RtsConnResponse& Get_RtsConnResponse()
  ...
  /** RtsNonceMessage **/
  static RtsConnection_1 CreateRtsNonceMessage(
      Anki::Vector::ExternalComms::RtsNonceMessage&& new_RtsNonceMessage);
  explicit RtsConnection_1(
      Anki::Vector::ExternalComms::RtsNonceMessage&& new_RtsNonceMessage);
  const Anki::Vector::ExternalComms::RtsNonceMessage& Get_RtsNonceMessage()
  ...
  /** RtsChallengeMessage **/
  static RtsConnection_1 CreateRtsChallengeMessage(
      Anki::Vector::ExternalComms::RtsChallengeMessage&&
          new_RtsChallengeMessage);
  explicit RtsConnection_1(Anki::Vector::ExternalComms::RtsChallengeMessage&&
                               new_RtsChallengeMessage);
  const Anki::Vector::ExternalComms::RtsChallengeMessage&
  Get_RtsChallengeMessage() const;
  void Set_RtsChallengeMessage(
  ...
  /** RtsChallengeSuccessMessage **/
  static RtsConnection_1 CreateRtsChallengeSuccessMessage(
      Anki::Vector::ExternalComms::RtsChallengeSuccessMessage&&
          new_RtsChallengeSuccessMessage);
  explicit RtsConnection_1(
      Anki::Vector::ExternalComms::RtsChallengeSuccessMessage&&
  ...
  /** RtsWifiConnectRequest **/
  static RtsConnection_1 CreateRtsWifiConnectRequest(
      Anki::Vector::ExternalComms::RtsWifiConnectRequest&&
          new_RtsWifiConnectRequest);
  explicit RtsConnection_1(Anki::Vector::ExternalComms::RtsWifiConnectRequest&&
                               new_RtsWifiConnectRequest);
  const Anki::Vector::ExternalComms::RtsWifiConnectRequest&
  Get_RtsWifiConnectRequest() const;
  void Set_RtsWifiConnectRequest(
  ...
  /** RtsWifiConnectResponse **/
  static RtsConnection_1 CreateRtsWifiConnectResponse(
      Anki::Vector::ExternalComms::RtsWifiConnectResponse&&
          new_RtsWifiConnectResponse);
  explicit RtsConnection_1(Anki::Vector::ExternalComms::RtsWifiConnectResponse&&
                               new_RtsWifiConnectResponse);
  const Anki::Vector::ExternalComms::RtsWifiConnectResponse&
  Get_RtsWifiConnectResponse() const;
  void Set_RtsWifiConnectResponse(
  ...
  /** RtsWifiIpRequest **/
  static RtsConnection_1 CreateRtsWifiIpRequest(
      Anki::Vector::ExternalComms::RtsWifiIpRequest&& new_RtsWifiIpRequest);
  explicit RtsConnection_1(
      Anki::Vector::ExternalComms::RtsWifiIpRequest&& new_RtsWifiIpRequest);
  const Anki::Vector::ExternalComms::RtsWifiIpRequest& Get_RtsWifiIpRequest()
  ...
  /** RtsWifiIpResponse **/
  static RtsConnection_1 CreateRtsWifiIpResponse(
      Anki::Vector::ExternalComms::RtsWifiIpResponse&& new_RtsWifiIpResponse);
  explicit RtsConnection_1(
      Anki::Vector::ExternalComms::RtsWifiIpResponse&& new_RtsWifiIpResponse);
  const Anki::Vector::ExternalComms::RtsWifiIpResponse& Get_RtsWifiIpResponse()
  ...
  /** RtsStatusRequest **/
  static RtsConnection_1 CreateRtsStatusRequest(
      Anki::Vector::ExternalComms::RtsStatusRequest&& new_RtsStatusRequest);
  explicit RtsConnection_1(
      Anki::Vector::ExternalComms::RtsStatusRequest&& new_RtsStatusRequest);
  const Anki::Vector::ExternalComms::RtsStatusRequest& Get_RtsStatusRequest()
  ...
  /** RtsStatusResponse **/
  static RtsConnection_1 CreateRtsStatusResponse(
      Anki::Vector::ExternalComms::RtsStatusResponse&& new_RtsStatusResponse);
  explicit RtsConnection_1(
      Anki::Vector::ExternalComms::RtsStatusResponse&& new_RtsStatusResponse);
  const Anki::Vector::ExternalComms::RtsStatusResponse& Get_RtsStatusResponse()
      const;
  void Set_RtsStatusResponse(
  ...
  /** RtsWifiScanRequest **/
  static RtsConnection_1 CreateRtsWifiScanRequest(
      Anki::Vector::ExternalComms::RtsWifiScanRequest&& new_RtsWifiScanRequest);
  explicit RtsConnection_1(
      Anki::Vector::ExternalComms::RtsWifiScanRequest&& new_RtsWifiScanRequest);
  const Anki::Vector::ExternalComms::RtsWifiScanRequest&
  ...
  /** RtsWifiScanResponse **/
  static RtsConnection_1 CreateRtsWifiScanResponse(
      Anki::Vector::ExternalComms::RtsWifiScanResponse&&
          new_RtsWifiScanResponse);
  explicit RtsConnection_1(Anki::Vector::ExternalComms::RtsWifiScanResponse&&
                               new_RtsWifiScanResponse);
  const Anki::Vector::ExternalComms::RtsWifiScanResponse&
  Get_RtsWifiScanResponse() const;
  void Set_RtsWifiScanResponse(
      const Anki::Vector::ExternalComms::RtsWifiScanResponse&
          new_RtsWifiScanResponse);
  void Set_RtsWifiScanResponse(
      Anki::Vector::ExternalComms::RtsWifiScanResponse&&
  ...
  /** RtsOtaUpdateRequest **/
  static RtsConnection_1 CreateRtsOtaUpdateRequest(
      Anki::Vector::ExternalComms::RtsOtaUpdateRequest&&
          new_RtsOtaUpdateRequest);
  explicit RtsConnection_1(Anki::Vector::ExternalComms::RtsOtaUpdateRequest&&
                               new_RtsOtaUpdateRequest);
  const Anki::Vector::ExternalComms::RtsOtaUpdateRequest&
  Get_RtsOtaUpdateRequest() const;
  void Set_RtsOtaUpdateRequest(
  ...
  /** RtsOtaUpdateResponse **/
  static RtsConnection_1 CreateRtsOtaUpdateResponse(
      Anki::Vector::ExternalComms::RtsOtaUpdateResponse&&
          new_RtsOtaUpdateResponse);
  explicit RtsConnection_1(Anki::Vector::ExternalComms::RtsOtaUpdateResponse&&
                               new_RtsOtaUpdateResponse);
  const Anki::Vector::ExternalComms::RtsOtaUpdateResponse&
  Get_RtsOtaUpdateResponse() const;
  void Set_RtsOtaUpdateResponse(
  ...
  /** RtsCancelPairing **/
  static RtsConnection_1 CreateRtsCancelPairing(
      Anki::Vector::ExternalComms::RtsCancelPairing&& new_RtsCancelPairing);
  explicit RtsConnection_1(
      Anki::Vector::ExternalComms::RtsCancelPairing&& new_RtsCancelPairing);
  const Anki::Vector::ExternalComms::RtsCancelPairing& Get_RtsCancelPairing()
  ...
  /** RtsForceDisconnect **/
  static RtsConnection_1 CreateRtsForceDisconnect(
      Anki::Vector::ExternalComms::RtsForceDisconnect&& new_RtsForceDisconnect);
  explicit RtsConnection_1(
      Anki::Vector::ExternalComms::RtsForceDisconnect&& new_RtsForceDisconnect);
  const Anki::Vector::ExternalComms::RtsForceDisconnect&
  ...
  /** RtsAck **/
  static RtsConnection_1 CreateRtsAck(
      Anki::Vector::ExternalComms::RtsAck&& new_RtsAck);
  ...
  /** RtsWifiAccessPointRequest **/
  static RtsConnection_1 CreateRtsWifiAccessPointRequest(
      Anki::Vector::ExternalComms::RtsWifiAccessPointRequest&&
          new_RtsWifiAccessPointRequest);
  explicit RtsConnection_1(
      Anki::Vector::ExternalComms::RtsWifiAccessPointRequest&&
  ...
  /** RtsWifiAccessPointResponse **/
  static RtsConnection_1 CreateRtsWifiAccessPointResponse(
      Anki::Vector::ExternalComms::RtsWifiAccessPointResponse&&
          new_RtsWifiAccessPointResponse);
  explicit RtsConnection_1(
      Anki::Vector::ExternalComms::RtsWifiAccessPointResponse&&
  ...
  /** RtsSshRequest **/
  static RtsConnection_1 CreateRtsSshRequest(
      Anki::Vector::ExternalComms::RtsSshRequest&& new_RtsSshRequest);
  explicit RtsConnection_1(
      Anki::Vector::ExternalComms::RtsSshRequest&& new_RtsSshRequest);
  const Anki::Vector::ExternalComms::RtsSshRequest& Get_RtsSshRequest() const;
  ...
  /** RtsSshResponse **/
  static RtsConnection_1 CreateRtsSshResponse(
      Anki::Vector::ExternalComms::RtsSshResponse&& new_RtsSshResponse);
  explicit RtsConnection_1(
      Anki::Vector::ExternalComms::RtsSshResponse&& new_RtsSshResponse);
  const Anki::Vector::ExternalComms::RtsSshResponse& Get_RtsSshResponse() const;
...
class RtsConnection {
 public:
  ...
  // Templated creator for making a union object out of one if its members
  template <Tag tag>
  static RtsConnection Create_(
      typename RtsConnection_TagToType<tag>::type member);

  /** Error **/
  static RtsConnection CreateError(
      Anki::Vector::ExternalComms::Error&& new_Error);
  ...
  /** RtsConnection_2 **/
  static RtsConnection CreateRtsConnection_2(
      Anki::Vector::ExternalComms::RtsConnection_2&& new_RtsConnection_2);
  explicit RtsConnection(
      Anki::Vector::ExternalComms::RtsConnection_2&& new_RtsConnection_2);
  const Anki::Vector::ExternalComms::RtsConnection_2& Get_RtsConnection_2()
      const;
  void Set_RtsConnection_2(
      const Anki::Vector::ExternalComms::RtsConnection_2& new_RtsConnection_2);
  void Set_RtsConnection_2(
      Anki::Vector::ExternalComms::RtsConnection_2&& new_RtsConnection_2);

  /** RtsConnection_3 **/
  static RtsConnection CreateRtsConnection_3(
      Anki::Vector::ExternalComms::RtsConnection_3&& new_RtsConnection_3);
  explicit RtsConnection(
      Anki::Vector::ExternalComms::RtsConnection_3&& new_RtsConnection_3);
  const Anki::Vector::ExternalComms::RtsConnection_3& Get_RtsConnection_3()
      const;
  void Set_RtsConnection_3(
      const Anki::Vector::ExternalComms::RtsConnection_3& new_RtsConnection_3);
  void Set_RtsConnection_3(
      Anki::Vector::ExternalComms::RtsConnection_3&& new_RtsConnection_3);

  /** RtsConnection_4 **/
  static RtsConnection CreateRtsConnection_4(
      Anki::Vector::ExternalComms::RtsConnection_4&& new_RtsConnection_4);
  explicit RtsConnection(
      Anki::Vector::ExternalComms::RtsConnection_4&& new_RtsConnection_4);
  const Anki::Vector::ExternalComms::RtsConnection_4& Get_RtsConnection_4()
      const;
  void Set_RtsConnection_4(
      const Anki::Vector::ExternalComms::RtsConnection_4& new_RtsConnection_4);
  void Set_RtsConnection_4(
      Anki::Vector::ExternalComms::RtsConnection_4&& new_RtsConnection_4);

  /** RtsConnection_5 **/
  static RtsConnection CreateRtsConnection_5(
      Anki::Vector::ExternalComms::RtsConnection_5&& new_RtsConnection_5);
  explicit RtsConnection(
      Anki::Vector::ExternalComms::RtsConnection_5&& new_RtsConnection_5);
  const Anki::Vector::ExternalComms::RtsConnection_5& Get_RtsConnection_5()
      const;
  void Set_RtsConnection_5(
...
struct DeprecatedAndReserved {
  ...
  DeprecatedAndReserved& operator=(const DeprecatedAndReserved& other) =
      default;
...
class ExternalComms {
 public:
  ...
  // Templated creator for making a union object out of one if its members
  template <Tag tag>
  static ExternalComms Create_(
      typename ExternalComms_TagToType<tag>::type member);

  /** Error **/
  static ExternalComms CreateError(
      Anki::Vector::ExternalComms::Error&& new_Error);
  ...
  /** RtsConnection_1 **/
  static ExternalComms CreateRtsConnection_1(
      Anki::Vector::ExternalComms::RtsConnection_1&& new_RtsConnection_1);
  explicit ExternalComms(
      Anki::Vector::ExternalComms::RtsConnection_1&& new_RtsConnection_1);
  const Anki::Vector::ExternalComms::RtsConnection_1& Get_RtsConnection_1()
      const;
  void Set_RtsConnection_1(
      const Anki::Vector::ExternalComms::RtsConnection_1& new_RtsConnection_1);
  void Set_RtsConnection_1(
      Anki::Vector::ExternalComms::RtsConnection_1&& new_RtsConnection_1);

  /** RtsConnection **/
  static ExternalComms CreateRtsConnection(
