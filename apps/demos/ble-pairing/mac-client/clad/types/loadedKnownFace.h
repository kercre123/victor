...
struct LoadedKnownFace {
  ...
  explicit LoadedKnownFace(int64_t secondsSinceFirstEnrolled,
                           int64_t secondsSinceLastUpdated,
                           int64_t secondsSinceLastSeen,
                           int64_t lastSeenSecondsSinceEpoch, int32_t faceID,
  ...
  void Invoke(Callable&& func) const {
    func(secondsSinceFirstEnrolled, secondsSinceLastUpdated,
         secondsSinceLastSeen, lastSeenSecondsSinceEpoch, faceID, name);
  }
};
...
struct RobotRenamedEnrolledFace {
  ...
  RobotRenamedEnrolledFace& operator=(const RobotRenamedEnrolledFace& other) =
      default;
  RobotRenamedEnrolledFace& operator=(RobotRenamedEnrolledFace&& other) =
      default;

  explicit RobotRenamedEnrolledFace(int32_t faceID, const std::string& name)
      : faceID(faceID), name(name) {}
