...
// generated/clad clad/types/loadedKnownFace.clad
...
LoadedKnownFace::LoadedKnownFace(const uint8_t* buff, size_t len)
    : LoadedKnownFace::LoadedKnownFace(
...
bool LoadedKnownFace::operator==(const LoadedKnownFace& other) const {
  return (this->secondsSinceFirstEnrolled == other.secondsSinceFirstEnrolled &&
          ...
          this->faceID == other.faceID && this->name == other.name);
}
...
const uint8_t LoadedKnownFaceVersionHash[16] = {
    0x68, 0xb2, 0xf6, 0x56, 0x1c, 0x39, 0xc3, 0x83,
    0xfc, 0x29, 0xd2, 0x53, 0xd,  0x56, 0xf0, 0x5};

// MESSAGE RobotRenamedEnrolledFace

RobotRenamedEnrolledFace::RobotRenamedEnrolledFace(
...
RobotRenamedEnrolledFace::RobotRenamedEnrolledFace(const uint8_t* buff,
                                                   size_t len)
    : RobotRenamedEnrolledFace::RobotRenamedEnrolledFace(
          {const_cast<uint8_t*>(buff), len, false}) {}
...
bool RobotRenamedEnrolledFace::operator==(
    const RobotRenamedEnrolledFace& other) const {
  return (this->faceID == other.faceID && this->name == other.name);
}
...
const char* RobotRenamedEnrolledFaceVersionHashStr =
    "b88cb003022c75948cc12ff4c6912877";

const uint8_t RobotRenamedEnrolledFaceVersionHash[16] = {
    0xb8, 0x8c, 0xb0, 0x3,  0x2,  0x2c, 0x75, 0x94,
    0x8c, 0xc1, 0x2f, 0xf4, 0xc6, 0x91, 0x28, 0x77};
