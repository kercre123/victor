...
- (void)async_WifiConnectRequest:(std::string)ssid
                        password:(std::string)pw
                          hidden:(bool)hid
                            auth:(uint8_t)authType;
...
- (void)HandleChallengeSuccessMessage:
    (const Anki::Vector::ExternalComms::RtsChallengeSuccessMessage&)msg;
...
- (void)HandleReceiveAccessPointResponse:
    (const Anki::Vector::ExternalComms::RtsWifiAccessPointResponse&)msg;
...
class Clad {
 public:
  ...
  static void SendRtsMessage(BleCentral* central, int commVersion, Args&&... args) {
    ...
    switch (commVersion) {
      case 1:
        msg = Anki::Vector::ExternalComms::ExternalComms(
            Anki::Vector::ExternalComms::RtsConnection_1(T(std::forward<Args>(args)...)));
        break;
      case 2:
        msg = Anki::Vector::ExternalComms::ExternalComms(Anki::Vector::ExternalComms::RtsConnection(
            Anki::Vector::ExternalComms::RtsConnection_2(T(std::forward<Args>(args)...))));
        break;
      case 3:
        msg = Anki::Vector::ExternalComms::ExternalComms(Anki::Vector::ExternalComms::RtsConnection(
            Anki::Vector::ExternalComms::RtsConnection_3(T(std::forward<Args>(args)...))));
        break;
      case 4:
        msg = Anki::Vector::ExternalComms::ExternalComms(Anki::Vector::ExternalComms::RtsConnection(
            Anki::Vector::ExternalComms::RtsConnection_4(T(std::forward<Args>(args)...))));
        break;
      case 5:
        msg = Anki::Vector::ExternalComms::ExternalComms(Anki::Vector::ExternalComms::RtsConnection(
            Anki::Vector::ExternalComms::RtsConnection_5(T(std::forward<Args>(args)...))));
        break;
      default:
  ...
  static void SendRtsMessage_2(BleCentral* central, int commVersion, Args&&... args) {
    Anki::Vector::ExternalComms::ExternalComms msg =
        Anki::Vector::ExternalComms::ExternalComms(Anki::Vector::ExternalComms::RtsConnection(
            Anki::Vector::ExternalComms::RtsConnection_2(T(std::forward<Args>(args)...))));
