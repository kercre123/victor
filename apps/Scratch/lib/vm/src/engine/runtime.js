...
class Runtime extends EventEmitter {
    ...
    stopAll () {
        ...
        while (threadsCopy.length > 0) {
            ...
            // TODO Turned off as currentBlockIdis not defined after scratch-vm update. Need to revisit.
            //
            // *** ANKI CHANGE ***
    ...
    _updateGlows (optExtraThreads) {
        ...
        for (let i = 0; i < searchThreads.length; i++) {
            ...
            if (target === this._editingTarget) {
                ...
                // *** ANKI CHANGE ***
                // Fix certain blocks not displaying the yellow outline when
