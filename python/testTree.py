...
def trainTree(labelsFilename, featureValuesFilename):
  t0 = time.time()
  labels = loadEmbeddedArray(labelsFilename)
  featureValues = loadEmbeddedArray(featureValuesFilename)
...
def testOnTrainingData(learnedTree, labelsFilename, featureValuesFilename):
  labels = loadEmbeddedArray(labelsFilename)
  featureValues = loadEmbeddedArray(featureValuesFilename)
...
#  numImages = 100
  ...
  for iImage in range(0,numImages):
    ...
    if iImage % 10000 == 0:
      t1 = time.time()
      print('Tested %d/%d. Current accuracy %d/%d=%f in %f seconds' % (iImage, numImages, numCorrect.sum(), numTotal.sum(), numCorrect.sum()/numTotal.sum(), t1-t0));
      t0 = time.time()
...
tree100 = trainTree('/Users/pbarnum/tmp/labels100.array', '/Users/pbarnum/tmp/featureValues100.array')
learnedTrees.append(tree100)
pickle.dump(learnedTrees, open('/Users/pbarnum/tmp/learnedTrees.pickle', 'wb'))
numCorrect100Train, numTotal100Train = testOnTrainingData(tree100, '/Users/pbarnum/tmp/labels100.array', '/Users/pbarnum/tmp/featureValues100.array')

tree100B = trainTree('/Users/pbarnum/tmp/labels100B.array', '/Users/pbarnum/tmp/featureValues100B.array')
learnedTrees.append(tree100B)
pickle.dump(learnedTrees, open('/Users/pbarnum/tmp/learnedTrees.pickle', 'wb'))
numCorrect100BTrain, numTotal100BTrain = testOnTrainingData(tree100B, '/Users/pbarnum/tmp/labels100B.array', '/Users/pbarnum/tmp/featureValues100B.array')

numCorrect100Switch, numTotal100Switch = testOnTrainingData(tree100, '/Users/pbarnum/tmp/labels100B.array', '/Users/pbarnum/tmp/featureValues100B.array')
numCorrect100BSwitch, numTotal100BSwitch = testOnTrainingData(tree100B, '/Users/pbarnum/tmp/labels100.array', '/Users/pbarnum/tmp/featureValues100.array')

tree300 = trainTree('/Users/pbarnum/tmp/labels300.array', '/Users/pbarnum/tmp/featureValues300.array')
learnedTrees.append(tree300)
pickle.dump(learnedTrees, open('/Users/pbarnum/tmp/learnedTrees.pickle', 'wb'))
numCorrect300Train, numTotal300Train = testOnTrainingData(tree300, '/Users/pbarnum/tmp/labels300.array', '/Users/pbarnum/tmp/featureValues300.array')

tree300B = trainTree('/Users/pbarnum/tmp/labels300B.array', '/Users/pbarnum/tmp/featureValues300B.array')
learnedTrees.append(tree300B)
pickle.dump(learnedTrees, open('/Users/pbarnum/tmp/learnedTrees.pickle', 'wb'))
numCorrect300BTrain, numTotal300BTrain = testOnTrainingData(tree300B, '/Users/pbarnum/tmp/labels300B.array', '/Users/pbarnum/tmp/featureValues300B.array')

numCorrect300Switch, numTotal300Switch = testOnTrainingData(tree300, '/Users/pbarnum/tmp/labels300B.array', '/Users/pbarnum/tmp/featureValues300B.array')
numCorrect300BSwitch, numTotal300BSwitch = testOnTrainingData(tree300B, '/Users/pbarnum/tmp/labels300.array', '/Users/pbarnum/tmp/featureValues300.array')

tree100_binary = trainTree('/Users/pbarnum/tmp/labels100.array', '/Users/pbarnum/tmp/featureValues100_binary.array')
learnedTrees.append(tree100_binary)
pickle.dump(learnedTrees, open('/Users/pbarnum/tmp/learnedTrees.pickle', 'wb'))
numCorrect100Train_binary, numTotal100Train_binary = testOnTrainingData(tree100_binary, '/Users/pbarnum/tmp/labels100.array', '/Users/pbarnum/tmp/featureValues100_binary.array')

tree100B_binary = trainTree('/Users/pbarnum/tmp/labels100B.array', '/Users/pbarnum/tmp/featureValues100B_binary.array')
learnedTrees.append(tree100B_binary)
pickle.dump(learnedTrees, open('/Users/pbarnum/tmp/learnedTrees.pickle', 'wb'))
numCorrect100BTrain_binary, numTotal100BTrain_binary = testOnTrainingData(tree100B_binary, '/Users/pbarnum/tmp/labels100B.array', '/Users/pbarnum/tmp/featureValues100B_binary.array')

numCorrect100Switch_binary, numTotal100Switch_binary = testOnTrainingData(tree100_binary, '/Users/pbarnum/tmp/labels100B.array', '/Users/pbarnum/tmp/featureValues100B_binary.array')
numCorrect100BSwitch_binary, numTotal100BSwitch_binary = testOnTrainingData(tree100B_binary, '/Users/pbarnum/tmp/labels100.array', '/Users/pbarnum/tmp/featureValues100_binary.array')

tree300_binary = trainTree('/Users/pbarnum/tmp/labels300.array', '/Users/pbarnum/tmp/featureValues300_binary.array')
learnedTrees.append(tree300_binary)
pickle.dump(learnedTrees, open('/Users/pbarnum/tmp/learnedTrees.pickle', 'wb'))
numCorrect300Train_binary, numTotal300Train_binary = testOnTrainingData(tree300_binary, '/Users/pbarnum/tmp/labels300.array', '/Users/pbarnum/tmp/featureValues300_binary.array')

tree300B_binary = trainTree('/Users/pbarnum/tmp/labels300B.array', '/Users/pbarnum/tmp/featureValues300B_binary.array')
learnedTrees.append(tree300B_binary)
pickle.dump(learnedTrees, open('/Users/pbarnum/tmp/learnedTrees.pickle', 'wb'))
numCorrect300BTrain_binary, numTotal300BTrain_binary = testOnTrainingData(tree300B_binary, '/Users/pbarnum/tmp/labels300B.array', '/Users/pbarnum/tmp/featureValues300B_binary.array')

numCorrect300Switch_binary, numTotal300Switch_binary = testOnTrainingData(tree300_binary, '/Users/pbarnum/tmp/labels300B.array', '/Users/pbarnum/tmp/featureValues300B_binary.array')
numCorrect300BSwitch_binary, numTotal300BSwitch_binary = testOnTrainingData(tree300B_binary, '/Users/pbarnum/tmp/labels300.array', '/Users/pbarnum/tmp/featureValues300_binary.array')
