def __GenerateTopOfFile():
    topString = \
        '/*\n\n\n\n\n\n\n\n\n\nThis file was automatically generated by the python script generateArray_cpp.py. Rather than editing this file, edit that script, then run "python generateArray2_cpp.py".\n\n\n\n\n\n\n\n\n\n*/\n\n';
