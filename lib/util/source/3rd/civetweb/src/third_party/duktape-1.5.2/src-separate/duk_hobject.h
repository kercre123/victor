...
#define DUK_HOBJECT_FLAG_EXTENSIBLE \
  DUK_HEAPHDR_USER_FLAG(0) /* object is extensible */
#define DUK_HOBJECT_FLAG_CONSTRUCTABLE \
  DUK_HEAPHDR_USER_FLAG(1) /* object is constructable */
#define DUK_HOBJECT_FLAG_BOUND \
  DUK_HEAPHDR_USER_FLAG(       \
      2) /* object established using Function.prototype.bind() */
#define DUK_HOBJECT_FLAG_COMPILEDFUNCTION \
  DUK_HEAPHDR_USER_FLAG(                  \
      4) /* object is a compiled function (duk_hcompiledfunction) */
#define DUK_HOBJECT_FLAG_NATIVEFUNCTION \
  DUK_HEAPHDR_USER_FLAG(                \
      5) /* object is a native function (duk_hnativefunction) */
#define DUK_HOBJECT_FLAG_BUFFEROBJECT \
  DUK_HEAPHDR_USER_FLAG(              \
      6) /* object is a buffer object (duk_hbufferobject) (always exotic) */
#define DUK_HOBJECT_FLAG_THREAD \
  DUK_HEAPHDR_USER_FLAG(7) /* object is a thread (duk_hthread) */
#define DUK_HOBJECT_FLAG_ARRAY_PART \
  DUK_HEAPHDR_USER_FLAG(            \
      8) /* object has an array part (a_size may still be 0) */
#define DUK_HOBJECT_FLAG_STRICT \
  DUK_HEAPHDR_USER_FLAG(9) /* function: function object is strict */
#define DUK_HOBJECT_FLAG_NOTAIL \
  DUK_HEAPHDR_USER_FLAG(10) /* function: function must not be tail called */
#define DUK_HOBJECT_FLAG_NEWENV                                             \
  DUK_HEAPHDR_USER_FLAG(11) /* function: create new environment when called \
                               (see duk_hcompiledfunction) */
#define DUK_HOBJECT_FLAG_NAMEBINDING                                          \
  DUK_HEAPHDR_USER_FLAG(                                                      \
      12) /* function: create binding for func name (function templates only, \
             used for named function expressions) */
#define DUK_HOBJECT_FLAG_CREATEARGS \
  DUK_HEAPHDR_USER_FLAG(            \
      13) /* function: create an arguments object on function call */
#define DUK_HOBJECT_FLAG_ENVRECCLOSED \
  DUK_HEAPHDR_USER_FLAG(14) /* envrec: (declarative) record is closed */
#define DUK_HOBJECT_FLAG_EXOTIC_ARRAY \
  DUK_HEAPHDR_USER_FLAG(              \
      15) /* 'Array' object, array length and index exotic behavior */
#define DUK_HOBJECT_FLAG_EXOTIC_STRINGOBJ \
  DUK_HEAPHDR_USER_FLAG(16) /* 'String' object, array index exotic behavior */
#define DUK_HOBJECT_FLAG_EXOTIC_ARGUMENTS                                  \
  DUK_HEAPHDR_USER_FLAG(17) /* 'Arguments' object and has arguments exotic \
                               behavior (non-strict callee) */
#define DUK_HOBJECT_FLAG_EXOTIC_DUKFUNC \
  DUK_HEAPHDR_USER_FLAG(                \
      18) /* Duktape/C (nativefunction) object, exotic 'length' */
#define DUK_HOBJECT_FLAG_EXOTIC_PROXYOBJ \
  DUK_HEAPHDR_USER_FLAG(19) /* 'Proxy' object */
...
#define DUK_HOBJECT_SET_CLASS_NUMBER(h, v)                           \
  DUK_HEAPHDR_SET_FLAG_RANGE(&(h)->hdr, DUK_HOBJECT_FLAG_CLASS_BASE, \
                             DUK_HOBJECT_FLAG_CLASS_BITS, (v))

#define DUK_HOBJECT_GET_CLASS_MASK(h)                                        \
  (1UL << DUK_HEAPHDR_GET_FLAG_RANGE(&(h)->hdr, DUK_HOBJECT_FLAG_CLASS_BASE, \
                                     DUK_HOBJECT_FLAG_CLASS_BITS))
...
#define DUK_HOBJECT_CMASK_UINT8CLAMPEDARRAY \
  (1UL << DUK_HOBJECT_CLASS_UINT8CLAMPEDARRAY)
...
#define DUK_HOBJECT_CMASK_ALL_BUFFEROBJECTS                             \
  (DUK_HOBJECT_CMASK_BUFFER | DUK_HOBJECT_CMASK_ARRAYBUFFER |           \
   DUK_HOBJECT_CMASK_DATAVIEW | DUK_HOBJECT_CMASK_INT8ARRAY |           \
   DUK_HOBJECT_CMASK_UINT8ARRAY | DUK_HOBJECT_CMASK_UINT8CLAMPEDARRAY | \
   DUK_HOBJECT_CMASK_INT16ARRAY | DUK_HOBJECT_CMASK_UINT16ARRAY |       \
   DUK_HOBJECT_CMASK_INT32ARRAY | DUK_HOBJECT_CMASK_UINT32ARRAY |       \
   DUK_HOBJECT_CMASK_FLOAT32ARRAY | DUK_HOBJECT_CMASK_FLOAT64ARRAY)
...
#define DUK_HOBJECT_IS_FUNCTION(h)                                            \
  DUK_HEAPHDR_CHECK_FLAG_BITS(                                                \
      &(h)->hdr, DUK_HOBJECT_FLAG_BOUND | DUK_HOBJECT_FLAG_COMPILEDFUNCTION | \
                     DUK_HOBJECT_FLAG_NATIVEFUNCTION)
...
#define DUK_HOBJECT_EXOTIC_BEHAVIOR_FLAGS                                \
  (DUK_HOBJECT_FLAG_EXOTIC_ARRAY | DUK_HOBJECT_FLAG_EXOTIC_ARGUMENTS |   \
   DUK_HOBJECT_FLAG_EXOTIC_STRINGOBJ | DUK_HOBJECT_FLAG_EXOTIC_DUKFUNC | \
   DUK_HOBJECT_FLAG_BUFFEROBJECT | DUK_HOBJECT_FLAG_EXOTIC_PROXYOBJ)
...
#define DUK_HOBJECT_HAS_NATIVEFUNCTION(h) \
  DUK_HEAPHDR_CHECK_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_NATIVEFUNCTION)
#define DUK_HOBJECT_HAS_BUFFEROBJECT(h) \
  DUK_HEAPHDR_CHECK_FLAG_BITS(&(h)->hdr, DUK_HOBJECT_FLAG_BUFFEROBJECT)
...
#define DUK_HOBJECT_SET_EXTENSIBLE(h) \
...
#define DUK_HOBJECT_SET_EXOTIC_PROXYOBJ(h) \
...
#define DUK_PROPDESC_FLAGS_MASK                                \
  (DUK_PROPDESC_FLAG_WRITABLE | DUK_PROPDESC_FLAG_ENUMERABLE | \
   DUK_PROPDESC_FLAG_CONFIGURABLE | DUK_PROPDESC_FLAG_ACCESSOR)
...
#define DUK_PROPDESC_FLAG_NO_OVERWRITE \
  (1 << 4) /* internal define property: skip write silently if exists */
...
#define DUK_PROPDESC_FLAGS_WC \
  (DUK_PROPDESC_FLAG_WRITABLE | DUK_PROPDESC_FLAG_CONFIGURABLE)
#define DUK_PROPDESC_FLAGS_EC \
  (DUK_PROPDESC_FLAG_ENUMERABLE | DUK_PROPDESC_FLAG_CONFIGURABLE)
...
#define DUK_GETDESC_FLAG_IGNORE_PROTOLOOP \
  (1 << 1) /* don't throw for prototype loop */
...
#define DUK_HOBJECT_GET_PROPS(heap, h)                      \
  ((duk_uint8_t *)DUK_USE_HEAPPTR_DEC16((heap)->heap_udata, \
                                        ((duk_heaphdr *)(h))->h_extra16))
#define DUK_HOBJECT_SET_PROPS(heap, h, x)                       \
  do {                                                          \
    ((duk_heaphdr *)(h))->h_extra16 =                           \
        DUK_USE_HEAPPTR_ENC16((heap)->heap_udata, (void *)(x)); \
  } while (0)
#else
...
#define DUK_HOBJECT_E_GET_KEY_BASE(heap, h) \
  ((duk_hstring **)(void *)(DUK_HOBJECT_GET_PROPS((heap), (h))))
...
#define DUK_HOBJECT_P_SET_REALLOC_PTRS(p_base, set_e_k, set_e_pv, set_e_f, \
                                       set_a, set_h, n_ent, n_arr, n_hash) \
  do {                                                                     \
...
#define DUK_HOBJECT_P_COMPUTE_SIZE(n_ent, n_arr, n_hash)                       \
  ((n_ent) *                                                                   \
       (sizeof(duk_hstring *) + sizeof(duk_propvalue) + sizeof(duk_uint8_t)) + \
   DUK_HOBJECT_E_FLAG_PADDING((n_ent)) + (n_arr) * sizeof(duk_tval) +          \
...
#define DUK_HOBJECT_P_COMPUTE_SIZE(n_ent, n_arr, n_hash)                       \
  ((n_ent) *                                                                   \
       (sizeof(duk_propvalue) + sizeof(duk_hstring *) + sizeof(duk_uint8_t)) + \
   (n_arr) * sizeof(duk_tval) + (n_hash) * sizeof(duk_uint32_t))
#define DUK_HOBJECT_P_SET_REALLOC_PTRS(p_base, set_e_k, set_e_pv, set_e_f, \
                                       set_a, set_h, n_ent, n_arr, n_hash) \
  do {                                                                     \
...
#define DUK_HOBJECT_P_ALLOC_SIZE(h)                      \
  DUK_HOBJECT_P_COMPUTE_SIZE(DUK_HOBJECT_GET_ESIZE((h)), \
...
#define DUK_HOBJECT_E_GET_VALUE_PTR(heap, h, i) \
  (&DUK_HOBJECT_E_GET_VALUE_BASE((heap), (h))[(i)])
#define DUK_HOBJECT_E_GET_VALUE_TVAL(heap, h, i) \
...
#define DUK_HOBJECT_E_GET_VALUE_GETTER_PTR(heap, h, i) \
  (&DUK_HOBJECT_E_GET_VALUE((heap), (h), (i)).a.get)
#define DUK_HOBJECT_E_GET_VALUE_SETTER(heap, h, i) \
  (DUK_HOBJECT_E_GET_VALUE((heap), (h), (i)).a.set)
#define DUK_HOBJECT_E_GET_VALUE_SETTER_PTR(heap, h, i) \
  (&DUK_HOBJECT_E_GET_VALUE((heap), (h), (i)).a.set)
...
#define DUK_HOBJECT_H_GET_INDEX_PTR(heap, h, i) \
  (&DUK_HOBJECT_H_GET_BASE((heap), (h))[(i)])
...
#define DUK_HOBJECT_E_SLOT_IS_WRITABLE(heap, h, i)                             \
  ((DUK_HOBJECT_E_GET_FLAGS((heap), (h), (i)) & DUK_PROPDESC_FLAG_WRITABLE) != \
   0)
#define DUK_HOBJECT_E_SLOT_IS_ENUMERABLE(heap, h, i) \
  ((DUK_HOBJECT_E_GET_FLAGS((heap), (h), (i)) &      \
    DUK_PROPDESC_FLAG_ENUMERABLE) != 0)
#define DUK_HOBJECT_E_SLOT_IS_CONFIGURABLE(heap, h, i) \
  ((DUK_HOBJECT_E_GET_FLAGS((heap), (h), (i)) &        \
    DUK_PROPDESC_FLAG_CONFIGURABLE) != 0)
#define DUK_HOBJECT_E_SLOT_IS_ACCESSOR(heap, h, i)                             \
  ((DUK_HOBJECT_E_GET_FLAGS((heap), (h), (i)) & DUK_PROPDESC_FLAG_ACCESSOR) != \
   0)

#define DUK_HOBJECT_E_SLOT_SET_WRITABLE(heap, h, i) \
  DUK_HOBJECT_E_SET_FLAG_BITS((heap), (h), (i), DUK_PROPDESC_FLAG_WRITABLE)
#define DUK_HOBJECT_E_SLOT_SET_ENUMERABLE(heap, h, i) \
...
#define DUK_HOBJECT_E_SLOT_CLEAR_CONFIGURABLE(heap, h, i) \
  DUK_HOBJECT_E_CLEAR_FLAG_BITS((heap), (h), (i),         \
                                DUK_PROPDESC_FLAG_CONFIGURABLE)
...
#define DUK_HOBJECT_GET_CLASS_STRING(heap, h)                     \
  DUK_HEAP_GET_STRING((heap), DUK_HOBJECT_CLASS_NUMBER_TO_STRIDX( \
                                  DUK_HOBJECT_GET_CLASS_NUMBER((h))))
...
/* hash size relative to entries size: for value X, approx. hash_prime(e_size +
 * e_size / X) */
#define DUK_HOBJECT_H_SIZE_DIVISOR \
  4 /* hash size approx. 1.25 times entries size */

/* if new_size < L * old_size, resize without abandon check; L = 3-bit fixed
 * point, e.g. 9 -> 9/8 = 112.5% */
#define DUK_HOBJECT_A_FAST_RESIZE_LIMIT \
  9 /* 112.5%, i.e. new size less than 12.5% higher -> fast resize */

/* if density < L, abandon array part, L = 3-bit fixed point, e.g. 2 -> 2/8 =
 * 25% */
/* limit is quite low: one array entry is 8 bytes, one normal entry is 4+1+8+4 =
 * 17 bytes (with hash entry) */
#define DUK_HOBJECT_A_ABANDON_LIMIT \
  2 /* 25%, i.e. less than 25% used -> abandon */
...
/* maximum length for a SKIP-1 diffstream: 35 bits per entry, rounded up to
 * bytes */
...
struct duk_hobject {
   ...
   *
   *    e_size * sizeof(duk_hstring *)         bytes of   entry keys (e_next gc
   * reachable) e_size * sizeof(duk_propvalue)         bytes of   entry values
   * (e_next gc reachable) e_size * sizeof(duk_uint8_t)           bytes of entry
   * flags (e_next gc reachable) a_size * sizeof(duk_tval)              bytes of
   * (opt) array values (plain only) (all gc reachable) h_size *
   * sizeof(duk_uint32_t)          bytes of   (opt) hash indexes to entries
   * (e_size), 0xffffffffUL = unused, 0xfffffffeUL = deleted
   *
   *  Layout 2 (DUK_USE_HOBJECT_LAYOUT_2):
   *
   *    e_size * sizeof(duk_propvalue)         bytes of   entry values (e_next
   * gc reachable) e_size * sizeof(duk_hstring *)         bytes of   entry keys
   * (e_next gc reachable) e_size * sizeof(duk_uint8_t) + pad     bytes of entry
   * flags (e_next gc reachable) a_size * sizeof(duk_tval)              bytes of
   * (opt) array values (plain only) (all gc reachable) h_size *
   * sizeof(duk_uint32_t)          bytes of   (opt) hash indexes to entries
   * (e_size), 0xffffffffUL = unused, 0xfffffffeUL = deleted
   ...
   *
   *    e_size * sizeof(duk_propvalue)         bytes of   entry values (e_next
   * gc reachable) a_size * sizeof(duk_tval)              bytes of   (opt) array
   * values (plain only) (all gc reachable) e_size * sizeof(duk_hstring *) bytes
   * of   entry keys (e_next gc reachable) h_size * sizeof(duk_uint32_t) bytes
   * of   (opt) hash indexes to entries (e_size), 0xffffffffUL = unused,
   * 0xfffffffeUL = deleted e_size * sizeof(duk_uint8_t)           bytes of
   * entry flags (e_next gc reachable)
   *
   ...
   *
   *  Objects with few keys don't have a hash index; keys are looked up
   * linearly, which is cache efficient because the keys are consecutive. Larger
   * objects have a hash index part which contains integer indexes to the
   * entries part.
   *
  ...
  /* prototype: the only internal property lifted outside 'e' as it is so
   * central */
#if defined(DUK_USE_HEAPPTR16)
  ...
  duk_uint32_t
      e_next; /* index for next new key ([0,e_next[ are gc reachable) */
...
#endif
DUK_INTERNAL_DECL duk_hcompiledfunction *duk_hcompiledfunction_alloc(
    duk_heap *heap, duk_uint_t hobject_flags);
DUK_INTERNAL_DECL duk_hnativefunction *duk_hnativefunction_alloc(
    duk_heap *heap, duk_uint_t hobject_flags);
DUK_INTERNAL duk_hbufferobject *duk_hbufferobject_alloc(
    duk_heap *heap, duk_uint_t hobject_flags);
...
DUK_INTERNAL_DECL duk_tval *duk_hobject_find_existing_entry_tval_ptr(
    duk_heap *heap, duk_hobject *obj, duk_hstring *key);
DUK_INTERNAL_DECL duk_tval *duk_hobject_find_existing_entry_tval_ptr_and_attrs(
    duk_heap *heap, duk_hobject *obj, duk_hstring *key, duk_int_t *out_attrs);
DUK_INTERNAL_DECL duk_tval *duk_hobject_find_existing_array_entry_tval_ptr(
    duk_heap *heap, duk_hobject *obj, duk_uarridx_t i);
DUK_INTERNAL_DECL duk_bool_t duk_hobject_get_own_propdesc(
    duk_hthread *thr, duk_hobject *obj, duk_hstring *key,
    duk_propdesc *out_desc, duk_small_uint_t flags);
...
#define duk_hobject_get_internal_value_tval_ptr(heap, obj) \
  duk_hobject_find_existing_entry_tval_ptr((heap), (obj),  \
...
DUK_INTERNAL_DECL duk_bool_t duk_hobject_hasprop_raw(duk_hthread *thr,
                                                     duk_hobject *obj,
                                                     duk_hstring *key);
DUK_INTERNAL_DECL void duk_hobject_define_property_internal(
    duk_hthread *thr, duk_hobject *obj, duk_hstring *key,
    duk_small_uint_t flags);
DUK_INTERNAL_DECL void duk_hobject_define_property_internal_arridx(
    duk_hthread *thr, duk_hobject *obj, duk_uarridx_t arr_idx,
    duk_small_uint_t flags);
DUK_INTERNAL_DECL void duk_hobject_define_accessor_internal(
    duk_hthread *thr, duk_hobject *obj, duk_hstring *key, duk_hobject *getter,
    duk_hobject *setter, duk_small_uint_t propflags);
DUK_INTERNAL_DECL void duk_hobject_set_length(
    duk_hthread *thr, duk_hobject *obj,
    duk_uint32_t length); /* XXX: duk_uarridx_t? */
DUK_INTERNAL_DECL void duk_hobject_set_length_zero(duk_hthread *thr,
                                                   duk_hobject *obj);
DUK_INTERNAL_DECL duk_uint32_t duk_hobject_get_length(
    duk_hthread *thr, duk_hobject *obj); /* XXX: duk_uarridx_t? */

/* helpers for defineProperty() and defineProperties() */
DUK_INTERNAL_DECL
void duk_hobject_prepare_property_descriptor(duk_context *ctx, duk_idx_t idx_in,
...
void duk_hobject_define_property_helper(duk_context *ctx,
                                        ...
                                        duk_hobject *obj, duk_hstring *key,
                                        duk_idx_t idx_value, duk_hobject *get,
                                        duk_hobject *set);

/* Object built-in methods */
DUK_INTERNAL_DECL duk_ret_t
duk_hobject_object_get_own_property_descriptor(duk_context *ctx);
DUK_INTERNAL_DECL void duk_hobject_object_seal_freeze_helper(
    duk_hthread *thr, duk_hobject *obj, duk_bool_t is_freeze);
DUK_INTERNAL_DECL duk_bool_t duk_hobject_object_is_sealed_frozen_helper(
    duk_hthread *thr, duk_hobject *obj, duk_bool_t is_frozen);
DUK_INTERNAL_DECL duk_bool_t duk_hobject_object_ownprop_helper(
    duk_context *ctx, duk_small_uint_t required_desc_flags);

/* internal properties */
DUK_INTERNAL_DECL duk_bool_t duk_hobject_get_internal_value(duk_heap *heap,
                                                            duk_hobject *obj,
                                                            duk_tval *tv);
DUK_INTERNAL_DECL duk_hstring *duk_hobject_get_internal_value_string(
    duk_heap *heap, duk_hobject *obj);
...
DUK_INTERNAL_DECL duk_hobject *duk_hobject_resolve_proxy_target(
    duk_hthread *thr, duk_hobject *obj);
#endif

/* enumeration */
DUK_INTERNAL_DECL void duk_hobject_enumerator_create(
    duk_context *ctx, duk_small_uint_t enum_flags);
DUK_INTERNAL_DECL duk_ret_t
duk_hobject_get_enumerated_keys(duk_context *ctx, duk_small_uint_t enum_flags);
...
DUK_INTERNAL_DECL duk_uint_fast32_t duk_hobject_pc2line_query(
    duk_context *ctx, duk_idx_t idx_func, duk_uint_fast32_t pc);
#endif

/* misc */
DUK_INTERNAL_DECL duk_bool_t duk_hobject_prototype_chain_contains(
    duk_hthread *thr, duk_hobject *h, duk_hobject *p, duk_bool_t ignore_loop);
