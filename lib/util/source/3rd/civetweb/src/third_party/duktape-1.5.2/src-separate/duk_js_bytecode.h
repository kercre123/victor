...
#define DUK_ENC_OP_ABC(op, abc) \
  ((duk_instr_t)((((duk_instr_t)(abc)) << 6) | ((duk_instr_t)(op))))
#define DUK_ENC_OP_A_BC(op, a, bc)                                         \
  ((duk_instr_t)((((duk_instr_t)(bc)) << 14) | (((duk_instr_t)(a)) << 6) | \
                 ((duk_instr_t)(op))))
#define DUK_ENC_OP_A_B_C(op, a, b, c)                                      \
  ((duk_instr_t)((((duk_instr_t)(c)) << 23) | (((duk_instr_t)(b)) << 14) | \
                 (((duk_instr_t)(a)) << 6) | ((duk_instr_t)(op))))
...
#define DUK_BC_DECLVAR_FLAG_UNDEF_VALUE \
  (1 << 4) /* use 'undefined' for value automatically */
