...
#define DUK_HSTRING_FLAG_INTERNAL \
  DUK_HEAPHDR_USER_FLAG(2) /* string is internal */
#define DUK_HSTRING_FLAG_RESERVED_WORD \
  DUK_HEAPHDR_USER_FLAG(3) /* string is a reserved word (non-strict) */
#define DUK_HSTRING_FLAG_STRICT_RESERVED_WORD \
  DUK_HEAPHDR_USER_FLAG(4) /* string is a reserved word (strict) */
#define DUK_HSTRING_FLAG_EVAL_OR_ARGUMENTS \
  DUK_HEAPHDR_USER_FLAG(5) /* string is 'eval' or 'arguments' */
#define DUK_HSTRING_FLAG_EXTDATA                                             \
  DUK_HEAPHDR_USER_FLAG(6) /* string data is external (duk_hstring_external) \
                            */
