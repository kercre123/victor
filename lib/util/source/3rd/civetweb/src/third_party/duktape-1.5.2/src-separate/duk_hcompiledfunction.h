...
#define DUK_HCOMPILEDFUNCTION_GET_CODE_END(heap, h)                           \
  ((duk_instr_t *)(void *)(DUK_HBUFFER_FIXED_GET_DATA_PTR(                    \
                           ...
                           DUK_HBUFFER_GET_SIZE(                              \
                               (duk_hbuffer *)DUK_HCOMPILEDFUNCTION_GET_DATA( \
                                   (heap), h))))

#define DUK_HCOMPILEDFUNCTION_GET_CONSTS_SIZE(heap, h)                       \
  ((duk_size_t)(((const duk_uint8_t *)DUK_HCOMPILEDFUNCTION_GET_CONSTS_END(  \
                    (heap), (h))) -                                          \
                ((const duk_uint8_t *)DUK_HCOMPILEDFUNCTION_GET_CONSTS_BASE( \
                    (heap), (h)))))

#define DUK_HCOMPILEDFUNCTION_GET_FUNCS_SIZE(heap, h)                       \
  ((duk_size_t)(((const duk_uint8_t *)DUK_HCOMPILEDFUNCTION_GET_FUNCS_END(  \
                    (heap), (h))) -                                         \
                ((const duk_uint8_t *)DUK_HCOMPILEDFUNCTION_GET_FUNCS_BASE( \
                    (heap), (h)))))

#define DUK_HCOMPILEDFUNCTION_GET_CODE_SIZE(heap, h)                           \
  ((duk_size_t)(                                                               \
      ((const duk_uint8_t *)DUK_HCOMPILEDFUNCTION_GET_CODE_END((heap), (h))) - \
      ((const duk_uint8_t *)DUK_HCOMPILEDFUNCTION_GET_CODE_BASE((heap),        \
                                                                (h)))))
