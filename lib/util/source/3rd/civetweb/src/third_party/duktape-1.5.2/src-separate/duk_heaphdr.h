...
#define DUK_HEAPHDR_PREINC_REFCOUNT(h) \
  (++(h)->h_refcount16) /* result: updated refcount */
...
#define DUK_TVAL_SET_FASTINT_UPDREF_ALT0(thr, tvptr_dst, newval) \
  do {                                                           \
    duk_tval *tv__dst;                                           \
    duk_tval tv__tmp;                                            \
    tv__dst = (tvptr_dst);                                       \
...
#define DUK_TVAL_SET_FASTINT_I32_UPDREF_ALT0(thr, tvptr_dst, newval) \
  do {                                                               \
    duk_tval *tv__dst;                                               \
    duk_tval tv__tmp;                                                \
    tv__dst = (tvptr_dst);                                           \
...
#define DUK_TVAL_SET_FASTINT_U32_UPDREF_ALT0(thr, tvptr_dst, newval) \
  do {                                                               \
    duk_tval *tv__dst;                                               \
    duk_tval tv__tmp;                                                \
    tv__dst = (tvptr_dst);                                           \
