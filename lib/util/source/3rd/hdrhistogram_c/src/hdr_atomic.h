...
static int64_t __inline hdr_atomic_exchange_64(volatile int64_t* field,
                                               int64_t initial) {
  return _InterlockedExchange64(field, initial);
}

static int64_t __inline hdr_atomic_add_fetch_64(volatile int64_t* field,
                                                int64_t value) {
...
#define hdr_atomic_add_fetch_64(field, value) \
  __atomic_add_fetch(field, value, __ATOMIC_SEQ_CST)
...
static inline int64_t hdr_atomic_exchange_64(volatile int64_t* field,
                                             int64_t value) {
  int64_t result = 0;
...
static inline int64_t hdr_atomic_add_fetch_64(volatile int64_t* field,
                                              int64_t value) {
