...
bool PtreeTraverser::done() const { return sVals_.empty(); }
...
const ptree& PtreeTraverser::topTree() const { return sVals_.top(); }

const PtreeKey& PtreeTraverser::topKey() const { return sKeys_.top(); }
