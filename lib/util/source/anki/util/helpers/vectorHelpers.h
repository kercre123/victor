...
// Instead of moving all following items down it just swaps the items with the
// end. This is faster, but shouldn't be used if the order of items is important
template <typename T>
...
// remove_swap_item - remove all items in container that match inElement, uses
// remove_swap so: Instead of moving all following items down it just swaps the
// items with the end. This is faster, but shouldn't be used if the order of
// items is important
template <typename T>
