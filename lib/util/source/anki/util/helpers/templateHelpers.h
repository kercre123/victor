...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - - SafeDelete: deletes and sets pointer
// to null
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
...
inline void SafeDeleteArray(T*& pointerRef) {
  delete[] pointerRef;  // c++ does not require checking that !=0 (delete 0 is
                        // ok)
  pointerRef = nullptr;
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - - EnumHasher: allows using enums and
// enum classes in containers that require std::hash, such as unordered_map
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - - EnumToUnderlying: automatically cast
// to the underlying type of an enum class
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -

template <typename EnumClass>
constexpr auto EnumToUnderlying(EnumClass e) ->
    typename std::underlying_type<EnumClass>::type {
  return static_cast<typename std::underlying_type<EnumClass>::type>(e);
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - - is_explicitly_constructible: has
// ::value == true if T{U} names an explicit constructor
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
...
struct is_explicitly_constructible
    : bool_constant<std::is_constructible<T, U>::value &&
                    !std::is_convertible<U, T>::value> {};

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - - A struct containing one of two types
// based on the bool template param
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
