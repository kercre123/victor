...
#define DECL_ENUM_ELEMENT_VAL_STR(element, value, descr) \
  DECL_ENUM_ELEMENT_STR(element, descr)
...
#define BEGIN_ENUM(ENUM_NAME)                                     \
  struct enum_translator_##ENUM_NAME {                            \
...
#define BEGIN_ENUM(ENUM_NAME) \
  void enum_translator_##ENUM_NAME::set_value_internal(const std::string& str)
...
#define DECL_ENUM_ELEMENT_VAL(element, value) \
  DECL_ENUM_ELEMENT_STR(element, element)
#define DECL_ENUM_ELEMENT_VAL_STR(element, value, descr) \
  DECL_ENUM_ELEMENT_STR(element, descr)

#define END_ENUM(ENUM_NAME)                                            \
  boost::optional<ENUM_NAME> enum_translator_##ENUM_NAME::get_value(   \
      const std::string& str) {                                        \
    set_value_internal(str);                                           \
    if (_found)                                                        \
      return boost::optional<ENUM_NAME>(_ret);                         \
    else                                                               \
      return boost::optional<ENUM_NAME>(boost::none);                  \
  }                                                                    \
  boost::optional<std::string> enum_translator_##ENUM_NAME::put_value( \
      const ENUM_NAME& enm) {                                          \
...
#define DECL_ENUM_ELEMENT_VAL_STR(element, value, descr) \
  DECL_ENUM_ELEMENT_VAL(element, value)
