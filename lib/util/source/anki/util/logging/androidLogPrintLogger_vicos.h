...
class AndroidLogPrintLogger : public ILoggerProvider {
 public:
  ...
  // virtual void Log(ILoggerProvider::LogLevel logLevel, const std::string&
  // message) override;

 private:
  std::string _tag;

  void Log(LogLevel level, const char *eventName,
           const std::vector<std::pair<const char *, const char *>> &keyValues,
           const char *eventValue);

  void Log(LogLevel level, const char *channel, const char *eventName,
           const std::vector<std::pair<const char *, const char *>> &keyValues,
           const char *eventValue);
