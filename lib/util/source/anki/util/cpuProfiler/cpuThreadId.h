 ...
 * Created: 07/30/16
 *
 * Description: Support for ThreadId (mostly just a wrapper around underlying
 *support from thread libraries)
 *
...
inline CpuThreadId GetCurrentThreadId() { return std::this_thread::get_id(); }
