...
RepeatCondition::RepeatCondition(const std::string& ruleId,
                                 const double secondsSinceLast)
    : _ruleId(ruleId), _secondsSinceLast(secondsSinceLast) {}

bool RepeatCondition::IsSatisfied(QuestEngine& questEngine,
