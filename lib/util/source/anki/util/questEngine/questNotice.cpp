...
QuestNotice::QuestNotice(const bool force, const uint8_t priority,
                         const time_t noticeTime, const std::string& guid,
                         const std::string& target, const std::string& titleKey,
...
bool QuestNotice::operator()(const QuestNotice& lhs,
                             const QuestNotice& rhs) const {
  return lhs < rhs;
}
