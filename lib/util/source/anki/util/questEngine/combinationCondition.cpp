...
CombinationCondition::CombinationCondition(
    CombinationConditionOperation operation, AbstractCondition* conditionA,
    AbstractCondition* conditionB)
    : AbstractCondition(),
