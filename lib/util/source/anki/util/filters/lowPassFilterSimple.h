...
class LowPassFilterSimple {
 public:
  ...
  //                           Using a smaller time constant will cause the
  //                           filtered value to track more closely to the raw
  //                           input (less 'smoothing'). A longer time constant
  //                           will result in more 'smoothing'.
