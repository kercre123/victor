...
#define CONSOLE_VAR_EXTERN(type, name) extern type name;
...
#define CONSOLE_VAR_RANGED(type, name, path, default, minVal, maxVal)        \
  type name = default;                                                       \
  namespace {                                                                \
  static Anki::Util::ConsoleVar<type> cvar_##name(name, #name, path, minVal, \
                                                  maxVal, false);            \
  }
...
#define CONSOLE_VAR_ENUM(type, name, path, default, values)                  \
  type name = default;                                                       \
  namespace {                                                                \
  static Anki::Util::ConsoleVar<type> cvar_##name(name, #name, path, values, \
                                                  false);                    \
  }
...
#define CONSOLE_VAR_EXTERN(type, name) extern const type name;

#define CONSOLE_VAR(type, name, path, default) extern const type name = default;
...
#define CONSOLE_VAR(type, name, default) type name = default;
...
#define CONSOLE_VAR(type, name, default) extern const type name = default;
