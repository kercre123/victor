...
class Histogram {
 public:
  ...
  // Significant_figures describes the level of precision for this histogram,
  // i.e. the number of figures in a decimal number that will be maintained.
  // E.g. a value of 3 will mean the results from the histogram will be accurate
  // up to the first three digits.
  //
  ...
  // Return false if the value is larger than highest trackable value and can't
  // be recorded, else true.
