...
// @return Experiment exists in lab definition with the specified
// `experimentKey`.
...
// @return ExperimentVariation with the specified `variationKey` in
// `experiment`.
...
// Determine whether `userHashBucket` value falls into experimental bucket
// range.
