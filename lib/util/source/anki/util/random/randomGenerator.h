...
class RandomGenerator {
 public:
  ...
  // Return a random floating point number in the range [0,maxVal).  This is
  // much better than any sort of mod-based rand because that only focuses on
  // the lower bits which are not as random as the higher bits.
