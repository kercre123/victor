 ...
 * Created: 02/16/15
 *
 * Description: Simple class for dynamically allocating and copying arbitrary
 *data from network packets for queuing etc. before copying back out again
 *later.
 *
...
class PacketByteArray {
 public:
  ...
  // Move Constructors and Move Assignment - marked noexcept so that std::vector
  // will use them on resize
