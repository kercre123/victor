...
SizedSrcBuffer::SizedSrcBuffer() : _buffer(nullptr), _bufferSize(0) {
#if SIZED_SRC_BUFFER_STORE_DESCRIPTOR
  _descriptor[0] = 0;
#endif
}

SizedSrcBuffer::SizedSrcBuffer(const uint8_t* inbuffer, uint32_t inbufferSize,
...
SrcBufferSet::SrcBufferSet() : _bufferCount(0) {}
