...
TEST(StringHelpers, StringCompare_stricmp) {
  ...
  // NOTE: strcmp implementations vary between returning -1,0,1 or -diff,0,diff
  // so cannot compare result directly
  //      we just want to ensure that they are -ve,0,+ve at the same times
  EXPECT_EQ(
      ToMin1Plus1Range(Anki::Util::stricmp(testString1lower, testString2lower)),
      ToMin1Plus1Range(strcmp(testString1lower, testString2lower)));
  EXPECT_EQ(
      ToMin1Plus1Range(Anki::Util::stricmp(testString2lower, testString1lower)),
      ToMin1Plus1Range(strcmp(testString2lower, testString1lower)));
  EXPECT_EQ(
      ToMin1Plus1Range(Anki::Util::stricmp(testString2lower, testString3lower)),
      ToMin1Plus1Range(strcmp(testString2lower, testString3lower)));
  EXPECT_EQ(
      ToMin1Plus1Range(Anki::Util::stricmp(testString3lower, testString2lower)),
      ToMin1Plus1Range(strcmp(testString3lower, testString2lower)));
  EXPECT_EQ(
      ToMin1Plus1Range(Anki::Util::stricmp(testString1lower, testString3lower)),
      ToMin1Plus1Range(strcmp(testString1lower, testString3lower)));
  EXPECT_EQ(
      ToMin1Plus1Range(Anki::Util::stricmp(testString3lower, testString1lower)),
      ToMin1Plus1Range(strcmp(testString3lower, testString1lower)));
}
