...
TEST(TestMath, TestClampedAdditionU16) {
  ...
  EXPECT_EQ(Anki::Util::ClampedAddition(uint16_t(32767), uint16_t(32767)),
            65534);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint16_t(32767), uint16_t(32768)),
            65535);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint16_t(32768), uint16_t(32768)),
            65535);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint16_t(32769), uint16_t(32769)),
            65535);
  ...
  EXPECT_EQ(Anki::Util::ClampedAddition(uint16_t(44444), uint16_t(44444)),
            65535);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint16_t(65535), uint16_t(65535)),
            65535);
}
...
TEST(TestMath, TestClampedAdditionU32) {
  ...
  EXPECT_EQ(
      Anki::Util::ClampedAddition(uint32_t(2147483647u), uint32_t(2147483647u)),
      4294967294u);
  EXPECT_EQ(
      Anki::Util::ClampedAddition(uint32_t(2147483647u), uint32_t(2147483648u)),
      4294967295u);
  EXPECT_EQ(
      Anki::Util::ClampedAddition(uint32_t(2147483648u), uint32_t(2147483648u)),
      4294967295u);
  EXPECT_EQ(
      Anki::Util::ClampedAddition(uint32_t(2147483649u), uint32_t(2147483649u)),
      4294967295u);

  EXPECT_EQ(Anki::Util::ClampedAddition(uint32_t(4294967293u), uint32_t(1u)),
            4294967294u);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint32_t(4294967293u), uint32_t(2u)),
            4294967295u);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint32_t(4294967293u), uint32_t(3u)),
            4294967295u);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint32_t(4294967293u), uint32_t(4u)),
            4294967295u);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint32_t(1u), uint32_t(4294967293u)),
            4294967294u);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint32_t(2u), uint32_t(4294967293u)),
            4294967295u);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint32_t(3u), uint32_t(4294967293u)),
            4294967295u);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint32_t(4u), uint32_t(4294967293u)),
            4294967295u);

  EXPECT_EQ(
      Anki::Util::ClampedAddition(uint32_t(3333333333u), uint32_t(3333333333u)),
      4294967295u);
  EXPECT_EQ(
      Anki::Util::ClampedAddition(uint32_t(4294967295u), uint32_t(4294967295u)),
      4294967295u);
}
...
TEST(TestMath, TestClampedAdditionU64) {
  ...
  EXPECT_EQ(Anki::Util::ClampedAddition(uint64_t(9223372036854775807ull),
                                        uint64_t(9223372036854775807ull)),
            18446744073709551614ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint64_t(9223372036854775807ull),
                                        uint64_t(9223372036854775808ull)),
            18446744073709551615ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint64_t(9223372036854775808ull),
                                        uint64_t(9223372036854775808ull)),
            18446744073709551615ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint64_t(9223372036854775809ull),
                                        uint64_t(9223372036854775809ull)),
            18446744073709551615ull);

  EXPECT_EQ(Anki::Util::ClampedAddition(uint64_t(18446744073709551613ull),
                                        uint64_t(1ull)),
            18446744073709551614ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint64_t(18446744073709551613ull),
                                        uint64_t(2ull)),
  ...
  EXPECT_EQ(Anki::Util::ClampedAddition(uint64_t(18446744073709551613ull),
                                        uint64_t(3ull)),
            18446744073709551615ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint64_t(1ull),
                                        uint64_t(18446744073709551613ull)),
            18446744073709551614ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint64_t(2ull),
                                        uint64_t(18446744073709551613ull)),
            18446744073709551615ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint64_t(3ull),
                                        uint64_t(18446744073709551613ull)),
            18446744073709551615ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint64_t(4ull),
                                        uint64_t(18446744073709551613ull)),
            18446744073709551615ull);

  EXPECT_EQ(Anki::Util::ClampedAddition(uint64_t(11111111111111111111ull),
                                        uint64_t(11111111111111111111ull)),
            18446744073709551615ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(uint64_t(18446744073709551615ull),
...
TEST(TestMath, TestClampedAdditionI8) {
  ...
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-127), ValueType(-127)),
            -128);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-128), ValueType(-128)),
            -128);
}
...
TEST(TestMath, TestClampedAdditionI16) {
  ...
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(16383), ValueType(16383)),
            32766);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(16383), ValueType(16384)),
            32767);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(16384), ValueType(16383)),
            32767);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(16384), ValueType(16384)),
            32767);
  ...
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(32767), ValueType(32767)),
            32767);
  ...
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-16384), ValueType(-16384)),
            -32768);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-16384), ValueType(-16385)),
            -32768);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-16385), ValueType(-16384)),
            -32768);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-16385), ValueType(-16385)),
            -32768);

  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-32765), ValueType(-1)),
            -32766);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-32765), ValueType(-2)),
            -32767);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-32765), ValueType(-3)),
            -32768);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-32765), ValueType(-4)),
            -32768);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-1), ValueType(-32765)),
            -32766);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-2), ValueType(-32765)),
            -32767);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-3), ValueType(-32765)),
            -32768);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-4), ValueType(-32765)),
            -32768);

  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-32767), ValueType(-32767)),
            -32768);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-32768), ValueType(-32768)),
            -32768);
}
...
TEST(TestMath, TestClampedAdditionI32) {
  ...
  EXPECT_EQ(
      Anki::Util::ClampedAddition(ValueType(1073741823), ValueType(1073741823)),
      2147483646);
  EXPECT_EQ(
      Anki::Util::ClampedAddition(ValueType(1073741823), ValueType(1073741824)),
      2147483647);
  EXPECT_EQ(
      Anki::Util::ClampedAddition(ValueType(1073741824), ValueType(1073741823)),
      2147483647);
  EXPECT_EQ(
      Anki::Util::ClampedAddition(ValueType(1073741824), ValueType(1073741824)),
      2147483647);

  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(2147483645), ValueType(1)),
            2147483646);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(2147483645), ValueType(2)),
            2147483647);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(2147483645), ValueType(3)),
            2147483647);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(2147483645), ValueType(4)),
            2147483647);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(1), ValueType(2147483645)),
            2147483646);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(2), ValueType(2147483645)),
            2147483647);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(3), ValueType(2147483645)),
            2147483647);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(4), ValueType(2147483645)),
            2147483647);

  EXPECT_EQ(
      Anki::Util::ClampedAddition(ValueType(2147483647), ValueType(2147483647)),
      2147483647);

  // -ve

  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-1073741823),
                                        ValueType(-1073741823)),
            -2147483646);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-1073741823),
                                        ValueType(-1073741824)),
            -2147483647);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-1073741824),
                                        ValueType(-1073741823)),
            -2147483647);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-1073741824),
                                        ValueType(-1073741824)),
            -2147483648);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-1073741824),
                                        ValueType(-1073741825)),
            -2147483648);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-1073741825),
                                        ValueType(-1073741824)),
            -2147483648);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-1073741825),
                                        ValueType(-1073741825)),
  ...
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-2147483647),
                                        ValueType(-2147483647)),
            -2147483648);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-2147483648),
                                        ValueType(-2147483648)),
            -2147483648);
}
...
TEST(TestMath, TestClampedAdditionI64) {
  ...
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(0ull), ValueType(0ull)),
            0ull);

  // +ve

  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(4611686018427387903ull),
                                        ValueType(4611686018427387903ull)),
            9223372036854775806ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(4611686018427387903ull),
                                        ValueType(4611686018427387904ull)),
            9223372036854775807ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(4611686018427387904ull),
                                        ValueType(4611686018427387903ull)),
            9223372036854775807ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(4611686018427387904ull),
                                        ValueType(4611686018427387904ull)),
  ...
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(9223372036854775805ull),
                                        ValueType(1)),
            9223372036854775806ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(9223372036854775805ull),
                                        ValueType(2)),
  ...
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(9223372036854775805ull),
                                        ValueType(4)),
            9223372036854775807ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(1),
                                        ValueType(9223372036854775805ull)),
            9223372036854775806ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(2),
                                        ValueType(9223372036854775805ull)),
            9223372036854775807ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(3),
                                        ValueType(9223372036854775805ull)),
            9223372036854775807ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(4),
                                        ValueType(9223372036854775805ull)),
            9223372036854775807ull);

  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(9223372036854775807),
                                        ValueType(9223372036854775807)),
            9223372036854775807);
  ...
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-4611686018427387904ull),
                                        ValueType(-4611686018427387905ull)),
            -9223372036854775808ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-4611686018427387905ull),
                                        ValueType(-4611686018427387904ull)),
            -9223372036854775808ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-4611686018427387905ull),
                                        ValueType(-4611686018427387905ull)),
  ...
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-9223372036854775807ull),
                                        ValueType(-9223372036854775807ull)),
            -9223372036854775808ull);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-9223372036854775808ull),
                                        ValueType(-9223372036854775808ull)),
            -9223372036854775808ull);
}
...
TEST(TestMath, TestClampedAdditionFloat) {
  ...
  EXPECT_FLOAT_EQ(Anki::Util::ClampedAddition(ValueType(0.0f), ValueType(0.0f)),
                  0.0f);

  // Opposite Sign

  EXPECT_FLOAT_EQ(
      Anki::Util::ClampedAddition(ValueType(FLT_MAX), ValueType(-FLT_MAX)),
      0.0f);
  EXPECT_FLOAT_EQ(
      Anki::Util::ClampedAddition(ValueType(10.0f), ValueType(-3.0f)), 7.0f);
  EXPECT_FLOAT_EQ(
      Anki::Util::ClampedAddition(ValueType(-4.0f), ValueType(2.0f)), -2.0f);

  // Same Sign no overflow

  EXPECT_FLOAT_EQ(Anki::Util::ClampedAddition(ValueType(1.0f), ValueType(1.0f)),
                  2.0f);
  EXPECT_FLOAT_EQ(
      Anki::Util::ClampedAddition(ValueType(-1.0f), ValueType(-1.0f)), -2.0f);

  EXPECT_FLOAT_EQ(Anki::Util::ClampedAddition(ValueType(2e38), ValueType(1e38)),
                  3e38);
  EXPECT_FLOAT_EQ(
      Anki::Util::ClampedAddition(ValueType(-2e38), ValueType(-1e38)), -3e38);

  // Same Sign clamped

  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(3e38), ValueType(1e38)),
            FLT_MAX);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(FLT_MAX), ValueType(FLT_MAX)),
            FLT_MAX);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-3e38), ValueType(-1e38)),
            -FLT_MAX);
  EXPECT_EQ(
...
TEST(TestMath, TestClampedAdditionDouble) {
  ...
  EXPECT_DOUBLE_EQ(Anki::Util::ClampedAddition(ValueType(0.0), ValueType(0.0)),
                   0.0);
  ...
  EXPECT_DOUBLE_EQ(
      ...
      0.0);
  EXPECT_DOUBLE_EQ(
      Anki::Util::ClampedAddition(ValueType(DBL_MAX), ValueType(-DBL_MAX)),
      0.0);
  EXPECT_DOUBLE_EQ(
      Anki::Util::ClampedAddition(ValueType(10.0), ValueType(-3.0)), 7.0);
  EXPECT_DOUBLE_EQ(Anki::Util::ClampedAddition(ValueType(-4.0), ValueType(2.0)),
                   -2.0);

  // Same Sign no overflow

  EXPECT_DOUBLE_EQ(Anki::Util::ClampedAddition(ValueType(1.0), ValueType(1.0)),
                   2.0);
  EXPECT_DOUBLE_EQ(
      Anki::Util::ClampedAddition(ValueType(-1.0), ValueType(-1.0)), -2.0);
  ...
  EXPECT_DOUBLE_EQ(
      Anki::Util::ClampedAddition(ValueType(1e308), ValueType(0.5e308)),
      1.5e+308);
  EXPECT_DOUBLE_EQ(
      Anki::Util::ClampedAddition(ValueType(-1e308), ValueType(-0.5e308)),
      -1.5e+308);
  ...
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(1e308), ValueType(1e308)),
            DBL_MAX);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(DBL_MAX), ValueType(DBL_MAX)),
            DBL_MAX);
  EXPECT_EQ(Anki::Util::ClampedAddition(ValueType(-1e308), ValueType(-1e308)),
            -DBL_MAX);
  EXPECT_EQ(
