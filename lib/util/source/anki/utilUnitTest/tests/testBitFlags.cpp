...
void TestBitFlagsForType(const std::vector<ET>& eFlagsToSet,
  ...
  for (int i = 0; i < kMaxBits; ++i) {
    ...
    const bool shouldBeSet = std::find(expectedTrue.begin(), expectedTrue.end(),
                                       i) != expectedTrue.end();
...
TEST(TestBitFlags, TestBitFlagsU8) {
  ...
  std::vector<ETestBitFlagEnumClassI8> eI8FlagsToSet = {
      ETestBitFlagEnumClassI8::e0, ETestBitFlagEnumClassI8::e3,
      ETestBitFlagEnumClassI8::e6, ETestBitFlagEnumClassI8::e7};
  std::vector<ETestBitFlagEnumClassI8> eI8FlagsToUnset = {
      ETestBitFlagEnumClassI8::e6};

  std::vector<ETestBitFlagEnumClassU64> eU64FlagsToSet = {
      ETestBitFlagEnumClassU64::e0, ETestBitFlagEnumClassU64::e3,
      ETestBitFlagEnumClassU64::e6, ETestBitFlagEnumClassU64::e7};
  std::vector<ETestBitFlagEnumClassU64> eU64FlagsToUnset = {
      ETestBitFlagEnumClassU64::e6};
  ...
  TestBitFlagsForType<uint8_t, ETestBitFlagEnum>(eFlagsToSet, eFlagsToUnset,
                                                 expectedTrue);
  TestBitFlagsForType<uint8_t, ETestBitFlagEnumClassI8>(
      eI8FlagsToSet, eI8FlagsToUnset, expectedTrue);
  TestBitFlagsForType<uint8_t, ETestBitFlagEnumClassU64>(
      eU64FlagsToSet, eU64FlagsToUnset, expectedTrue);
...
TEST(TestBitFlags, TestBitFlagsU16) {
  ...
  std::vector<ETestBitFlagEnumClassI8> eI8FlagsToSet = {
      ETestBitFlagEnumClassI8::e1, ETestBitFlagEnumClassI8::e3,
      ETestBitFlagEnumClassI8::e8, ETestBitFlagEnumClassI8::e13,
      ETestBitFlagEnumClassI8::e15};
  std::vector<ETestBitFlagEnumClassI8> eI8FlagsToUnset = {
      ETestBitFlagEnumClassI8::e13};

  std::vector<ETestBitFlagEnumClassU64> eU64FlagsToSet = {
      ETestBitFlagEnumClassU64::e1, ETestBitFlagEnumClassU64::e3,
      ETestBitFlagEnumClassU64::e8, ETestBitFlagEnumClassU64::e13,
      ETestBitFlagEnumClassU64::e15};
  std::vector<ETestBitFlagEnumClassU64> eU64FlagsToUnset = {
      ETestBitFlagEnumClassU64::e13};
  ...
  TestBitFlagsForType<uint16_t, ETestBitFlagEnum>(eFlagsToSet, eFlagsToUnset,
                                                  expectedTrue);
  TestBitFlagsForType<uint16_t, ETestBitFlagEnumClassI8>(
      eI8FlagsToSet, eI8FlagsToUnset, expectedTrue);
  TestBitFlagsForType<uint16_t, ETestBitFlagEnumClassU64>(
      eU64FlagsToSet, eU64FlagsToUnset, expectedTrue);
...
TEST(TestBitFlags, TestBitFlagsU32) {
  std::vector<ETestBitFlagEnum> eFlagsToSet = {eTF1,  eTF4,  eTF10,
                                               eTF15, eTF25, eTF31};
  std::vector<ETestBitFlagEnum> eFlagsToUnset = {eTF4};

  std::vector<ETestBitFlagEnumClassI8> eI8FlagsToSet = {
      ETestBitFlagEnumClassI8::e1,  ETestBitFlagEnumClassI8::e4,
      ETestBitFlagEnumClassI8::e10, ETestBitFlagEnumClassI8::e15,
      ETestBitFlagEnumClassI8::e25, ETestBitFlagEnumClassI8::e31};
  std::vector<ETestBitFlagEnumClassI8> eI8FlagsToUnset = {
      ETestBitFlagEnumClassI8::e4};

  std::vector<ETestBitFlagEnumClassU64> eU64FlagsToSet = {
      ETestBitFlagEnumClassU64::e1,  ETestBitFlagEnumClassU64::e4,
      ETestBitFlagEnumClassU64::e10, ETestBitFlagEnumClassU64::e15,
      ETestBitFlagEnumClassU64::e25, ETestBitFlagEnumClassU64::e31};
  std::vector<ETestBitFlagEnumClassU64> eU64FlagsToUnset = {
      ETestBitFlagEnumClassU64::e4};
  ...
  TestBitFlagsForType<uint32_t, ETestBitFlagEnum>(eFlagsToSet, eFlagsToUnset,
                                                  expectedTrue);
  TestBitFlagsForType<uint32_t, ETestBitFlagEnumClassI8>(
      eI8FlagsToSet, eI8FlagsToUnset, expectedTrue);
  TestBitFlagsForType<uint32_t, ETestBitFlagEnumClassU64>(
      eU64FlagsToSet, eU64FlagsToUnset, expectedTrue);
...
TEST(TestBitFlags, TestBitFlagsU64) {
  std::vector<ETestBitFlagEnum> eFlagsToSet = {eTF3,  eTF7,  eTF12, eTF17,
                                               eTF26, eTF33, eTF52, eTF63};
  std::vector<ETestBitFlagEnum> eFlagsToUnset = {eTF3, eTF26};

  std::vector<ETestBitFlagEnumClassI8> eI8FlagsToSet = {
      ETestBitFlagEnumClassI8::e3,  ETestBitFlagEnumClassI8::e7,
      ETestBitFlagEnumClassI8::e12, ETestBitFlagEnumClassI8::e17,
      ETestBitFlagEnumClassI8::e26, ETestBitFlagEnumClassI8::e33,
      ETestBitFlagEnumClassI8::e52, ETestBitFlagEnumClassI8::e63};
  std::vector<ETestBitFlagEnumClassI8> eI8FlagsToUnset = {
      ETestBitFlagEnumClassI8::e3, ETestBitFlagEnumClassI8::e26};

  std::vector<ETestBitFlagEnumClassU64> eU64FlagsToSet = {
      ETestBitFlagEnumClassU64::e3,  ETestBitFlagEnumClassU64::e7,
      ETestBitFlagEnumClassU64::e12, ETestBitFlagEnumClassU64::e17,
      ETestBitFlagEnumClassU64::e26, ETestBitFlagEnumClassU64::e33,
      ETestBitFlagEnumClassU64::e52, ETestBitFlagEnumClassU64::e63};
  std::vector<ETestBitFlagEnumClassU64> eU64FlagsToUnset = {
      ETestBitFlagEnumClassU64::e3, ETestBitFlagEnumClassU64::e26};
  ...
  TestBitFlagsForType<uint64_t, ETestBitFlagEnum>(eFlagsToSet, eFlagsToUnset,
                                                  expectedTrue);
  TestBitFlagsForType<uint64_t, ETestBitFlagEnumClassI8>(
      eI8FlagsToSet, eI8FlagsToUnset, expectedTrue);
  TestBitFlagsForType<uint64_t, ETestBitFlagEnumClassU64>(
      eU64FlagsToSet, eU64FlagsToUnset, expectedTrue);
  TestBitFlagsForType<uint64_t, int>(iFlagsToSet, iFlagsToUnset, expectedTrue);

  // Verify that BitFlagStorage<> with N smaller types would work identically to
  // the larger builtin type
  using namespace Anki::Util;
  TestBitFlagsForType<BitFlagStorage<uint32_t, 2>, ETestBitFlagEnum>(
      eFlagsToSet, eFlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint32_t, 2>, ETestBitFlagEnumClassI8>(
      eI8FlagsToSet, eI8FlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint32_t, 2>, ETestBitFlagEnumClassU64>(
      eU64FlagsToSet, eU64FlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint32_t, 2>, int>(
      iFlagsToSet, iFlagsToUnset, expectedTrue);

  TestBitFlagsForType<BitFlagStorage<uint16_t, 4>, ETestBitFlagEnum>(
      eFlagsToSet, eFlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint16_t, 4>, ETestBitFlagEnumClassI8>(
      eI8FlagsToSet, eI8FlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint16_t, 4>, ETestBitFlagEnumClassU64>(
      eU64FlagsToSet, eU64FlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint16_t, 4>, int>(
      iFlagsToSet, iFlagsToUnset, expectedTrue);

  TestBitFlagsForType<BitFlagStorage<uint16_t, 8>, ETestBitFlagEnum>(
      eFlagsToSet, eFlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint16_t, 8>, ETestBitFlagEnumClassI8>(
      eI8FlagsToSet, eI8FlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint16_t, 8>, ETestBitFlagEnumClassU64>(
      eU64FlagsToSet, eU64FlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint16_t, 8>, int>(
      iFlagsToSet, iFlagsToUnset, expectedTrue);
}
...
TEST(TestBitFlags, TestBitFlagsU128) {
  ...
  std::vector<ETestBitFlagEnumClassI8> eI8FlagsToSet = {
      ...
      ETestBitFlagEnumClassI8::e26, ETestBitFlagEnumClassI8::e33,
      ETestBitFlagEnumClassI8::e52, ETestBitFlagEnumClassI8::e63,
      ETestBitFlagEnumClassI8::e64, ETestBitFlagEnumClassI8::e115,
      ETestBitFlagEnumClassI8::e127};
  std::vector<ETestBitFlagEnumClassI8> eI8FlagsToUnset = {
      ETestBitFlagEnumClassI8::e3, ETestBitFlagEnumClassI8::e26,
      ETestBitFlagEnumClassI8::e115};
  ...
  std::vector<ETestBitFlagEnumClassU64> eU64FlagsToSet = {
      ...
      ETestBitFlagEnumClassU64::e26, ETestBitFlagEnumClassU64::e33,
      ETestBitFlagEnumClassU64::e52, ETestBitFlagEnumClassU64::e63,
      ETestBitFlagEnumClassU64::e64, ETestBitFlagEnumClassU64::e115,
      ETestBitFlagEnumClassU64::e127};
  std::vector<ETestBitFlagEnumClassU64> eU64FlagsToUnset = {
      ETestBitFlagEnumClassU64::e3, ETestBitFlagEnumClassU64::e26,
      ETestBitFlagEnumClassU64::e115};
  ...
  using namespace Anki::Util;
  TestBitFlagsForType<BitFlagStorage<uint64_t, 2>, ETestBitFlagEnum>(
      eFlagsToSet, eFlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint32_t, 4>, ETestBitFlagEnum>(
      eFlagsToSet, eFlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint16_t, 8>, ETestBitFlagEnum>(
      eFlagsToSet, eFlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint8_t, 16>, ETestBitFlagEnum>(
      eFlagsToSet, eFlagsToUnset, expectedTrue);

  TestBitFlagsForType<BitFlagStorage<uint64_t, 2>, ETestBitFlagEnumClassI8>(
      eI8FlagsToSet, eI8FlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint32_t, 4>, ETestBitFlagEnumClassI8>(
      eI8FlagsToSet, eI8FlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint16_t, 8>, ETestBitFlagEnumClassI8>(
      eI8FlagsToSet, eI8FlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint8_t, 16>, ETestBitFlagEnumClassI8>(
      eI8FlagsToSet, eI8FlagsToUnset, expectedTrue);

  TestBitFlagsForType<BitFlagStorage<uint64_t, 2>, ETestBitFlagEnumClassU64>(
      eU64FlagsToSet, eU64FlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint32_t, 4>, ETestBitFlagEnumClassU64>(
      eU64FlagsToSet, eU64FlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint16_t, 8>, ETestBitFlagEnumClassU64>(
      eU64FlagsToSet, eU64FlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint8_t, 16>, ETestBitFlagEnumClassU64>(
      eU64FlagsToSet, eU64FlagsToUnset, expectedTrue);

  TestBitFlagsForType<BitFlagStorage<uint64_t, 2>, int>(
      iFlagsToSet, iFlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint32_t, 4>, int>(
      iFlagsToSet, iFlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint16_t, 8>, int>(
      iFlagsToSet, iFlagsToUnset, expectedTrue);
  TestBitFlagsForType<BitFlagStorage<uint8_t, 16>, int>(
      iFlagsToSet, iFlagsToUnset, expectedTrue);
}

// --gtest_filter=TestBitFlags.TestTypedefs
TEST(TestBitFlags, TestTypedefs) {
  // Verify that helper "using typedefs" (BitFlags8/16/32/64) work identically
  // to specifiying the entire type
