...
class QuestRuleBuilderTest : public FileHelper {
 public:
  ...
  static void SetUpTestCase() { Anki::Util::FileUtils::DeleteFile(StatFile()); }
...
TEST_F(QuestRuleBuilderTest, LoadDefinitions) {
  ...
  std::string jsonString(
      "{\"rules\":[{\"id\":\"test.load.definitions\",\"eventNames\":[\"game."
      "end\"],\"action\":{\"type\":\"Notice\",\"attributes\":{\"titleKey\":"
      "\"home.notice.title\",\"descriptionKey\":\"home.notice.description\"}},"
      "\"condition\":{\"type\":\"CountThreshold\",\"attributes\":{\"operator\":"
      "\"CountThresholdOperatorEquals\",\"targetValue\":5,\"triggerKey\":"
      "\"game.end\"}}}]}");
...
TEST_F(QuestRuleBuilderTest, DISABLED_RepeatCondition) {
  ...
  std::string jsonString(
      "{\"rules\":[{\"id\":\"test.repeat.condition\",\"eventNames\":[\"game."
      "end\"],\"action\":{\"type\":\"Notice\",\"attributes\":{\"titleKey\":"
      "\"home.notice.title\",\"descriptionKey\":\"home.notice.description\"}},"
      "\"condition\":{\"type\":\"Combination\",\"attributes\":{\"operation\":"
      "\"AND\",\"conditionA\":{\"type\":\"CountThreshold\",\"attributes\":{"
      "\"operator\":\"CountThresholdOperatorEquals\",\"targetValue\":3,"
      "\"triggerKey\":\"game.end\"}},\"conditionB\":{\"type\":\"Combination\","
      "\"attributes\":{\"operation\":\"NOT\",\"conditionA\":{\"type\":"
      "\"Repeat\",\"attributes\":{\"noticeKey\":\"home.notice.tires\","
  ...
  QuestNotice previousNotice(false, 0, tNow, "", "", "home.notice.title",
  ...
  // this should not add a notice, since the time between events is less than
  // the delta time in the repeat condition
  questEngine->IncrementEvent("game.end");
  const std::set<QuestNotice>& notices = questEngine->GetNotices();
  EXPECT_EQ(1, notices.size());
...
TEST_F(QuestRuleBuilderTest, ExpiredRepeatCondition) {
  ...
  std::string jsonString(
      "{\"rules\":[{\"id\":\"test.expired.repeat.condition\",\"eventNames\":["
      "\"game.end\"],\"action\":{\"type\":\"Notice\",\"attributes\":{"
      "\"titleKey\":\"home.notice.title\",\"descriptionKey\":\"home.notice."
      "description\"}},\"condition\":{\"type\":\"Combination\",\"attributes\":{"
      "\"operation\":\"AND\",\"conditionA\":{\"type\":\"CountThreshold\","
      "\"attributes\":{\"operator\":\"CountThresholdOperatorEquals\","
      "\"targetValue\":3,\"triggerKey\":\"game.end\"}},\"conditionB\":{"
      "\"type\":\"Combination\",\"attributes\":{\"operation\":\"NOT\","
      "\"conditionA\":{\"type\":\"Repeat\",\"attributes\":{\"noticeKey\":"
      "\"home.notice.tires\",\"secondsSinceLast\":86400}}}}}}}]}");
  Anki::Util::FileUtils::WriteFile(RulesFile(), jsonString);
  ...
  // this should add a notice, since the time between events is greater than the
  // delta time in the repeat condition
  questEngine->IncrementEvent("game.end");
  const std::set<QuestNotice>& notices = questEngine->GetNotices();
...
TEST_F(QuestRuleBuilderTest, InvalidJson) {
  ...
  std::string jsonString(
      "{\"rules\":[{\"id\":\"test.invalid.json\",\"eventNames\":[\"game.end\"],"
      "\"action\":{\"type\":\"Notice\",\"attributes\":{\"titleKey\":\"home."
      "notice.title\",\"descriptionKey\":\"home.notice.description\"}},"
      "\"condition\":{\"type\":\"CountThreshold\",\"attributes\":{\"operator\":"
      "\"CountThresholdOperatorEquals\",\"targetValue\":5,\"triggerKey\":"
      "\"game.end\",,,,}}}]}");
  Anki::Util::FileUtils::WriteFile(RulesFile(), jsonString);
...
TEST_F(QuestRuleBuilderTest, EmptyCondition) {
  ...
  std::string jsonString(
      "{\"rules\":[{\"id\":\"test.empty.condition\",\"eventNames\":[\"game."
      "end\"],\"action\":{\"type\":\"Notice\",\"attributes\":{\"titleKey\":"
      "\"home.notice.title\",\"descriptionKey\":\"home.notice.description\"}}}]"
      "}");
  Anki::Util::FileUtils::WriteFile(RulesFile(), jsonString);
...
TEST_F(QuestRuleBuilderTest, EmptyActions) {
  ...
  std::string jsonString(
      "{\"rules\":[{\"id\":\"test.empty.action\",\"eventNames\":[\"game.end\"],"
      "\"condition\":{\"type\":\"CountThreshold\",\"attributes\":{\"operator\":"
      "\"CountThresholdOperatorEquals\",\"targetValue\":5,\"triggerKey\":"
      "\"game.end\"}}}]}");
  Anki::Util::FileUtils::WriteFile(RulesFile(), jsonString);
...
TEST_F(QuestRuleBuilderTest, PartialValidRules) {
  ...
  std::string jsonString(
      "{\"rules\":[{\"id\":\"test.partial.valid.rules\",\"eventNames\":[\"game."
      "end\"],\"action\":{\"type\":\"Notice\",\"attributes\":{\"titleKey\":"
      "\"home.notice.title\",\"descriptionKey\":\"home.notice.description\"}},"
      "\"condition\":{\"type\":\"CountThreshold\",\"attributes\":{\"operator\":"
      "\"CountThresholdOperatorEquals\",\"targetValue\":5,\"triggerKey\":"
