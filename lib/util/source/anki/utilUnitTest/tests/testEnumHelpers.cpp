...
// ================================================================================
// Enum implementations - i.e. everything that would normally be in a separate
// CPP file:
...
const char* EnumToString(const TestEnum m) {
  switch (m) {
    ...
    case TestEnum::TestVal3:
      return "TestVal3";
    case TestEnum::TestVal4:
      return "TestVal4";
    case TestEnum::TestVal5:
      return "TestVal5";
    case TestEnum::TestVal6:
      return "TestVal6";
    case TestEnum::TestVal7:
      return "TestVal7";
    case TestEnum::TestVal8:
      return "TestVal8";
    case TestEnum::Count:
      return "Count";
    default:
