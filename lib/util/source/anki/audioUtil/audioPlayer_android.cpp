...
AudioPlayer::~AudioPlayer() { StopPlaying(); }

bool AudioPlayer::StartPlaying(AudioChunkList::const_iterator beginIter,
...
void AudioPlayer::StopPlaying() {
  ...
  _impl->_currentChunkIter = _impl->_endChunkIter =
      AudioChunkList::const_iterator{};
