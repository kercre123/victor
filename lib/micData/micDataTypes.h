...
enum class MicDataType { Raw, Processed };
...
static constexpr uint32_t kIncomingAudioChunkSize =
...
static constexpr uint32_t kTriggerAudioLengthDebug_ms =
    1500;  // We only hold onto more audio for FP testing during development
