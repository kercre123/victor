...
AudioFilePackageLUT::AudioFilePackageLUT()
...
AKRESULT AudioFilePackageLUT::Setup(
...
const AudioFilePackageLUT::AkFileEntry<AkFileID> * AudioFilePackageLUT::LookupFile(
...
// Find a file entry by ID.
const AudioFilePackageLUT::AkFileEntry<AkUInt64> * AudioFilePackageLUT::LookupFile(
...
AKRESULT AudioFilePackageLUT::SetCurLanguage(
...
void AudioFilePackageLUT::RemoveFileExtension( AkOSChar* in_pstring )
{
...
AkFileID AudioFilePackageLUT::GetSoundBankID(
...
AkUInt64 AudioFilePackageLUT::GetExternalID(
...
void AudioFilePackageLUT::_MakeLowerA( char* in_pString, size_t in_strlen )
{
...
void AudioFilePackageLUT::_MakeLower( AkOSChar* in_pString )
{
...
AkUInt32 AudioFilePackageLUT::StringMap::GetID( const AkOSChar* in_pszString )
{
