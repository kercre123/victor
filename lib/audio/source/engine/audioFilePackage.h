...
// It holds a system file handle and a look-up table (AudioFilePackageLUT).
//
// AudioFilePackage objects can be chained together using the ListFilePackages
...
//-----------------------------------------------------------------------------
// Name: AudioFilePackage
// Desc: Base class representing a file package (incomplete implementation). 
// It holds a look-up table (AudioFilePackageLUT) and manages memory for the LUT and
// for itself. 
//-----------------------------------------------------------------------------
class AudioFilePackage : public AudioListAware<AudioFilePackage>
{
public:
	// Package factory.
		...
		)
	{
		...
		// Construct a AudioFilePackage at the end of this memory region.
	...
	// Members.
	// ------------------------------
	AudioFilePackageLUT	lut;		// Package look-up table.
...
protected:
	...
	AudioFilePackage();
	AudioFilePackage(AudioFilePackage&);
	AudioFilePackage( AkUInt32 in_uPackageID, AkUInt32 in_uHeaderSize, AkMemPoolId in_poolID, void * in_pToRelease, bool in_bIsInternalPool )
...
// Desc: AkListBare of AudioFilePackage items.
//-----------------------------------------------------------------------------
typedef AkListBare<AudioFilePackage,AudioListAware,AkCountPolicyWithCount> ListFilePackages;
