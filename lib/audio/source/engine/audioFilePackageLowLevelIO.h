...
//-----------------------------------------------------------------------------
// Name: CAkDiskPackage 
// Desc: This class extends the AudioFilePackage class by providing system handle
// management.
...
// is destroyed.
//-----------------------------------------------------------------------------
class AudioDiskPackage : public AudioFilePackage
{
public:
	...
	static AudioDiskPackage * Create(
	...
	{
		AudioDiskPackage * pPackage = AudioFilePackage::Create<AudioDiskPackage>(
			in_pszPackageName,
			in_memPoolID,
			in_uHeaderSize,
	...
	AudioDiskPackage( AkUInt32 in_uPackageID, AkUInt32 in_uHeaderSize, AkMemPoolId in_poolID, void * in_pToRelease, bool in_bIsInternalPool )
		: AudioFilePackage( in_uPackageID, in_uHeaderSize, in_poolID, in_pToRelease, in_bIsInternalPool )
	{ }
...
//-----------------------------------------------------------------------------
// Name: class AudioFilePackageLowLevelIO.
...
//-----------------------------------------------------------------------------
template <class T_LLIOHOOK_FILELOC, class T_PACKAGE = AudioDiskPackage>
class AudioFilePackageLowLevelIO : public T_LLIOHOOK_FILELOC
{
public:

    AudioFilePackageLowLevelIO();
    virtual ~AudioFilePackageLowLevelIO();
...
protected:
	...
	{
		((AudioFilePackageLowLevelIO<T_LLIOHOOK_FILELOC, T_PACKAGE>*)in_pCookie)->OnLanguageChange( in_pLanguageName );
	}
...
#include "audioFilePackageLowLevelIO.inl"
