...
alias victor_restart='GET_GIT_ROOT; ${GIT_PROJ_ROOT}/project/victor/scripts/cozmoctl.sh restart && ${GIT_PROJ_ROOT}/project/victor/scripts/robotctl.sh restart && ${GIT_PROJ_ROOT}/project/victor/scripts/animctl.sh restart && ${GIT_PROJ_ROOT}/project/victor/scripts/cloudctl.sh restart'
alias victor_stop='GET_GIT_ROOT; ${GIT_PROJ_ROOT}/project/victor/scripts/cozmoctl.sh stop && ${GIT_PROJ_ROOT}/project/victor/scripts/robotctl.sh stop && ${GIT_PROJ_ROOT}/project/victor/scripts/animctl.sh stop && ${GIT_PROJ_ROOT}/project/victor/scripts/cloudctl.sh stop'
