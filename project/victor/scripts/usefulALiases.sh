...
alias victor_build_oskr='GET_GIT_ROOT; source ${GIT_PROJ_ROOT}/project/victor/scripts/usefulALiases.sh; ${GIT_PROJ_ROOT}/project/victor/scripts/victor_build_oskr.sh'
