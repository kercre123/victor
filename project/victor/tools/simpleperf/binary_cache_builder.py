            ...
            for root, _, files in os.walk(symfs_dir):
                for file in files:
                    ...
                    if paths is not None:
                        sym_file = os.path.join(root, file)
                        sym_file_full = sym_file + ".full"
                        ...
                        for binary in paths:
                            ...
                            if expected_build_id == build_id:
                                if os.path.exists(sym_file_full):
                                    src_sym_file = sym_file_full
                                else:
                                    src_sym_file = sym_file
                                print("copy_to_binary_cache: {}".format(src_sym_file))
                                self._copy_to_binary_cache(src_sym_file,
