...
DEVICE_ASSET_ROOT_DIR="${INSTALL_ROOT}/data/assets"
...
HAS_RSYNC=$?
adb_shell "[ -f "$DEVICE_RSYNC_CONF_DIR/rsyncd.conf" ]"
HAS_RSYNC_CONF=$?
set -e
...
# sync files
rsync -v -v -rcP --stats --delete ./ rsync://${DEVICE_IP_ADDRESS}/${DEVICE_ASSET_REL_DIR}/
