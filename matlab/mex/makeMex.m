...
ste    mex mexClosestIndex.cpp
   ...
   compileVerbose = ' '; % or compileVerbose = 'v';
    ...
    mex(compileVerbose, 'mexGaussianBlur.cpp', ...
        ...
        ['-I' mexWrapperDir], ...
        ['-L', openCvLibDir], '-l opencv_core', '-l opencv_imgproc');
    %%
    mex(compileVerbose, '-g', 'mexBundleAdjust.cpp', ...
        ...
        ['-I' openCvIncludeDirs{17}], ...
        ['-I' openCvIncludeDirs{18}], ...
        ['-L', openCvLibDir], '-l opencv_core', '-l opencv_contrib', ...
        '-l opencv_calib3d'); 
end
