...
/*
 * [X_final, R_final, T_final] = mexBundleAdjust(x_obs, X_world, R, T, K,
 * radDistortionCoeffs)
 *
 * Inputs:
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  ...
  mxAssert(
      mxIsCell(prhs[0]),  //&& mxGetNumberOfElements(prhs[0])==numPoses,
  ...
  mxAssert(mxGetN(prhs[1]) == 3, "World points should be [numPts x 3] array.");
  ...
  lms.bundleAdjust(worldPts, imagePts, visibility, camCalibMats, R, T,
                   distCoeffs, criteria);
