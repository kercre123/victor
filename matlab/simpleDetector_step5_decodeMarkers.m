function [markers, validQuads] = simpleDetector_step5_decodeMarkers(img, quads, quadTforms, minQuadArea, quadRefinementIterations, embeddedConversions, showTiming, NearestNeighborLibrary, DEBUG_DISPLAY)
        ...
        for i_quad = 1:numQuads
            ...
            if strcmp(embeddedConversions.extractFiducialMethod, 'matlab_original')
                markers{end+1} = VisionMarkerTrained(img, 'Corners', corners, ...
                    ...
                    'NearestNeighborLibrary', NearestNeighborLibrary);  %#ok<AGROW>
