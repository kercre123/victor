...
function binaryImage = computeBinaryCharacteristicScaleImage_boxFilters_lowMemory(image, numLevels, numRowsToScroll, thresholdFraction)

if ~exist('numRowsToScroll', 'var')
    numRowsToScroll = 32;
end
