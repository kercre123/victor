...
namespace AnimationTool
{
    partial class MainForm
    {
        private double GetTimeNeededFromFile(PointData current)
        {
            ...
            double x = Math.Round((current.triggerTime_ms + current.durationTime_ms) * 0.001D, 3);
        ...
        private void ReadAudioRobotFromFile(AudioRobotPointData current)
        {
            ...
            Sequencer.ExtraAudioData extraData = new Sequencer.ExtraAudioData(path, Math.Round(current.durationTime_ms * 0.001D, 3), volume < MoveSelectedDataPoints.DELTA_X ? 1 : volume);
        ...
        private void ReadFaceAnimationImageFromFile(FaceAnimationPointData current)
        {
            ...
            Sequencer.ExtraFaceAnimationData extraData = new Sequencer.ExtraFaceAnimationData(path, Math.Round(current.durationTime_ms * 0.001D, 3));
