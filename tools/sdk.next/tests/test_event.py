...
#         recv = EventReceiver(loop=self.loop)
#         recv._dispatch_dynamic_event("EvtOne", 456)
#         test_utils.run_briefly(self.loop)
#         self.assertEqual(recv._result_evt_one_internal.msg, 456)
    ...
    # TODO: add test_dispatch_wait_for_event_with_timeout

        #print("one", recv._result_evt_one)
        #print("two", recv._result_evt_two)
