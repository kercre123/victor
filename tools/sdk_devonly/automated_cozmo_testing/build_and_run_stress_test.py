...
parser.add_argument('-path', '--build_folder_path',
					  action='store',
					  required=False,
...
def install_android_build(build_path, serial_id_list):
	...
	for serial_id in serial_id_list:
		print("Installing Cozmo for Android device: {}...".format(get_device_name(serial_id)))
...
def install_ios_build(build_path, serial_id_list):
	...
	for serial_id in serial_id_list:
		print("Installing Cozmo for iOS device: {}...".format(get_device_name(serial_id)))
...
def run_test_for_device(platform, serial_id_list):
	for serial_id in serial_id_list:
		print("Run Stress test for Cozmo: {}...".format(get_device_name(serial_id)))
