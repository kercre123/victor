...
class SayText(action.Action):
    ...
    def _encode(self):
        #The playEvent is hackily used to have cozmo play an animation and with the sound
        #generated by converting the text to speech. There is currently no other better way.
        return _clad_to_engine_iface.SayText(text=self.text, 
                    playEvent=_clad_to_engine_cozmo.AnimationTrigger.OnSawNewNamedFace,
                    style=_clad_to_engine_cozmo.SayTextStyle.Name_Normal)
...
class Cozmo(event.Dispatcher):
    ...
    * A Behaviors object, starting and ending robot behaviors such as looking around
    ...
    def say_text(self, text):
        ...
        '''
        action = self.say_text_factory(text, conn=self.conn, robot=self,
