...
namespace Anki
{
  ...
  int CaptureImages(const int cameraId, const int numImages, const cv::Size2i imageSize, std::vector<cv::Mat> &capturedImages, double &captureTime, const bool startCaptureImmediately=false, const bool showPreview=true, const bool showCrosshair=true);
}
