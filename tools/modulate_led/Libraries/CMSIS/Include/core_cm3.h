...
/** \defgroup CMSIS_MISRA_Exceptions  CMSIS MISRA-C:2004 Compliance Exceptions
  CMSIS violates following MISRA-C2004 Rules:
   ...
   - Violates MISRA 2004 Required Rule 8.5, object/function definition in header
  file.<br> Function definitions in header files are used to allow 'inlining'.

   - Violates MISRA 2004 Required Rule 18.4, declaration of union type or object
  of union type: '{...}'.<br> Unions are used for effective representation of
  core registers.
...
/*!< __FPU_USED to be checked prior to making use of FPU specific registers and
 * functions */
#define __FPU_USED 0
...
/** \ingroup  CMSIS_core_register
  ...
  Type definitions for the Cortex-M System Control and ID Register not in the
  SCB
  @{
 */
...
/** \brief  Set Priority Grouping
  ...
  This function sets the priority grouping field using the required unlock
...
/** \brief  Disable External Interrupt
    ...
    This function disables a device specific interrupt in the NVIC interrupt
   controller. The interrupt number cannot be a negative value.
...
/** \brief  Get Pending Interrupt
    ...
    This function reads the pending register in the NVIC and returns the pending
...
/** \brief  Encode Priority
    ...
    This function encodes the priority for an interrupt with the given priority
   group, preemptive priority value and sub priority value. In case of a
...
/** \brief  Decode Priority
    ...
    This function decodes an interrupt priority value with the given priority
   group to preemptive priority value and sub priority value. In case of a
   conflict between priority grouping and available priority bits
   (__NVIC_PRIO_BITS) the samllest possible priority group is set.
...
/** \brief  System Tick Configuration
   ...
   the system tick timer. Counter is in free running mode to generate periodical
   interrupts.
...
/** \brief  ITM Check Character
    ...
    This function checks external variable ITM_RxBuffer whether a character is
   available or not. It returns '1' if a character is available and '0' if no
