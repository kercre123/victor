...
def install_ndk(revision):
    ...
    ndk_info_darwin = {
        'r15c': {'size': 960251267, 'sha1': 'ea4b5d76475db84745aa8828000d009625fc1f98'},
...
def install_sdk(version):
    sdk_info_darwin = {
        ...
        'r4': {"size": 1079992526, "sha1": 'a7340bc479f321b3d68f99018aa5fd00fb5665c7'},
    }
