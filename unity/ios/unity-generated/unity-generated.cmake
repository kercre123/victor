...
if(DEFINED ENV{IPHONEOS_DEPLOYMENT_TARGET})
    message("-- Ios deployment target set to $ENV{IPHONEOS_DEPLOYMENT_TARGET}")
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Os -miphoneos-version-min=$ENV{IPHONEOS_DEPLOYMENT_TARGET}")
else()
    message("-- Warning: No ios deployment target set.")
