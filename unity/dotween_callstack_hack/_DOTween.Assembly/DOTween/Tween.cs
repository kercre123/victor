...
{
    /// <summary>
    /// Custom DoTween exception 
    /// </summary>
    public class DoTweenException : System.Exception
    {
        public DoTweenException() : base() { }
        /// <summary>
        /// Custom DoTween exception 
        /// </summary>
        public DoTweenException(string message) : base(message) { }

        /// <summary>
        /// Custom DoTween exception 
        /// </summary>
        public DoTweenException(string message, System.Exception inner) : base(message, inner) { }

        /// <summary>
        /// Custom DoTween exception 
        /// </summary>
        public DoTweenException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context) { }
    }
...
#pragma warning restore 1591
        ...
        public void ProcessDoTweenException(Exception e)
        {
            ...
            exceptionMessage += "\n---------------------------------------------------\n";
            exceptionMessage += "Error Callstack: ";
            throw new DoTweenException(exceptionMessage);
        }
...
//            updateType = UpdateType.Normal;
        ...
        internal static bool DoGoto(Tween t, float toPosition, int toCompletedLoops, UpdateMode updateMode)
        {
            ...
            catch (DoTweenException doTweenException) {
                throw doTweenException;
            }
            catch (Exception e) {
                t.ProcessDoTweenException(e);
                return false;
            }
        }
