...
namespace InvestorDemo {
  ...
  public class InvestorDemoGame : GameBase {
    ...
    protected void InitializeMinigameObjects() {
      ...
      Anki.Cozmo.Audio.AudioClient.Instance.PostParameter(Anki.Cozmo.Audio.GameParameter.ParameterType.Ui_Volume, 1.0f, Anki.Cozmo.Audio.GameObjectType.Invalid);
