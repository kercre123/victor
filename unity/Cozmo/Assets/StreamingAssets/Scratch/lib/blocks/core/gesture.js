...
Blockly.Gesture.prototype.doStart = function(e) {
  ...
  // *** ANKI CHANGE ***
  // Don't block tooltips from showing ever. Not sure if there is a time we do want to block.
  ...
  // *** ANKI CHANGE ***
  // Only call longStart (which shows tooltips) if the user is tapping in the flyout_.
  if (this.flyout_ && goog.string.caseInsensitiveEquals(e.type, 'touchstart')) {
