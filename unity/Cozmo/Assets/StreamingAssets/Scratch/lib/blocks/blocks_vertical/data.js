...
Blockly.Blocks['data_addtolist'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "message0": "%{BKY_DATA_ADD_TO_LIST_SCRATCH_2}", // *** ANKI CHANGE ***
      //"message0": "add %1 to %2",
...
Blockly.Blocks['data_deleteoflist'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "message0": "%{BKY_DATA_DELETE_FROM_LIST_SCRATCH_2}", // *** ANKI CHANGE ***
...
Blockly.Blocks['data_insertatlist'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "message0": "%{BKY_DATA_INSERT_LIST_SCRATCH_2}", // *** ANKI CHANGE ***
...
Blockly.Blocks['data_replaceitemoflist'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "message0": "%{BKY_DATA_REPLACE_IN_LIST_SCRATCH_2}", // *** ANKI CHANGE ***
...
Blockly.Blocks['data_itemoflist'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "message0": "%{BKY_DATA_ITEM_IN_LIST_SCRATCH_2}", // *** ANKI CHANGE ***
...
Blockly.Blocks['data_lengthoflist'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "message0": "%{BKY_DATA_LENGTH_OF_LIST_SCRATCH_2}", // *** ANKI CHANGE ***
...
Blockly.Blocks['data_listcontainsitem'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "message0": "%{BKY_DATA_LIST_CONTAINS_SCRATCH_2}", // *** ANKI CHANGE ***
