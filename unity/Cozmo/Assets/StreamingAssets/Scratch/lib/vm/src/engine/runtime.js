...
const defaultBlockPackages = {
    ...
    scratch3_cozmo: require('../blocks/scratch3_cozmo') // *** ANKI CHANGE ***
};
...
class Runtime extends EventEmitter {
    ...
    stopAll () {
        ...
        // Turning this off for now during scratch-vm merge, 01/19/18. Need to revisit.
        /*
        const threadsCopy = this.threads.slice();
        while (threadsCopy.length > 0) {
            const poppedThread = threadsCopy.pop();

            /// TODO Turned off as currentBlockId is not defined after scratch-vm update. Need to revisit. 6/10/17, msintov
            //
            // *** ANKI CHANGE ***
