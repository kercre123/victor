...
public class SoundCheckModal : Cozmo.UI.BaseModal {
  ...
  private void Awake() {
    _PlayButton.Initialize(HandlePlayButton, "play_sound_button", this.DASEventDialogName);
    _SoundsGoodButton.Initialize(HandleSoundsGoodButton, "sounds_good_button", this.DASEventDialogName);
    _PlayAgainButton.Initialize(HandlePlayButton, "play_again_button", this.DASEventDialogName);
