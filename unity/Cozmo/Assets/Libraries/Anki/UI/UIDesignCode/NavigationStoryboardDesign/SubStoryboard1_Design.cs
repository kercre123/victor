...
public class SubStoryboard1_Design : Anki.UI.Storyboard {
  ...
  protected override void LoadStoryboard()
  {
    ...
    sbNode1.AddSegueDescription(new StoryboardExitSegueDescription("Pop", "ExitSegue_Pop"));
    ...
    sbNode3.AddSegueDescription(new StoryboardSegueDescription("Push", sbNode5Key, NavigationSegueDirection.Forward, SegueAnimationTransition.AnimationType.Slide));
    ...
    StoryboardNode sbNode5 = new StoryboardNode(sbNode5Key, "Sub-StoryboardNavCntr 2_Design");
    sbNode5.NavigationBarHidden = true;
    sbNode5.AddSegueDescription(new StoryboardSegueDescription("Exit_Pop", sbNode3Key, NavigationSegueDirection.Reverse, SegueAnimationTransition.AnimationType.Slide));
