...
public static class ImageUtil {
  ...
  static readonly byte[] _HeaderColor50 = {
    0xFF, 0xD8, 0xFF, 0xE0, 0x00, 0x10, 0x4A, 0x46, 0x49, 0x46, 0x00, 0x01, 0x01, 0x00, 0x00, 0x01,
    0x00, 0x01, 0x00, 0x00, 0xFF, 0xDB, 0x00, 0x43, 0x00, 0x10, 0x0B, 0x0C, 0x0E, 0x0C, 0x0A, 0x10, // 0x19 = QTable
    0x0E, 0x0D, 0x0E, 0x12, 0x11, 0x10, 0x13, 0x18, 0x28, 0x1A, 0x18, 0x16, 0x16, 0x18, 0x31, 0x23,
    0x25, 0x1D, 0x28, 0x3A, 0x33, 0x3D, 0x3C, 0x39, 0x33, 0x38, 0x37, 0x40, 0x48, 0x5C, 0x4E, 0x40,
  ...
  // Helper used by both mini color and mini gray decoding
  private static void MiniJpegHelper(MemoryStream bufferIn, MemoryStream bufferOut, byte[] header, int height, int width)
  {
  ...
  public static void MinimizedGreyToJpeg(MemoryStream bufferIn, MemoryStream bufferOut, int height, int width)
  {
    ...
    MiniJpegHelper(bufferIn, bufferOut, header, height, width);

  }

  // Turn a fully assembled MINIPEG_COLOR image into a JPEG with header and footer
  // This is a port of C# code from Nathan.
  public static void MinimizedColorToJpeg(MemoryStream bufferIn, MemoryStream bufferOut, int height, int width)
  {
    MiniJpegHelper(bufferIn, bufferOut, _HeaderColor50, height, width);
  } 
