...
// Full command line: ../lib/anki/cozmo-engine/tools/message-buffers/emitters/CSharp_emitter.py -C src -I ../lib/anki/cozmo-engine/clad/src --output-file ../unity/Cozmo/Assets/Scripts/MessageBuffers/UiMessagesU2G.cs anki/cozmo/messageBuffers/game/UiMessagesU2G.clad
...
public class Message {
	public enum Tag {
		...
		ClearAllBlocks,	//29
		ClearAllObjects,	//30
		SetObjectAdditionAndDeletion,	//31
		VisionWhileMoving,	//32
		ExecuteBehavior,	//33
		SetBehaviorState,	//34
		AbortPath,	//35
		AbortAll,	//36
		...
		DrawPoseMarker,	//38
		ErasePoseMarker,	//39
		SetWheelControllerGains,	//40
		SetHeadControllerGains,	//41
		SetLiftControllerGains,	//42
		SetSteeringControllerGains,	//43
		SelectNextSoundScheme,	//44
		StartTestMode,	//45
		IMURequest,	//46
		PlayAnimation,	//47
		ReadAnimationFile,	//48
		StartFaceTracking,	//49
		StopFaceTracking,	//50
		StartLookingForMarkers,	//51
		StopLookingForMarkers,	//52
		SetVisionSystemParams,	//53
		SetFaceDetectParams,	//54
		SetActiveObjectLEDs,	//55
		SetAllActiveObjectLEDs,	//56
		SetBackpackLEDs,	//57
		VisualizeQuad,	//58
		EraseQuad,	//59
		INVALID
