...
// Full command line: /Users/gregnage/cozmo-game/lib/anki/cozmo-engine/tools/message-buffers/emitters/CSharp_emitter.py -o /Users/gregnage/cozmo-game/unity/Cozmo/Assets/Scripts/Channel/UiMessageDefinitionsG2U.cs /Users/gregnage/cozmo-game/src/comms/messaging/UiMessageDefinitionsG2U.clad
...
public class G2U_PlaySound
{
	...
	{
		this.soundFilename = System.String.Empty;
	}
...
public class G2U_Message {
	...
	public System.IO.Stream Unpack(System.IO.Stream stream)
	{
		...
		switch(newTag) {
		case Tag.Ping:
			_state = new Anki.Cozmo.G2U_Ping(stream);
			break;
		case Tag.RobotAvailable:
			_state = new Anki.Cozmo.G2U_RobotAvailable(stream);
			break;
		case Tag.UiDeviceAvailable:
			_state = new Anki.Cozmo.G2U_UiDeviceAvailable(stream);
			break;
		case Tag.RobotConnected:
			_state = new Anki.Cozmo.G2U_RobotConnected(stream);
			break;
		case Tag.RobotDisconnected:
			_state = new Anki.Cozmo.G2U_RobotDisconnected(stream);
			break;
		case Tag.UiDeviceConnected:
			_state = new Anki.Cozmo.G2U_UiDeviceConnected(stream);
			break;
		case Tag.RobotState:
			_state = new Anki.Cozmo.G2U_RobotState(stream);
			break;
		case Tag.ImageChunk:
			_state = new Anki.Cozmo.G2U_ImageChunk(stream);
			break;
		case Tag.RobotObservedObject:
			_state = new Anki.Cozmo.G2U_RobotObservedObject(stream);
			break;
		case Tag.RobotObservedNothing:
			_state = new Anki.Cozmo.G2U_RobotObservedNothing(stream);
			break;
		case Tag.RobotDeletedObject:
			_state = new Anki.Cozmo.G2U_RobotDeletedObject(stream);
			break;
		case Tag.DeviceDetectedVisionMarker:
			_state = new Anki.Cozmo.G2U_DeviceDetectedVisionMarker(stream);
			break;
		case Tag.RobotCompletedAction:
			_state = new Anki.Cozmo.G2U_RobotCompletedAction(stream);
			break;
		case Tag.PlaySound:
			_state = new Anki.Cozmo.G2U_PlaySound(stream);
			break;
		case Tag.StopSound:
			_state = new Anki.Cozmo.G2U_StopSound(stream);
			break;
		default:
			break;
		}
