...
// Full command line: /Users/gregnage/cozmo-game/lib/anki/cozmo-engine/tools/message-buffers/emitters/CSharp_emitter.py -o /Users/gregnage/cozmo-game/unity/Cozmo/Assets/Scripts/Channel/UiMessageDefinitionsU2G.cs /Users/gregnage/cozmo-game/src/comms/messaging/UiMessageDefinitionsU2G.clad
...
public class U2G_PlayAnimation
{
	...
	{
		this.animationName = System.String.Empty;
	}
...
public class U2G_Message {
	...
	public System.IO.Stream Unpack(System.IO.Stream stream)
	{
		...
		switch(newTag) {
		case Tag.Ping:
			_state = new Anki.Cozmo.U2G_Ping(stream);
			break;
		case Tag.ConnectToRobot:
			_state = new Anki.Cozmo.U2G_ConnectToRobot(stream);
			break;
		case Tag.ConnectToUiDevice:
			_state = new Anki.Cozmo.U2G_ConnectToUiDevice(stream);
			break;
		case Tag.DisconnectFromUiDevice:
			_state = new Anki.Cozmo.U2G_DisconnectFromUiDevice(stream);
			break;
		case Tag.ForceAddRobot:
			_state = new Anki.Cozmo.U2G_ForceAddRobot(stream);
			break;
		case Tag.StartEngine:
			_state = new Anki.Cozmo.U2G_StartEngine(stream);
			break;
		case Tag.DriveWheels:
			_state = new Anki.Cozmo.U2G_DriveWheels(stream);
			break;
		case Tag.TurnInPlace:
			_state = new Anki.Cozmo.U2G_TurnInPlace(stream);
			break;
		case Tag.MoveHead:
			_state = new Anki.Cozmo.U2G_MoveHead(stream);
			break;
		case Tag.MoveLift:
			_state = new Anki.Cozmo.U2G_MoveLift(stream);
			break;
		case Tag.SetLiftHeight:
			_state = new Anki.Cozmo.U2G_SetLiftHeight(stream);
			break;
		case Tag.SetHeadAngle:
			_state = new Anki.Cozmo.U2G_SetHeadAngle(stream);
			break;
		case Tag.TrackHeadToObject:
			_state = new Anki.Cozmo.U2G_TrackHeadToObject(stream);
			break;
		case Tag.StopAllMotors:
			_state = new Anki.Cozmo.U2G_StopAllMotors(stream);
			break;
		case Tag.ImageRequest:
			_state = new Anki.Cozmo.U2G_ImageRequest(stream);
			break;
		case Tag.SetRobotImageSendMode:
			_state = new Anki.Cozmo.U2G_SetRobotImageSendMode(stream);
			break;
		case Tag.SaveImages:
			_state = new Anki.Cozmo.U2G_SaveImages(stream);
			break;
		case Tag.SaveRobotState:
			_state = new Anki.Cozmo.U2G_SaveRobotState(stream);
			break;
		case Tag.EnableDisplay:
			_state = new Anki.Cozmo.U2G_EnableDisplay(stream);
			break;
		case Tag.SetHeadlights:
			_state = new Anki.Cozmo.U2G_SetHeadlights(stream);
			break;
		case Tag.GotoPose:
			_state = new Anki.Cozmo.U2G_GotoPose(stream);
			break;
		case Tag.PlaceObjectOnGround:
			_state = new Anki.Cozmo.U2G_PlaceObjectOnGround(stream);
			break;
		case Tag.PlaceObjectOnGroundHere:
			_state = new Anki.Cozmo.U2G_PlaceObjectOnGroundHere(stream);
			break;
		case Tag.ExecuteTestPlan:
			_state = new Anki.Cozmo.U2G_ExecuteTestPlan(stream);
			break;
		case Tag.SelectNextObject:
			_state = new Anki.Cozmo.U2G_SelectNextObject(stream);
			break;
		case Tag.PickAndPlaceObject:
			_state = new Anki.Cozmo.U2G_PickAndPlaceObject(stream);
			break;
		case Tag.TraverseObject:
			_state = new Anki.Cozmo.U2G_TraverseObject(stream);
			break;
		case Tag.SetRobotCarryingObject:
			_state = new Anki.Cozmo.U2G_SetRobotCarryingObject(stream);
			break;
		case Tag.ClearAllBlocks:
			_state = new Anki.Cozmo.U2G_ClearAllBlocks(stream);
			break;
		case Tag.VisionWhileMoving:
			_state = new Anki.Cozmo.U2G_VisionWhileMoving(stream);
			break;
		case Tag.ExecuteBehavior:
			_state = new Anki.Cozmo.U2G_ExecuteBehavior(stream);
			break;
		case Tag.SetBehaviorState:
			_state = new Anki.Cozmo.U2G_SetBehaviorState(stream);
			break;
		case Tag.AbortPath:
			_state = new Anki.Cozmo.U2G_AbortPath(stream);
			break;
		case Tag.AbortAll:
			_state = new Anki.Cozmo.U2G_AbortAll(stream);
			break;
		case Tag.DrawPoseMarker:
			_state = new Anki.Cozmo.U2G_DrawPoseMarker(stream);
			break;
		case Tag.ErasePoseMarker:
			_state = new Anki.Cozmo.U2G_ErasePoseMarker(stream);
			break;
		case Tag.SetHeadControllerGains:
			_state = new Anki.Cozmo.U2G_SetHeadControllerGains(stream);
			break;
		case Tag.SetLiftControllerGains:
			_state = new Anki.Cozmo.U2G_SetLiftControllerGains(stream);
			break;
		case Tag.SelectNextSoundScheme:
			_state = new Anki.Cozmo.U2G_SelectNextSoundScheme(stream);
			break;
		case Tag.StartTestMode:
			_state = new Anki.Cozmo.U2G_StartTestMode(stream);
			break;
		case Tag.IMURequest:
			_state = new Anki.Cozmo.U2G_IMURequest(stream);
			break;
		case Tag.PlayAnimation:
			_state = new Anki.Cozmo.U2G_PlayAnimation(stream);
			break;
		case Tag.ReadAnimationFile:
			_state = new Anki.Cozmo.U2G_ReadAnimationFile(stream);
			break;
		case Tag.StartFaceTracking:
			_state = new Anki.Cozmo.U2G_StartFaceTracking(stream);
			break;
		case Tag.StopFaceTracking:
			_state = new Anki.Cozmo.U2G_StopFaceTracking(stream);
			break;
		case Tag.StartLookingForMarkers:
			_state = new Anki.Cozmo.U2G_StartLookingForMarkers(stream);
			break;
		case Tag.StopLookingForMarkers:
			_state = new Anki.Cozmo.U2G_StopLookingForMarkers(stream);
			break;
		case Tag.SetVisionSystemParams:
			_state = new Anki.Cozmo.U2G_SetVisionSystemParams(stream);
			break;
		case Tag.SetFaceDetectParams:
			_state = new Anki.Cozmo.U2G_SetFaceDetectParams(stream);
			break;
		default:
			break;
		}
