...
namespace CodeLab {
  ...
  // CodeLabFeaturedSerializedProject is only used in vertical grammar.
  public class CodeLabFeaturedSerializedProject {
    public Guid ProjectUUID;
    public string ProjectJSON; // Serialized Scratch project
  }
  ...
  public class CodeLabGame : GameBase {
    ...
    protected override void InitializeGame(ChallengeConfigBase challengeConfigData) {
      ...
      _CodeLabFeaturedProjects = this.LoadFeaturedProjects();
...
#elif UNITY_ANDROID
      string streamingAssetsPath = PlatformUtil.GetResourcesBaseFolder() + projectFolder;
#endif
    ...
    private void HandleBlockScratchRequest(ScratchRequest scratchRequest) {
      ...
      if (HandleDrawOnFaceRequest(scratchRequest)) {
        ...
        string text = RemoveUnsupportedCharsAndTrim(scratchRequest.argString);
    ...
    public static string RemoveUnsupportedCharsAndTrim(string rawString) {
      rawString = RemoveUnsupportedChars(rawString);
