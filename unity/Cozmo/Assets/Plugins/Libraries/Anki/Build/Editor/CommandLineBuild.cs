...
// CommandLineBuild needs to be in the global namespace right now because we are
// calling it from the command line in a build script
// https://github.com/anki/build-tools/blob/master/tools/ankibuild/unity.py
//namespace Anki {
//  namespace Build {
public class CommandLineBuild {
  ...
  public static void Build() {
    ...
    string result = Anki.Build.Builder.BuildWithArgs(argv);
