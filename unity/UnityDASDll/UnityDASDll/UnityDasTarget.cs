...
public class UnityDasTarget : IDASTarget
{
  ...
  {
    UnityEngine.Debug.Log (string.Format ("DAS [{0}-{1}] {2} - {3}", 2, channelName, eventName, eventValue), context);
  }
  ...
  {
    UnityEngine.Debug.Log (string.Format ("DAS [{0}-{1}] {2} - {3}", 1, channelName, eventName, eventValue), context);
  }
  ...
  {
    UnityEngine.Debug.Log (string.Format ("DAS GetGlobal [{0}] {1}", 6, key));
    return "";
  }
