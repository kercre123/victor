...
OKAO_API INT32 OKAO_FR_ExtractPoints_GRAY(HFEATURE hFeature,
                                          RAWIMAGE *pImageGRAY, INT32 nWidth,
                                          INT32 nHeight, GRAY_ORDER ImageOrder,
                                          INT32 nPointNum, POINT aptPoint[],
                                          INT32 anConfidence[]);
/*      Extracts Face Feature from Facial Part Positions and the YUV422 Image */
OKAO_API INT32 OKAO_FR_ExtractPoints_YUV422(HFEATURE hFeature,
                                            RAWIMAGE *pImageYUV, INT32 nWidth,
                                            INT32 nHeight,
 ...
 */
OKAO_API INT32 OKAO_FR_ExtractPoints_YUV420SP(
    HFEATURE hFeature, RAWIMAGE *pImageY, RAWIMAGE *pImageCx, INT32 nWidth,
    INT32 nHeight, YUV420SP_ORDER ImageOrder, INT32 nPointNum, POINT aptPoint[],
    INT32 anConfidence[]);
/*      Extracts Face Feature from Facial Part Positions and the YUV420FP Image
 */
OKAO_API INT32 OKAO_FR_ExtractPoints_YUV420FP(
    HFEATURE hFeature, RAWIMAGE *pImageY, RAWIMAGE *pImageCb,
    RAWIMAGE *pImageCr, INT32 nWidth, INT32 nHeight, YUV420FP_ORDER ImageOrder,
    INT32 nPointNum, POINT aptPoint[], INT32 anConfidence[]);
/*      Extracts Face Feature from Facial Parts Detection Result Handle ans the
 * GRAY Image      */
OKAO_API INT32 OKAO_FR_ExtractHandle_GRAY(HFEATURE hFeature,
                                          RAWIMAGE *pImageGRAY, INT32 nWidth,
                                          INT32 nHeight, GRAY_ORDER ImageOrder,
                                          HPTRESULT hPtResult);
/*      Extracts Face Feature from Facial Parts Detection Result Handle ans the
 * YUV422 Image    */
OKAO_API INT32 OKAO_FR_ExtractHandle_YUV422(HFEATURE hFeature,
                                            RAWIMAGE *pImageYUV, INT32 nWidth,
                                            INT32 nHeight,
                                            YUV422_ORDER ImageOrder,
                                            HPTRESULT hPtResult);
/*      Extracts Face Feature from Facial Parts Detection Result Handle ans the
 * YUV420SP Image  */
OKAO_API INT32 OKAO_FR_ExtractHandle_YUV420SP(
    HFEATURE hFeature, RAWIMAGE *pImageY, RAWIMAGE *pImageCx, INT32 nWidth,
    INT32 nHeight, YUV420SP_ORDER ImageOrder, HPTRESULT hPtResult);
/*      Extracts Face Feature from Facial Parts Detection Result Handle ans the
 * YUV420FP Image  */
OKAO_API INT32 OKAO_FR_ExtractHandle_YUV420FP(
    HFEATURE hFeature, RAWIMAGE *pImageY, RAWIMAGE *pImageCb,
    RAWIMAGE *pImageCr, INT32 nWidth, INT32 nHeight, YUV420FP_ORDER ImageOrder,
    HPTRESULT hPtResult);
...
OKAO_API INT32 OKAO_FR_WriteFeatureToMemory(HFEATURE hFeature, UINT8 *pbyBuffer,
                                            UINT32 unBufSize);
/*      Reads Face Feature Data from Memory      */
OKAO_API INT32 OKAO_FR_ReadFeatureFromMemory(HFEATURE hFeature,
                                             UINT8 *pbyBuffer, UINT32 unBufSize,
                                             FR_ERROR *pError);
...
OKAO_API HALBUM OKAO_FR_CreateAlbumHandle(HCOMMON hCO, INT32 nMaxUserNum,
...
OKAO_API INT32 OKAO_FR_GetAlbumMaxNum(HALBUM hAlbum, INT32 *pnMaxUserNum,
                                      INT32 *pnMaxDataNumPerUser);

/*********************************************
 * Data Registration In Album
 *********************************************/
/*      Registers Face Feature Data into Album Data */
OKAO_API INT32 OKAO_FR_RegisterData(HALBUM hAlbum, HFEATURE hFeature,
...
OKAO_API INT32 OKAO_FR_GetRegisteredAllDataNum(HALBUM hAlbum,
                                               INT32 *pnAllDataNum);
...
OKAO_API INT32 OKAO_FR_GetRegisteredUsrDataNum(HALBUM hAlbum, INT32 nUserID,
                                               INT32 *pnUserDataNum);
/*      Gets Data Registration Status of a specified User               */
OKAO_API INT32 OKAO_FR_IsRegistered(HALBUM hAlbum, INT32 nUserID, INT32 nDataID,
                                    BOOL *pIsRegistered);
...
OKAO_API INT32 OKAO_FR_GetSerializedAlbumSize(HALBUM hAlbum,
                                              UINT32 *punSerializedAlbumSize);
/*      Serializes Album Data                   */
OKAO_API INT32 OKAO_FR_SerializeAlbum(HALBUM hAlbum, UINT8 *pbyBuffer,
                                      UINT32 unBufSize);
/*      Restores Album Data                     */
OKAO_API HALBUM OKAO_FR_RestoreAlbum(HCOMMON hCO, UINT8 *pbyBuffer,
                                     UINT32 unBufSize, FR_ERROR *pError);

/*********************************************
 * Acquisition of Feature Data from Album Data
 *********************************************/
/*      Gets Feature Data from Album Data      */
OKAO_API INT32 OKAO_FR_GetFeatureFromAlbum(HALBUM hAlbum, INT32 nUserID,
                                           INT32 nDataID, HFEATURE hFeature);

/*********************************************
 * Verification/Identification
 *********************************************/
/*      Verification      */
OKAO_API INT32 OKAO_FR_Verify(HFEATURE hFeature, HALBUM hAlbum, INT32 nUserID,
                              INT32 *pnScore);
/*      Identification    */
OKAO_API INT32 OKAO_FR_Identify(HFEATURE hFeature, HALBUM hAlbum,
                                INT32 nMaxResultNum, INT32 anUserID[],
                                INT32 anScore[], INT32 *pnResultNum);
