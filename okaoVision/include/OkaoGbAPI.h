...
OKAO_API INT32 OKAO_GB_SetPoint(HGAZEBLINK hGB, INT32 nPointNum,
...
OKAO_API INT32 OKAO_GB_Estimate(HGAZEBLINK hGB, RAWIMAGE *pImage, INT32 nWidth,
...
OKAO_API INT32 OKAO_GB_GetEyeCloseRatio(HGBRESULT hGbResult,
                                        INT32 *pnCloseRatioLeftEye,
                                        INT32 *pnCloseRatioRightEye);
/* Get the estimation result for gaze */
OKAO_API INT32 OKAO_GB_GetGazeDirection(HGBRESULT hGbResult,
                                        INT32 *pnGazeLeftRight,
                                        INT32 *pnGazeUpDown);
