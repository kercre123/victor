...
OKAO_API INT32 OKAO_PT_SetPositionFromHandle(HPOINTER hPT, HDTRESULT hDtResult,
                                             INT32 nIndex);
/* Set face position */
OKAO_API INT32 OKAO_PT_SetPosition(HPOINTER hPT, POINT *pptLeftTop,
                                   POINT *pptRightTop, POINT *pptLeftBottom,
                                   POINT *pptRightBottom, INT32 nPose,
                                   DTVERSION DtVersion);
/* Set face position from Motion face detection IP result */
OKAO_API INT32 OKAO_PT_SetPositionIP(HPOINTER hPT, INT32 nCenterX,
                                     INT32 nCenterY, INT32 nSize, INT32 nAngle,
                                     INT32 nScale, INT32 nPose,
                                     DTVERSION DtVersion);
...
OKAO_API INT32 OKAO_PT_DetectPoint_GRAY(HPOINTER hPT, RAWIMAGE *pImageGRAY,
                                        INT32 nWidth, INT32 nHeight,
                                        GRAY_ORDER ImageOrder,
                                        HPTRESULT hPtResult);
/* Execute Facial Parts Detection(YUV422) */
OKAO_API INT32 OKAO_PT_DetectPoint_YUV422(HPOINTER hPT, RAWIMAGE *pImageYUV,
                                          INT32 nWidth, INT32 nHeight,
                                          YUV422_ORDER ImageOrder,
                                          HPTRESULT hPtResult);
/* Execute Facial Parts Detection(YUV420SP) */
OKAO_API INT32 OKAO_PT_DetectPoint_YUV420SP(HPOINTER hPT, RAWIMAGE *pImageY,
                                            RAWIMAGE *pImageCx, INT32 nWidth,
                                            INT32 nHeight,
                                            YUV420SP_ORDER ImageOrder,
                                            HPTRESULT hPtResult);
/* Execute Facial Parts Detection(YUV420FP) */
OKAO_API INT32 OKAO_PT_DetectPoint_YUV420FP(HPOINTER hPT, RAWIMAGE *pImageY,
                                            RAWIMAGE *pImageCb,
                                            RAWIMAGE *pImageCr, INT32 nWidth,
                                            INT32 nHeight,
...
OKAO_API INT32 OKAO_PT_GetResult(HPTRESULT hPtResult, INT32 nPointNum,
                                 POINT aptPoint[], INT32 anConfidence[]);
/* Get the face direction angles(degree) detected by OKAO_Pointer() */
OKAO_API INT32 OKAO_PT_GetFaceDirection(HPTRESULT hPtResult, INT32 *pnUpDown,
                                        INT32 *pnLeftRight, INT32 *pnRoll);
