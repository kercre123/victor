/*-------------------------------------------------------------------*/
/*  Copyright(C) 2010-2014 by OMRON Corporation                      */
/*  All Rights Reserved.                                             */
/*                                                                   */
...
#define DETECTOR_TYPE_SOFT_BD_V1 \
  (DET_SOFT | DET_BD | DET_V1) /* Human Body Detection V1    */
#define DETECTOR_TYPE_SOFT_PD_V1 \
  (DET_SOFT | DET_PD | DET_V1)           /* Pet Detection V1           */
...
#define DET_METHOD_DETECTED_HIGH \
  (DET_METHOD_DETECTED |         \
   DET_METHOD_ACCURACY_HIGH) /* Detected with high accuracy */
#define DET_METHOD_TRACKED_HIGH \
  (DET_METHOD_TRACKED |         \
   DET_METHOD_ACCURACY_HIGH) /* Tracked with high accuracy  */
#define DET_METHOD_TRACKED_MIDDLE \
  (DET_METHOD_TRACKED |           \
   DET_METHOD_ACCURACY_MIDDLE) /* Tracked with middle accuracy */
