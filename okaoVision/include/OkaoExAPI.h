...
OKAO_API INT32 OKAO_EX_SetPoint(HEXPRESSION hEX, INT32 nPointNum,
...
OKAO_API INT32 OKAO_EX_Estimate_GRAY(HEXPRESSION hEX, RAWIMAGE *pImageGRAY,
                                     INT32 nWidth, INT32 nHeight,
                                     GRAY_ORDER ImageOrder,
                                     HEXRESULT hExResult);

OKAO_API INT32 OKAO_EX_Estimate_YUV422(HEXPRESSION hEX, RAWIMAGE *pImageYUV,
                                       INT32 nWidth, INT32 nHeight,
                                       YUV422_ORDER ImageOrder,
                                       HEXRESULT hExResult);

OKAO_API INT32 OKAO_EX_Estimate_YUV420SP(HEXPRESSION hEX, RAWIMAGE *pImageY,
                                         RAWIMAGE *pImageCx, INT32 nWidth,
                                         INT32 nHeight,
                                         YUV420SP_ORDER ImageOrder,
                                         HEXRESULT hExResult);

OKAO_API INT32 OKAO_EX_Estimate_YUV420FP(HEXPRESSION hEX, RAWIMAGE *pImageY,
...
OKAO_API INT32 OKAO_EX_GetResult(HEXRESULT hExResult, INT32 nExpressionNum,
                                 INT32 anScore[]);
