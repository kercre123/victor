...
OKAO_API INT32 OKAO_SM_SetPoint(HSMILE hSM, INT32 nPointNum, POINT aptPoint[],
                                INT32 anConfidence[], INT32 nUpDown,
                                INT32 nLeftRight);
...
OKAO_API INT32 OKAO_SM_Estimate(HSMILE hSM, RAWIMAGE *pImage, INT32 nWidth,
...
OKAO_API INT32 OKAO_SM_GetResult(HSMRESULT hSmResult, INT32 *pnSmile,
                                 INT32 *pnConfidence);
