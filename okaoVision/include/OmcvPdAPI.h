...
#define DETECTOR_TYPE_SOFT_PD_V2 \
  (DET_SOFT | DET_PD | DET_V2) /* Pet Detection V2 */
...
OMCV_API HPET OMCV_PD_CreateHandle(INT32 nDetectionMode,
...
OMCV_API INT32 OMCV_PD_Detect(HPET hPD, RAWIMAGE *pImage, INT32 nWidth,
                              INT32 nHeight, HPDRESULT hPdResult);

/**********************************************************/
/* Gets Detection Result                                  */
/**********************************************************/
/* Gets the number of detected pet */
OMCV_API INT32 OMCV_PD_GetResultCount(HPDRESULT hPdResult, INT32 nObjectType,
                                      INT32 *pnCount);
...
OMCV_API INT32 OMCV_PD_GetSizeRange(HPET hPD, INT32 *pnMinSize,
                                    INT32 *pnMaxSize);
...
OMCV_API INT32 OMCV_PD_MV_SetSearchCycle(HPET hPD, INT32 nInitialPetSearchCycle,
                                         INT32 nNewPetSearchCycle);
OMCV_API INT32 OMCV_PD_MV_GetSearchCycle(HPET hPD,
                                         INT32 *pnInitialPetSearchCycle,
                                         INT32 *pnNewPetSearchCycle);

/* Sets/Gets Max Retry Count and Max Hold Count */
OMCV_API INT32 OMCV_PD_MV_SetLostParam(HPET hPD, INT32 nMaxRetryCount,
                                       INT32 nMaxHoldCount);
OMCV_API INT32 OMCV_PD_MV_GetLostParam(HPET hPD, INT32 *pnMaxRetryCount,
                                       INT32 *pnMaxHoldCount);

/* Sets/Gets the steadiness parameters for size and positon of the detection
 * result */
OMCV_API INT32 OMCV_PD_MV_SetSteadinessParam(HPET hPD,
                                             INT32 nPosSteadinessParam,
                                             INT32 nSizeSteadinessParam);
OMCV_API INT32 OMCV_PD_MV_GetSteadinessParam(HPET hPD,
