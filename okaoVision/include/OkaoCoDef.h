...
/*                                                                   */
/*-------------------------------------------------------------------*/
#ifndef OKAOCODEF_H__
#define OKAOCODEF_H__
...
typedef enum {
  YUV420SP_ORDER_Y0Y1Y2Y3_CBCR =
      0, /* 1st Plane : Y0Y1Y2Y3..., 2nd Plane : CbCrCbCr... */
  YUV420SP_ORDER_Y0Y1Y2Y3_CRCB, /* 1st Plane : Y0Y1Y2Y3..., 2nd Plane :
                                   CrCbCrCb... */
  YUV420SP_ORDER_Y3Y2Y1Y0_CBCR, /* 1st Plane : Y3Y2Y1Y0..., 2nd Plane :
                                   CbCrCbCr... */
  YUV420SP_ORDER_Y3Y2Y1Y0_CRCB  /* 1st Plane : Y3Y2Y1Y0..., 2nd Plane :
                                   CrCbCrCb... */
} YUV420SP_ORDER;

typedef enum {
  YUV420FP_ORDER_Y0Y1Y2Y3_CB_CR = 0, /* 1st Plane : Y0Y1Y2Y3..., 2nd Plane :
                                        CbCb... , 3rd Plane : CrCr... */
  YUV420FP_ORDER_Y3Y2Y1Y0_CB_CR /* 1st Plane : Y3Y2Y1Y0..., 2nd Plane : CbCb...
                                   , 3rd Plane : CrCr... */
} YUV420FP_ORDER;
