...
#define DETECTOR_TYPE_SOFT_ED_V1 \
  (DET_SOFT | DET_ED | DET_V1) /* Eye Detection V1 */
...
/**********************************************************/
/* Executes detection */
OKAO_API INT32 OKAO_ED_Detect(HEYEDETECTION hED, RAWIMAGE *pImage, INT32 nWidth,
                              INT32 nHeight, volatile INT32 *pnBreakFlag,
                              HEDRESULT hEdResult);
...
OKAO_API INT32 OKAO_ED_GetResultInfo(HEDRESULT hEdResult, INT32 nIndex,
...
OKAO_API INT32 OKAO_ED_SetSizeRange(HEYEDETECTION hED, INT32 nMinSize,
                                    INT32 nMaxSize);
OKAO_API INT32 OKAO_ED_GetSizeRange(HEYEDETECTION hED, INT32 *pnMinSize,
                                    INT32 *pnMaxSize);
