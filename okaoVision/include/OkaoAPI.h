...
/*----- Memory Management -----*/
OKAO_API INT32 OKAO_SetWMemoryArea(
    VOID *pMemoryAddr, UINT32 unSize); /* Work Memory Area Setting */
OKAO_API INT32 OKAO_SetBMemoryArea(
    VOID *pMemoryAddr, UINT32 unSize);     /* Backup Memory Area Setting */
...
/*----- BGR Data --> GRAY Data -----*/
OKAO_API INT32
OKAO_ImgConvertBGRtoGRAY(RAWIMAGE *pSrcImage,   /* (I) BGR Image Data       */
...
OKAO_API INT32
OKAO_ImgConvertYUV422toGRAY(RAWIMAGE *pSrcImage, /* (I) YUV422 Image Data    */
                            INT32 nWidth,        /* (I) Image Width          */
                            INT32 nHeight,       /* (I) Image Height         */
                            RAWIMAGE *pGrayImage); /* (O) GRAY Scale Data */
...
OKAO_API INT32
OKAO_ImgConvertBGRtoYUV422(RAWIMAGE *pSrcImage,  /* (I) BGR Image Data       */
                           INT32 nWidth,         /* (I) Image Width          */
                           INT32 nHeight,        /* (I) Image Height         */
...
OKAO_API INT32
OKAO_ImgConvertYUV422toBGR(RAWIMAGE *pSrcImage,  /* (I) YUV422 Image Data    */
                           INT32 nWidth,         /* (I) Image Width          */
                           INT32 nHeight,        /* (I) Image Height         */
...
/*----- Conversion of "coordinates of the center, size, and angle" from
 * coordinates of the rectangle. -----*/
OKAO_API INT32
OKAO_ConvertRectToCenter(POINT ptLeftTop,     /* (I) Top-left Corner     */
