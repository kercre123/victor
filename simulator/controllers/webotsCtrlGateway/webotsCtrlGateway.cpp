 ...
 * Date:          07/17/2018
 * Description:   Wrapper controller which simply invokes vic-gateway in the
 * background Author:        Matt Michini
 */
...
int main(int argc, char** argv) {
  ...
  // Spawn vic-gateway in the background. Note that since this is being spawned
  // in the background, it will continue to run even if the Webots simulation is
  // paused. Also, stdout and stderr from vic-gateway will still make it to the
  // Webots console.
