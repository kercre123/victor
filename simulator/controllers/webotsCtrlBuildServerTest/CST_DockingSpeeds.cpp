  ...
  switch (_testState) {
    ...
    case TestState::DockingSpeed1: {
      IF_ALL_CONDITIONS_WITH_TIMEOUT_ASSERT(
          ...
          GetNumObjects() == 1) {
        PRINT_NAMED_INFO("DockingSpeed1",
                         "Docking with speed:%f accel:%f decel:%f",
                         mp.dockSpeed_mmps, mp.accel_mmps2, mp.dockDecel_mmps2);
        ...
        m.numRetries = 3;
        // Pickup object 0
        m.action.Set_pickupObject(
            ExternalInterface::PickupObject(0, mp, 0, false, true));
    ...
    case TestState::DockingSpeed2: {
      IF_ALL_CONDITIONS_WITH_TIMEOUT_ASSERT(
          ...
          GetCarryingObjectID() == -1, GetNumObjects() == 1) {
        ResetTest();

        mp.dockSpeed_mmps = 80;
        mp.dockDecel_mmps2 = 200;

        PRINT_NAMED_INFO("DockingSpeed2",
                         "Docking with speed:%f accel:%f decel:%f",
                         mp.dockSpeed_mmps, mp.accel_mmps2, mp.dockDecel_mmps2);
    ...
    case TestState::DockingSpeed3: {
      IF_ALL_CONDITIONS_WITH_TIMEOUT_ASSERT(
        ...
        PRINT_NAMED_INFO("DockingSpeed3",
                         "Docking with speed:%f accel:%f decel:%f",
                         mp.dockSpeed_mmps, mp.accel_mmps2, mp.dockDecel_mmps2);
    ...
    case TestState::DockingSpeed4: {
      IF_ALL_CONDITIONS_WITH_TIMEOUT_ASSERT(
        ...
        PRINT_NAMED_INFO("DockingSpeed4",
                         "Docking with speed:%f accel:%f decel:%f",
                         mp.dockSpeed_mmps, mp.accel_mmps2, mp.dockDecel_mmps2);
    ...
    case TestState::DockingSpeed5: {
      IF_ALL_CONDITIONS_WITH_TIMEOUT_ASSERT(
        ...
        PRINT_NAMED_INFO("DockingSpeed5",
                         "Docking with speed:%f accel:%f decel:%f",
                         mp.dockSpeed_mmps, mp.accel_mmps2, mp.dockDecel_mmps2);
    ...
    case TestState::PlaceBlock: {
      IF_ALL_CONDITIONS_WITH_TIMEOUT_ASSERT(
          55, !IsRobotStatus(RobotStatusFlag::IS_MOVING),
          GetCarryingObjectID() == 0) {
        ExternalInterface::QueueSingleAction m;
        m.position = QueueActionPosition::NOW;
        ...
        m.numRetries = 3;
        // Pickup object 0
        m.action.Set_placeObjectOnGroundHere(
            ExternalInterface::PlaceObjectOnGroundHere());
        ExternalInterface::MessageGameToEngine message;
        message.Set_QueueSingleAction(m);
        SendMessage(message);
    ...
    case TestState::VerifyPlaced: {
      ...
      IF_ALL_CONDITIONS_WITH_TIMEOUT_ASSERT(
          55, !IsRobotStatus(RobotStatusFlag::IS_MOVING),
          GetCarryingObjectID() == -1, _placeActionCompleted,
        ...
        m.idTag = 10;
        m.action.Set_waitForImages(
            ExternalInterface::WaitForImages(5, 0, VisionMode::Markers));
        ExternalInterface::MessageGameToEngine message;
        message.Set_QueueSingleAction(m);
        SendMessage(message);
        ...
        m1.idTag = 20;
        m1.action.Set_setHeadAngle(
            ExternalInterface::SetHeadAngle(0, 100, 100, 0));
...
void CST_DockingSpeeds::HandleRobotStateUpdate(
    const ExternalInterface::RobotState& msg) {
  _robotState = msg;
}

void CST_DockingSpeeds::HandleRobotCompletedAction(
