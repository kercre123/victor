...
enum class TestState { Init, CliffFL, CliffFR, CliffBL, CliffBR, TestDone };
...
class CST_CliffDetection : public CozmoSimTestController {
 ...
 private:
  ...
  virtual void HandleSetCliffDetectThresholds(
      const SetCliffDetectThresholds& msg) override;
...
bool CST_CliffDetection::CheckCliffDetected(CliffSensor cliffID) {
  ...
  IF_ALL_CONDITIONS_WITH_TIMEOUT_ASSERT(
      25.0, !IsRobotStatus(RobotStatusFlag::IS_MOVING),
...
void CST_CliffDetection::HandleSetCliffDetectThresholds(
