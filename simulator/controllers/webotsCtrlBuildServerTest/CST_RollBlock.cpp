...
enum class TestState { Init, RollObject, TestDone };
  ...
  switch (_testState) {
    ...
    case TestState::RollObject: {
      ...
      IF_ALL_CONDITIONS_WITH_TIMEOUT_ASSERT(
          ...
          NEAR(GetRobotHeadAngle_rad(), 0, HEAD_ANGLE_TOL), !objIds.empty()) {
        ...
        m.action.Set_rollObject(ExternalInterface::RollObject(
            _cubeID, _defaultTestMotionProfile, 0, false, false, true, false));
    ...
    case TestState::TestDone: {
      ...
      IF_ALL_CONDITIONS_WITH_TIMEOUT_ASSERT(
          25, !IsRobotStatus(RobotStatusFlag::IS_MOVING),
