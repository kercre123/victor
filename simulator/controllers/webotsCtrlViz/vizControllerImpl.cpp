...
void VizControllerImpl::Init() {
  ...
  Subscribe(VizInterface::MessageVizTag::SetRobot,
            std::bind(&VizControllerImpl::ProcessVizSetRobotMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::SetLabel,
            std::bind(&VizControllerImpl::ProcessVizSetLabelMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::DockingErrorSignal,
            std::bind(&VizControllerImpl::ProcessVizDockingErrorSignalMessage,
                      this, std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::VisionMarker,
            std::bind(&VizControllerImpl::ProcessVizVisionMarkerMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::CameraQuad,
            std::bind(&VizControllerImpl::ProcessVizCameraQuadMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::CameraRect,
            std::bind(&VizControllerImpl::ProcessVizCameraRectMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::CameraLine,
            std::bind(&VizControllerImpl::ProcessVizCameraLineMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::CameraOval,
            std::bind(&VizControllerImpl::ProcessVizCameraOvalMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::CameraText,
            std::bind(&VizControllerImpl::ProcessVizCameraTextMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::ImageChunk,
            std::bind(&VizControllerImpl::ProcessVizImageChunkMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::TrackerQuad,
            std::bind(&VizControllerImpl::ProcessVizTrackerQuadMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::RobotStateMessage,
            std::bind(&VizControllerImpl::ProcessVizRobotStateMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::CurrentAnimation,
            std::bind(&VizControllerImpl::ProcessVizCurrentAnimation, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::SaveImages,
            std::bind(&VizControllerImpl::ProcessSaveImages, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::SaveState,
            std::bind(&VizControllerImpl::ProcessSaveState, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::CameraParams,
            std::bind(&VizControllerImpl::ProcessCameraParams, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::BehaviorStackDebug,
            std::bind(&VizControllerImpl::ProcessBehaviorStackDebug, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::VisionModeDebug,
            std::bind(&VizControllerImpl::ProcessVisionModeDebug, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::EnabledVisionModes,
            std::bind(&VizControllerImpl::ProcessEnabledVisionModes, this,
                      std::placeholders::_1));

  Subscribe(VizInterface::MessageVizTag::SetVizOrigin,
            std::bind(&VizControllerImpl::ProcessVizSetOriginMessage, this,
                      std::placeholders::_1));

  Subscribe(VizInterface::MessageVizTag::MemoryMapMessageVizBegin,
            std::bind(&VizControllerImpl::ProcessVizMemoryMapMessageBegin, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::MemoryMapMessageViz,
            std::bind(&VizControllerImpl::ProcessVizMemoryMapMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::MemoryMapMessageVizEnd,
            std::bind(&VizControllerImpl::ProcessVizMemoryMapMessageEnd, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::Object,
            std::bind(&VizControllerImpl::ProcessVizObjectMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::EraseObject,
            std::bind(&VizControllerImpl::ProcessVizEraseObjectMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::ShowObjects,
            std::bind(&VizControllerImpl::ProcessVizShowObjectsMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::LineSegment,
            std::bind(&VizControllerImpl::ProcessVizLineSegmentMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::EraseLineSegments,
            std::bind(&VizControllerImpl::ProcessVizEraseLineSegmentsMessage,
                      this, std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::Quad,
            std::bind(&VizControllerImpl::ProcessVizQuadMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::EraseQuad,
            std::bind(&VizControllerImpl::ProcessVizEraseQuadMessage, this,
                      std::placeholders::_1));
  Subscribe(
      VizInterface::MessageVizTag::AppendPathSegmentLine,
      std::bind(&VizControllerImpl::ProcessVizAppendPathSegmentLineMessage,
                this, std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::AppendPathSegmentArc,
            std::bind(&VizControllerImpl::ProcessVizAppendPathSegmentArcMessage,
                      this, std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::SetPathColor,
            std::bind(&VizControllerImpl::ProcessVizSetPathColorMessage, this,
                      std::placeholders::_1));
  Subscribe(VizInterface::MessageVizTag::ErasePath,
            std::bind(&VizControllerImpl::ProcessVizErasePathMessage, this,
                      std::placeholders::_1));
  ...
  // Find all the debug image displays in the proto. Use the first as the camera
  // feed and the rest for debug images.
  {
    webots::Node* vizNode = _vizSupervisor.getSelf();
    webots::Field* numDisplaysField =
        vizNode->getField("numDebugImageDisplays");
    s32 numDisplays = 1;
    if (numDisplaysField == nullptr) {
      PRINT_NAMED_WARNING("VizControllerImpl.Init.MissingNumDebugDisplaysField",
                          "Assuming single display (camera)");
    } else {
      numDisplays = numDisplaysField->getSFInt32() +
                    1;  // +1 because this is in addition to the camera
    }

    _camDisp = nullptr;

    for (s32 displayCtr = 0; displayCtr < numDisplays; ++displayCtr) {
      webots::Display* display = _vizSupervisor.getDisplay(
          "cozmo_debug_image_display" + std::to_string(displayCtr));
      DEV_ASSERT_MSG(display != nullptr,
                     "VizControllerImpl.Init.NullDebugDisplay", "displayCtr=%d",
                     displayCtr);
  ...
  auto nodeInfo =
      WebotsHelpers::GetFirstMatchingSceneTreeNode(_vizSupervisor, "CozmoBot");
  if (nodeInfo.nodePtr == nullptr) {
    // If there's no Vector, look for a Whiskey
    nodeInfo = WebotsHelpers::GetFirstMatchingSceneTreeNode(_vizSupervisor,
                                                            "WhiskeyBot");
  }

  const auto* nd = nodeInfo.nodePtr;
  if (nd != nullptr) {
    DEV_ASSERT(nodeInfo.type == webots::Node::ROBOT,
               "VizControllerImpl.Init.CozmoBotNotASupervisor");
    ...
    if (vizMode) {
      PRINT_NAMED_INFO("VizControllerImpl.Init.FoundVizRobot",
                       "Found Viz robot with name %s",
                       nodeInfo.typeName.c_str());
      ...
      DEV_ASSERT_MSG(
          _vizBot.Valid(), "VizControllerImpl.Init.MissingFields",
          "Could not find all required fields in CozmoBot supervisor");
    } else if (_drawingObjectsEnabled) {
      // vizMode is false here, meaning that there is an actual simulated robot
      // in the world. If drawing objects is enabled, then we must be able to
      // hide any new objects from the robot's camera. Therefore, we need to be
      // able to access the Camera node so that we can call
      // Node::setVisibility() on each new object. There seems to be no good way
      // to get the underlying node pointer of the camera, so we have to do this
      // somewhat hacky iteration over all of the nodes in the world to find the
      // camera node's ID.
      ...
      // A RangeFinder node may or may not exist depending on whether or not the
      // simulated robot is Whiskey or Vector
      if (tofNode != nullptr) {
...
void VizControllerImpl::Update() {
  ...
  const double updateRate =
      _vizSupervisor.getSelf()->getField("drawObjectsRate_sec")->getSFFloat();
...
void VizControllerImpl::ProcessMessage(VizInterface::MessageViz&& message) {
  ...
  _eventMgr.Broadcast(
      AnkiEvent<VizInterface::MessageViz>(type, std::move(message)));
}

void VizControllerImpl::ProcessSaveImages(
  ...
  if (_saveImageMode != ImageSendMode::Off) {
    ...
    if (!_savedImagesFolder.empty() &&
        !Util::FileUtils::CreateDirectory(_savedImagesFolder, false, true)) {
      PRINT_NAMED_WARNING(
          "VizControllerImpl.ProcessSaveImages.CreateDirectoryFailed",
...
void VizControllerImpl::ProcessSaveState(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
...
void VizControllerImpl::SetRobotPose(CozmoBotVizParams& vizParams,
                                     const Pose3d& pose, const f32 headAngle,
                                     const f32 liftAngle) {
  // Make sure we haven't tried to set these Webots fields in the current time
  // step (which causes weird behavior due to a Webots R2018a bug with the
  // setSF* functions) This should be removed once the Webots bug is fixed
  // (COZMO-16021)
  ...
  vizParams.liftAngle->setSFFloat(
      liftAngle +
      0.199763);  // Adding LIFT_LOW_ANGLE_LIMIT since the model's lift angle
                  // does not correspond to robot's lift angle.
  // TODO: Make this less hard-coded.
  vizParams.headAngle->setSFFloat(headAngle);
}

void VizControllerImpl::ProcessVizSetRobotMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  if (_vizBot.Valid()) {
...
static inline void SetColorHelper(webots::Display* disp, u32 ankiColor) {
  ...
  if (alpha < 0xff) {
    ...
    disp->setAlpha(1.f);  // need to restore alpha to 1.0 in case it was lowered
                          // from a previous call
  }
}

void VizControllerImpl::DrawText(webots::Display* disp, u32 lineNum, u32 color,
                                 const char* text) {
  if (disp == nullptr) {
  ...
  const int yLabelStep =
      10;  // Line spacing in pixels. Characters are 8x8 pixels in size.

  // Clear line specified by lineNum
  SetColorHelper(disp, NamedColors::BLACK);
  disp->fillRectangle(0, baseYOffset + yLabelStep * lineNum, disp->getWidth(),
                      yLabelStep);
...
void VizControllerImpl::DrawText(webots::Display* disp, u32 lineNum,
                                 const char* text) {
  DrawText(disp, lineNum, 0xffffff, text);
}

void VizControllerImpl::ProcessVizSetLabelMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  const auto& payload = msg.GetData().Get_SetLabel();
  const u32 lineNum =
      ((uint32_t)VizTextLabelType::NUM_TEXT_LABELS + payload.labelID);
  DrawText(_disp, lineNum, payload.colorID, payload.text.c_str());
}

void VizControllerImpl::ProcessVizDockingErrorSignalMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  // TODO: This can overlap with text being displayed. Create a dedicated
  // display for it?
  ...
  sprintf(text, "ErrSig x:%.1f y:%.1f z:%.1f a:%.2f\n", payload.x_dist,
          payload.y_dist, payload.z_dist, payload.angle);
  ...
  // Draw robot position
  _dockDisp->drawOval((int)(baseXOffset + 0.5f * rectW), baseYOffset + rectH, 3,
                      3);
  ...
  if (blockFaceCenterX < halfBlockFaceLength ||
      (blockFaceCenterX > rectW - halfBlockFaceLength) ||
      blockFaceCenterY < halfBlockFaceLength ||
      (blockFaceCenterY > rectH - halfBlockFaceLength)) {
    return;
  }
  ...
  _dockDisp->drawLine(blockFaceCenterX + dx, blockFaceCenterY + dy,
                      blockFaceCenterX - dx, blockFaceCenterY - dy);
  _dockDisp->drawOval(blockFaceCenterX, blockFaceCenterY, 2, 2);
}

void VizControllerImpl::ProcessVizVisionMarkerMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  ...
  _camDisp->drawLine(payload.topLeft_x, payload.topLeft_y, payload.bottomLeft_x,
                     payload.bottomLeft_y);
  _camDisp->drawLine(payload.bottomLeft_x, payload.bottomLeft_y,
                     payload.bottomRight_x, payload.bottomRight_y);
  _camDisp->drawLine(payload.bottomRight_x, payload.bottomRight_y,
                     payload.topRight_x, payload.topRight_y);
  _camDisp->drawLine(payload.topRight_x, payload.topRight_y, payload.topLeft_x,
                     payload.topLeft_y);
}

void VizControllerImpl::ProcessVizCameraQuadMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  const auto& payload = msg.GetData().Get_CameraQuad();

  SetColorHelper(_camDisp, payload.color);
  _camDisp->drawLine((int)payload.xUpperLeft, (int)payload.yUpperLeft,
                     (int)payload.xLowerLeft, (int)payload.yLowerLeft);
  _camDisp->drawLine((int)payload.xLowerLeft, (int)payload.yLowerLeft,
                     (int)payload.xLowerRight, (int)payload.yLowerRight);
  _camDisp->drawLine((int)payload.xLowerRight, (int)payload.yLowerRight,
                     (int)payload.xUpperRight, (int)payload.yUpperRight);

  if (payload.topColor != payload.color) {
    SetColorHelper(_camDisp, payload.topColor);
  }
  _camDisp->drawLine((int)payload.xUpperRight, (int)payload.yUpperRight,
                     (int)payload.xUpperLeft, (int)payload.yUpperLeft);
}

void VizControllerImpl::ProcessVizCameraRectMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  const auto& payload = msg.GetData().Get_CameraRect();

  SetColorHelper(_camDisp, payload.color);
  if (payload.filled) {
    _camDisp->fillRectangle(payload.x, payload.y, payload.width,
                            payload.height);
  } else {
    _camDisp->drawRectangle(payload.x, payload.y, payload.width,
                            payload.height);
  }
}

void VizControllerImpl::ProcessVizCameraLineMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  const auto& payload = msg.GetData().Get_CameraLine();
  SetColorHelper(_camDisp, payload.color);
  _camDisp->drawLine((int)payload.xStart, (int)payload.yStart,
                     (int)payload.xEnd, (int)payload.yEnd);
}

void VizControllerImpl::ProcessVizCameraOvalMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  const auto& payload = msg.GetData().Get_CameraOval();
  SetColorHelper(_camDisp, payload.color);
  _camDisp->drawOval(
      (int)std::round(payload.xCen), (int)std::round(payload.yCen),
      (int)std::round(payload.xRad), (int)std::round(payload.yRad));
}

void VizControllerImpl::ProcessVizCameraTextMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
...
static void DisplayImageHelper(const EncodedImage& encodedImage,
  ...
  if (RESULT_OK != result) {
    PRINT_NAMED_WARNING("VizControllerImpl.DisplayImageHelper.DecodeFailed",
                        "t=%d", (TimeStamp_t)encodedImage.GetTimeStamp());
    return;
  }

  if (img.IsEmpty()) {
    PRINT_NAMED_WARNING(
        "VizControllerImpl.DisplayImageHelper.EmptyImageDecoded", "t=%d",
        (TimeStamp_t)encodedImage.GetTimeStamp());
    return;
  }

  if (img.GetNumCols() == display->getWidth() &&
      img.GetNumRows() == display->getHeight()) {
    // Simple case: image already the right size
    imageRef = display->imageNew(img.GetNumCols(), img.GetNumRows(),
                                 img.GetDataPointer(), webots::Display::RGB);
  } else {
    // Resize to fit the display
    // NOTE: making fixed-size data buffer static because resizedImage will
    // change dims each time it's used.
    static std::vector<u8> buffer(display->getWidth() * display->getHeight() *
                                  3);
    Vision::ImageRGB resizedImage(display->getHeight(), display->getWidth(),
                                  buffer.data());
    img.ResizeKeepAspectRatio(resizedImage,
                              Vision::ResizeMethod::NearestNeighbor);
    imageRef =
        display->imageNew(resizedImage.GetNumCols(), resizedImage.GetNumRows(),
...
void VizControllerImpl::ProcessVizImageChunkMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  ...
  if (displayIndex == 0) {
    ...
    // - We don't display until we receive a DisplayImage message (see
    // ProcessVizDisplayImageMessage())
    // - We do extra bookkeeping around the save counter so that we can also
    // save the
    //   the visualized image (with any extra viz elements overlaid) when it is
    //   complete, and with a matching filename.
    EncodedImage& encodedImage = _bufferedImages[_imageBufferIndex];
    const bool isImageReady = encodedImage.AddChunk(payload);

    if (isImageReady) {
      DEV_ASSERT_MSG(
          payload.frameTimeStamp == encodedImage.GetTimeStamp(),
          "VizControllerImpl.ProcessVizImageChunkMessage.TimestampMismath",
          "Payload:%u Image:%u", payload.frameTimeStamp,
          (TimeStamp_t)encodedImage.GetTimeStamp());

      // Add an entry in EncodedImages map for this new image, now that it's
      // complete
      auto result =
          _encodedImages.emplace(payload.frameTimeStamp, _imageBufferIndex);
      DEV_ASSERT_MSG(
          result.second,
          "VizControllerImpl.ProcessVizImageChunkMessage.DuplicateTimestamp",
          "t=%u", payload.frameTimeStamp);
      DEV_ASSERT_MSG(
          result.first->second == _imageBufferIndex,
          "VizControllerImpl.ProcessVizImageChunkMessage.BadInsertion",
          "Expected index:%zu Got:%zu", _imageBufferIndex,
          result.first->second);
#pragma unused(result)  // Avoid unused variable error in Release (only used in
                        // DEV_ASSERTs)
      ...
      // Invalidate anything in encodedImages using the index we are about to
      // start adding chunks to (not the one we just completed; i.e.
      // encodedImage != _bufferedImages[_imageBufferIndex] now because we
      ...
      // Store the mapping for its timestamp to save counter so we can keep
      // saved "viz" images' counters and filenames in sync with these raw
      // images files. Have to do this anytime saveVizImage is enabled (which it
      // could be even while _saveImageMode is Off, thanks to the vision system
      // potentially processing images more slowly than full frame rate) or when
      // it is about to be enabled (when saveImage is true)
      ...
      if (saveImage) {
        ...
        origFilename << "images_" << encodedImage.GetTimeStamp() << "_"
                     << _saveCtr << ".jpg";
        encodedImage.Save(Util::FileUtils::FullFilePath(
            {_savedImagesFolder, origFilename.str()}));
        _saveVizImage = true;
        ++_saveCtr;
    ...
    // For non-camera (debug) images, just display (and save) immediately. No
    // need to wait for any additional "viz" overlay to be added. Note: debug
    // images are only saved in "Stream" mode (not "SingleShot")
    if (displayIndex < 1 || displayIndex > _debugImages.size()) {
      PRINT_NAMED_WARNING(
          "VizControllerImpl.ProcessVizImageChunkMessage.InvalidDisplayIndex",
      ...
      if (isImageReady) {
        if (ImageSendMode::Stream == _saveImageMode) {
          ...
          debugFilename << "debug" << displayIndex << "_"
                        << debugImage.encodedImage.GetTimeStamp() << ".jpg";
          debugImage.encodedImage.Save(Util::FileUtils::FullFilePath(
              {_savedImagesFolder, debugFilename.str()}));
        }

        DisplayImageHelper(debugImage.encodedImage, debugImage.imageRef,
                           debugImage.imageDisplay);
      }
    }
  }
}

void VizControllerImpl::DisplayBufferedCameraImage(
    const RobotTimeStamp_t timestamp) {
  ...
  DEV_ASSERT_MSG(timestamp == encodedImage.GetTimeStamp(),
                 ...
                 "key=%u vs. encImg=%u", (TimeStamp_t)timestamp,
                 (TimeStamp_t)encodedImage.GetTimeStamp());

  if (_saveVizImage && _curImageTimestamp > 0) {
    if (!_savedImagesFolder.empty() &&
        !Util::FileUtils::CreateDirectory(_savedImagesFolder, false, true)) {
      PRINT_NAMED_WARNING("VizControllerImpl.CreateDirectory",
    ...
    if (saveCtrIter != _bufferedSaveCtrs.end()) {
      ...
      webots::ImageRef* copyImg = _camDisp->imageCopy(
          0, 0, _camDisp->getWidth(), _camDisp->getHeight());
      std::stringstream vizFilename;
      vizFilename << "viz_images_" << _curImageTimestamp << "_"
                  << saveCtrIter->second << ".png";
      _camDisp->imageSave(copyImg,
                          Util::FileUtils::FullFilePath(
                              {_savedImagesFolder, vizFilename.str()}));
      _camDisp->imageDelete(copyImg);
      _saveVizImage = false;

      // Remove all saved counters up to and including timestamp we just saved
      // (the assumption is we never go backward, so once we've saved this one,
      // we don't need it or anything that came before it)
  ...
  // Store the timestamp for the currently displayed image so we can use it to
  // save that image with the right filename next call
  _curImageTimestamp = timestamp;

  DisplayCameraInfo(timestamp);

  // Remove all encoded images up to and including the specified timestamp (the
  // assumption is we never go backward, so once we've displayed this one, we
  // don't need it or anything that came before it)
  _encodedImages.erase(_encodedImages.begin(), ++encImgIter);
}

void VizControllerImpl::ProcessCameraParams(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
...
void VizControllerImpl::DisplayCameraInfo(const RobotTimeStamp_t timestamp) {
  ...
  _camDisp->drawText(
      std::to_string((TimeStamp_t)timestamp), 1,
      _camDisp->getHeight() - 9);  // display timestamp at lower left
  _camDisp->drawText(
      text, _camDisp->getWidth() - 144,
      _camDisp->getHeight() - 9);  // display exposure in bottom right

  snprintf(text, sizeof(text), "AWB:%.3f %.3f %.3f\n",
           _cameraParams.whiteBalanceGainR, _cameraParams.whiteBalanceGainG,
           _cameraParams.whiteBalanceGainB);
  SetColorHelper(_camDisp, NamedColors::RED);
  _camDisp->drawText(text, _camDisp->getWidth() - 180,
                     _camDisp->getHeight() - 18);
}

void VizControllerImpl::ProcessVizTrackerQuadMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  const auto& payload = msg.GetData().Get_TrackerQuad();
  _camDisp->setColor(0x0000ff);
  _camDisp->drawLine((int)payload.topLeft_x, (int)payload.topLeft_y,
                     (int)payload.topRight_x, (int)payload.topRight_y);
  _camDisp->setColor(0x00ff00);
  _camDisp->drawLine((int)payload.topRight_x, (int)payload.topRight_y,
                     (int)payload.bottomRight_x, (int)payload.bottomRight_y);
  _camDisp->drawLine((int)payload.bottomRight_x, (int)payload.bottomRight_y,
                     (int)payload.bottomLeft_x, (int)payload.bottomLeft_y);
  _camDisp->drawLine((int)payload.bottomLeft_x, (int)payload.bottomLeft_y,
                     (int)payload.topLeft_x, (int)payload.topLeft_y);
}

void VizControllerImpl::ProcessVizRobotStateMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  const auto& payload = msg.GetData().Get_RobotStateMessage();
  char txt[128];

  sprintf(txt, "Pose: %6.1f, %6.1f, ang: %4.1f  [fid: %u, oid: %u]",
          payload.state.pose.x, payload.state.pose.y,
          RAD_TO_DEG(payload.state.pose.angle), payload.state.pose_frame_id,
          payload.state.pose_origin_id);
  DrawText(_disp, (u32)VizTextLabelType::TEXT_LABEL_POSE,
           Anki::NamedColors::GREEN, txt);
  ...
  DrawText(_disp, (u32)VizTextLabelType::TEXT_LABEL_HEAD_LIFT,
           Anki::NamedColors::GREEN, txt);
  ...
  DrawText(_disp, (u32)VizTextLabelType::TEXT_LABEL_PITCH,
           Anki::NamedColors::GREEN, txt);

  sprintf(txt, "Roll: %4.1f deg", RAD_TO_DEG(payload.state.pose.roll_angle));
  DrawText(_disp, (u32)VizTextLabelType::TEXT_LABEL_ROLL,
           Anki::NamedColors::GREEN, txt);

  sprintf(txt, "Acc:  %6.0f %6.0f %6.0f mm/s2  ImuTemp %+6.2f degC",
          payload.state.accel.x, payload.state.accel.y, payload.state.accel.z,
          payload.imuTemperature_degC);
  DrawText(_disp, (u32)VizTextLabelType::TEXT_LABEL_ACCEL,
           Anki::NamedColors::GREEN, txt);

  sprintf(txt, "Gyro: %6.1f %6.1f %6.1f deg/s",
          RAD_TO_DEG(payload.state.gyro.x), RAD_TO_DEG(payload.state.gyro.y),
          RAD_TO_DEG(payload.state.gyro.z));
  DrawText(_disp, (u32)VizTextLabelType::TEXT_LABEL_GYRO,
           Anki::NamedColors::GREEN, txt);

  bool cliffDetected = payload.state.cliffDetectedFlags > 0;
  sprintf(txt, "Cliff: {%4u, %4u, %4u, %4u} thresh: {%4u, %4u, %4u, %4u}",
          payload.state.cliffDataRaw[0], payload.state.cliffDataRaw[1],
          payload.state.cliffDataRaw[2], payload.state.cliffDataRaw[3],
          payload.cliffThresholds[0], payload.cliffThresholds[1],
          payload.cliffThresholds[2], payload.cliffThresholds[3]);
  DrawText(_disp, (u32)VizTextLabelType::TEXT_LABEL_CLIFF,
           cliffDetected ? Anki::NamedColors::RED : Anki::NamedColors::GREEN,
           txt);

  const auto& proxData = payload.state.proxData;
  sprintf(txt, "Dist: %4u mm, sigStrength: %5.3f, ambient: %5.3f status %s",
          proxData.distance_mm, proxData.signalIntensity / proxData.spadCount,
          100.f * proxData.ambientIntensity / proxData.spadCount,
          RangeStatusToString(proxData.rangeStatus));
  DrawText(_disp, (u32)VizTextLabelType::TEXT_LABEL_DIST,
           Anki::NamedColors::GREEN, txt);

  sprintf(txt, "Speed L: %4d  R: %4d mm/s",
          (int)payload.state.lwheel_speed_mmps,
          (int)payload.state.rwheel_speed_mmps);
  DrawText(_disp, (u32)VizTextLabelType::TEXT_LABEL_SPEEDS,
           Anki::NamedColors::GREEN, txt);
  ...
  sprintf(
      txt, "OffTreadsState: %s  %s", EnumToString(currTreadState),
      (currTreadState != nextTreadState) ? EnumToString(nextTreadState) : "");
  DrawText(_disp, (u32)VizTextLabelType::TEXT_LABEL_OFF_TREADS_STATE,
           onTreads ? Anki::NamedColors::GREEN : Anki::NamedColors::RED, txt);

  sprintf(txt, "Touch: %u", payload.state.backpackTouchSensorRaw);
  DrawText(_disp, (u32)VizTextLabelType::TEXT_LABEL_TOUCH,
           Anki::NamedColors::GREEN, txt);

  sprintf(
      txt, "Batt: %2.2fV, %2uC [%c%c]", payload.batteryVolts,
      payload.state.battTemp_C,
      payload.state.status & (uint32_t)RobotStatusFlag::IS_BATTERY_OVERHEATED
          ? 'H'
          : ' ',
      payload.state.status & (uint32_t)RobotStatusFlag::IS_BATTERY_DISCONNECTED
          ? 'D'
          : ' ');
  DrawText(_disp, (u32)VizTextLabelType::TEXT_LABEL_BATTERY,
           Anki::NamedColors::GREEN, txt);

  sprintf(
      txt, "Locked: %c%c%c, InUse: %c%c%c",
  ...
  DrawText(_disp, (u32)VizTextLabelType::TEXT_LABEL_ANIM_TRACK_LOCKS,
           Anki::NamedColors::GREEN, txt);

  sprintf(txt, "Video: %.1f Hz   Proc: %.1f Hz",
          1000.f / (f32)payload.videoFramePeriodMs,
          1000.f / (f32)payload.imageProcPeriodMs);
  DrawText(_disp, (u32)VizTextLabelType::TEXT_LABEL_VID_RATE,
           Anki::NamedColors::GREEN, txt);

  sprintf(
      txt, "Status: %5s %5s %6s %4s %4s",
      payload.state.status & (uint32_t)RobotStatusFlag::IS_CARRYING_BLOCK
          ? "CARRY"
          : "",
      payload.state.status & (uint32_t)RobotStatusFlag::IS_PICKING_OR_PLACING
          ? "PAP"
          : "",
      ...
      payload.state.status & (uint32_t)RobotStatusFlag::IS_FALLING ? "FALL"
                                                                   : "");
  DrawText(_disp, (u32)VizTextLabelType::TEXT_LABEL_STATUS_FLAG,
           Anki::NamedColors::GREEN, txt);
  ...
  sprintf(
      ...
      payload.state.status & (uint32_t)RobotStatusFlag::IS_CHARGING ? "CHARGING"
                                                                    : "",
      payload.state.status & (uint32_t)RobotStatusFlag::IS_ON_CHARGER
          ? "ON_CHARGER"
          : "",
      payload.state.status & (uint32_t)RobotStatusFlag::IS_BUTTON_PRESSED
          ? "PWR_BTN"
          : "",
      payload.state.status & (uint32_t)RobotStatusFlag::CALM_POWER_MODE ? "CALM"
                                                                        : "");

  DrawText(_disp, (u32)VizTextLabelType::TEXT_LABEL_STATUS_FLAG_2,
           Anki::NamedColors::GREEN, txt);
  ...
  sprintf(
      ...
      payload.state.status & (uint32_t)RobotStatusFlag::IS_PATHING ? "PATH"
                                                                   : "",
      payload.state.status & (uint32_t)RobotStatusFlag::LIFT_IN_POS ? ""
                                                                    : "LIFTING",
      payload.state.status & (uint32_t)RobotStatusFlag::HEAD_IN_POS ? ""
                                                                    : "HEADING",
      payload.state.status & (uint32_t)RobotStatusFlag::IS_MOVING ? "MOVING"
                                                                  : "");
  DrawText(_disp, (u32)VizTextLabelType::TEXT_LABEL_STATUS_FLAG_3,
           Anki::NamedColors::GREEN, txt);
  ...
  if (_saveState) {
    ...
    if (payload.Size() > kMaxPayloadSize) {
      PRINT_NAMED_WARNING(
          "VizController.ProcessVizRobotStateMessage.PayloadSizeTooLarge",
...
void VizControllerImpl::ProcessVizCurrentAnimation(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
...
void VizControllerImpl::ProcessBehaviorStackDebug(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  ...
  _bsmStackDisp->fillRectangle(0, 0, _bsmStackDisp->getWidth(),
                               _bsmStackDisp->getHeight());

  const VizInterface::BehaviorStackDebug& debugData =
      msg.GetData().Get_BehaviorStackDebug();

  for (size_t i = 0; i < debugData.debugStrings.size(); ++i) {
    DrawText(_bsmStackDisp, (u32)i, (u32)Anki::NamedColors::WHITE,
             debugData.debugStrings[i].c_str());
  }
}

void VizControllerImpl::ProcessVisionModeDebug(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  ...
  _visionModeDisp->fillRectangle(0, 0, _visionModeDisp->getWidth(),
                                 _visionModeDisp->getHeight());

  const VizInterface::VisionModeDebug& debugData =
      msg.GetData().Get_VisionModeDebug();

  DrawText(_visionModeDisp, 0, (u32)Anki::NamedColors::WHITE,
           "Vision Schedule:       Mode:");
  for (size_t i = 0; i < debugData.debugStrings.size(); ++i) {
    // Only show full-blown vision modes, not modifiers (which just piggy back
    // on their Modes' schedules) The convention is that modifiers have an
    // underscore in their name
    if (debugData.debugStrings[i].find("_") == std::string::npos) {
      DrawText(_visionModeDisp, (u32)(i + 1), (u32)Anki::NamedColors::GREEN,
               debugData.debugStrings[i].c_str());
    }
  }
}

static inline void SetColorForMode(const std::vector<VisionMode>& modes,
...
static inline void DrawTextHelper(const u32 x, const u32 y,
                                  const std::string& str,
                                  webots::Display* disp) {
  if ((x >= disp->getWidth()) || (y >= disp->getHeight())) {
    LOG_WARNING("VizControllerImpl.DrawTextHelper.StringOOB",
                "'%s': (x,y)=(%d,%d)", str.c_str(), x, y);
  }
  disp->drawText(str, x, y);
}

void VizControllerImpl::ProcessEnabledVisionModes(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  if (_disp == nullptr) {
    return;
  }
  ...
  const u32 fillY = ((uint32_t)VizTextLabelType::NUM_TEXT_LABELS +
                     (uint32_t)TextLabelType::VISION_MODE + 1) *
                    kLineHeight;
  ...
  static std::map<VisionMode, std::list<std::pair<VisionMode, std::string>>>
      kModesMap;
  if (kModesMap.empty()) {
    for (VisionMode m = VisionMode(0); m < VisionMode::Count; m++) {
      ...
      if (isModifier) {
        const VisionMode mode =
            VisionModeFromString(str.substr(0, underscorePos));
        const size_t kMaxModStrLen = 8;
        const std::string modifierStr =
            str.substr(underscorePos + 1,
                       std::min(str.size() - underscorePos, kMaxModStrLen));
  ...
  // Loop over all the modes and draw those _without_ modifiers first, in
  // columns
  u32 index = 0;
  for (auto const& entry : kModesMap) {
    ...
    // Left align text with kTextWidth+1 padding of spaces (+1 for space between
    // modes)
    std::stringstream ss;
  ...
  // Second loop draws those _with_ modifiers, one mode per line, modifiers
  // grouped into [] after
  x = 0;
  y += kLineHeight + 1;
  ...
  for (auto const& entry : kModesMap) {
    ...
    SetColorForMode(data.modes, m, _disp);
    DrawTextHelper(x - kCharWidth, y, "]",
                   _disp);  // -kCharWidth for trailing space
...
void VizControllerImpl::ProcessVizSetOriginMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  const auto& m = msg.GetData().Get_SetVizOrigin();

  _vizControllerPose =
      Pose3d(m.rot_rad, Vec3f(m.rot_axis_x, m.rot_axis_y, m.rot_axis_z),
             Vec3f(MM_TO_M(m.trans_x_mm), MM_TO_M(m.trans_y_mm),
                   MM_TO_M(m.trans_z_mm)));

  WebotsHelpers::SetNodePose(*_vizSupervisor.getSelf(), _vizControllerPose);
}

void VizControllerImpl::ProcessVizMemoryMapMessageBegin(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  _navMapNodes.clear();
  _navMapNodes.reserve(1024);  // reserve some memory to avoid re-allocations
}

void VizControllerImpl::ProcessVizMemoryMapMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  const auto& payload = msg.GetData().Get_MemoryMapMessageViz();
  _navMapNodes.insert(_navMapNodes.end(), payload.quadInfos.begin(),
                      payload.quadInfos.end());
}

void VizControllerImpl::ProcessVizMemoryMapMessageEnd(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  ...
  // Store the pixel coordinates of the center of the image (for later
  // conversion from x/y to image coordinates)
  ...
  for (const auto& node : _navMapNodes) {
    ...
    const float webotsAlpha =
        (rgba & 0xFF) / 255.f;  // convert alpha to 0.0 to 1.0
    _navMapDisp->setAlpha(webotsAlpha);
    _navMapDisp->setColor(webotsColor);

    // Webots requires the x,y position of the rectangle to be the top left
    ...
    // Convert x,y (with origin in the center of the image) to image coordinates
    // (top left of image is origin)
    auto imageX = topLeftCornerX + displayCenterX;
    auto imageY = -topLeftCornerY + displayCenterY;

    // We subtract 1 from the width/height to leave a 'space' between nodes,
    // which allows us to see the individual quads even if they are the same
    // color.
    int width = node.edgeLen_mm - 1;
    int height = node.edgeLen_mm - 1;

    // If the quad would be off the display plane, we still want to draw as much
    // of it as we can
    if (imageX < 0) {
...
void VizControllerImpl::ProcessVizObjectMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
...
void VizControllerImpl::ProcessVizEraseObjectMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
...
void VizControllerImpl::ProcessVizShowObjectsMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
...
void VizControllerImpl::ProcessVizLineSegmentMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
...
void VizControllerImpl::ProcessVizEraseLineSegmentsMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  const auto& payload = msg.GetData().Get_EraseLineSegments();
  EraseVizSegments(payload.identifier);
}

void VizControllerImpl::ProcessVizQuadMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
...
void VizControllerImpl::ProcessVizEraseQuadMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  const auto& payload = msg.GetData().Get_EraseQuad();
  EraseVizQuads((VizQuadType)payload.quadType, payload.quadID);
}

void VizControllerImpl::ProcessVizAppendPathSegmentLineMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
...
void VizControllerImpl::ProcessVizAppendPathSegmentArcMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
...
void VizControllerImpl::ProcessVizSetPathColorMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
...
void VizControllerImpl::ProcessVizErasePathMessage(
    const AnkiEvent<VizInterface::MessageViz>& msg) {
  const auto& payload = msg.GetData().Get_ErasePath();
  EraseVizPath(payload.pathID);
}

void VizControllerImpl::EraseVizObjects(const uint32_t lowerBoundId,
                                        const uint32_t upperBoundId) {
  ...
  // Erase objects in bounds (but first remove them from the scene tree if
  // necessary)
...
void VizControllerImpl::EraseVizQuads(const VizQuadType quadType,
...
void VizControllerImpl::DrawObjects() {
  ...
  constexpr static const FullEnumToValueArray<
      VizObjectType, const char*, VizObjectType::NUM_VIZ_OBJECT_TYPES>
      kVizObjectTypeToProtoString{
  ...
  static_assert(IsSequentialArray(kVizObjectTypeToProtoString),
                "kVizObjectTypeToProtoString array does not define each entry "
  ...
  for (auto& obj : _vizObjects) {
    ...
    if (vizObjectInfo.webotsNodeId < 0) {
      const auto& protoStr =
          kVizObjectTypeToProtoString[Util::EnumToUnderlying(objectType)]
              .Value();
      vizObjectInfo.webotsNodeId =
          WebotsHelpers::AddSceneTreeNode(_vizSupervisor, protoStr);
    }

    // If we don't have a webots node ID at this point, then this is not a
    // drawable object, so just skip it.
    if (vizObjectInfo.webotsNodeId < 0) {
      continue;
    }
    ...
    switch (objectType) {
      ...
      case VizObjectType::VIZ_OBJECT_CHARGER:
        ...
        nodePtr->getField("slopeLength")
            ->setSFFloat(d.objParameters[0] * d.x_size_m);
  ...
  for (auto& segmentInfo : _vizSegments) {
    for (auto& segment : segmentInfo.second) {
      ...
      if (segment.webotsNodeId < 0) {
        segment.webotsNodeId =
            WebotsHelpers::AddSceneTreeNode(_vizSupervisor, "LineSegment {}");
      }
      ...
      double origin[3] = {segment.data.origin[0], segment.data.origin[1],
                          segment.data.origin[2]};
      nodePtr->getField("origin")->setSFVec3f(origin);

      double dest[3] = {segment.data.dest[0], segment.data.dest[1],
                        segment.data.dest[2]};
  ...
  for (auto& quadTypeMap : _vizQuads) {
    for (auto& quad : quadTypeMap.second) {
      ...
      if (quadInfo.webotsNodeId < 0) {
        quadInfo.webotsNodeId =
            WebotsHelpers::AddSceneTreeNode(_vizSupervisor, "WireframeQuad {}");
      }
      ...
      double lowerRight[3] = {data.xLowerRight, data.yLowerRight,
                              data.zLowerRight};
      nodePtr->getField("lowerRight")->setSFVec3f(lowerRight);

      double upperRight[3] = {data.xUpperRight, data.yUpperRight,
                              data.zUpperRight};
...
void VizControllerImpl::DrawPaths() {
  for (auto& pathInfo : _vizPaths) {
    ...
    for (auto& arc : pathInfo.second.arcs) {
      ...
      if (arc.webotsNodeId < 0) {
        arc.webotsNodeId =
            WebotsHelpers::AddSceneTreeNode(_vizSupervisor, "CircularArc {}");
      }
