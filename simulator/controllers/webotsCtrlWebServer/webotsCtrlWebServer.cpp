...
int main(int argc, char** argv) {
  ...
  Util::Data::DataPlatform dataPlatform =
      WebotsCtrlShared::CreateDataPlatformBS(argv[0], "webotsCtrlWebServer");
  ...
  OSState::getInstance()->SetRobotID(
      webserverSupervisor.getSelf()->getField("robotID")->getSFInt32());
  ...
  if (params.filterLog) {
    ...
    if (!dataPlatform.readAsJson(Util::Data::Scope::Resources,
                                 ...
                                 consoleFilterConfig)) {
      LOG_ERROR("webotsCtrlWebServer.main.loadConsoleConfig",
    ...
    LOG_INFO("webotsCtrlWebServer.main.noFilter",
  ...
  LOG_INFO("webotsCtrlWebServer.main",
           "cozmoWebServer created and initialized");
