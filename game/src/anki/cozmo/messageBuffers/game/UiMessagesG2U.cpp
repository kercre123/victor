...
// Full command line: emitters/cozmo_CPP_main_emitter.py -C src -r ../game/include -o ../game/src --header-output-extension .def anki/cozmo/messageBuffers/game/UiMessagesG2U.clad
