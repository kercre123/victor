...
class RtsHandlerV6 : public IRtsHandler {
public:
  RtsHandlerV6(INetworkStream* stream, 
...
private:
  ...
  std::unique_ptr<ExternalCommsCladHandlerV6> _cladHandler;
  ...
  void HandleRtsChallengeMessage(const Vector::ExternalComms::RtsConnection_6& msg);

  Signal::SmartHandle _rtsWifiConnectRequestHandle;
  void HandleRtsWifiConnectRequest(const Vector::ExternalComms::RtsConnection_6& msg);

  Signal::SmartHandle _rtsWifiIpRequestHandle;
  void HandleRtsWifiIpRequest(const Vector::ExternalComms::RtsConnection_6& msg);

  Signal::SmartHandle _rtsRtsStatusRequestHandle;
  void HandleRtsStatusRequest(const Vector::ExternalComms::RtsConnection_6& msg);

  Signal::SmartHandle _rtsWifiScanRequestHandle;
  void HandleRtsWifiScanRequest(const Vector::ExternalComms::RtsConnection_6& msg);

  Signal::SmartHandle _rtsWifiForgetRequestHandle;
  void HandleRtsWifiForgetRequest(const Vector::ExternalComms::RtsConnection_6& msg);

  Signal::SmartHandle _rtsOtaUpdateRequestHandle;
  void HandleRtsOtaUpdateRequest(const Vector::ExternalComms::RtsConnection_6& msg);

  Signal::SmartHandle _rtsOtaCancelRequestHandle;
  void HandleRtsOtaCancelRequest(const Vector::ExternalComms::RtsConnection_6& msg);

  Signal::SmartHandle _rtsWifiAccessPointRequestHandle;
  void HandleRtsWifiAccessPointRequest(const Vector::ExternalComms::RtsConnection_6& msg);

  Signal::SmartHandle _rtsCancelPairingHandle;
  void HandleRtsCancelPairing(const Vector::ExternalComms::RtsConnection_6& msg);

  Signal::SmartHandle _rtsAckHandle;
  void HandleRtsAck(const Vector::ExternalComms::RtsConnection_6& msg);

  Signal::SmartHandle _rtsLogRequestHandle;
  void HandleRtsLogRequest(const Vector::ExternalComms::RtsConnection_6& msg);

  Signal::SmartHandle _rtsCloudSessionHandle;
  void HandleRtsCloudSessionRequest(const Vector::ExternalComms::RtsConnection_6& msg);

  Signal::SmartHandle _rtsAppConnectionIdHandle;
  void HandleRtsAppConnectionIdRequest(const Vector::ExternalComms::RtsConnection_6& msg);

  Signal::SmartHandle _rtsForceDisconnectHandle;
  void HandleRtsForceDisconnect(const Vector::ExternalComms::RtsConnection_6& msg);

  Signal::SmartHandle _rtsSdkProxyHandle;
  void HandleRtsSdkProxyRequest(const Vector::ExternalComms::RtsConnection_6& msg);
