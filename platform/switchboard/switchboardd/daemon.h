...
class Daemon {
 ...
 private:
  ...
  static void HandleEngineTimer(struct ev_loop* loop, struct ev_timer* w,
                                int revents);
  static void HandleTokenTimer(struct ev_loop* loop, struct ev_timer* w,
                               int revents);
  static void HandleAnkibtdTimer(struct ev_loop* loop, struct ev_timer* w,
                                 int revents);
