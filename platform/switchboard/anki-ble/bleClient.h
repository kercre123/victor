...
namespace Switchboard { 
  ...
  private:
    ...
    const std::string kEncryptedReadCharacteristicUUID = "7D2A4BDA-D29B-4152-B725-2491478C5CD7";

    const std::string kPlainTextWriteCharacteristicUUID = "30619F2D-0F54-41BD-A65A-7588D8C85B45";
    const std::string kEncryptedWriteCharacteristicUUID = "30619F2D-0F54-41BD-A65A-7588D8C85B45";
