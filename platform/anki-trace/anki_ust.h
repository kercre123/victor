...
TRACEPOINT_EVENT(anki_ust, anki_fault_code, TP_ARGS(int, code),
                 TP_FIELDS(ctf_integer(int, c, code)))

TRACEPOINT_EVENT(anki_ust, vic_anim_loop_duration, TP_ARGS(long long, duration),
                 TP_FIELDS(ctf_integer(long long, duration, duration)))

TRACEPOINT_EVENT(anki_ust, vic_robot_loop_duration,
                 TP_ARGS(long long, duration),
                 TP_FIELDS(ctf_integer(long long, duration, duration)))

TRACEPOINT_EVENT(anki_ust, vic_robot_robot_loop_period,
                 TP_ARGS(long long, delay),
                 TP_FIELDS(ctf_integer(long long, delay, delay)))

TRACEPOINT_EVENT(anki_ust, vic_engine_loop_duration,
                 TP_ARGS(long long, duration),
                 TP_FIELDS(ctf_integer(long long, duration, duration)))
