...
#define FIXMODE_PACKOUT1       33
#define FIXMODE_LIFETEST       36
#define FIXMODE_RECHARGE1      37
#define FIXMODE_RECHARGE2      38
...
#define FIXMODE_INFO_INIT_DATA                                                                                                        \
  ...
  { "PACKOUT1"    , TestRobotDetect     , TestRobotPackoutGetTests    , TestRobotCleanup            , FIXMODE_PACKOUT1    },  /*33*/  \
  { NULL          , NULL                , NULL                        , NULL                        , -1 },                           \
  { NULL          , NULL                , NULL                        , NULL                        , -1 },                           \
  { "LIFETEST"    , TestRobotDetect     , TestRobotLifetestGetTests   , TestRobotCleanup            , FIXMODE_LIFETEST    },  /*36*/  \
  { "RECHARGE1"   , TestRobotDetect     , TestRobotRecharge1GetTests  , TestRobotCleanup            , FIXMODE_RECHARGE1   },  /*37*/  \
  { "RECHARGE2"   , TestRobotDetect     , TestRobotRecharge2GetTests  , TestRobotCleanup            , FIXMODE_RECHARGE2   },  /*38*/  \
...
#define ERROR_SERIAL_INVALID        913   // When the serial number of this fixture exceeds 255 it can't make cubes!
...
// SWD Errors
#define ERROR_SWD_ZERO_UID          960   // ?
#define ERROR_SWD_JTAG_LOCK         961   // failed to lock jtag
#define ERROR_SWD_VERIFY_FAILED     962   // failed flash write verification
...
// Charge contact comms (testport) errors
