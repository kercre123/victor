...
namespace {
  ...
  static const char* _animAltPath = "/anki/data/assets/cozmo_resources/config/engine/animations/boot_anim_alt.raw";
...
int main(int argc, char** argv)
{
  ...
  if (Anki::Vector::IsXray()) {
    fd = open(_animAltPath, O_RDONLY);
  } else {
    fd = open(_animPath, O_RDONLY);
  }
  
  if(fd < 0)
  {
    printf("Failed to open boot anim\n");
    return -1;
  }
