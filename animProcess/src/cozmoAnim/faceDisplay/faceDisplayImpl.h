...
class FaceDisplayImpl {
 public:
  ...
  // 'frame' is a buffer of FACE_DISPLAY_WIDTH x FACE_DISPLAY_HEIGHT u16s where
  // each pixel is a RGB_565 value. You can use OpenCV to create the frame like
  // so.
  //
  //      Vision::ImageRGB testImg;
  //      testImg.Load("testPattern.jpg");
  //      testImg.Resize(FaceDisplay::FACE_DISPLAY_HEIGHT,
  //      FaceDisplay::FACE_DISPLAY_WIDTH); cv::Mat img565;
