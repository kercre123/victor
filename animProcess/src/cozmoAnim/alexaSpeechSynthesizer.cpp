...
//void AlexaSpeechSynthesizer::addObserver(std::shared_ptr<SpeechSynthesizerObserverInterface> observer) {
//    ACSDK_DEBUG9(LX("addObserver").d("observer", observer.get()));
//    m_executor.submit([this, observer]() { m_observers.insert(observer); });
//}
//
//void AlexaSpeechSynthesizer::removeObserver(std::shared_ptr<SpeechSynthesizerObserverInterface> observer) {
//    ACSDK_DEBUG9(LX("removeObserver").d("observer", observer.get()));
//    m_executor.submit([this, observer]() { m_observers.erase(observer); }).wait();
//}
//
//void AlexaSpeechSynthesizer::onDeregistered() {
...
//
//void AlexaSpeechSynthesizer::onFocusChanged(FocusState newFocus) {
...
//}
//
//void AlexaSpeechSynthesizer::provideState(
...
//}
//
//void AlexaSpeechSynthesizer::onContextAvailable(const std::string& jsonContext) {
//    ACSDK_DEBUG9(LX("onContextAvailable").d("context", jsonContext));
//    // default no-op
//}
//
//void AlexaSpeechSynthesizer::onContextFailure(const ContextRequestError error) {
//    ACSDK_DEBUG9(LX("onContextFailure").d("error", error));
//    // default no-op
//}
//
//void AlexaSpeechSynthesizer::onPlaybackStarted(SourceId id) {
...
//}
//
//void AlexaSpeechSynthesizer::onPlaybackFinished(SourceId id) {
...
//}
//
//void AlexaSpeechSynthesizer::onPlaybackError(
//    SourceId id,
...
//}
//
//void AlexaSpeechSynthesizer::onPlaybackStopped(SourceId id) {
//    ACSDK_DEBUG9(LX("onPlaybackStopped").d("callbackSourceId", id));
//    onPlaybackFinished(id);
//}
//
//AlexaSpeechSynthesizer::SpeakDirectiveInfo::SpeakDirectiveInfo(std::shared_ptr<DirectiveInfo> directiveInfo) :
...
//}
//
//void AlexaSpeechSynthesizer::SpeakDirectiveInfo::clear() {
...
//}
//
//AlexaSpeechSynthesizer::SpeechSynthesizer(
//    std::shared_ptr<MediaPlayerInterface> mediaPlayer,
//    std::shared_ptr<MessageSenderInterface> messageSender,
//    std::shared_ptr<FocusManagerInterface> focusManager,
//    std::shared_ptr<ContextManagerInterface> contextManager,
...
//void AlexaSpeechSynthesizer::doShutdown() {
...
//void AlexaSpeechSynthesizer::init() {
...
//void AlexaSpeechSynthesizer::executeHandleImmediately(std::shared_ptr<DirectiveInfo> info) {
...
//}
//
//void AlexaSpeechSynthesizer::executePreHandleAfterValidation(std::shared_ptr<SpeakDirectiveInfo> speakInfo) {
...
//}
//
//void AlexaSpeechSynthesizer::executeHandleAfterValidation(std::shared_ptr<SpeakDirectiveInfo> speakInfo) {
...
//}
//
//void AlexaSpeechSynthesizer::executePreHandle(std::shared_ptr<DirectiveInfo> info) {
...
//}
//
//void AlexaSpeechSynthesizer::executeHandle(std::shared_ptr<DirectiveInfo> info) {
...
//}
//
//void AlexaSpeechSynthesizer::executeCancel(std::shared_ptr<DirectiveInfo> info) {
...
//}
//
//void AlexaSpeechSynthesizer::executeStateChange() {
...
//}
//
//void AlexaSpeechSynthesizer::executeProvideState(const unsigned int& stateRequestToken) {
...
//}
//
//void AlexaSpeechSynthesizer::executePlaybackStarted() {
...
//}
//
//void AlexaSpeechSynthesizer::executePlaybackFinished() {
...
//}
//
//void AlexaSpeechSynthesizer::executePlaybackError(const avsCommon::utils::mediaPlayer::ErrorType& type, std::string error) {
...
//}
//
//std::string AlexaSpeechSynthesizer::buildState(std::string& token, int64_t offsetInMilliseconds) const {
...
//}
//
//std::string AlexaSpeechSynthesizer::buildPayload(std::string& token) {
...
//}
//
//void AlexaSpeechSynthesizer::startPlaying() {
...
//}
//
//void AlexaSpeechSynthesizer::stopPlaying() {
...
//}
//
//void AlexaSpeechSynthesizer::setCurrentStateLocked(SpeechSynthesizerObserverInterface::SpeechSynthesizerState newState) {
...
//}
//
//void AlexaSpeechSynthesizer::setDesiredStateLocked(FocusState newFocus) {
//    switch (newFocus) {
//        case FocusState::FOREGROUND:
...
//}
//
//void AlexaSpeechSynthesizer::resetCurrentInfo(std::shared_ptr<SpeakDirectiveInfo> speakInfo) {
...
//}
//
//void AlexaSpeechSynthesizer::setHandlingCompleted() {
...
//}
//
//void AlexaSpeechSynthesizer::sendExceptionEncounteredAndReportFailed(
...
//}
//
//void AlexaSpeechSynthesizer::sendExceptionEncounteredAndReportMissingProperty(
//    std::shared_ptr<SpeakDirectiveInfo> speakInfo,
...
//}
//
//void AlexaSpeechSynthesizer::releaseForegroundFocus() {
...
//}
//
//std::shared_ptr<AlexaSpeechSynthesizer::SpeakDirectiveInfo> AlexaSpeechSynthesizer::validateInfo(
...
//}
//
//std::shared_ptr<AlexaSpeechSynthesizer::SpeakDirectiveInfo> AlexaSpeechSynthesizer::getSpeakDirectiveInfo(
...
//}
//
//bool AlexaSpeechSynthesizer::setSpeakDirectiveInfo(
//    const std::string& messageId,
//    std::shared_ptr<AlexaSpeechSynthesizer::SpeakDirectiveInfo> speakDirectiveInfo) {
//    std::lock_guard<std::mutex> lock(m_speakDirectiveInfoMutex);
//    auto it = m_speakDirectiveInfoMap.find(messageId);
//    if (it != m_speakDirectiveInfoMap.end()) {
//        return false;
...
//}
//
//void AlexaSpeechSynthesizer::removeSpeakDirectiveInfo(const std::string& messageId) {
//    std::lock_guard<std::mutex> lock(m_speakDirectiveInfoMutex);
//    m_speakDirectiveInfoMap.erase(messageId);
//}
//
//void AlexaSpeechSynthesizer::addToDirectiveQueue(std::shared_ptr<SpeakDirectiveInfo> speakInfo) {
//    std::lock_guard<std::mutex> lock(m_speakInfoQueueMutex);
//    if (m_speakInfoQueue.empty()) {
...
//}
//
//void AlexaSpeechSynthesizer::resetMediaSourceId() {
//    m_mediaSourceId = MediaPlayerInterface::ERROR;
//}
//
//void AlexaSpeechSynthesizer::onDialogUXStateChanged(
...
//}
//
//void AlexaSpeechSynthesizer::executeOnDialogUXStateChanged(
//    avsCommon::sdkInterfaces::DialogUXStateObserverInterface::DialogUXState newState) {
