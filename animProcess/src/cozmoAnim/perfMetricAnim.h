...
class PerfMetricAnim : public PerfMetric {
 public:
  ...
  void SetAnimationStreamer(Anim::AnimationStreamer* animationStreamer) {
 ...
 private:
  ...
  // Frame size:  Base struct is 16 bytes; plus this struct is 20 bytes = 36
  // bytes total x 1000 frames is roughly 35 KB
