...
// Switches precision between single (1) and double (0).
// Note that NEON instructions are only available in single precision.
// If you change this, switch the lib included in fftw.cmake. Ideally both of these
// would be a single build flag.
#ifndef FFTW_SINGLE
