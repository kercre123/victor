...
class MicImmediateDirection {
 ...
 private:
  static constexpr uint32_t kMicDirectionBuffer_ms =
      700 + kTriggerOverlapSize_ms;
  static constexpr uint32_t kMicDirectionBufferLen =
      kMicDirectionBuffer_ms / kTimePerChunk_ms;
