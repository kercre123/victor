...
#define ENCODED_COLOR(color)  (((color << 24) & LED_IR) ? (u16)LED_ENC_IR : 0)    | \
                             ((((color >> 8) & LED_RED)   >> (16 + 3)) << (u32)LED_ENC_RED_SHIFT) | \
                             ((((color >> 8) & LED_GREEN) >> ( 8 + 3)) << (u32)LED_ENC_GRN_SHIFT) | \
                             ((((color >> 8) & LED_BLUE)  >> ( 0 + 3)) << (u32)LED_ENC_BLU_SHIFT)
