...
//#include "SampleApp/AlexaLogger.h"
...
#define CONSOLE_LOG(x) PRINT_NAMED_WARNING("ALEXA", "%s", std::string{x}.c_str())
      ...
      void AlexaLogger::onDialogUXStateChanged(DialogUXState state) {
      ...
      void AlexaLogger::onConnectionStatusChanged(const Status status, const ChangedReason reason) {
      ...
      void AlexaLogger::onSettingChanged(const std::string& key, const std::string& value) {
      ...
      void AlexaLogger::onSpeakerSettingsChanged(
      ...
      void AlexaLogger::onSetIndicator(avsCommon::avs::IndicatorState state) {
      ...
      void AlexaLogger::onRequestAuthorization(const std::string& url, const std::string& code) {
      ...
      void AlexaLogger::onCheckingForAuthorization() {
      ...
      void AlexaLogger::onAuthStateChange(AuthObserverInterface::State newState, AuthObserverInterface::Error newError) {
          ...
          if (m_authState != newState) {
            ...
            switch (m_authState) {
              ...
              case AuthObserverInterface::State::UNRECOVERABLE_ERROR:
                ...
                CONSOLE_LOG({oss.str() + ENTER_LIMITED});
      ...
      void AlexaLogger::onCapabilitiesStateChange(
      ...
      void AlexaLogger::printWelcomeScreen() {
        m_executor.submit([]() { CONSOLE_LOG(ALEXA_WELCOME_MESSAGE); });
      }
      
      void AlexaLogger::printHelpScreen() {
        m_executor.submit([]() { CONSOLE_LOG(HELP_MESSAGE); });
      }
      
      void AlexaLogger::printLimitedHelp() {
        m_executor.submit(
                          [this]() { CONSOLE_LOG(LIMITED_HELP_HEADER + m_failureStatus + LIMITED_HELP_MESSAGE); });
      }
      
      void AlexaLogger::printSettingsScreen() {
        m_executor.submit([]() { CONSOLE_LOG(SETTINGS_MESSAGE); });
      }
      
      void AlexaLogger::printLocaleScreen() {
        m_executor.submit([]() { CONSOLE_LOG(LOCALE_MESSAGE); });
      }
      
      void AlexaLogger::printSpeakerControlScreen() {
        m_executor.submit([]() { CONSOLE_LOG(SPEAKER_CONTROL_MESSAGE); });
      }
      
      void AlexaLogger::printFirmwareVersionControlScreen() {
        m_executor.submit([]() { CONSOLE_LOG(FIRMWARE_CONTROL_MESSAGE); });
      }
      
      void AlexaLogger::printVolumeControlScreen() {
        m_executor.submit([]() { CONSOLE_LOG(VOLUME_CONTROL_MESSAGE); });
      }
      
      void AlexaLogger::printESPControlScreen(bool support, const std::string& voiceEnergy, const std::string& ambientEnergy) {
      ...
      void AlexaLogger::printCommsControlScreen() {
        m_executor.submit([]() { CONSOLE_LOG(COMMS_MESSAGE); });
      }
      
      void AlexaLogger::printErrorScreen() {
        m_executor.submit([]() { CONSOLE_LOG("Invalid Option"); });
      }
      
      void AlexaLogger::microphoneOff() {
        m_executor.submit([]() { CONSOLE_LOG("Microphone Off!"); });
      }
      
      void AlexaLogger::printResetConfirmation() {
        m_executor.submit([]() { CONSOLE_LOG(RESET_CONFIRMATION); });
      }
      
      void AlexaLogger::printResetWarning() {
        m_executor.submit([]() { CONSOLE_LOG(RESET_WARNING); });
      }
      
      void AlexaLogger::microphoneOn() {
        m_executor.submit([this]() { printState(); });
      }
      
      void AlexaLogger::printState() {
      ...
      void AlexaLogger::printESPDataOverrideNotSupported() {
        m_executor.submit([]() { CONSOLE_LOG("Cannot override ESP Value in this device."); });
      }
      
      void AlexaLogger::printESPNotSupported() {
        m_executor.submit([]() { CONSOLE_LOG("ESP is not supported in this device."); });
      }
      
      void AlexaLogger::printCommsNotSupported() {
        m_executor.submit([]() { CONSOLE_LOG("Comms is not supported in this device."); });
      }
      
      void AlexaLogger::setFailureStatus(const std::string& status) {
