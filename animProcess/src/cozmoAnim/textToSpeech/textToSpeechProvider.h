 ...
 * given string. This class declares an interface common to all
 * platform-specific implementations. This is done to insulate engine and audio
 * code from details of text-to-speech implementation.
 *
...
//
// TextToSpeechProviderData is used to hold audio returned from TTS provider to
// engine. Audio data is automatically released when the object is destroyed.
//
...
//
// TextToSpeechProvider defines a common interface for various platform-specific
// implementations.
//
class TextToSpeechProvider {
 public:
  TextToSpeechProvider(const Anim::AnimContext* ctx,
