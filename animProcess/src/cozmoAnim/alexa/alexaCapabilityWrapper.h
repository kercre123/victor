...
class AlexaCapabilityWrapper
 ...
 public:
  ...
  AlexaCapabilityWrapper(
      const std::string& nameSpace,
      std::shared_ptr<alexaClientSDK::avsCommon::avs::CapabilityAgent>
          capabilityAgent,
  ...
  virtual alexaClientSDK::avsCommon::avs::DirectiveHandlerConfiguration
  getConfiguration() const override;

 private:
  void RunDirectiveCallback(
      const std::shared_ptr<alexaClientSDK::avsCommon::avs::AVSDirective>&
          directive);
