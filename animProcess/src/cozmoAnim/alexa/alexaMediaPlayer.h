...
private:
  ...
  std::map<SourceId, std::shared_ptr< alexaClientSDK::avsCommon::avs::attachment::AttachmentReader >> _sourceReaders;
  std::map<SourceId, std::shared_ptr< std::istream >> _sourceStreams;
