...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
AlexaCapabilityWrapper::AlexaCapabilityWrapper(
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void AlexaCapabilityWrapper::preHandleDirective(
    std::shared_ptr<DirectiveInfo> info) {
  // note: this AVS method was made public only for the purpose of this wrapper,
  // so if you delete the wrapper, revert the libs
  _capabilityAgent->preHandleDirective(info);
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void AlexaCapabilityWrapper::handleDirective(
    std::shared_ptr<DirectiveInfo> info) {
  if (info != nullptr) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void AlexaCapabilityWrapper::cancelDirective(
    std::shared_ptr<DirectiveInfo> info) {
  // note: this AVS method was made public only for the purpose of this wrapper,
  // so if you delete the wrapper, revert the libs
  // TODO: implement cancel directive callback. the ones we care about (time)
  // come with separate directives)
  _capabilityAgent->cancelDirective(info);
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void AlexaCapabilityWrapper::handleDirectiveImmediately(
...
AlexaCapabilityWrapper::getConfiguration() const {
  // note: this AVS method was made public only for the purpose of this wrapper,
  // so if you delete the wrapper, revert the libs
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - -
void AlexaCapabilityWrapper::RunDirectiveCallback(
