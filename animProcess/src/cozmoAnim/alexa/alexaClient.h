...
class AlexaClient : private Util::noncopyable,
 ...
 public:
  ...
  static std::unique_ptr<AlexaClient> Create(
      ...
      std::shared_ptr<
          ...
          authDelegate,
      std::shared_ptr<alexaClientSDK::certifiedSender::MessageStorageInterface>
          messageStorage,
      std::shared_ptr<alexaClientSDK::capabilityAgents::alerts::storage::
                          AlertStorageInterface>
          alertStorage,
      std::shared_ptr<alexaClientSDK::capabilityAgents::notifications::
                          NotificationsStorageInterface>
          notificationsStorage,
      std::shared_ptr<
          alexaClientSDK::capabilityAgents::settings::SettingsStorageInterface>
          settingsStorage,
      std::shared_ptr<
          alexaClientSDK::settings::storage::DeviceSettingStorageInterface>
          deviceSettingStorage,
      std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::audio::
  ...
  void Connect(const std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::
                                         CapabilitiesDelegateInterface>&
                   capabilitiesDelegate);
  ...
  std::future<bool> NotifyOfTapToTalk(
      ...
      alexaClientSDK::avsCommon::avs::AudioInputStream::Index beginIndex =
          alexaClientSDK::capabilityAgents::aip::AudioInputProcessor::
              INVALID_INDEX,
  ...
  void AddAlertObserver(
      std::shared_ptr<
          alexaClientSDK::capabilityAgents::alerts::AlertObserverInterface>
          observer);
  ...
  using OnDirectiveFunc = std::function<void(
      const std::string&, const std::string&, const std::string&)>;
  void SetDirectiveCallback(const OnDirectiveFunc& onDirective) {
    _onDirectiveFunc = onDirective;
  }
 ...
 private:
  ...
  std::shared_ptr<alexaClientSDK::afml::AudioActivityTracker>
      _audioActivityTracker;
  ...
  std::shared_ptr<alexaClientSDK::avsCommon::avs::ExceptionEncounteredSender>
      _exceptionSender;

  std::shared_ptr<alexaClientSDK::certifiedSender::CertifiedSender>
      _certifiedSender;

  std::shared_ptr<alexaClientSDK::capabilityAgents::aip::AudioInputProcessor>
      _audioInputProcessor;

  std::shared_ptr<
      alexaClientSDK::capabilityAgents::speechSynthesizer::SpeechSynthesizer>
      _speechSynthesizer;

  std::shared_ptr<alexaClientSDK::capabilityAgents::audioPlayer::AudioPlayer>
      _audioPlayer;

  std::shared_ptr<
      alexaClientSDK::capabilityAgents::alerts::AlertsCapabilityAgent>
      _alertsCapabilityAgent;

  std::shared_ptr<alexaClientSDK::capabilityAgents::interactionModel::
  ...
  std::shared_ptr<
      alexaClientSDK::capabilityAgents::system::UserInactivityMonitor>
  ...
  std::shared_ptr<alexaClientSDK::capabilityAgents::settings::Settings>
      _settings;
  ...
  std::shared_ptr<alexaClientSDK::capabilityAgents::doNotDisturb::
                      DoNotDisturbCapabilityAgent>
      _dndCapabilityAgent;

  std::shared_ptr<alexaClientSDK::capabilityAgents::system::SoftwareInfoSender>
      _softwareInfoSender;
  ...
  // IMPORTANT: Adding another shared_ptr? Keep the order of shared_ptrs of SDK
  // objects in the same order as in the SDK's DefaultClient.h. There could
  // otherwise be a risk of circular refs among shared_ptrs because of liberal
