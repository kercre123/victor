...
class AudioLayerManager : public ITrackLayerManager<RobotAudioKeyFrame> {
 public:
  ...
  // Generates a track of all audio "keyframes" necessary for creating audio
  // glitch sounds Needs to know how many keyframes to generate so that the
  // audio matches with other animation tracks
  void GenerateGlitchAudio(
      u32 numFramesToGen,
