...
void BackpackLayerManager::GenerateGlitchLights(
  ...
  // Remove the random light from the set of lights we can pick so we don't pick
  it again backpackLightsToPickFrom.erase(backpackLightsToPickFrom.begin() +
  rand);
