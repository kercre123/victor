...
//  RecogData_v6(recog_t* recog, searchs_t* search, bool isPhraseSpotted, bool allowsFollowupRecog);
  ...
  RecogData_v6& operator=(RecogData_v6&& other);
...
using RecogDataSP = std::shared_ptr<RecogData_v6>;
  
template <typename ...Args>
static RecogDataSP MakeRecogDataSP(Args&& ...args)
{
  return std::shared_ptr<RecogData_v6>(new RecogData_v6(std::forward<Args>(args)...));
}
