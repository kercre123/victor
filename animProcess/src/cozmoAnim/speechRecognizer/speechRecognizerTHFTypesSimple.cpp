...
RecogData::RecogData(recog_t* recog, searchs_t* search, bool isPhraseSpotted,
...
RecogData::~RecogData() { DestroyData(_recognizer, _search); }

RecogData::RecogData(RecogData&& other)
    : _recognizer(other._recognizer), _search(other._search) {
