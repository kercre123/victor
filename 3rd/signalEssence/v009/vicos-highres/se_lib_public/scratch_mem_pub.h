...
// useful for debug
void ScratchGetHighWaterMarkSummary(size_t *pForX, size_t *pForH,
                                    size_t *pForS);
 ...
 */
void *ScratchGetBuf_real(ScratchPool_t pool, size_t numRequested, const char *,
                         int);
void *ScratchGetBufZ_real(ScratchPool_t pool, size_t numRequested, const char *,
                          int);
...
#define ScratchGetBuf(pool, len) \
  ScratchGetBuf_real(pool, len, __FILE__, __LINE__)
...
#define ScratchGetBufZ(pool, len) \
  ScratchGetBuf_real(pool, len, __FILE__, __LINE__)
...
#define ScratchReleaseBuf(pool, pBuf) \
  ScratchReleaseBuf_real(pool, pBuf, __FILE__, __LINE__)
#define ScratchReleaseBufX(pBuf) \
  ScratchReleaseBuf_real(POOL_X, pBuf, __FILE__, __LINE__)
#define ScratchReleaseBufH(pBuf) \
  ScratchReleaseBuf_real(POOL_H, pBuf, __FILE__, __LINE__)
#define ScratchReleaseBufS(pBuf) \
  ScratchReleaseBuf_real(POOL_S, pBuf, __FILE__, __LINE__)

#define ScratchCheckBuf \
  (pool, pBuf) ScratchCheckBuf_real(pool, pbuf, __FILE__, __LINE__)
#define ScratchCheckBufX(pool, pBuf) \
  ScratchCheckBuf_real(POOL_X, pbuf, __FILE__, __LINE__)
#define ScratchCheckBufH(pool, pBuf) \
  ScratchCheckBuf_real(POOL_H, pbuf, __FILE__, __LINE__)
#define ScratchCheckBufS(pool, pBuf) \
  ScratchCheckBuf_real(POOL_S, pbuf, __FILE__, __LINE__)
