...
#define FR_ABS_INT16(x)                          \
  ((int16)(x) == (SE_MIN_INT16) ? (SE_MAX_INT16) \
                                : ((int16)(x)) < 0 ? -(x) : (x))

#define FR_ABS_INT32(x)                          \
  ((int32)(x) == (SE_MIN_INT32) ? (SE_MAX_INT32) \
                                : ((int32)(x)) < 0 ? -(x) : (x))
...
int16 FrMultiply(int16, /* 1st multiplicand */
                 int16  /* 2nd multiplicand */
);

int16 FrMultiplyWithExp(int16, /* 1st multiplicand */
                        int16, /* 2nd multiplicand */
                        int16  /* number of left shifts */
);

int16 FrMultiplyRightShifts(int16 x,     /* 1st multiplicand */
                            int16 y,     /* 2nd multiplicand */
                            uint16 rs);  // number of right shifts

int16 FrMultiplyLeftShifts(int16 x,     /* 1st multiplicand */
                           int16 y,     /* 2nd multiplicand */
...
int16 FracMulNormExp(int16,  /* 1st multiplicand */
                     int16,  /* 2nd multiplicand */
                     int16 * /* * to result */
);
...
int16 FrMulAdd(int16 x,   // 1st multiplicand
               int16 y,   // 2nd multiplicand
...
int16 FrMulAddNoSat(int16 x,   // 1st multiplicand
                    int16 y,   // 2nd multiplicand
                    int16 z);  // number to add
...
static INLINE int16 LimitInt32ToInt16_ansi(int32 x32) {
  return (x32 > SE_MAX_INT16)
             ? SE_MAX_INT16
             : (x32 < SE_MIN_INT16) ? SE_MIN_INT16 : (int16)x32;
}
static INLINE int32 LimitInt64ToInt32_ansi(int64 x) {
  return (x > (int64)SE_MAX_INT32)
             ? (int32)SE_MAX_INT32
             : (x < (int64)SE_MIN_INT32) ? (int32)SE_MIN_INT32 : (int32)x;
}
...
int16 ExpConvert(int16 input, /* to be converted */
...
/* Returns the left shift count needed to normalize src to a 32-bit signed long
 * value. */
...
#define FR_MIN_INT16(_x, _y) \
  ((int16)(_x) <= (int16)(_y)) ? (int16)(_x) : (int16)(_y)
#define FR_MAX_INT16(_x, _y) \
  ((int16)(_x) >= (int16)(_y)) ? (int16)(_x) : (int16)(_y)
