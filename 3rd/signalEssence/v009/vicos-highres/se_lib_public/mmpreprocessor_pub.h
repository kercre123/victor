...
typedef struct {
  ...
  //
  // you can configure the number of single-pole DC removal filters applied to
  // the input signal (up to MMP_MAX_NUM_POLES). this feature allows you to
  // emulate the "c67 highpass filter" feature formerly implemented in the mmif
  // layer.
  int32 NumDcRmvPoles;
...
/* Function Prototypes */
void MMPreProcessorSetDefaultConfig(MMPreProcConfig_t *cp, int32 numMics,
                                    int32 blockSize,
