/***************************************************************************
   (C) Copyright 2012 SignalEssence; All Rights Reserved
    ...
    Description:
    Implement a 4th order IIR filter, as described in "High-Order Digital
Parametric Equalizer Design" which is available in
../devtools/high-order-filters/
    ...
    * cascfilt.m   : cascaded filters using the matlab (octave) 'filter'
function.
