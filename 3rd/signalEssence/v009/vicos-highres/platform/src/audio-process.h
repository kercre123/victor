...
typedef struct {
  ...
  float32 runtime_last_block;  //  the time it took the last block to run, in
                               //  milliseconds
...
audio_process_error_t audio_process_rx(platform_data_t *platform, int16 *RinBuf,
                                       int16 *RoutBuf);
audio_process_error_t audio_process_tx(platform_data_t *platform, int16 *SinBuf,
                                       int16 *SoutBuf, int16 *RefBuf);
#endif
