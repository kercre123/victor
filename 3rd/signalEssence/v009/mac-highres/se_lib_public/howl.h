...
void HowlSetDefaultConfig(HowlSuppressorConfig_t *pConfig, int blockSize,
                          int sampleRateHz);
void HowlInit(HowlSuppressor_t *pState, const HowlSuppressorConfig_t *pConfig);
void HowlDestroy(HowlSuppressor_t *pState);
void HowlSuppress_f32(HowlSuppressor_t *pState, const float32 *pIn,
                      float32 *pOut);
void HowlSuppress_q15(HowlSuppressor_t *pState, const int16 *pIn, int16 *pOut);
