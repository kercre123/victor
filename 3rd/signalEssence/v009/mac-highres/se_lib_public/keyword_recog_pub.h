...
void KeywordSetProfile(KeywordConfig_t *pCfg, int profileIndex,
                       int32 *pProfileData, int lenProfile_i32);

//
// keyword detection is not automatically performed in the MMFX layer.
//
// the MMIF layer should use the MMIF helper function MMIfDetectKeyword() to
// invoke the keyword detector.
