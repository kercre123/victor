...
void InitQdEchoModeling(
    QdEchoModel_t *sp,
    int16 modelIndex);  // ECHO_MODEL_HANDHELD = 0, ECHO_MODEL_DESKTOP_VIDEO =
                        // 1, ECHO_MODEL_BIG_BOARD_SHORT_AEC = 2,
...
int32 DoQdEchoModeling(QdEchoModel_t *sp, int16 gErl_q12, int16 gErle_q12,
                       int16 padFactor_q10, int32 routPower);
