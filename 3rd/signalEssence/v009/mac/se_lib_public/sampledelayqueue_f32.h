...
void InitSampleDelayQueue_f32(SampleDelayQueueF32_t *sp, float32 *bufAddr,
                              int32 bufferSize,  // size of the allocated array
                              int32 initialDelay, char *pSeDiagPrefix);

int32 GetNumSamplesDelay_f32(SampleDelayQueueF32_t *rp);

// void WriteSampleDelayQueue(
void SampleDelayWrite_f32(SampleDelayQueueF32_t *rp, const float32 *inbufptr,
                          int32 numSampsIn);

// void ReadSampleDelayQueue(
int32 SampleDelayPeek_f32(SampleDelayQueueF32_t *rp, float32 *outbufptr,
                          int32 numSamples);

int32 SampleDelayDequeue_f32(SampleDelayQueueF32_t *sp, float32 *outBufPtr,
                             int32 numSamples);
