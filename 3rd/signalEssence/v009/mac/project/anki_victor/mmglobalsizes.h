...
// maximum length of acoustic echo canceller estimated channel model (in
// samples)
...
#define MAX_MIC_CONTRIBS \
  30  // differential beams will usually require fewer microphones

// MAX_SUBBANDS is divided up into two purposes:
//  1. The maximum ever anticipated.  This is used to define buffers for
//  configuration
//     parameters.
//  2. The maximum number of buffers needed.  This is used to define the maximum
//  for
//     large buffers.
// This way it is possible to make the memory allocation small or large as
// needed without having to touch a lot of parameters.
