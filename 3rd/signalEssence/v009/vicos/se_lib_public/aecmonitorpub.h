...
History
   ...
   09-01-09       hjm    added clipping actions: added MicClippingDetected flag
to AecMeasurement_t 11-29-11       ryu    split header into private/public
Description
...
typedef struct {
  ...
  float RefinRmsMaxLevel;  // RmsMaxLevel sets the maximum output level
                           // (specified as Q15) at Rout
...
void AecMonitorSetDefaultConfig(AecMonitorConfig_t *cfgp, int32 numMics);
