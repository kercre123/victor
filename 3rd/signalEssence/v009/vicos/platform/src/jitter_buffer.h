...
void jb_init(jitter_buffer_t *jb, int channels, int sample_size_bytes,
             int buffer_size_frames);
void jb_destroy(jitter_buffer_t *jb);

// These functions work with the native sample size as defined in the jb_init
// function.
...
// These functions take int16 arguments, but store internally in whatever format
// was in jb_init.
