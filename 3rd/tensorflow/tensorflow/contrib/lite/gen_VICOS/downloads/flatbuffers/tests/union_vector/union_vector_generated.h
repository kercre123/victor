...
inline const char **EnumNamesCharacter() {
  static const char *names[] = {"NONE",    "MuLan", "Rapunzel", "Belle",
...
inline flatbuffers::TypeTable *AttackerTypeTable() {
  static flatbuffers::TypeCode type_codes[] = {{flatbuffers::ET_INT, 0, -1}};
  static const char *names[] = {"sword_attack_damage"};
  static flatbuffers::TypeTable tt = {
...
inline flatbuffers::TypeTable *RapunzelTypeTable() {
  ...
  static const char *names[] = {"hair_length"};
  static flatbuffers::TypeTable tt = {
...
inline flatbuffers::TypeTable *BookReaderTypeTable() {
  static flatbuffers::TypeCode type_codes[] = {{flatbuffers::ET_INT, 0, -1}};
  static const int32_t values[] = {0, 4};
  static const char *names[] = {"books_read"};
  static flatbuffers::TypeTable tt = {
      flatbuffers::ST_STRUCT, 1, type_codes, nullptr, values, names};
  return &tt;
}
...
inline flatbuffers::TypeTable *MovieTypeTable() {
  ...
  static flatbuffers::TypeFunction type_refs[] = {CharacterTypeTable};
  static const char *names[] = {"main_character_type", "main_character",
