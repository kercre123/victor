...
#define DEFINE_BITMASK_OPERATORS(E, T)                            \
  inline E operator|(E lhs, E rhs) { return E(T(lhs) | T(rhs)); } \
  inline E operator&(E lhs, E rhs) { return E(T(lhs) & T(rhs)); } \
  inline E operator^(E lhs, E rhs) { return E(T(lhs) ^ T(rhs)); } \
  inline E operator~(E lhs) { return E(~T(lhs)); }                \
  ...
  inline bool operator!(E rhs) { return !bool(T(rhs)); }
/// @endcond
}  // namespace flatbuffers
