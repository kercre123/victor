...
struct TensorEvaluator<const TensorReshapingOp<NewDimensions, ArgType>,
  ...
  EIGEN_DEVICE_FUNC typename Eigen::internal::traits<XprType>::PointerType
  data() const {
...
template <typename Index>
struct MemcpyTriggerForSlicing<Index, const Eigen::SyclDevice> {
...
struct TensorEvaluator<const TensorSlicingOp<StartIndices, Sizes, ArgType>,
  ...
  /// used by sycl
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const StartIndices& startIndices()
      const {
    return m_offsets;
  }
...
struct TensorEvaluator<
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorEvaluator(const XprType& op,
      ...
      : m_impl(op.expression(), device),
        ...
        m_exprStartIndices(op.startIndices()),
  ...
  // use by sycl
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const StartIndices& exprStartIndices()
      const {
    return m_exprStartIndices;
  }
  // use by sycl
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const StartIndices& exprStopIndices()
      const {
