...
struct TableInFirstNS FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  enum { VT_FOO_TABLE = 4, VT_FOO_ENUM = 6, VT_FOO_STRUCT = 8 };
...
struct TableInC FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  enum { VT_REFER_TO_A1 = 4, VT_REFER_TO_A2 = 6 };
...
inline flatbuffers::TypeTable *TableInFirstNSTypeTable() {
  ...
  static const char *names[] = {"foo_table", "foo_enum", "foo_struct"};
...
inline flatbuffers::TypeTable *TableInCTypeTable() {
  ...
  static const char *names[] = {"refer_to_a1", "refer_to_a2"};
  static flatbuffers::TypeTable tt = {
...
inline flatbuffers::TypeTable *SecondTableInATypeTable() {
  ...
  static const char *names[] = {"refer_to_c"};
  static flatbuffers::TypeTable tt = {
