...
inline Equipment (&EnumValuesEquipment())[2] {
  static Equipment values[] = {Equipment_NONE, Equipment_Weapon};
  return values;
}
...
struct EquipmentUnion {
  ...
  WeaponT *AsWeapon() {
    return type == Equipment_Weapon ? reinterpret_cast<WeaponT *>(value)
                                    : nullptr;
  }
  const WeaponT *AsWeapon() const {
    return type == Equipment_Weapon ? reinterpret_cast<const WeaponT *>(value)
                                    : nullptr;
  }
};
...
struct MonsterT : public flatbuffers::NativeTable {
  ...
  MonsterT() : mana(150), hp(100), color(Color_Blue) {}
};
...
struct Monster FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<Weapon>> *weapons() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Weapon>> *>(
        VT_WEAPONS);
  }
  flatbuffers::Vector<flatbuffers::Offset<Weapon>> *mutable_weapons() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<Weapon>> *>(
        VT_WEAPONS);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyField<Vec3>(verifier, VT_POS) &&
           ...
           VerifyOffset(verifier, VT_WEAPONS) && verifier.Verify(weapons()) &&
...
template <>
inline const Weapon *Monster::equipped_as<Weapon>() const {
...
inline flatbuffers::Offset<Monster> CreateMonsterDirect(
  ...
  return MyGame::Sample::CreateMonster(
      ...
      inventory ? _fbb.CreateVector<uint8_t>(*inventory) : 0, color,
...
struct Weapon FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_NAME) &&
           ...
           VerifyField<int16_t>(verifier, VT_DAMAGE) && verifier.EndTable();
  }
  WeaponT *UnPack(
      const flatbuffers::resolver_function_t *_resolver = nullptr) const;
...
inline flatbuffers::Offset<Weapon> CreateWeaponDirect(
    ...
    int16_t damage = 0) {
  return MyGame::Sample::CreateWeapon(_fbb, name ? _fbb.CreateString(name) : 0,
                                      damage);
}
...
inline void Monster::UnPackTo(
  ...
  };
  {
    ...
    if (_e) {
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        _o->weapons[_i] =
            flatbuffers::unique_ptr<WeaponT>(_e->Get(_i)->UnPack(_resolver));
      }
    }
  };
  {
  ...
  };
  {
    ...
    if (_e)
      _o->equipped.value =
          EquipmentUnion::UnPack(_e, equipped_type(), _resolver);
  };
}
...
inline flatbuffers::Offset<Monster> CreateMonster(
  ...
  auto _weapons =
      _o->weapons.size()
          ? _fbb.CreateVector<flatbuffers::Offset<Weapon>>(
                _o->weapons.size(),
...
inline flatbuffers::TypeTable *EquipmentTypeTable() {
  ...
  static flatbuffers::TypeFunction type_refs[] = {WeaponTypeTable};
  static const char *names[] = {"NONE", "Weapon"};
  static flatbuffers::TypeTable tt = {
...
inline flatbuffers::TypeTable *Vec3TypeTable() {
  static flatbuffers::TypeCode type_codes[] = {{flatbuffers::ET_FLOAT, 0, -1},
...
inline flatbuffers::TypeTable *MonsterTypeTable() {
  ...
  static flatbuffers::TypeFunction type_refs[] = {
      Vec3TypeTable, ColorTypeTable, WeaponTypeTable, EquipmentTypeTable};
  static const char *names[] = {
      "pos",       "mana",  "hp",      "name",          "friendly",
      "inventory", "color", "weapons", "equipped_type", "equipped"};
  static flatbuffers::TypeTable tt = {
...
inline flatbuffers::TypeTable *WeaponTypeTable() {
  ...
  static const char *names[] = {"name", "damage"};
  static flatbuffers::TypeTable tt = {
