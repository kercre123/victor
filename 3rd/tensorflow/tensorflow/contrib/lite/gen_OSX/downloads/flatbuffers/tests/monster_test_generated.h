...
inline Color (&EnumValuesColor())[3] {
  static Color values[] = {Color_Red, Color_Green, Color_Blue};
  return values;
}

inline const char **EnumNamesColor() {
  static const char *names[] = {"Red", "Green", "",     "",     "",
                                "",    "",      "Blue", nullptr};
  return names;
}
...
inline Any (&EnumValuesAny())[4] {
  static Any values[] = {Any_NONE, Any_Monster, Any_TestSimpleTableWithEnum,
                         Any_MyGame_Example2_Monster};
  return values;
}

inline const char **EnumNamesAny() {
  static const char *names[] = {"NONE", "Monster", "TestSimpleTableWithEnum",
...
template <>
struct AnyTraits<MyGame::Example2::Monster> {
...
struct AnyUnion {
  ...
  MonsterT *AsMonster() {
    return type == Any_Monster ? reinterpret_cast<MonsterT *>(value) : nullptr;
  }
  const MonsterT *AsMonster() const {
    return type == Any_Monster ? reinterpret_cast<const MonsterT *>(value)
                               : nullptr;
  }
  TestSimpleTableWithEnumT *AsTestSimpleTableWithEnum() {
    return type == Any_TestSimpleTableWithEnum
               ? reinterpret_cast<TestSimpleTableWithEnumT *>(value)
               : nullptr;
  }
  const TestSimpleTableWithEnumT *AsTestSimpleTableWithEnum() const {
    return type == Any_TestSimpleTableWithEnum
               ? reinterpret_cast<const TestSimpleTableWithEnumT *>(value)
               : nullptr;
  }
...
MANUALLY_ALIGNED_STRUCT(4) Ability FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  Ability() { memset(this, 0, sizeof(Ability)); }
...
struct TestSimpleTableWithEnumT : public flatbuffers::NativeTable {
  ...
  Color color;
  TestSimpleTableWithEnumT() : color(Color_Green) {}
};
...
struct TestSimpleTableWithEnumBuilder {
  ...
  void add_color(Color color) {
    fbb_.AddElement<int8_t>(TestSimpleTableWithEnum::VT_COLOR,
                            static_cast<int8_t>(color), 2);
  }
  explicit TestSimpleTableWithEnumBuilder(flatbuffers::FlatBufferBuilder &_fbb)
      : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  TestSimpleTableWithEnumBuilder &operator=(
      const TestSimpleTableWithEnumBuilder &);
...
CreateTestSimpleTableWithEnum(flatbuffers::FlatBufferBuilder &_fbb,
...
struct Stat FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum { VT_ID = 4, VT_VAL = 6, VT_COUNT = 8 };
  ...
  bool mutate_val(int64_t _val) { return SetField<int64_t>(VT_VAL, _val, 0); }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_ID) &&
           verifier.Verify(id()) && VerifyField<int64_t>(verifier, VT_VAL) &&
           VerifyField<uint16_t>(verifier, VT_COUNT) && verifier.EndTable();
  }
  StatT *UnPack(
      const flatbuffers::resolver_function_t *_resolver = nullptr) const;
...
inline flatbuffers::Offset<Stat> CreateStatDirect(
  ...
  return MyGame::Example::CreateStat(_fbb, id ? _fbb.CreateString(id) : 0, val,
                                     count);
}
...
struct Monster FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_hp(int16_t _hp) { return SetField<int16_t>(VT_HP, _hp, 100); }
  ...
  template <typename T>
  const T *test_as() const;
  const Monster *test_as_Monster() const {
    return test_type() == Any_Monster ? static_cast<const Monster *>(test())
                                      : nullptr;
  }
  const TestSimpleTableWithEnum *test_as_TestSimpleTableWithEnum() const {
    return test_type() == Any_TestSimpleTableWithEnum
               ? static_cast<const TestSimpleTableWithEnum *>(test())
               : nullptr;
  }
  const MyGame::Example2::Monster *test_as_MyGame_Example2_Monster() const {
    return test_type() == Any_MyGame_Example2_Monster
  ...
  /// multiline too
  const flatbuffers::Vector<flatbuffers::Offset<Monster>> *testarrayoftables()
      const {
    return GetPointer<
        const flatbuffers::Vector<flatbuffers::Offset<Monster>> *>(
        VT_TESTARRAYOFTABLES);
  }
  flatbuffers::Vector<flatbuffers::Offset<Monster>>
      *mutable_testarrayoftables() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<Monster>> *>(
        VT_TESTARRAYOFTABLES);
  }
  ...
  const flatbuffers::Vector<const Ability *> *testarrayofsortedstruct() const {
    return GetPointer<const flatbuffers::Vector<const Ability *> *>(
        VT_TESTARRAYOFSORTEDSTRUCT);
  }
  flatbuffers::Vector<const Ability *> *mutable_testarrayofsortedstruct() {
    return GetPointer<flatbuffers::Vector<const Ability *> *>(
        VT_TESTARRAYOFSORTEDSTRUCT);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyField<Vec3>(verifier, VT_POS) &&
           ...
           VerifyOffset(verifier, VT_TEST4) && verifier.Verify(test4()) &&
           ...
           VerifyOffset(verifier, VT_FLEX) && verifier.Verify(flex()) &&
           VerifyOffset(verifier, VT_TEST5) && verifier.Verify(test5()) &&
           ...
           verifier.VerifyTable(parent_namespace_test()) && verifier.EndTable();
  }
  MonsterT *UnPack(
      const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(
...
template <>
inline const Monster *Monster::test_as<Monster>() const {
  return test_as_Monster();
}

template <>
inline const TestSimpleTableWithEnum *
Monster::test_as<TestSimpleTableWithEnum>() const {
...
struct MonsterBuilder {
  ...
  void add_testarrayoftables(
      flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Monster>>>
          testarrayoftables) {
  ...
  void add_testarrayofsortedstruct(
      flatbuffers::Offset<flatbuffers::Vector<const Ability *>>
...
inline flatbuffers::Offset<Monster> CreateMonster(
    flatbuffers::FlatBufferBuilder &_fbb, const Vec3 *pos = 0,
    int16_t mana = 150, int16_t hp = 100,
    flatbuffers::Offset<flatbuffers::String> name = 0,
    flatbuffers::Offset<flatbuffers::Vector<uint8_t>> inventory = 0,
    Color color = Color_Blue, Any test_type = Any_NONE,
    ...
    flatbuffers::Offset<Stat> testempty = 0, bool testbool = false,
    int32_t testhashs32_fnv1 = 0, uint32_t testhashu32_fnv1 = 0,
    int64_t testhashs64_fnv1 = 0, uint64_t testhashu64_fnv1 = 0,
    int32_t testhashs32_fnv1a = 0, uint32_t testhashu32_fnv1a = 0,
    int64_t testhashs64_fnv1a = 0, uint64_t testhashu64_fnv1a = 0,
...
inline flatbuffers::Offset<Monster> CreateMonsterDirect(
    flatbuffers::FlatBufferBuilder &_fbb, const Vec3 *pos = 0,
    int16_t mana = 150, int16_t hp = 100, const char *name = nullptr,
    const std::vector<uint8_t> *inventory = nullptr, Color color = Color_Blue,
    Any test_type = Any_NONE, flatbuffers::Offset<void> test = 0,
    const std::vector<const Test *> *test4 = nullptr,
    const std::vector<flatbuffers::Offset<flatbuffers::String>>
        *testarrayofstring = nullptr,
    const std::vector<flatbuffers::Offset<Monster>> *testarrayoftables =
        nullptr,
    flatbuffers::Offset<Monster> enemy = 0,
  ...
  return MyGame::Example::CreateMonster(
      _fbb, pos, mana, hp, name ? _fbb.CreateString(name) : 0,
      inventory ? _fbb.CreateVector<uint8_t>(*inventory) : 0, color, test_type,
      test, test4 ? _fbb.CreateVector<const Test *>(*test4) : 0,
      testarrayofstring
      ...
      testarrayofstring2
          ...
          : 0,
      testarrayofsortedstruct
          ? _fbb.CreateVector<const Ability *>(*testarrayofsortedstruct)
          : 0,
...
struct TypeAliases FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_i8(int8_t _i8) { return SetField<int8_t>(VT_I8, _i8, 0); }
  uint8_t u8() const { return GetField<uint8_t>(VT_U8, 0); }
  bool mutate_u8(uint8_t _u8) { return SetField<uint8_t>(VT_U8, _u8, 0); }
  int16_t i16() const { return GetField<int16_t>(VT_I16, 0); }
  bool mutate_i16(int16_t _i16) { return SetField<int16_t>(VT_I16, _i16, 0); }
  uint16_t u16() const { return GetField<uint16_t>(VT_U16, 0); }
  bool mutate_u16(uint16_t _u16) { return SetField<uint16_t>(VT_U16, _u16, 0); }
  int32_t i32() const { return GetField<int32_t>(VT_I32, 0); }
  bool mutate_i32(int32_t _i32) { return SetField<int32_t>(VT_I32, _i32, 0); }
  uint32_t u32() const { return GetField<uint32_t>(VT_U32, 0); }
  bool mutate_u32(uint32_t _u32) { return SetField<uint32_t>(VT_U32, _u32, 0); }
  int64_t i64() const { return GetField<int64_t>(VT_I64, 0); }
  bool mutate_i64(int64_t _i64) { return SetField<int64_t>(VT_I64, _i64, 0); }
  uint64_t u64() const { return GetField<uint64_t>(VT_U64, 0); }
  bool mutate_u64(uint64_t _u64) { return SetField<uint64_t>(VT_U64, _u64, 0); }
  float f32() const { return GetField<float>(VT_F32, 0.0f); }
  bool mutate_f32(float _f32) { return SetField<float>(VT_F32, _f32, 0.0f); }
  double f64() const { return GetField<double>(VT_F64, 0.0); }
  bool mutate_f64(double _f64) { return SetField<double>(VT_F64, _f64, 0.0); }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyField<int8_t>(verifier, VT_I8) &&
           ...
           VerifyOffset(verifier, VT_V8) && verifier.Verify(v8()) &&
...
inline flatbuffers::Offset<TypeAliases> CreateTypeAliasesDirect(
  ...
  return MyGame::Example::CreateTypeAliases(
      _fbb, i8, u8, i16, u16, i32, u32, i64, u64, f32, f64,
...
inline void Monster::UnPackTo(
  ...
  {
    auto _e = pos();
    if (_e) _o->pos = flatbuffers::unique_ptr<Vec3>(new Vec3(*_e));
  };
  {
    auto _e = mana();
    _o->mana = _e;
  ...
  {
    auto _e = test();
    if (_e) _o->test.value = AnyUnion::UnPack(_e, test_type(), _resolver);
  };
  {
    auto _e = test4();
    if (_e) {
    ...
    if (_e) {
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        _o->testarrayoftables[_i] =
            flatbuffers::unique_ptr<MonsterT>(_e->Get(_i)->UnPack(_resolver));
      }
    }
  };
  {
    auto _e = enemy();
    if (_e)
      _o->enemy = flatbuffers::unique_ptr<MonsterT>(_e->UnPack(_resolver));
  };
  {
    ...
    if (_e) {
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        _o->testnestedflatbuffer[_i] = _e->Get(_i);
      }
    }
  };
  {
    auto _e = testempty();
    if (_e)
      _o->testempty = flatbuffers::unique_ptr<StatT>(_e->UnPack(_resolver));
  };
  {
    auto _e = testbool();
    _o->testbool = _e;
...
inline flatbuffers::Offset<Monster> CreateMonster(
  ...
  auto _testarrayoftables =
      _o->testarrayoftables.size()
          ? _fbb.CreateVector<flatbuffers::Offset<Monster>>(
                _o->testarrayoftables.size(),
...
inline AnyUnion::AnyUnion(const AnyUnion &u) FLATBUFFERS_NOEXCEPT
    : type(u.type),
      value(nullptr) {
  switch (type) {
    case Any_Monster: {
    ...
    case Any_TestSimpleTableWithEnum: {
      value = new TestSimpleTableWithEnumT(
          *reinterpret_cast<TestSimpleTableWithEnumT *>(u.value));
      break;
    }
    case Any_MyGame_Example2_Monster: {
...
inline flatbuffers::TypeTable *ColorTypeTable() {
  static flatbuffers::TypeCode type_codes[] = {{flatbuffers::ET_CHAR, 0, 0},
                                               {flatbuffers::ET_CHAR, 0, 0},
                                               {flatbuffers::ET_CHAR, 0, 0}};
  static flatbuffers::TypeFunction type_refs[] = {ColorTypeTable};
...
inline flatbuffers::TypeTable *AnyTypeTable() {
  ...
  static flatbuffers::TypeFunction type_refs[] = {
      MonsterTypeTable, TestSimpleTableWithEnumTypeTable,
...
inline flatbuffers::TypeTable *TestTypeTable() {
  static flatbuffers::TypeCode type_codes[] = {{flatbuffers::ET_SHORT, 0, -1},
...
inline flatbuffers::TypeTable *Vec3TypeTable() {
  static flatbuffers::TypeCode type_codes[] = {
      ...
      {flatbuffers::ET_CHAR, 0, 0},   {flatbuffers::ET_SEQUENCE, 0, 1}};
  static flatbuffers::TypeFunction type_refs[] = {ColorTypeTable,
                                                  TestTypeTable};
  static const int32_t values[] = {0, 4, 8, 16, 24, 26, 32};
  static const char *names[] = {"x", "y", "z", "test1", "test2", "test3"};
  static flatbuffers::TypeTable tt = {
...
inline flatbuffers::TypeTable *AbilityTypeTable() {
  static flatbuffers::TypeCode type_codes[] = {{flatbuffers::ET_UINT, 0, -1},
                                               {flatbuffers::ET_UINT, 0, -1}};
  static const int32_t values[] = {0, 4, 8};
  static const char *names[] = {"id", "distance"};
  static flatbuffers::TypeTable tt = {
      flatbuffers::ST_STRUCT, 2, type_codes, nullptr, values, names};
  return &tt;
}
...
inline flatbuffers::TypeTable *StatTypeTable() {
  static flatbuffers::TypeCode type_codes[] = {{flatbuffers::ET_STRING, 0, -1},
                                               {flatbuffers::ET_LONG, 0, -1},
                                               {flatbuffers::ET_USHORT, 0, -1}};
  static const char *names[] = {"id", "val", "count"};
  static flatbuffers::TypeTable tt = {
...
inline flatbuffers::TypeTable *MonsterTypeTable() {
  static flatbuffers::TypeCode type_codes[] = {
      ...
      {flatbuffers::ET_CHAR, 0, 1},     {flatbuffers::ET_UTYPE, 0, 2},
  ...
  static flatbuffers::TypeFunction type_refs[] = {
      Vec3TypeTable,    ColorTypeTable,
      AnyTypeTable,     TestTypeTable,
      MonsterTypeTable, StatTypeTable,
      AbilityTypeTable, MyGame::InParentNamespaceTypeTable};
  static const char *names[] = {"pos",
                                "mana",
                                "hp",
                                "name",
                                "friendly",
