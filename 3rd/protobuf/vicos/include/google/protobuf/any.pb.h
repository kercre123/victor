...
namespace protobuf {
template <>
LIBPROTOBUF_EXPORT ::google::protobuf::Any*
Arena::CreateMaybeMessage<::google::protobuf::Any>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace protobuf {
                                                                   ...
                                                                   */
{
 public:
  ...
  static bool ParseAnyTypeUrl(const string& type_url, string* full_type_name);
  ...
  inline Any* New() const final { return CreateMaybeMessage<Any>(NULL); }
