...
/* -- IETF ChaCha20-Poly1305 construction with a 96-bit nonce and a 32-bit
 * internal counter -- */
...
int crypto_aead_chacha20poly1305_ietf_decrypt_detached(
    unsigned char *m, unsigned char *nsec, const unsigned char *c,
    unsigned long long clen, const unsigned char *mac, const unsigned char *ad,
    unsigned long long adlen, const unsigned char *npub, const unsigned char *k)
    __attribute__((warn_unused_result));
...
/* -- Original ChaCha20-Poly1305 construction with a 64-bit nonce and a 64-bit
 * internal counter -- */
