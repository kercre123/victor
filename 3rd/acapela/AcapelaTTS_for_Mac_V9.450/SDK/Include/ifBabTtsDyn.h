...
#define _IFBABTTSDYN_setLoadErrorStr(str)      \
  strncpy(_IFBABTTSDYN_loadErrorStr, (str),    \
          (sizeof(_IFBABTTSDYN_loadErrorStr) / \
           sizeof(_IFBABTTSDYN_loadErrorStr[0u])))
#define _IFBABTTSDYN_setLoadErrorStrF(fmt, ...)     \
  snprintf(_IFBABTTSDYN_loadErrorStr,               \
           (sizeof(_IFBABTTSDYN_loadErrorStr) /     \
            sizeof(_IFBABTTSDYN_loadErrorStr[0u])), \
           fmt, __VA_ARGS__)
#endif
...
#define _IFBABTTSDYN_API_FUNCS                                                 \
  _IFBABTTSDYN_API_FUNC(BabTTS_Init, bool, (void))                             \
  _IFBABTTSDYN_API_FUNC(BabTTS_Uninit, bool, (void))                           \
  _IFBABTTSDYN_API_FUNC(BabTTS_GetNumVoices, long int, (void))                 \
  _IFBABTTSDYN_API_FUNC(BabTTS_EnumVoices, BabTtsError,                        \
                        (DWORD dwIndex, char szVoice[50]))                     \
  _IFBABTTSDYN_API_FUNC(BabTTS_GetVoiceInfo, BabTtsError,                      \
                        (const char *lpszVoice, BABTTSINFO *lpInfo))           \
  _IFBABTTSDYN_API_FUNC(BabTTS_GetVoiceInfoExImpl, BabTtsError,                \
                        (const char *lpszVoice, BABTTSINFO2 *lpInfo))          \
  _IFBABTTSDYN_API_FUNC(BabTTS_GetInstanceInfo, BabTtsError,                   \
                        (LPBABTTS lpObject, BABTTSINFO * lpInfo))              \
  _IFBABTTSDYN_API_FUNC(BabTTS_GetInstanceInfoExImpl, BabTtsError,             \
                        (LPBABTTS lpObject, BABTTSINFO2 * lpInfo))             \
  _IFBABTTSDYN_API_FUNC(BabTTS_GetVoiceLicense, BabTtsError,                   \
  ...
  _IFBABTTSDYN_API_FUNC(BabTTS_Create, LPBABTTS, (void))                       \
  _IFBABTTSDYN_API_FUNC(                                                       \
      BabTTS_Open, BabTtsError,                                                \
      (LPBABTTS lpObject, const char *lpszSpeechFont, DWORD dwOpenFlag))       \
  _IFBABTTSDYN_API_FUNC(BabTTS_Close, BabTtsError, (LPBABTTS lpObject))        \
  _IFBABTTSDYN_API_FUNC(                                                       \
      BabTTS_Speak, BabTtsError,                                               \
      (LPBABTTS lpObject, const char *lpszText, DWORD dwSpeakFlag))            \
  _IFBABTTSDYN_API_FUNC(BabTTS_Write, BabTtsError,                             \
                        (LPBABTTS lpObject, const char *lpszText,              \
                         const char *lpszFileName, DWORD dwWriteFlag))         \
  _IFBABTTSDYN_API_FUNC(BabTTS_Reset, BabTtsError, (LPBABTTS lpObject))        \
  _IFBABTTSDYN_API_FUNC(BabTTS_ResetSettings, BabTtsError,                     \
                        (LPBABTTS lpObject))                                   \
  _IFBABTTSDYN_API_FUNC(                                                       \
  ...
  _IFBABTTSDYN_API_FUNC(BabTTS_SetFilterPreset, BabTtsError,                   \
                        (LPBABTTS lpObject, const char *lpszPreset))           \
  _IFBABTTSDYN_API_FUNC(BabTTS_GetFilterPreset, BabTtsError,                   \
                        (LPBABTTS lpObject, char szPreset[50]))                \
  _IFBABTTSDYN_API_FUNC(BabTTS_Dialog, BabTtsError,                            \
                        (LPBABTTS lpObject, HWND hWnd, BabTtsDlg dlgType))     \
  _IFBABTTSDYN_API_FUNC(BabTTS_Pause, BabTtsError, (LPBABTTS lpObject))        \
  _IFBABTTSDYN_API_FUNC(BabTTS_Resume, BabTtsError, (LPBABTTS lpObject))       \
  _IFBABTTSDYN_API_FUNC(                                                       \
      BabTTS_DictLoad, BabTtsError,                                            \
      (LPBABTTS lpObject, LPBABTTSDICT * lppDict, const char *lpszFileName))   \
  _IFBABTTSDYN_API_FUNC(BabTTS_DictGetNumLoaded, long int,                     \
                        (LPBABTTS lpObject))                                   \
  _IFBABTTSDYN_API_FUNC(BabTTS_DictGetMax, long int, (LPBABTTS lpObject))      \
  _IFBABTTSDYN_API_FUNC(                                                       \
      BabTTS_DictEnum, BabTtsError,                                            \
      (LPBABTTS lpObject, LPBABTTSDICT * lppDict, DWORD dwIndex))              \
  _IFBABTTSDYN_API_FUNC(BabTTS_DictIsModified, long int,                       \
                        (LPBABTTS lpObject, LPBABTTSDICT lpDict))              \
  _IFBABTTSDYN_API_FUNC(BabTTS_DictUnload, BabTtsError,                        \
                        (LPBABTTS lpObject, LPBABTTSDICT lpDict))              \
  _IFBABTTSDYN_API_FUNC(BabTTS_DictUnloadAll, BabTtsError,                     \
                        (LPBABTTS lpObject))                                   \
  _IFBABTTSDYN_API_FUNC(BabTTS_DictEnable, BabTtsError,                        \
                        (LPBABTTS lpObject, LPBABTTSDICT lpDict))              \
  _IFBABTTSDYN_API_FUNC(BabTTS_DictDisable, BabTtsError,                       \
                        (LPBABTTS lpObject, LPBABTTSDICT lpDict))              \
  _IFBABTTSDYN_API_FUNC(                                                       \
      BabTTS_DictSave, BabTtsError,                                            \
      (LPBABTTS lpObject, LPBABTTSDICT lpDict, const char *lpszFileName))      \
  _IFBABTTSDYN_API_FUNC(BabTTS_DictSaveAll, BabTtsError, (LPBABTTS lpObject))  \
  _IFBABTTSDYN_API_FUNC(                                                       \
      BabTTS_DictAddWord, BabTtsError,                                         \
      (LPBABTTS lpObject, LPBABTTSDICT lpDict, const char *lpszWord,           \
       const char *lpszTrans, BabTtsWordType Type))                            \
  _IFBABTTSDYN_API_FUNC(                                                       \
  ...
  _IFBABTTSDYN_API_FUNC(                                                       \
      ...
      (LPBABTTS lpObject, LPBABTTSDICT lpDict, const char *lpszWord,           \
       char *lpszTrans, DWORD *lpdwSize, BabTtsWordType *lpWordType))          \
  _IFBABTTSDYN_API_FUNC(BabTTS_DictGetNumEntries, long int,                    \
                        (LPBABTTS lpObject, LPBABTTSDICT lpDict))              \
  _IFBABTTSDYN_API_FUNC(                                                       \
      BabTTS_DictGetEntry, BabTtsError,                                        \
      (LPBABTTS lpObject, LPBABTTSDICT lpDict, DWORD dwIndex, char *lpszEntry, \
       DWORD *lpdwEntrySize))                                                  \
  _IFBABTTSDYN_API_FUNC(BabTTS_DictAddWordEx, BabTtsError,                     \
                        (LPBABTTS lpObject, LPBABTTSDICT lpDict,               \
                         const char *lpszWord, const char *lpszTrans,          \
                         BabTtsWordType Type, BabTtsWordEncoding Encoding))    \
  _IFBABTTSDYN_API_FUNC(BabTTS_DictRemoveWordEx, BabTtsError,                  \
                        (LPBABTTS lpObject, LPBABTTSDICT lpDict,               \
                         const char *lpszWord, BabTtsWordEncoding Encoding))   \
  _IFBABTTSDYN_API_FUNC(                                                       \
      BabTTS_DictGetWordTransEx, BabTtsError,                                  \
      (LPBABTTS lpObject, LPBABTTSDICT lpDict, const char *lpszWord,           \
       char *lpszTrans, DWORD *lpdwTransSize, BabTtsWordType *lpWordType,      \
       BabTtsWordEncoding Encoding))                                           \
  _IFBABTTSDYN_API_FUNC(                                                       \
      BabTTS_DictGetEntryEx, BabTtsError,                                      \
      (LPBABTTS lpObject, LPBABTTSDICT lpDict, DWORD dwIndex, char *lpszEntry, \
       DWORD *lpdwEntrySize, BabTtsWordEncoding Encoding))                     \
  _IFBABTTSDYN_API_FUNC(                                                       \
      BabTTS_DictGetInfo, BabTtsError,                                         \
      (LPBABTTS lpObject, LPBABTTSDICT lpDict, LPBABTTSDICTINFO lpDictinfo))   \
  _IFBABTTSDYN_API_FUNC(BabTTS_DictGetInfoFromFile, BabTtsError,               \
                        (LPBABTTS lpObject, const char *lpszFileName,          \
                         LPBABTTSDICTINFO lpDictinfo))                         \
  _IFBABTTSDYN_API_FUNC(                                                       \
      BabTTS_DictSetInfo, BabTtsError,                                         \
      (LPBABTTS lpObject, LPBABTTSDICT lpDict, BABTTSDICTINFO Dictinfo))       \
  _IFBABTTSDYN_API_FUNC(BabTTS_DictSetPassword, BabTtsError,                   \
                        (LPBABTTS lpObject, LPBABTTSDICT lpDict,               \
                         const char *lpszStr1, const char *lpszStr2))          \
  _IFBABTTSDYN_API_FUNC(                                                       \
      BabTTS_DictGetDefList, BabTtsError,                                      \
      (LPBABTTS lpObject, char *lpszFileList, DWORD *lpdwSize))                \
  _IFBABTTSDYN_API_FUNC(BabTTS_DictSetDefList, BabTtsError,                    \
  ...
  _IFBABTTSDYN_API_FUNC(                                                       \
      ...
      (LPBABTTS lpObject, LPBABTTSDICT lpDict, const char *lpszBuffer,         \
       BabTTSDictProc lpCallback, void *lpCallbackUserData, DWORD dwFlags))    \
  _IFBABTTSDYN_API_FUNC(BabTTS_DictExport, BabTtsError,                        \
                        (LPBABTTS lpObject, LPBABTTSDICT lpDict,               \
                         const char *lpszBuffer, DWORD dwFlags))               \
  _IFBABTTSDYN_API_FUNC(                                                       \
  ...
  _IFBABTTSDYN_API_FUNC(BabTTS_GetErrorNameImpl, const char *,                 \
                        (BabTtsError dwErrorCode))                             \
  _IFBABTTSDYN_API_FUNC(BabTTS_GetErrorWideNameImpl, const wchar_t *,          \
                        (BabTtsError dwErrorCode))                             \
  _IFBABTTSDYN_API_FUNC(BabTTS_ExpandVoiceTemplate, BabTtsError,               \
...
#define BABTTS_LIB                                \
  _IFBABTTSDYN_T(_IFBABTTSDYN_ACATTS_LIB_DIRPATH) \
  _IFBABTTSDYN_T(_IFBABTTSDYN_ACATTS_LIB_NAKEDNAME)
#endif

#if !defined(BABTTS_LIBNAME)
#define BABTTS_LIBNAME _IFBABTTSDYN_T(_IFBABTTSDYN_ACATTS_LIB_NAKEDNAME)
#endif
...
#define _IFBABTTSDYN_API_FUNC(name, resultType, args) LP_##name name = NULL;
...
static const TCHAR *_IFBABTTSDYN_getLastWin32ErrorStr() {
  ...
  if (0 == FormatMessage(
               ...
               buffer, ((sizeof(buffer) / sizeof(buffer[0u])) - sizeof(TCHAR)),
               NULL)) {
    _sntprintf(lastErrorStr, (sizeof(lastErrorStr) / sizeof(lastErrorStr[0u])),
...
#if defined(WIN32) || defined(_WIN32)
#define _IFBABTTSDYN_API_FUNC(name, resultType, args)                         \
  if (NULL == (name = (LP_##name)_IFBABTTSDYN_RESOLVE_SYMBOL(hMod, #name))) { \
    _IFBABTTSDYN_setLoadErrorStrF(                                            \
        _T("couldn't resolve the address of symbol \"") _T(                   \
            #name) _T("\": %s"),                                              \
...
HMODULE BabTtsInitDllEx(LPCTSTR lpszLib) {
  ...
  if (_T('\0') == lpszLib[0u]) {
    path = BABTTS_LIB;
  } else if ((INVALID_FILE_ATTRIBUTES !=
    ...
    if (_sntprintf(buffer, MAX_PATH - 1, _T("%s%s%s"), lpszLib, separator,
                   BABTTS_LIBNAME) >= (MAX_PATH - 1)) {
  ...
  if ((NULL == hMod) || (hMod < ((HMODULE)32u))) {
    _IFBABTTSDYN_setLoadErrorStrF(_T("LoadLibrary() failed: %s"),
                                  _IFBABTTSDYN_getLastWin32ErrorStr());
    return NULL;
  }
#else
  if ('\0' == lpszLib[0]) {
    path = BABTTS_LIB;
  } else if ((-1 != stat(path, &statBuffer)) && (S_ISDIR(statBuffer.st_mode))) {
    if ('/' != lpszLib[strlen(lpszLib) - 1]) {
      separator = "/";
    }

    if (snprintf(buffer, PATH_MAX - 1, "%s%s%s", lpszLib, separator,
                 BABTTS_LIBNAME) >= (PATH_MAX - 1)) {
      _IFBABTTSDYN_setLoadErrorStr(
...
HMODULE BabTtsInitDll() {
  ...
  if ((NULL == hMod) ||
      (0u == GetModuleFileName(hMod, szTemp,
                               (sizeof(szTemp) / sizeof(szTemp[0u]))))) {
  ...
  if (NULL == acattsDLibPath) {
    {
      ...
      strncpy(szTemp, infoDylib.dli_fname,
...
/* Generate the function pointer cleaning code for each API
   function. */
#define _IFBABTTSDYN_API_FUNC(name, resultType, args) name = NULL;
...
#define _IFBABTTSDYN_API_FUNC(name, resultType, args) extern LP_##name name;
...
inline BabTtsError BabTTS_GetVoiceInfoEx(const char *lpszVoice,
                                         BABTTSINFO2 *lpInfo) {
  if (NULL != lpInfo) {
...
inline BabTtsError BabTTS_GetInstanceInfoEx(LPBABTTS lpObject,
                                            BABTTSINFO2 *lpInfo) {
  if (NULL != lpInfo) {
    lpInfo->dwStructSize = sizeof(BABTTSINFO2);
    lpInfo->dwStructVersion = BABTTSINFO_VERSION2;
