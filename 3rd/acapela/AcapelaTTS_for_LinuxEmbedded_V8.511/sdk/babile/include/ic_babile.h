...
#define E_BABILE_ISPLAYING \
  -3 /* already in play mode or currently processing text */
...
#define BABIL_PARM_VAL_DCTORDER_CUS \
  0 /*default*/                       /* 1:callback, 2:user, 3:system */
#define BABIL_PARM_VAL_DCTORDER_USC 1 /* 1:user, 2:system, 3:callback */
/*#define BABIL_PARM_VAL_DCTORDER_SCU	2			*/ /* 1:system,
                                                                      2:callback,
                                                                      3:user */
...
/* reserved                             47  */
#define BABIL_PARM_PTR_MARKCB \
  48 /* provide Mark callback through babileParams structure */
...
#define BABIL_PARM_SEL_VAL_SYNCONDURCALL \
  0x0010 /* sync on ??? reserved for BABTTS */
...
#define BABIL_PARM_PITCHNLP \
  75 /* control NLP pitch rather than synthesizer's  */
...
#define BABILE_TEXTPHONETIZE \
  6 /* (phonetizer mode) == BABILE_MARKPHO + BABILE_PHONETIZE */
...
#define BABILE_SEL_BUFFERING10 \
  50 | BUFFER_UNITACOUSTIC_ALL | BUFFER_UNITSOFFSETS_ALL | BUFFER_BERSTREAM_ALL
#define BABILE_SEL_BUFFERING10F                            \
  50 | BUFFER_UNITACOUSTIC_ALL | BUFFER_UNITSOFFSETS_ALL | \
      BUFFER_BERSTREAM_ALL | BUFFER_FORCE
#define BABILE_SEL_BUFFERING8                                \
  50 | BUFFER_UNITACOUSTIC_ALL | BUFFER_UNITSOFFSETS_SMALL | \
      BUFFER_BERSTREAM_ALL
#define BABILE_SEL_BUFFERING8F                               \
  50 | BUFFER_UNITACOUSTIC_ALL | BUFFER_UNITSOFFSETS_SMALL | \
      BUFFER_BERSTREAM_ALL | BUFFER_FORCE
#define BABILE_SEL_BUFFERING7                                \
  50 | BUFFER_UNITACOUSTIC_ALL | BUFFER_UNITSOFFSETS_SMALL | \
      BUFFER_BERSTREAM_SMALL
#define BABILE_SEL_BUFFERING7F                               \
  50 | BUFFER_UNITACOUSTIC_ALL | BUFFER_UNITSOFFSETS_SMALL | \
      BUFFER_BERSTREAM_SMALL | BUFFER_FORCE
#define BABILE_SEL_BUFFERING5 \
  50 | BUFFER_UNITACOUSTIC_MED | BUFFER_UNITSOFFSETS_ALL | BUFFER_BERSTREAM_ALL
#define BABILE_SEL_BUFFERING5F                             \
  50 | BUFFER_UNITACOUSTIC_MED | BUFFER_UNITSOFFSETS_ALL | \
      BUFFER_BERSTREAM_ALL | BUFFER_FORCE
#define BABILE_SEL_BUFFERING4                                \
  50 | BUFFER_UNITACOUSTIC_MED | BUFFER_UNITSOFFSETS_SMALL | \
      BUFFER_BERSTREAM_ALL
#define BABILE_SEL_BUFFERING4F                               \
  50 | BUFFER_UNITACOUSTIC_MED | BUFFER_UNITSOFFSETS_SMALL | \
      BUFFER_BERSTREAM_ALL | BUFFER_FORCE
#define BABILE_SEL_BUFFERING3                                \
  50 | BUFFER_UNITACOUSTIC_MED | BUFFER_UNITSOFFSETS_SMALL | \
      BUFFER_BERSTREAM_SMALL
#define BABILE_SEL_BUFFERING3F                               \
  50 | BUFFER_UNITACOUSTIC_MED | BUFFER_UNITSOFFSETS_SMALL | \
      BUFFER_BERSTREAM_SMALL | BUFFER_FORCE
...
#define BABILE_SYNCNEWWINDOW \
  10 /* sync on analysis window update (compulsory) */
