...
#define BB_DB_READ_WRITE \
  BB_DB_READ | BB_DB_WRITE /* Opened for read-write operations */
...
#define BB_ROM_DBMEMTYPE                                                     \
  BB_CREATEDBMEMTYPE(BB_DBSPACE_READONLY, BB_DBTYPE_MEM, BB_DBACCESS_DIRECT, \
                     BB_DBBUFFERIZE_OFF)
#define BB_RAM_DBMEMTYPE                                                      \
  BB_CREATEDBMEMTYPE(BB_DBSPACE_READWRITE, BB_DBTYPE_MEM, BB_DBACCESS_DIRECT, \
                     BB_DBBUFFERIZE_OFF)
#define BB_ROFILE_DBMEMTYPE                               \
  BB_CREATEDBMEMTYPE(BB_DBSPACE_READONLY, BB_DBTYPE_FILE, \
                     BB_DBACCESS_UNDIRECT, BB_DBBUFFERIZE_ON)
#define BB_RWFILE_DBMEMTYPE                                \
  BB_CREATEDBMEMTYPE(BB_DBSPACE_READWRITE, BB_DBTYPE_FILE, \
                     BB_DBACCESS_UNDIRECT, BB_DBBUFFERIZE_ON)
#define BB_DEFAULT_DBMEMTYPE                              \
  BB_CREATEDBMEMTYPE(BB_DBSPACE_READONLY, BB_DBTYPE_FILE, \
                     BB_DBACCESS_UNDIRECT, BB_DBBUFFERIZE_ON)
...
/* --> Done for BabTTS: pointer to function and special handle for using
 * CBabFileAbstract */
