...
/*This is an automaticatly genarated file by ../inc/colibri_h_to_is_colibri_h.pl
 * ../inc/colibri.h ../inc/is_colibri.h*/
...
static const char* const ALF_ReturnCode_Strings[] = {
    ...
    ""};
#define ALF_ReturnCode_MAX_VALUE \
  (sizeof(ALF_ReturnCode_Strings) / sizeof(char*))
#define ALF_ReturnCode_2str(code)                       \
  (((code >= ALF_ReturnCode_MAX_VALUE) || (code < 0) || \
    (*ALF_ReturnCode_Strings[abs((int)code)] == '\0'))  \
       ? "UNDEFINED"                                    \
       : ALF_ReturnCode_Strings[abs((int)code)])
