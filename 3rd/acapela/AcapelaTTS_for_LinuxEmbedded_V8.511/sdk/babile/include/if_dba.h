...
extern BB_ERROR BB_dbFeof(
    BB_DbHndl *dbHandle); /* Only accurate for type FILE */
...
extern BB_ERROR BB_dbSeekCurrent(BB_DbHndl *dbHandle,
                                 const BB_DbOffset32 dbOffset);
...
extern BB_ERROR BB_dbReadMultiU8(BB_DbHndl *dbHandle, BB_U8 *pu8value,
                                 const BB_U32 u32length);
#define BB_dbReadMultiS8(dbHandle, pvalue, length) \
  BB_dbReadMultiU8(dbHandle, (BB_U8 *)pvalue, length)
extern BB_ERROR BB_dbReadMultiU16(BB_DbHndl *dbHandle, BB_U16 *pu16value,
                                  const BB_U32 u32length);
#define BB_dbReadMultiS16(dbHandle, pvalue, length) \
  BB_dbReadMultiU16(dbHandle, (BB_U16 *)pvalue, length)
extern BB_ERROR BB_dbReadMultiU32(BB_DbHndl *dbHandle, BB_U32 *pu32value,
                                  const BB_U32 u32length);
#define BB_dbReadMultiS32(dbHandle, pvalue, length) \
  BB_dbReadMultiU32(dbHandle, (BB_U32 *)pvalue, length)
#define BB_dbReadMultiTCHAR(dbHandle, pvalue, length) \
  (BB_TCHAR) BB_dbReadMultiU8(dbHandle, (BB_U8 *)pvalue, length)

extern BB_NU32 BB_dbRead(void *buffer, BB_S32 size, BB_S32 count,
                         BB_DbHndl *dbHandle);
...
extern BB_DbOffset32 BB_dbWriteMultiU8(BB_DbHndl *dbHandle, BB_U8 *pu8value,
                                       const BB_S32 s32length);
#define BB_dbWriteMultiS8(dbHandle, pvalue, length) \
  BB_dbWriteMultiU8(dbHandle, (BB_S8)pvalue, length)
extern BB_DbOffset32 BB_dbWriteMultiU16(BB_DbHndl *dbHandle, BB_U16 *pu16value,
                                        const BB_S32 s32length);
#define BB_dbWriteMultiS16(dbHandle, pvalue, length) \
  BB_dbWriteMultiU16(dbHandle, (BB_S16)pvalue, length)
extern BB_DbOffset32 BB_dbWriteMultiU32(BB_DbHndl *dbHandle, BB_U32 *pu32value,
                                        const BB_S32 s32length);
#define BB_dbWriteMultiS32(dbHandle, pvalue, length) \
  BB_dbWriteMultiU32(dbHandle, (BB_S32)pvalue, length)
#define BB_dbWriteMultiTCHAR(dbHandle, pvalue, length) \
  (BB_DbOffset) BB_dbWriteMultiU8(dbHandle, (BB_U8 *)pvalue, length)
