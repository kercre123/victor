...
class NotificationRenderer
 ...
 public:
  ...
  using SourceId =
      avsCommon::utils::mediaPlayer::MediaPlayerInterface::SourceId;
  ...
  /// @{
  void addObserver(
      std::shared_ptr<NotificationRendererObserverInterface> observer) override;
  void removeObserver(
      std::shared_ptr<NotificationRendererObserverInterface> observer) override;
  ...
  void onPlaybackError(SourceId sourceId,
 ...
 private:
  ...
  /// @c m_mutex.
  std::unordered_set<std::shared_ptr<NotificationRendererObserverInterface>>
      m_observers;
  ...
  /// Factory for creating @c istream instances containing the default audio
  /// asset.
