...
/**
 * This class implements an interface for interacting with a Notifications
 * database.
 *
 * Users should be notified of their pending notifications in the order that
 * SetIndicator directives are received. NotificationIndicators are therefore
 * stored in a queue and should be persisted across system shutdown.
 *
 * This storage is also responsible for maintaining IndicatorState as defined in
 * IndicatorState.h.
 */
class NotificationsStorageInterface {
 public:
   ...
   *
   * @param [out] notificationIndicator A pointer to receive the peeked @c
   ...
   *
   * @param [out] state A pointer to receive the currently stored @c
   * IndicatorState
