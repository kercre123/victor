...
/// Structure for specifying the traits of a SharedDataStream which works
...
struct InProcessSDSTraits {
  ...
  /// A std::vector provides a simple container to hold a buffer for in-process
  /// usage.
  ...
  /// A std::condition_variable provides a condition variable which will work
  /// for in-process usage.
...
/// Type alias for a SharedDataStream which works between threads in a single
/// process.
