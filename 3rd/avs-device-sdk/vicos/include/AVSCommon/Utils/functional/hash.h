 ...
 * Combination by XOR. A circular rotate left is applied to the seed value
 * before the XOR so that combining hashes generated by the same hash function
 * for the same value (a common use case) won't degenerate to zero.
 *
