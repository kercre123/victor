...
enum class AVRCPCommand {
  ...
  /// A Previous command. If issued at the beginning of a song, the previous
...
/**
 * Overload for the @c AVRCPCommand enum. This will write the @c AVRCPCommand as
 * a string to the provided stream.
 *
...
/// Used to implement an instance of AVRCPTarget (Audio/Video Remote Control
/// Profile).
