...
class CallManagerInterface
 ...
 public:
   ...
   * Constructor.
   *
   * @param objectName The name of the class or object which requires shutdown
   * calls.  Used in log messages when problems are detected in shutdown or
  ...
  CallManagerInterface(
      const std::string& objectName, const std::string& avsNamespace,
  ...
  virtual void addObserver(
      std::shared_ptr<avsCommon::sdkInterfaces::CallStateObserverInterface>
          observer) = 0;
...
inline CallManagerInterface::CallManagerInterface(
    ...
    : utils::RequiresShutdown{objectName},
      avsCommon::avs::CapabilityAgent{avsNamespace,
                                      exceptionEncounteredSender} {}
