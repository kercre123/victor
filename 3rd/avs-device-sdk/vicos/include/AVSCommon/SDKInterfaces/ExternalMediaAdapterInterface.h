...
class ExternalMediaAdapterInterface
 ...
 public:
   ...
   */
  virtual void handleLogin(const std::string& accessToken,
                           const std::string& userName, bool forceLogin,
   ...
   */
  virtual void handlePlay(std::string& playContextToken, int64_t index,
...
inline AdapterSessionState::AdapterSessionState()
    : loggedIn{false}, isGuest{false}, launched{false}, active{false} {}
...
inline ExternalMediaAdapterInterface::ExternalMediaAdapterInterface(
 ...
 */
inline std::string SupportedPlaybackOperationToString(
    SupportedPlaybackOperation operation) {
  switch (operation) {
