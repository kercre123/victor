...
class DialogUXStateObserverInterface {
 public:
  ...
  enum class DialogUXState {
    ...
    /**
     * A customer request has been completed and no more input is accepted. In
     * this state, Alexa is waiting for a response from AVS.
     */
    THINKING,
...
inline std::string DialogUXStateObserverInterface::stateToString(
    DialogUXState state) {
  switch (state) {
...
/**
 * Write a @c DialogUXStateObserverInterface::DialogUXState value to an @c
 * ostream as a string.
 *
 * @param stream The stream to write the value to.
 * @param state The @c DialogUXStateObserverInterface::DialogUXState value to
 * write to the @c ostream as a string.
