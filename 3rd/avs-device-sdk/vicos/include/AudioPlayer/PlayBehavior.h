...
/// Used to determine how a client must handle queueing and playback of a
/// stream.
enum class PlayBehavior {
  /**
   * Immediately begin playback of the stream returned with the @c Play
  ...
  /// Replace all streams in the queue. This does not impact the currently
  /// playing stream.
  REPLACE_ENQUEUED
};
 ...
 */
inline bool stringToPlayBehavior(const std::string& text,
 ...
 * @param playBehavior The @c PlayBehavior value to write to the @c ostream as a
 * string.
