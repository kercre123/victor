...
class HTTP2TransportFactory : public TransportFactoryInterface {
 public:
   ...
   *
   * @param connectionFactory Object used to create instances of
   * HTTP2ConnectionInterface.
   * @param postConnectFactory Object used to create instances of the
   * PostConnectInterface.
   */
  HTTP2TransportFactory(
      std::shared_ptr<avsCommon::utils::http2::HTTP2ConnectionFactoryInterface>
          connectionFactory,
 ...
 private:
  /// Save a pointer to the object used to create instances of the
  /// HTTP2ConnectionInterface.
  std::shared_ptr<avsCommon::utils::http2::HTTP2ConnectionFactoryInterface>
      m_connectionFactory;
