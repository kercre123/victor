...
/**
 * Class containing references to implementations for all equalizer related
 * interfaces.
 */
class EqualizerRuntimeSetup {
 public:
   ...
   */
  void setStorage(std::shared_ptr<
  ...
  /**
   * Adds @c EqualizerControllerListenerInterface instance to be used by the
   * SDK.
   *
   * @param listener @c EqualizerControllerListenerInterface instance to be used
   * by the SDK.
   */
  ...
  /**
   * Returns a list of all equalizer controller listeners that are going to be
   * used by the SDK.
   *
   * @return List of all equalizer controller listeners that are going to be
   * used by the SDK.
   */
