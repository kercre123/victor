...
/**
 * The @c VisualActivityTracker implements the @c ActivityTrackerInterface and
 * gets notification from the @c FocusManager any activities in the visual
 * channels.  It also implements the @c StateProviderInterface and will provide
 * to AVS the activity of the visual channels as described in Focus Management.
 */
class VisualActivityTracker
 ...
 public:
   ...
   * context for events.
   * @return A @c std::shared_ptr to the new @c VisualActivityTracker instance,
 ...
 private:
  ...
  /**
   * This function provides updated context information for
   * VisualActivityTracker to @c ContextManager.  This function is called when
   * @c ContextManager calls @c provideState().
   *
