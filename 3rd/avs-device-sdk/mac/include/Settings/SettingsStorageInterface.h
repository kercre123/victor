 ...
 * database, as well as for storing, loading, and modifying Settings.
 */
class SettingsStorageInterface {
 public:
   ...
   * @return @c true If the setting is stored in the database, @c false
   * otherwise.
   */
   ...
   */
  virtual bool load(
      std::unordered_map<std::string, std::string>* mapOfSettings) = 0;

  /**
   * Updates a database record of the Setting parameter.
   * The field which is updated by this operation is the value of the particular
   * setting.
   *
