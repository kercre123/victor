...
class PingHandler : public acl::ExchangeHandler,
 ...
 private:
   ...
   * @param authToken The token to use to authorize the request.
   */
  PingHandler(std::shared_ptr<ExchangeHandlerContextInterface> context,
              const std::string& authToken);
  ...
  avsCommon::utils::http2::HTTP2ReceiveDataStatus onReceiveData(
