...
/**
 * Handle HTTP response codes and finished notifications for mime encoded
 * responses from AVS.
 */
class MimeResponseStatusHandlerInterface {
 public:
   ...
   * @param nonMimeBody The body of the reply (for non
   * HTTPResponseCode::SUCCESS_OK responses)
   */
