...
class MessageRequestHandler
 ...
 public:
   ...
   *
   * @param context The ExchangeContext in which this MessageRequest handler
   * will operate.
 ...
 private:
  ...
  /**
   * Notify the associated HTTP2Transport instance that the message request
   * failed or was acknowledged by AVS.
   */
  ...
  avsCommon::utils::http2::HTTP2GetMimeHeadersResult getMimePartHeaderLines()
      override;
  avsCommon::utils::http2::HTTP2SendDataResult onSendMimePartData(
      char* bytes, size_t size) override;
  /// @}
  ...
  void onResponseFinished(
      ...
      const std::string& nonMimeBody) override;
  /// @}
