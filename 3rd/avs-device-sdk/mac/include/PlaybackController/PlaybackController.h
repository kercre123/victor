...
class PlaybackController
 ...
 public:
   ...
   *
   * @param contextManager The @c ContextManagerInterface used to generate
   * system context for events.
   * @param messageSender The @c MessageSenderInterface that sends events to
   * AVS.
  ...
  void onTogglePressed(avsCommon::avs::PlaybackToggle toggle,
   ...
   *
   * @param PlaybackCommand The @PlaybackButton or @PlaybackToggle that was
   * pressed to generate the message sent.
 ...
 private:
  ...
  /// The @c Executor which queues up operations from asynchronous API calls to
  /// the @c PlaybackControllerInterface.
