...
class PlaybackCommand {
 public:
   ...
   * Constructor
   *
   * @param name The distinguishing command name. It is either the event
   * name(v1.0), or the payload name(v1.1).
   */
   ...
   * @param command The @c PlaybackCommand value to write to the @c ostream as a
   * string.
   ...
   */
  static const PlaybackCommand& buttonToCommand(
   ...
   * @return The matched @c PlaybackCommand
   */
  static const PlaybackCommand& toggleToCommand(
      avsCommon::avs::PlaybackToggle toggle, bool action);
...
/**
 *  This class represents a @c PlaybackController 1.1 interface
 * ButtonCommandIssued.
 */
...
/**
 * This class represents a @c PlaybackController 1.1 interface @c
 * ToggleCommandIssued.
 */
class ToggleCommand : public PlaybackCommand {
 public:
   ...
   * @param action The action for this command. @ true indicates the *_SELECT
   * variant of a command, and @ false indicates the *_DESELECT variant.
   */
 ...
 private:
  ...
  /**
   * The toggle action associated with this object. The action for this command.
   * @ true indicates the *_SELECT variant of a command, and @ false indicates
   * the *_DESELECT variant.
   */
  bool m_action;
};
