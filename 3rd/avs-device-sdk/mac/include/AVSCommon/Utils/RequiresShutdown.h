...
/**
 * Abstract base class which requires the derived class to implement a shutdown
 * function and tries to verify that client code calls @c shutdown() correctly.
 */
class RequiresShutdown {
 public:
  ...
  /**
   * Prepares/enables this object to be deleted.  This should be the last
   * function called on this object prior to deleting (or resetting) its
   * shared_ptr.
   *
   * @warning
   * @li Attempting to call functions on this object after calling shutdown()
   * can result in undefined behavior.
   * @li Neglecting to call shutdown() on this object can result in resource
