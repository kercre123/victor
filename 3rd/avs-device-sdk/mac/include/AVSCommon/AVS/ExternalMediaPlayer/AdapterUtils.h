...
/**
 * Method to iterate over a vector of supported operation in playback state and
 * convert to JSON.
 *
 * @param supportedOperations The array of supported operations from the current
 * playback state.
...
rapidjson::Value buildSupportedOperations(
    const std::vector<avsCommon::sdkInterfaces::externalMediaPlayer::
                          SupportedPlaybackOperation>& supportedOperations,
...
rapidjson::Value buildPlaybackState(
    const avsCommon::sdkInterfaces::externalMediaPlayer::AdapterPlaybackState&
        playbackState,
    rapidjson::Document::AllocatorType& allocator);
...
rapidjson::Value buildSessionState(
    const avsCommon::sdkInterfaces::externalMediaPlayer::AdapterSessionState&
        sessionState,
    rapidjson::Document::AllocatorType& allocator);
 ...
 * otherwise.
 */
bool buildDefaultPlayerState(rapidjson::Value* document,
                             rapidjson::Document::AllocatorType& allocator);
