...
class AttachmentWriter {
 public:
  /**
   * An enum class to communicate the possible states following a @c write()
   * call.
   */
   ...
   * @param[out] writeStatus The out-parameter where the resulting state of the
   * write will be expressed.
  ...
  virtual std::size_t write(
      const void* buf, std::size_t numBytes, WriteStatus* writeStatus,
   ...
   * management when a writer no longer needs to use an attachment.
   */
