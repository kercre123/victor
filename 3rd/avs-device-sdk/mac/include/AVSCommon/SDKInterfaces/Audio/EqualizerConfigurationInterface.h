...
/**
 * Interface to provide a configuration of equalizer capabilities supported by
 * the device.
 */
class EqualizerConfigurationInterface {
 public:
  ...
  /**
   * Returns @c EqualizerState object defining default values for equalizer mode
   * and band levels. These values should be used when resetting any band to its
   * default level.
   *
