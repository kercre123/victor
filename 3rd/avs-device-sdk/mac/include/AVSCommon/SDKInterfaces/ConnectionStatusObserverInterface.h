...
/**
 * This class allows a client to be notified of changes to connection status to
 * AVS.
 */
class ConnectionStatusObserverInterface {
 public:
  ...
  enum class ChangedReason {
    /// The non-reason, to be used when no reason is specified (i.e. the 'unset'
    /// value).
    NONE,
    ...
    /// The connection status changed due to the client interacting with the
    /// Connection public api.
    ACL_CLIENT_REQUEST,

    /// The connection attempt failed due to the Connection object being
    /// disabled.
    ACL_DISABLED,
...
/**
 * Write a @c ConnectionStatusObserverInterface::Status value to an @c ostream
 * as a string.
 *
 * @param stream The stream to write the value to.
 * @param status The ConnectionStatusObserverInterface::Status value to write to
 * the @c ostream as a string.
 * @return The @c ostream that was passed in and written to.
 */
inline std::ostream& operator<<(
    std::ostream& stream, ConnectionStatusObserverInterface::Status status) {
  switch (status) {
...
/**
 * Write a @c ConnectionStatusObserverInterface::ChangeReason value to an @c
 * ostream as a string.
 *
 * @param stream The stream to write the value to.
 * @param reason The ConnectionStatusObserverInterface::ChangeReason value to
...
inline std::ostream& operator<<(
  ...
  switch (reason) {
    ...
    case ConnectionStatusObserverInterface::ChangedReason::READ_TIMEDOUT:
      ...
      break;
    case ConnectionStatusObserverInterface::ChangedReason::
        FAILURE_PROTOCOL_ERROR:
