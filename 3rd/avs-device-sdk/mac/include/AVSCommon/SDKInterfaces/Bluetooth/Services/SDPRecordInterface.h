...
/// Used to implement ServiceDiscoveryProtocol records. This allows
/// identification of the service.
class SDPRecordInterface {
 public:
  /**
   * The base UUID of a Bluetooth service. All service UUIDs are calculated from
   * this. Services have a short uuid assigned that is either uuid16 or uuid32.
   * For example:
   *
