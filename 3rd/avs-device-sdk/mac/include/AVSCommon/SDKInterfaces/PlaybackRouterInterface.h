...
class PlaybackRouterInterface {
 public:
  ...
  /**
   * This method can be called by the client when a Button is pressed on a
   * physical button or on the GUI. A ButtonCommandIssued event message will be
  ...
  /**
   * This method can be called by the client when a Toggle is pressed on a
   * physical button or on the GUI. A ToggleCommandIssued event message will be
   * sent to the observer.
   *
  ...
  /**
   * This method sets the playback button press handler that any time a button
   * is pressed this handler will be called.
   *
   * @param handler - The handler to call on future playback button presses.
   */
  virtual void setHandler(
      std::shared_ptr<PlaybackHandlerInterface> handler) = 0;

  /**
   * This method switches playback button pressess handling to the default
   * handler.
   */
