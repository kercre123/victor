...
/**
 * This interface is used to observe changes to the device registration, such as
 * user logout.
 */
class RegistrationObserverInterface {
 public:
   ...
   *
   * @warning This method is called while RegistrationManager is in a locked
   * state. The callback must not block on calls to RegistrationManager methods
   * either.
   */
