...
/**
 * A class which will convert AVRCP commands to the related @c
 * PlaybackRouterInterface commands.
 */
class BluetoothAVRCPTransformer
 ...
 public:
   ...
   *
   * @param eventBus The @c BluetoothEventBus in which @c
   * AVRCPCommandReceivedEvent events will appear.
   * @param playbackRouter The @c PlaybackRouterInterface in which AVRCP
   * commands will be transformed to.
   *
