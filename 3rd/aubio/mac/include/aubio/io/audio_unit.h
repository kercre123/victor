...
typedef uint_t (*aubio_device_callback_t)(void *closure, fmat_t *ibuf,
                                          fmat_t *obuf);
...
sint_t aubio_audio_unit_set_preferred_latency(aubio_audio_unit_t *o,
                                              smpl_t latency);
sint_t aubio_audio_unit_set_prevent_feedback(aubio_audio_unit_t *o,
                                             uint_t prevent_feedback);
