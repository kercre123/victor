...
inline const char **EnumNamesBaseType() {
  static const char *names[] = {"None",  "UType",  "Bool",   "Byte",   "UByte",
...
inline const char *EnumNameBaseType(BaseType e) {
  return EnumNamesBaseType()[static_cast<int>(e)];
}
...
struct TypeBuilder {
  ...
  TypeBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
...
struct KeyValueBuilder {
  ...
  KeyValueBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<KeyValue> CreateKeyValueDirect(
  ...
  return CreateKeyValue(_fbb, key ? _fbb.CreateString(key) : 0,
                        value ? _fbb.CreateString(value) : 0);
}

struct EnumVal FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  enum { VT_NAME = 4, VT_VALUE = 6, VT_OBJECT = 8 };
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.VerifyTable(object()) && verifier.EndTable();
  }
};
...
struct EnumValBuilder {
  ...
  EnumValBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
struct EnumBuilder {
  ...
  EnumBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
struct FieldBuilder {
  ...
  FieldBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
struct ObjectBuilder {
  ...
  ObjectBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
struct SchemaBuilder {
  ...
  SchemaBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
