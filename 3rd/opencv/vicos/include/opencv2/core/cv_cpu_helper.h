...
#define CV_CPU_CALL_SSE(fn, args) \
  if (CV_CPU_HAS_SUPPORT_SSE) return (opt_SSE::fn args)
#else
#define CV_TRY_SSE 0
...
#define CV_CPU_CALL_SSE2(fn, args) \
  if (CV_CPU_HAS_SUPPORT_SSE2) return (opt_SSE2::fn args)
#else
...
#define CV_CPU_CALL_SSE3(fn, args) \
  if (CV_CPU_HAS_SUPPORT_SSE3) return (opt_SSE3::fn args)
#else
...
#define CV_CPU_CALL_SSSE3(fn, args) \
  if (CV_CPU_HAS_SUPPORT_SSSE3) return (opt_SSSE3::fn args)
#else
...
#define CV_CPU_CALL_SSE4_1(fn, args) \
  if (CV_CPU_HAS_SUPPORT_SSE4_1) return (opt_SSE4_1::fn args)
#else
...
#define CV_CPU_CALL_SSE4_2(fn, args) \
  if (CV_CPU_HAS_SUPPORT_SSE4_2) return (opt_SSE4_2::fn args)
#else
...
#define CV_CPU_CALL_POPCNT(fn, args) \
  if (CV_CPU_HAS_SUPPORT_POPCNT) return (opt_POPCNT::fn args)
#else
...
#define CV_CPU_CALL_AVX(fn, args) \
  if (CV_CPU_HAS_SUPPORT_AVX) return (opt_AVX::fn args)
#else
#define CV_TRY_AVX 0
...
#define CV_CPU_CALL_FP16(fn, args) \
  if (CV_CPU_HAS_SUPPORT_FP16) return (opt_FP16::fn args)
#else
...
#define CV_CPU_CALL_AVX2(fn, args) \
  if (CV_CPU_HAS_SUPPORT_AVX2) return (opt_AVX2::fn args)
#else
...
#define CV_CPU_CALL_FMA3(fn, args) \
  if (CV_CPU_HAS_SUPPORT_FMA3) return (opt_FMA3::fn args)
#else
...
#define CV_CPU_CALL_NEON(fn, args) \
  if (CV_CPU_HAS_SUPPORT_NEON) return (opt_NEON::fn args)
#else
...
#define CV_CPU_CALL_VSX(fn, args) \
  if (CV_CPU_HAS_SUPPORT_VSX) return (opt_VSX::fn args)
#else
#define CV_TRY_VSX 0
