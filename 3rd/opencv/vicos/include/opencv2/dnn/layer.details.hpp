 ...
 *   @param constuctorFunc pointer to the function of type
 * LayerRegister::Constuctor, which creates the layer.
...
#define CV_DNN_REGISTER_LAYER_CLASS(type, class) \
  cv::dnn::LayerFactory::registerLayer(          \
      #type, cv::dnn::details::_layerDynamicRegisterer<class>);
...
#define CV_DNN_REGISTER_LAYER_FUNC_STATIC(type, constuctorFunc) \
  static cv::dnn::details::_LayerStaticRegisterer               \
      __LayerStaticRegisterer_##type(#type, constuctorFunc);
...
#define CV_DNN_REGISTER_LAYER_CLASS_STATIC(type, class)                 \
  ...
  static cv::dnn::details::_LayerStaticRegisterer                       \
      __LayerStaticRegisterer_##type(#type,                             \
                                     __LayerStaticRegisterer_func_##type);
