 ...
 * Method:    void nBitmapToMat2(Bitmap b, long m_addr, boolean
 * unPremultiplyAlpha)
 */
...
// old signature is left for binary compatibility with 2.4.0 & 2.4.1, to removed
// in 2.5
