  ...
  ResizeNearestNeighborLayerImpl(const LayerParams &params) {
    ...
    if (alignCorners)
      CV_Error(Error::StsNotImplemented,
               "Nearest neighborhood resize with align_corners=true is not "
               "implemented");
  }
...
Ptr<ResizeNearestNeighborLayer> ResizeNearestNeighborLayer::create(
    const LayerParams &params) {
  return Ptr<ResizeNearestNeighborLayer>(
      new ResizeNearestNeighborLayerImpl(params));
}
