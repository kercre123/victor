...
void protobuf_AssignDesc_tensor_2eproto() {
  ...
  static const int TensorProto_offsets_[13] = {
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TensorProto,
                                                     tensor_shape_),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TensorProto,
                                                     version_number_),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TensorProto,
...
void protobuf_AddDesc_tensor_2eproto_impl() {
  ...
  ::google::protobuf::internal::OnShutdown(
      &protobuf_ShutdownFile_tensor_2eproto);
}
...
::tensorflow::TensorShapeProto* TensorProto::_slow_release_tensor_shape() {
  if (tensor_shape_ == NULL) {
    ...
    ::tensorflow::TensorShapeProto* temp =
        new ::tensorflow::TensorShapeProto(*tensor_shape_);
    tensor_shape_ = NULL;
    return temp;
  }
}
  ...
  if (message_arena != NULL &&
    ...
    ::tensorflow::TensorShapeProto* new_tensor_shape =
        ::google::protobuf::Arena::CreateMessage<
            ::tensorflow::TensorShapeProto>(message_arena);
...
#define ZR_HELPER_(f)                                                  \
  _Pragma("clang diagnostic push")                                     \
      _Pragma(                                                         \
          ...
          "\"-Winvalid-offsetof\"") __builtin_offsetof(TensorProto, f) \
          _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) \
  reinterpret_cast<char*>(&reinterpret_cast<TensorProto*>(16)->f)
#endif
      ...
      case 2: {
        ...
        parse_tensor_shape:
          DO_(::google::protobuf::internal::WireFormatLite::
                  ReadMessageNoVirtual(input, mutable_tensor_shape()));
        } else {
          goto handle_unusual;
        }
          ...
          DO_((::google::protobuf::internal::WireFormatLite::
                   ReadRepeatedPrimitiveNoInline<
                       double, ::google::protobuf::internal::WireFormatLite::
                                   TYPE_DOUBLE>(1, 50, input,
                                                this->mutable_double_val())));
        } else {
          goto handle_unusual;
        }
      ...
      case 12: {
        ...
        parse_dcomplex_val:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::
                   ReadRepeatedPrimitiveNoInline<
                       double, ::google::protobuf::internal::WireFormatLite::
                                   TYPE_DOUBLE>(1, 98, input,
                                                this->mutable_dcomplex_val())));
        } else {
          goto handle_unusual;
        }
...
void TensorProto::SerializeWithCachedSizes(
  ...
  // optional .tensorflow.DataType dtype = 1;
  if (this->dtype() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteEnum(1, this->dtype(),
                                                            output);
  }
...
::google::protobuf::uint8* TensorProto::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_tensor_shape()) {
    target = ::google::protobuf::internal::WireFormatLite::
        InternalWriteMessageNoVirtualToArray(2, *this->tensor_shape_, false,
                                             target);
  }
  ...
  for (int i = 0; i < this->int_val_size(); i++) {
    target =
        ::google::protobuf::internal::WireFormatLite::WriteInt32NoTagToArray(
            this->int_val(i), target);
  }

  // repeated bytes string_val = 8;
  for (int i = 0; i < this->string_val_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBytesToArray(
        8, this->string_val(i), target);
  }
...
size_t TensorProto::ByteSizeLong() const {
  ...
  // repeated bytes string_val = 8;
  total_size +=
      1 * ::google::protobuf::internal::FromIntSize(this->string_val_size());
  for (int i = 0; i < this->string_val_size(); i++) {
  ...
  // repeated int64 int64_val = 10 [packed = true];
  {
    ...
    for (unsigned int i = 0; i < count; i++) {
      data_size += ::google::protobuf::internal::WireFormatLite::Int64Size(
          this->int64_val(i));
    }
    if (data_size > 0) {
      total_size += 1 + ::google::protobuf::internal::WireFormatLite::Int32Size(
...
void TensorProto::UnsafeMergeFrom(const TensorProto& from) {
  ...
  if (from.has_tensor_shape()) {
    mutable_tensor_shape()->::tensorflow::TensorShapeProto::MergeFrom(
        from.tensor_shape());
  }
...
// optional .tensorflow.DataType dtype = 1;
void TensorProto::clear_dtype() { dtype_ = 0; }
...
void TensorProto::set_allocated_tensor_shape(
    ::tensorflow::TensorShapeProto* tensor_shape) {
...
// optional int32 version_number = 3;
void TensorProto::clear_version_number() { version_number_ = 0; }
...
// repeated int32 half_val = 13 [packed = true];
int TensorProto::half_val_size() const { return half_val_.size(); }
void TensorProto::clear_half_val() { half_val_.Clear(); }
...
// repeated float float_val = 5 [packed = true];
int TensorProto::float_val_size() const { return float_val_.size(); }
void TensorProto::clear_float_val() { float_val_.Clear(); }
...
const ::google::protobuf::RepeatedField<float>& TensorProto::float_val() const {
  // @@protoc_insertion_point(field_list:tensorflow.TensorProto.float_val)
  return float_val_;
}
::google::protobuf::RepeatedField<float>* TensorProto::mutable_float_val() {
  // @@protoc_insertion_point(field_mutable_list:tensorflow.TensorProto.float_val)
  return &float_val_;
}

// repeated double double_val = 6 [packed = true];
int TensorProto::double_val_size() const { return double_val_.size(); }
void TensorProto::clear_double_val() { double_val_.Clear(); }
...
const ::google::protobuf::RepeatedField<double>& TensorProto::double_val()
    const {
  // @@protoc_insertion_point(field_list:tensorflow.TensorProto.double_val)
  return double_val_;
}
::google::protobuf::RepeatedField<double>* TensorProto::mutable_double_val() {
  // @@protoc_insertion_point(field_mutable_list:tensorflow.TensorProto.double_val)
  return &double_val_;
}

// repeated int32 int_val = 7 [packed = true];
int TensorProto::int_val_size() const { return int_val_.size(); }
void TensorProto::clear_int_val() { int_val_.Clear(); }
...
// repeated bytes string_val = 8;
int TensorProto::string_val_size() const { return string_val_.size(); }
void TensorProto::clear_string_val() { string_val_.Clear(); }
...
// repeated float scomplex_val = 9 [packed = true];
int TensorProto::scomplex_val_size() const { return scomplex_val_.size(); }
void TensorProto::clear_scomplex_val() { scomplex_val_.Clear(); }
...
const ::google::protobuf::RepeatedField<float>& TensorProto::scomplex_val()
    const {
  // @@protoc_insertion_point(field_list:tensorflow.TensorProto.scomplex_val)
  return scomplex_val_;
}
::google::protobuf::RepeatedField<float>* TensorProto::mutable_scomplex_val() {
  // @@protoc_insertion_point(field_mutable_list:tensorflow.TensorProto.scomplex_val)
  return &scomplex_val_;
}

// repeated int64 int64_val = 10 [packed = true];
int TensorProto::int64_val_size() const { return int64_val_.size(); }
void TensorProto::clear_int64_val() { int64_val_.Clear(); }
...
// repeated bool bool_val = 11 [packed = true];
int TensorProto::bool_val_size() const { return bool_val_.size(); }
void TensorProto::clear_bool_val() { bool_val_.Clear(); }
...
const ::google::protobuf::RepeatedField<bool>& TensorProto::bool_val() const {
  // @@protoc_insertion_point(field_list:tensorflow.TensorProto.bool_val)
  return bool_val_;
}
::google::protobuf::RepeatedField<bool>* TensorProto::mutable_bool_val() {
  // @@protoc_insertion_point(field_mutable_list:tensorflow.TensorProto.bool_val)
  return &bool_val_;
}

// repeated double dcomplex_val = 12 [packed = true];
int TensorProto::dcomplex_val_size() const { return dcomplex_val_.size(); }
void TensorProto::clear_dcomplex_val() { dcomplex_val_.Clear(); }
...
const ::google::protobuf::RepeatedField<double>& TensorProto::dcomplex_val()
    const {
  // @@protoc_insertion_point(field_list:tensorflow.TensorProto.dcomplex_val)
  return dcomplex_val_;
}
::google::protobuf::RepeatedField<double>* TensorProto::mutable_dcomplex_val() {
