...
extern ::google::protobuf::internal::ExplicitlyConstructed<OpDef_ArgDef>
...
extern ::google::protobuf::internal::ExplicitlyConstructed<OpDef_AttrDef>
...
extern ::google::protobuf::internal::ExplicitlyConstructed<OpDef>
...
extern ::google::protobuf::internal::ExplicitlyConstructed<OpDeprecation>
...
extern ::google::protobuf::internal::ExplicitlyConstructed<OpList>
...
inline void OpDef_ArgDef::set_allocated_description(
...
inline void OpDef_ArgDef::set_allocated_number_attr(
...
inline void OpDef_AttrDef::set_allocated_description(
    ::std::string* description) {
  if (description != NULL) {
  } else {
  }
...
// optional int64 minimum = 6;
inline void OpDef_AttrDef::clear_minimum() { minimum_ = GOOGLE_LONGLONG(0); }
...
// repeated .tensorflow.OpDef.ArgDef input_arg = 2;
inline int OpDef::input_arg_size() const { return input_arg_.size(); }
...
// repeated .tensorflow.OpDef.ArgDef output_arg = 3;
inline int OpDef::output_arg_size() const { return output_arg_.size(); }
...
// repeated .tensorflow.OpDef.AttrDef attr = 4;
inline int OpDef::attr_size() const { return attr_.size(); }
...
inline void OpDeprecation::set_allocated_explanation(
...
// repeated .tensorflow.OpDef op = 1;
inline int OpList::op_size() const { return op_.size(); }
