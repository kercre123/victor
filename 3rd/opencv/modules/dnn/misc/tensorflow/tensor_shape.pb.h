...
extern ::google::protobuf::internal::ExplicitlyConstructed<TensorShapeProto_Dim>
...
extern ::google::protobuf::internal::ExplicitlyConstructed<TensorShapeProto>
...
// optional int64 size = 1;
inline void TensorShapeProto_Dim::clear_size() { size_ = GOOGLE_LONGLONG(0); }
...
// repeated .tensorflow.TensorShapeProto.Dim dim = 2;
inline int TensorShapeProto::dim_size() const { return dim_.size(); }
inline void TensorShapeProto::clear_dim() { dim_.Clear(); }
inline const ::tensorflow::TensorShapeProto_Dim& TensorShapeProto::dim(
    int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.TensorShapeProto.dim)
  return dim_.Get(index);
}
inline ::tensorflow::TensorShapeProto_Dim* TensorShapeProto::mutable_dim(
    int index) {
...
// optional bool unknown_rank = 3;
inline void TensorShapeProto::clear_unknown_rank() { unknown_rank_ = false; }
