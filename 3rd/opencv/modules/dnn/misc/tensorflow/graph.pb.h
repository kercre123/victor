                                                     ...
                                                     */
{
 ...
 public:
  ...
  const ::google::protobuf::RepeatedPtrField< ::tensorflow::NodeDef>& node()
      const;
 ...
 private:
  ...
  void _slow_set_allocated_versions(::google::protobuf::Arena* message_arena,
 ...
 public:
  ...
  void unsafe_arena_set_allocated_versions(::tensorflow::VersionDef* versions);
  ...
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_version(
 ...
 private:
  ...
  void _slow_set_allocated_library(::google::protobuf::Arena* message_arena,
...
extern ::google::protobuf::internal::ExplicitlyConstructed<GraphDef>
                                                    ...
                                                    */
{
 ...
 public:
  ...
  void unsafe_arena_set_allocated_op(::std::string* op);
  ...
  void unsafe_arena_set_allocated_device(::std::string* device);
...
extern ::google::protobuf::internal::ExplicitlyConstructed<NodeDef>
...
// repeated .tensorflow.NodeDef node = 1;
inline int GraphDef::node_size() const { return node_.size(); }
inline void GraphDef::clear_node() { node_.Clear(); }
...
inline void GraphDef::set_allocated_versions(
    ::tensorflow::VersionDef* versions) {
...
// optional int32 version = 3 [deprecated = true];
inline void GraphDef::clear_version() { version_ = 0; }
...
inline void GraphDef::set_allocated_library(
    ::tensorflow::FunctionDefLibrary* library) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete library_;
...
inline void NodeDef::unsafe_arena_set_allocated_name(::std::string* name) {
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
  if (name != NULL) {
  } else {
  }
...
inline void NodeDef::unsafe_arena_set_allocated_op(::std::string* op) {
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
  if (op != NULL) {
  } else {
  }
...
// repeated string input = 3;
inline int NodeDef::input_size() const { return input_.size(); }
inline void NodeDef::clear_input() { input_.Clear(); }
...
inline void NodeDef::unsafe_arena_set_allocated_device(::std::string* device) {
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
  if (device != NULL) {
  } else {
  }
...
// map<string, .tensorflow.AttrValue> attr = 5;
inline int NodeDef::attr_size() const { return attr_.size(); }
inline void NodeDef::clear_attr() { attr_.Clear(); }
