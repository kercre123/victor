...
extern ::google::protobuf::internal::ExplicitlyConstructed<FunctionDefLibrary>
...
extern ::google::protobuf::internal::ExplicitlyConstructed<FunctionDef_Node>
                                                        ...
                                                        */
{
 ...
 private:
  ...
  void _slow_set_allocated_signature(::google::protobuf::Arena* message_arena,
...
extern ::google::protobuf::internal::ExplicitlyConstructed<FunctionDef>
...
extern ::google::protobuf::internal::ExplicitlyConstructed<GradientDef>
...
// repeated string ret = 1;
inline int FunctionDef_Node::ret_size() const { return ret_.size(); }
inline void FunctionDef_Node::clear_ret() { ret_.Clear(); }
...
inline void FunctionDef_Node::unsafe_arena_set_allocated_op(::std::string* op) {
  GOOGLE_DCHECK(GetArenaNoVirtual() != NULL);
  if (op != NULL) {
  } else {
  }
...
// repeated string arg = 3;
inline int FunctionDef_Node::arg_size() const { return arg_.size(); }
inline void FunctionDef_Node::clear_arg() { arg_.Clear(); }
...
// repeated string dep = 4;
inline int FunctionDef_Node::dep_size() const { return dep_.size(); }
inline void FunctionDef_Node::clear_dep() { dep_.Clear(); }
...
// map<string, .tensorflow.AttrValue> attr = 5;
inline int FunctionDef_Node::attr_size() const { return attr_.size(); }
inline void FunctionDef_Node::clear_attr() { attr_.Clear(); }
...
// repeated .tensorflow.FunctionDef.Node node = 2;
inline int FunctionDef::node_size() const { return node_.size(); }
inline void FunctionDef::clear_node() { node_.Clear(); }
inline const ::tensorflow::FunctionDef_Node& FunctionDef::node(
    int index) const {
