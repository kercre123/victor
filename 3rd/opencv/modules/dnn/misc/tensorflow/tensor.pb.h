                                                        ...
                                                        */
{
 ...
 public:
  ...
  const ::google::protobuf::RepeatedField< ::google::protobuf::int32>& int_val()
      const;
  ::google::protobuf::RepeatedField< ::google::protobuf::int32>*
  mutable_int_val();
  ...
  const ::google::protobuf::RepeatedPtrField< ::std::string>& string_val()
      const;
...
extern ::google::protobuf::internal::ExplicitlyConstructed<TensorProto>
...
// repeated int32 half_val = 13 [packed = true];
inline int TensorProto::half_val_size() const { return half_val_.size(); }
...
// repeated float float_val = 5 [packed = true];
inline int TensorProto::float_val_size() const { return float_val_.size(); }
...
inline const ::google::protobuf::RepeatedField<float>& TensorProto::float_val()
    const {
...
// repeated double double_val = 6 [packed = true];
inline int TensorProto::double_val_size() const { return double_val_.size(); }
...
// repeated int32 int_val = 7 [packed = true];
inline int TensorProto::int_val_size() const { return int_val_.size(); }
...
// repeated bytes string_val = 8;
inline int TensorProto::string_val_size() const { return string_val_.size(); }
...
// repeated int64 int64_val = 10 [packed = true];
inline int TensorProto::int64_val_size() const { return int64_val_.size(); }
...
// repeated bool bool_val = 11 [packed = true];
inline int TensorProto::bool_val_size() const { return bool_val_.size(); }
...
inline const ::google::protobuf::RepeatedField<bool>& TensorProto::bool_val()
    const {
