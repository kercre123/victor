...
extern ::google::protobuf::internal::ExplicitlyConstructed<VersionDef>
...
// optional int32 producer = 1;
inline void VersionDef::clear_producer() { producer_ = 0; }
...
// optional int32 min_consumer = 2;
inline void VersionDef::clear_min_consumer() { min_consumer_ = 0; }
...
inline void VersionDef::clear_bad_consumers() { bad_consumers_.Clear(); }
...
inline void VersionDef::set_bad_consumers(int index,
