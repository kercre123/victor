...
#define DEF_ACC_INT_FUNCS(suffix, type, acctype)                               \
  void acc_##suffix(const type* src, acctype* dst, const uchar* mask, int len, \
                    int cn) {                                                  \
  ...
  void accSqr_##suffix(const type* src, acctype* dst, const uchar* mask,       \
                       int len, int cn) {                                      \
  ...
  void accProd_##suffix(const type* src1, const type* src2, acctype* dst,      \
  ...
  void accW_##suffix(const type* src, acctype* dst, const uchar* mask,         \
                     int len, int cn, double alpha) {                          \
...
void acc_simd_(const uchar* src, float* dst, const uchar* mask, int len,
               int cn);
void acc_simd_(const ushort* src, float* dst, const uchar* mask, int len,
               int cn);
void acc_simd_(const uchar* src, double* dst, const uchar* mask, int len,
               int cn);
void acc_simd_(const ushort* src, double* dst, const uchar* mask, int len,
               int cn);
void acc_simd_(const float* src, float* dst, const uchar* mask, int len,
               int cn);
void acc_simd_(const float* src, double* dst, const uchar* mask, int len,
               int cn);
void acc_simd_(const double* src, double* dst, const uchar* mask, int len,
               int cn);
void accSqr_simd_(const uchar* src, float* dst, const uchar* mask, int len,
                  int cn);
void accSqr_simd_(const ushort* src, float* dst, const uchar* mask, int len,
                  int cn);
void accSqr_simd_(const uchar* src, double* dst, const uchar* mask, int len,
                  int cn);
void accSqr_simd_(const ushort* src, double* dst, const uchar* mask, int len,
                  int cn);
void accSqr_simd_(const float* src, float* dst, const uchar* mask, int len,
                  int cn);
void accSqr_simd_(const float* src, double* dst, const uchar* mask, int len,
                  int cn);
void accSqr_simd_(const double* src, double* dst, const uchar* mask, int len,
                  int cn);
void accProd_simd_(const uchar* src1, const uchar* src2, float* dst,
                   const uchar* mask, int len, int cn);
void accProd_simd_(const ushort* src1, const ushort* src2, float* dst,
                   const uchar* mask, int len, int cn);
void accProd_simd_(const uchar* src1, const uchar* src2, double* dst,
                   const uchar* mask, int len, int cn);
void accProd_simd_(const ushort* src1, const ushort* src2, double* dst,
                   const uchar* mask, int len, int cn);
void accProd_simd_(const float* src1, const float* src2, float* dst,
                   const uchar* mask, int len, int cn);
void accProd_simd_(const float* src1, const float* src2, double* dst,
                   const uchar* mask, int len, int cn);
void accProd_simd_(const double* src1, const double* src2, double* dst,
                   const uchar* mask, int len, int cn);
void accW_simd_(const uchar* src, float* dst, const uchar* mask, int len,
                int cn, double alpha);
void accW_simd_(const ushort* src, float* dst, const uchar* mask, int len,
                int cn, double alpha);
void accW_simd_(const uchar* src, double* dst, const uchar* mask, int len,
                int cn, double alpha);
void accW_simd_(const ushort* src, double* dst, const uchar* mask, int len,
                int cn, double alpha);
void accW_simd_(const float* src, float* dst, const uchar* mask, int len,
                int cn, double alpha);
void accW_simd_(const float* src, double* dst, const uchar* mask, int len,
                int cn, double alpha);
void accW_simd_(const double* src, double* dst, const uchar* mask, int len,
                int cn, double alpha);

// accumulate series optimized by AVX
void acc_avx_32f(const float* src, float* dst, const uchar* mask, int len,
                 int cn);
void acc_avx_32f64f(const float* src, double* dst, const uchar* mask, int len,
                    int cn);
void acc_avx_64f(const double* src, double* dst, const uchar* mask, int len,
                 int cn);
void accSqr_avx_32f(const float* src, float* dst, const uchar* mask, int len,
                    int cn);
void accSqr_avx_32f64f(const float* src, double* dst, const uchar* mask,
                       int len, int cn);
void accSqr_avx_64f(const double* src, double* dst, const uchar* mask, int len,
                    int cn);
void accProd_avx_32f(const float* src1, const float* src2, float* dst,
                     const uchar* mask, int len, int cn);
void accProd_avx_32f64f(const float* src1, const float* src2, double* dst,
                        const uchar* mask, int len, int cn);
void accProd_avx_64f(const double* src1, const double* src2, double* dst,
                     const uchar* mask, int len, int cn);
void accW_avx_32f(const float* src, float* dst, const uchar* mask, int len,
                  int cn, double alpha);
void accW_avx_32f64f(const float* src, double* dst, const uchar* mask, int len,
                     int cn, double alpha);
void accW_avx_64f(const double* src, double* dst, const uchar* mask, int len,
                  int cn, double alpha);

#ifndef CV_CPU_OPTIMIZATION_DECLARATIONS_ONLY

template <typename T, typename AT>
void acc_general_(const T* src, AT* dst, const uchar* mask, int len, int cn,
                  int start = 0) {
  int i = start;
...
template <typename T, typename AT>
void accSqr_general_(const T* src, AT* dst, const uchar* mask, int len, int cn,
                     int start = 0) {
  int i = start;
...
template <typename T, typename AT>
void accProd_general_(const T* src1, const T* src2, AT* dst, const uchar* mask,
                      int len, int cn, int start = 0) {
  int i = start;
...
template <typename T, typename AT>
void accW_general_(const T* src, AT* dst, const uchar* mask, int len, int cn,
                   double alpha, int start = 0) {
  AT a = (AT)alpha, b = 1 - a;
  int i = start;
...
void acc_simd_(const uchar* src, float* dst, const uchar* mask, int len,
  ...
  if (!mask) {
    ...
    for (; x <= size - cVectorWidth; x += cVectorWidth) {
      ...
      v_store(dst + x,
              v_load(dst + x) + v_cvt_f32(v_reinterpret_as_s32(v_src00)));
      v_store(dst + x + 4,
              v_load(dst + x + 4) + v_cvt_f32(v_reinterpret_as_s32(v_src01)));
      v_store(dst + x + 8,
              v_load(dst + x + 8) + v_cvt_f32(v_reinterpret_as_s32(v_src10)));
      v_store(dst + x + 12,
              v_load(dst + x + 12) + v_cvt_f32(v_reinterpret_as_s32(v_src11)));
    }
  } else {
    ...
    if (cn == 1) {
      for (; x <= len - cVectorWidth; x += cVectorWidth) {
        ...
        v_store(dst + x + 8,
                v_load(dst + x + 8) + v_cvt_f32(v_reinterpret_as_s32(v_src10)));
        v_store(dst + x + 12, v_load(dst + x + 12) +
                                  v_cvt_f32(v_reinterpret_as_s32(v_src11)));
      }
    } else if (cn == 3) {
      for (; x <= len - cVectorWidth; x += cVectorWidth) {
        v_uint8x16 v_mask = v_load(mask + x);
        ...
        v_load_deinterleave(dst + ((x + 12) * cn), v_dst011, v_dst111,
                            v_dst211);
...
void acc_simd_(const ushort* src, float* dst, const uchar* mask, int len,
  ...
  if (!mask) {
    ...
    for (; x <= size - cVectorWidth; x += cVectorWidth) {
      ...
      v_store(dst + x,
              v_load(dst + x) + v_cvt_f32(v_reinterpret_as_s32(v_src0)));
      v_store(dst + x + 4,
              v_load(dst + x + 4) + v_cvt_f32(v_reinterpret_as_s32(v_src1)));
    }
  } else {
    if (cn == 1) {
  ...
  if (!mask) {
    ...
    if (cn == 1) {
      for (; x <= len - cVectorWidth; x += cVectorWidth) {
        ...
        v_float32x4 v_mask0 =
            v_reinterpret_as_f32(~(v_masku320 == v_reinterpret_as_u32(v_0)));
        v_float32x4 v_mask1 =
            v_reinterpret_as_f32(~(v_masku321 == v_reinterpret_as_u32(v_0)));

        v_store(dst + x, v_load(dst + x) + (v_load(src + x) & v_mask0));
        v_store(dst + x + 4,
                v_load(dst + x + 4) + (v_load(src + x + 4) & v_mask1));
      }
    } else if (cn == 3) {
      for (; x <= len - cVectorWidth; x += cVectorWidth) {
        v_uint16x8 v_masku16 = v_load_expand(mask + x);
        ...
        v_store_interleave(dst + x * cn, v_dst00 + v_src00, v_dst10 + v_src10,
                           v_dst20 + v_src20);
        v_store_interleave(dst + (x + 4) * cn, v_dst01 + v_src01,
  ...
  if (!mask) {
    ...
    if (cn == 1) {
      ...
      for (; x <= len - cVectorWidth; x += cVectorWidth) {
        ...
        v_float64x2 v_src0000, v_src0001, v_src0010, v_src0011, v_src0100,
            v_src0101, v_src0110, v_src0111;
        v_float64x2 v_src1000, v_src1001, v_src1010, v_src1011, v_src1100,
            v_src1101, v_src1110, v_src1111;
        v_float64x2 v_src2000, v_src2001, v_src2010, v_src2011, v_src2100,
            v_src2101, v_src2110, v_src2111;
        ...
        v_float64x2 v_dst0000, v_dst0001, v_dst0010, v_dst0011, v_dst0100,
            v_dst0101, v_dst0110, v_dst0111;
        v_float64x2 v_dst1000, v_dst1001, v_dst1010, v_dst1011, v_dst1100,
            v_dst1101, v_dst1110, v_dst1111;
        v_float64x2 v_dst2000, v_dst2001, v_dst2010, v_dst2011, v_dst2100,
            v_dst2101, v_dst2110, v_dst2111;
        v_load_deinterleave(dst + (x * cn), v_dst0000, v_dst1000, v_dst2000);
        v_load_deinterleave(dst + ((x + 2) * cn), v_dst0001, v_dst1001,
                            v_dst2001);
        v_load_deinterleave(dst + ((x + 4) * cn), v_dst0010, v_dst1010,
                            v_dst2010);
        v_load_deinterleave(dst + ((x + 6) * cn), v_dst0011, v_dst1011,
                            v_dst2011);
        v_load_deinterleave(dst + ((x + 8) * cn), v_dst0100, v_dst1100,
                            v_dst2100);
        v_load_deinterleave(dst + ((x + 10) * cn), v_dst0101, v_dst1101,
                            v_dst2101);
        v_load_deinterleave(dst + ((x + 12) * cn), v_dst0110, v_dst1110,
                            v_dst2110);
        v_load_deinterleave(dst + ((x + 14) * cn), v_dst0111, v_dst1111,
                            v_dst2111);

        v_store_interleave(dst + (x * cn), v_dst0000 + v_src0000,
                           v_dst1000 + v_src1000, v_dst2000 + v_src2000);
        v_store_interleave(dst + ((x + 2) * cn), v_dst0001 + v_src0001,
                           v_dst1001 + v_src1001, v_dst2001 + v_src2001);
        v_store_interleave(dst + ((x + 4) * cn), v_dst0010 + v_src0010,
                           v_dst1010 + v_src1010, v_dst2010 + v_src2010);
        v_store_interleave(dst + ((x + 6) * cn), v_dst0011 + v_src0011,
                           v_dst1011 + v_src1011, v_dst2011 + v_src2011);
        v_store_interleave(dst + ((x + 8) * cn), v_dst0100 + v_src0100,
                           v_dst1100 + v_src1100, v_dst2100 + v_src2100);
        v_store_interleave(dst + ((x + 10) * cn), v_dst0101 + v_src0101,
                           v_dst1101 + v_src1101, v_dst2101 + v_src2101);
        v_store_interleave(dst + ((x + 12) * cn), v_dst0110 + v_src0110,
                           v_dst1110 + v_src1110, v_dst2110 + v_src2110);
        v_store_interleave(dst + ((x + 14) * cn), v_dst0111 + v_src0111,
                           v_dst1111 + v_src1111, v_dst2111 + v_src2111);
      }
    }
  }
  ...
  if (!mask) {
    ...
    if (cn == 3) {
      for (; x <= len - cVectorWidth; x += cVectorWidth) {
        ...
        v_float64x2 v_dst00, v_dst01, v_dst02, v_dst03, v_dst10, v_dst11,
            v_dst12, v_dst13, v_dst20, v_dst21, v_dst22, v_dst23;
        v_load_deinterleave(dst + x * cn, v_dst00, v_dst10, v_dst20);
        ...
        v_store_interleave(dst + x * cn, v_dst00 + v_src00, v_dst10 + v_src10,
                           v_dst20 + v_src20);
        v_store_interleave(dst + (x + 2) * cn, v_dst01 + v_src01,
                           v_dst11 + v_src11, v_dst21 + v_src21);
        v_store_interleave(dst + (x + 4) * cn, v_dst02 + v_src02,
                           v_dst12 + v_src12, v_dst22 + v_src22);
        v_store_interleave(dst + (x + 6) * cn, v_dst03 + v_src03,
                           v_dst13 + v_src13, v_dst23 + v_src23);
      }
    }
  }
  ...
  if (!mask) {
    ...
    if (cn == 1) {
      ...
      for (; x <= len - cVectorWidth; x += cVectorWidth) {
        ...
        v_store_interleave(
            dst + x * cn, v_dst000 + v_cvt_f32(v_reinterpret_as_s32(v_src000)),
            v_dst100 + v_cvt_f32(v_reinterpret_as_s32(v_src100)),
            v_dst200 + v_cvt_f32(v_reinterpret_as_s32(v_src200)));
        v_store_interleave(
            dst + (x + 4) * cn,
  ...
  if (!mask) {
    ...
    if (cn == 1) {
      ...
      for (; x <= len - cVectorWidth; x += cVectorWidth) {
        ...
        v_uint16x8 v_1src00, v_1src01, v_1src10, v_1src11, v_1src20, v_1src21,
            v_2src00, v_2src01, v_2src10, v_2src11, v_2src20, v_2src21;
        ...
        v_uint32x4 v_src000, v_src001, v_src002, v_src003, v_src100, v_src101,
            v_src102, v_src103, v_src200, v_src201, v_src202, v_src203;
        v_expand(v_src00, v_src000, v_src001);
        ...
        v_float32x4 v_dst000, v_dst001, v_dst002, v_dst003, v_dst100, v_dst101,
            v_dst102, v_dst103, v_dst200, v_dst201, v_dst202, v_dst203;
        v_load_deinterleave(dst + x * cn, v_dst000, v_dst100, v_dst200);
        v_load_deinterleave(dst + (x + 4) * cn, v_dst001, v_dst101, v_dst201);
  ...
  if (!mask) {
    ...
    if (cn == 1) {
      ...
      for (; x <= len - cVectorWidth; x += cVectorWidth) {
        ...
        v_uint32x4 v_1src00, v_1src01, v_1src10, v_1src11, v_1src20, v_1src21,
            v_2src00, v_2src01, v_2src10, v_2src11, v_2src20, v_2src21;
        v_expand(v_1src0, v_1src00, v_1src01);
        v_expand(v_1src1, v_1src10, v_1src11);
        v_expand(v_1src2, v_1src20, v_1src21);
...
void accProd_simd_(const float* src1, const float* src2, float* dst,
  ...
  if (!mask) {
    ...
    for (; x <= size - cVectorWidth; x += cVectorWidth) {
      ...
      v_store(dst + x + 4, v_load(dst + x + 4) +
                               v_load(src1 + x + 4) * v_load(src2 + x + 4));
    }
  } else {
    v_uint32x4 v_0 = v_setzero_u32();
    if (cn == 1) {
      for (; x <= len - cVectorWidth; x += cVectorWidth) {
        ...
        v_store(dst + x, v_load(dst + x) +
                             ((v_load(src1 + x) * v_load(src2 + x)) & v_mask0));
        v_store(dst + x + 4,
                v_load(dst + x + 4) +
                    ((v_load(src1 + x + 4) * v_load(src2 + x + 4)) & v_mask1));
      }
    } else if (cn == 3) {
      for (; x <= len - cVectorWidth; x += cVectorWidth) {
        v_uint32x4 v_mask32_0 = v_load_expand_q(mask + x);
        ...
        v_store_interleave(dst + x * cn,
                           v_dst00 + ((v_1src00 * v_2src00) & v_mask0),
                           v_dst10 + ((v_1src10 * v_2src10) & v_mask0),
                           v_dst20 + ((v_1src20 * v_2src20) & v_mask0));
        v_store_interleave(dst + (x + 4) * cn,
                           v_dst01 + ((v_1src01 * v_2src01) & v_mask1),
  ...
  if (!mask) {
    ...
    if (cn == 1) {
      for (; x <= len - cVectorWidth; x += cVectorWidth) {
        ...
        v_store(dst + x + 2,
                v_load(dst + x + 2) + ((v_src01 * v_src11) & v_mask1));
      }
    } else if (cn == 3) {
      for (; x <= len - cVectorWidth; x += cVectorWidth) {
        v_uint32x4 v_mask32 = v_load_expand_q(mask + x);
...
void accW_simd_(const uchar* src, float* dst, const uchar* mask, int len,
  ...
  if (!mask) {
    ...
    for (; x <= size - cVectorWidth; x += cVectorWidth) {
      ...
      v_dst00 = (v_dst00 * v_beta) +
                (v_cvt_f32(v_reinterpret_as_s32(v_src00)) * v_alpha);
      v_dst01 = (v_dst01 * v_beta) +
                (v_cvt_f32(v_reinterpret_as_s32(v_src01)) * v_alpha);
      v_dst10 = (v_dst10 * v_beta) +
                (v_cvt_f32(v_reinterpret_as_s32(v_src10)) * v_alpha);
      v_dst11 = (v_dst11 * v_beta) +
                (v_cvt_f32(v_reinterpret_as_s32(v_src11)) * v_alpha);
...
void accW_simd_(const float* src, float* dst, const uchar* mask, int len,
  ...
  if (!mask) {
    ...
    for (; x <= size - cVectorWidth; x += cVectorWidth) {
      v_store(dst + x,
              ((v_load(dst + x) * v_beta) + (v_load(src + x) * v_alpha)));
      v_store(dst + x + 4, ((v_load(dst + x + 4) * v_beta) +
                            (v_load(src + x + 4) * v_alpha)));
    }
  }
...
void accW_simd_(const float* src, double* dst, const uchar* mask, int len,
  ...
  if (!mask) {
    ...
    for (; x <= size - cVectorWidth; x += cVectorWidth) {
      ...
      v_store(dst + x + 2,
              ((v_load(dst + x + 2) * v_beta) + (v_src01 * v_alpha)));
      v_store(dst + x + 4,
              ((v_load(dst + x + 4) * v_beta) + (v_src10 * v_alpha)));
      v_store(dst + x + 6,
              ((v_load(dst + x + 6) * v_beta) + (v_src11 * v_alpha)));
    }
  }
...
void accW_simd_(const double* src, double* dst, const uchar* mask, int len,
  ...
  if (!mask) {
    ...
    for (; x <= size - cVectorWidth; x += cVectorWidth) {
      ...
      v_store(dst + x + 2,
              ((v_load(dst + x + 2) * v_beta) + (v_src1 * v_alpha)));
    }
  }
...
void accW_avx_32f(const float* src, float* dst, const uchar* mask, int len,
  ...
  if (!mask) {
    ...
    for (; x <= size - cVectorWidth; x += cVectorWidth) {
      _mm256_storeu_ps(
          dst + x,
          _mm256_add_ps(_mm256_mul_ps(_mm256_loadu_ps(dst + x), v_beta),
                        _mm256_mul_ps(_mm256_loadu_ps(src + x), v_alpha)));
      _mm256_storeu_ps(
          dst + x + 8,
          _mm256_add_ps(_mm256_mul_ps(_mm256_loadu_ps(dst + x + 8), v_beta),
...
void accW_avx_32f64f(const float* src, double* dst, const uchar* mask, int len,
  ...
  if (!mask) {
    ...
    for (; x <= size - cVectorWidth; x += cVectorWidth) {
      ...
      _mm256_storeu_pd(
          dst + x,
          _mm256_add_pd(_mm256_mul_pd(_mm256_loadu_pd(dst + x), v_beta),
                        _mm256_mul_pd(v_src00, v_alpha)));
      _mm256_storeu_pd(
          dst + x + 4,
          _mm256_add_pd(_mm256_mul_pd(_mm256_loadu_pd(dst + x + 4), v_beta),
                        _mm256_mul_pd(v_src01, v_alpha)));
      _mm256_storeu_pd(
          dst + x + 8,
          _mm256_add_pd(_mm256_mul_pd(_mm256_loadu_pd(dst + x + 8), v_beta),
                        _mm256_mul_pd(v_src10, v_alpha)));
      _mm256_storeu_pd(
          dst + x + 12,
          _mm256_add_pd(_mm256_mul_pd(_mm256_loadu_pd(dst + x + 12), v_beta),
