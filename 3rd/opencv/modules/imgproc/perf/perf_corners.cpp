...
typedef std::tr1::tuple<string, int, int, double, BorderType>
    Img_BlockSize_ApertureSize_k_BorderType_t;
typedef perf::TestBaseWithParam<Img_BlockSize_ApertureSize_k_BorderType_t>
    Img_BlockSize_ApertureSize_k_BorderType;

PERF_TEST_P(Img_BlockSize_ApertureSize_k_BorderType, cornerHarris,
            testing::Combine(testing::Values("stitching/a1.png",
                                             "cv/shared/pic5.png"),
                             testing::Values(3, 5), testing::Values(3, 5),
                             testing::Values(0.04, 0.1), BorderType::all())) {
...
typedef std::tr1::tuple<string, int, int, BorderType>
    Img_BlockSize_ApertureSize_BorderType_t;
typedef perf::TestBaseWithParam<Img_BlockSize_ApertureSize_BorderType_t>
