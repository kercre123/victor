...
CV_ENUM(MethodType, TM_SQDIFF, TM_SQDIFF_NORMED, TM_CCORR, TM_CCORR_NORMED,
        TM_CCOEFF, TM_CCOEFF_NORMED)

typedef std::tr1::tuple<Size, Size, MethodType, MatType>
    ImgSize_TmplSize_Method_MatType_t;
typedef TestBaseWithParam<ImgSize_TmplSize_Method_MatType_t>
...
OCL_PERF_TEST_P(ImgSize_TmplSize_Method_MatType, MatchTemplate,
                ::testing::Combine(
                    ...
                    testing::Values(cv::Size(11, 11), cv::Size(16, 16),
                                    cv::Size(41, 41)),
                    MethodType::all(),
  ...
  double eps = isNormed ? 3e-2 : 255 * 255 * tmpl.total() * 1e-4;
...
OCL_PERF_TEST_P(CV_TM_CCORRFixture, matchTemplate,
                ::testing::Combine(::testing::Values(Size(1000, 1000),
                                                     Size(2000, 2000)),
...
OCL_PERF_TEST_P(CV_TM_CCORR_NORMEDFixture, matchTemplate,
                ::testing::Values(Size(1000, 1000), Size(2000, 2000),
                                  Size(4000, 4000))) {
