...
struct Guid {
 public:
  ...
  Guid(unsigned int __aArg, unsigned short __bArg, unsigned short __cArg,
       unsigned __int8 __dArg, unsigned __int8 __eArg, unsigned __int8 __fArg,
       unsigned __int8 __gArg, unsigned __int8 __hArg, unsigned __int8 __iArg,
       unsigned __int8 __jArg, unsigned __int8 __kArg);
  Guid(unsigned int __aArg, unsigned short __bArg, unsigned short __cArg,
       const unsigned __int8* __dArg);
...
static_assert(sizeof(__rcGUID_t) == sizeof(::_GUID),
...
inline bool Guid::Equals(Guid __guidArg) { return *this == __guidArg; }
...
inline bool operator==(Guid __aArg, Guid __bArg) {
  ...
  return (__a[0] == __b[0] && __a[1] == __b[1] && __a[2] == __b[2] &&
          __a[3] == __b[3]);
}

inline bool operator!=(Guid __aArg, Guid __bArg) { return !(__aArg == __bArg); }
...
inline Guid::Guid(unsigned int __aArg, unsigned short __bArg,
                  unsigned short __cArg, unsigned __int8 __dArg,
                  unsigned __int8 __eArg, unsigned __int8 __fArg,
                  unsigned __int8 __gArg, unsigned __int8 __hArg,
                  unsigned __int8 __iArg, unsigned __int8 __jArg,
...
inline Guid::Guid(unsigned int __aArg, unsigned short __bArg,
                  unsigned short __cArg, const unsigned __int8 __dArg[8])
...
__declspec(selectany) Guid
    __winrt_GUID_NULL(0x00000000, 0x0000, 0x0000, 0x00, 0x00, 0x00, 0x00, 0x00,
                      0x00, 0x00, 0x00);

//
//// Don't want to define the real IUnknown from unknown.h here. That would
///means if the user has / any broken code that uses it, compile errors will
///take the form of e.g.: /     predefined C++ WinRT types (compiler
///internal)(41) : see declaration of 'IUnknown::QueryInterface' / This is not
///helpful. If they use IUnknown, we still need to point them to the actual
///unknown.h so / that they can see the original definition.
////
//// For WinRT, we'll instead have a parallel COM interface hierarchy for basic
///interfaces starting with _. / The type mismatch is not an issue. COM passes
///types through GUID / void* combos - the original type / doesn't come into
///play unless the user static_casts an implementation type to one of these, but
...
__declspec(dllexport) __declspec(
    noreturn) void __stdcall __abi_WinRTraiseNotImplementedException();
__declspec(dllexport) __declspec(
    noreturn) void __stdcall __abi_WinRTraiseInvalidCastException();
__declspec(dllexport) __declspec(
    noreturn) void __stdcall __abi_WinRTraiseNullReferenceException();
__declspec(dllexport) __declspec(
    noreturn) void __stdcall __abi_WinRTraiseOperationCanceledException();
__declspec(dllexport) __declspec(
    noreturn) void __stdcall __abi_WinRTraiseFailureException();
__declspec(dllexport) __declspec(
    noreturn) void __stdcall __abi_WinRTraiseAccessDeniedException();
__declspec(dllexport) __declspec(
    noreturn) void __stdcall __abi_WinRTraiseOutOfMemoryException();
__declspec(dllexport) __declspec(
    noreturn) void __stdcall __abi_WinRTraiseInvalidArgumentException();
__declspec(dllexport) __declspec(
    noreturn) void __stdcall __abi_WinRTraiseOutOfBoundsException();
__declspec(dllexport) __declspec(
    noreturn) void __stdcall __abi_WinRTraiseChangedStateException();
__declspec(dllexport) __declspec(
    noreturn) void __stdcall __abi_WinRTraiseClassNotRegisteredException();
__declspec(dllexport) __declspec(
    noreturn) void __stdcall __abi_WinRTraiseWrongThreadException();
__declspec(dllexport) __declspec(
    noreturn) void __stdcall __abi_WinRTraiseDisconnectedException();
__declspec(dllexport) __declspec(
    noreturn) void __stdcall __abi_WinRTraiseObjectDisposedException();
__declspec(dllexport) __declspec(
    noreturn) void __stdcall __abi_WinRTraiseCOMException(long);

__declspec(noreturn) inline void __stdcall __abi_WinRTraiseException(
    long __hrArg) {
  switch (__hrArg) {
 ...
 public:
  ...
  void* operator new(size_t __sizeArg, void* __pSmallCaptureArg) {
    if (__sizeArg > __smallCaptureSize) {
      return reinterpret_cast<__abi_CaptureBase*>(
          HeapAlloc(GetProcessHeap(), 0, __sizeArg));
    }
...
struct __abi_CapturePtr {
  ...
  __abi_CapturePtr()
      : ptr(reinterpret_cast<__abi_CaptureBase*>(smallCapture)) {}
  ~__abi_CapturePtr() { ptr->Delete(ptr, smallCapture); }
};
...
struct __abi_FunctorCapture1 : public __abi_CaptureBase {
  ...
  virtual __TReturnType __stdcall Invoke(__TArg0 __arg0) {
    return functor(__arg0);
  }
};
template <typename __TFunctor, typename __TReturnType, typename __TArg0,
          typename __TArg1>
struct __abi_FunctorCapture2 : public __abi_CaptureBase {
  ...
  virtual __TReturnType __stdcall Invoke(__TArg0 __arg0, __TArg1 __arg1) {
    return functor(__arg0, __arg1);
  }
};
template <typename __TFunctor, typename __TReturnType, typename __TArg0,
          typename __TArg1, typename __TArg2>
struct __abi_FunctorCapture3 : public __abi_CaptureBase {
  __TFunctor functor;
  __abi_FunctorCapture3(__TFunctor __functor) : functor(__functor) {}
  virtual __TReturnType __stdcall Invoke(__TArg0 __arg0, __TArg1 __arg1,
                                         __TArg2 __arg2) {
    return functor(__arg0, __arg1, __arg2);
  }
};
template <typename __TFunctor, typename __TReturnType, typename __TArg0,
          typename __TArg1, typename __TArg2, typename __TArg3>
struct __abi_FunctorCapture4 : public __abi_CaptureBase {
  __TFunctor functor;
  __abi_FunctorCapture4(__TFunctor __functor) : functor(__functor) {}
  virtual __TReturnType __stdcall Invoke(__TArg0 __arg0, __TArg1 __arg1,
                                         __TArg2 __arg2, __TArg3 __arg3) {
    return functor(__arg0, __arg1, __arg2, __arg3);
  }
};
template <typename __TFunctor, typename __TReturnType, typename __TArg0,
          typename __TArg1, typename __TArg2, typename __TArg3,
...
struct __abi_FunctorCapture5 : public __abi_CaptureBase {
  ...
  virtual __TReturnType __stdcall Invoke(__TArg0 __arg0, __TArg1 __arg1,
                                         __TArg2 __arg2, __TArg3 __arg3,
                                         __TArg4 __arg4) {
    return functor(__arg0, __arg1, __arg2, __arg3, __arg4);
  }
};
template <typename __TFunctor, typename __TReturnType, typename __TArg0,
          typename __TArg1, typename __TArg2, typename __TArg3,
          typename __TArg4, typename __TArg5>
struct __abi_FunctorCapture6 : public __abi_CaptureBase {
  __TFunctor functor;
  __abi_FunctorCapture6(__TFunctor __functor) : functor(__functor) {}
  virtual __TReturnType __stdcall Invoke(__TArg0 __arg0, __TArg1 __arg1,
                                         __TArg2 __arg2, __TArg3 __arg3,
                                         __TArg4 __arg4, __TArg5 __arg5) {
    return functor(__arg0, __arg1, __arg2, __arg3, __arg4, __arg5);
  }
};
template <typename __TFunctor, typename __TReturnType, typename __TArg0,
          typename __TArg1, typename __TArg2, typename __TArg3,
          typename __TArg4, typename __TArg5, typename __TArg6>
struct __abi_FunctorCapture7 : public __abi_CaptureBase {
  ...
  virtual __TReturnType __stdcall Invoke(__TArg0 __arg0, __TArg1 __arg1,
                                         ...
                                         __TArg4 __arg4, __TArg5 __arg5,
                                         __TArg6 __arg6) {
    return functor(__arg0, __arg1, __arg2, __arg3, __arg4, __arg5, __arg6);
  }
};
template <typename __TFunctor, typename __TReturnType, typename __TArg0,
          typename __TArg1, typename __TArg2, typename __TArg3,
...
template <typename __TFunctor, typename __TReturnType, typename __TArg0,
          typename __TArg1, typename __TArg2, typename __TArg3,
          typename __TArg4, typename __TArg5, typename __TArg6,
          typename __TArg7, typename __TArg8>
...
template <typename __TFunctor, typename __TReturnType, typename __TArg0,
          typename __TArg1, typename __TArg2, typename __TArg3,
          typename __TArg4, typename __TArg5, typename __TArg6,
          typename __TArg7, typename __TArg8, typename __TArg9>
struct __abi_FunctorCapture10 : public __abi_CaptureBase {
  ...
  virtual __TReturnType __stdcall Invoke(__TArg0 __arg0, __TArg1 __arg1,
                                         ...
                                         __TArg4 __arg4, __TArg5 __arg5,
                                         __TArg6 __arg6, __TArg7 __arg7,
                                         __TArg8 __arg8, __TArg9 __arg9) {
    return functor(__arg0, __arg1, __arg2, __arg3, __arg4, __arg5, __arg6,
                   __arg7, __arg8, __arg9);
  }
};

#define __is_winrt_array(type)                                                 \
  (type == ABI::Windows::Foundation::PropertyType::PropertyType_UInt8Array ||  \
   type == ABI::Windows::Foundation::PropertyType::PropertyType_Int16Array ||  \
   type == ABI::Windows::Foundation::PropertyType::PropertyType_UInt16Array || \
   type == ABI::Windows::Foundation::PropertyType::PropertyType_Int32Array ||  \
   type == ABI::Windows::Foundation::PropertyType::PropertyType_UInt32Array || \
   type == ABI::Windows::Foundation::PropertyType::PropertyType_Int64Array ||  \
   type == ABI::Windows::Foundation::PropertyType::PropertyType_UInt64Array || \
   type == ABI::Windows::Foundation::PropertyType::PropertyType_SingleArray || \
   type == ABI::Windows::Foundation::PropertyType::PropertyType_DoubleArray || \
   type == ABI::Windows::Foundation::PropertyType::PropertyType_Char16Array || \
   type ==                                                                     \
       ABI::Windows::Foundation::PropertyType::PropertyType_BooleanArray ||    \
   type == ABI::Windows::Foundation::PropertyType::PropertyType_StringArray || \
   type == ABI::Windows::Foundation::PropertyType::                            \
               PropertyType_InspectableArray ||                                \
   type ==                                                                     \
       ABI::Windows::Foundation::PropertyType::PropertyType_DateTimeArray ||   \
   type ==                                                                     \
       ABI::Windows::Foundation::PropertyType::PropertyType_TimeSpanArray ||   \
   type == ABI::Windows::Foundation::PropertyType::PropertyType_GuidArray ||   \
   type == ABI::Windows::Foundation::PropertyType::PropertyType_PointArray ||  \
   type == ABI::Windows::Foundation::PropertyType::PropertyType_SizeArray ||   \
   type == ABI::Windows::Foundation::PropertyType::PropertyType_RectArray ||   \
   type ==                                                                     \
       ABI::Windows::Foundation::PropertyType::PropertyType_OtherTypeArray)

template <typename _Type,
          bool bUnknown = std::is_base_of<IUnknown, _Type>::value>
struct winrt_type {};
template <typename _Type>
struct winrt_type<_Type, true> {
  ...
  static const ABI::Windows::Foundation::PropertyType _PropType =
      ABI::Windows::Foundation::PropertyType::PropertyType_OtherType;
};
template <typename _Type>
struct winrt_type<_Type, false> {
  static IUnknown* create(_Type* _ObjInCtx) {
    ...
    Microsoft::WRL::ComPtr<ABI::Windows::Foundation::IPropertyValueStatics>
        spPropVal;
    if (SUCCEEDED(hr)) hr = objFactory.As(&spPropVal);
    if (SUCCEEDED(hr)) {
      hr = winrt_type<_Type>::create(spPropVal.Get(), _ObjInCtx,
                                     _PObj.GetAddressOf());
      if (SUCCEEDED(hr)) return reinterpret_cast<IUnknown*>(_PObj.Detach());
    }
    return nullptr;
  }
  static IID getuuid() {
    return __uuidof(ABI::Windows::Foundation::IPropertyValue);
  }
  static const ABI::Windows::Foundation::PropertyType _PropType =
      ABI::Windows::Foundation::PropertyType::PropertyType_OtherType;
};
...
struct winrt_type<void> {
  static HRESULT create(
      ABI::Windows::Foundation::IPropertyValueStatics* spPropVal,
      void* _ObjInCtx, IInspectable** ppInsp) {
    (void)_ObjInCtx;
...
#define MAKE_TYPE(Type, Name)                                        \
  ...
  struct winrt_type<Type> {                                          \
    static HRESULT create(                                           \
        ABI::Windows::Foundation::IPropertyValueStatics* spPropVal,  \
        Type* _ObjInCtx, IInspectable** ppInsp) {                    \
      return spPropVal->Create##Name(*_ObjInCtx, ppInsp);            \
    }                                                                \
    static const ABI::Windows::Foundation::PropertyType _PropType =  \
        ABI::Windows::Foundation::PropertyType::PropertyType_##Name; \
  };
...
struct winrt_array_type {
  static IUnknown* create(_Type* _ObjInCtx, size_t N) {
    ...
    if (SUCCEEDED(hr)) hr = objFactory.As(&spPropVal);
    if (SUCCEEDED(hr)) {
      hr = winrt_array_type<_Type>::create(spPropVal.Get(), N, _ObjInCtx,
                                           _PObj.GetAddressOf());
      if (SUCCEEDED(hr)) return reinterpret_cast<IUnknown*>(_PObj.Detach());
    }
    return nullptr;
...
#define MAKE_ARRAY_TYPE(Type, Name)                                           \
  ...
  struct winrt_array_type<Type*> {                                            \
    static HRESULT create(                                                    \
        ABI::Windows::Foundation::IPropertyValueStatics* spPropVal,           \
        UINT32 __valueSize, Type** _ObjInCtx, IInspectable** ppInsp) {        \
      return spPropVal->Create##Name##Array(__valueSize, *_ObjInCtx, ppInsp); \
    }                                                                         \
    static const ABI::Windows::Foundation::PropertyType _PropType =           \
        ABI::Windows::Foundation::PropertyType::PropertyType_##Name##Array;   \
    static std::vector<Type> PropertyValueToVector(                           \
        ABI::Windows::Foundation::IPropertyValue* propValue) {                \
      UINT32 uLen = 0;                                                        \
      Type* pArray = nullptr;                                                 \
...
// MAKE_ARRAY_TYPE(boolean, Boolean) //conflict with identical type in C++ of
// BYTE/UInt8
...
#define __is_valid_winrt_type(_Type)                                           \
  (std::is_void<_Type>::value || std::is_same<_Type, BYTE>::value ||           \
   std::is_same<_Type, INT16>::value || std::is_same<_Type, UINT16>::value ||  \
   std::is_same<_Type, INT32>::value || std::is_same<_Type, UINT32>::value ||  \
   std::is_same<_Type, INT64>::value || std::is_same<_Type, UINT64>::value ||  \
   std::is_same<_Type, FLOAT>::value || std::is_same<_Type, DOUBLE>::value ||  \
   std::is_same<_Type, WCHAR>::value || std::is_same<_Type, boolean>::value || \
   ...
   std::is_base_of<IInspectable,                                               \
                   typename DerefHelper<_Type>::DerefType>::value ||           \
   ...
   std::is_same<_Type, BYTE*>::value || std::is_same<_Type, INT16*>::value ||  \
