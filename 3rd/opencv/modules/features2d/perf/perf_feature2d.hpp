...
/* cofiguration for tests of detectors/descriptors. shared between ocl and cpu
 * tests. */
...
#define DETECTORS_ONLY                                                      \
  FAST_DEFAULT, FAST_20_TRUE_TYPE5_8, FAST_20_TRUE_TYPE7_12,                \
      FAST_20_TRUE_TYPE9_16, FAST_20_FALSE_TYPE5_8, FAST_20_FALSE_TYPE7_12, \
      FAST_20_FALSE_TYPE9_16,                                               \
                                                                            \
...
#define DETECTORS_EXTRACTORS                                        \
  ORB_DEFAULT, ORB_1500_13_1, AKAZE_DEFAULT, AKAZE_DESCRIPTOR_KAZE, \
      BRISK_DEFAULT, KAZE_DEFAULT
...
#define TEST_IMAGES                                                          \
  testing::Values(                                                           \
      ...
      "stitching/a3.png", "stitching/s2.jpg")
...
static inline Ptr<Feature2D> getFeature2D(Feature2DType type) {
  switch (type) {
    ...
    case FAST_20_TRUE_TYPE5_8:
      return FastFeatureDetector::create(20, true,
    ...
    case FAST_20_FALSE_TYPE5_8:
      return FastFeatureDetector::create(20, false,
                                         FastFeatureDetector::TYPE_5_8);
    ...
    case AGAST_5_8:
      return AgastFeatureDetector::create(70, true,
