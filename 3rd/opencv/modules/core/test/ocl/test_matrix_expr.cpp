...
PARAM_TEST_CASE(UMatExpr, MatDepth, Channels) {
  ...
  virtual void SetUp() { type = CV_MAKE_TYPE(GET_PARAM(0), GET_PARAM(1)); }

  void generateTestData() { size = randomSize(1, MAX_VALUE); }
};
...
OCL_INSTANTIATE_TEST_CASE_P(MatrixOperation, UMatExpr,
