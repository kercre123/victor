...
#define TYPICAL_MAT_TYPES_ADWEIGHTED \
  CV_8UC1, CV_8UC4, CV_8SC1, CV_16UC1, CV_16SC1, CV_32SC1
#define TYPICAL_MATS_ADWEIGHTED                             \
  testing::Combine(testing::Values(szVGA, sz720p, sz1080p), \
                   testing::Values(TYPICAL_MAT_TYPES_ADWEIGHTED))
