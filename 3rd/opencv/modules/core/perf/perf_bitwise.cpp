...
#define TYPICAL_MAT_TYPES_BITW_ARITHM \
  CV_8UC1, CV_8SC1, CV_8UC4, CV_32SC1, CV_32SC4
#define TYPICAL_MATS_BITW_ARITHM                                   \
  testing::Combine(testing::Values(TYPICAL_MAT_SIZES_BITW_ARITHM), \
                   testing::Values(TYPICAL_MAT_TYPES_BITW_ARITHM))
