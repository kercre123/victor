...
CV_FLAGS(NormType, NORM_HAMMING2, NORM_HAMMING, NORM_INF, NORM_L1, NORM_L2,
...
PERF_TEST_P(Size_MatType_NormType, norm,
            testing::Combine(testing::Values(TYPICAL_MAT_SIZES),
                             ...
                             testing::Values((int)NORM_INF, (int)NORM_L1,
                                             (int)NORM_L2))) {
...
PERF_TEST_P(Size_MatType_NormType, norm2,
            testing::Combine(testing::Values(TYPICAL_MAT_SIZES),
                             ...
                             testing::Values((int)NORM_INF, (int)NORM_L1,
                                             (int)NORM_L2,
                                             (int)(NORM_RELATIVE + NORM_INF),
                                             (int)(NORM_RELATIVE + NORM_L1),
                                             (int)(NORM_RELATIVE + NORM_L2)))) {
  Size sz = get<0>(GetParam());
  int matType = get<1>(GetParam());
  int normType = get<2>(GetParam());
...
PERF_TEST_P(PerfHamming, norm,
            testing::Combine(testing::Values(NORM_HAMMING, NORM_HAMMING2),
...
PERF_TEST_P(Size_MatType_NormType, normalize_mask,
            testing::Combine(testing::Values(::perf::szVGA, ::perf::sz1080p),
                             testing::Values(TYPICAL_MAT_TYPES),
                             testing::Values((int)NORM_INF, (int)NORM_L1,
                                             (int)NORM_L2))) {
  Size sz = get<0>(GetParam());
