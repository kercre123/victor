...
#define TYPICAL_MAT_TYPES_CORE_ARITHM                                          \
  CV_8UC1, CV_8SC1, CV_16SC1, CV_16SC2, CV_16SC3, CV_16SC4, CV_8UC4, CV_32SC1, \
      CV_32FC1
#define TYPICAL_MATS_CORE_ARITHM                                   \
  testing::Combine(testing::Values(TYPICAL_MAT_SIZES_CORE_ARITHM), \
                   testing::Values(TYPICAL_MAT_TYPES_CORE_ARITHM))
