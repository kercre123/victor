...
extern CL_RUNTIME_EXPORT void*(CL_API_CALL* clSVMAlloc)(cl_context context,
                                                        cl_svm_mem_flags flags,
                                                        size_t size,
                                                        unsigned int alignment);
extern CL_RUNTIME_EXPORT void(CL_API_CALL* clSVMFree)(cl_context context,
                                                      void* svm_pointer);
extern CL_RUNTIME_EXPORT cl_int(CL_API_CALL* clSetKernelArgSVMPointer)(
    cl_kernel kernel, cl_uint arg_index, const void* arg_value);
// extern CL_RUNTIME_EXPORT void* (CL_API_CALL *clSetKernelExecInfo)(cl_kernel
// kernel, cl_kernel_exec_info param_name, size_t param_value_size, const void*
// param_value); extern CL_RUNTIME_EXPORT cl_int (CL_API_CALL
...
//        num_svm_pointers, void* svm_pointers[], void* user_data), void*
//        user_data, cl_uint num_events_in_wait_list, const cl_event*
//        event_wait_list, cl_event* event);
extern CL_RUNTIME_EXPORT cl_int(CL_API_CALL* clEnqueueSVMMemcpy)(
...
extern CL_RUNTIME_EXPORT cl_int(CL_API_CALL* clEnqueueSVMMemFill)(
    ...
    const cl_event* event_wait_list, cl_event* event);
extern CL_RUNTIME_EXPORT cl_int(CL_API_CALL* clEnqueueSVMMap)(
    cl_command_queue command_queue, cl_bool blocking_map,
    cl_map_flags map_flags, void* svm_ptr, size_t size,
    cl_uint num_events_in_wait_list, const cl_event* event_wait_list,
    cl_event* event);
extern CL_RUNTIME_EXPORT cl_int(CL_API_CALL* clEnqueueSVMUnmap)(
