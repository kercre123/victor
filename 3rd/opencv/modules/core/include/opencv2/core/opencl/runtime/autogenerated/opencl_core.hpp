...
extern CL_RUNTIME_EXPORT cl_kernel(CL_API_CALL* clCreateKernel)(cl_program,
                                                                const char*,
                                                                cl_int*);
...
extern CL_RUNTIME_EXPORT cl_program(
    CL_API_CALL* clCreateProgramWithBuiltInKernels)(cl_context, cl_uint,
                                                    const cl_device_id*,
                                                    const char*, cl_int*);
...
extern CL_RUNTIME_EXPORT cl_int(CL_API_CALL* clCreateSubDevices)(
...
extern CL_RUNTIME_EXPORT cl_int(CL_API_CALL* clGetMemObjectInfo)(cl_mem,
                                                                 ...
                                                                 size_t, void*,
                                                                 size_t*);
extern CL_RUNTIME_EXPORT cl_int(CL_API_CALL* clGetPlatformIDs)(cl_uint,
                                                               cl_platform_id*,
                                                               cl_uint*);
...
extern CL_RUNTIME_EXPORT cl_program(CL_API_CALL* clLinkProgram)(
    ...
    const cl_program*, void(CL_CALLBACK*)(cl_program, void*), void*, cl_int*);
...
extern CL_RUNTIME_EXPORT cl_int(CL_API_CALL* clSetKernelArg)(cl_kernel, cl_uint,
                                                             size_t,
                                                             const void*);
