...
#include <TargetConditionals.h>
    ...
    (!defined(TARGET_OS_OSX) && !TARGET_OS_IPHONE)
 ...
 * Platform dependent.
 *
 * Supports multiple readers / single writer access pattern (RW / readers–writer
 * / shared-exclusive lock).
 *
 * File must exist.
 * File can't be re-used (for example, I/O operations via std::fstream is not
 * safe)
 */
