...
/**
 * Test for check whether reading exif orientation tag was processed
 * successfully or not The test info is the set of 8 images named
 * testExifRotate_{1 to 8}.jpg The test image is the square 10x10 points divided
 * by four sub-squares: (R corresponds to Red, G to Green, B to Blue, W to
 * white)
 * ---------             ---------
 * | R | G |             | G | R |
 * |-------| - (tag 1)   |-------| - (tag 2)
...
const string exif_files[] = {"readwrite/testExifOrientation_1.jpg",
