...
// these defines are used to resolve conflict between tiff.h and
...
TEST(Imgcodecs_Tiff, write_read_16bit_big_little_endian) {
  // see issue #2601 "16-bit Grayscale TIFF Load Failures Due to Buffer
  // Underflow and Endianness"

  // Setup data for two minimal 16-bit grayscale TIFF files in both endian
  // formats
  uchar tiff_sample_data[2][86] = {
      {// Little endian
       0x49, 0x49, 0x2a, 0x00, 0x0c, 0x00, 0x00, 0x00, 0xad, 0xde, 0xef,
       0xbe, 0x06, 0x00, 0x00, 0x01, 0x03, 0x00, 0x01, 0x00, 0x00, 0x00,
       0x02, 0x00, 0x00, 0x00, 0x01, 0x01, 0x03, 0x00, 0x01, 0x00, 0x00,
       0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x01, 0x03, 0x00, 0x01, 0x00,
       0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x06, 0x01, 0x03, 0x00, 0x01,
       0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x11, 0x01, 0x04, 0x00,
       0x01, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x17, 0x01, 0x04,
       0x00, 0x01, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00},
      {// Big endian
       0x4d, 0x4d, 0x00, 0x2a, 0x00, 0x00, 0x00, 0x0c, 0xde, 0xad, 0xbe,
       0xef, 0x00, 0x06, 0x01, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x01,
       0x00, 0x02, 0x00, 0x00, 0x01, 0x01, 0x00, 0x03, 0x00, 0x00, 0x00,
       0x01, 0x00, 0x01, 0x00, 0x00, 0x01, 0x02, 0x00, 0x03, 0x00, 0x00,
       0x00, 0x01, 0x00, 0x10, 0x00, 0x00, 0x01, 0x06, 0x00, 0x03, 0x00,
       0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x01, 0x11, 0x00, 0x04,
       0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x08, 0x01, 0x17, 0x00,
       0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x04}};
...
TEST(Imgcodecs_Tiff, decode_tile_remainder) {
   ...
   * using the command 'convert <input> -define tiff:tile-geometry=128x128
   * -depth [8|16] <output> Note that the conversion to 16 bits expands the
   * range from 0-255 to 0-255*255, so the test converts back but rounding
   * errors cause small differences.
   */
...
TEST(Imgcodecs_Tiff, decode_infinite_rowsperstrip) {
  const uchar sample_data[142] = {
      ,
...
TEST_P(Imgcodecs_Tiff_Modes, decode_multipage) {
  ...
  const string page_files[] = {
      "readwrite/multipage_p1.tif", "readwrite/multipage_p2.tif",
      "readwrite/multipage_p3.tif", "readwrite/multipage_p4.tif",
      "readwrite/multipage_p5.tif", "readwrite/multipage_p6.tif"};
...
const int all_modes[] = {IMREAD_UNCHANGED, IMREAD_GRAYSCALE, IMREAD_COLOR,
                         IMREAD_ANYDEPTH, IMREAD_ANYCOLOR};

INSTANTIATE_TEST_CASE_P(AllModes, Imgcodecs_Tiff_Modes,
