...
#define TEST(test_case_name, test_name)                                      \
  ...
  void GTEST_TEST_CLASS_NAME_(test_case_name, test_name)::TestBody()         \
      CV__TEST_BODY_IMPL(                                                    \
          #test_case_name                                                    \
          "_" #test_name) void GTEST_TEST_CLASS_NAME_(test_case_name,        \
                                                      test_name)::Body()
...
#define TEST_F(test_fixture, test_name)                                      \
  class GTEST_TEST_CLASS_NAME_(test_fixture, test_name)                      \
   ...
   private:                                                                  \
    ...
    virtual void Body();                                                     \
    static ::testing::TestInfo* const test_info_ GTEST_ATTRIBUTE_UNUSED_;    \
    GTEST_DISALLOW_COPY_AND_ASSIGN_(GTEST_TEST_CLASS_NAME_(test_fixture,     \
                                                           test_name));      \
  };                                                                         \
                                                                             \
  ...
  void GTEST_TEST_CLASS_NAME_(test_fixture, test_name)::TestBody()           \
      CV__TEST_BODY_IMPL(                                                    \
          #test_fixture                                                      \
          "_" #test_name) void GTEST_TEST_CLASS_NAME_(test_fixture,          \
                                                      test_name)::Body()

// Don't use directly
#define CV__TEST_P(test_case_name, test_name, bodyMethodName,                  \
                   BODY_IMPL /*(name_str)*/)                                   \
  class GTEST_TEST_CLASS_NAME_(test_case_name, test_name)                      \
  ...
  void GTEST_TEST_CLASS_NAME_(test_case_name, test_name)::TestBody()           \
      BODY_IMPL(#test_case_name "_" #test_name) void GTEST_TEST_CLASS_NAME_(   \
          test_case_name, test_name)::bodyMethodName()

#undef TEST_P
#define TEST_P(test_case_name, test_name) \
  CV__TEST_P(test_case_name, test_name, Body, CV__TEST_BODY_IMPL)
