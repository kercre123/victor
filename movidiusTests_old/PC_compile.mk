...
PC_FOLDERS= leon_code/main_code pc_code kernels ../../common/swCommon/pcModel ../../common/swCommon/shave_code/myriad1/include ../../common/shared/include shave_code .

PC_SOURCES = shave_code/ImageKernelProcessing.cpp leon_code/main_code/main_code.c \
             pc_code/pcKernelProcessing.cpp\
             kernels/gaussVx2Shave.cpp kernels/gaussHx2Shave.cpp ../../common/swCommon/pcModel/myriadModel.cpp 
