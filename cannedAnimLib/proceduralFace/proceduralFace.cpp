...
Vision::Image ProceduralFace::_hueImage =
    Vision::Image(FACE_DISPLAY_HEIGHT, FACE_DISPLAY_WIDTH,
                  static_cast<u8>(_hue* std::numeric_limits<u8>::max()));
Vision::Image ProceduralFace::_satImage =
    Vision::Image(FACE_DISPLAY_HEIGHT, FACE_DISPLAY_WIDTH,
                  static_cast<u8>(_saturation* std::numeric_limits<u8>::max()));

#define CONSOLE_GROUP "Face.ParameterizedFace"

// Set up hue and saturation console functions
std::unique_ptr<Anki::Util::IConsoleFunction> ProceduralFace::_hueConsoleFunc =
    std::unique_ptr<Anki::Util::IConsoleFunction>(
        new Anki::Util::IConsoleFunction("ProcFace_Hue", HueConsoleFunction,
                                         CONSOLE_GROUP, "float hue"));
std::unique_ptr<Anki::Util::IConsoleFunction>
    ProceduralFace::_saturationConsoleFunc =
        std::unique_ptr<Anki::Util::IConsoleFunction>(
            new Anki::Util::IConsoleFunction(
                "ProcFace_Saturation", SaturationConsoleFunction, CONSOLE_GROUP,
                "float saturation"));
#undef CONSOLE_GROUP
...
void ProceduralFace::SaturationConsoleFunction(
    ConsoleFunctionContextRef context) {
...
CONSOLE_VAR_RANGED(s32, kProcFace_NominalEyeSpacing, CONSOLE_GROUP, 92,
                   -FACE_DISPLAY_WIDTH, FACE_DISPLAY_WIDTH);  // V1: 64;

#undef CONSOLE_GROUP

//
// This is a big lookup table for all the properties of the eye parameters.
// We use the magic of the FullEnumToValueArrayChecker to compile-time guarantee
// each property is set for each param. Not using CLAD's enum concept here
// because it is not generated for the CppLite emitter which is used for the
//   robot/anim process -- plus we're storing a complex type (a struct) instead
//   of just a single value.
//

// Different ways we combine eye parameters
enum class EyeParamCombineMethod : u8 { None, Add, Multiply, Average };

// Each entry in the LUT is one of these
struct EyeParamInfo {
  bool isAngle;
  bool canBeUnset;  // parameter can be "unset", i.e. -1 (cannot use this if
                    // isAngle=true!)
  ProceduralFace::Value defaultValue;  // initial value for the parameter
  ProceduralFace::Value
      defaultValueIfCombiningWithUnset;  // value to use as default when
                                         // combining and both unset, ignored if
                                         // canBeUnset=false
  EyeParamCombineMethod combineMethod;
  struct {
    ProceduralFace::Value min;
    ProceduralFace::Value max;
  } clipLimits;
};

// NOTE: HotSpotCenters are marked as canBeUnset=true, but (a) -1 is a valid
// value, and (b) we aren't doing anything
//       special when we combine/interpolate them later despite this setting
//       (VIC-13592)
constexpr static const Util::FullEnumToValueArrayChecker::FullEnumToValueArray<
    ProceduralFace::Parameter, EyeParamInfo,
    ProceduralFace::Parameter::NumParameters>
    kEyeParamInfoLUT{
        {ProceduralFace::Parameter::EyeCenterX,
         {false,
          false,
          0.f,
          0.f,
          EyeParamCombineMethod::Add,
          {-FACE_DISPLAY_WIDTH / 2, FACE_DISPLAY_WIDTH / 2}}},
        {ProceduralFace::Parameter::EyeCenterY,
         {false,
          false,
          0.f,
          0.f,
          EyeParamCombineMethod::Add,
          {-FACE_DISPLAY_HEIGHT / 2, FACE_DISPLAY_HEIGHT / 2}}},
        {ProceduralFace::Parameter::EyeScaleX,
         {false,
          false,
          1.f,
          0.f,
          EyeParamCombineMethod::Multiply,
          {0.f, 10.f}}},
        {ProceduralFace::Parameter::EyeScaleY,
         {false,
          false,
          1.f,
          0.f,
          EyeParamCombineMethod::Multiply,
          {0.f, 10.f}}},
        {ProceduralFace::Parameter::EyeAngle,
         {true, false, 0.f, 0.f, EyeParamCombineMethod::Add, {-360, 360}}},
        {ProceduralFace::Parameter::LowerInnerRadiusX,
         {false, false, 0.f, 0.f, EyeParamCombineMethod::None, {0.f, 1.f}}},
        {ProceduralFace::Parameter::LowerInnerRadiusY,
         {false, false, 0.f, 0.f, EyeParamCombineMethod::None, {0.f, 1.f}}},
        {ProceduralFace::Parameter::UpperInnerRadiusX,
         {false, false, 0.f, 0.f, EyeParamCombineMethod::None, {0.f, 1.f}}},
        {ProceduralFace::Parameter::UpperInnerRadiusY,
         {false, false, 0.f, 0.f, EyeParamCombineMethod::None, {0.f, 1.f}}},
        {ProceduralFace::Parameter::UpperOuterRadiusX,
         {false, false, 0.f, 0.f, EyeParamCombineMethod::None, {0.f, 1.f}}},
        {ProceduralFace::Parameter::UpperOuterRadiusY,
         {false, false, 0.f, 0.f, EyeParamCombineMethod::None, {0.f, 1.f}}},
        {ProceduralFace::Parameter::LowerOuterRadiusX,
         {false, false, 0.f, 0.f, EyeParamCombineMethod::None, {0.f, 1.f}}},
        {ProceduralFace::Parameter::LowerOuterRadiusY,
         {false, false, 0.f, 0.f, EyeParamCombineMethod::None, {0.f, 1.f}}},
        {ProceduralFace::Parameter::UpperLidY,
         {false, false, 0.f, 0.f, EyeParamCombineMethod::None, {0.f, 1.f}}},
        {ProceduralFace::Parameter::UpperLidAngle,
         {true, false, 0.f, 0.f, EyeParamCombineMethod::Add, {-45, 45}}},
        {ProceduralFace::Parameter::UpperLidBend,
         {false, false, 0.f, 0.f, EyeParamCombineMethod::None, {-1.f, 1.f}}},
        {ProceduralFace::Parameter::LowerLidY,
         {false, false, 0.f, 0.f, EyeParamCombineMethod::None, {0.f, 1.f}}},
        {ProceduralFace::Parameter::LowerLidAngle,
         {true, false, 0.f, 0.f, EyeParamCombineMethod::Add, {-45, 45}}},
        {ProceduralFace::Parameter::LowerLidBend,
         {false, false, 0.f, 0.f, EyeParamCombineMethod::None, {-1.f, 1.f}}},
        {ProceduralFace::Parameter::Saturation,
         {false, true, -1.f, 1.f, EyeParamCombineMethod::None, {-1.f, 1.f}}},
        {ProceduralFace::Parameter::Lightness,
         {false, true, -1.f, 1.f, EyeParamCombineMethod::None, {-1.f, 1.f}}},
        {ProceduralFace::Parameter::GlowSize,
         {false, true, -1.f, 0.0f, EyeParamCombineMethod::None, {-1.f, 1.f}}},
        {ProceduralFace::Parameter::HotSpotCenterX,
         {false, true, 0.f, 0.0f, EyeParamCombineMethod::Average, {-1.f, 1.f}}},
        {ProceduralFace::Parameter::HotSpotCenterY,
         {false, true, 0.f, 0.0f, EyeParamCombineMethod::Average, {-1.f, 1.f}}},
        {ProceduralFace::Parameter::GlowLightness,
         {false, true, 0.f, 0.f, EyeParamCombineMethod::None, {0.f, 1.f}}},
    };

static_assert(
    Util::FullEnumToValueArrayChecker::IsSequentialArray(kEyeParamInfoLUT),
    "EyeParamInfoLUT array does not define each entry in order, once and only "
    "once!");
...
ProceduralFace::ProceduralFace() {
  for (std::underlying_type<Parameter>::type iParam = 0;
       iParam < Util::EnumToUnderlying(Parameter::NumParameters); ++iParam) {
    _eyeParams[WhichEye::Left][iParam] =
        kEyeParamInfoLUT[iParam].Value().defaultValue;
  }
...
bool ProceduralFace::operator==(const ProceduralFace& other) const {
  if (_eyeParams[ProceduralFace::WhichEye::Left] !=
      other._eyeParams[ProceduralFace::WhichEye::Left]) {
    return false;
  }
  if (_eyeParams[ProceduralFace::WhichEye::Right] !=
      other._eyeParams[ProceduralFace::WhichEye::Right]) {
    return false;
  }
...
s32 ProceduralFace::GetNominalEyeY() { return HEIGHT / 2; }
  ...
  if (this != &other) {
    ...
    if (nullptr != other._scanlineDistorter) {
      ...
      _scanlineDistorter.reset(
          new ScanlineDistorter(*other._scanlineDistorter));
    } else if (nullptr != _scanlineDistorter) {
      // Other does not have a ScanlineDistorter, but this does. Get rid of
      // this's.
      _scanlineDistorter.reset();
    }
  }
...
void ProceduralFace::SetEyeArrayHelper(WhichEye eye,
                                       const std::vector<Value>& eyeArray) {
  const char* eyeStr = (eye == WhichEye::Left) ? kLeftEyeKey : kRightEyeKey;

  // NOTE: don't do this

  // TODO: replace with a single version of assets, same version of code and
  // assets,
  ...
  const size_t N_without_hotspots =
      N -
      6;  // Before Saturation, Lightness, Glow, and HotSpotCenterX/Y were added
  const size_t N_without_glowlightness = N - 1;  // Before Eye Glow Lightness
  if (eyeArray.size() != N && eyeArray.size() != N_without_hotspots &&
      eyeArray.size() != N_without_glowlightness) {
    PRINT_NAMED_WARNING("ProceduralFace.SetEyeArrayHelper.WrongNumParams",
                        "Unexpected number of parameters for %s array (%lu vs. "
                        "%lu or %lu or %lu)",
                        eyeStr, (unsigned long)eyeArray.size(),
                        (unsigned long)N, (unsigned long)N_without_hotspots,
                        (unsigned long)N_without_glowlightness);
  }
  ...
  if (eyeArray.size() <= N_without_glowlightness) {
    ...
    const size_t N_upgrade_start =
        (eyeArray.size() <= N_without_hotspots ? N_without_hotspots
                                               : N_without_glowlightness);

    for (std::underlying_type<Parameter>::type iParam = N_upgrade_start;
         iParam < N; ++iParam) {
...
void ProceduralFace::SetFromFlatBuf(
    const CozmoAnim::ProceduralFace* procFaceKeyframe) {
...
void ProceduralFace::SetFromJson(const Json::Value& jsonRoot) {
  ...
  if (JsonTools::GetValueOptional(jsonRoot, kScanlineOpacityKey,
                                  scanlineOpacity)) {
    SetScanlineOpacity(scanlineOpacity);
  }
}

void ProceduralFace::SetFromValues(const std::vector<f32>& leftEyeData,
                                   const std::vector<f32>& rightEyeData,
                                   f32 faceAngle_deg, f32 faceCenterX,
                                   f32 faceCenterY, f32 faceScaleX,
                                   f32 faceScaleY, f32 scanlineOpacity) {
  std::vector<Value> eyeParams;

  for (std::vector<f32>::const_iterator it = leftEyeData.begin();
       it != leftEyeData.end(); ++it) {
  ...
  for (std::vector<f32>::const_iterator it = rightEyeData.begin();
       it != rightEyeData.end(); ++it) {
    eyeParams.push_back(*it);
  }
  SetEyeArrayHelper(WhichEye::Right, eyeParams);
...
void ProceduralFace::SetFromMessage(const ProceduralFaceParameters& msg) {
  ...
  for (s32 i = 0; i < (size_t)ProceduralEyeParameter::NumParameters; ++i) {
    SetParameter(WhichEye::Left, static_cast<ProceduralFace::Parameter>(i),
                 msg.leftEye[i]);
    SetParameter(WhichEye::Right, static_cast<ProceduralFace::Parameter>(i),
                 msg.rightEye[i]);
  }
}

void ProceduralFace::LookAt(f32 xShift, f32 yShift, f32 xmax, f32 ymax,
                            f32 lookUpMaxScale, f32 lookDownMinScale,
                            f32 outerEyeScaleIncrease) {
  SetFacePositionAndKeepCentered({xShift, yShift});

  // Amount "outer" eye will increase in scale depending on how far left/right
  // we look
  const f32 yscaleLR =
      1.f + outerEyeScaleIncrease * std::min(1.f, std::abs(xShift) / xmax);

  // Amount both eyes will increase/decrease in size depending on how far we
  // look up or down
  const f32 yscaleUD =
      (lookUpMaxScale - lookDownMinScale) *
          std::min(1.f, (1.f - (yShift + ymax) / (2.f * ymax))) +
      lookDownMinScale;

  if (xShift < 0) {
    SetParameter(WhichEye::Left, ProceduralEyeParameter::EyeScaleY,
                 yscaleLR * yscaleUD);
    SetParameter(WhichEye::Right, ProceduralEyeParameter::EyeScaleY,
                 (2.f - yscaleLR) * yscaleUD);
  } else {
    SetParameter(WhichEye::Left, ProceduralEyeParameter::EyeScaleY,
                 (2.f - yscaleLR) * yscaleUD);
    SetParameter(WhichEye::Right, ProceduralEyeParameter::EyeScaleY,
  ...
  DEV_ASSERT_MSG(
      FLT_GT(GetParameter(WhichEye::Left, ProceduralEyeParameter::EyeScaleY),
             0.f),
      "ProceduralFace.LookAt.NegativeLeftEyeScaleY",
      "yShift=%f yscaleLR=%f yscaleUD=%f ymax=%f", yShift, yscaleLR, yscaleUD,
      ymax);
  DEV_ASSERT_MSG(
      FLT_GT(GetParameter(WhichEye::Right, ProceduralEyeParameter::EyeScaleY),
             0.f),
  ...
  //                  "shift=(%.1f,%.1f), up/down scale=%.3f, left/right
  //                  scale=%.3f), reduceIOD=%.3f", xShift, yShift, yscaleUD,
  //                  yscaleLR, reduceIOD);
}

template <typename T>
inline static T LinearBlendHelper(const T value1, const T value2,
  ...
  T blendValue =
      static_cast<T>((1.f - blendFraction) * static_cast<float>(value1) +
                     blendFraction * static_cast<float>(value2));
  return blendValue;
}

inline static ProceduralFace::Value BlendAngleHelper(
    const ProceduralFace::Value angle1_deg,
    const ProceduralFace::Value angle2_deg, const float blendFraction) {
...
void ProceduralFace::Interpolate(const ProceduralFace& face1,
  ...
  for (auto const whichEye : {WhichEye::Left, WhichEye::Right}) {
    for (int iParam = 0; iParam < static_cast<int>(Parameter::NumParameters);
         ++iParam) {
      ...
      if (paramInfo.isAngle) {
        ...
        SetParameter(whichEye, param,
                     BlendAngleHelper(face1.GetParameter(whichEye, param),
        ...
        // NOTE: Despite preceding comment, this is just a regular linear blend.
        // Is that ok? (VIC-13592)
        SetParameter(whichEye, param,
                     LinearBlendHelper(face1.GetParameter(whichEye, param),
                                       face2.GetParameter(whichEye, param),
                                       blendFraction));
      } else {
        SetParameter(whichEye, param,
  ...
  SetFaceAngle(BlendAngleHelper(face1.GetFaceAngle(), face2.GetFaceAngle(),
                                blendFraction));
  SetFacePosition(
      {LinearBlendHelper(face1.GetFacePosition().x(),
                         face2.GetFacePosition().x(), blendFraction),
       LinearBlendHelper(face1.GetFacePosition().y(),
                         face2.GetFacePosition().y(), blendFraction)});
  SetFaceScale({LinearBlendHelper(face1.GetFaceScale().x(),
                                  face2.GetFaceScale().x(), blendFraction),
                LinearBlendHelper(face1.GetFaceScale().y(),
                                  face2.GetFaceScale().y(), blendFraction)});

  SetScanlineOpacity(LinearBlendHelper(
      face1.GetScanlineOpacity(), face2.GetScanlineOpacity(), blendFraction));

}  // Interpolate()

void ProceduralFace::GetEyeBoundingBox(Value& xmin, Value& xmax, Value& ymin,
                                       Value& ymax) {
  // Left edge of left eye
  const Value leftHalfWidth =
      GetParameter(WhichEye::Left, Parameter::EyeScaleX) * NominalEyeWidth / 2;
  const Value rightHalfWidth =
      GetParameter(WhichEye::Right, Parameter::EyeScaleX) * NominalEyeWidth / 2;
  xmin =
      (ProceduralFace::GetNominalLeftEyeX() +
       _faceScale.x() * (GetParameter(WhichEye::Left, Parameter::EyeCenterX) -
                         leftHalfWidth));

  // Right edge of right eye
  xmax =
      (ProceduralFace::GetNominalRightEyeX() +
       _faceScale.x() * (GetParameter(WhichEye::Right, Parameter::EyeCenterX) +
                         rightHalfWidth));

  // Min of the top edges of the two eyes
  const Value leftHalfHeight =
      GetParameter(WhichEye::Left, Parameter::EyeScaleY) * NominalEyeHeight / 2;
  const Value rightHalfHeight =
      GetParameter(WhichEye::Right, Parameter::EyeScaleY) * NominalEyeHeight /
      2;
  ymin = (ProceduralFace::GetNominalEyeY() +
          _faceScale.y() *
              (std::min(GetParameter(WhichEye::Left, Parameter::EyeCenterY) -
                            leftHalfHeight,
                        GetParameter(WhichEye::Right, Parameter::EyeCenterY) -
                            rightHalfHeight)));

  // Max of the bottom edges of the two eyes
  ymax = (ProceduralFace::GetNominalEyeY() +
          _faceScale.y() *
              (std::max(GetParameter(WhichEye::Left, Parameter::EyeCenterY) +
                            leftHalfHeight,
                        GetParameter(WhichEye::Right, Parameter::EyeCenterY) +
                            rightHalfHeight)));
...
void ProceduralFace::SetFacePositionAndKeepCentered(Point<2, Value> center) {
  ...
  // NOTE: (1) if you set center and *then* change eye centers/scales, you could
  // still go off screen
  //       (2) this also doesn't take lid height into account, so if the top lid
  //       is half closed and
  //           you move the eyes way down, it could look like they disappeared,
  //           for example
...
void ProceduralFace::CombineEyeParams(EyeParamArray& eyeArray0,
                                      const EyeParamArray& eyeArray1) {
  for (std::underlying_type<Parameter>::type iParam = 0;
       iParam < Util::EnumToUnderlying(Parameter::NumParameters); ++iParam) {
    const auto& paramInfo = kEyeParamInfoLUT[iParam].Value();
...
ProceduralFace& ProceduralFace::Combine(const ProceduralFace& otherFace) {
  CombineEyeParams(_eyeParams[(int)WhichEye::Left],
                   otherFace.GetParameters(WhichEye::Left));
  CombineEyeParams(_eyeParams[(int)WhichEye::Right],
                   otherFace.GetParameters(WhichEye::Right));
  ...
  const bool otherHasScanlineDistortion =
      (nullptr != otherFace._scanlineDistorter);

  if (thisHasScanlineDistortion && otherHasScanlineDistortion) {
    // Need to pick one. Convention, for whatever reason, will be to choose the
    // one that distorts the midpoint of the eyes the most (in either direction)
    const s32 thisMidPointShift =
        std::abs(_scanlineDistorter->GetEyeDistortionAmount(0.5f));
    const s32 otherMidPointShift =
        std::abs(otherFace._scanlineDistorter->GetEyeDistortionAmount(0.5f));
    if (otherMidPointShift > thisMidPointShift) {
      // Other distorts more. Use it.
      _scanlineDistorter.reset(
          new ScanlineDistorter(*otherFace._scanlineDistorter));
    }
...
ProceduralFace::Value ProceduralFace::Clip(WhichEye eye, Parameter param,
                                           Value newValue) const {
  auto const& clipLimits =
      kEyeParamInfoLUT[Util::EnumToUnderlying(param)].Value().clipLimits;
...
static void ClipWarning(const char* paramName, ProceduralFace::Value value,
                        ProceduralFace::Value minVal,
                        ProceduralFace::Value maxVal) {
  PRINT_NAMED_WARNING(
      "ProceduralFace.Clip.OutOfRange",
      "Value of %f out of range [%f,%f] for parameter %s. Clipping.", value,
      minVal, maxVal, paramName);
}

static void NoClipWarning(const char* paramName, ProceduralFace::Value value,
                          ProceduralFace::Value minVal,
                          ProceduralFace::Value maxVal) {
  // Do nothing
}
...
std::function<void(const char*, ProceduralFace::Value, ProceduralFace::Value,
                   ProceduralFace::Value)>
    ProceduralFace::ClipWarnFcn = &ClipWarning;
...
void ProceduralFace::RemoveScanlineDistorter() { _scanlineDistorter.reset(); }

template <class T>
void ProceduralFace::AddConsoleVar(T& var, const char* name, const char* group,
                                   const T& minVal, const T& maxVal) {
  // Allocate console var, then add it to list of console vars managed by this
  // object
  ConsoleVarPtr ptr(
      new Anki::Util::ConsoleVar<T>(var, name, group, minVal, maxVal, true));
...
void ProceduralFace::RegisterFaceWithConsoleVars() {
  AddConsoleVar<float>(_faceCenter[0], "kProcFace_CenterX", CONSOLE_GROUP,
                       -100.f, 100.f);
  AddConsoleVar<float>(_faceCenter[1], "kProcFace_CenterY", CONSOLE_GROUP,
                       -100.f, 100.f);
  AddConsoleVar<float>(_faceAngle_deg, "kProcFace_Angle_deg", CONSOLE_GROUP,
                       -90.f, 90.f);
  AddConsoleVar<float>(_faceScale[0], "kProcFace_ScaleX", CONSOLE_GROUP, 0.f,
                       4.f);
  AddConsoleVar<float>(_faceScale[1], "kProcFace_ScaleY", CONSOLE_GROUP, 0.f,
                       4.f);
  AddConsoleVar<float>(_hue, "kProcFace_Hue", CONSOLE_GROUP, 0.f, 1.f);
  AddConsoleVar<float>(_saturation, "kProcFace_Saturation", CONSOLE_GROUP, 0.,
                       1.f);
  ...
  for (auto whichEye : {WhichEye::Left, WhichEye::Right}) {
    for (std::underlying_type<Parameter>::type iParam = 0;
      ...
      std::string param =
          eyeName + "_" + EnumToString(kEyeParamInfoLUT[iParam].EnumValue());
      AddConsoleVar<float>(_eyeParams[whichEye][iParam], param.c_str(),
                           group.c_str(),
