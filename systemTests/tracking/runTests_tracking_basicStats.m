...
%                 pause(.03);
            ...
            elseif algorithmParameters.track_maxSnapToClosestQuadDistance > 0
            ...
            if iPose == 1 || algorithmParameters.track_maxSnapToClosestQuadDistance > 0
                if strcmp(algorithmParameters.whichAlgorithm, 'c_6dof')
                    try
                        ...
                        % If the current quad fails initialization, intialize with a stupid quad, that should just track pporly and incorrectly, but not crash
                        currentQuad = [50,20; 20,20; 50,50; 20,50];
