...
if (ANDROID)
  ...
  set(OPENCV2_INCLUDE_PATH ${CORETECH_EXTERNAL_DIR}/build/${OPENCV_DIR} ${CORETECH_EXTERNAL_DIR}/build/opencv-android) 
else()
  #set(OPENCV_DIR opencv-${OPENCV_VERSION})
  ...
  set(OPENCV2_INCLUDE_PATH ${CORETECH_EXTERNAL_DIR}/build/${OPENCV_DIR})
endif()
