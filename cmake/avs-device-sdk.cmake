...
if (VICOS)
  set(LIBAVS_INCLUDE_PATH "${ANKI_EXTERNAL_DIR}/avs-device-sdk/avs-device-sdk/vicos/include")
  set(LIBAVS_LIB_PATH "${ANKI_EXTERNAL_DIR}/avs-device-sdk/avs-device-sdk/vicos/lib")
elseif (MACOSX)
  set(LIBAVS_INCLUDE_PATH "${ANKI_EXTERNAL_DIR}/avs-device-sdk/avs-device-sdk/mac/include")
  set(LIBAVS_LIB_PATH "${ANKI_EXTERNAL_DIR}/avs-device-sdk/avs-device-sdk/mac/lib")
endif()
