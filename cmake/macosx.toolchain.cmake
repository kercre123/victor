...
# TODO:REG list(APPEND MACOSX_COMPILER_FLAGS_RELEASE
# TODO:REG  -D_FORTIFY_SOURCE=2)
...
if (SIMULATOR)
  list(APPEND MACOSX_COMPILER_FLAGS "-DSIMULATOR")
endif()
if (WEBOTS)
  list(APPEND MACOSX_COMPILER_FLAGS "-DWEBOTS")
endif()
