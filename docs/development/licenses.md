...
### [Open Source Org](https://github.com/OpenSourceOrg/licenses)
...
|Apache-1.1|Apache Software License, Version 1.1|https://opensource.org/licenses/Apache-1.1|
|Apache-2.0|Apache License, Version 2.0|https://en.wikipedia.org/wiki/Apache_License|
...
|BSD-2|BSD 2-Clause License|https://en.wikipedia.org/wiki/BSD_licenses#2-clause|
|BSD-3|BSD 3-Clause License|https://en.wikipedia.org/wiki/BSD_licenses#3-clause|
|BSL-1.0|Boost Software License 1.0 (BSL-1.0)|https://opensource.org/licenses/BSL-1.0|
|CATOSL-1.1|Computer Associates Trusted Open Source License, Version 1.1|https://opensource.org/licenses/CATOSL-1.1|
|CDDL-1.0|Common Development and Distribution License, Version 1.0|https://en.wikipedia.org/wiki/Common_Development_and_Distribution_License|
...
|CPL-1.0|Common Public License, Version 1.0|https://opensource.org/licenses/CPL-1.0|
...
|EPL-1.0|Eclipse Public License, Version 1.0|https://en.wikipedia.org/wiki/Eclipse_Public_License|
...
|GPL-2.0|GNU General Public License, Version 2.0|https://en.wikipedia.org/wiki/GNU_General_Public_License|
|GPL-3.0|GNU General Public License, Version 3.0|https://en.wikipedia.org/wiki/GNU_General_Public_License|
...
|IPL-1.0|IBM Public License, Version 1.0|https://opensource.org/licenses/IPL-1.0|
...
|LGPL-2.1|GNU Lesser General Public License, Version 2.1|https://en.wikipedia.org/wiki/GNU_Lesser_General_Public_License|
|LGPL-3.0|GNU Lesser General Public License, Version 3.0|https://en.wikipedia.org/wiki/GNU_Lesser_General_Public_License|
...
|MIT|MIT/Expat License|https://en.wikipedia.org/wiki/MIT_License|
...
|MPL-1.1|Mozilla Public License, Version 1.1|https://opensource.org/licenses/MPL-1.1|
|MPL-2.0|Mozilla Public License, Version 2.0|https://en.wikipedia.org/wiki/MPL_License|
...
|PHP-3.0|The PHP License, Version 3.0|https://opensource.org/licenses/PHP-3.0|
|PostgreSQL|The PostgreSQL Licence|https://opensource.org/licenses/PostgreSQL|
|Python-2.0|Python License, Version 2.0|https://opensource.org/licenses/Python-2.0|
...
|Sleepycat|The Sleepycat License|https://opensource.org/licenses/Sleepycat|
|SPL-1.0|Sun Public License, Version 1.0|https://opensource.org/licenses/SPL-1.0|
|UPL|The Universal Permissive License (UPL), Version 1.0|https://opensource.org/licenses/UPL|
...
|Zlib|The zlib/libpng License (Zlib)|https://opensource.org/licenses/Zlib|
